...
1.  Open the test application project *test\_app/firmware/pic32cm\_mc00\_curiosity\_pro.X* in the IDE

2.  Build the project to generate the binary **\(Do not program the binary\)**

3.  Open the bootloader project *bootloader/firmware/pic32cm\_mc00\_curiosity\_pro.X* in the IDE
