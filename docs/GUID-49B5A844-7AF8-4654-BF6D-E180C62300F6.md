...
|------------|-----------|
|bootloader/firmware/sam\_g55\_xpro.X|MPLABX Project for [SAM G55 Xplained Pro Evaluation Kit](http://www.microchip.com/DevelopmentTools/ProductDetails/atsamg55-xpro)|

**Test Application**

|Project Name|Description|
|------------|-----------|
|test\_app/firmware/sam\_g55\_xpro.X|MPLABX Project for [SAM G55 Xplained Pro Evaluation Kit](http://www.microchip.com/DevelopmentTools/ProductDetails/atsamg55-xpro)|
...
1.  Open the test application project *test\_app/firmware/sam\_g55\_xpro.X* in the IDE

2.  Build the project to generate the binary **\(Do not program the binary\)**

3.  Open the bootloader project *bootloader/firmware/sam\_g55\_xpro.X* in the IDE
