...
1.  Open the test application project *test\_app/firmware/sam\_d11\_xpro.X* in the IDE

2.  Build the project to generate the binary **\(Do not program the binary\)**

3.  Open the bootloader project *bootloader/firmware/sam\_d11\_xpro.X* in the IDE
