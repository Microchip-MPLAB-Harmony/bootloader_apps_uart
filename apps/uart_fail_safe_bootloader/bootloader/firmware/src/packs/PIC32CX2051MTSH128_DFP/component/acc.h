...
#ifndef _PIC32CXMTSH_ACC_COMPONENT_H_
#define _PIC32CXMTSH_ACC_COMPONENT_H_
...
#define   ACC_MR_SELMINUS_AD3_Val             _UINT32_(0x0)                                        /* (ACC_MR) Selects AD3  */
#define   ACC_MR_SELMINUS_AD4_Val             _UINT32_(0x1)                                        /* (ACC_MR) Selects AD4  */
#define   ACC_MR_SELMINUS_VTEMP_Val           _UINT32_(0x2)                                        /* (ACC_MR) Selects VTEMP  */
#define   ACC_MR_SELMINUS_VREFTEMP_Val        _UINT32_(0x3)                                        /* (ACC_MR) Selects VREFTEMP  */
#define ACC_MR_SELMINUS_AD3                   (ACC_MR_SELMINUS_AD3_Val << ACC_MR_SELMINUS_Pos)     /* (ACC_MR) Selects AD3 Position  */
#define ACC_MR_SELMINUS_AD4                   (ACC_MR_SELMINUS_AD4_Val << ACC_MR_SELMINUS_Pos)     /* (ACC_MR) Selects AD4 Position  */
#define ACC_MR_SELMINUS_VTEMP                 (ACC_MR_SELMINUS_VTEMP_Val << ACC_MR_SELMINUS_Pos)   /* (ACC_MR) Selects VTEMP Position  */
#define ACC_MR_SELMINUS_VREFTEMP              (ACC_MR_SELMINUS_VREFTEMP_Val << ACC_MR_SELMINUS_Pos) /* (ACC_MR) Selects VREFTEMP Position  */
...
#define   ACC_MR_SELPLUS_AD0_Val              _UINT32_(0x0)                                        /* (ACC_MR) Selects AD0  */
#define   ACC_MR_SELPLUS_AD1_Val              _UINT32_(0x1)                                        /* (ACC_MR) Selects AD1  */
#define   ACC_MR_SELPLUS_AD2_Val              _UINT32_(0x2)                                        /* (ACC_MR) Selects AD2  */
#define   ACC_MR_SELPLUS_VREFP_Val            _UINT32_(0x3)                                        /* (ACC_MR) Selects VREFP  */
#define ACC_MR_SELPLUS_AD0                    (ACC_MR_SELPLUS_AD0_Val << ACC_MR_SELPLUS_Pos)       /* (ACC_MR) Selects AD0 Position  */
#define ACC_MR_SELPLUS_AD1                    (ACC_MR_SELPLUS_AD1_Val << ACC_MR_SELPLUS_Pos)       /* (ACC_MR) Selects AD1 Position  */
#define ACC_MR_SELPLUS_AD2                    (ACC_MR_SELPLUS_AD2_Val << ACC_MR_SELPLUS_Pos)       /* (ACC_MR) Selects AD2 Position  */
#define ACC_MR_SELPLUS_VREFP                  (ACC_MR_SELPLUS_VREFP_Val << ACC_MR_SELPLUS_Pos)     /* (ACC_MR) Selects VREFP Position  */
...
#endif /* _PIC32CXMTSH_ACC_COMPONENT_H_ */
