...
#define MATRIX_PASSR2_REG_OFST         _UINT32_(0x248)     /* (MATRIX_PASSR2) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR3_REG_OFST         _UINT32_(0x24C)     /* (MATRIX_PASSR3) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR4_REG_OFST         _UINT32_(0x250)     /* (MATRIX_PASSR4) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR5_REG_OFST         _UINT32_(0x254)     /* (MATRIX_PASSR5) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR6_REG_OFST         _UINT32_(0x258)     /* (MATRIX_PASSR6) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR7_REG_OFST         _UINT32_(0x25C)     /* (MATRIX_PASSR7) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR8_REG_OFST         _UINT32_(0x260)     /* (MATRIX_PASSR8) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR9_REG_OFST         _UINT32_(0x264)     /* (MATRIX_PASSR9) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR10_REG_OFST        _UINT32_(0x268)     /* (MATRIX_PASSR10) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR11_REG_OFST        _UINT32_(0x26C)     /* (MATRIX_PASSR11) Protected Areas Split Slave 0 Register Offset */
#define MATRIX_PASSR12_REG_OFST        _UINT32_(0x270)     /* (MATRIX_PASSR12) Protected Areas Split Slave 0 Register Offset */
...
#define MATRIX_PRTSR2_REG_OFST         _UINT32_(0x288)     /* (MATRIX_PRTSR2) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR3_REG_OFST         _UINT32_(0x28C)     /* (MATRIX_PRTSR3) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR4_REG_OFST         _UINT32_(0x290)     /* (MATRIX_PRTSR4) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR5_REG_OFST         _UINT32_(0x294)     /* (MATRIX_PRTSR5) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR6_REG_OFST         _UINT32_(0x298)     /* (MATRIX_PRTSR6) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR7_REG_OFST         _UINT32_(0x29C)     /* (MATRIX_PRTSR7) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR8_REG_OFST         _UINT32_(0x2A0)     /* (MATRIX_PRTSR8) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR9_REG_OFST         _UINT32_(0x2A4)     /* (MATRIX_PRTSR9) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR10_REG_OFST        _UINT32_(0x2A8)     /* (MATRIX_PRTSR10) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR11_REG_OFST        _UINT32_(0x2AC)     /* (MATRIX_PRTSR11) Protected Region Top Slave 0 Register Offset */
#define MATRIX_PRTSR12_REG_OFST        _UINT32_(0x2B0)     /* (MATRIX_PRTSR12) Protected Region Top Slave 0 Register Offset */
...
typedef struct
{
  ...
  __IO  uint32_t                       MATRIX_SFR[16];     /**< Offset: 0x110 (R/W  32) Special Function Register */
  ...
  __IO  uint32_t                       MATRIX_PSR[16];     /**< Offset: 0x200 (R/W  32) Protection Slave 0 Register */
  __IO  uint32_t                       MATRIX_PASSR[16];   /**< Offset: 0x240 (R/W  32) Protected Areas Split Slave 0 Register */
  __IO  uint32_t                       MATRIX_PRTSR[16];   /**< Offset: 0x280 (R/W  32) Protected Region Top Slave 0 Register */
  __IO  uint32_t                       MATRIX_PPSELR[3];   /**< Offset: 0x2C0 (R/W  32) Protected Peripheral Select 1 Register */
} matrix_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CXMTSH_MATRIX_COMPONENT_H_ */
