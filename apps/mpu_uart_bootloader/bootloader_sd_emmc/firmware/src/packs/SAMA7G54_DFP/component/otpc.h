...
#ifndef _SAMA7G5_OTPC_COMPONENT_H_
#define _SAMA7G5_OTPC_COMPONENT_H_
...
#define OTPC_CR_PGM(value)                    (OTPC_CR_PGM_Msk & (_UINT32_(value) << OTPC_CR_PGM_Pos)) /* Assignment of value for PGM in the OTPC_CR register */
...
#define OTPC_CR_CKSGEN(value)                 (OTPC_CR_CKSGEN_Msk & (_UINT32_(value) << OTPC_CR_CKSGEN_Pos)) /* Assignment of value for CKSGEN in the OTPC_CR register */
...
#define OTPC_CR_INVLD(value)                  (OTPC_CR_INVLD_Msk & (_UINT32_(value) << OTPC_CR_INVLD_Pos)) /* Assignment of value for INVLD in the OTPC_CR register */
...
#define OTPC_CR_HIDE(value)                   (OTPC_CR_HIDE_Msk & (_UINT32_(value) << OTPC_CR_HIDE_Pos)) /* Assignment of value for HIDE in the OTPC_CR register */
...
#define OTPC_CR_READ(value)                   (OTPC_CR_READ_Msk & (_UINT32_(value) << OTPC_CR_READ_Pos)) /* Assignment of value for READ in the OTPC_CR register */
...
#define OTPC_CR_FLUSH(value)                  (OTPC_CR_FLUSH_Msk & (_UINT32_(value) << OTPC_CR_FLUSH_Pos)) /* Assignment of value for FLUSH in the OTPC_CR register */
...
#define OTPC_CR_KBSTART(value)                (OTPC_CR_KBSTART_Msk & (_UINT32_(value) << OTPC_CR_KBSTART_Pos)) /* Assignment of value for KBSTART in the OTPC_CR register */
...
#define OTPC_CR_KBSTOP(value)                 (OTPC_CR_KBSTOP_Msk & (_UINT32_(value) << OTPC_CR_KBSTOP_Pos)) /* Assignment of value for KBSTOP in the OTPC_CR register */
...
#define OTPC_CR_REFRESH(value)                (OTPC_CR_REFRESH_Msk & (_UINT32_(value) << OTPC_CR_REFRESH_Pos)) /* Assignment of value for REFRESH in the OTPC_CR register */
...
#define OTPC_CR_KEY(value)                    (OTPC_CR_KEY_Msk & (_UINT32_(value) << OTPC_CR_KEY_Pos)) /* Assignment of value for KEY in the OTPC_CR register */
...
#define OTPC_MR_UHCRRDIS(value)               (OTPC_MR_UHCRRDIS_Msk & (_UINT32_(value) << OTPC_MR_UHCRRDIS_Pos)) /* Assignment of value for UHCRRDIS in the OTPC_MR register */
...
#define OTPC_MR_NPCKT(value)                  (OTPC_MR_NPCKT_Msk & (_UINT32_(value) << OTPC_MR_NPCKT_Pos)) /* Assignment of value for NPCKT in the OTPC_MR register */
...
#define OTPC_MR_EMUL(value)                   (OTPC_MR_EMUL_Msk & (_UINT32_(value) << OTPC_MR_EMUL_Pos)) /* Assignment of value for EMUL in the OTPC_MR register */
...
#define OTPC_MR_RDDIS(value)                  (OTPC_MR_RDDIS_Msk & (_UINT32_(value) << OTPC_MR_RDDIS_Pos)) /* Assignment of value for RDDIS in the OTPC_MR register */
...
#define OTPC_MR_WRDIS(value)                  (OTPC_MR_WRDIS_Msk & (_UINT32_(value) << OTPC_MR_WRDIS_Pos)) /* Assignment of value for WRDIS in the OTPC_MR register */
...
#define OTPC_MR_KBDST(value)                  (OTPC_MR_KBDST_Msk & (_UINT32_(value) << OTPC_MR_KBDST_Pos)) /* Assignment of value for KBDST in the OTPC_MR register */
...
#define OTPC_MR_LOCK(value)                   (OTPC_MR_LOCK_Msk & (_UINT32_(value) << OTPC_MR_LOCK_Pos)) /* Assignment of value for LOCK in the OTPC_MR register */
...
#define OTPC_MR_ADDR(value)                   (OTPC_MR_ADDR_Msk & (_UINT32_(value) << OTPC_MR_ADDR_Pos)) /* Assignment of value for ADDR in the OTPC_MR register */
...
#define OTPC_AR_DADDR(value)                  (OTPC_AR_DADDR_Msk & (_UINT32_(value) << OTPC_AR_DADDR_Pos)) /* Assignment of value for DADDR in the OTPC_AR register */
...
#define OTPC_AR_INCRT(value)                  (OTPC_AR_INCRT_Msk & (_UINT32_(value) << OTPC_AR_INCRT_Pos)) /* Assignment of value for INCRT in the OTPC_AR register */
...
#define OTPC_SR_PGM(value)                    (OTPC_SR_PGM_Msk & (_UINT32_(value) << OTPC_SR_PGM_Pos)) /* Assignment of value for PGM in the OTPC_SR register */
...
#define OTPC_SR_LOCK(value)                   (OTPC_SR_LOCK_Msk & (_UINT32_(value) << OTPC_SR_LOCK_Pos)) /* Assignment of value for LOCK in the OTPC_SR register */
...
#define OTPC_SR_INVLD(value)                  (OTPC_SR_INVLD_Msk & (_UINT32_(value) << OTPC_SR_INVLD_Pos)) /* Assignment of value for INVLD in the OTPC_SR register */
...
#define OTPC_SR_EMUL(value)                   (OTPC_SR_EMUL_Msk & (_UINT32_(value) << OTPC_SR_EMUL_Pos)) /* Assignment of value for EMUL in the OTPC_SR register */
...
#define OTPC_SR_MKBB(value)                   (OTPC_SR_MKBB_Msk & (_UINT32_(value) << OTPC_SR_MKBB_Pos)) /* Assignment of value for MKBB in the OTPC_SR register */
...
#define OTPC_SR_SKBB(value)                   (OTPC_SR_SKBB_Msk & (_UINT32_(value) << OTPC_SR_SKBB_Pos)) /* Assignment of value for SKBB in the OTPC_SR register */
...
#define OTPC_SR_READ(value)                   (OTPC_SR_READ_Msk & (_UINT32_(value) << OTPC_SR_READ_Pos)) /* Assignment of value for READ in the OTPC_SR register */
...
#define OTPC_SR_FLUSH(value)                  (OTPC_SR_FLUSH_Msk & (_UINT32_(value) << OTPC_SR_FLUSH_Pos)) /* Assignment of value for FLUSH in the OTPC_SR register */
...
#define OTPC_SR_HIDE(value)                   (OTPC_SR_HIDE_Msk & (_UINT32_(value) << OTPC_SR_HIDE_Pos)) /* Assignment of value for HIDE in the OTPC_SR register */
...
#define OTPC_SR_ONEF(value)                   (OTPC_SR_ONEF_Msk & (_UINT32_(value) << OTPC_SR_ONEF_Pos)) /* Assignment of value for ONEF in the OTPC_SR register */
...
#define OTPC_IER_EOP(value)                   (OTPC_IER_EOP_Msk & (_UINT32_(value) << OTPC_IER_EOP_Pos)) /* Assignment of value for EOP in the OTPC_IER register */
...
#define OTPC_IER_EOL(value)                   (OTPC_IER_EOL_Msk & (_UINT32_(value) << OTPC_IER_EOL_Pos)) /* Assignment of value for EOL in the OTPC_IER register */
...
#define OTPC_IER_EOI(value)                   (OTPC_IER_EOI_Msk & (_UINT32_(value) << OTPC_IER_EOI_Pos)) /* Assignment of value for EOI in the OTPC_IER register */
...
#define OTPC_IER_EOKT(value)                  (OTPC_IER_EOKT_Msk & (_UINT32_(value) << OTPC_IER_EOKT_Pos)) /* Assignment of value for EOKT in the OTPC_IER register */
...
#define OTPC_IER_PGERR(value)                 (OTPC_IER_PGERR_Msk & (_UINT32_(value) << OTPC_IER_PGERR_Pos)) /* Assignment of value for PGERR in the OTPC_IER register */
...
#define OTPC_IER_LKERR(value)                 (OTPC_IER_LKERR_Msk & (_UINT32_(value) << OTPC_IER_LKERR_Pos)) /* Assignment of value for LKERR in the OTPC_IER register */
...
#define OTPC_IER_IVERR(value)                 (OTPC_IER_IVERR_Msk & (_UINT32_(value) << OTPC_IER_IVERR_Pos)) /* Assignment of value for IVERR in the OTPC_IER register */
...
#define OTPC_IER_WERR(value)                  (OTPC_IER_WERR_Msk & (_UINT32_(value) << OTPC_IER_WERR_Pos)) /* Assignment of value for WERR in the OTPC_IER register */
...
#define OTPC_IER_EOR(value)                   (OTPC_IER_EOR_Msk & (_UINT32_(value) << OTPC_IER_EOR_Pos)) /* Assignment of value for EOR in the OTPC_IER register */
...
#define OTPC_IER_EOF(value)                   (OTPC_IER_EOF_Msk & (_UINT32_(value) << OTPC_IER_EOF_Pos)) /* Assignment of value for EOF in the OTPC_IER register */
...
#define OTPC_IER_EOH(value)                   (OTPC_IER_EOH_Msk & (_UINT32_(value) << OTPC_IER_EOH_Pos)) /* Assignment of value for EOH in the OTPC_IER register */
...
#define OTPC_IER_EORF(value)                  (OTPC_IER_EORF_Msk & (_UINT32_(value) << OTPC_IER_EORF_Pos)) /* Assignment of value for EORF in the OTPC_IER register */
...
#define OTPC_IER_CKERR(value)                 (OTPC_IER_CKERR_Msk & (_UINT32_(value) << OTPC_IER_CKERR_Pos)) /* Assignment of value for CKERR in the OTPC_IER register */
...
#define OTPC_IER_COERR(value)                 (OTPC_IER_COERR_Msk & (_UINT32_(value) << OTPC_IER_COERR_Pos)) /* Assignment of value for COERR in the OTPC_IER register */
...
#define OTPC_IER_HDERR(value)                 (OTPC_IER_HDERR_Msk & (_UINT32_(value) << OTPC_IER_HDERR_Pos)) /* Assignment of value for HDERR in the OTPC_IER register */
...
#define OTPC_IER_KBERR(value)                 (OTPC_IER_KBERR_Msk & (_UINT32_(value) << OTPC_IER_KBERR_Pos)) /* Assignment of value for KBERR in the OTPC_IER register */
...
#define OTPC_IER_SECE(value)                  (OTPC_IER_SECE_Msk & (_UINT32_(value) << OTPC_IER_SECE_Pos)) /* Assignment of value for SECE in the OTPC_IER register */
...
#define OTPC_IDR_EOP(value)                   (OTPC_IDR_EOP_Msk & (_UINT32_(value) << OTPC_IDR_EOP_Pos)) /* Assignment of value for EOP in the OTPC_IDR register */
...
#define OTPC_IDR_EOL(value)                   (OTPC_IDR_EOL_Msk & (_UINT32_(value) << OTPC_IDR_EOL_Pos)) /* Assignment of value for EOL in the OTPC_IDR register */
...
#define OTPC_IDR_EOI(value)                   (OTPC_IDR_EOI_Msk & (_UINT32_(value) << OTPC_IDR_EOI_Pos)) /* Assignment of value for EOI in the OTPC_IDR register */
...
#define OTPC_IDR_EOKT(value)                  (OTPC_IDR_EOKT_Msk & (_UINT32_(value) << OTPC_IDR_EOKT_Pos)) /* Assignment of value for EOKT in the OTPC_IDR register */
...
#define OTPC_IDR_PGERR(value)                 (OTPC_IDR_PGERR_Msk & (_UINT32_(value) << OTPC_IDR_PGERR_Pos)) /* Assignment of value for PGERR in the OTPC_IDR register */
...
#define OTPC_IDR_LKERR(value)                 (OTPC_IDR_LKERR_Msk & (_UINT32_(value) << OTPC_IDR_LKERR_Pos)) /* Assignment of value for LKERR in the OTPC_IDR register */
...
#define OTPC_IDR_IVERR(value)                 (OTPC_IDR_IVERR_Msk & (_UINT32_(value) << OTPC_IDR_IVERR_Pos)) /* Assignment of value for IVERR in the OTPC_IDR register */
...
#define OTPC_IDR_WERR(value)                  (OTPC_IDR_WERR_Msk & (_UINT32_(value) << OTPC_IDR_WERR_Pos)) /* Assignment of value for WERR in the OTPC_IDR register */
...
#define OTPC_IDR_EOR(value)                   (OTPC_IDR_EOR_Msk & (_UINT32_(value) << OTPC_IDR_EOR_Pos)) /* Assignment of value for EOR in the OTPC_IDR register */
...
#define OTPC_IDR_EOF(value)                   (OTPC_IDR_EOF_Msk & (_UINT32_(value) << OTPC_IDR_EOF_Pos)) /* Assignment of value for EOF in the OTPC_IDR register */
...
#define OTPC_IDR_EOH(value)                   (OTPC_IDR_EOH_Msk & (_UINT32_(value) << OTPC_IDR_EOH_Pos)) /* Assignment of value for EOH in the OTPC_IDR register */
...
#define OTPC_IDR_EORF(value)                  (OTPC_IDR_EORF_Msk & (_UINT32_(value) << OTPC_IDR_EORF_Pos)) /* Assignment of value for EORF in the OTPC_IDR register */
...
#define OTPC_IDR_CKERR(value)                 (OTPC_IDR_CKERR_Msk & (_UINT32_(value) << OTPC_IDR_CKERR_Pos)) /* Assignment of value for CKERR in the OTPC_IDR register */
...
#define OTPC_IDR_COERR(value)                 (OTPC_IDR_COERR_Msk & (_UINT32_(value) << OTPC_IDR_COERR_Pos)) /* Assignment of value for COERR in the OTPC_IDR register */
...
#define OTPC_IDR_HDERR(value)                 (OTPC_IDR_HDERR_Msk & (_UINT32_(value) << OTPC_IDR_HDERR_Pos)) /* Assignment of value for HDERR in the OTPC_IDR register */
...
#define OTPC_IDR_KBERR(value)                 (OTPC_IDR_KBERR_Msk & (_UINT32_(value) << OTPC_IDR_KBERR_Pos)) /* Assignment of value for KBERR in the OTPC_IDR register */
...
#define OTPC_IDR_SECE(value)                  (OTPC_IDR_SECE_Msk & (_UINT32_(value) << OTPC_IDR_SECE_Pos)) /* Assignment of value for SECE in the OTPC_IDR register */
...
#define OTPC_IMR_EOP(value)                   (OTPC_IMR_EOP_Msk & (_UINT32_(value) << OTPC_IMR_EOP_Pos)) /* Assignment of value for EOP in the OTPC_IMR register */
...
#define OTPC_IMR_EOL(value)                   (OTPC_IMR_EOL_Msk & (_UINT32_(value) << OTPC_IMR_EOL_Pos)) /* Assignment of value for EOL in the OTPC_IMR register */
...
#define OTPC_IMR_EOI(value)                   (OTPC_IMR_EOI_Msk & (_UINT32_(value) << OTPC_IMR_EOI_Pos)) /* Assignment of value for EOI in the OTPC_IMR register */
...
#define OTPC_IMR_EOKT(value)                  (OTPC_IMR_EOKT_Msk & (_UINT32_(value) << OTPC_IMR_EOKT_Pos)) /* Assignment of value for EOKT in the OTPC_IMR register */
...
#define OTPC_IMR_PGERR(value)                 (OTPC_IMR_PGERR_Msk & (_UINT32_(value) << OTPC_IMR_PGERR_Pos)) /* Assignment of value for PGERR in the OTPC_IMR register */
...
#define OTPC_IMR_LKERR(value)                 (OTPC_IMR_LKERR_Msk & (_UINT32_(value) << OTPC_IMR_LKERR_Pos)) /* Assignment of value for LKERR in the OTPC_IMR register */
...
#define OTPC_IMR_IVERR(value)                 (OTPC_IMR_IVERR_Msk & (_UINT32_(value) << OTPC_IMR_IVERR_Pos)) /* Assignment of value for IVERR in the OTPC_IMR register */
...
#define OTPC_IMR_WERR(value)                  (OTPC_IMR_WERR_Msk & (_UINT32_(value) << OTPC_IMR_WERR_Pos)) /* Assignment of value for WERR in the OTPC_IMR register */
...
#define OTPC_IMR_EOR(value)                   (OTPC_IMR_EOR_Msk & (_UINT32_(value) << OTPC_IMR_EOR_Pos)) /* Assignment of value for EOR in the OTPC_IMR register */
...
#define OTPC_IMR_EOF(value)                   (OTPC_IMR_EOF_Msk & (_UINT32_(value) << OTPC_IMR_EOF_Pos)) /* Assignment of value for EOF in the OTPC_IMR register */
...
#define OTPC_IMR_EOH(value)                   (OTPC_IMR_EOH_Msk & (_UINT32_(value) << OTPC_IMR_EOH_Pos)) /* Assignment of value for EOH in the OTPC_IMR register */
...
#define OTPC_IMR_EORF(value)                  (OTPC_IMR_EORF_Msk & (_UINT32_(value) << OTPC_IMR_EORF_Pos)) /* Assignment of value for EORF in the OTPC_IMR register */
...
#define OTPC_IMR_CKERR(value)                 (OTPC_IMR_CKERR_Msk & (_UINT32_(value) << OTPC_IMR_CKERR_Pos)) /* Assignment of value for CKERR in the OTPC_IMR register */
...
#define OTPC_IMR_COERR(value)                 (OTPC_IMR_COERR_Msk & (_UINT32_(value) << OTPC_IMR_COERR_Pos)) /* Assignment of value for COERR in the OTPC_IMR register */
...
#define OTPC_IMR_HDERR(value)                 (OTPC_IMR_HDERR_Msk & (_UINT32_(value) << OTPC_IMR_HDERR_Pos)) /* Assignment of value for HDERR in the OTPC_IMR register */
...
#define OTPC_IMR_KBERR(value)                 (OTPC_IMR_KBERR_Msk & (_UINT32_(value) << OTPC_IMR_KBERR_Pos)) /* Assignment of value for KBERR in the OTPC_IMR register */
...
#define OTPC_IMR_SECE(value)                  (OTPC_IMR_SECE_Msk & (_UINT32_(value) << OTPC_IMR_SECE_Pos)) /* Assignment of value for SECE in the OTPC_IMR register */
...
#define OTPC_ISR_EOP(value)                   (OTPC_ISR_EOP_Msk & (_UINT32_(value) << OTPC_ISR_EOP_Pos)) /* Assignment of value for EOP in the OTPC_ISR register */
...
#define OTPC_ISR_EOL(value)                   (OTPC_ISR_EOL_Msk & (_UINT32_(value) << OTPC_ISR_EOL_Pos)) /* Assignment of value for EOL in the OTPC_ISR register */
...
#define OTPC_ISR_EOI(value)                   (OTPC_ISR_EOI_Msk & (_UINT32_(value) << OTPC_ISR_EOI_Pos)) /* Assignment of value for EOI in the OTPC_ISR register */
...
#define OTPC_ISR_EOKT(value)                  (OTPC_ISR_EOKT_Msk & (_UINT32_(value) << OTPC_ISR_EOKT_Pos)) /* Assignment of value for EOKT in the OTPC_ISR register */
...
#define OTPC_ISR_PGERR(value)                 (OTPC_ISR_PGERR_Msk & (_UINT32_(value) << OTPC_ISR_PGERR_Pos)) /* Assignment of value for PGERR in the OTPC_ISR register */
...
#define OTPC_ISR_LKERR(value)                 (OTPC_ISR_LKERR_Msk & (_UINT32_(value) << OTPC_ISR_LKERR_Pos)) /* Assignment of value for LKERR in the OTPC_ISR register */
...
#define OTPC_ISR_IVERR(value)                 (OTPC_ISR_IVERR_Msk & (_UINT32_(value) << OTPC_ISR_IVERR_Pos)) /* Assignment of value for IVERR in the OTPC_ISR register */
...
#define OTPC_ISR_WERR(value)                  (OTPC_ISR_WERR_Msk & (_UINT32_(value) << OTPC_ISR_WERR_Pos)) /* Assignment of value for WERR in the OTPC_ISR register */
...
#define OTPC_ISR_EOR(value)                   (OTPC_ISR_EOR_Msk & (_UINT32_(value) << OTPC_ISR_EOR_Pos)) /* Assignment of value for EOR in the OTPC_ISR register */
...
#define OTPC_ISR_EOF(value)                   (OTPC_ISR_EOF_Msk & (_UINT32_(value) << OTPC_ISR_EOF_Pos)) /* Assignment of value for EOF in the OTPC_ISR register */
...
#define OTPC_ISR_EOH(value)                   (OTPC_ISR_EOH_Msk & (_UINT32_(value) << OTPC_ISR_EOH_Pos)) /* Assignment of value for EOH in the OTPC_ISR register */
...
#define OTPC_ISR_EORF(value)                  (OTPC_ISR_EORF_Msk & (_UINT32_(value) << OTPC_ISR_EORF_Pos)) /* Assignment of value for EORF in the OTPC_ISR register */
...
#define OTPC_ISR_CKERR(value)                 (OTPC_ISR_CKERR_Msk & (_UINT32_(value) << OTPC_ISR_CKERR_Pos)) /* Assignment of value for CKERR in the OTPC_ISR register */
...
#define OTPC_ISR_COERR(value)                 (OTPC_ISR_COERR_Msk & (_UINT32_(value) << OTPC_ISR_COERR_Pos)) /* Assignment of value for COERR in the OTPC_ISR register */
...
#define OTPC_ISR_HDERR(value)                 (OTPC_ISR_HDERR_Msk & (_UINT32_(value) << OTPC_ISR_HDERR_Pos)) /* Assignment of value for HDERR in the OTPC_ISR register */
...
#define OTPC_ISR_KBERR(value)                 (OTPC_ISR_KBERR_Msk & (_UINT32_(value) << OTPC_ISR_KBERR_Pos)) /* Assignment of value for KBERR in the OTPC_ISR register */
...
#define OTPC_HR_PACKET(value)                 (OTPC_HR_PACKET_Msk & (_UINT32_(value) << OTPC_HR_PACKET_Pos)) /* Assignment of value for PACKET in the OTPC_HR register */
...
#define OTPC_HR_LOCK(value)                   (OTPC_HR_LOCK_Msk & (_UINT32_(value) << OTPC_HR_LOCK_Pos)) /* Assignment of value for LOCK in the OTPC_HR register */
...
#define OTPC_HR_INVLD(value)                  (OTPC_HR_INVLD_Msk & (_UINT32_(value) << OTPC_HR_INVLD_Pos)) /* Assignment of value for INVLD in the OTPC_HR register */
...
#define OTPC_HR_SECURE(value)                 (OTPC_HR_SECURE_Msk & (_UINT32_(value) << OTPC_HR_SECURE_Pos)) /* Assignment of value for SECURE in the OTPC_HR register */
...
#define OTPC_HR_ONE(value)                    (OTPC_HR_ONE_Msk & (_UINT32_(value) << OTPC_HR_ONE_Pos)) /* Assignment of value for ONE in the OTPC_HR register */
...
#define OTPC_HR_SIZE(value)                   (OTPC_HR_SIZE_Msk & (_UINT32_(value) << OTPC_HR_SIZE_Pos)) /* Assignment of value for SIZE in the OTPC_HR register */
...
#define OTPC_HR_CHECKSUM(value)               (OTPC_HR_CHECKSUM_Msk & (_UINT32_(value) << OTPC_HR_CHECKSUM_Pos)) /* Assignment of value for CHECKSUM in the OTPC_HR register */
...
#define OTPC_DR_DATA(value)                   (OTPC_DR_DATA_Msk & (_UINT32_(value) << OTPC_DR_DATA_Pos)) /* Assignment of value for DATA in the OTPC_DR register */
...
#define OTPC_BAR_BCADDR(value)                (OTPC_BAR_BCADDR_Msk & (_UINT32_(value) << OTPC_BAR_BCADDR_Pos)) /* Assignment of value for BCADDR in the OTPC_BAR register */
...
#define OTPC_BAR_SBCADDR(value)               (OTPC_BAR_SBCADDR_Msk & (_UINT32_(value) << OTPC_BAR_SBCADDR_Pos)) /* Assignment of value for SBCADDR in the OTPC_BAR register */
...
#define OTPC_CAR_CADDR(value)                 (OTPC_CAR_CADDR_Msk & (_UINT32_(value) << OTPC_CAR_CADDR_Pos)) /* Assignment of value for CADDR in the OTPC_CAR register */
...
#define OTPC_SCAR_SCADDR(value)               (OTPC_SCAR_SCADDR_Msk & (_UINT32_(value) << OTPC_SCAR_SCADDR_Pos)) /* Assignment of value for SCADDR in the OTPC_SCAR register */
...
#define OTPC_UHC0R_JTAGDIS(value)             (OTPC_UHC0R_JTAGDIS_Msk & (_UINT32_(value) << OTPC_UHC0R_JTAGDIS_Pos)) /* Assignment of value for JTAGDIS in the OTPC_UHC0R register */
...
#define OTPC_UHC0R_SECDBG(value)              (OTPC_UHC0R_SECDBG_Msk & (_UINT32_(value) << OTPC_UHC0R_SECDBG_Pos)) /* Assignment of value for SECDBG in the OTPC_UHC0R register */
...
#define OTPC_UHC1R_URDDIS(value)              (OTPC_UHC1R_URDDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_URDDIS_Pos)) /* Assignment of value for URDDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_UPGDIS(value)              (OTPC_UHC1R_UPGDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_UPGDIS_Pos)) /* Assignment of value for UPGDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_UHCINVDIS(value)           (OTPC_UHC1R_UHCINVDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_UHCINVDIS_Pos)) /* Assignment of value for UHCINVDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_UHCLKDIS(value)            (OTPC_UHC1R_UHCLKDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_UHCLKDIS_Pos)) /* Assignment of value for UHCLKDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_UHCPGDIS(value)            (OTPC_UHC1R_UHCPGDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_UHCPGDIS_Pos)) /* Assignment of value for UHCPGDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_BCINVDIS(value)            (OTPC_UHC1R_BCINVDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_BCINVDIS_Pos)) /* Assignment of value for BCINVDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_BCLKDIS(value)             (OTPC_UHC1R_BCLKDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_BCLKDIS_Pos)) /* Assignment of value for BCLKDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_BCPGDIS(value)             (OTPC_UHC1R_BCPGDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_BCPGDIS_Pos)) /* Assignment of value for BCPGDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_SBCINVDIS(value)           (OTPC_UHC1R_SBCINVDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_SBCINVDIS_Pos)) /* Assignment of value for SBCINVDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_SBCLKDIS(value)            (OTPC_UHC1R_SBCLKDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_SBCLKDIS_Pos)) /* Assignment of value for SBCLKDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_SBCPGDIS(value)            (OTPC_UHC1R_SBCPGDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_SBCPGDIS_Pos)) /* Assignment of value for SBCPGDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_SCINVDIS(value)            (OTPC_UHC1R_SCINVDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_SCINVDIS_Pos)) /* Assignment of value for SCINVDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_SCLKDIS(value)             (OTPC_UHC1R_SCLKDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_SCLKDIS_Pos)) /* Assignment of value for SCLKDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_SCPGDIS(value)             (OTPC_UHC1R_SCPGDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_SCPGDIS_Pos)) /* Assignment of value for SCPGDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_CINVDIS(value)             (OTPC_UHC1R_CINVDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_CINVDIS_Pos)) /* Assignment of value for CINVDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_CLKDIS(value)              (OTPC_UHC1R_CLKDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_CLKDIS_Pos)) /* Assignment of value for CLKDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_CPGDIS(value)              (OTPC_UHC1R_CPGDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_CPGDIS_Pos)) /* Assignment of value for CPGDIS in the OTPC_UHC1R register */
...
#define OTPC_UHC1R_URFDIS(value)              (OTPC_UHC1R_URFDIS_Msk & (_UINT32_(value) << OTPC_UHC1R_URFDIS_Pos)) /* Assignment of value for URFDIS in the OTPC_UHC1R register */
...
#define OTPC_UID0R_UID(value)                 (OTPC_UID0R_UID_Msk & (_UINT32_(value) << OTPC_UID0R_UID_Pos)) /* Assignment of value for UID in the OTPC_UID0R register */
...
#define OTPC_UID1R_UID(value)                 (OTPC_UID1R_UID_Msk & (_UINT32_(value) << OTPC_UID1R_UID_Pos)) /* Assignment of value for UID in the OTPC_UID1R register */
...
#define OTPC_UID2R_UID(value)                 (OTPC_UID2R_UID_Msk & (_UINT32_(value) << OTPC_UID2R_UID_Pos)) /* Assignment of value for UID in the OTPC_UID2R register */
...
#define OTPC_UID3R_UID(value)                 (OTPC_UID3R_UID_Msk & (_UINT32_(value) << OTPC_UID3R_UID_Pos)) /* Assignment of value for UID in the OTPC_UID3R register */
...
#define OTPC_WPMR_WPCFEN(value)               (OTPC_WPMR_WPCFEN_Msk & (_UINT32_(value) << OTPC_WPMR_WPCFEN_Pos)) /* Assignment of value for WPCFEN in the OTPC_WPMR register */
...
#define OTPC_WPMR_WPITEN(value)               (OTPC_WPMR_WPITEN_Msk & (_UINT32_(value) << OTPC_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the OTPC_WPMR register */
...
#define OTPC_WPMR_WPCTEN(value)               (OTPC_WPMR_WPCTEN_Msk & (_UINT32_(value) << OTPC_WPMR_WPCTEN_Pos)) /* Assignment of value for WPCTEN in the OTPC_WPMR register */
...
#define OTPC_WPMR_FIRSTE(value)               (OTPC_WPMR_FIRSTE_Msk & (_UINT32_(value) << OTPC_WPMR_FIRSTE_Pos)) /* Assignment of value for FIRSTE in the OTPC_WPMR register */
...
#define OTPC_WPMR_WPKEY(value)                (OTPC_WPMR_WPKEY_Msk & (_UINT32_(value) << OTPC_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the OTPC_WPMR register */
...
#define OTPC_WPSR_WPVS(value)                 (OTPC_WPSR_WPVS_Msk & (_UINT32_(value) << OTPC_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the OTPC_WPSR register */
...
#define OTPC_WPSR_CGD(value)                  (OTPC_WPSR_CGD_Msk & (_UINT32_(value) << OTPC_WPSR_CGD_Pos)) /* Assignment of value for CGD in the OTPC_WPSR register */
...
#define OTPC_WPSR_SEQE(value)                 (OTPC_WPSR_SEQE_Msk & (_UINT32_(value) << OTPC_WPSR_SEQE_Pos)) /* Assignment of value for SEQE in the OTPC_WPSR register */
...
#define OTPC_WPSR_SWE(value)                  (OTPC_WPSR_SWE_Msk & (_UINT32_(value) << OTPC_WPSR_SWE_Pos)) /* Assignment of value for SWE in the OTPC_WPSR register */
...
#define OTPC_WPSR_WPVSRC(value)               (OTPC_WPSR_WPVSRC_Msk & (_UINT32_(value) << OTPC_WPSR_WPVSRC_Pos)) /* Assignment of value for WPVSRC in the OTPC_WPSR register */
...
#define OTPC_WPSR_SWETYP(value)               (OTPC_WPSR_SWETYP_Msk & (_UINT32_(value) << OTPC_WPSR_SWETYP_Pos)) /* Assignment of value for SWETYP in the OTPC_WPSR register */
...
/* OTPC register offsets definitions */
...
#endif /* _SAMA7G5_OTPC_COMPONENT_H_ */
