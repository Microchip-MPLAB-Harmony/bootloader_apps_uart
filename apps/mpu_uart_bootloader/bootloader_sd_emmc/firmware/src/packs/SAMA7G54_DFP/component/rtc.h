...
#ifndef _SAMA7G5_RTC_COMPONENT_H_
#define _SAMA7G5_RTC_COMPONENT_H_
...
#define RTC_CALR_RESETVALUE                   _UINT32_(0x1E11220)                                  /*  (RTC_CALR) Calendar Register  Reset Value */
...
#define RTC_TSSR0_DWDTSW(value)               (RTC_TSSR0_DWDTSW_Msk & (_UINT32_(value) << RTC_TSSR0_DWDTSW_Pos)) /* Assignment of value for DWDTSW in the RTC_TSSR0 register */
...
#define RTC_TSSR0_TST(value)                  (RTC_TSSR0_TST_Msk & (_UINT32_(value) << RTC_TSSR0_TST_Pos)) /* Assignment of value for TST in the RTC_TSSR0 register */
...
#define RTC_TSSR0_JTAG(value)                 (RTC_TSSR0_JTAG_Msk & (_UINT32_(value) << RTC_TSSR0_JTAG_Pos)) /* Assignment of value for JTAG in the RTC_TSSR0 register */
...
#define RTC_TSSR1_DWDTSW(value)               (RTC_TSSR1_DWDTSW_Msk & (_UINT32_(value) << RTC_TSSR1_DWDTSW_Pos)) /* Assignment of value for DWDTSW in the RTC_TSSR1 register */
...
#define RTC_TSSR1_TST(value)                  (RTC_TSSR1_TST_Msk & (_UINT32_(value) << RTC_TSSR1_TST_Pos)) /* Assignment of value for TST in the RTC_TSSR1 register */
...
#define RTC_TSSR1_JTAG(value)                 (RTC_TSSR1_JTAG_Msk & (_UINT32_(value) << RTC_TSSR1_JTAG_Pos)) /* Assignment of value for JTAG in the RTC_TSSR1 register */
...
#endif /* _SAMA7G5_RTC_COMPONENT_H_ */
