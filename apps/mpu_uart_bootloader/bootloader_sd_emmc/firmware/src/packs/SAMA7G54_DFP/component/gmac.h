...
#ifndef _SAMA7G5_GMAC_COMPONENT_H_
#define _SAMA7G5_GMAC_COMPONENT_H_
...
#define GMAC_NCR_MIIONRGMII(value)            (GMAC_NCR_MIIONRGMII_Msk & (_UINT32_(value) << GMAC_NCR_MIIONRGMII_Pos)) /* Assignment of value for MIIONRGMII in the GMAC_NCR register */
...
#define GMAC_NSR_SB_PEND_XFER(value)          (GMAC_NSR_SB_PEND_XFER_Msk & (_UINT32_(value) << GMAC_NSR_SB_PEND_XFER_Pos)) /* Assignment of value for SB_PEND_XFER in the GMAC_NSR register */
...
#define   GMAC_UR_MIM_MII_Val                 _UINT32_(0x0)                                        /* (GMAC_UR) Selects the MII mode when GMAC_NCR.MIIONRGMII=1  */
#define   GMAC_UR_MIM_RMII_Val                _UINT32_(0x1)                                        /* (GMAC_UR) Selects the RMII mode when GMAC_NCR.MIIONRGMII=0  */
#define   GMAC_UR_MIM_RGMII_Val               _UINT32_(0x2)                                        /* (GMAC_UR) Selects the RGMII mode when GMAC_NCR.MIIONRGMII=0  */
#define GMAC_UR_MIM_MII                       (GMAC_UR_MIM_MII_Val << GMAC_UR_MIM_Pos)             /* (GMAC_UR) Selects the MII mode when GMAC_NCR.MIIONRGMII=1 Position */
#define GMAC_UR_MIM_RMII                      (GMAC_UR_MIM_RMII_Val << GMAC_UR_MIM_Pos)            /* (GMAC_UR) Selects the RMII mode when GMAC_NCR.MIIONRGMII=0 Position */
#define GMAC_UR_MIM_RGMII                     (GMAC_UR_MIM_RGMII_Val << GMAC_UR_MIM_Pos)           /* (GMAC_UR) Selects the RGMII mode when GMAC_NCR.MIIONRGMII=0 Position */
...
#define GMAC_DCFGR_Msk                        _UINT32_(0x31FF3FDF)                                 /* (GMAC_DCFGR) Register Mask  */
...
#define GMAC_TSR_Msk                          _UINT32_(0x000001BF)                                 /* (GMAC_TSR) Register Mask  */
...
#define GMAC_AMP_AR2R_MAX_PIPELINE(value)     (GMAC_AMP_AR2R_MAX_PIPELINE_Msk & (_UINT32_(value) << GMAC_AMP_AR2R_MAX_PIPELINE_Pos)) /* Assignment of value for AR2R_MAX_PIPELINE in the GMAC_AMP register */
...
#define GMAC_AMP_AW2W_MAX_PIPELINE(value)     (GMAC_AMP_AW2W_MAX_PIPELINE_Msk & (_UINT32_(value) << GMAC_AMP_AW2W_MAX_PIPELINE_Pos)) /* Assignment of value for AW2W_MAX_PIPELINE in the GMAC_AMP register */
...
#define GMAC_AMP_USE_FROM(value)              (GMAC_AMP_USE_FROM_Msk & (_UINT32_(value) << GMAC_AMP_USE_FROM_Pos)) /* Assignment of value for USE_FROM in the GMAC_AMP register */
...
#define GMAC_TXPQUANT1_QUANT_P2(value)        (GMAC_TXPQUANT1_QUANT_P2_Msk & (_UINT32_(value) << GMAC_TXPQUANT1_QUANT_P2_Pos)) /* Assignment of value for QUANT_P2 in the GMAC_TXPQUANT1 register */
...
#define GMAC_TXPQUANT1_QUANT_P3(value)        (GMAC_TXPQUANT1_QUANT_P3_Msk & (_UINT32_(value) << GMAC_TXPQUANT1_QUANT_P3_Pos)) /* Assignment of value for QUANT_P3 in the GMAC_TXPQUANT1 register */
...
#define GMAC_TXPQUANT2_QUANT_P4(value)        (GMAC_TXPQUANT2_QUANT_P4_Msk & (_UINT32_(value) << GMAC_TXPQUANT2_QUANT_P4_Pos)) /* Assignment of value for QUANT_P4 in the GMAC_TXPQUANT2 register */
...
#define GMAC_TXPQUANT2_QUANT_P5(value)        (GMAC_TXPQUANT2_QUANT_P5_Msk & (_UINT32_(value) << GMAC_TXPQUANT2_QUANT_P5_Pos)) /* Assignment of value for QUANT_P5 in the GMAC_TXPQUANT2 register */
...
#define GMAC_TXPQUANT3_QUANT_P6(value)        (GMAC_TXPQUANT3_QUANT_P6_Msk & (_UINT32_(value) << GMAC_TXPQUANT3_QUANT_P6_Pos)) /* Assignment of value for QUANT_P6 in the GMAC_TXPQUANT3 register */
...
#define GMAC_TXPQUANT3_QUANT_P7(value)        (GMAC_TXPQUANT3_QUANT_P7_Msk & (_UINT32_(value) << GMAC_TXPQUANT3_QUANT_P7_Pos)) /* Assignment of value for QUANT_P7 in the GMAC_TXPQUANT3 register */
...
#define GMAC_QOS_CFG0_Q0_DATA(value)          (GMAC_QOS_CFG0_Q0_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q0_DATA_Pos)) /* Assignment of value for Q0_DATA in the GMAC_QOS_CFG0 register */
...
#define GMAC_QOS_CFG0_Q0_DESCR(value)         (GMAC_QOS_CFG0_Q0_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q0_DESCR_Pos)) /* Assignment of value for Q0_DESCR in the GMAC_QOS_CFG0 register */
...
#define GMAC_QOS_CFG0_Q1_DATA(value)          (GMAC_QOS_CFG0_Q1_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q1_DATA_Pos)) /* Assignment of value for Q1_DATA in the GMAC_QOS_CFG0 register */
...
#define GMAC_QOS_CFG0_Q1_DESCR(value)         (GMAC_QOS_CFG0_Q1_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q1_DESCR_Pos)) /* Assignment of value for Q1_DESCR in the GMAC_QOS_CFG0 register */
...
#define GMAC_QOS_CFG0_Q2_DATA(value)          (GMAC_QOS_CFG0_Q2_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q2_DATA_Pos)) /* Assignment of value for Q2_DATA in the GMAC_QOS_CFG0 register */
...
#define GMAC_QOS_CFG0_Q2_DESCR(value)         (GMAC_QOS_CFG0_Q2_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q2_DESCR_Pos)) /* Assignment of value for Q2_DESCR in the GMAC_QOS_CFG0 register */
...
#define GMAC_QOS_CFG0_Q3_DATA(value)          (GMAC_QOS_CFG0_Q3_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q3_DATA_Pos)) /* Assignment of value for Q3_DATA in the GMAC_QOS_CFG0 register */
...
#define GMAC_QOS_CFG0_Q3_DESCR(value)         (GMAC_QOS_CFG0_Q3_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG0_Q3_DESCR_Pos)) /* Assignment of value for Q3_DESCR in the GMAC_QOS_CFG0 register */
...
#define GMAC_QOS_CFG1_Q5_DATA(value)          (GMAC_QOS_CFG1_Q5_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG1_Q5_DATA_Pos)) /* Assignment of value for Q5_DATA in the GMAC_QOS_CFG1 register */
...
#define GMAC_QOS_CFG1_Q5_DESCR(value)         (GMAC_QOS_CFG1_Q5_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG1_Q5_DESCR_Pos)) /* Assignment of value for Q5_DESCR in the GMAC_QOS_CFG1 register */
...
#define GMAC_QOS_CFG1_Q6_DATA(value)          (GMAC_QOS_CFG1_Q6_DATA_Msk & (_UINT32_(value) << GMAC_QOS_CFG1_Q6_DATA_Pos)) /* Assignment of value for Q6_DATA in the GMAC_QOS_CFG1 register */
...
#define GMAC_QOS_CFG1_Q6_DESCR(value)         (GMAC_QOS_CFG1_Q6_DESCR_Msk & (_UINT32_(value) << GMAC_QOS_CFG1_Q6_DESCR_Pos)) /* Assignment of value for Q6_DESCR in the GMAC_QOS_CFG1 register */
...
#define GMAC_TQBWRL1_ALLOCQ4(value)           (GMAC_TQBWRL1_ALLOCQ4_Msk & (_UINT32_(value) << GMAC_TQBWRL1_ALLOCQ4_Pos)) /* Assignment of value for ALLOCQ4 in the GMAC_TQBWRL1 register */
...
#define GMAC_TQBWRL1_ALLOCQ5(value)           (GMAC_TQBWRL1_ALLOCQ5_Msk & (_UINT32_(value) << GMAC_TQBWRL1_ALLOCQ5_Pos)) /* Assignment of value for ALLOCQ5 in the GMAC_TQBWRL1 register */
