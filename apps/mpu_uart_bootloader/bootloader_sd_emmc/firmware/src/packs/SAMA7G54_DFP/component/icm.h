...
#ifndef _SAMA7G5_ICM_COMPONENT_H_
#define _SAMA7G5_ICM_COMPONENT_H_
...
#define ICM_RADDR_RADDR(value)                (ICM_RADDR_RADDR_Msk & (_UINT32_(value) << ICM_RADDR_RADDR_Pos)) /* Assignment of value for RADDR in the ICM_RADDR register */
...
#define ICM_RNEXT_NEXT(value)                 (ICM_RNEXT_NEXT_Msk & (_UINT32_(value) << ICM_RNEXT_NEXT_Pos)) /* Assignment of value for NEXT in the ICM_RNEXT register */
...
#define ICM_WPMR_WPEN(value)                  (ICM_WPMR_WPEN_Msk & (_UINT32_(value) << ICM_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the ICM_WPMR register */
...
#define ICM_WPMR_WPITEN(value)                (ICM_WPMR_WPITEN_Msk & (_UINT32_(value) << ICM_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the ICM_WPMR register */
...
#define ICM_WPMR_WPCREN(value)                (ICM_WPMR_WPCREN_Msk & (_UINT32_(value) << ICM_WPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the ICM_WPMR register */
...
#define ICM_WPMR_WPKEY(value)                 (ICM_WPMR_WPKEY_Msk & (_UINT32_(value) << ICM_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the ICM_WPMR register */
...
#define ICM_WPSR_WPVS(value)                  (ICM_WPSR_WPVS_Msk & (_UINT32_(value) << ICM_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the ICM_WPSR register */
...
#define ICM_WPSR_WPVSRC(value)                (ICM_WPSR_WPVSRC_Msk & (_UINT32_(value) << ICM_WPSR_WPVSRC_Pos)) /* Assignment of value for WPVSRC in the ICM_WPSR register */
...
/* ICM_DSC register API structure */
typedef struct
...
#endif /* _SAMA7G5_ICM_COMPONENT_H_ */
