...
#ifndef _SAMA7G5_TCPC_COMPONENT_H_
#define _SAMA7G5_TCPC_COMPONENT_H_
...
#define TCPC_VID_RESETVALUE                   _UINT16_(0xBBBB)                                     /*  (TCPC_VID) Vendor ID Register  Reset Value */
...
#define TCPC_VID_VID(value)                   (TCPC_VID_VID_Msk & (_UINT16_(value) << TCPC_VID_VID_Pos)) /* Assignment of value for VID in the TCPC_VID register */
#define TCPC_VID_Msk                          _UINT16_(0xFFFF)                                     /* (TCPC_VID) Register Mask  */


/* -------- TCPC_PID : (TCPC Offset: 0x02) ( R/ 16) Product ID Register -------- */
#define TCPC_PID_RESETVALUE                   _UINT16_(0xCCCC)                                     /*  (TCPC_PID) Product ID Register  Reset Value */
...
#define TCPC_PID_PID(value)                   (TCPC_PID_PID_Msk & (_UINT16_(value) << TCPC_PID_PID_Pos)) /* Assignment of value for PID in the TCPC_PID register */
#define TCPC_PID_Msk                          _UINT16_(0xFFFF)                                     /* (TCPC_PID) Register Mask  */


/* -------- TCPC_DID : (TCPC Offset: 0x04) ( R/ 16) Device ID Register -------- */
#define TCPC_DID_RESETVALUE                   _UINT16_(0xDDDD)                                     /*  (TCPC_DID) Device ID Register  Reset Value */
...
#define TCPC_DID_DID(value)                   (TCPC_DID_DID_Msk & (_UINT16_(value) << TCPC_DID_DID_Pos)) /* Assignment of value for DID in the TCPC_DID register */
#define TCPC_DID_Msk                          _UINT16_(0xFFFF)                                     /* (TCPC_DID) Register Mask  */


/* -------- TCPC_UTCR : (TCPC Offset: 0x06) ( R/ 16) USB Type-C Rev Register -------- */
#define TCPC_UTCR_RESETVALUE                  _UINT16_(0xAAAA)                                     /*  (TCPC_UTCR) USB Type-C Rev Register  Reset Value */
...
#define TCPC_UTCR_UTCR(value)                 (TCPC_UTCR_UTCR_Msk & (_UINT16_(value) << TCPC_UTCR_UTCR_Pos)) /* Assignment of value for UTCR in the TCPC_UTCR register */
...
#define TCPC_UPDR_UPDR(value)                 (TCPC_UPDR_UPDR_Msk & (_UINT16_(value) << TCPC_UPDR_UPDR_Pos)) /* Assignment of value for UPDR in the TCPC_UPDR register */
...
#define TCPC_PDIR_PDIR(value)                 (TCPC_PDIR_PDIR_Msk & (_UINT16_(value) << TCPC_PDIR_PDIR_Pos)) /* Assignment of value for PDIR in the TCPC_PDIR register */
...
#define TCPC_AL_CCS(value)                    (TCPC_AL_CCS_Msk & (_UINT16_(value) << TCPC_AL_CCS_Pos)) /* Assignment of value for CCS in the TCPC_AL register */
...
#define TCPC_AL_PWRS(value)                   (TCPC_AL_PWRS_Msk & (_UINT16_(value) << TCPC_AL_PWRS_Pos)) /* Assignment of value for PWRS in the TCPC_AL register */
...
#define TCPC_AL_VBUSHI(value)                 (TCPC_AL_VBUSHI_Msk & (_UINT16_(value) << TCPC_AL_VBUSHI_Pos)) /* Assignment of value for VBUSHI in the TCPC_AL register */
...
#define TCPC_AL_VBUSLO(value)                 (TCPC_AL_VBUSLO_Msk & (_UINT16_(value) << TCPC_AL_VBUSLO_Pos)) /* Assignment of value for VBUSLO in the TCPC_AL register */
...
#define TCPC_AL_FLT(value)                    (TCPC_AL_FLT_Msk & (_UINT16_(value) << TCPC_AL_FLT_Pos)) /* Assignment of value for FLT in the TCPC_AL register */
...
#define TCPC_AL_VBUSSNKDS(value)              (TCPC_AL_VBUSSNKDS_Msk & (_UINT16_(value) << TCPC_AL_VBUSSNKDS_Pos)) /* Assignment of value for VBUSSNKDS in the TCPC_AL register */
...
#define TCPC_AL_VDA(value)                    (TCPC_AL_VDA_Msk & (_UINT16_(value) << TCPC_AL_VDA_Pos)) /* Assignment of value for VDA in the TCPC_AL register */
...
#define TCPC_ALM_CCS(value)                   (TCPC_ALM_CCS_Msk & (_UINT16_(value) << TCPC_ALM_CCS_Pos)) /* Assignment of value for CCS in the TCPC_ALM register */
...
#define TCPC_ALM_PWRS(value)                  (TCPC_ALM_PWRS_Msk & (_UINT16_(value) << TCPC_ALM_PWRS_Pos)) /* Assignment of value for PWRS in the TCPC_ALM register */
...
#define TCPC_ALM_VBUSHI(value)                (TCPC_ALM_VBUSHI_Msk & (_UINT16_(value) << TCPC_ALM_VBUSHI_Pos)) /* Assignment of value for VBUSHI in the TCPC_ALM register */
...
#define TCPC_ALM_VBUSLO(value)                (TCPC_ALM_VBUSLO_Msk & (_UINT16_(value) << TCPC_ALM_VBUSLO_Pos)) /* Assignment of value for VBUSLO in the TCPC_ALM register */
...
#define TCPC_ALM_FLT(value)                   (TCPC_ALM_FLT_Msk & (_UINT16_(value) << TCPC_ALM_FLT_Pos)) /* Assignment of value for FLT in the TCPC_ALM register */
...
#define TCPC_ALM_VBUSSNKDS(value)             (TCPC_ALM_VBUSSNKDS_Msk & (_UINT16_(value) << TCPC_ALM_VBUSSNKDS_Pos)) /* Assignment of value for VBUSSNKDS in the TCPC_ALM register */
...
#define TCPC_ALM_VDA(value)                   (TCPC_ALM_VDA_Msk & (_UINT16_(value) << TCPC_ALM_VDA_Pos)) /* Assignment of value for VDA in the TCPC_ALM register */
...
#define TCPC_PSM_SNKVBUS(value)               (TCPC_PSM_SNKVBUS_Msk & (_UINT8_(value) << TCPC_PSM_SNKVBUS_Pos)) /* Assignment of value for SNKVBUS in the TCPC_PSM register */
...
#define TCPC_PSM_VBUS(value)                  (TCPC_PSM_VBUS_Msk & (_UINT8_(value) << TCPC_PSM_VBUS_Pos)) /* Assignment of value for VBUS in the TCPC_PSM register */
...
#define TCPC_PSM_VBUSDETE(value)              (TCPC_PSM_VBUSDETE_Msk & (_UINT8_(value) << TCPC_PSM_VBUSDETE_Pos)) /* Assignment of value for VBUSDETE in the TCPC_PSM register */
...
#define TCPC_PSM_SRCVBUS(value)               (TCPC_PSM_SRCVBUS_Msk & (_UINT8_(value) << TCPC_PSM_SRCVBUS_Pos)) /* Assignment of value for SRCVBUS in the TCPC_PSM register */
...
#define TCPC_PSM_INIT(value)                  (TCPC_PSM_INIT_Msk & (_UINT8_(value) << TCPC_PSM_INIT_Pos)) /* Assignment of value for INIT in the TCPC_PSM register */
...
#define TCPC_FSM_VBUSOVPF(value)              (TCPC_FSM_VBUSOVPF_Msk & (_UINT8_(value) << TCPC_FSM_VBUSOVPF_Pos)) /* Assignment of value for VBUSOVPF in the TCPC_FSM register */
...
#define TCPC_FSM_VBUSOCPF(value)              (TCPC_FSM_VBUSOCPF_Msk & (_UINT8_(value) << TCPC_FSM_VBUSOCPF_Pos)) /* Assignment of value for VBUSOCPF in the TCPC_FSM register */
...
#define TCPC_FSM_FRCDCHF(value)               (TCPC_FSM_FRCDCHF_Msk & (_UINT8_(value) << TCPC_FSM_FRCDCHF_Pos)) /* Assignment of value for FRCDCHF in the TCPC_FSM register */
...
#define TCPC_FSM_AUTDCHF(value)               (TCPC_FSM_AUTDCHF_Msk & (_UINT8_(value) << TCPC_FSM_AUTDCHF_Pos)) /* Assignment of value for AUTDCHF in the TCPC_FSM register */
...
#define TCPC_FSM_FRCOFVBUS(value)             (TCPC_FSM_FRCOFVBUS_Msk & (_UINT8_(value) << TCPC_FSM_FRCOFVBUS_Pos)) /* Assignment of value for FRCOFVBUS in the TCPC_FSM register */
...
#define TCPC_FSM_ALLREGRES(value)             (TCPC_FSM_ALLREGRES_Msk & (_UINT8_(value) << TCPC_FSM_ALLREGRES_Pos)) /* Assignment of value for ALLREGRES in the TCPC_FSM register */
...
#define TCPC_CSO_COR(value)                   (TCPC_CSO_COR_Msk & (_UINT8_(value) << TCPC_CSO_COR_Pos)) /* Assignment of value for COR in the TCPC_CSO register */
...
#define TCPC_CSO_CNX(value)                   (TCPC_CSO_CNX_Msk & (_UINT8_(value) << TCPC_CSO_CNX_Pos)) /* Assignment of value for CNX in the TCPC_CSO register */
...
#define TCPC_RCTL_CC1(value)                  (TCPC_RCTL_CC1_Msk & (_UINT8_(value) << TCPC_RCTL_CC1_Pos)) /* Assignment of value for CC1 in the TCPC_RCTL register */
...
#define TCPC_RCTL_CC2(value)                  (TCPC_RCTL_CC2_Msk & (_UINT8_(value) << TCPC_RCTL_CC2_Pos)) /* Assignment of value for CC2 in the TCPC_RCTL register */
...
#define TCPC_RCTL_RP(value)                   (TCPC_RCTL_RP_Msk & (_UINT8_(value) << TCPC_RCTL_RP_Pos)) /* Assignment of value for RP in the TCPC_RCTL register */
...
#define TCPC_RCTL_DRP(value)                  (TCPC_RCTL_DRP_Msk & (_UINT8_(value) << TCPC_RCTL_DRP_Pos)) /* Assignment of value for DRP in the TCPC_RCTL register */
...
#define TCPC_FCTL_VBUSOVPF(value)             (TCPC_FCTL_VBUSOVPF_Msk & (_UINT8_(value) << TCPC_FCTL_VBUSOVPF_Pos)) /* Assignment of value for VBUSOVPF in the TCPC_FCTL register */
...
#define TCPC_FCTL_VBUSOCPF(value)             (TCPC_FCTL_VBUSOCPF_Msk & (_UINT8_(value) << TCPC_FCTL_VBUSOCPF_Pos)) /* Assignment of value for VBUSOCPF in the TCPC_FCTL register */
...
#define TCPC_FCTL_FRCOFVBUS(value)            (TCPC_FCTL_FRCOFVBUS_Msk & (_UINT8_(value) << TCPC_FCTL_FRCOFVBUS_Pos)) /* Assignment of value for FRCOFVBUS in the TCPC_FCTL register */
...
#define TCPC_CCS_LK4CNX(value)                (TCPC_CCS_LK4CNX_Msk & (_UINT8_(value) << TCPC_CCS_LK4CNX_Pos)) /* Assignment of value for LK4CNX in the TCPC_CCS register */
...
#define TCPC_PS_SNKVBUS(value)                (TCPC_PS_SNKVBUS_Msk & (_UINT8_(value) << TCPC_PS_SNKVBUS_Pos)) /* Assignment of value for SNKVBUS in the TCPC_PS register */
...
#define TCPC_PS_VCONN(value)                  (TCPC_PS_VCONN_Msk & (_UINT8_(value) << TCPC_PS_VCONN_Pos)) /* Assignment of value for VCONN in the TCPC_PS register */
...
#define TCPC_PS_VBUS(value)                   (TCPC_PS_VBUS_Msk & (_UINT8_(value) << TCPC_PS_VBUS_Pos)) /* Assignment of value for VBUS in the TCPC_PS register */
...
#define TCPC_PS_VBUSDETE(value)               (TCPC_PS_VBUSDETE_Msk & (_UINT8_(value) << TCPC_PS_VBUSDETE_Pos)) /* Assignment of value for VBUSDETE in the TCPC_PS register */
...
#define TCPC_PS_SRCVBUS(value)                (TCPC_PS_SRCVBUS_Msk & (_UINT8_(value) << TCPC_PS_SRCVBUS_Pos)) /* Assignment of value for SRCVBUS in the TCPC_PS register */
...
#define TCPC_PS_SRCHIV(value)                 (TCPC_PS_SRCHIV_Msk & (_UINT8_(value) << TCPC_PS_SRCHIV_Pos)) /* Assignment of value for SRCHIV in the TCPC_PS register */
...
#define TCPC_PS_INIT(value)                   (TCPC_PS_INIT_Msk & (_UINT8_(value) << TCPC_PS_INIT_Pos)) /* Assignment of value for INIT in the TCPC_PS register */
...
#define TCPC_PS_DBG(value)                    (TCPC_PS_DBG_Msk & (_UINT8_(value) << TCPC_PS_DBG_Pos)) /* Assignment of value for DBG in the TCPC_PS register */
...
#define TCPC_FS_VBUSOVPF(value)               (TCPC_FS_VBUSOVPF_Msk & (_UINT8_(value) << TCPC_FS_VBUSOVPF_Pos)) /* Assignment of value for VBUSOVPF in the TCPC_FS register */
...
#define TCPC_FS_VBUSOCPF(value)               (TCPC_FS_VBUSOCPF_Msk & (_UINT8_(value) << TCPC_FS_VBUSOCPF_Pos)) /* Assignment of value for VBUSOCPF in the TCPC_FS register */
...
#define TCPC_FS_FRCOFVBUS(value)              (TCPC_FS_FRCOFVBUS_Msk & (_UINT8_(value) << TCPC_FS_FRCOFVBUS_Pos)) /* Assignment of value for FRCOFVBUS in the TCPC_FS register */
...
#define TCPC_FS_ALLREGRES(value)              (TCPC_FS_ALLREGRES_Msk & (_UINT8_(value) << TCPC_FS_ALLREGRES_Pos)) /* Assignment of value for ALLREGRES in the TCPC_FS register */
...
#define TCPC_CMD_COMMAND(value)               (TCPC_CMD_COMMAND_Msk & (_UINT8_(value) << TCPC_CMD_COMMAND_Pos)) /* Assignment of value for COMMAND in the TCPC_CMD register */
...
#define TCPC_DCP1_SRCVBUS(value)              (TCPC_DCP1_SRCVBUS_Msk & (_UINT16_(value) << TCPC_DCP1_SRCVBUS_Pos)) /* Assignment of value for SRCVBUS in the TCPC_DCP1 register */
...
#define TCPC_DCP1_SRCHVBUS(value)             (TCPC_DCP1_SRCHVBUS_Msk & (_UINT16_(value) << TCPC_DCP1_SRCHVBUS_Pos)) /* Assignment of value for SRCHVBUS in the TCPC_DCP1 register */
...
#define TCPC_DCP1_SNKVBUS(value)              (TCPC_DCP1_SNKVBUS_Msk & (_UINT16_(value) << TCPC_DCP1_SNKVBUS_Pos)) /* Assignment of value for SNKVBUS in the TCPC_DCP1 register */
...
#define TCPC_DCP1_SRCVCN(value)               (TCPC_DCP1_SRCVCN_Msk & (_UINT16_(value) << TCPC_DCP1_SRCVCN_Pos)) /* Assignment of value for SRCVCN in the TCPC_DCP1 register */
...
#define TCPC_DCP1_SOPDBG(value)               (TCPC_DCP1_SOPDBG_Msk & (_UINT16_(value) << TCPC_DCP1_SOPDBG_Pos)) /* Assignment of value for SOPDBG in the TCPC_DCP1 register */
...
#define TCPC_DCP1_ROLES(value)                (TCPC_DCP1_ROLES_Msk & (_UINT16_(value) << TCPC_DCP1_ROLES_Pos)) /* Assignment of value for ROLES in the TCPC_DCP1 register */
...
#define TCPC_DCP1_SRCRES(value)               (TCPC_DCP1_SRCRES_Msk & (_UINT16_(value) << TCPC_DCP1_SRCRES_Pos)) /* Assignment of value for SRCRES in the TCPC_DCP1 register */
...
#define TCPC_DCP1_VBUSMSRAL(value)            (TCPC_DCP1_VBUSMSRAL_Msk & (_UINT16_(value) << TCPC_DCP1_VBUSMSRAL_Pos)) /* Assignment of value for VBUSMSRAL in the TCPC_DCP1 register */
...
#define TCPC_DCP1_FRCDCH(value)               (TCPC_DCP1_FRCDCH_Msk & (_UINT16_(value) << TCPC_DCP1_FRCDCH_Pos)) /* Assignment of value for FRCDCH in the TCPC_DCP1 register */
...
#define TCPC_DCP1_BLDDCH(value)               (TCPC_DCP1_BLDDCH_Msk & (_UINT16_(value) << TCPC_DCP1_BLDDCH_Pos)) /* Assignment of value for BLDDCH in the TCPC_DCP1 register */
...
#define TCPC_DCP1_VBUSOVPR(value)             (TCPC_DCP1_VBUSOVPR_Msk & (_UINT16_(value) << TCPC_DCP1_VBUSOVPR_Pos)) /* Assignment of value for VBUSOVPR in the TCPC_DCP1 register */
...
#define TCPC_DCP1_VBUSOCPR(value)             (TCPC_DCP1_VBUSOCPR_Msk & (_UINT16_(value) << TCPC_DCP1_VBUSOCPR_Pos)) /* Assignment of value for VBUSOCPR in the TCPC_DCP1 register */
...
#define TCPC_DCP2_VCOFC(value)                (TCPC_DCP2_VCOFC_Msk & (_UINT16_(value) << TCPC_DCP2_VCOFC_Pos)) /* Assignment of value for VCOFC in the TCPC_DCP2 register */
...
#define TCPC_DCP2_VCPSP(value)                (TCPC_DCP2_VCPSP_Msk & (_UINT16_(value) << TCPC_DCP2_VCPSP_Pos)) /* Assignment of value for VCPSP in the TCPC_DCP2 register */
...
#define TCPC_DCP2_VBUSVALSB(value)            (TCPC_DCP2_VBUSVALSB_Msk & (_UINT16_(value) << TCPC_DCP2_VBUSVALSB_Pos)) /* Assignment of value for VBUSVALSB in the TCPC_DCP2 register */
...
#define TCPC_DCP2_STPDSCHTH(value)            (TCPC_DCP2_STPDSCHTH_Msk & (_UINT16_(value) << TCPC_DCP2_STPDSCHTH_Pos)) /* Assignment of value for STPDSCHTH in the TCPC_DCP2 register */
...
#define TCPC_DCP2_SKDSCDET(value)             (TCPC_DCP2_SKDSCDET_Msk & (_UINT16_(value) << TCPC_DCP2_SKDSCDET_Pos)) /* Assignment of value for SKDSCDET in the TCPC_DCP2 register */
...
#define TCPC_DCP2_WDTMR(value)                (TCPC_DCP2_WDTMR_Msk & (_UINT16_(value) << TCPC_DCP2_WDTMR_Pos)) /* Assignment of value for WDTMR in the TCPC_DCP2 register */
...
#define TCPC_SIC_FOFVBUS(value)               (TCPC_SIC_FOFVBUS_Msk & (_UINT8_(value) << TCPC_SIC_FOFVBUS_Pos)) /* Assignment of value for FOFVBUS in the TCPC_SIC register */
...
#define TCPC_SIC_VBUSEOCF(value)              (TCPC_SIC_VBUSEOCF_Msk & (_UINT8_(value) << TCPC_SIC_VBUSEOCF_Pos)) /* Assignment of value for VBUSEOCF in the TCPC_SIC register */
...
#define TCPC_SIC_VBUSEOVF(value)              (TCPC_SIC_VBUSEOVF_Msk & (_UINT8_(value) << TCPC_SIC_VBUSEOVF_Pos)) /* Assignment of value for VBUSEOVF in the TCPC_SIC register */
...
#define TCPC_SOC_CNROR(value)                 (TCPC_SOC_CNROR_Msk & (_UINT8_(value) << TCPC_SOC_CNROR_Pos)) /* Assignment of value for CNROR in the TCPC_SOC register */
...
#define TCPC_SOC_CNXPR(value)                 (TCPC_SOC_CNXPR_Msk & (_UINT8_(value) << TCPC_SOC_CNXPR_Pos)) /* Assignment of value for CNXPR in the TCPC_SOC register */
...
#define TCPC_SOC_MXCFGCTL(value)              (TCPC_SOC_MXCFGCTL_Msk & (_UINT8_(value) << TCPC_SOC_MXCFGCTL_Pos)) /* Assignment of value for MXCFGCTL in the TCPC_SOC register */
...
#define TCPC_SOC_ACI(value)                   (TCPC_SOC_ACI_Msk & (_UINT8_(value) << TCPC_SOC_ACI_Pos)) /* Assignment of value for ACI in the TCPC_SOC register */
...
#define TCPC_SOC_AAAI(value)                  (TCPC_SOC_AAAI_Msk & (_UINT8_(value) << TCPC_SOC_AAAI_Pos)) /* Assignment of value for AAAI in the TCPC_SOC register */
...
#define TCPC_SOC_VBUSPM(value)                (TCPC_SOC_VBUSPM_Msk & (_UINT8_(value) << TCPC_SOC_VBUSPM_Pos)) /* Assignment of value for VBUSPM in the TCPC_SOC register */
...
#define TCPC_SOC_DBGAI(value)                 (TCPC_SOC_DBGAI_Msk & (_UINT8_(value) << TCPC_SOC_DBGAI_Pos)) /* Assignment of value for DBGAI in the TCPC_SOC register */
...
#define TCPC_CR_SWRST(value)                  (TCPC_CR_SWRST_Msk & (_UINT32_(value) << TCPC_CR_SWRST_Pos)) /* Assignment of value for SWRST in the TCPC_CR register */
...
#define TCPC_CR_WAKEY(value)                  (TCPC_CR_WAKEY_Msk & (_UINT32_(value) << TCPC_CR_WAKEY_Pos)) /* Assignment of value for WAKEY in the TCPC_CR register */
...
#define TCPC_SSR_CC_STATUS(value)             (TCPC_SSR_CC_STATUS_Msk & (_UINT32_(value) << TCPC_SSR_CC_STATUS_Pos)) /* Assignment of value for CC_STATUS in the TCPC_SSR register */
...
#define TCPC_SSR_POWER_STATUS(value)          (TCPC_SSR_POWER_STATUS_Msk & (_UINT32_(value) << TCPC_SSR_POWER_STATUS_Pos)) /* Assignment of value for POWER_STATUS in the TCPC_SSR register */
...
#define TCPC_SSR_FAULT_STATUS(value)          (TCPC_SSR_FAULT_STATUS_Msk & (_UINT32_(value) << TCPC_SSR_FAULT_STATUS_Pos)) /* Assignment of value for FAULT_STATUS in the TCPC_SSR register */
...
#define TCPC_CSR_CC_STATUS(value)             (TCPC_CSR_CC_STATUS_Msk & (_UINT32_(value) << TCPC_CSR_CC_STATUS_Pos)) /* Assignment of value for CC_STATUS in the TCPC_CSR register */
...
#define TCPC_CSR_POWER_STATUS(value)          (TCPC_CSR_POWER_STATUS_Msk & (_UINT32_(value) << TCPC_CSR_POWER_STATUS_Pos)) /* Assignment of value for POWER_STATUS in the TCPC_CSR register */
...
#define TCPC_SAR_ALERT(value)                 (TCPC_SAR_ALERT_Msk & (_UINT32_(value) << TCPC_SAR_ALERT_Pos)) /* Assignment of value for ALERT in the TCPC_SAR register */
...
#define TCPC_UPC_TCIDCTSEL(value)             (TCPC_UPC_TCIDCTSEL_Msk & (_UINT32_(value) << TCPC_UPC_TCIDCTSEL_Pos)) /* Assignment of value for TCIDCTSEL in the TCPC_UPC register */
#define   TCPC_UPC_TCIDCTSEL_THRESHOLD_0_Val  _UINT32_(0x0)                                        /* (TCPC_UPC) Type-C cell power down  */
#define   TCPC_UPC_TCIDCTSEL_THRESHOLD_2_Val  _UINT32_(0x2)                                        /* (TCPC_UPC) Type-C VRa Threshold  */
#define   TCPC_UPC_TCIDCTSEL_THRESHOLD_4_Val  _UINT32_(0x4)                                        /* (TCPC_UPC) Type-C VRd-USB Threshold  */
#define   TCPC_UPC_TCIDCTSEL_THRESHOLD_6_Val  _UINT32_(0x6)                                        /* (TCPC_UPC) Type-C VRd-1.5 Threshold, Type-C VRd Threshold  */
...
#define TCPC_UPC_RDIPSEL(value)               (TCPC_UPC_RDIPSEL_Msk & (_UINT32_(value) << TCPC_UPC_RDIPSEL_Pos)) /* Assignment of value for RDIPSEL in the TCPC_UPC register */
...
#define TCPC_UPC_DMPDFD(value)                (TCPC_UPC_DMPDFD_Msk & (_UINT32_(value) << TCPC_UPC_DMPDFD_Pos)) /* Assignment of value for DMPDFD in the TCPC_UPC register */
...
#define TCPC_UPC_DMPDFE(value)                (TCPC_UPC_DMPDFE_Msk & (_UINT32_(value) << TCPC_UPC_DMPDFE_Pos)) /* Assignment of value for DMPDFE in the TCPC_UPC register */
...
#define TCPC_UPC_BCIDPSRCE(value)             (TCPC_UPC_BCIDPSRCE_Msk & (_UINT32_(value) << TCPC_UPC_BCIDPSRCE_Pos)) /* Assignment of value for BCIDPSRCE in the TCPC_UPC register */
...
#define TCPC_UPC_BCDETSEL(value)              (TCPC_UPC_BCDETSEL_Msk & (_UINT32_(value) << TCPC_UPC_BCDETSEL_Pos)) /* Assignment of value for BCDETSEL in the TCPC_UPC register */
...
#define TCPC_UPC_BCVSRCE(value)               (TCPC_UPC_BCVSRCE_Msk & (_UINT32_(value) << TCPC_UPC_BCVSRCE_Pos)) /* Assignment of value for BCVSRCE in the TCPC_UPC register */
...
#define TCPC_UPC_BCDETE(value)                (TCPC_UPC_BCDETE_Msk & (_UINT32_(value) << TCPC_UPC_BCDETE_Pos)) /* Assignment of value for BCDETE in the TCPC_UPC register */
...
#define TCPC_UPS_DP(value)                    (TCPC_UPS_DP_Msk & (_UINT32_(value) << TCPC_UPS_DP_Pos)) /* Assignment of value for DP in the TCPC_UPS register */
...
#define TCPC_UPS_DM(value)                    (TCPC_UPS_DM_Msk & (_UINT32_(value) << TCPC_UPS_DM_Pos)) /* Assignment of value for DM in the TCPC_UPS register */
...
#define TCPC_UPS_CHGDCP(value)                (TCPC_UPS_CHGDCP_Msk & (_UINT32_(value) << TCPC_UPS_CHGDCP_Pos)) /* Assignment of value for CHGDCP in the TCPC_UPS register */
...
#define TCPC_UPS_CC1ID(value)                 (TCPC_UPS_CC1ID_Msk & (_UINT32_(value) << TCPC_UPS_CC1ID_Pos)) /* Assignment of value for CC1ID in the TCPC_UPS register */
#define   TCPC_UPS_CC1ID_0_Val                _UINT32_(0x0)                                        /* (TCPC_UPS) CC1 output is low. Voltage is below the selected TCPC_UPC.TCIDCTSEL threshold for Power Source Detection at Sink and is above the selected TCPC_UPC.TCIDCTSEL threshold for Sink Detection at Power Source.  */
#define   TCPC_UPS_CC1ID_1_Val                _UINT32_(0x1)                                        /* (TCPC_UPS) CC1 output is high. Voltage is above the selected TCPC_UPC.TCIDCTSEL threshold for Power Source Detection at Sink and is below the selected TCPC_UPC.TCIDCTSEL threshold for Sink Detection at Power Source.  */
#define TCPC_UPS_CC1ID_0                      (TCPC_UPS_CC1ID_0_Val << TCPC_UPS_CC1ID_Pos)         /* (TCPC_UPS) CC1 output is low. Voltage is below the selected TCPC_UPC.TCIDCTSEL threshold for Power Source Detection at Sink and is above the selected TCPC_UPC.TCIDCTSEL threshold for Sink Detection at Power Source. Position */
#define TCPC_UPS_CC1ID_1                      (TCPC_UPS_CC1ID_1_Val << TCPC_UPS_CC1ID_Pos)         /* (TCPC_UPS) CC1 output is high. Voltage is above the selected TCPC_UPC.TCIDCTSEL threshold for Power Source Detection at Sink and is below the selected TCPC_UPC.TCIDCTSEL threshold for Sink Detection at Power Source. Position */
...
#define TCPC_UPS_CC2RDT(value)                (TCPC_UPS_CC2RDT_Msk & (_UINT32_(value) << TCPC_UPS_CC2RDT_Pos)) /* Assignment of value for CC2RDT in the TCPC_UPS register */
#define   TCPC_UPS_CC2RDT_0_Val               _UINT32_(0x0)                                        /* (TCPC_UPS) CC2 output is low. Voltage is below the selected TCUPC.TCIDCTSEL threshold for Power Source Detection at Sink and is above the selected TCPC_UPC.TCIDCTSEL threshold for Sink Detection at Power Source.  */
#define   TCPC_UPS_CC2RDT_1_Val               _UINT32_(0x1)                                        /* (TCPC_UPS) CC2 output is high. Voltage is above the selected TCUPC.TCIDCTSEL threshold for Power Source Detection at Sink and is below the selected TCPC_UPC.TCIDCTSEL threshold for Sink Detection at Power Source.  */
#define TCPC_UPS_CC2RDT_0                     (TCPC_UPS_CC2RDT_0_Val << TCPC_UPS_CC2RDT_Pos)       /* (TCPC_UPS) CC2 output is low. Voltage is below the selected TCUPC.TCIDCTSEL threshold for Power Source Detection at Sink and is above the selected TCPC_UPC.TCIDCTSEL threshold for Sink Detection at Power Source. Position */
#define TCPC_UPS_CC2RDT_1                     (TCPC_UPS_CC2RDT_1_Val << TCPC_UPS_CC2RDT_Pos)       /* (TCPC_UPS) CC2 output is high. Voltage is above the selected TCUPC.TCIDCTSEL threshold for Power Source Detection at Sink and is below the selected TCPC_UPC.TCIDCTSEL threshold for Sink Detection at Power Source. Position */
#define TCPC_UPS_Msk                          _UINT32_(0x0000001F)                                 /* (TCPC_UPS) Register Mask  */


/* TCPC register offsets definitions */
...
#endif /* _SAMA7G5_TCPC_COMPONENT_H_ */
