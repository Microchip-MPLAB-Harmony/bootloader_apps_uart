...
#define HSMC_SETUP_NWE_SETUP(value)           (HSMC_SETUP_NWE_SETUP_Msk & (_UINT32_(value) << HSMC_SETUP_NWE_SETUP_Pos)) /* Assignment of value for NWE_SETUP in the HSMC_SETUP register */
...
#define HSMC_SETUP_NCS_WR_SETUP(value)        (HSMC_SETUP_NCS_WR_SETUP_Msk & (_UINT32_(value) << HSMC_SETUP_NCS_WR_SETUP_Pos)) /* Assignment of value for NCS_WR_SETUP in the HSMC_SETUP register */
...
#define HSMC_SETUP_NRD_SETUP(value)           (HSMC_SETUP_NRD_SETUP_Msk & (_UINT32_(value) << HSMC_SETUP_NRD_SETUP_Pos)) /* Assignment of value for NRD_SETUP in the HSMC_SETUP register */
...
#define HSMC_SETUP_NCS_RD_SETUP(value)        (HSMC_SETUP_NCS_RD_SETUP_Msk & (_UINT32_(value) << HSMC_SETUP_NCS_RD_SETUP_Pos)) /* Assignment of value for NCS_RD_SETUP in the HSMC_SETUP register */
...
#define HSMC_PULSE_NWE_PULSE(value)           (HSMC_PULSE_NWE_PULSE_Msk & (_UINT32_(value) << HSMC_PULSE_NWE_PULSE_Pos)) /* Assignment of value for NWE_PULSE in the HSMC_PULSE register */
...
#define HSMC_PULSE_NCS_WR_PULSE(value)        (HSMC_PULSE_NCS_WR_PULSE_Msk & (_UINT32_(value) << HSMC_PULSE_NCS_WR_PULSE_Pos)) /* Assignment of value for NCS_WR_PULSE in the HSMC_PULSE register */
...
#define HSMC_PULSE_NRD_PULSE(value)           (HSMC_PULSE_NRD_PULSE_Msk & (_UINT32_(value) << HSMC_PULSE_NRD_PULSE_Pos)) /* Assignment of value for NRD_PULSE in the HSMC_PULSE register */
...
#define HSMC_PULSE_NCS_RD_PULSE(value)        (HSMC_PULSE_NCS_RD_PULSE_Msk & (_UINT32_(value) << HSMC_PULSE_NCS_RD_PULSE_Pos)) /* Assignment of value for NCS_RD_PULSE in the HSMC_PULSE register */
...
#define HSMC_CYCLE_NWE_CYCLE(value)           (HSMC_CYCLE_NWE_CYCLE_Msk & (_UINT32_(value) << HSMC_CYCLE_NWE_CYCLE_Pos)) /* Assignment of value for NWE_CYCLE in the HSMC_CYCLE register */
...
#define HSMC_CYCLE_NRD_CYCLE(value)           (HSMC_CYCLE_NRD_CYCLE_Msk & (_UINT32_(value) << HSMC_CYCLE_NRD_CYCLE_Pos)) /* Assignment of value for NRD_CYCLE in the HSMC_CYCLE register */
...
#define HSMC_TIMINGS_TCLR(value)              (HSMC_TIMINGS_TCLR_Msk & (_UINT32_(value) << HSMC_TIMINGS_TCLR_Pos)) /* Assignment of value for TCLR in the HSMC_TIMINGS register */
...
#define HSMC_TIMINGS_TADL(value)              (HSMC_TIMINGS_TADL_Msk & (_UINT32_(value) << HSMC_TIMINGS_TADL_Pos)) /* Assignment of value for TADL in the HSMC_TIMINGS register */
...
#define HSMC_TIMINGS_TAR(value)               (HSMC_TIMINGS_TAR_Msk & (_UINT32_(value) << HSMC_TIMINGS_TAR_Pos)) /* Assignment of value for TAR in the HSMC_TIMINGS register */
...
#define HSMC_TIMINGS_OCMS(value)              (HSMC_TIMINGS_OCMS_Msk & (_UINT32_(value) << HSMC_TIMINGS_OCMS_Pos)) /* Assignment of value for OCMS in the HSMC_TIMINGS register */
...
#define HSMC_TIMINGS_TRR(value)               (HSMC_TIMINGS_TRR_Msk & (_UINT32_(value) << HSMC_TIMINGS_TRR_Pos)) /* Assignment of value for TRR in the HSMC_TIMINGS register */
...
#define HSMC_TIMINGS_TWB(value)               (HSMC_TIMINGS_TWB_Msk & (_UINT32_(value) << HSMC_TIMINGS_TWB_Pos)) /* Assignment of value for TWB in the HSMC_TIMINGS register */
...
#define HSMC_TIMINGS_NFSEL(value)             (HSMC_TIMINGS_NFSEL_Msk & (_UINT32_(value) << HSMC_TIMINGS_NFSEL_Pos)) /* Assignment of value for NFSEL in the HSMC_TIMINGS register */
...
#define HSMC_MODE_READ_MODE(value)            (HSMC_MODE_READ_MODE_Msk & (_UINT32_(value) << HSMC_MODE_READ_MODE_Pos)) /* Assignment of value for READ_MODE in the HSMC_MODE register */
...
#define HSMC_MODE_WRITE_MODE(value)           (HSMC_MODE_WRITE_MODE_Msk & (_UINT32_(value) << HSMC_MODE_WRITE_MODE_Pos)) /* Assignment of value for WRITE_MODE in the HSMC_MODE register */
...
#define HSMC_MODE_EXNW_MODE(value)            (HSMC_MODE_EXNW_MODE_Msk & (_UINT32_(value) << HSMC_MODE_EXNW_MODE_Pos)) /* Assignment of value for EXNW_MODE in the HSMC_MODE register */
...
#define HSMC_MODE_BAT(value)                  (HSMC_MODE_BAT_Msk & (_UINT32_(value) << HSMC_MODE_BAT_Pos)) /* Assignment of value for BAT in the HSMC_MODE register */
...
#define HSMC_MODE_DBW(value)                  (HSMC_MODE_DBW_Msk & (_UINT32_(value) << HSMC_MODE_DBW_Pos)) /* Assignment of value for DBW in the HSMC_MODE register */
...
#define HSMC_MODE_TDF_CYCLES(value)           (HSMC_MODE_TDF_CYCLES_Msk & (_UINT32_(value) << HSMC_MODE_TDF_CYCLES_Pos)) /* Assignment of value for TDF_CYCLES in the HSMC_MODE register */
...
#define HSMC_MODE_TDF_MODE(value)             (HSMC_MODE_TDF_MODE_Msk & (_UINT32_(value) << HSMC_MODE_TDF_MODE_Pos)) /* Assignment of value for TDF_MODE in the HSMC_MODE register */
...
#define HSMC_PMECC_ECC(value)                 (HSMC_PMECC_ECC_Msk & (_UINT32_(value) << HSMC_PMECC_ECC_Pos)) /* Assignment of value for ECC in the HSMC_PMECC register */
...
#define HSMC_REM_REM2NP1(value)               (HSMC_REM_REM2NP1_Msk & (_UINT32_(value) << HSMC_REM_REM2NP1_Pos)) /* Assignment of value for REM2NP1 in the HSMC_REM register */
...
#define HSMC_REM_REM2NP3(value)               (HSMC_REM_REM2NP3_Msk & (_UINT32_(value) << HSMC_REM_REM2NP3_Pos)) /* Assignment of value for REM2NP3 in the HSMC_REM register */
...
#define HSMC_CFG_PAGESIZE(value)              (HSMC_CFG_PAGESIZE_Msk & (_UINT32_(value) << HSMC_CFG_PAGESIZE_Pos)) /* Assignment of value for PAGESIZE in the HSMC_CFG register */
...
#define HSMC_CFG_WSPARE(value)                (HSMC_CFG_WSPARE_Msk & (_UINT32_(value) << HSMC_CFG_WSPARE_Pos)) /* Assignment of value for WSPARE in the HSMC_CFG register */
...
#define HSMC_CFG_RSPARE(value)                (HSMC_CFG_RSPARE_Msk & (_UINT32_(value) << HSMC_CFG_RSPARE_Pos)) /* Assignment of value for RSPARE in the HSMC_CFG register */
...
#define HSMC_CFG_EDGECTRL(value)              (HSMC_CFG_EDGECTRL_Msk & (_UINT32_(value) << HSMC_CFG_EDGECTRL_Pos)) /* Assignment of value for EDGECTRL in the HSMC_CFG register */
...
#define HSMC_CFG_RBEDGE(value)                (HSMC_CFG_RBEDGE_Msk & (_UINT32_(value) << HSMC_CFG_RBEDGE_Pos)) /* Assignment of value for RBEDGE in the HSMC_CFG register */
...
#define HSMC_CFG_DTOCYC(value)                (HSMC_CFG_DTOCYC_Msk & (_UINT32_(value) << HSMC_CFG_DTOCYC_Pos)) /* Assignment of value for DTOCYC in the HSMC_CFG register */
...
#define HSMC_CFG_DTOMUL(value)                (HSMC_CFG_DTOMUL_Msk & (_UINT32_(value) << HSMC_CFG_DTOMUL_Pos)) /* Assignment of value for DTOMUL in the HSMC_CFG register */
...
#define HSMC_CFG_NFCSPARESIZE(value)          (HSMC_CFG_NFCSPARESIZE_Msk & (_UINT32_(value) << HSMC_CFG_NFCSPARESIZE_Pos)) /* Assignment of value for NFCSPARESIZE in the HSMC_CFG register */
...
#define HSMC_CTRL_NFCEN(value)                (HSMC_CTRL_NFCEN_Msk & (_UINT32_(value) << HSMC_CTRL_NFCEN_Pos)) /* Assignment of value for NFCEN in the HSMC_CTRL register */
...
#define HSMC_CTRL_NFCDIS(value)               (HSMC_CTRL_NFCDIS_Msk & (_UINT32_(value) << HSMC_CTRL_NFCDIS_Pos)) /* Assignment of value for NFCDIS in the HSMC_CTRL register */
...
#define HSMC_SR_SMCSTS(value)                 (HSMC_SR_SMCSTS_Msk & (_UINT32_(value) << HSMC_SR_SMCSTS_Pos)) /* Assignment of value for SMCSTS in the HSMC_SR register */
...
#define HSMC_SR_RB_RISE(value)                (HSMC_SR_RB_RISE_Msk & (_UINT32_(value) << HSMC_SR_RB_RISE_Pos)) /* Assignment of value for RB_RISE in the HSMC_SR register */
...
#define HSMC_SR_RB_FALL(value)                (HSMC_SR_RB_FALL_Msk & (_UINT32_(value) << HSMC_SR_RB_FALL_Pos)) /* Assignment of value for RB_FALL in the HSMC_SR register */
...
#define HSMC_SR_NFCBUSY(value)                (HSMC_SR_NFCBUSY_Msk & (_UINT32_(value) << HSMC_SR_NFCBUSY_Pos)) /* Assignment of value for NFCBUSY in the HSMC_SR register */
...
#define HSMC_SR_NFCWR(value)                  (HSMC_SR_NFCWR_Msk & (_UINT32_(value) << HSMC_SR_NFCWR_Pos)) /* Assignment of value for NFCWR in the HSMC_SR register */
...
#define HSMC_SR_NFCSID(value)                 (HSMC_SR_NFCSID_Msk & (_UINT32_(value) << HSMC_SR_NFCSID_Pos)) /* Assignment of value for NFCSID in the HSMC_SR register */
...
#define HSMC_SR_XFRDONE(value)                (HSMC_SR_XFRDONE_Msk & (_UINT32_(value) << HSMC_SR_XFRDONE_Pos)) /* Assignment of value for XFRDONE in the HSMC_SR register */
...
#define HSMC_SR_CMDDONE(value)                (HSMC_SR_CMDDONE_Msk & (_UINT32_(value) << HSMC_SR_CMDDONE_Pos)) /* Assignment of value for CMDDONE in the HSMC_SR register */
...
#define HSMC_SR_DTOE(value)                   (HSMC_SR_DTOE_Msk & (_UINT32_(value) << HSMC_SR_DTOE_Pos)) /* Assignment of value for DTOE in the HSMC_SR register */
...
#define HSMC_SR_UNDEF(value)                  (HSMC_SR_UNDEF_Msk & (_UINT32_(value) << HSMC_SR_UNDEF_Pos)) /* Assignment of value for UNDEF in the HSMC_SR register */
...
#define HSMC_SR_AWB(value)                    (HSMC_SR_AWB_Msk & (_UINT32_(value) << HSMC_SR_AWB_Pos)) /* Assignment of value for AWB in the HSMC_SR register */
...
#define HSMC_SR_NFCASE(value)                 (HSMC_SR_NFCASE_Msk & (_UINT32_(value) << HSMC_SR_NFCASE_Pos)) /* Assignment of value for NFCASE in the HSMC_SR register */
...
#define HSMC_SR_RB_EDGE0(value)               (HSMC_SR_RB_EDGE0_Msk & (_UINT32_(value) << HSMC_SR_RB_EDGE0_Pos)) /* Assignment of value for RB_EDGE0 in the HSMC_SR register */
...
#define HSMC_IER_RB_RISE(value)               (HSMC_IER_RB_RISE_Msk & (_UINT32_(value) << HSMC_IER_RB_RISE_Pos)) /* Assignment of value for RB_RISE in the HSMC_IER register */
...
#define HSMC_IER_RB_FALL(value)               (HSMC_IER_RB_FALL_Msk & (_UINT32_(value) << HSMC_IER_RB_FALL_Pos)) /* Assignment of value for RB_FALL in the HSMC_IER register */
...
#define HSMC_IER_XFRDONE(value)               (HSMC_IER_XFRDONE_Msk & (_UINT32_(value) << HSMC_IER_XFRDONE_Pos)) /* Assignment of value for XFRDONE in the HSMC_IER register */
...
#define HSMC_IER_CMDDONE(value)               (HSMC_IER_CMDDONE_Msk & (_UINT32_(value) << HSMC_IER_CMDDONE_Pos)) /* Assignment of value for CMDDONE in the HSMC_IER register */
...
#define HSMC_IER_DTOE(value)                  (HSMC_IER_DTOE_Msk & (_UINT32_(value) << HSMC_IER_DTOE_Pos)) /* Assignment of value for DTOE in the HSMC_IER register */
...
#define HSMC_IER_UNDEF(value)                 (HSMC_IER_UNDEF_Msk & (_UINT32_(value) << HSMC_IER_UNDEF_Pos)) /* Assignment of value for UNDEF in the HSMC_IER register */
...
#define HSMC_IER_AWB(value)                   (HSMC_IER_AWB_Msk & (_UINT32_(value) << HSMC_IER_AWB_Pos)) /* Assignment of value for AWB in the HSMC_IER register */
...
#define HSMC_IER_NFCASE(value)                (HSMC_IER_NFCASE_Msk & (_UINT32_(value) << HSMC_IER_NFCASE_Pos)) /* Assignment of value for NFCASE in the HSMC_IER register */
...
#define HSMC_IER_RB_EDGE0(value)              (HSMC_IER_RB_EDGE0_Msk & (_UINT32_(value) << HSMC_IER_RB_EDGE0_Pos)) /* Assignment of value for RB_EDGE0 in the HSMC_IER register */
...
#define HSMC_IDR_RB_RISE(value)               (HSMC_IDR_RB_RISE_Msk & (_UINT32_(value) << HSMC_IDR_RB_RISE_Pos)) /* Assignment of value for RB_RISE in the HSMC_IDR register */
...
#define HSMC_IDR_RB_FALL(value)               (HSMC_IDR_RB_FALL_Msk & (_UINT32_(value) << HSMC_IDR_RB_FALL_Pos)) /* Assignment of value for RB_FALL in the HSMC_IDR register */
...
#define HSMC_IDR_XFRDONE(value)               (HSMC_IDR_XFRDONE_Msk & (_UINT32_(value) << HSMC_IDR_XFRDONE_Pos)) /* Assignment of value for XFRDONE in the HSMC_IDR register */
...
#define HSMC_IDR_CMDDONE(value)               (HSMC_IDR_CMDDONE_Msk & (_UINT32_(value) << HSMC_IDR_CMDDONE_Pos)) /* Assignment of value for CMDDONE in the HSMC_IDR register */
...
#define HSMC_IDR_DTOE(value)                  (HSMC_IDR_DTOE_Msk & (_UINT32_(value) << HSMC_IDR_DTOE_Pos)) /* Assignment of value for DTOE in the HSMC_IDR register */
...
#define HSMC_IDR_UNDEF(value)                 (HSMC_IDR_UNDEF_Msk & (_UINT32_(value) << HSMC_IDR_UNDEF_Pos)) /* Assignment of value for UNDEF in the HSMC_IDR register */
...
#define HSMC_IDR_AWB(value)                   (HSMC_IDR_AWB_Msk & (_UINT32_(value) << HSMC_IDR_AWB_Pos)) /* Assignment of value for AWB in the HSMC_IDR register */
...
#define HSMC_IDR_NFCASE(value)                (HSMC_IDR_NFCASE_Msk & (_UINT32_(value) << HSMC_IDR_NFCASE_Pos)) /* Assignment of value for NFCASE in the HSMC_IDR register */
...
#define HSMC_IDR_RB_EDGE0(value)              (HSMC_IDR_RB_EDGE0_Msk & (_UINT32_(value) << HSMC_IDR_RB_EDGE0_Pos)) /* Assignment of value for RB_EDGE0 in the HSMC_IDR register */
...
#define HSMC_IMR_RB_RISE(value)               (HSMC_IMR_RB_RISE_Msk & (_UINT32_(value) << HSMC_IMR_RB_RISE_Pos)) /* Assignment of value for RB_RISE in the HSMC_IMR register */
...
#define HSMC_IMR_RB_FALL(value)               (HSMC_IMR_RB_FALL_Msk & (_UINT32_(value) << HSMC_IMR_RB_FALL_Pos)) /* Assignment of value for RB_FALL in the HSMC_IMR register */
...
#define HSMC_IMR_XFRDONE(value)               (HSMC_IMR_XFRDONE_Msk & (_UINT32_(value) << HSMC_IMR_XFRDONE_Pos)) /* Assignment of value for XFRDONE in the HSMC_IMR register */
...
#define HSMC_IMR_CMDDONE(value)               (HSMC_IMR_CMDDONE_Msk & (_UINT32_(value) << HSMC_IMR_CMDDONE_Pos)) /* Assignment of value for CMDDONE in the HSMC_IMR register */
...
#define HSMC_IMR_DTOE(value)                  (HSMC_IMR_DTOE_Msk & (_UINT32_(value) << HSMC_IMR_DTOE_Pos)) /* Assignment of value for DTOE in the HSMC_IMR register */
...
#define HSMC_IMR_UNDEF(value)                 (HSMC_IMR_UNDEF_Msk & (_UINT32_(value) << HSMC_IMR_UNDEF_Pos)) /* Assignment of value for UNDEF in the HSMC_IMR register */
...
#define HSMC_IMR_AWB(value)                   (HSMC_IMR_AWB_Msk & (_UINT32_(value) << HSMC_IMR_AWB_Pos)) /* Assignment of value for AWB in the HSMC_IMR register */
...
#define HSMC_IMR_NFCASE(value)                (HSMC_IMR_NFCASE_Msk & (_UINT32_(value) << HSMC_IMR_NFCASE_Pos)) /* Assignment of value for NFCASE in the HSMC_IMR register */
...
#define HSMC_IMR_RB_EDGE0(value)              (HSMC_IMR_RB_EDGE0_Msk & (_UINT32_(value) << HSMC_IMR_RB_EDGE0_Pos)) /* Assignment of value for RB_EDGE0 in the HSMC_IMR register */
...
#define HSMC_ADDR_ADDR_CYCLE0(value)          (HSMC_ADDR_ADDR_CYCLE0_Msk & (_UINT32_(value) << HSMC_ADDR_ADDR_CYCLE0_Pos)) /* Assignment of value for ADDR_CYCLE0 in the HSMC_ADDR register */
...
#define HSMC_BANK_BANK(value)                 (HSMC_BANK_BANK_Msk & (_UINT32_(value) << HSMC_BANK_BANK_Pos)) /* Assignment of value for BANK in the HSMC_BANK register */
...
#define HSMC_PMECCFG_BCH_ERR(value)           (HSMC_PMECCFG_BCH_ERR_Msk & (_UINT32_(value) << HSMC_PMECCFG_BCH_ERR_Pos)) /* Assignment of value for BCH_ERR in the HSMC_PMECCFG register */
...
#define HSMC_PMECCFG_SECTORSZ(value)          (HSMC_PMECCFG_SECTORSZ_Msk & (_UINT32_(value) << HSMC_PMECCFG_SECTORSZ_Pos)) /* Assignment of value for SECTORSZ in the HSMC_PMECCFG register */
...
#define HSMC_PMECCFG_PAGESIZE(value)          (HSMC_PMECCFG_PAGESIZE_Msk & (_UINT32_(value) << HSMC_PMECCFG_PAGESIZE_Pos)) /* Assignment of value for PAGESIZE in the HSMC_PMECCFG register */
...
#define HSMC_PMECCFG_NANDWR(value)            (HSMC_PMECCFG_NANDWR_Msk & (_UINT32_(value) << HSMC_PMECCFG_NANDWR_Pos)) /* Assignment of value for NANDWR in the HSMC_PMECCFG register */
...
#define   HSMC_PMECCFG_SPAREEN_0_Val          _UINT32_(0x0)                                        /* (HSMC_PMECCFG) For NAND write access: The spare area is not protected by ECC. For NAND read access: The spare area is not protected by ECC.  */
#define   HSMC_PMECCFG_SPAREEN_1_Val          _UINT32_(0x1)                                        /* (HSMC_PMECCFG) For NAND write access: The spare area is protected with the last sector of data. For NAND read access: The spare area contains protected data.  */
#define HSMC_PMECCFG_SPAREEN_0                (HSMC_PMECCFG_SPAREEN_0_Val << HSMC_PMECCFG_SPAREEN_Pos) /* (HSMC_PMECCFG) For NAND write access: The spare area is not protected by ECC. For NAND read access: The spare area is not protected by ECC. Position */
#define HSMC_PMECCFG_SPAREEN_1                (HSMC_PMECCFG_SPAREEN_1_Val << HSMC_PMECCFG_SPAREEN_Pos) /* (HSMC_PMECCFG) For NAND write access: The spare area is protected with the last sector of data. For NAND read access: The spare area contains protected data. Position */
...
#define HSMC_PMECCSAREA_SPARESIZE(value)      (HSMC_PMECCSAREA_SPARESIZE_Msk & (_UINT32_(value) << HSMC_PMECCSAREA_SPARESIZE_Pos)) /* Assignment of value for SPARESIZE in the HSMC_PMECCSAREA register */
...
#define HSMC_PMECCSADDR_STARTADDR(value)      (HSMC_PMECCSADDR_STARTADDR_Msk & (_UINT32_(value) << HSMC_PMECCSADDR_STARTADDR_Pos)) /* Assignment of value for STARTADDR in the HSMC_PMECCSADDR register */
...
#define HSMC_PMECCEADDR_ENDADDR(value)        (HSMC_PMECCEADDR_ENDADDR_Msk & (_UINT32_(value) << HSMC_PMECCEADDR_ENDADDR_Pos)) /* Assignment of value for ENDADDR in the HSMC_PMECCEADDR register */
...
#define HSMC_PMECCTRL_RST(value)              (HSMC_PMECCTRL_RST_Msk & (_UINT32_(value) << HSMC_PMECCTRL_RST_Pos)) /* Assignment of value for RST in the HSMC_PMECCTRL register */
...
#define HSMC_PMECCTRL_DATA(value)             (HSMC_PMECCTRL_DATA_Msk & (_UINT32_(value) << HSMC_PMECCTRL_DATA_Pos)) /* Assignment of value for DATA in the HSMC_PMECCTRL register */
...
#define HSMC_PMECCTRL_USER(value)             (HSMC_PMECCTRL_USER_Msk & (_UINT32_(value) << HSMC_PMECCTRL_USER_Pos)) /* Assignment of value for USER in the HSMC_PMECCTRL register */
...
#define HSMC_PMECCTRL_ENABLE(value)           (HSMC_PMECCTRL_ENABLE_Msk & (_UINT32_(value) << HSMC_PMECCTRL_ENABLE_Pos)) /* Assignment of value for ENABLE in the HSMC_PMECCTRL register */
...
#define HSMC_PMECCSR_BUSY(value)              (HSMC_PMECCSR_BUSY_Msk & (_UINT32_(value) << HSMC_PMECCSR_BUSY_Pos)) /* Assignment of value for BUSY in the HSMC_PMECCSR register */
...
#define HSMC_PMECCSR_ENABLE(value)            (HSMC_PMECCSR_ENABLE_Msk & (_UINT32_(value) << HSMC_PMECCSR_ENABLE_Pos)) /* Assignment of value for ENABLE in the HSMC_PMECCSR register */
...
#define HSMC_PMECCIER_ERRIE(value)            (HSMC_PMECCIER_ERRIE_Msk & (_UINT32_(value) << HSMC_PMECCIER_ERRIE_Pos)) /* Assignment of value for ERRIE in the HSMC_PMECCIER register */
...
#define HSMC_PMECCIDR_ERRID(value)            (HSMC_PMECCIDR_ERRID_Msk & (_UINT32_(value) << HSMC_PMECCIDR_ERRID_Pos)) /* Assignment of value for ERRID in the HSMC_PMECCIDR register */
...
#define HSMC_PMECCIMR_ERRIM(value)            (HSMC_PMECCIMR_ERRIM_Msk & (_UINT32_(value) << HSMC_PMECCIMR_ERRIM_Pos)) /* Assignment of value for ERRIM in the HSMC_PMECCIMR register */
...
#define HSMC_PMECCISR_ERRIS(value)            (HSMC_PMECCISR_ERRIS_Msk & (_UINT32_(value) << HSMC_PMECCISR_ERRIS_Pos)) /* Assignment of value for ERRIS in the HSMC_PMECCISR register */
...
#define HSMC_ELCFG_SECTORSZ(value)            (HSMC_ELCFG_SECTORSZ_Msk & (_UINT32_(value) << HSMC_ELCFG_SECTORSZ_Pos)) /* Assignment of value for SECTORSZ in the HSMC_ELCFG register */
...
#define HSMC_ELCFG_ERRNUM(value)              (HSMC_ELCFG_ERRNUM_Msk & (_UINT32_(value) << HSMC_ELCFG_ERRNUM_Pos)) /* Assignment of value for ERRNUM in the HSMC_ELCFG register */
...
#define HSMC_ELPRIM_PRIMITIV(value)           (HSMC_ELPRIM_PRIMITIV_Msk & (_UINT32_(value) << HSMC_ELPRIM_PRIMITIV_Pos)) /* Assignment of value for PRIMITIV in the HSMC_ELPRIM register */
...
#define HSMC_ELEN_ENINIT(value)               (HSMC_ELEN_ENINIT_Msk & (_UINT32_(value) << HSMC_ELEN_ENINIT_Pos)) /* Assignment of value for ENINIT in the HSMC_ELEN register */
...
#define HSMC_ELDIS_DIS(value)                 (HSMC_ELDIS_DIS_Msk & (_UINT32_(value) << HSMC_ELDIS_DIS_Pos)) /* Assignment of value for DIS in the HSMC_ELDIS register */
...
#define HSMC_ELSR_BUSY(value)                 (HSMC_ELSR_BUSY_Msk & (_UINT32_(value) << HSMC_ELSR_BUSY_Pos)) /* Assignment of value for BUSY in the HSMC_ELSR register */
...
#define HSMC_ELIER_DONE(value)                (HSMC_ELIER_DONE_Msk & (_UINT32_(value) << HSMC_ELIER_DONE_Pos)) /* Assignment of value for DONE in the HSMC_ELIER register */
...
#define HSMC_ELIDR_DONE(value)                (HSMC_ELIDR_DONE_Msk & (_UINT32_(value) << HSMC_ELIDR_DONE_Pos)) /* Assignment of value for DONE in the HSMC_ELIDR register */
...
#define HSMC_ELIMR_DONE(value)                (HSMC_ELIMR_DONE_Msk & (_UINT32_(value) << HSMC_ELIMR_DONE_Pos)) /* Assignment of value for DONE in the HSMC_ELIMR register */
...
#define HSMC_ELISR_DONE(value)                (HSMC_ELISR_DONE_Msk & (_UINT32_(value) << HSMC_ELISR_DONE_Pos)) /* Assignment of value for DONE in the HSMC_ELISR register */
...
#define HSMC_ELISR_ERR_CNT(value)             (HSMC_ELISR_ERR_CNT_Msk & (_UINT32_(value) << HSMC_ELISR_ERR_CNT_Pos)) /* Assignment of value for ERR_CNT in the HSMC_ELISR register */
...
#define HSMC_SIGMA0_SIGMA_Pos                 _UINT32_(0)                                          /* (HSMC_SIGMA0) Coefficient of degree 0 in the SIGMA polynomial Position */
#define HSMC_SIGMA0_SIGMA_Msk                 (_UINT32_(0x3FFF) << HSMC_SIGMA0_SIGMA_Pos)          /* (HSMC_SIGMA0) Coefficient of degree 0 in the SIGMA polynomial Mask */
#define HSMC_SIGMA0_SIGMA(value)              (HSMC_SIGMA0_SIGMA_Msk & (_UINT32_(value) << HSMC_SIGMA0_SIGMA_Pos)) /* Assignment of value for SIGMA in the HSMC_SIGMA0 register */
...
#define HSMC_ERRLOC_ERRLOCN(value)            (HSMC_ERRLOC_ERRLOCN_Msk & (_UINT32_(value) << HSMC_ERRLOC_ERRLOCN_Pos)) /* Assignment of value for ERRLOCN in the HSMC_ERRLOC register */
...
#define HSMC_OCMS_SMSE(value)                 (HSMC_OCMS_SMSE_Msk & (_UINT32_(value) << HSMC_OCMS_SMSE_Pos)) /* Assignment of value for SMSE in the HSMC_OCMS register */
...
#define HSMC_OCMS_SRSE(value)                 (HSMC_OCMS_SRSE_Msk & (_UINT32_(value) << HSMC_OCMS_SRSE_Pos)) /* Assignment of value for SRSE in the HSMC_OCMS register */
...
#define HSMC_KEY1_KEY1(value)                 (HSMC_KEY1_KEY1_Msk & (_UINT32_(value) << HSMC_KEY1_KEY1_Pos)) /* Assignment of value for KEY1 in the HSMC_KEY1 register */
...
#define HSMC_KEY2_KEY2(value)                 (HSMC_KEY2_KEY2_Msk & (_UINT32_(value) << HSMC_KEY2_KEY2_Pos)) /* Assignment of value for KEY2 in the HSMC_KEY2 register */
...
#define HSMC_CLKCFG_CLKDIV(value)             (HSMC_CLKCFG_CLKDIV_Msk & (_UINT32_(value) << HSMC_CLKCFG_CLKDIV_Pos)) /* Assignment of value for CLKDIV in the HSMC_CLKCFG register */
...
#define HSMC_CLKCFG_CLKEN(value)              (HSMC_CLKCFG_CLKEN_Msk & (_UINT32_(value) << HSMC_CLKCFG_CLKEN_Pos)) /* Assignment of value for CLKEN in the HSMC_CLKCFG register */
...
#define HSMC_CLKCFG_CLKEDGE(value)            (HSMC_CLKCFG_CLKEDGE_Msk & (_UINT32_(value) << HSMC_CLKCFG_CLKEDGE_Pos)) /* Assignment of value for CLKEDGE in the HSMC_CLKCFG register */
...
#define HSMC_WPMR_WPEN(value)                 (HSMC_WPMR_WPEN_Msk & (_UINT32_(value) << HSMC_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the HSMC_WPMR register */
...
#define HSMC_WPMR_WPKEY(value)                (HSMC_WPMR_WPKEY_Msk & (_UINT32_(value) << HSMC_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the HSMC_WPMR register */
...
#define HSMC_WPSR_WPVS(value)                 (HSMC_WPSR_WPVS_Msk & (_UINT32_(value) << HSMC_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the HSMC_WPSR register */
...
#define HSMC_WPSR_WPVSRC(value)               (HSMC_WPSR_WPVSRC_Msk & (_UINT32_(value) << HSMC_WPSR_WPVSRC_Pos)) /* Assignment of value for WPVSRC in the HSMC_WPSR register */
...
/* SMC_PMECC register API structure */
typedef struct
{
...
/* SMC_REM register API structure */
typedef struct
{
...
#endif /* _SAMA7G5_SMC_COMPONENT_H_ */
