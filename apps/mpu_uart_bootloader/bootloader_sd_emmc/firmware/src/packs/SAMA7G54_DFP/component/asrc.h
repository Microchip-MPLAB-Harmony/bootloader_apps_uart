...
#ifndef _SAMA7G5_ASRC_COMPONENT_H_
#define _SAMA7G5_ASRC_COMPONENT_H_
...
#define ASRC_MR_GT96K_Pos                     _UINT32_(12)                                         /* (ASRC_MR) Frequency Sampling Greater Than 96 kHz Position */
#define ASRC_MR_GT96K_Msk                     (_UINT32_(0x1) << ASRC_MR_GT96K_Pos)                 /* (ASRC_MR) Frequency Sampling Greater Than 96 kHz Mask */
#define ASRC_MR_GT96K(value)                  (ASRC_MR_GT96K_Msk & (_UINT32_(value) << ASRC_MR_GT96K_Pos)) /* Assignment of value for GT96K in the ASRC_MR register */
#define   ASRC_MR_GT96K_DISABLE_Val           _UINT32_(0x0)                                        /* (ASRC_MR) Up to 4 DSP with up to 96 kHz as the upper bound limit of the sampling frequency.  */
#define   ASRC_MR_GT96K_ENABLE_Val            _UINT32_(0x1)                                        /* (ASRC_MR) Up to 2 DSP with up to 192 kHz as the upper bound limit of the sampling frequency. The number of enabled DSPs is limited to 2.  */
...
#define ASRC_MR_Msk                           _UINT32_(0x0000100F)                                 /* (ASRC_MR) Register Mask  */
...
#define ASRC_IER_Msk                          _UINT32_(0x40013F3F)                                 /* (ASRC_IER) Register Mask  */
...
#define ASRC_IDR_Msk                          _UINT32_(0x40013F3F)                                 /* (ASRC_IDR) Register Mask  */
...
#define ASRC_IMR_Msk                          _UINT32_(0x40013F3F)                                 /* (ASRC_IMR) Register Mask  */
...
#define ASRC_ISR_Msk                          _UINT32_(0x40013F3F)                                 /* (ASRC_ISR) Register Mask  */
...
#define   ASRC_WPSR_SEQE_1_Val                _UINT32_(0x1)                                        /* (ASRC_WPSR) A peripheral internal sequencer error has occurred since the last read of ASRC_WPSR.  */
...
#define ASRC_WPSR_Msk                         _UINT32_(0x03FFFF0D)                                 /* (ASRC_WPSR) Register Mask  */
...
#endif /* _SAMA7G5_ASRC_COMPONENT_H_ */
