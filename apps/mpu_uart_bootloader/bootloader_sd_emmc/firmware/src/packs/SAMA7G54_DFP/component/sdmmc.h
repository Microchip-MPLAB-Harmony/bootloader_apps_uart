...
#ifndef _SAMA7G5_SDMMC_COMPONENT_H_
#define _SAMA7G5_SDMMC_COMPONENT_H_
...
#define SDMMC_BSR_BLKSIZE(value)              (SDMMC_BSR_BLKSIZE_Msk & (_UINT16_(value) << SDMMC_BSR_BLKSIZE_Pos)) /* Assignment of value for BLKSIZE in the SDMMC_BSR register */
...
#define SDMMC_BCR_BLKCNT(value)               (SDMMC_BCR_BLKCNT_Msk & (_UINT16_(value) << SDMMC_BCR_BLKCNT_Pos)) /* Assignment of value for BLKCNT in the SDMMC_BCR register */
...
#define SDMMC_ARG1R_ARG1(value)               (SDMMC_ARG1R_ARG1_Msk & (_UINT32_(value) << SDMMC_ARG1R_ARG1_Pos)) /* Assignment of value for ARG1 in the SDMMC_ARG1R register */
...
#define SDMMC_CA1R_RTMOD(value)               (SDMMC_CA1R_RTMOD_Msk & (_UINT32_(value) << SDMMC_CA1R_RTMOD_Pos)) /* Assignment of value for RTMOD in the SDMMC_CA1R register */
...
#define SDMMC_ASAR0_ADMASA(value)             (SDMMC_ASAR0_ADMASA_Msk & (_UINT32_(value) << SDMMC_ASAR0_ADMASA_Pos)) /* Assignment of value for ADMASA in the SDMMC_ASAR0 register */
...
#define SDMMC_APSR_HDATLL(value)              (SDMMC_APSR_HDATLL_Msk & (_UINT32_(value) << SDMMC_APSR_HDATLL_Pos)) /* Assignment of value for HDATLL in the SDMMC_APSR register */
...
#define SDMMC_MC3R_HS400EN(value)             (SDMMC_MC3R_HS400EN_Msk & (_UINT8_(value) << SDMMC_MC3R_HS400EN_Pos)) /* Assignment of value for HS400EN in the SDMMC_MC3R register */
...
#define SDMMC_MC3R_ESMEN(value)               (SDMMC_MC3R_ESMEN_Msk & (_UINT8_(value) << SDMMC_MC3R_ESMEN_Pos)) /* Assignment of value for ESMEN in the SDMMC_MC3R register */
...
#define SDMMC_ACR_BUFM(value)                 (SDMMC_ACR_BUFM_Msk & (_UINT32_(value) << SDMMC_ACR_BUFM_Pos)) /* Assignment of value for BUFM in the SDMMC_ACR register */
...
#define SDMMC_ACR_DFQOS(value)                (SDMMC_ACR_DFQOS_Msk & (_UINT32_(value) << SDMMC_ACR_DFQOS_Pos)) /* Assignment of value for DFQOS in the SDMMC_ACR register */
...
#define SDMMC_RTC1R_TMREN(value)              (SDMMC_RTC1R_TMREN_Msk & (_UINT8_(value) << SDMMC_RTC1R_TMREN_Pos)) /* Assignment of value for TMREN in the SDMMC_RTC1R register */
...
#define SDMMC_RTC2R_RLD(value)                (SDMMC_RTC2R_RLD_Msk & (_UINT8_(value) << SDMMC_RTC2R_RLD_Pos)) /* Assignment of value for RLD in the SDMMC_RTC2R register */
...
#define SDMMC_RTCVR_TCVAL(value)              (SDMMC_RTCVR_TCVAL_Msk & (_UINT32_(value) << SDMMC_RTCVR_TCVAL_Pos)) /* Assignment of value for TCVAL in the SDMMC_RTCVR register */
...
#define SDMMC_RTISTER_TEVT(value)             (SDMMC_RTISTER_TEVT_Msk & (_UINT8_(value) << SDMMC_RTISTER_TEVT_Pos)) /* Assignment of value for TEVT in the SDMMC_RTISTER register */
...
#define SDMMC_RTISIER_TEVT(value)             (SDMMC_RTISIER_TEVT_Msk & (_UINT8_(value) << SDMMC_RTISIER_TEVT_Pos)) /* Assignment of value for TEVT in the SDMMC_RTISIER register */
...
#define SDMMC_RTISTR_TEVT(value)              (SDMMC_RTISTR_TEVT_Msk & (_UINT8_(value) << SDMMC_RTISTR_TEVT_Pos)) /* Assignment of value for TEVT in the SDMMC_RTISTR register */
...
#define SDMMC_RTSSR_TEVTSLOT(value)           (SDMMC_RTSSR_TEVTSLOT_Msk & (_UINT8_(value) << SDMMC_RTSSR_TEVTSLOT_Pos)) /* Assignment of value for TEVTSLOT in the SDMMC_RTSSR register */
...
#define SDMMC_TUNCR_SMPLPT(value)             (SDMMC_TUNCR_SMPLPT_Msk & (_UINT32_(value) << SDMMC_TUNCR_SMPLPT_Pos)) /* Assignment of value for SMPLPT in the SDMMC_TUNCR register */
...
#define SDMMC_CALCR_RESETVALUE                _UINT32_(0x00)                                       /*  (SDMMC_CALCR) Calibration Control Register  Reset Value */
...
#define SDMMC_CALCR_EN(value)                 (SDMMC_CALCR_EN_Msk & (_UINT32_(value) << SDMMC_CALCR_EN_Pos)) /* Assignment of value for EN in the SDMMC_CALCR register */
...
#define SDMMC_CALCR_CLKDIV(value)             (SDMMC_CALCR_CLKDIV_Msk & (_UINT32_(value) << SDMMC_CALCR_CLKDIV_Pos)) /* Assignment of value for CLKDIV in the SDMMC_CALCR register */
...
#define SDMMC_CALCR_ALWYSON(value)            (SDMMC_CALCR_ALWYSON_Msk & (_UINT32_(value) << SDMMC_CALCR_ALWYSON_Pos)) /* Assignment of value for ALWYSON in the SDMMC_CALCR register */
...
#define SDMMC_CALCR_TUNDIS(value)             (SDMMC_CALCR_TUNDIS_Msk & (_UINT32_(value) << SDMMC_CALCR_TUNDIS_Pos)) /* Assignment of value for TUNDIS in the SDMMC_CALCR register */
...
#define SDMMC_CALCR_BPEN(value)               (SDMMC_CALCR_BPEN_Msk & (_UINT32_(value) << SDMMC_CALCR_BPEN_Pos)) /* Assignment of value for BPEN in the SDMMC_CALCR register */
...
#define SDMMC_CALCR_CNTVAL(value)             (SDMMC_CALCR_CNTVAL_Msk & (_UINT32_(value) << SDMMC_CALCR_CNTVAL_Pos)) /* Assignment of value for CNTVAL in the SDMMC_CALCR register */
...
#define SDMMC_CALCR_CALN(value)               (SDMMC_CALCR_CALN_Msk & (_UINT32_(value) << SDMMC_CALCR_CALN_Pos)) /* Assignment of value for CALN in the SDMMC_CALCR register */
...
#define SDMMC_CALCR_CALNBP(value)             (SDMMC_CALCR_CALNBP_Msk & (_UINT32_(value) << SDMMC_CALCR_CALNBP_Pos)) /* Assignment of value for CALNBP in the SDMMC_CALCR register */
...
#define SDMMC_CALCR_CALP(value)               (SDMMC_CALCR_CALP_Msk & (_UINT32_(value) << SDMMC_CALCR_CALP_Pos)) /* Assignment of value for CALP in the SDMMC_CALCR register */
...
#define SDMMC_CALCR_CALPBP(value)             (SDMMC_CALCR_CALPBP_Msk & (_UINT32_(value) << SDMMC_CALCR_CALPBP_Pos)) /* Assignment of value for CALPBP in the SDMMC_CALCR register */
...
#define SDMMC_EPVR8_SDCLKFSEL(value)          (SDMMC_EPVR8_SDCLKFSEL_Msk & (_UINT16_(value) << SDMMC_EPVR8_SDCLKFSEL_Pos)) /* Assignment of value for SDCLKFSEL in the SDMMC_EPVR8 register */
...
#define SDMMC_EPVR8_CLKGSEL(value)            (SDMMC_EPVR8_CLKGSEL_Msk & (_UINT16_(value) << SDMMC_EPVR8_CLKGSEL_Pos)) /* Assignment of value for CLKGSEL in the SDMMC_EPVR8 register */
...
#define SDMMC_EPVR8_DRVSEL(value)             (SDMMC_EPVR8_DRVSEL_Msk & (_UINT16_(value) << SDMMC_EPVR8_DRVSEL_Pos)) /* Assignment of value for DRVSEL in the SDMMC_EPVR8 register */
...
#endif /* _SAMA7G5_SDMMC_COMPONENT_H_ */
