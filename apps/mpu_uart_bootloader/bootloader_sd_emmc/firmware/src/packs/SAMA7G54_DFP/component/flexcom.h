...
#define FLEX_US_IMR_LIN_Msk                   _UINT32_(0xFE00E000)                                 /* (FLEX_US_IMR_LIN) Register Mask  */
...
#define FLEX_SPI_MR_Msk                       _UINT32_(0xFF0F11BF)                                 /* (FLEX_SPI_MR) Register Mask  */
...
#define FLEX_SPI_IER_Msk                      _UINT32_(0xFF001F0F)                                 /* (FLEX_SPI_IER) Register Mask  */
...
#define FLEX_SPI_IDR_Msk                      _UINT32_(0xFF001F0F)                                 /* (FLEX_SPI_IDR) Register Mask  */
...
#define FLEX_SPI_IMR_Msk                      _UINT32_(0xFF001F0F)                                 /* (FLEX_SPI_IMR) Register Mask  */
...
#endif /* _SAMA7G5_FLEXCOM_COMPONENT_H_ */
