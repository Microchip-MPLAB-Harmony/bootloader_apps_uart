...
#ifndef _SAMA7G5_QSPI_COMPONENT_H_
#define _SAMA7G5_QSPI_COMPONENT_H_
...
#define QSPI_CR_DLLON_Pos                     _UINT32_(2)                                          /* (QSPI_CR) DLL On Request Position */
#define QSPI_CR_DLLON_Msk                     (_UINT32_(0x1) << QSPI_CR_DLLON_Pos)                 /* (QSPI_CR) DLL On Request Mask */
#define QSPI_CR_DLLON(value)                  (QSPI_CR_DLLON_Msk & (_UINT32_(value) << QSPI_CR_DLLON_Pos)) /* Assignment of value for DLLON in the QSPI_CR register */
#define   QSPI_CR_DLLON_0_Val                 _UINT32_(0x0)                                        /* (QSPI_CR) No effect.  */
#define   QSPI_CR_DLLON_1_Val                 _UINT32_(0x1)                                        /* (QSPI_CR) Enables the DLL. When the DLL is locked (using QSPI_SR.DLOCK), the QSPI core receives a clock and is functional.  */
#define QSPI_CR_DLLON_0                       (QSPI_CR_DLLON_0_Val << QSPI_CR_DLLON_Pos)           /* (QSPI_CR) No effect. Position */
#define QSPI_CR_DLLON_1                       (QSPI_CR_DLLON_1_Val << QSPI_CR_DLLON_Pos)           /* (QSPI_CR) Enables the DLL. When the DLL is locked (using QSPI_SR.DLOCK), the QSPI core receives a clock and is functional. Position */
#define QSPI_CR_DLLOFF_Pos                    _UINT32_(3)                                          /* (QSPI_CR) DLL Off Request Position */
#define QSPI_CR_DLLOFF_Msk                    (_UINT32_(0x1) << QSPI_CR_DLLOFF_Pos)                /* (QSPI_CR) DLL Off Request Mask */
#define QSPI_CR_DLLOFF(value)                 (QSPI_CR_DLLOFF_Msk & (_UINT32_(value) << QSPI_CR_DLLOFF_Pos)) /* Assignment of value for DLLOFF in the QSPI_CR register */
#define   QSPI_CR_DLLOFF_0_Val                _UINT32_(0x0)                                        /* (QSPI_CR) No effect.  */
#define   QSPI_CR_DLLOFF_1_Val                _UINT32_(0x1)                                        /* (QSPI_CR) Disables the DLL. When the DLL is not locked (using QSPI_SR.DLOCK), the QSPI core does not receive a clock and is not functional.  */
#define QSPI_CR_DLLOFF_0                      (QSPI_CR_DLLOFF_0_Val << QSPI_CR_DLLOFF_Pos)         /* (QSPI_CR) No effect. Position */
#define QSPI_CR_DLLOFF_1                      (QSPI_CR_DLLOFF_1_Val << QSPI_CR_DLLOFF_Pos)         /* (QSPI_CR) Disables the DLL. When the DLL is not locked (using QSPI_SR.DLOCK), the QSPI core does not receive a clock and is not functional. Position */
...
#define QSPI_CR_STPCAL(value)                 (QSPI_CR_STPCAL_Msk & (_UINT32_(value) << QSPI_CR_STPCAL_Pos)) /* Assignment of value for STPCAL in the QSPI_CR register */
...
#define QSPI_CR_SRFRSH(value)                 (QSPI_CR_SRFRSH_Msk & (_UINT32_(value) << QSPI_CR_SRFRSH_Pos)) /* Assignment of value for SRFRSH in the QSPI_CR register */
...
#define QSPI_CR_UPDCFG(value)                 (QSPI_CR_UPDCFG_Msk & (_UINT32_(value) << QSPI_CR_UPDCFG_Pos)) /* Assignment of value for UPDCFG in the QSPI_CR register */
...
#define QSPI_CR_STTFR(value)                  (QSPI_CR_STTFR_Msk & (_UINT32_(value) << QSPI_CR_STTFR_Pos)) /* Assignment of value for STTFR in the QSPI_CR register */
...
#define QSPI_CR_RTOUT(value)                  (QSPI_CR_RTOUT_Msk & (_UINT32_(value) << QSPI_CR_RTOUT_Pos)) /* Assignment of value for RTOUT in the QSPI_CR register */
...
#define QSPI_CR_Msk                           _UINT32_(0x010007BF)                                 /* (QSPI_CR) Register Mask  */
...
#define QSPI_MR_DQSDLYEN(value)               (QSPI_MR_DQSDLYEN_Msk & (_UINT32_(value) << QSPI_MR_DQSDLYEN_Pos)) /* Assignment of value for DQSDLYEN in the QSPI_MR register */
...
#define QSPI_MR_TAMPCLR(value)                (QSPI_MR_TAMPCLR_Msk & (_UINT32_(value) << QSPI_MR_TAMPCLR_Pos)) /* Assignment of value for TAMPCLR in the QSPI_MR register */
...
#define QSPI_MR_AQICMEN(value)                (QSPI_MR_AQICMEN_Msk & (_UINT32_(value) << QSPI_MR_AQICMEN_Pos)) /* Assignment of value for AQICMEN in the QSPI_MR register */
...
#define QSPI_ISR_RDRF(value)                  (QSPI_ISR_RDRF_Msk & (_UINT32_(value) << QSPI_ISR_RDRF_Pos)) /* Assignment of value for RDRF in the QSPI_ISR register */
...
#define QSPI_ISR_TDRE(value)                  (QSPI_ISR_TDRE_Msk & (_UINT32_(value) << QSPI_ISR_TDRE_Pos)) /* Assignment of value for TDRE in the QSPI_ISR register */
...
#define QSPI_ISR_TXEMPTY(value)               (QSPI_ISR_TXEMPTY_Msk & (_UINT32_(value) << QSPI_ISR_TXEMPTY_Pos)) /* Assignment of value for TXEMPTY in the QSPI_ISR register */
...
#define QSPI_ISR_OVRES(value)                 (QSPI_ISR_OVRES_Msk & (_UINT32_(value) << QSPI_ISR_OVRES_Pos)) /* Assignment of value for OVRES in the QSPI_ISR register */
...
#define QSPI_ISR_CSR(value)                   (QSPI_ISR_CSR_Msk & (_UINT32_(value) << QSPI_ISR_CSR_Pos)) /* Assignment of value for CSR in the QSPI_ISR register */
...
#define QSPI_ISR_CSF(value)                   (QSPI_ISR_CSF_Msk & (_UINT32_(value) << QSPI_ISR_CSF_Pos)) /* Assignment of value for CSF in the QSPI_ISR register */
...
#define QSPI_ISR_INSTRE(value)                (QSPI_ISR_INSTRE_Msk & (_UINT32_(value) << QSPI_ISR_INSTRE_Pos)) /* Assignment of value for INSTRE in the QSPI_ISR register */
...
#define QSPI_ISR_LWRA(value)                  (QSPI_ISR_LWRA_Msk & (_UINT32_(value) << QSPI_ISR_LWRA_Pos)) /* Assignment of value for LWRA in the QSPI_ISR register */
...
#define QSPI_ISR_QITF(value)                  (QSPI_ISR_QITF_Msk & (_UINT32_(value) << QSPI_ISR_QITF_Pos)) /* Assignment of value for QITF in the QSPI_ISR register */
...
#define QSPI_ISR_QITR(value)                  (QSPI_ISR_QITR_Msk & (_UINT32_(value) << QSPI_ISR_QITR_Pos)) /* Assignment of value for QITR in the QSPI_ISR register */
...
#define QSPI_ISR_CSFA(value)                  (QSPI_ISR_CSFA_Msk & (_UINT32_(value) << QSPI_ISR_CSFA_Pos)) /* Assignment of value for CSFA in the QSPI_ISR register */
...
#define QSPI_ISR_CSRA(value)                  (QSPI_ISR_CSRA_Msk & (_UINT32_(value) << QSPI_ISR_CSRA_Pos)) /* Assignment of value for CSRA in the QSPI_ISR register */
...
#define QSPI_ISR_RFRSHD(value)                (QSPI_ISR_RFRSHD_Msk & (_UINT32_(value) << QSPI_ISR_RFRSHD_Pos)) /* Assignment of value for RFRSHD in the QSPI_ISR register */
...
#define QSPI_ISR_TOUT(value)                  (QSPI_ISR_TOUT_Msk & (_UINT32_(value) << QSPI_ISR_TOUT_Pos)) /* Assignment of value for TOUT in the QSPI_ISR register */
...
#define QSPI_IER_LWRA(value)                  (QSPI_IER_LWRA_Msk & (_UINT32_(value) << QSPI_IER_LWRA_Pos)) /* Assignment of value for LWRA in the QSPI_IER register */
...
#define QSPI_IER_QITF(value)                  (QSPI_IER_QITF_Msk & (_UINT32_(value) << QSPI_IER_QITF_Pos)) /* Assignment of value for QITF in the QSPI_IER register */
...
#define QSPI_IER_QITR(value)                  (QSPI_IER_QITR_Msk & (_UINT32_(value) << QSPI_IER_QITR_Pos)) /* Assignment of value for QITR in the QSPI_IER register */
...
#define QSPI_IER_CSFA(value)                  (QSPI_IER_CSFA_Msk & (_UINT32_(value) << QSPI_IER_CSFA_Pos)) /* Assignment of value for CSFA in the QSPI_IER register */
...
#define QSPI_IER_CSRA(value)                  (QSPI_IER_CSRA_Msk & (_UINT32_(value) << QSPI_IER_CSRA_Pos)) /* Assignment of value for CSRA in the QSPI_IER register */
...
#define QSPI_IER_RFRSHD(value)                (QSPI_IER_RFRSHD_Msk & (_UINT32_(value) << QSPI_IER_RFRSHD_Pos)) /* Assignment of value for RFRSHD in the QSPI_IER register */
...
#define QSPI_IDR_LWRA(value)                  (QSPI_IDR_LWRA_Msk & (_UINT32_(value) << QSPI_IDR_LWRA_Pos)) /* Assignment of value for LWRA in the QSPI_IDR register */
...
#define QSPI_IDR_QITF(value)                  (QSPI_IDR_QITF_Msk & (_UINT32_(value) << QSPI_IDR_QITF_Pos)) /* Assignment of value for QITF in the QSPI_IDR register */
...
#define QSPI_IDR_QITR(value)                  (QSPI_IDR_QITR_Msk & (_UINT32_(value) << QSPI_IDR_QITR_Pos)) /* Assignment of value for QITR in the QSPI_IDR register */
...
#define QSPI_IDR_CSFA(value)                  (QSPI_IDR_CSFA_Msk & (_UINT32_(value) << QSPI_IDR_CSFA_Pos)) /* Assignment of value for CSFA in the QSPI_IDR register */
...
#define QSPI_IDR_CSRA(value)                  (QSPI_IDR_CSRA_Msk & (_UINT32_(value) << QSPI_IDR_CSRA_Pos)) /* Assignment of value for CSRA in the QSPI_IDR register */
...
#define QSPI_IDR_RFRSHD(value)                (QSPI_IDR_RFRSHD_Msk & (_UINT32_(value) << QSPI_IDR_RFRSHD_Pos)) /* Assignment of value for RFRSHD in the QSPI_IDR register */
...
#define QSPI_IMR_LWRA(value)                  (QSPI_IMR_LWRA_Msk & (_UINT32_(value) << QSPI_IMR_LWRA_Pos)) /* Assignment of value for LWRA in the QSPI_IMR register */
...
#define QSPI_IMR_QITF(value)                  (QSPI_IMR_QITF_Msk & (_UINT32_(value) << QSPI_IMR_QITF_Pos)) /* Assignment of value for QITF in the QSPI_IMR register */
...
#define QSPI_IMR_QITR(value)                  (QSPI_IMR_QITR_Msk & (_UINT32_(value) << QSPI_IMR_QITR_Pos)) /* Assignment of value for QITR in the QSPI_IMR register */
...
#define QSPI_IMR_CSFA(value)                  (QSPI_IMR_CSFA_Msk & (_UINT32_(value) << QSPI_IMR_CSFA_Pos)) /* Assignment of value for CSFA in the QSPI_IMR register */
...
#define QSPI_IMR_CSRA(value)                  (QSPI_IMR_CSRA_Msk & (_UINT32_(value) << QSPI_IMR_CSRA_Pos)) /* Assignment of value for CSRA in the QSPI_IMR register */
...
#define QSPI_IMR_RFRSHD(value)                (QSPI_IMR_RFRSHD_Msk & (_UINT32_(value) << QSPI_IMR_RFRSHD_Pos)) /* Assignment of value for RFRSHD in the QSPI_IMR register */
...
#define QSPI_SR_SYNCBSY(value)                (QSPI_SR_SYNCBSY_Msk & (_UINT32_(value) << QSPI_SR_SYNCBSY_Pos)) /* Assignment of value for SYNCBSY in the QSPI_SR register */
...
#define QSPI_SR_RBUSY(value)                  (QSPI_SR_RBUSY_Msk & (_UINT32_(value) << QSPI_SR_RBUSY_Pos)) /* Assignment of value for RBUSY in the QSPI_SR register */
...
#define QSPI_SR_HIDLE(value)                  (QSPI_SR_HIDLE_Msk & (_UINT32_(value) << QSPI_SR_HIDLE_Pos)) /* Assignment of value for HIDLE in the QSPI_SR register */
...
#define QSPI_SR_DLOCK_Pos                     _UINT32_(5)                                          /* (QSPI_SR) DLL Lock Position */
#define QSPI_SR_DLOCK_Msk                     (_UINT32_(0x1) << QSPI_SR_DLOCK_Pos)                 /* (QSPI_SR) DLL Lock Mask */
#define QSPI_SR_DLOCK(value)                  (QSPI_SR_DLOCK_Msk & (_UINT32_(value) << QSPI_SR_DLOCK_Pos)) /* Assignment of value for DLOCK in the QSPI_SR register */
#define   QSPI_SR_DLOCK_0_Val                 _UINT32_(0x0)                                        /* (QSPI_SR) DLL is not locked. The QSPI Controller and physical interface have not received a clock yet.  */
#define   QSPI_SR_DLOCK_1_Val                 _UINT32_(0x1)                                        /* (QSPI_SR) DLL is locked. The QSPI Controller and physical interface have received a clock.  */
...
#define QSPI_SR_CALBSY(value)                 (QSPI_SR_CALBSY_Msk & (_UINT32_(value) << QSPI_SR_CALBSY_Pos)) /* Assignment of value for CALBSY in the QSPI_SR register */
...
#define QSPI_SR_Msk                           _UINT32_(0x0000007F)                                 /* (QSPI_SR) Register Mask  */
...
#define QSPI_WICR_WRINST(value)               (QSPI_WICR_WRINST_Msk & (_UINT32_(value) << QSPI_WICR_WRINST_Pos)) /* Assignment of value for WRINST in the QSPI_WICR register */
...
#define QSPI_WICR_WROPT(value)                (QSPI_WICR_WROPT_Msk & (_UINT32_(value) << QSPI_WICR_WROPT_Pos)) /* Assignment of value for WROPT in the QSPI_WICR register */
...
#define QSPI_IFR_DDREN(value)                 (QSPI_IFR_DDREN_Msk & (_UINT32_(value) << QSPI_IFR_DDREN_Pos)) /* Assignment of value for DDREN in the QSPI_IFR register */
...
#define QSPI_IFR_END(value)                   (QSPI_IFR_END_Msk & (_UINT32_(value) << QSPI_IFR_END_Pos)) /* Assignment of value for END in the QSPI_IFR register */
...
#define QSPI_IFR_SMRM(value)                  (QSPI_IFR_SMRM_Msk & (_UINT32_(value) << QSPI_IFR_SMRM_Pos)) /* Assignment of value for SMRM in the QSPI_IFR register */
...
#define QSPI_IFR_APBTFRTYP(value)             (QSPI_IFR_APBTFRTYP_Msk & (_UINT32_(value) << QSPI_IFR_APBTFRTYP_Pos)) /* Assignment of value for APBTFRTYP in the QSPI_IFR register */
...
#define QSPI_IFR_DQSEN(value)                 (QSPI_IFR_DQSEN_Msk & (_UINT32_(value) << QSPI_IFR_DQSEN_Pos)) /* Assignment of value for DQSEN in the QSPI_IFR register */
...
#define QSPI_IFR_DDRCMDEN(value)              (QSPI_IFR_DDRCMDEN_Msk & (_UINT32_(value) << QSPI_IFR_DDRCMDEN_Pos)) /* Assignment of value for DDRCMDEN in the QSPI_IFR register */
...
#define QSPI_IFR_HFWBEN(value)                (QSPI_IFR_HFWBEN_Msk & (_UINT32_(value) << QSPI_IFR_HFWBEN_Pos)) /* Assignment of value for HFWBEN in the QSPI_IFR register */
...
#define QSPI_IFR_Msk                          _UINT32_(0x3FFFDFFF)                                 /* (QSPI_IFR) Register Mask  */
...
#define QSPI_RICR_RDINST(value)               (QSPI_RICR_RDINST_Msk & (_UINT32_(value) << QSPI_RICR_RDINST_Pos)) /* Assignment of value for RDINST in the QSPI_RICR register */
...
#define QSPI_RICR_RDOPT(value)                (QSPI_RICR_RDOPT_Msk & (_UINT32_(value) << QSPI_RICR_RDOPT_Pos)) /* Assignment of value for RDOPT in the QSPI_RICR register */
...
#define QSPI_SMR_SCRKL(value)                 (QSPI_SMR_SCRKL_Msk & (_UINT32_(value) << QSPI_SMR_SCRKL_Pos)) /* Assignment of value for SCRKL in the QSPI_SMR register */
...
#define QSPI_REFRESH_REFRESH(value)           (QSPI_REFRESH_REFRESH_Msk & (_UINT32_(value) << QSPI_REFRESH_REFRESH_Pos)) /* Assignment of value for REFRESH in the QSPI_REFRESH register */
...
#define QSPI_WRACNT_NBWRA(value)              (QSPI_WRACNT_NBWRA_Msk & (_UINT32_(value) << QSPI_WRACNT_NBWRA_Pos)) /* Assignment of value for NBWRA in the QSPI_WRACNT register */
...
#define QSPI_DLLCFG_RESETVALUE                _UINT32_(0x00)                                       /*  (QSPI_DLLCFG) DLL Configuration Register  Reset Value */

#define QSPI_DLLCFG_RANGE_Pos                 _UINT32_(0)                                          /* (QSPI_DLLCFG) DLL Range Position */
#define QSPI_DLLCFG_RANGE_Msk                 (_UINT32_(0x1) << QSPI_DLLCFG_RANGE_Pos)             /* (QSPI_DLLCFG) DLL Range Mask */
#define QSPI_DLLCFG_RANGE(value)              (QSPI_DLLCFG_RANGE_Msk & (_UINT32_(value) << QSPI_DLLCFG_RANGE_Pos)) /* Assignment of value for RANGE in the QSPI_DLLCFG register */
#define   QSPI_DLLCFG_RANGE_0_Val             _UINT32_(0x0)                                        /* (QSPI_DLLCFG) The QSPI core clock runs at 25 MHz to 100 MHz.  */
#define   QSPI_DLLCFG_RANGE_1_Val             _UINT32_(0x1)                                        /* (QSPI_DLLCFG) The QSPI core clock runs at 50 MHz to 208 MHz.  */
#define QSPI_DLLCFG_RANGE_0                   (QSPI_DLLCFG_RANGE_0_Val << QSPI_DLLCFG_RANGE_Pos)   /* (QSPI_DLLCFG) The QSPI core clock runs at 25 MHz to 100 MHz. Position */
#define QSPI_DLLCFG_RANGE_1                   (QSPI_DLLCFG_RANGE_1_Val << QSPI_DLLCFG_RANGE_Pos)   /* (QSPI_DLLCFG) The QSPI core clock runs at 50 MHz to 208 MHz. Position */
#define QSPI_DLLCFG_Msk                       _UINT32_(0x00000001)                                 /* (QSPI_DLLCFG) Register Mask  */
...
#define QSPI_PCALCFG_AAON(value)              (QSPI_PCALCFG_AAON_Msk & (_UINT32_(value) << QSPI_PCALCFG_AAON_Pos)) /* Assignment of value for AAON in the QSPI_PCALCFG register */
...
#define QSPI_PCALCFG_DAPCAL(value)            (QSPI_PCALCFG_DAPCAL_Msk & (_UINT32_(value) << QSPI_PCALCFG_DAPCAL_Pos)) /* Assignment of value for DAPCAL in the QSPI_PCALCFG register */
...
#define QSPI_PCALCFG_DIFFPM(value)            (QSPI_PCALCFG_DIFFPM_Msk & (_UINT32_(value) << QSPI_PCALCFG_DIFFPM_Pos)) /* Assignment of value for DIFFPM in the QSPI_PCALCFG register */
...
#define QSPI_PCALCFG_CLKDIV(value)            (QSPI_PCALCFG_CLKDIV_Msk & (_UINT32_(value) << QSPI_PCALCFG_CLKDIV_Pos)) /* Assignment of value for CLKDIV in the QSPI_PCALCFG register */
...
#define QSPI_PCALCFG_CALCNT(value)            (QSPI_PCALCFG_CALCNT_Msk & (_UINT32_(value) << QSPI_PCALCFG_CALCNT_Pos)) /* Assignment of value for CALCNT in the QSPI_PCALCFG register */
...
#define QSPI_PCALCFG_CALP(value)              (QSPI_PCALCFG_CALP_Msk & (_UINT32_(value) << QSPI_PCALCFG_CALP_Pos)) /* Assignment of value for CALP in the QSPI_PCALCFG register */
...
#define QSPI_PCALCFG_CALN(value)              (QSPI_PCALCFG_CALN_Msk & (_UINT32_(value) << QSPI_PCALCFG_CALN_Pos)) /* Assignment of value for CALN in the QSPI_PCALCFG register */
...
#define QSPI_PCALBP_BPEN(value)               (QSPI_PCALBP_BPEN_Msk & (_UINT32_(value) << QSPI_PCALBP_BPEN_Pos)) /* Assignment of value for BPEN in the QSPI_PCALBP register */
...
#define QSPI_PCALBP_CALPBP(value)             (QSPI_PCALBP_CALPBP_Msk & (_UINT32_(value) << QSPI_PCALBP_CALPBP_Pos)) /* Assignment of value for CALPBP in the QSPI_PCALBP register */
...
#define QSPI_PCALBP_CALNBP(value)             (QSPI_PCALBP_CALNBP_Msk & (_UINT32_(value) << QSPI_PCALBP_CALNBP_Pos)) /* Assignment of value for CALNBP in the QSPI_PCALBP register */
...
#define QSPI_TOUT_TCNTM(value)                (QSPI_TOUT_TCNTM_Msk & (_UINT32_(value) << QSPI_TOUT_TCNTM_Pos)) /* Assignment of value for TCNTM in the QSPI_TOUT register */
...
#define QSPI_WPMR_WPITEN(value)               (QSPI_WPMR_WPITEN_Msk & (_UINT32_(value) << QSPI_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the QSPI_WPMR register */
...
#define QSPI_WPMR_WPCREN(value)               (QSPI_WPMR_WPCREN_Msk & (_UINT32_(value) << QSPI_WPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the QSPI_WPMR register */
...
#define QSPI_DLLCFG_REG_OFST           _UINT32_(0x58)      /* (QSPI_DLLCFG) DLL Configuration Register Offset */
...
#endif /* _SAMA7G5_QSPI_COMPONENT_H_ */
