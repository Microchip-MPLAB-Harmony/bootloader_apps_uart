...
#ifndef _SAMA7G5_PMC_COMPONENT_H_
#define _SAMA7G5_PMC_COMPONENT_H_
...
#define PMC_SCER_Msk                          _UINT32_(0x0000FF00)                                 /* (PMC_SCER) Register Mask  */
...
#define PMC_SCDR_Msk                          _UINT32_(0x0000FF00)                                 /* (PMC_SCDR) Register Mask  */
...
#define PMC_SCSR_Msk                          _UINT32_(0x0000FF00)                                 /* (PMC_SCSR) Register Mask  */
...
#define PMC_PLL_CTRL0_DIVPMC(value)           (PMC_PLL_CTRL0_DIVPMC_Msk & (_UINT32_(value) << PMC_PLL_CTRL0_DIVPMC_Pos)) /* Assignment of value for DIVPMC in the PMC_PLL_CTRL0 register */
...
#define PMC_PLL_CTRL0_DIVIO(value)            (PMC_PLL_CTRL0_DIVIO_Msk & (_UINT32_(value) << PMC_PLL_CTRL0_DIVIO_Pos)) /* Assignment of value for DIVIO in the PMC_PLL_CTRL0 register */
...
#define PMC_PLL_CTRL0_ENPLL(value)            (PMC_PLL_CTRL0_ENPLL_Msk & (_UINT32_(value) << PMC_PLL_CTRL0_ENPLL_Pos)) /* Assignment of value for ENPLL in the PMC_PLL_CTRL0 register */
...
#define PMC_PLL_CTRL0_ENPLLCK(value)          (PMC_PLL_CTRL0_ENPLLCK_Msk & (_UINT32_(value) << PMC_PLL_CTRL0_ENPLLCK_Pos)) /* Assignment of value for ENPLLCK in the PMC_PLL_CTRL0 register */
...
#define PMC_PLL_CTRL0_ENIOPLLCK(value)        (PMC_PLL_CTRL0_ENIOPLLCK_Msk & (_UINT32_(value) << PMC_PLL_CTRL0_ENIOPLLCK_Pos)) /* Assignment of value for ENIOPLLCK in the PMC_PLL_CTRL0 register */
...
#define PMC_PLL_CTRL0_ENLOCK(value)           (PMC_PLL_CTRL0_ENLOCK_Msk & (_UINT32_(value) << PMC_PLL_CTRL0_ENLOCK_Pos)) /* Assignment of value for ENLOCK in the PMC_PLL_CTRL0 register */
...
#define PMC_PLL_CTRL1_FRACR(value)            (PMC_PLL_CTRL1_FRACR_Msk & (_UINT32_(value) << PMC_PLL_CTRL1_FRACR_Pos)) /* Assignment of value for FRACR in the PMC_PLL_CTRL1 register */
...
#define PMC_PLL_CTRL1_MUL(value)              (PMC_PLL_CTRL1_MUL_Msk & (_UINT32_(value) << PMC_PLL_CTRL1_MUL_Pos)) /* Assignment of value for MUL in the PMC_PLL_CTRL1 register */
...
#define PMC_PLL_SSR_STEP(value)               (PMC_PLL_SSR_STEP_Msk & (_UINT32_(value) << PMC_PLL_SSR_STEP_Pos)) /* Assignment of value for STEP in the PMC_PLL_SSR register */
...
#define PMC_PLL_SSR_NSTEP(value)              (PMC_PLL_SSR_NSTEP_Msk & (_UINT32_(value) << PMC_PLL_SSR_NSTEP_Pos)) /* Assignment of value for NSTEP in the PMC_PLL_SSR register */
...
#define PMC_PLL_SSR_ENSPREAD(value)           (PMC_PLL_SSR_ENSPREAD_Msk & (_UINT32_(value) << PMC_PLL_SSR_ENSPREAD_Pos)) /* Assignment of value for ENSPREAD in the PMC_PLL_SSR register */
...
#define PMC_PLL_ACR_CONTROL(value)            (PMC_PLL_ACR_CONTROL_Msk & (_UINT32_(value) << PMC_PLL_ACR_CONTROL_Pos)) /* Assignment of value for CONTROL in the PMC_PLL_ACR register */
...
#define PMC_PLL_ACR_LOCK_THR(value)           (PMC_PLL_ACR_LOCK_THR_Msk & (_UINT32_(value) << PMC_PLL_ACR_LOCK_THR_Pos)) /* Assignment of value for LOCK_THR in the PMC_PLL_ACR register */
...
#define PMC_PLL_ACR_LOOP_FILTER(value)        (PMC_PLL_ACR_LOOP_FILTER_Msk & (_UINT32_(value) << PMC_PLL_ACR_LOOP_FILTER_Pos)) /* Assignment of value for LOOP_FILTER in the PMC_PLL_ACR register */
#define PMC_PLL_ACR_Msk                       _UINT32_(0x3F070FFF)                                 /* (PMC_PLL_ACR) Register Mask  */
...
#define PMC_PLL_UPDT_ID(value)                (PMC_PLL_UPDT_ID_Msk & (_UINT32_(value) << PMC_PLL_UPDT_ID_Pos)) /* Assignment of value for ID in the PMC_PLL_UPDT register */
...
#define PMC_PLL_UPDT_UPDATE(value)            (PMC_PLL_UPDT_UPDATE_Msk & (_UINT32_(value) << PMC_PLL_UPDT_UPDATE_Pos)) /* Assignment of value for UPDATE in the PMC_PLL_UPDT register */
...
#define PMC_PLL_UPDT_STUPTIM(value)           (PMC_PLL_UPDT_STUPTIM_Msk & (_UINT32_(value) << PMC_PLL_UPDT_STUPTIM_Pos)) /* Assignment of value for STUPTIM in the PMC_PLL_UPDT register */
...
#define CKGR_MOR_ULP1(value)                  (CKGR_MOR_ULP1_Msk & (_UINT32_(value) << CKGR_MOR_ULP1_Pos)) /* Assignment of value for ULP1 in the CKGR_MOR register */
...
#define CKGR_MOR_AUTOMAINSW(value)            (CKGR_MOR_AUTOMAINSW_Msk & (_UINT32_(value) << CKGR_MOR_AUTOMAINSW_Pos)) /* Assignment of value for AUTOMAINSW in the CKGR_MOR register */
...
#define CKGR_MOR_AUTOCPUSW(value)             (CKGR_MOR_AUTOCPUSW_Msk & (_UINT32_(value) << CKGR_MOR_AUTOCPUSW_Pos)) /* Assignment of value for AUTOCPUSW in the CKGR_MOR register */
...
#define PMC_CPU_CKR_CSS(value)                (PMC_CPU_CKR_CSS_Msk & (_UINT32_(value) << PMC_CPU_CKR_CSS_Pos)) /* Assignment of value for CSS in the PMC_CPU_CKR register */
...
#define PMC_CPU_CKR_PRES(value)               (PMC_CPU_CKR_PRES_Msk & (_UINT32_(value) << PMC_CPU_CKR_PRES_Pos)) /* Assignment of value for PRES in the PMC_CPU_CKR register */
...
#define PMC_CPU_CKR_MDIV(value)               (PMC_CPU_CKR_MDIV_Msk & (_UINT32_(value) << PMC_CPU_CKR_MDIV_Pos)) /* Assignment of value for MDIV in the PMC_CPU_CKR register */
...
#define PMC_CPU_RATIO_RATIO(value)            (PMC_CPU_RATIO_RATIO_Msk & (_UINT32_(value) << PMC_CPU_RATIO_RATIO_Pos)) /* Assignment of value for RATIO in the PMC_CPU_RATIO register */
...
#define PMC_MCR_ID(value)                     (PMC_MCR_ID_Msk & (_UINT32_(value) << PMC_MCR_ID_Pos)) /* Assignment of value for ID in the PMC_MCR register */
...
#define PMC_MCR_CMD(value)                    (PMC_MCR_CMD_Msk & (_UINT32_(value) << PMC_MCR_CMD_Pos)) /* Assignment of value for CMD in the PMC_MCR register */
...
#define PMC_MCR_DIV(value)                    (PMC_MCR_DIV_Msk & (_UINT32_(value) << PMC_MCR_DIV_Pos)) /* Assignment of value for DIV in the PMC_MCR register */
...
#define PMC_MCR_CSS(value)                    (PMC_MCR_CSS_Msk & (_UINT32_(value) << PMC_MCR_CSS_Pos)) /* Assignment of value for CSS in the PMC_MCR register */
...
#define   PMC_MCR_CSS_IMGPLL_Val              _UINT32_(0x7)                                        /* (PMC_MCR) IMGPLL is selected.  */
#define   PMC_MCR_CSS_BAUDPLL_Val             _UINT32_(0x8)                                        /* (PMC_MCR) BAUDPLL is selected.  */
#define   PMC_MCR_CSS_AUDIOPLL_Val            _UINT32_(0x9)                                        /* (PMC_MCR) AUDIOPLL is selected.  */
#define   PMC_MCR_CSS_ETHPLL_Val              _UINT32_(0xA)                                        /* (PMC_MCR) ETHPLL is selected.  */
...
#define PMC_MCR_EN(value)                     (PMC_MCR_EN_Msk & (_UINT32_(value) << PMC_MCR_EN_Pos)) /* Assignment of value for EN in the PMC_MCR register */
...
#define PMC_XTALF_XTALF(value)                (PMC_XTALF_XTALF_Msk & (_UINT32_(value) << PMC_XTALF_XTALF_Pos)) /* Assignment of value for XTALF in the PMC_XTALF register */
...
#define   PMC_PCK_CSS_DDRPLL_Val              _UINT32_(0x6)                                        /* (PMC_PCK) DDRPLL is selected.  */
#define   PMC_PCK_CSS_IMGPLL_Val              _UINT32_(0x7)                                        /* (PMC_PCK) IMGPLL is selected.  */
...
#define PMC_IER_MCKMON(value)                 (PMC_IER_MCKMON_Msk & (_UINT32_(value) << PMC_IER_MCKMON_Pos)) /* Assignment of value for MCKMON in the PMC_IER register */
...
#define PMC_IDR_MCKMON(value)                 (PMC_IDR_MCKMON_Msk & (_UINT32_(value) << PMC_IDR_MCKMON_Pos)) /* Assignment of value for MCKMON in the PMC_IDR register */
...
#define PMC_SR_MCKMON(value)                  (PMC_SR_MCKMON_Msk & (_UINT32_(value) << PMC_SR_MCKMON_Pos)) /* Assignment of value for MCKMON in the PMC_SR register */
...
#define PMC_SR_GCLKRDY(value)                 (PMC_SR_GCLKRDY_Msk & (_UINT32_(value) << PMC_SR_GCLKRDY_Pos)) /* Assignment of value for GCLKRDY in the PMC_SR register */
...
#define PMC_SR_PLL_INT(value)                 (PMC_SR_PLL_INT_Msk & (_UINT32_(value) << PMC_SR_PLL_INT_Pos)) /* Assignment of value for PLL_INT in the PMC_SR register */
...
#define PMC_IMR_MCKMON(value)                 (PMC_IMR_MCKMON_Msk & (_UINT32_(value) << PMC_IMR_MCKMON_Pos)) /* Assignment of value for MCKMON in the PMC_IMR register */
...
#define PMC_FSMR_HSDHC(value)                 (PMC_FSMR_HSDHC_Msk & (_UINT32_(value) << PMC_FSMR_HSDHC_Pos)) /* Assignment of value for HSDHC in the PMC_FSMR register */
...
#define PMC_FSMR_Msk                          _UINT32_(0x000F0000)                                 /* (PMC_FSMR) Register Mask  */
...
#define PMC_WCR_WKPIONB(value)                (PMC_WCR_WKPIONB_Msk & (_UINT32_(value) << PMC_WCR_WKPIONB_Pos)) /* Assignment of value for WKPIONB in the PMC_WCR register */
...
#define PMC_WCR_EN(value)                     (PMC_WCR_EN_Msk & (_UINT32_(value) << PMC_WCR_EN_Pos)) /* Assignment of value for EN in the PMC_WCR register */
...
#define PMC_WCR_WIP(value)                    (PMC_WCR_WIP_Msk & (_UINT32_(value) << PMC_WCR_WIP_Pos)) /* Assignment of value for WIP in the PMC_WCR register */
...
#define PMC_WCR_CMD(value)                    (PMC_WCR_CMD_Msk & (_UINT32_(value) << PMC_WCR_CMD_Pos)) /* Assignment of value for CMD in the PMC_WCR register */
...
#define PMC_WPMR_WPITEN(value)                (PMC_WPMR_WPITEN_Msk & (_UINT32_(value) << PMC_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the PMC_WPMR register */
...
#define   PMC_PCR_GCLKCSS_IMGPLL_Val          _UINT32_(0x7)                                        /* (PMC_PCR) IMGPLL is selected.  */
...
#define PMC_PCR_MCKID_Pos                     _UINT32_(16)                                         /* (PMC_PCR) Main System Bus Clock Index (Read-only) Position */
#define PMC_PCR_MCKID_Msk                     (_UINT32_(0xF) << PMC_PCR_MCKID_Pos)                 /* (PMC_PCR) Main System Bus Clock Index (Read-only) Mask */
#define PMC_PCR_MCKID(value)                  (PMC_PCR_MCKID_Msk & (_UINT32_(value) << PMC_PCR_MCKID_Pos)) /* Assignment of value for MCKID in the PMC_PCR register */
...
#define   PMC_SLPWK_AIPR_AIP_1_Val            _UINT32_(0x1)                                        /* (PMC_SLPWK_AIPR) One or more peripherals are currently active. The device must not enter ULP1 mode if the asynchronous partial wake-up is enabled for one of the following PIDs: FLEXCOMx, and ADCC.  */
...
#define PMC_SLPWK_AIPR_AIP_1                  (PMC_SLPWK_AIPR_AIP_1_Val << PMC_SLPWK_AIPR_AIP_Pos) /* (PMC_SLPWK_AIPR) One or more peripherals are currently active. The device must not enter ULP1 mode if the asynchronous partial wake-up is enabled for one of the following PIDs: FLEXCOMx, and ADCC. Position */
...
#define PMC_SLPWKCR_PID(value)                (PMC_SLPWKCR_PID_Msk & (_UINT32_(value) << PMC_SLPWKCR_PID_Pos)) /* Assignment of value for PID in the PMC_SLPWKCR register */
...
#define PMC_SLPWKCR_CMD(value)                (PMC_SLPWKCR_CMD_Msk & (_UINT32_(value) << PMC_SLPWKCR_CMD_Pos)) /* Assignment of value for CMD in the PMC_SLPWKCR register */
...
#define PMC_SLPWKCR_ASR(value)                (PMC_SLPWKCR_ASR_Msk & (_UINT32_(value) << PMC_SLPWKCR_ASR_Pos)) /* Assignment of value for ASR in the PMC_SLPWKCR register */
...
#define PMC_SLPWKCR_SLPWKSR(value)            (PMC_SLPWKCR_SLPWKSR_Msk & (_UINT32_(value) << PMC_SLPWKCR_SLPWKSR_Pos)) /* Assignment of value for SLPWKSR in the PMC_SLPWKCR register */
...
#define PMC_MCKLIM_MCK_LOW_IT(value)          (PMC_MCKLIM_MCK_LOW_IT_Msk & (_UINT32_(value) << PMC_MCKLIM_MCK_LOW_IT_Pos)) /* Assignment of value for MCK_LOW_IT in the PMC_MCKLIM register */
...
#define PMC_MCKLIM_MCK_HIGH_IT(value)         (PMC_MCKLIM_MCK_HIGH_IT_Msk & (_UINT32_(value) << PMC_MCKLIM_MCK_HIGH_IT_Pos)) /* Assignment of value for MCK_HIGH_IT in the PMC_MCKLIM register */
...
#define PMC_CSR0_PID11(value)                 (PMC_CSR0_PID11_Msk & (_UINT32_(value) << PMC_CSR0_PID11_Pos)) /* Assignment of value for PID11 in the PMC_CSR0 register */
...
#define PMC_CSR0_PID19(value)                 (PMC_CSR0_PID19_Msk & (_UINT32_(value) << PMC_CSR0_PID19_Pos)) /* Assignment of value for PID19 in the PMC_CSR0 register */
...
#define PMC_CSR0_PID21(value)                 (PMC_CSR0_PID21_Msk & (_UINT32_(value) << PMC_CSR0_PID21_Pos)) /* Assignment of value for PID21 in the PMC_CSR0 register */
...
#define PMC_CSR0_PID22(value)                 (PMC_CSR0_PID22_Msk & (_UINT32_(value) << PMC_CSR0_PID22_Pos)) /* Assignment of value for PID22 in the PMC_CSR0 register */
...
#define PMC_CSR0_PID23(value)                 (PMC_CSR0_PID23_Msk & (_UINT32_(value) << PMC_CSR0_PID23_Pos)) /* Assignment of value for PID23 in the PMC_CSR0 register */
...
#define PMC_CSR0_PID24(value)                 (PMC_CSR0_PID24_Msk & (_UINT32_(value) << PMC_CSR0_PID24_Pos)) /* Assignment of value for PID24 in the PMC_CSR0 register */
...
#define PMC_CSR0_PID25(value)                 (PMC_CSR0_PID25_Msk & (_UINT32_(value) << PMC_CSR0_PID25_Pos)) /* Assignment of value for PID25 in the PMC_CSR0 register */
...
#define PMC_CSR0_PID27(value)                 (PMC_CSR0_PID27_Msk & (_UINT32_(value) << PMC_CSR0_PID27_Pos)) /* Assignment of value for PID27 in the PMC_CSR0 register */
...
#define PMC_CSR0_PID28(value)                 (PMC_CSR0_PID28_Msk & (_UINT32_(value) << PMC_CSR0_PID28_Pos)) /* Assignment of value for PID28 in the PMC_CSR0 register */
...
#define PMC_CSR0_PID30(value)                 (PMC_CSR0_PID30_Msk & (_UINT32_(value) << PMC_CSR0_PID30_Pos)) /* Assignment of value for PID30 in the PMC_CSR0 register */
...
#define PMC_CSR0_Msk                          _UINT32_(0x5BE80800)                                 /* (PMC_CSR0) Register Mask  */

#define PMC_CSR0_PID_Pos                      _UINT32_(11)                                         /* (PMC_CSR0 Position) Peripheral Clock 3x Status */
#define PMC_CSR0_PID_Msk                      (_UINT32_(0x3FF) << PMC_CSR0_PID_Pos)                /* (PMC_CSR0 Mask) PID */
...
#define PMC_CSR1_PID32(value)                 (PMC_CSR1_PID32_Msk & (_UINT32_(value) << PMC_CSR1_PID32_Pos)) /* Assignment of value for PID32 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID33(value)                 (PMC_CSR1_PID33_Msk & (_UINT32_(value) << PMC_CSR1_PID33_Pos)) /* Assignment of value for PID33 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID34(value)                 (PMC_CSR1_PID34_Msk & (_UINT32_(value) << PMC_CSR1_PID34_Pos)) /* Assignment of value for PID34 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID37(value)                 (PMC_CSR1_PID37_Msk & (_UINT32_(value) << PMC_CSR1_PID37_Pos)) /* Assignment of value for PID37 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID38(value)                 (PMC_CSR1_PID38_Msk & (_UINT32_(value) << PMC_CSR1_PID38_Pos)) /* Assignment of value for PID38 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID39(value)                 (PMC_CSR1_PID39_Msk & (_UINT32_(value) << PMC_CSR1_PID39_Pos)) /* Assignment of value for PID39 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID40(value)                 (PMC_CSR1_PID40_Msk & (_UINT32_(value) << PMC_CSR1_PID40_Pos)) /* Assignment of value for PID40 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID41(value)                 (PMC_CSR1_PID41_Msk & (_UINT32_(value) << PMC_CSR1_PID41_Pos)) /* Assignment of value for PID41 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID42(value)                 (PMC_CSR1_PID42_Msk & (_UINT32_(value) << PMC_CSR1_PID42_Pos)) /* Assignment of value for PID42 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID43(value)                 (PMC_CSR1_PID43_Msk & (_UINT32_(value) << PMC_CSR1_PID43_Pos)) /* Assignment of value for PID43 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID44(value)                 (PMC_CSR1_PID44_Msk & (_UINT32_(value) << PMC_CSR1_PID44_Pos)) /* Assignment of value for PID44 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID45(value)                 (PMC_CSR1_PID45_Msk & (_UINT32_(value) << PMC_CSR1_PID45_Pos)) /* Assignment of value for PID45 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID46(value)                 (PMC_CSR1_PID46_Msk & (_UINT32_(value) << PMC_CSR1_PID46_Pos)) /* Assignment of value for PID46 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID47(value)                 (PMC_CSR1_PID47_Msk & (_UINT32_(value) << PMC_CSR1_PID47_Pos)) /* Assignment of value for PID47 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID48(value)                 (PMC_CSR1_PID48_Msk & (_UINT32_(value) << PMC_CSR1_PID48_Pos)) /* Assignment of value for PID48 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID49(value)                 (PMC_CSR1_PID49_Msk & (_UINT32_(value) << PMC_CSR1_PID49_Pos)) /* Assignment of value for PID49 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID51(value)                 (PMC_CSR1_PID51_Msk & (_UINT32_(value) << PMC_CSR1_PID51_Pos)) /* Assignment of value for PID51 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID52(value)                 (PMC_CSR1_PID52_Msk & (_UINT32_(value) << PMC_CSR1_PID52_Pos)) /* Assignment of value for PID52 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID55(value)                 (PMC_CSR1_PID55_Msk & (_UINT32_(value) << PMC_CSR1_PID55_Pos)) /* Assignment of value for PID55 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID56(value)                 (PMC_CSR1_PID56_Msk & (_UINT32_(value) << PMC_CSR1_PID56_Pos)) /* Assignment of value for PID56 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID57(value)                 (PMC_CSR1_PID57_Msk & (_UINT32_(value) << PMC_CSR1_PID57_Pos)) /* Assignment of value for PID57 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID58(value)                 (PMC_CSR1_PID58_Msk & (_UINT32_(value) << PMC_CSR1_PID58_Pos)) /* Assignment of value for PID58 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID60(value)                 (PMC_CSR1_PID60_Msk & (_UINT32_(value) << PMC_CSR1_PID60_Pos)) /* Assignment of value for PID60 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID61(value)                 (PMC_CSR1_PID61_Msk & (_UINT32_(value) << PMC_CSR1_PID61_Pos)) /* Assignment of value for PID61 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID62(value)                 (PMC_CSR1_PID62_Msk & (_UINT32_(value) << PMC_CSR1_PID62_Pos)) /* Assignment of value for PID62 in the PMC_CSR1 register */
...
#define PMC_CSR1_PID63(value)                 (PMC_CSR1_PID63_Msk & (_UINT32_(value) << PMC_CSR1_PID63_Pos)) /* Assignment of value for PID63 in the PMC_CSR1 register */
#define   PMC_CSR1_PID63_0_Val                _UINT32_(0x0)                                        /* (PMC_CSR1) The corresponding peripheral clock is disabled.  */
#define   PMC_CSR1_PID63_1_Val                _UINT32_(0x1)                                        /* (PMC_CSR1) The corresponding peripheral clock is enabled.  */
...
#define PMC_CSR1_Msk                          _UINT32_(0xF79BFFE7)                                 /* (PMC_CSR1) Register Mask  */

#define PMC_CSR1_PID_Pos                      _UINT32_(0)                                          /* (PMC_CSR1 Position) Peripheral Clock 63 Status */
#define PMC_CSR1_PID_Msk                      (_UINT32_(0x3FFFFFF) << PMC_CSR1_PID_Pos)            /* (PMC_CSR1 Mask) PID */
...
#define PMC_CSR2_PID64(value)                 (PMC_CSR2_PID64_Msk & (_UINT32_(value) << PMC_CSR2_PID64_Pos)) /* Assignment of value for PID64 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID65(value)                 (PMC_CSR2_PID65_Msk & (_UINT32_(value) << PMC_CSR2_PID65_Pos)) /* Assignment of value for PID65 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID66(value)                 (PMC_CSR2_PID66_Msk & (_UINT32_(value) << PMC_CSR2_PID66_Pos)) /* Assignment of value for PID66 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID68(value)                 (PMC_CSR2_PID68_Msk & (_UINT32_(value) << PMC_CSR2_PID68_Pos)) /* Assignment of value for PID68 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID69(value)                 (PMC_CSR2_PID69_Msk & (_UINT32_(value) << PMC_CSR2_PID69_Pos)) /* Assignment of value for PID69 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID70(value)                 (PMC_CSR2_PID70_Msk & (_UINT32_(value) << PMC_CSR2_PID70_Pos)) /* Assignment of value for PID70 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID71(value)                 (PMC_CSR2_PID71_Msk & (_UINT32_(value) << PMC_CSR2_PID71_Pos)) /* Assignment of value for PID71 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID72(value)                 (PMC_CSR2_PID72_Msk & (_UINT32_(value) << PMC_CSR2_PID72_Pos)) /* Assignment of value for PID72 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID73(value)                 (PMC_CSR2_PID73_Msk & (_UINT32_(value) << PMC_CSR2_PID73_Pos)) /* Assignment of value for PID73 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID74(value)                 (PMC_CSR2_PID74_Msk & (_UINT32_(value) << PMC_CSR2_PID74_Pos)) /* Assignment of value for PID74 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID75(value)                 (PMC_CSR2_PID75_Msk & (_UINT32_(value) << PMC_CSR2_PID75_Pos)) /* Assignment of value for PID75 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID77(value)                 (PMC_CSR2_PID77_Msk & (_UINT32_(value) << PMC_CSR2_PID77_Pos)) /* Assignment of value for PID77 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID78(value)                 (PMC_CSR2_PID78_Msk & (_UINT32_(value) << PMC_CSR2_PID78_Pos)) /* Assignment of value for PID78 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID79(value)                 (PMC_CSR2_PID79_Msk & (_UINT32_(value) << PMC_CSR2_PID79_Pos)) /* Assignment of value for PID79 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID80(value)                 (PMC_CSR2_PID80_Msk & (_UINT32_(value) << PMC_CSR2_PID80_Pos)) /* Assignment of value for PID80 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID81(value)                 (PMC_CSR2_PID81_Msk & (_UINT32_(value) << PMC_CSR2_PID81_Pos)) /* Assignment of value for PID81 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID82(value)                 (PMC_CSR2_PID82_Msk & (_UINT32_(value) << PMC_CSR2_PID82_Pos)) /* Assignment of value for PID82 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID83(value)                 (PMC_CSR2_PID83_Msk & (_UINT32_(value) << PMC_CSR2_PID83_Pos)) /* Assignment of value for PID83 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID84(value)                 (PMC_CSR2_PID84_Msk & (_UINT32_(value) << PMC_CSR2_PID84_Pos)) /* Assignment of value for PID84 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID85(value)                 (PMC_CSR2_PID85_Msk & (_UINT32_(value) << PMC_CSR2_PID85_Pos)) /* Assignment of value for PID85 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID86(value)                 (PMC_CSR2_PID86_Msk & (_UINT32_(value) << PMC_CSR2_PID86_Pos)) /* Assignment of value for PID86 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID87(value)                 (PMC_CSR2_PID87_Msk & (_UINT32_(value) << PMC_CSR2_PID87_Pos)) /* Assignment of value for PID87 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID88(value)                 (PMC_CSR2_PID88_Msk & (_UINT32_(value) << PMC_CSR2_PID88_Pos)) /* Assignment of value for PID88 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID89(value)                 (PMC_CSR2_PID89_Msk & (_UINT32_(value) << PMC_CSR2_PID89_Pos)) /* Assignment of value for PID89 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID90(value)                 (PMC_CSR2_PID90_Msk & (_UINT32_(value) << PMC_CSR2_PID90_Pos)) /* Assignment of value for PID90 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID91(value)                 (PMC_CSR2_PID91_Msk & (_UINT32_(value) << PMC_CSR2_PID91_Pos)) /* Assignment of value for PID91 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID92(value)                 (PMC_CSR2_PID92_Msk & (_UINT32_(value) << PMC_CSR2_PID92_Pos)) /* Assignment of value for PID92 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID93(value)                 (PMC_CSR2_PID93_Msk & (_UINT32_(value) << PMC_CSR2_PID93_Pos)) /* Assignment of value for PID93 in the PMC_CSR2 register */
...
#define PMC_CSR2_PID94(value)                 (PMC_CSR2_PID94_Msk & (_UINT32_(value) << PMC_CSR2_PID94_Pos)) /* Assignment of value for PID94 in the PMC_CSR2 register */
#define   PMC_CSR2_PID94_0_Val                _UINT32_(0x0)                                        /* (PMC_CSR2) The corresponding peripheral clock is disabled.  */
#define   PMC_CSR2_PID94_1_Val                _UINT32_(0x1)                                        /* (PMC_CSR2) The corresponding peripheral clock is enabled.  */
...
#define PMC_CSR2_PID95(value)                 (PMC_CSR2_PID95_Msk & (_UINT32_(value) << PMC_CSR2_PID95_Pos)) /* Assignment of value for PID95 in the PMC_CSR2 register */
#define   PMC_CSR2_PID95_0_Val                _UINT32_(0x0)                                        /* (PMC_CSR2) The corresponding peripheral clock is disabled.  */
#define   PMC_CSR2_PID95_1_Val                _UINT32_(0x1)                                        /* (PMC_CSR2) The corresponding peripheral clock is enabled.  */
...
#define PMC_CSR2_Msk                          _UINT32_(0xFFFFEFF7)                                 /* (PMC_CSR2) Register Mask  */
...
#define PMC_CSR3_PID96(value)                 (PMC_CSR3_PID96_Msk & (_UINT32_(value) << PMC_CSR3_PID96_Pos)) /* Assignment of value for PID96 in the PMC_CSR3 register */
#define   PMC_CSR3_PID96_0_Val                _UINT32_(0x0)                                        /* (PMC_CSR3) The corresponding peripheral clock is disabled.  */
#define   PMC_CSR3_PID96_1_Val                _UINT32_(0x1)                                        /* (PMC_CSR3) The corresponding peripheral clock is enabled.  */
...
#define PMC_CSR3_PID97(value)                 (PMC_CSR3_PID97_Msk & (_UINT32_(value) << PMC_CSR3_PID97_Pos)) /* Assignment of value for PID97 in the PMC_CSR3 register */
#define   PMC_CSR3_PID97_0_Val                _UINT32_(0x0)                                        /* (PMC_CSR3) The corresponding peripheral clock is disabled.  */
#define   PMC_CSR3_PID97_1_Val                _UINT32_(0x1)                                        /* (PMC_CSR3) The corresponding peripheral clock is enabled.  */
...
#define PMC_CSR3_PID98(value)                 (PMC_CSR3_PID98_Msk & (_UINT32_(value) << PMC_CSR3_PID98_Pos)) /* Assignment of value for PID98 in the PMC_CSR3 register */
#define   PMC_CSR3_PID98_0_Val                _UINT32_(0x0)                                        /* (PMC_CSR3) The corresponding peripheral clock is disabled.  */
#define   PMC_CSR3_PID98_1_Val                _UINT32_(0x1)                                        /* (PMC_CSR3) The corresponding peripheral clock is enabled.  */
...
#define PMC_CSR3_PID104(value)                (PMC_CSR3_PID104_Msk & (_UINT32_(value) << PMC_CSR3_PID104_Pos)) /* Assignment of value for PID104 in the PMC_CSR3 register */
...
#define PMC_CSR3_PID105(value)                (PMC_CSR3_PID105_Msk & (_UINT32_(value) << PMC_CSR3_PID105_Pos)) /* Assignment of value for PID105 in the PMC_CSR3 register */
...
#define PMC_CSR3_PID106(value)                (PMC_CSR3_PID106_Msk & (_UINT32_(value) << PMC_CSR3_PID106_Pos)) /* Assignment of value for PID106 in the PMC_CSR3 register */
#define   PMC_CSR3_PID106_0_Val               _UINT32_(0x0)                                        /* (PMC_CSR3) The corresponding peripheral clock is disabled.  */
#define   PMC_CSR3_PID106_1_Val               _UINT32_(0x1)                                        /* (PMC_CSR3) The corresponding peripheral clock is enabled.  */
...
#define PMC_CSR3_Msk                          _UINT32_(0x00000707)                                 /* (PMC_CSR3) Register Mask  */

#define PMC_CSR3_PID_Pos                      _UINT32_(0)                                          /* (PMC_CSR3 Position) Peripheral Clock xx6 Status */
#define PMC_CSR3_PID_Msk                      (_UINT32_(0x3F) << PMC_CSR3_PID_Pos)                 /* (PMC_CSR3 Mask) PID */
...
#define PMC_GCSR0_GPID26(value)               (PMC_GCSR0_GPID26_Msk & (_UINT32_(value) << PMC_GCSR0_GPID26_Pos)) /* Assignment of value for GPID26 in the PMC_GCSR0 register */
...
#define PMC_GCSR0_GPID29(value)               (PMC_GCSR0_GPID29_Msk & (_UINT32_(value) << PMC_GCSR0_GPID29_Pos)) /* Assignment of value for GPID29 in the PMC_GCSR0 register */
...
#define PMC_GCSR0_GPID30(value)               (PMC_GCSR0_GPID30_Msk & (_UINT32_(value) << PMC_GCSR0_GPID30_Pos)) /* Assignment of value for GPID30 in the PMC_GCSR0 register */
...
#define PMC_GCSR0_Msk                         _UINT32_(0x64000000)                                 /* (PMC_GCSR0) Register Mask  */

#define PMC_GCSR0_GPID_Pos                    _UINT32_(26)                                         /* (PMC_GCSR0 Position) Generic Clock 3x Status */
...
#define PMC_GCSR1_GPID33(value)               (PMC_GCSR1_GPID33_Msk & (_UINT32_(value) << PMC_GCSR1_GPID33_Pos)) /* Assignment of value for GPID33 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID38(value)               (PMC_GCSR1_GPID38_Msk & (_UINT32_(value) << PMC_GCSR1_GPID38_Pos)) /* Assignment of value for GPID38 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID39(value)               (PMC_GCSR1_GPID39_Msk & (_UINT32_(value) << PMC_GCSR1_GPID39_Pos)) /* Assignment of value for GPID39 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID40(value)               (PMC_GCSR1_GPID40_Msk & (_UINT32_(value) << PMC_GCSR1_GPID40_Pos)) /* Assignment of value for GPID40 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID41(value)               (PMC_GCSR1_GPID41_Msk & (_UINT32_(value) << PMC_GCSR1_GPID41_Pos)) /* Assignment of value for GPID41 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID42(value)               (PMC_GCSR1_GPID42_Msk & (_UINT32_(value) << PMC_GCSR1_GPID42_Pos)) /* Assignment of value for GPID42 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID43(value)               (PMC_GCSR1_GPID43_Msk & (_UINT32_(value) << PMC_GCSR1_GPID43_Pos)) /* Assignment of value for GPID43 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID44(value)               (PMC_GCSR1_GPID44_Msk & (_UINT32_(value) << PMC_GCSR1_GPID44_Pos)) /* Assignment of value for GPID44 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID45(value)               (PMC_GCSR1_GPID45_Msk & (_UINT32_(value) << PMC_GCSR1_GPID45_Pos)) /* Assignment of value for GPID45 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID46(value)               (PMC_GCSR1_GPID46_Msk & (_UINT32_(value) << PMC_GCSR1_GPID46_Pos)) /* Assignment of value for GPID46 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID47(value)               (PMC_GCSR1_GPID47_Msk & (_UINT32_(value) << PMC_GCSR1_GPID47_Pos)) /* Assignment of value for GPID47 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID48(value)               (PMC_GCSR1_GPID48_Msk & (_UINT32_(value) << PMC_GCSR1_GPID48_Pos)) /* Assignment of value for GPID48 in the PMC_GCSR1 register */
#define   PMC_GCSR1_GPID48_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR1) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR1_GPID48_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR1) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR1_GPID49(value)               (PMC_GCSR1_GPID49_Msk & (_UINT32_(value) << PMC_GCSR1_GPID49_Pos)) /* Assignment of value for GPID49 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID51(value)               (PMC_GCSR1_GPID51_Msk & (_UINT32_(value) << PMC_GCSR1_GPID51_Pos)) /* Assignment of value for GPID51 in the PMC_GCSR1 register */
#define   PMC_GCSR1_GPID51_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR1) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR1_GPID51_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR1) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR1_GPID52(value)               (PMC_GCSR1_GPID52_Msk & (_UINT32_(value) << PMC_GCSR1_GPID52_Pos)) /* Assignment of value for GPID52 in the PMC_GCSR1 register */
#define   PMC_GCSR1_GPID52_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR1) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR1_GPID52_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR1) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR1_GPID53(value)               (PMC_GCSR1_GPID53_Msk & (_UINT32_(value) << PMC_GCSR1_GPID53_Pos)) /* Assignment of value for GPID53 in the PMC_GCSR1 register */
#define   PMC_GCSR1_GPID53_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR1) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR1_GPID53_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR1) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR1_GPID54(value)               (PMC_GCSR1_GPID54_Msk & (_UINT32_(value) << PMC_GCSR1_GPID54_Pos)) /* Assignment of value for GPID54 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID57(value)               (PMC_GCSR1_GPID57_Msk & (_UINT32_(value) << PMC_GCSR1_GPID57_Pos)) /* Assignment of value for GPID57 in the PMC_GCSR1 register */
#define   PMC_GCSR1_GPID57_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR1) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR1_GPID57_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR1) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR1_GPID58(value)               (PMC_GCSR1_GPID58_Msk & (_UINT32_(value) << PMC_GCSR1_GPID58_Pos)) /* Assignment of value for GPID58 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID61(value)               (PMC_GCSR1_GPID61_Msk & (_UINT32_(value) << PMC_GCSR1_GPID61_Pos)) /* Assignment of value for GPID61 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID62(value)               (PMC_GCSR1_GPID62_Msk & (_UINT32_(value) << PMC_GCSR1_GPID62_Pos)) /* Assignment of value for GPID62 in the PMC_GCSR1 register */
...
#define PMC_GCSR1_GPID63(value)               (PMC_GCSR1_GPID63_Msk & (_UINT32_(value) << PMC_GCSR1_GPID63_Pos)) /* Assignment of value for GPID63 in the PMC_GCSR1 register */
#define   PMC_GCSR1_GPID63_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR1) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR1_GPID63_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR1) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR1_Msk                         _UINT32_(0xE67BFFC2)                                 /* (PMC_GCSR1) Register Mask  */

#define PMC_GCSR1_GPID_Pos                    _UINT32_(1)                                          /* (PMC_GCSR1 Position) Generic Clock 63 Status */
#define PMC_GCSR1_GPID_Msk                    (_UINT32_(0x3FFFFF) << PMC_GCSR1_GPID_Pos)           /* (PMC_GCSR1 Mask) GPID */
...
#define PMC_GCSR2_GPID64(value)               (PMC_GCSR2_GPID64_Msk & (_UINT32_(value) << PMC_GCSR2_GPID64_Pos)) /* Assignment of value for GPID64 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID65(value)               (PMC_GCSR2_GPID65_Msk & (_UINT32_(value) << PMC_GCSR2_GPID65_Pos)) /* Assignment of value for GPID65 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID66(value)               (PMC_GCSR2_GPID66_Msk & (_UINT32_(value) << PMC_GCSR2_GPID66_Pos)) /* Assignment of value for GPID66 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID68(value)               (PMC_GCSR2_GPID68_Msk & (_UINT32_(value) << PMC_GCSR2_GPID68_Pos)) /* Assignment of value for GPID68 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID69(value)               (PMC_GCSR2_GPID69_Msk & (_UINT32_(value) << PMC_GCSR2_GPID69_Pos)) /* Assignment of value for GPID69 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID70(value)               (PMC_GCSR2_GPID70_Msk & (_UINT32_(value) << PMC_GCSR2_GPID70_Pos)) /* Assignment of value for GPID70 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID71(value)               (PMC_GCSR2_GPID71_Msk & (_UINT32_(value) << PMC_GCSR2_GPID71_Pos)) /* Assignment of value for GPID71 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID72(value)               (PMC_GCSR2_GPID72_Msk & (_UINT32_(value) << PMC_GCSR2_GPID72_Pos)) /* Assignment of value for GPID72 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID72_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID72_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR2_GPID73(value)               (PMC_GCSR2_GPID73_Msk & (_UINT32_(value) << PMC_GCSR2_GPID73_Pos)) /* Assignment of value for GPID73 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID74(value)               (PMC_GCSR2_GPID74_Msk & (_UINT32_(value) << PMC_GCSR2_GPID74_Pos)) /* Assignment of value for GPID74 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID75(value)               (PMC_GCSR2_GPID75_Msk & (_UINT32_(value) << PMC_GCSR2_GPID75_Pos)) /* Assignment of value for GPID75 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID78(value)               (PMC_GCSR2_GPID78_Msk & (_UINT32_(value) << PMC_GCSR2_GPID78_Pos)) /* Assignment of value for GPID78 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID78_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID78_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR2_GPID79(value)               (PMC_GCSR2_GPID79_Msk & (_UINT32_(value) << PMC_GCSR2_GPID79_Pos)) /* Assignment of value for GPID79 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID80(value)               (PMC_GCSR2_GPID80_Msk & (_UINT32_(value) << PMC_GCSR2_GPID80_Pos)) /* Assignment of value for GPID80 in the PMC_GCSR2 register */
...
#define PMC_GCSR2_GPID81(value)               (PMC_GCSR2_GPID81_Msk & (_UINT32_(value) << PMC_GCSR2_GPID81_Pos)) /* Assignment of value for GPID81 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID81_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID81_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR2_GPID82(value)               (PMC_GCSR2_GPID82_Msk & (_UINT32_(value) << PMC_GCSR2_GPID82_Pos)) /* Assignment of value for GPID82 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID82_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID82_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR2_GPID84(value)               (PMC_GCSR2_GPID84_Msk & (_UINT32_(value) << PMC_GCSR2_GPID84_Pos)) /* Assignment of value for GPID84 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID84_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID84_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR2_GPID85(value)               (PMC_GCSR2_GPID85_Msk & (_UINT32_(value) << PMC_GCSR2_GPID85_Pos)) /* Assignment of value for GPID85 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID85_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID85_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR2_GPID88(value)               (PMC_GCSR2_GPID88_Msk & (_UINT32_(value) << PMC_GCSR2_GPID88_Pos)) /* Assignment of value for GPID88 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID88_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID88_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR2_GPID91(value)               (PMC_GCSR2_GPID91_Msk & (_UINT32_(value) << PMC_GCSR2_GPID91_Pos)) /* Assignment of value for GPID91 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID91_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID91_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
...
#define PMC_GCSR2_GPID94(value)               (PMC_GCSR2_GPID94_Msk & (_UINT32_(value) << PMC_GCSR2_GPID94_Pos)) /* Assignment of value for GPID94 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID94_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID94_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
#define PMC_GCSR2_GPID94_0                    (PMC_GCSR2_GPID94_0_Val << PMC_GCSR2_GPID94_Pos)     /* (PMC_GCSR2) The corresponding Generic clock is disabled. Position */
#define PMC_GCSR2_GPID94_1                    (PMC_GCSR2_GPID94_1_Val << PMC_GCSR2_GPID94_Pos)     /* (PMC_GCSR2) The corresponding Generic clock is enabled. Position */
...
#define PMC_GCSR2_GPID95(value)               (PMC_GCSR2_GPID95_Msk & (_UINT32_(value) << PMC_GCSR2_GPID95_Pos)) /* Assignment of value for GPID95 in the PMC_GCSR2 register */
#define   PMC_GCSR2_GPID95_0_Val              _UINT32_(0x0)                                        /* (PMC_GCSR2) The corresponding Generic clock is disabled.  */
#define   PMC_GCSR2_GPID95_1_Val              _UINT32_(0x1)                                        /* (PMC_GCSR2) The corresponding Generic clock is enabled.  */
#define PMC_GCSR2_GPID95_0                    (PMC_GCSR2_GPID95_0_Val << PMC_GCSR2_GPID95_Pos)     /* (PMC_GCSR2) The corresponding Generic clock is disabled. Position */
#define PMC_GCSR2_GPID95_1                    (PMC_GCSR2_GPID95_1_Val << PMC_GCSR2_GPID95_Pos)     /* (PMC_GCSR2) The corresponding Generic clock is enabled. Position */
#define PMC_GCSR2_Msk                         _UINT32_(0xC937CFF7)                                 /* (PMC_GCSR2) Register Mask  */

#define PMC_GCSR2_GPID_Pos                    _UINT32_(0)                                          /* (PMC_GCSR2 Position) Generic Clock 95 Status */
#define PMC_GCSR2_GPID_Msk                    (_UINT32_(0x3FFFFF) << PMC_GCSR2_GPID_Pos)           /* (PMC_GCSR2 Mask) GPID */
...
#define PMC_PLL_IER_LOCK0(value)              (PMC_PLL_IER_LOCK0_Msk & (_UINT32_(value) << PMC_PLL_IER_LOCK0_Pos)) /* Assignment of value for LOCK0 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_LOCK1(value)              (PMC_PLL_IER_LOCK1_Msk & (_UINT32_(value) << PMC_PLL_IER_LOCK1_Pos)) /* Assignment of value for LOCK1 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_LOCK2(value)              (PMC_PLL_IER_LOCK2_Msk & (_UINT32_(value) << PMC_PLL_IER_LOCK2_Pos)) /* Assignment of value for LOCK2 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_LOCK3(value)              (PMC_PLL_IER_LOCK3_Msk & (_UINT32_(value) << PMC_PLL_IER_LOCK3_Pos)) /* Assignment of value for LOCK3 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_LOCK4(value)              (PMC_PLL_IER_LOCK4_Msk & (_UINT32_(value) << PMC_PLL_IER_LOCK4_Pos)) /* Assignment of value for LOCK4 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_LOCK5(value)              (PMC_PLL_IER_LOCK5_Msk & (_UINT32_(value) << PMC_PLL_IER_LOCK5_Pos)) /* Assignment of value for LOCK5 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_LOCK6(value)              (PMC_PLL_IER_LOCK6_Msk & (_UINT32_(value) << PMC_PLL_IER_LOCK6_Pos)) /* Assignment of value for LOCK6 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_UNLOCK0(value)            (PMC_PLL_IER_UNLOCK0_Msk & (_UINT32_(value) << PMC_PLL_IER_UNLOCK0_Pos)) /* Assignment of value for UNLOCK0 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_UNLOCK1(value)            (PMC_PLL_IER_UNLOCK1_Msk & (_UINT32_(value) << PMC_PLL_IER_UNLOCK1_Pos)) /* Assignment of value for UNLOCK1 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_UNLOCK2(value)            (PMC_PLL_IER_UNLOCK2_Msk & (_UINT32_(value) << PMC_PLL_IER_UNLOCK2_Pos)) /* Assignment of value for UNLOCK2 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_UNLOCK3(value)            (PMC_PLL_IER_UNLOCK3_Msk & (_UINT32_(value) << PMC_PLL_IER_UNLOCK3_Pos)) /* Assignment of value for UNLOCK3 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_UNLOCK4(value)            (PMC_PLL_IER_UNLOCK4_Msk & (_UINT32_(value) << PMC_PLL_IER_UNLOCK4_Pos)) /* Assignment of value for UNLOCK4 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_UNLOCK5(value)            (PMC_PLL_IER_UNLOCK5_Msk & (_UINT32_(value) << PMC_PLL_IER_UNLOCK5_Pos)) /* Assignment of value for UNLOCK5 in the PMC_PLL_IER register */
...
#define PMC_PLL_IER_UNLOCK6(value)            (PMC_PLL_IER_UNLOCK6_Msk & (_UINT32_(value) << PMC_PLL_IER_UNLOCK6_Pos)) /* Assignment of value for UNLOCK6 in the PMC_PLL_IER register */
#define PMC_PLL_IER_Msk                       _UINT32_(0x007F007F)                                 /* (PMC_PLL_IER) Register Mask  */

#define PMC_PLL_IER_LOCK_Pos                  _UINT32_(0)                                          /* (PMC_PLL_IER Position) PLL of Index x Lock Interrupt Enable */
#define PMC_PLL_IER_LOCK_Msk                  (_UINT32_(0x7F) << PMC_PLL_IER_LOCK_Pos)             /* (PMC_PLL_IER Mask) LOCK */
...
#define PMC_PLL_IDR_LOCK0(value)              (PMC_PLL_IDR_LOCK0_Msk & (_UINT32_(value) << PMC_PLL_IDR_LOCK0_Pos)) /* Assignment of value for LOCK0 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_LOCK1(value)              (PMC_PLL_IDR_LOCK1_Msk & (_UINT32_(value) << PMC_PLL_IDR_LOCK1_Pos)) /* Assignment of value for LOCK1 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_LOCK2(value)              (PMC_PLL_IDR_LOCK2_Msk & (_UINT32_(value) << PMC_PLL_IDR_LOCK2_Pos)) /* Assignment of value for LOCK2 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_LOCK3(value)              (PMC_PLL_IDR_LOCK3_Msk & (_UINT32_(value) << PMC_PLL_IDR_LOCK3_Pos)) /* Assignment of value for LOCK3 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_LOCK4(value)              (PMC_PLL_IDR_LOCK4_Msk & (_UINT32_(value) << PMC_PLL_IDR_LOCK4_Pos)) /* Assignment of value for LOCK4 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_LOCK5(value)              (PMC_PLL_IDR_LOCK5_Msk & (_UINT32_(value) << PMC_PLL_IDR_LOCK5_Pos)) /* Assignment of value for LOCK5 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_LOCK6(value)              (PMC_PLL_IDR_LOCK6_Msk & (_UINT32_(value) << PMC_PLL_IDR_LOCK6_Pos)) /* Assignment of value for LOCK6 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_UNLOCK0(value)            (PMC_PLL_IDR_UNLOCK0_Msk & (_UINT32_(value) << PMC_PLL_IDR_UNLOCK0_Pos)) /* Assignment of value for UNLOCK0 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_UNLOCK1(value)            (PMC_PLL_IDR_UNLOCK1_Msk & (_UINT32_(value) << PMC_PLL_IDR_UNLOCK1_Pos)) /* Assignment of value for UNLOCK1 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_UNLOCK2(value)            (PMC_PLL_IDR_UNLOCK2_Msk & (_UINT32_(value) << PMC_PLL_IDR_UNLOCK2_Pos)) /* Assignment of value for UNLOCK2 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_UNLOCK3(value)            (PMC_PLL_IDR_UNLOCK3_Msk & (_UINT32_(value) << PMC_PLL_IDR_UNLOCK3_Pos)) /* Assignment of value for UNLOCK3 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_UNLOCK4(value)            (PMC_PLL_IDR_UNLOCK4_Msk & (_UINT32_(value) << PMC_PLL_IDR_UNLOCK4_Pos)) /* Assignment of value for UNLOCK4 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_UNLOCK5(value)            (PMC_PLL_IDR_UNLOCK5_Msk & (_UINT32_(value) << PMC_PLL_IDR_UNLOCK5_Pos)) /* Assignment of value for UNLOCK5 in the PMC_PLL_IDR register */
...
#define PMC_PLL_IDR_UNLOCK6(value)            (PMC_PLL_IDR_UNLOCK6_Msk & (_UINT32_(value) << PMC_PLL_IDR_UNLOCK6_Pos)) /* Assignment of value for UNLOCK6 in the PMC_PLL_IDR register */
#define PMC_PLL_IDR_Msk                       _UINT32_(0x007F007F)                                 /* (PMC_PLL_IDR) Register Mask  */

#define PMC_PLL_IDR_LOCK_Pos                  _UINT32_(0)                                          /* (PMC_PLL_IDR Position) PLL of Index x Lock Interrupt Disable */
#define PMC_PLL_IDR_LOCK_Msk                  (_UINT32_(0x7F) << PMC_PLL_IDR_LOCK_Pos)             /* (PMC_PLL_IDR Mask) LOCK */
...
#define PMC_PLL_IMR_LOCK0(value)              (PMC_PLL_IMR_LOCK0_Msk & (_UINT32_(value) << PMC_PLL_IMR_LOCK0_Pos)) /* Assignment of value for LOCK0 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_LOCK1(value)              (PMC_PLL_IMR_LOCK1_Msk & (_UINT32_(value) << PMC_PLL_IMR_LOCK1_Pos)) /* Assignment of value for LOCK1 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_LOCK2(value)              (PMC_PLL_IMR_LOCK2_Msk & (_UINT32_(value) << PMC_PLL_IMR_LOCK2_Pos)) /* Assignment of value for LOCK2 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_LOCK3(value)              (PMC_PLL_IMR_LOCK3_Msk & (_UINT32_(value) << PMC_PLL_IMR_LOCK3_Pos)) /* Assignment of value for LOCK3 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_LOCK4(value)              (PMC_PLL_IMR_LOCK4_Msk & (_UINT32_(value) << PMC_PLL_IMR_LOCK4_Pos)) /* Assignment of value for LOCK4 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_LOCK5(value)              (PMC_PLL_IMR_LOCK5_Msk & (_UINT32_(value) << PMC_PLL_IMR_LOCK5_Pos)) /* Assignment of value for LOCK5 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_LOCK6(value)              (PMC_PLL_IMR_LOCK6_Msk & (_UINT32_(value) << PMC_PLL_IMR_LOCK6_Pos)) /* Assignment of value for LOCK6 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_UNLOCK0(value)            (PMC_PLL_IMR_UNLOCK0_Msk & (_UINT32_(value) << PMC_PLL_IMR_UNLOCK0_Pos)) /* Assignment of value for UNLOCK0 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_UNLOCK1(value)            (PMC_PLL_IMR_UNLOCK1_Msk & (_UINT32_(value) << PMC_PLL_IMR_UNLOCK1_Pos)) /* Assignment of value for UNLOCK1 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_UNLOCK2(value)            (PMC_PLL_IMR_UNLOCK2_Msk & (_UINT32_(value) << PMC_PLL_IMR_UNLOCK2_Pos)) /* Assignment of value for UNLOCK2 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_UNLOCK3(value)            (PMC_PLL_IMR_UNLOCK3_Msk & (_UINT32_(value) << PMC_PLL_IMR_UNLOCK3_Pos)) /* Assignment of value for UNLOCK3 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_UNLOCK4(value)            (PMC_PLL_IMR_UNLOCK4_Msk & (_UINT32_(value) << PMC_PLL_IMR_UNLOCK4_Pos)) /* Assignment of value for UNLOCK4 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_UNLOCK5(value)            (PMC_PLL_IMR_UNLOCK5_Msk & (_UINT32_(value) << PMC_PLL_IMR_UNLOCK5_Pos)) /* Assignment of value for UNLOCK5 in the PMC_PLL_IMR register */
...
#define PMC_PLL_IMR_UNLOCK6(value)            (PMC_PLL_IMR_UNLOCK6_Msk & (_UINT32_(value) << PMC_PLL_IMR_UNLOCK6_Pos)) /* Assignment of value for UNLOCK6 in the PMC_PLL_IMR register */
#define PMC_PLL_IMR_Msk                       _UINT32_(0x007F007F)                                 /* (PMC_PLL_IMR) Register Mask  */

#define PMC_PLL_IMR_LOCK_Pos                  _UINT32_(0)                                          /* (PMC_PLL_IMR Position) PLL of Index x Lock Interrupt Mask */
#define PMC_PLL_IMR_LOCK_Msk                  (_UINT32_(0x7F) << PMC_PLL_IMR_LOCK_Pos)             /* (PMC_PLL_IMR Mask) LOCK */
...
#define PMC_PLL_ISR0_LOCK0(value)             (PMC_PLL_ISR0_LOCK0_Msk & (_UINT32_(value) << PMC_PLL_ISR0_LOCK0_Pos)) /* Assignment of value for LOCK0 in the PMC_PLL_ISR0 register */
...
#define PMC_PLL_ISR0_LOCK1(value)             (PMC_PLL_ISR0_LOCK1_Msk & (_UINT32_(value) << PMC_PLL_ISR0_LOCK1_Pos)) /* Assignment of value for LOCK1 in the PMC_PLL_ISR0 register */
...
#define PMC_PLL_ISR0_LOCK2(value)             (PMC_PLL_ISR0_LOCK2_Msk & (_UINT32_(value) << PMC_PLL_ISR0_LOCK2_Pos)) /* Assignment of value for LOCK2 in the PMC_PLL_ISR0 register */
...
#define PMC_PLL_ISR0_LOCK3(value)             (PMC_PLL_ISR0_LOCK3_Msk & (_UINT32_(value) << PMC_PLL_ISR0_LOCK3_Pos)) /* Assignment of value for LOCK3 in the PMC_PLL_ISR0 register */
...
#define PMC_PLL_ISR0_LOCK4(value)             (PMC_PLL_ISR0_LOCK4_Msk & (_UINT32_(value) << PMC_PLL_ISR0_LOCK4_Pos)) /* Assignment of value for LOCK4 in the PMC_PLL_ISR0 register */
...
#define PMC_PLL_ISR0_LOCK5(value)             (PMC_PLL_ISR0_LOCK5_Msk & (_UINT32_(value) << PMC_PLL_ISR0_LOCK5_Pos)) /* Assignment of value for LOCK5 in the PMC_PLL_ISR0 register */
...
#define PMC_PLL_ISR0_LOCK6(value)             (PMC_PLL_ISR0_LOCK6_Msk & (_UINT32_(value) << PMC_PLL_ISR0_LOCK6_Pos)) /* Assignment of value for LOCK6 in the PMC_PLL_ISR0 register */
...
#define PMC_PLL_ISR0_UNLOCK0(value)           (PMC_PLL_ISR0_UNLOCK0_Msk & (_UINT32_(value) << PMC_PLL_ISR0_UNLOCK0_Pos)) /* Assignment of value for UNLOCK0 in the PMC_PLL_ISR0 register */
#define   PMC_PLL_ISR0_UNLOCK0_0_Val          _UINT32_(0x0)                                        /* (PMC_PLL_ISR0) PLL is not unlocked.  */
#define   PMC_PLL_ISR0_UNLOCK0_1_Val          _UINT32_(0x1)                                        /* (PMC_PLL_ISR0) PLLx is unlocked. To know the unlock type, the PMC_PISR1 register can be read.  */
...
#define PMC_PLL_ISR0_UNLOCK1(value)           (PMC_PLL_ISR0_UNLOCK1_Msk & (_UINT32_(value) << PMC_PLL_ISR0_UNLOCK1_Pos)) /* Assignment of value for UNLOCK1 in the PMC_PLL_ISR0 register */
#define   PMC_PLL_ISR0_UNLOCK1_0_Val          _UINT32_(0x0)                                        /* (PMC_PLL_ISR0) PLL is not unlocked.  */
#define   PMC_PLL_ISR0_UNLOCK1_1_Val          _UINT32_(0x1)                                        /* (PMC_PLL_ISR0) PLLx is unlocked. To know the unlock type, the PMC_PISR1 register can be read.  */
...
#define PMC_PLL_ISR0_UNLOCK2(value)           (PMC_PLL_ISR0_UNLOCK2_Msk & (_UINT32_(value) << PMC_PLL_ISR0_UNLOCK2_Pos)) /* Assignment of value for UNLOCK2 in the PMC_PLL_ISR0 register */
#define   PMC_PLL_ISR0_UNLOCK2_0_Val          _UINT32_(0x0)                                        /* (PMC_PLL_ISR0) PLL is not unlocked.  */
#define   PMC_PLL_ISR0_UNLOCK2_1_Val          _UINT32_(0x1)                                        /* (PMC_PLL_ISR0) PLLx is unlocked. To know the unlock type, the PMC_PISR1 register can be read.  */
...
#define PMC_PLL_ISR0_UNLOCK3(value)           (PMC_PLL_ISR0_UNLOCK3_Msk & (_UINT32_(value) << PMC_PLL_ISR0_UNLOCK3_Pos)) /* Assignment of value for UNLOCK3 in the PMC_PLL_ISR0 register */
#define   PMC_PLL_ISR0_UNLOCK3_0_Val          _UINT32_(0x0)                                        /* (PMC_PLL_ISR0) PLL is not unlocked.  */
#define   PMC_PLL_ISR0_UNLOCK3_1_Val          _UINT32_(0x1)                                        /* (PMC_PLL_ISR0) PLLx is unlocked. To know the unlock type, the PMC_PISR1 register can be read.  */
...
#define PMC_PLL_ISR0_UNLOCK4(value)           (PMC_PLL_ISR0_UNLOCK4_Msk & (_UINT32_(value) << PMC_PLL_ISR0_UNLOCK4_Pos)) /* Assignment of value for UNLOCK4 in the PMC_PLL_ISR0 register */
#define   PMC_PLL_ISR0_UNLOCK4_0_Val          _UINT32_(0x0)                                        /* (PMC_PLL_ISR0) PLL is not unlocked.  */
#define   PMC_PLL_ISR0_UNLOCK4_1_Val          _UINT32_(0x1)                                        /* (PMC_PLL_ISR0) PLLx is unlocked. To know the unlock type, the PMC_PISR1 register can be read.  */
...
#define PMC_PLL_ISR0_UNLOCK5(value)           (PMC_PLL_ISR0_UNLOCK5_Msk & (_UINT32_(value) << PMC_PLL_ISR0_UNLOCK5_Pos)) /* Assignment of value for UNLOCK5 in the PMC_PLL_ISR0 register */
#define   PMC_PLL_ISR0_UNLOCK5_0_Val          _UINT32_(0x0)                                        /* (PMC_PLL_ISR0) PLL is not unlocked.  */
#define   PMC_PLL_ISR0_UNLOCK5_1_Val          _UINT32_(0x1)                                        /* (PMC_PLL_ISR0) PLLx is unlocked. To know the unlock type, the PMC_PISR1 register can be read.  */
...
#define PMC_PLL_ISR0_UNLOCK6(value)           (PMC_PLL_ISR0_UNLOCK6_Msk & (_UINT32_(value) << PMC_PLL_ISR0_UNLOCK6_Pos)) /* Assignment of value for UNLOCK6 in the PMC_PLL_ISR0 register */
#define   PMC_PLL_ISR0_UNLOCK6_0_Val          _UINT32_(0x0)                                        /* (PMC_PLL_ISR0) PLL is not unlocked.  */
#define   PMC_PLL_ISR0_UNLOCK6_1_Val          _UINT32_(0x1)                                        /* (PMC_PLL_ISR0) PLLx is unlocked. To know the unlock type, the PMC_PISR1 register can be read.  */
...
#define PMC_PLL_ISR0_Msk                      _UINT32_(0x007F007F)                                 /* (PMC_PLL_ISR0) Register Mask  */

#define PMC_PLL_ISR0_LOCK_Pos                 _UINT32_(0)                                          /* (PMC_PLL_ISR0 Position) PLL of Index x Lock Interrupt Status */
#define PMC_PLL_ISR0_LOCK_Msk                 (_UINT32_(0x7F) << PMC_PLL_ISR0_LOCK_Pos)            /* (PMC_PLL_ISR0 Mask) LOCK */
...
#define PMC_PLL_ISR1_UDR0(value)              (PMC_PLL_ISR1_UDR0_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDR0_Pos)) /* Assignment of value for UDR0 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_UDR1(value)              (PMC_PLL_ISR1_UDR1_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDR1_Pos)) /* Assignment of value for UDR1 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_UDR2(value)              (PMC_PLL_ISR1_UDR2_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDR2_Pos)) /* Assignment of value for UDR2 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_UDR3(value)              (PMC_PLL_ISR1_UDR3_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDR3_Pos)) /* Assignment of value for UDR3 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_UDR4(value)              (PMC_PLL_ISR1_UDR4_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDR4_Pos)) /* Assignment of value for UDR4 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_UDR5(value)              (PMC_PLL_ISR1_UDR5_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDR5_Pos)) /* Assignment of value for UDR5 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_UDR6(value)              (PMC_PLL_ISR1_UDR6_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDR6_Pos)) /* Assignment of value for UDR6 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_OVR0(value)              (PMC_PLL_ISR1_OVR0_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVR0_Pos)) /* Assignment of value for OVR0 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_OVR1(value)              (PMC_PLL_ISR1_OVR1_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVR1_Pos)) /* Assignment of value for OVR1 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_OVR2(value)              (PMC_PLL_ISR1_OVR2_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVR2_Pos)) /* Assignment of value for OVR2 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_OVR3(value)              (PMC_PLL_ISR1_OVR3_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVR3_Pos)) /* Assignment of value for OVR3 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_OVR4(value)              (PMC_PLL_ISR1_OVR4_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVR4_Pos)) /* Assignment of value for OVR4 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_OVR5(value)              (PMC_PLL_ISR1_OVR5_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVR5_Pos)) /* Assignment of value for OVR5 in the PMC_PLL_ISR1 register */
...
#define PMC_PLL_ISR1_OVR6(value)              (PMC_PLL_ISR1_OVR6_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVR6_Pos)) /* Assignment of value for OVR6 in the PMC_PLL_ISR1 register */
...
#endif /* _SAMA7G5_PMC_COMPONENT_H_ */
