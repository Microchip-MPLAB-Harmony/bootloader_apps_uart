...
#ifndef _SAMA7G5_UDPHS_COMPONENT_H_
#define _SAMA7G5_UDPHS_COMPONENT_H_
...
#define UDPHS_DMANXTDSC_NXT_DSC_ADD(value)    (UDPHS_DMANXTDSC_NXT_DSC_ADD_Msk & (_UINT32_(value) << UDPHS_DMANXTDSC_NXT_DSC_ADD_Pos)) /* Assignment of value for NXT_DSC_ADD in the UDPHS_DMANXTDSC register */
...
#define UDPHS_DMAADDRESS_BUFF_ADD(value)      (UDPHS_DMAADDRESS_BUFF_ADD_Msk & (_UINT32_(value) << UDPHS_DMAADDRESS_BUFF_ADD_Pos)) /* Assignment of value for BUFF_ADD in the UDPHS_DMAADDRESS register */
...
#define UDPHS_DMACONTROL_CHANN_ENB(value)     (UDPHS_DMACONTROL_CHANN_ENB_Msk & (_UINT32_(value) << UDPHS_DMACONTROL_CHANN_ENB_Pos)) /* Assignment of value for CHANN_ENB in the UDPHS_DMACONTROL register */
...
#define UDPHS_DMACONTROL_LDNXT_DSC(value)     (UDPHS_DMACONTROL_LDNXT_DSC_Msk & (_UINT32_(value) << UDPHS_DMACONTROL_LDNXT_DSC_Pos)) /* Assignment of value for LDNXT_DSC in the UDPHS_DMACONTROL register */
...
#define UDPHS_DMACONTROL_END_TR_EN(value)     (UDPHS_DMACONTROL_END_TR_EN_Msk & (_UINT32_(value) << UDPHS_DMACONTROL_END_TR_EN_Pos)) /* Assignment of value for END_TR_EN in the UDPHS_DMACONTROL register */
...
#define UDPHS_DMACONTROL_END_B_EN(value)      (UDPHS_DMACONTROL_END_B_EN_Msk & (_UINT32_(value) << UDPHS_DMACONTROL_END_B_EN_Pos)) /* Assignment of value for END_B_EN in the UDPHS_DMACONTROL register */
...
#define UDPHS_DMACONTROL_END_TR_IT(value)     (UDPHS_DMACONTROL_END_TR_IT_Msk & (_UINT32_(value) << UDPHS_DMACONTROL_END_TR_IT_Pos)) /* Assignment of value for END_TR_IT in the UDPHS_DMACONTROL register */
...
#define UDPHS_DMACONTROL_END_BUFFIT(value)    (UDPHS_DMACONTROL_END_BUFFIT_Msk & (_UINT32_(value) << UDPHS_DMACONTROL_END_BUFFIT_Pos)) /* Assignment of value for END_BUFFIT in the UDPHS_DMACONTROL register */
...
#define UDPHS_DMACONTROL_DESC_LD_IT(value)    (UDPHS_DMACONTROL_DESC_LD_IT_Msk & (_UINT32_(value) << UDPHS_DMACONTROL_DESC_LD_IT_Pos)) /* Assignment of value for DESC_LD_IT in the UDPHS_DMACONTROL register */
...
#define UDPHS_DMACONTROL_BURST_LCK(value)     (UDPHS_DMACONTROL_BURST_LCK_Msk & (_UINT32_(value) << UDPHS_DMACONTROL_BURST_LCK_Pos)) /* Assignment of value for BURST_LCK in the UDPHS_DMACONTROL register */
...
#define UDPHS_DMACONTROL_BUFF_LENGTH(value)   (UDPHS_DMACONTROL_BUFF_LENGTH_Msk & (_UINT32_(value) << UDPHS_DMACONTROL_BUFF_LENGTH_Pos)) /* Assignment of value for BUFF_LENGTH in the UDPHS_DMACONTROL register */
...
#define UDPHS_DMASTATUS_CHANN_ENB(value)      (UDPHS_DMASTATUS_CHANN_ENB_Msk & (_UINT32_(value) << UDPHS_DMASTATUS_CHANN_ENB_Pos)) /* Assignment of value for CHANN_ENB in the UDPHS_DMASTATUS register */
...
#define UDPHS_DMASTATUS_CHANN_ACT(value)      (UDPHS_DMASTATUS_CHANN_ACT_Msk & (_UINT32_(value) << UDPHS_DMASTATUS_CHANN_ACT_Pos)) /* Assignment of value for CHANN_ACT in the UDPHS_DMASTATUS register */
...
#define UDPHS_DMASTATUS_END_TR_ST(value)      (UDPHS_DMASTATUS_END_TR_ST_Msk & (_UINT32_(value) << UDPHS_DMASTATUS_END_TR_ST_Pos)) /* Assignment of value for END_TR_ST in the UDPHS_DMASTATUS register */
...
#define UDPHS_DMASTATUS_END_BF_ST(value)      (UDPHS_DMASTATUS_END_BF_ST_Msk & (_UINT32_(value) << UDPHS_DMASTATUS_END_BF_ST_Pos)) /* Assignment of value for END_BF_ST in the UDPHS_DMASTATUS register */
...
#define UDPHS_DMASTATUS_DESC_LDST(value)      (UDPHS_DMASTATUS_DESC_LDST_Msk & (_UINT32_(value) << UDPHS_DMASTATUS_DESC_LDST_Pos)) /* Assignment of value for DESC_LDST in the UDPHS_DMASTATUS register */
...
#define UDPHS_DMASTATUS_BUFF_COUNT(value)     (UDPHS_DMASTATUS_BUFF_COUNT_Msk & (_UINT32_(value) << UDPHS_DMASTATUS_BUFF_COUNT_Pos)) /* Assignment of value for BUFF_COUNT in the UDPHS_DMASTATUS register */
...
#define UDPHS_EPTCFG_EPT_SIZE(value)          (UDPHS_EPTCFG_EPT_SIZE_Msk & (_UINT32_(value) << UDPHS_EPTCFG_EPT_SIZE_Pos)) /* Assignment of value for EPT_SIZE in the UDPHS_EPTCFG register */
...
#define UDPHS_EPTCFG_EPT_DIR(value)           (UDPHS_EPTCFG_EPT_DIR_Msk & (_UINT32_(value) << UDPHS_EPTCFG_EPT_DIR_Pos)) /* Assignment of value for EPT_DIR in the UDPHS_EPTCFG register */
...
#define UDPHS_EPTCFG_EPT_TYPE(value)          (UDPHS_EPTCFG_EPT_TYPE_Msk & (_UINT32_(value) << UDPHS_EPTCFG_EPT_TYPE_Pos)) /* Assignment of value for EPT_TYPE in the UDPHS_EPTCFG register */
...
#define UDPHS_EPTCFG_BK_NUMBER(value)         (UDPHS_EPTCFG_BK_NUMBER_Msk & (_UINT32_(value) << UDPHS_EPTCFG_BK_NUMBER_Pos)) /* Assignment of value for BK_NUMBER in the UDPHS_EPTCFG register */
...
#define UDPHS_EPTCFG_NB_TRANS(value)          (UDPHS_EPTCFG_NB_TRANS_Msk & (_UINT32_(value) << UDPHS_EPTCFG_NB_TRANS_Pos)) /* Assignment of value for NB_TRANS in the UDPHS_EPTCFG register */
...
#define UDPHS_EPTCFG_EPT_MAPD(value)          (UDPHS_EPTCFG_EPT_MAPD_Msk & (_UINT32_(value) << UDPHS_EPTCFG_EPT_MAPD_Pos)) /* Assignment of value for EPT_MAPD in the UDPHS_EPTCFG register */
...
#define UDPHS_EPTCTLENB_EPT_ENABL(value)      (UDPHS_EPTCTLENB_EPT_ENABL_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_EPT_ENABL_Pos)) /* Assignment of value for EPT_ENABL in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_AUTO_VALID(value)     (UDPHS_EPTCTLENB_AUTO_VALID_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_AUTO_VALID_Pos)) /* Assignment of value for AUTO_VALID in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_INTDIS_DMA(value)     (UDPHS_EPTCTLENB_INTDIS_DMA_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_INTDIS_DMA_Pos)) /* Assignment of value for INTDIS_DMA in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_NYET_DIS(value)       (UDPHS_EPTCTLENB_NYET_DIS_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_NYET_DIS_Pos)) /* Assignment of value for NYET_DIS in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_ERR_OVFLW(value)      (UDPHS_EPTCTLENB_ERR_OVFLW_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_ERR_OVFLW_Pos)) /* Assignment of value for ERR_OVFLW in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_RXRDY_TXKL(value)     (UDPHS_EPTCTLENB_RXRDY_TXKL_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_RXRDY_TXKL_Pos)) /* Assignment of value for RXRDY_TXKL in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_TX_COMPLT(value)      (UDPHS_EPTCTLENB_TX_COMPLT_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_TX_COMPLT_Pos)) /* Assignment of value for TX_COMPLT in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_TXRDY(value)          (UDPHS_EPTCTLENB_TXRDY_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_TXRDY_Pos)) /* Assignment of value for TXRDY in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_RX_SETUP(value)       (UDPHS_EPTCTLENB_RX_SETUP_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_RX_SETUP_Pos)) /* Assignment of value for RX_SETUP in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_STALL_SNT(value)      (UDPHS_EPTCTLENB_STALL_SNT_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_STALL_SNT_Pos)) /* Assignment of value for STALL_SNT in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_NAK_IN(value)         (UDPHS_EPTCTLENB_NAK_IN_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_NAK_IN_Pos)) /* Assignment of value for NAK_IN in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_NAK_OUT(value)        (UDPHS_EPTCTLENB_NAK_OUT_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_NAK_OUT_Pos)) /* Assignment of value for NAK_OUT in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_BUSY_BANK(value)      (UDPHS_EPTCTLENB_BUSY_BANK_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_BUSY_BANK_Pos)) /* Assignment of value for BUSY_BANK in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLENB_SHRT_PCKT(value)      (UDPHS_EPTCTLENB_SHRT_PCKT_Msk & (_UINT32_(value) << UDPHS_EPTCTLENB_SHRT_PCKT_Pos)) /* Assignment of value for SHRT_PCKT in the UDPHS_EPTCTLENB register */
...
#define UDPHS_EPTCTLDIS_EPT_DISABL(value)     (UDPHS_EPTCTLDIS_EPT_DISABL_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_EPT_DISABL_Pos)) /* Assignment of value for EPT_DISABL in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_AUTO_VALID(value)     (UDPHS_EPTCTLDIS_AUTO_VALID_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_AUTO_VALID_Pos)) /* Assignment of value for AUTO_VALID in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_INTDIS_DMA(value)     (UDPHS_EPTCTLDIS_INTDIS_DMA_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_INTDIS_DMA_Pos)) /* Assignment of value for INTDIS_DMA in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_NYET_DIS(value)       (UDPHS_EPTCTLDIS_NYET_DIS_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_NYET_DIS_Pos)) /* Assignment of value for NYET_DIS in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_ERR_OVFLW(value)      (UDPHS_EPTCTLDIS_ERR_OVFLW_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_ERR_OVFLW_Pos)) /* Assignment of value for ERR_OVFLW in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_RXRDY_TXKL(value)     (UDPHS_EPTCTLDIS_RXRDY_TXKL_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_RXRDY_TXKL_Pos)) /* Assignment of value for RXRDY_TXKL in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_TX_COMPLT(value)      (UDPHS_EPTCTLDIS_TX_COMPLT_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_TX_COMPLT_Pos)) /* Assignment of value for TX_COMPLT in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_TXRDY(value)          (UDPHS_EPTCTLDIS_TXRDY_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_TXRDY_Pos)) /* Assignment of value for TXRDY in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_RX_SETUP(value)       (UDPHS_EPTCTLDIS_RX_SETUP_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_RX_SETUP_Pos)) /* Assignment of value for RX_SETUP in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_STALL_SNT(value)      (UDPHS_EPTCTLDIS_STALL_SNT_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_STALL_SNT_Pos)) /* Assignment of value for STALL_SNT in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_NAK_IN(value)         (UDPHS_EPTCTLDIS_NAK_IN_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_NAK_IN_Pos)) /* Assignment of value for NAK_IN in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_NAK_OUT(value)        (UDPHS_EPTCTLDIS_NAK_OUT_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_NAK_OUT_Pos)) /* Assignment of value for NAK_OUT in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_BUSY_BANK(value)      (UDPHS_EPTCTLDIS_BUSY_BANK_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_BUSY_BANK_Pos)) /* Assignment of value for BUSY_BANK in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTLDIS_SHRT_PCKT(value)      (UDPHS_EPTCTLDIS_SHRT_PCKT_Msk & (_UINT32_(value) << UDPHS_EPTCTLDIS_SHRT_PCKT_Pos)) /* Assignment of value for SHRT_PCKT in the UDPHS_EPTCTLDIS register */
...
#define UDPHS_EPTCTL_EPT_ENABL(value)         (UDPHS_EPTCTL_EPT_ENABL_Msk & (_UINT32_(value) << UDPHS_EPTCTL_EPT_ENABL_Pos)) /* Assignment of value for EPT_ENABL in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_AUTO_VALID(value)        (UDPHS_EPTCTL_AUTO_VALID_Msk & (_UINT32_(value) << UDPHS_EPTCTL_AUTO_VALID_Pos)) /* Assignment of value for AUTO_VALID in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_INTDIS_DMA(value)        (UDPHS_EPTCTL_INTDIS_DMA_Msk & (_UINT32_(value) << UDPHS_EPTCTL_INTDIS_DMA_Pos)) /* Assignment of value for INTDIS_DMA in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_NYET_DIS(value)          (UDPHS_EPTCTL_NYET_DIS_Msk & (_UINT32_(value) << UDPHS_EPTCTL_NYET_DIS_Pos)) /* Assignment of value for NYET_DIS in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_ERR_OVFLW(value)         (UDPHS_EPTCTL_ERR_OVFLW_Msk & (_UINT32_(value) << UDPHS_EPTCTL_ERR_OVFLW_Pos)) /* Assignment of value for ERR_OVFLW in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_RXRDY_TXKL(value)        (UDPHS_EPTCTL_RXRDY_TXKL_Msk & (_UINT32_(value) << UDPHS_EPTCTL_RXRDY_TXKL_Pos)) /* Assignment of value for RXRDY_TXKL in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_TX_COMPLT(value)         (UDPHS_EPTCTL_TX_COMPLT_Msk & (_UINT32_(value) << UDPHS_EPTCTL_TX_COMPLT_Pos)) /* Assignment of value for TX_COMPLT in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_TXRDY(value)             (UDPHS_EPTCTL_TXRDY_Msk & (_UINT32_(value) << UDPHS_EPTCTL_TXRDY_Pos)) /* Assignment of value for TXRDY in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_RX_SETUP(value)          (UDPHS_EPTCTL_RX_SETUP_Msk & (_UINT32_(value) << UDPHS_EPTCTL_RX_SETUP_Pos)) /* Assignment of value for RX_SETUP in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_STALL_SNT(value)         (UDPHS_EPTCTL_STALL_SNT_Msk & (_UINT32_(value) << UDPHS_EPTCTL_STALL_SNT_Pos)) /* Assignment of value for STALL_SNT in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_NAK_IN(value)            (UDPHS_EPTCTL_NAK_IN_Msk & (_UINT32_(value) << UDPHS_EPTCTL_NAK_IN_Pos)) /* Assignment of value for NAK_IN in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_NAK_OUT(value)           (UDPHS_EPTCTL_NAK_OUT_Msk & (_UINT32_(value) << UDPHS_EPTCTL_NAK_OUT_Pos)) /* Assignment of value for NAK_OUT in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_BUSY_BANK(value)         (UDPHS_EPTCTL_BUSY_BANK_Msk & (_UINT32_(value) << UDPHS_EPTCTL_BUSY_BANK_Pos)) /* Assignment of value for BUSY_BANK in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTCTL_SHRT_PCKT(value)         (UDPHS_EPTCTL_SHRT_PCKT_Msk & (_UINT32_(value) << UDPHS_EPTCTL_SHRT_PCKT_Pos)) /* Assignment of value for SHRT_PCKT in the UDPHS_EPTCTL register */
...
#define UDPHS_EPTSETSTA_FRCESTALL(value)      (UDPHS_EPTSETSTA_FRCESTALL_Msk & (_UINT32_(value) << UDPHS_EPTSETSTA_FRCESTALL_Pos)) /* Assignment of value for FRCESTALL in the UDPHS_EPTSETSTA register */
...
#define UDPHS_EPTSETSTA_RXRDY_TXKL(value)     (UDPHS_EPTSETSTA_RXRDY_TXKL_Msk & (_UINT32_(value) << UDPHS_EPTSETSTA_RXRDY_TXKL_Pos)) /* Assignment of value for RXRDY_TXKL in the UDPHS_EPTSETSTA register */
...
#define UDPHS_EPTSETSTA_TXRDY(value)          (UDPHS_EPTSETSTA_TXRDY_Msk & (_UINT32_(value) << UDPHS_EPTSETSTA_TXRDY_Pos)) /* Assignment of value for TXRDY in the UDPHS_EPTSETSTA register */
...
#define UDPHS_EPTCLRSTA_FRCESTALL(value)      (UDPHS_EPTCLRSTA_FRCESTALL_Msk & (_UINT32_(value) << UDPHS_EPTCLRSTA_FRCESTALL_Pos)) /* Assignment of value for FRCESTALL in the UDPHS_EPTCLRSTA register */
...
#define UDPHS_EPTCLRSTA_TOGGLESQ(value)       (UDPHS_EPTCLRSTA_TOGGLESQ_Msk & (_UINT32_(value) << UDPHS_EPTCLRSTA_TOGGLESQ_Pos)) /* Assignment of value for TOGGLESQ in the UDPHS_EPTCLRSTA register */
...
#define UDPHS_EPTCLRSTA_RXRDY_TXKL(value)     (UDPHS_EPTCLRSTA_RXRDY_TXKL_Msk & (_UINT32_(value) << UDPHS_EPTCLRSTA_RXRDY_TXKL_Pos)) /* Assignment of value for RXRDY_TXKL in the UDPHS_EPTCLRSTA register */
...
#define UDPHS_EPTCLRSTA_TX_COMPLT(value)      (UDPHS_EPTCLRSTA_TX_COMPLT_Msk & (_UINT32_(value) << UDPHS_EPTCLRSTA_TX_COMPLT_Pos)) /* Assignment of value for TX_COMPLT in the UDPHS_EPTCLRSTA register */
...
#define UDPHS_EPTCLRSTA_RX_SETUP(value)       (UDPHS_EPTCLRSTA_RX_SETUP_Msk & (_UINT32_(value) << UDPHS_EPTCLRSTA_RX_SETUP_Pos)) /* Assignment of value for RX_SETUP in the UDPHS_EPTCLRSTA register */
...
#define UDPHS_EPTCLRSTA_STALL_SNT(value)      (UDPHS_EPTCLRSTA_STALL_SNT_Msk & (_UINT32_(value) << UDPHS_EPTCLRSTA_STALL_SNT_Pos)) /* Assignment of value for STALL_SNT in the UDPHS_EPTCLRSTA register */
...
#define UDPHS_EPTCLRSTA_NAK_IN(value)         (UDPHS_EPTCLRSTA_NAK_IN_Msk & (_UINT32_(value) << UDPHS_EPTCLRSTA_NAK_IN_Pos)) /* Assignment of value for NAK_IN in the UDPHS_EPTCLRSTA register */
...
#define UDPHS_EPTCLRSTA_NAK_OUT(value)        (UDPHS_EPTCLRSTA_NAK_OUT_Msk & (_UINT32_(value) << UDPHS_EPTCLRSTA_NAK_OUT_Pos)) /* Assignment of value for NAK_OUT in the UDPHS_EPTCLRSTA register */
...
#define UDPHS_EPTSTA_FRCESTALL(value)         (UDPHS_EPTSTA_FRCESTALL_Msk & (_UINT32_(value) << UDPHS_EPTSTA_FRCESTALL_Pos)) /* Assignment of value for FRCESTALL in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_TOGGLESQ_STA(value)      (UDPHS_EPTSTA_TOGGLESQ_STA_Msk & (_UINT32_(value) << UDPHS_EPTSTA_TOGGLESQ_STA_Pos)) /* Assignment of value for TOGGLESQ_STA in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_ERR_OVFLW(value)         (UDPHS_EPTSTA_ERR_OVFLW_Msk & (_UINT32_(value) << UDPHS_EPTSTA_ERR_OVFLW_Pos)) /* Assignment of value for ERR_OVFLW in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_RXRDY_TXKL(value)        (UDPHS_EPTSTA_RXRDY_TXKL_Msk & (_UINT32_(value) << UDPHS_EPTSTA_RXRDY_TXKL_Pos)) /* Assignment of value for RXRDY_TXKL in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_TX_COMPLT(value)         (UDPHS_EPTSTA_TX_COMPLT_Msk & (_UINT32_(value) << UDPHS_EPTSTA_TX_COMPLT_Pos)) /* Assignment of value for TX_COMPLT in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_TXRDY(value)             (UDPHS_EPTSTA_TXRDY_Msk & (_UINT32_(value) << UDPHS_EPTSTA_TXRDY_Pos)) /* Assignment of value for TXRDY in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_RX_SETUP(value)          (UDPHS_EPTSTA_RX_SETUP_Msk & (_UINT32_(value) << UDPHS_EPTSTA_RX_SETUP_Pos)) /* Assignment of value for RX_SETUP in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_STALL_SNT(value)         (UDPHS_EPTSTA_STALL_SNT_Msk & (_UINT32_(value) << UDPHS_EPTSTA_STALL_SNT_Pos)) /* Assignment of value for STALL_SNT in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_NAK_IN(value)            (UDPHS_EPTSTA_NAK_IN_Msk & (_UINT32_(value) << UDPHS_EPTSTA_NAK_IN_Pos)) /* Assignment of value for NAK_IN in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_NAK_OUT(value)           (UDPHS_EPTSTA_NAK_OUT_Msk & (_UINT32_(value) << UDPHS_EPTSTA_NAK_OUT_Pos)) /* Assignment of value for NAK_OUT in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_CURBK_CTLDIR(value)      (UDPHS_EPTSTA_CURBK_CTLDIR_Msk & (_UINT32_(value) << UDPHS_EPTSTA_CURBK_CTLDIR_Pos)) /* Assignment of value for CURBK_CTLDIR in the UDPHS_EPTSTA register */
#define   UDPHS_EPTSTA_CURBK_CTLDIR_0_Val     _UINT32_(0x0)                                        /* (UDPHS_EPTSTA)   */
#define   UDPHS_EPTSTA_CURBK_CTLDIR_BANK0_Val _UINT32_(0x0)                                        /* (UDPHS_EPTSTA) Control endpoint only: A Control Write is requested by the Host. or Bank 0 (or single bank)  */
#define   UDPHS_EPTSTA_CURBK_CTLDIR_BANK1_Val _UINT32_(0x1)                                        /* (UDPHS_EPTSTA) Control endpoint only: A Control Read is requested by the Host. or Bank 1  */
#define   UDPHS_EPTSTA_CURBK_CTLDIR_BANK2_Val _UINT32_(0x2)                                        /* (UDPHS_EPTSTA) Bank 2  */
#define UDPHS_EPTSTA_CURBK_CTLDIR_0           (UDPHS_EPTSTA_CURBK_CTLDIR_0_Val << UDPHS_EPTSTA_CURBK_CTLDIR_Pos) /* (UDPHS_EPTSTA)  Position */
#define UDPHS_EPTSTA_CURBK_CTLDIR_BANK0       (UDPHS_EPTSTA_CURBK_CTLDIR_BANK0_Val << UDPHS_EPTSTA_CURBK_CTLDIR_Pos) /* (UDPHS_EPTSTA) Control endpoint only: A Control Write is requested by the Host. or Bank 0 (or single bank) Position */
#define UDPHS_EPTSTA_CURBK_CTLDIR_BANK1       (UDPHS_EPTSTA_CURBK_CTLDIR_BANK1_Val << UDPHS_EPTSTA_CURBK_CTLDIR_Pos) /* (UDPHS_EPTSTA) Control endpoint only: A Control Read is requested by the Host. or Bank 1 Position */
...
#define UDPHS_EPTSTA_BUSY_BANK_STA(value)     (UDPHS_EPTSTA_BUSY_BANK_STA_Msk & (_UINT32_(value) << UDPHS_EPTSTA_BUSY_BANK_STA_Pos)) /* Assignment of value for BUSY_BANK_STA in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_BYTE_COUNT(value)        (UDPHS_EPTSTA_BYTE_COUNT_Msk & (_UINT32_(value) << UDPHS_EPTSTA_BYTE_COUNT_Pos)) /* Assignment of value for BYTE_COUNT in the UDPHS_EPTSTA register */
...
#define UDPHS_EPTSTA_SHRT_PCKT(value)         (UDPHS_EPTSTA_SHRT_PCKT_Msk & (_UINT32_(value) << UDPHS_EPTSTA_SHRT_PCKT_Pos)) /* Assignment of value for SHRT_PCKT in the UDPHS_EPTSTA register */
...
#define UDPHS_CTRL_DEV_ADDR(value)            (UDPHS_CTRL_DEV_ADDR_Msk & (_UINT32_(value) << UDPHS_CTRL_DEV_ADDR_Pos)) /* Assignment of value for DEV_ADDR in the UDPHS_CTRL register */
...
#define UDPHS_CTRL_FADDR_EN(value)            (UDPHS_CTRL_FADDR_EN_Msk & (_UINT32_(value) << UDPHS_CTRL_FADDR_EN_Pos)) /* Assignment of value for FADDR_EN in the UDPHS_CTRL register */
...
#define UDPHS_CTRL_EN_UDPHS(value)            (UDPHS_CTRL_EN_UDPHS_Msk & (_UINT32_(value) << UDPHS_CTRL_EN_UDPHS_Pos)) /* Assignment of value for EN_UDPHS in the UDPHS_CTRL register */
...
#define UDPHS_CTRL_DETACH(value)              (UDPHS_CTRL_DETACH_Msk & (_UINT32_(value) << UDPHS_CTRL_DETACH_Pos)) /* Assignment of value for DETACH in the UDPHS_CTRL register */
...
#define UDPHS_CTRL_REWAKEUP(value)            (UDPHS_CTRL_REWAKEUP_Msk & (_UINT32_(value) << UDPHS_CTRL_REWAKEUP_Pos)) /* Assignment of value for REWAKEUP in the UDPHS_CTRL register */
...
#define UDPHS_CTRL_PULLD_DIS(value)           (UDPHS_CTRL_PULLD_DIS_Msk & (_UINT32_(value) << UDPHS_CTRL_PULLD_DIS_Pos)) /* Assignment of value for PULLD_DIS in the UDPHS_CTRL register */
...
#define UDPHS_FNUM_MICRO_FRAME_NUM(value)     (UDPHS_FNUM_MICRO_FRAME_NUM_Msk & (_UINT32_(value) << UDPHS_FNUM_MICRO_FRAME_NUM_Pos)) /* Assignment of value for MICRO_FRAME_NUM in the UDPHS_FNUM register */
...
#define UDPHS_FNUM_FRAME_NUMBER(value)        (UDPHS_FNUM_FRAME_NUMBER_Msk & (_UINT32_(value) << UDPHS_FNUM_FRAME_NUMBER_Pos)) /* Assignment of value for FRAME_NUMBER in the UDPHS_FNUM register */
...
#define UDPHS_FNUM_FNUM_ERR(value)            (UDPHS_FNUM_FNUM_ERR_Msk & (_UINT32_(value) << UDPHS_FNUM_FNUM_ERR_Pos)) /* Assignment of value for FNUM_ERR in the UDPHS_FNUM register */
...
#define UDPHS_IEN_DET_SUSPD(value)            (UDPHS_IEN_DET_SUSPD_Msk & (_UINT32_(value) << UDPHS_IEN_DET_SUSPD_Pos)) /* Assignment of value for DET_SUSPD in the UDPHS_IEN register */
...
#define UDPHS_IEN_MICRO_SOF(value)            (UDPHS_IEN_MICRO_SOF_Msk & (_UINT32_(value) << UDPHS_IEN_MICRO_SOF_Pos)) /* Assignment of value for MICRO_SOF in the UDPHS_IEN register */
...
#define UDPHS_IEN_INT_SOF(value)              (UDPHS_IEN_INT_SOF_Msk & (_UINT32_(value) << UDPHS_IEN_INT_SOF_Pos)) /* Assignment of value for INT_SOF in the UDPHS_IEN register */
...
#define UDPHS_IEN_ENDRESET(value)             (UDPHS_IEN_ENDRESET_Msk & (_UINT32_(value) << UDPHS_IEN_ENDRESET_Pos)) /* Assignment of value for ENDRESET in the UDPHS_IEN register */
...
#define UDPHS_IEN_WAKE_UP(value)              (UDPHS_IEN_WAKE_UP_Msk & (_UINT32_(value) << UDPHS_IEN_WAKE_UP_Pos)) /* Assignment of value for WAKE_UP in the UDPHS_IEN register */
...
#define UDPHS_IEN_ENDOFRSM(value)             (UDPHS_IEN_ENDOFRSM_Msk & (_UINT32_(value) << UDPHS_IEN_ENDOFRSM_Pos)) /* Assignment of value for ENDOFRSM in the UDPHS_IEN register */
...
#define UDPHS_IEN_UPSTR_RES(value)            (UDPHS_IEN_UPSTR_RES_Msk & (_UINT32_(value) << UDPHS_IEN_UPSTR_RES_Pos)) /* Assignment of value for UPSTR_RES in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_0(value)                (UDPHS_IEN_EPT_0_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_0_Pos)) /* Assignment of value for EPT_0 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_1(value)                (UDPHS_IEN_EPT_1_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_1_Pos)) /* Assignment of value for EPT_1 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_2(value)                (UDPHS_IEN_EPT_2_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_2_Pos)) /* Assignment of value for EPT_2 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_3(value)                (UDPHS_IEN_EPT_3_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_3_Pos)) /* Assignment of value for EPT_3 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_4(value)                (UDPHS_IEN_EPT_4_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_4_Pos)) /* Assignment of value for EPT_4 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_5(value)                (UDPHS_IEN_EPT_5_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_5_Pos)) /* Assignment of value for EPT_5 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_6(value)                (UDPHS_IEN_EPT_6_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_6_Pos)) /* Assignment of value for EPT_6 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_7(value)                (UDPHS_IEN_EPT_7_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_7_Pos)) /* Assignment of value for EPT_7 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_8(value)                (UDPHS_IEN_EPT_8_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_8_Pos)) /* Assignment of value for EPT_8 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_9(value)                (UDPHS_IEN_EPT_9_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_9_Pos)) /* Assignment of value for EPT_9 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_10(value)               (UDPHS_IEN_EPT_10_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_10_Pos)) /* Assignment of value for EPT_10 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_11(value)               (UDPHS_IEN_EPT_11_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_11_Pos)) /* Assignment of value for EPT_11 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_12(value)               (UDPHS_IEN_EPT_12_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_12_Pos)) /* Assignment of value for EPT_12 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_13(value)               (UDPHS_IEN_EPT_13_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_13_Pos)) /* Assignment of value for EPT_13 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_14(value)               (UDPHS_IEN_EPT_14_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_14_Pos)) /* Assignment of value for EPT_14 in the UDPHS_IEN register */
...
#define UDPHS_IEN_EPT_15(value)               (UDPHS_IEN_EPT_15_Msk & (_UINT32_(value) << UDPHS_IEN_EPT_15_Pos)) /* Assignment of value for EPT_15 in the UDPHS_IEN register */
...
#define UDPHS_IEN_DMA_1(value)                (UDPHS_IEN_DMA_1_Msk & (_UINT32_(value) << UDPHS_IEN_DMA_1_Pos)) /* Assignment of value for DMA_1 in the UDPHS_IEN register */
...
#define UDPHS_IEN_DMA_2(value)                (UDPHS_IEN_DMA_2_Msk & (_UINT32_(value) << UDPHS_IEN_DMA_2_Pos)) /* Assignment of value for DMA_2 in the UDPHS_IEN register */
...
#define UDPHS_IEN_DMA_3(value)                (UDPHS_IEN_DMA_3_Msk & (_UINT32_(value) << UDPHS_IEN_DMA_3_Pos)) /* Assignment of value for DMA_3 in the UDPHS_IEN register */
...
#define UDPHS_IEN_DMA_4(value)                (UDPHS_IEN_DMA_4_Msk & (_UINT32_(value) << UDPHS_IEN_DMA_4_Pos)) /* Assignment of value for DMA_4 in the UDPHS_IEN register */
...
#define UDPHS_IEN_DMA_5(value)                (UDPHS_IEN_DMA_5_Msk & (_UINT32_(value) << UDPHS_IEN_DMA_5_Pos)) /* Assignment of value for DMA_5 in the UDPHS_IEN register */
...
#define UDPHS_IEN_DMA_6(value)                (UDPHS_IEN_DMA_6_Msk & (_UINT32_(value) << UDPHS_IEN_DMA_6_Pos)) /* Assignment of value for DMA_6 in the UDPHS_IEN register */
...
#define UDPHS_IEN_DMA_7(value)                (UDPHS_IEN_DMA_7_Msk & (_UINT32_(value) << UDPHS_IEN_DMA_7_Pos)) /* Assignment of value for DMA_7 in the UDPHS_IEN register */
...
#define UDPHS_INTSTA_SPEED(value)             (UDPHS_INTSTA_SPEED_Msk & (_UINT32_(value) << UDPHS_INTSTA_SPEED_Pos)) /* Assignment of value for SPEED in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_DET_SUSPD(value)         (UDPHS_INTSTA_DET_SUSPD_Msk & (_UINT32_(value) << UDPHS_INTSTA_DET_SUSPD_Pos)) /* Assignment of value for DET_SUSPD in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_MICRO_SOF(value)         (UDPHS_INTSTA_MICRO_SOF_Msk & (_UINT32_(value) << UDPHS_INTSTA_MICRO_SOF_Pos)) /* Assignment of value for MICRO_SOF in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_INT_SOF(value)           (UDPHS_INTSTA_INT_SOF_Msk & (_UINT32_(value) << UDPHS_INTSTA_INT_SOF_Pos)) /* Assignment of value for INT_SOF in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_ENDRESET(value)          (UDPHS_INTSTA_ENDRESET_Msk & (_UINT32_(value) << UDPHS_INTSTA_ENDRESET_Pos)) /* Assignment of value for ENDRESET in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_WAKE_UP(value)           (UDPHS_INTSTA_WAKE_UP_Msk & (_UINT32_(value) << UDPHS_INTSTA_WAKE_UP_Pos)) /* Assignment of value for WAKE_UP in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_ENDOFRSM(value)          (UDPHS_INTSTA_ENDOFRSM_Msk & (_UINT32_(value) << UDPHS_INTSTA_ENDOFRSM_Pos)) /* Assignment of value for ENDOFRSM in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_UPSTR_RES(value)         (UDPHS_INTSTA_UPSTR_RES_Msk & (_UINT32_(value) << UDPHS_INTSTA_UPSTR_RES_Pos)) /* Assignment of value for UPSTR_RES in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_0(value)             (UDPHS_INTSTA_EPT_0_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_0_Pos)) /* Assignment of value for EPT_0 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_1(value)             (UDPHS_INTSTA_EPT_1_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_1_Pos)) /* Assignment of value for EPT_1 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_2(value)             (UDPHS_INTSTA_EPT_2_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_2_Pos)) /* Assignment of value for EPT_2 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_3(value)             (UDPHS_INTSTA_EPT_3_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_3_Pos)) /* Assignment of value for EPT_3 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_4(value)             (UDPHS_INTSTA_EPT_4_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_4_Pos)) /* Assignment of value for EPT_4 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_5(value)             (UDPHS_INTSTA_EPT_5_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_5_Pos)) /* Assignment of value for EPT_5 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_6(value)             (UDPHS_INTSTA_EPT_6_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_6_Pos)) /* Assignment of value for EPT_6 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_7(value)             (UDPHS_INTSTA_EPT_7_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_7_Pos)) /* Assignment of value for EPT_7 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_8(value)             (UDPHS_INTSTA_EPT_8_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_8_Pos)) /* Assignment of value for EPT_8 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_9(value)             (UDPHS_INTSTA_EPT_9_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_9_Pos)) /* Assignment of value for EPT_9 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_10(value)            (UDPHS_INTSTA_EPT_10_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_10_Pos)) /* Assignment of value for EPT_10 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_11(value)            (UDPHS_INTSTA_EPT_11_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_11_Pos)) /* Assignment of value for EPT_11 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_12(value)            (UDPHS_INTSTA_EPT_12_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_12_Pos)) /* Assignment of value for EPT_12 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_13(value)            (UDPHS_INTSTA_EPT_13_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_13_Pos)) /* Assignment of value for EPT_13 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_14(value)            (UDPHS_INTSTA_EPT_14_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_14_Pos)) /* Assignment of value for EPT_14 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_EPT_15(value)            (UDPHS_INTSTA_EPT_15_Msk & (_UINT32_(value) << UDPHS_INTSTA_EPT_15_Pos)) /* Assignment of value for EPT_15 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_DMA_1(value)             (UDPHS_INTSTA_DMA_1_Msk & (_UINT32_(value) << UDPHS_INTSTA_DMA_1_Pos)) /* Assignment of value for DMA_1 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_DMA_2(value)             (UDPHS_INTSTA_DMA_2_Msk & (_UINT32_(value) << UDPHS_INTSTA_DMA_2_Pos)) /* Assignment of value for DMA_2 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_DMA_3(value)             (UDPHS_INTSTA_DMA_3_Msk & (_UINT32_(value) << UDPHS_INTSTA_DMA_3_Pos)) /* Assignment of value for DMA_3 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_DMA_4(value)             (UDPHS_INTSTA_DMA_4_Msk & (_UINT32_(value) << UDPHS_INTSTA_DMA_4_Pos)) /* Assignment of value for DMA_4 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_DMA_5(value)             (UDPHS_INTSTA_DMA_5_Msk & (_UINT32_(value) << UDPHS_INTSTA_DMA_5_Pos)) /* Assignment of value for DMA_5 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_DMA_6(value)             (UDPHS_INTSTA_DMA_6_Msk & (_UINT32_(value) << UDPHS_INTSTA_DMA_6_Pos)) /* Assignment of value for DMA_6 in the UDPHS_INTSTA register */
...
#define UDPHS_INTSTA_DMA_7(value)             (UDPHS_INTSTA_DMA_7_Msk & (_UINT32_(value) << UDPHS_INTSTA_DMA_7_Pos)) /* Assignment of value for DMA_7 in the UDPHS_INTSTA register */
...
#define UDPHS_CLRINT_DET_SUSPD(value)         (UDPHS_CLRINT_DET_SUSPD_Msk & (_UINT32_(value) << UDPHS_CLRINT_DET_SUSPD_Pos)) /* Assignment of value for DET_SUSPD in the UDPHS_CLRINT register */
...
#define UDPHS_CLRINT_MICRO_SOF(value)         (UDPHS_CLRINT_MICRO_SOF_Msk & (_UINT32_(value) << UDPHS_CLRINT_MICRO_SOF_Pos)) /* Assignment of value for MICRO_SOF in the UDPHS_CLRINT register */
...
#define UDPHS_CLRINT_INT_SOF(value)           (UDPHS_CLRINT_INT_SOF_Msk & (_UINT32_(value) << UDPHS_CLRINT_INT_SOF_Pos)) /* Assignment of value for INT_SOF in the UDPHS_CLRINT register */
...
#define UDPHS_CLRINT_ENDRESET(value)          (UDPHS_CLRINT_ENDRESET_Msk & (_UINT32_(value) << UDPHS_CLRINT_ENDRESET_Pos)) /* Assignment of value for ENDRESET in the UDPHS_CLRINT register */
...
#define UDPHS_CLRINT_WAKE_UP(value)           (UDPHS_CLRINT_WAKE_UP_Msk & (_UINT32_(value) << UDPHS_CLRINT_WAKE_UP_Pos)) /* Assignment of value for WAKE_UP in the UDPHS_CLRINT register */
...
#define UDPHS_CLRINT_ENDOFRSM(value)          (UDPHS_CLRINT_ENDOFRSM_Msk & (_UINT32_(value) << UDPHS_CLRINT_ENDOFRSM_Pos)) /* Assignment of value for ENDOFRSM in the UDPHS_CLRINT register */
...
#define UDPHS_CLRINT_UPSTR_RES(value)         (UDPHS_CLRINT_UPSTR_RES_Msk & (_UINT32_(value) << UDPHS_CLRINT_UPSTR_RES_Pos)) /* Assignment of value for UPSTR_RES in the UDPHS_CLRINT register */
...
#define UDPHS_EPTRST_EPT_0(value)             (UDPHS_EPTRST_EPT_0_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_0_Pos)) /* Assignment of value for EPT_0 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_1(value)             (UDPHS_EPTRST_EPT_1_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_1_Pos)) /* Assignment of value for EPT_1 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_2(value)             (UDPHS_EPTRST_EPT_2_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_2_Pos)) /* Assignment of value for EPT_2 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_3(value)             (UDPHS_EPTRST_EPT_3_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_3_Pos)) /* Assignment of value for EPT_3 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_4(value)             (UDPHS_EPTRST_EPT_4_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_4_Pos)) /* Assignment of value for EPT_4 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_5(value)             (UDPHS_EPTRST_EPT_5_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_5_Pos)) /* Assignment of value for EPT_5 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_6(value)             (UDPHS_EPTRST_EPT_6_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_6_Pos)) /* Assignment of value for EPT_6 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_7(value)             (UDPHS_EPTRST_EPT_7_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_7_Pos)) /* Assignment of value for EPT_7 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_8(value)             (UDPHS_EPTRST_EPT_8_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_8_Pos)) /* Assignment of value for EPT_8 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_9(value)             (UDPHS_EPTRST_EPT_9_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_9_Pos)) /* Assignment of value for EPT_9 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_10(value)            (UDPHS_EPTRST_EPT_10_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_10_Pos)) /* Assignment of value for EPT_10 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_11(value)            (UDPHS_EPTRST_EPT_11_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_11_Pos)) /* Assignment of value for EPT_11 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_12(value)            (UDPHS_EPTRST_EPT_12_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_12_Pos)) /* Assignment of value for EPT_12 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_13(value)            (UDPHS_EPTRST_EPT_13_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_13_Pos)) /* Assignment of value for EPT_13 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_14(value)            (UDPHS_EPTRST_EPT_14_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_14_Pos)) /* Assignment of value for EPT_14 in the UDPHS_EPTRST register */
...
#define UDPHS_EPTRST_EPT_15(value)            (UDPHS_EPTRST_EPT_15_Msk & (_UINT32_(value) << UDPHS_EPTRST_EPT_15_Pos)) /* Assignment of value for EPT_15 in the UDPHS_EPTRST register */
...
#define UDPHS_TST_SPEED_CFG(value)            (UDPHS_TST_SPEED_CFG_Msk & (_UINT32_(value) << UDPHS_TST_SPEED_CFG_Pos)) /* Assignment of value for SPEED_CFG in the UDPHS_TST register */
...
#define UDPHS_TST_TST_J(value)                (UDPHS_TST_TST_J_Msk & (_UINT32_(value) << UDPHS_TST_TST_J_Pos)) /* Assignment of value for TST_J in the UDPHS_TST register */
...
#define UDPHS_TST_TST_K(value)                (UDPHS_TST_TST_K_Msk & (_UINT32_(value) << UDPHS_TST_TST_K_Pos)) /* Assignment of value for TST_K in the UDPHS_TST register */
...
#define UDPHS_TST_TST_PKT(value)              (UDPHS_TST_TST_PKT_Msk & (_UINT32_(value) << UDPHS_TST_TST_PKT_Pos)) /* Assignment of value for TST_PKT in the UDPHS_TST register */
...
#define UDPHS_TST_OPMODE2(value)              (UDPHS_TST_OPMODE2_Msk & (_UINT32_(value) << UDPHS_TST_OPMODE2_Pos)) /* Assignment of value for OPMODE2 in the UDPHS_TST register */
...
/* UDPHS register offsets definitions */
...
/* UDPHS_DMA register API structure */
typedef struct
{
...
/* UDPHS_EPT register API structure */
typedef struct
{
...
#endif /* _SAMA7G5_UDPHS_COMPONENT_H_ */
