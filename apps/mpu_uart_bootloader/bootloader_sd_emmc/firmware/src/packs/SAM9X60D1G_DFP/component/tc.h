...
#ifndef _SAM9X6_TC_COMPONENT_H_
#define _SAM9X6_TC_COMPONENT_H_
...
#define   TC_CMR_TCCLKS_TIMER_CLOCK2_Val      _UINT32_(0x1)                                        /* (TC_CMR) Clock selected: internal div8 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK3_Val      _UINT32_(0x2)                                        /* (TC_CMR) Clock selected: internal div32 clock signal (from PMC)  */
#define   TC_CMR_TCCLKS_TIMER_CLOCK4_Val      _UINT32_(0x3)                                        /* (TC_CMR) Clock selected: internal div128 clock signal (from PMC)  */
...
#define TC_SR_Msk                             _UINT32_(0x000704FF)                                 /* (TC_SR) Register Mask  */
