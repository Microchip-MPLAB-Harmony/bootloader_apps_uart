...
#define GFX2D_PA_PA(value)                    (GFX2D_PA_PA_Msk & (_UINT32_(value) << GFX2D_PA_PA_Pos)) /* Assignment of value for PA in the GFX2D_PA register */
...
#define GFX2D_PITCH_PITCH(value)              (GFX2D_PITCH_PITCH_Msk & (_UINT32_(value) << GFX2D_PITCH_PITCH_Pos)) /* Assignment of value for PITCH in the GFX2D_PITCH register */
...
#define GFX2D_CFG_PF(value)                   (GFX2D_CFG_PF_Msk & (_UINT32_(value) << GFX2D_CFG_PF_Pos)) /* Assignment of value for PF in the GFX2D_CFG register */
...
#define GFX2D_CFG_IDXCX(value)                (GFX2D_CFG_IDXCX_Msk & (_UINT32_(value) << GFX2D_CFG_IDXCX_Pos)) /* Assignment of value for IDXCX in the GFX2D_CFG register */
...
#define GFX2D_PC_SEL(value)                   (GFX2D_PC_SEL_Msk & (_UINT32_(value) << GFX2D_PC_SEL_Pos)) /* Assignment of value for SEL in the GFX2D_PC register */
...
#define GFX2D_PC_FILT(value)                  (GFX2D_PC_FILT_Msk & (_UINT32_(value) << GFX2D_PC_FILT_Pos)) /* Assignment of value for FILT in the GFX2D_PC register */
...
#define GFX2D_MC_COUNTER(value)               (GFX2D_MC_COUNTER_Msk & (_UINT32_(value) << GFX2D_MC_COUNTER_Pos)) /* Assignment of value for COUNTER in the GFX2D_MC register */
...
#define GFX2D_GC_REGEN(value)                 (GFX2D_GC_REGEN_Msk & (_UINT32_(value) << GFX2D_GC_REGEN_Pos)) /* Assignment of value for REGEN in the GFX2D_GC register */
...
#define GFX2D_GC_MTY(value)                   (GFX2D_GC_MTY_Msk & (_UINT32_(value) << GFX2D_GC_MTY_Pos)) /* Assignment of value for MTY in the GFX2D_GC register */
...
#define GFX2D_GC_REGQOS1(value)               (GFX2D_GC_REGQOS1_Msk & (_UINT32_(value) << GFX2D_GC_REGQOS1_Pos)) /* Assignment of value for REGQOS1 in the GFX2D_GC register */
...
#define GFX2D_GC_REGQOS2(value)               (GFX2D_GC_REGQOS2_Msk & (_UINT32_(value) << GFX2D_GC_REGQOS2_Pos)) /* Assignment of value for REGQOS2 in the GFX2D_GC register */
...
#define GFX2D_GC_REGQOS3(value)               (GFX2D_GC_REGQOS3_Msk & (_UINT32_(value) << GFX2D_GC_REGQOS3_Pos)) /* Assignment of value for REGQOS3 in the GFX2D_GC register */
...
#define GFX2D_GE_ENABLE(value)                (GFX2D_GE_ENABLE_Msk & (_UINT32_(value) << GFX2D_GE_ENABLE_Pos)) /* Assignment of value for ENABLE in the GFX2D_GE register */
...
#define GFX2D_GD_DISABLE(value)               (GFX2D_GD_DISABLE_Msk & (_UINT32_(value) << GFX2D_GD_DISABLE_Pos)) /* Assignment of value for DISABLE in the GFX2D_GD register */
...
#define GFX2D_GD_WFERES(value)                (GFX2D_GD_WFERES_Msk & (_UINT32_(value) << GFX2D_GD_WFERES_Pos)) /* Assignment of value for WFERES in the GFX2D_GD register */
...
#define GFX2D_GS_STATUS(value)                (GFX2D_GS_STATUS_Msk & (_UINT32_(value) << GFX2D_GS_STATUS_Pos)) /* Assignment of value for STATUS in the GFX2D_GS register */
...
#define GFX2D_GS_BUSY(value)                  (GFX2D_GS_BUSY_Msk & (_UINT32_(value) << GFX2D_GS_BUSY_Pos)) /* Assignment of value for BUSY in the GFX2D_GS register */
...
#define GFX2D_GS_WFEIP(value)                 (GFX2D_GS_WFEIP_Msk & (_UINT32_(value) << GFX2D_GS_WFEIP_Pos)) /* Assignment of value for WFEIP in the GFX2D_GS register */
...
#define GFX2D_IE_RBEMPTY(value)               (GFX2D_IE_RBEMPTY_Msk & (_UINT32_(value) << GFX2D_IE_RBEMPTY_Pos)) /* Assignment of value for RBEMPTY in the GFX2D_IE register */
...
#define GFX2D_IE_EXEND(value)                 (GFX2D_IE_EXEND_Msk & (_UINT32_(value) << GFX2D_IE_EXEND_Pos)) /* Assignment of value for EXEND in the GFX2D_IE register */
...
#define GFX2D_IE_RERR(value)                  (GFX2D_IE_RERR_Msk & (_UINT32_(value) << GFX2D_IE_RERR_Pos)) /* Assignment of value for RERR in the GFX2D_IE register */
...
#define GFX2D_IE_BERR(value)                  (GFX2D_IE_BERR_Msk & (_UINT32_(value) << GFX2D_IE_BERR_Pos)) /* Assignment of value for BERR in the GFX2D_IE register */
...
#define GFX2D_IE_IERR(value)                  (GFX2D_IE_IERR_Msk & (_UINT32_(value) << GFX2D_IE_IERR_Pos)) /* Assignment of value for IERR in the GFX2D_IE register */
...
#define GFX2D_ID_RBEMPTY(value)               (GFX2D_ID_RBEMPTY_Msk & (_UINT32_(value) << GFX2D_ID_RBEMPTY_Pos)) /* Assignment of value for RBEMPTY in the GFX2D_ID register */
...
#define GFX2D_ID_EXEND(value)                 (GFX2D_ID_EXEND_Msk & (_UINT32_(value) << GFX2D_ID_EXEND_Pos)) /* Assignment of value for EXEND in the GFX2D_ID register */
...
#define GFX2D_ID_RERR(value)                  (GFX2D_ID_RERR_Msk & (_UINT32_(value) << GFX2D_ID_RERR_Pos)) /* Assignment of value for RERR in the GFX2D_ID register */
...
#define GFX2D_ID_BERR(value)                  (GFX2D_ID_BERR_Msk & (_UINT32_(value) << GFX2D_ID_BERR_Pos)) /* Assignment of value for BERR in the GFX2D_ID register */
...
#define GFX2D_ID_IERR(value)                  (GFX2D_ID_IERR_Msk & (_UINT32_(value) << GFX2D_ID_IERR_Pos)) /* Assignment of value for IERR in the GFX2D_ID register */
...
#define GFX2D_IM_RBEMPTY(value)               (GFX2D_IM_RBEMPTY_Msk & (_UINT32_(value) << GFX2D_IM_RBEMPTY_Pos)) /* Assignment of value for RBEMPTY in the GFX2D_IM register */
...
#define GFX2D_IM_EXEND(value)                 (GFX2D_IM_EXEND_Msk & (_UINT32_(value) << GFX2D_IM_EXEND_Pos)) /* Assignment of value for EXEND in the GFX2D_IM register */
...
#define GFX2D_IM_RERR(value)                  (GFX2D_IM_RERR_Msk & (_UINT32_(value) << GFX2D_IM_RERR_Pos)) /* Assignment of value for RERR in the GFX2D_IM register */
...
#define GFX2D_IM_BERR(value)                  (GFX2D_IM_BERR_Msk & (_UINT32_(value) << GFX2D_IM_BERR_Pos)) /* Assignment of value for BERR in the GFX2D_IM register */
...
#define GFX2D_IM_IERR(value)                  (GFX2D_IM_IERR_Msk & (_UINT32_(value) << GFX2D_IM_IERR_Pos)) /* Assignment of value for IERR in the GFX2D_IM register */
...
#define GFX2D_IS_RBEMPTY(value)               (GFX2D_IS_RBEMPTY_Msk & (_UINT32_(value) << GFX2D_IS_RBEMPTY_Pos)) /* Assignment of value for RBEMPTY in the GFX2D_IS register */
...
#define GFX2D_IS_EXEND(value)                 (GFX2D_IS_EXEND_Msk & (_UINT32_(value) << GFX2D_IS_EXEND_Pos)) /* Assignment of value for EXEND in the GFX2D_IS register */
...
#define GFX2D_IS_RERR(value)                  (GFX2D_IS_RERR_Msk & (_UINT32_(value) << GFX2D_IS_RERR_Pos)) /* Assignment of value for RERR in the GFX2D_IS register */
...
#define GFX2D_IS_BERR(value)                  (GFX2D_IS_BERR_Msk & (_UINT32_(value) << GFX2D_IS_BERR_Pos)) /* Assignment of value for BERR in the GFX2D_IS register */
...
#define GFX2D_IS_IERR(value)                  (GFX2D_IS_IERR_Msk & (_UINT32_(value) << GFX2D_IS_IERR_Pos)) /* Assignment of value for IERR in the GFX2D_IS register */
...
#define GFX2D_BASE_BASE(value)                (GFX2D_BASE_BASE_Msk & (_UINT32_(value) << GFX2D_BASE_BASE_Pos)) /* Assignment of value for BASE in the GFX2D_BASE register */
...
#define GFX2D_LEN_LEN(value)                  (GFX2D_LEN_LEN_Msk & (_UINT32_(value) << GFX2D_LEN_LEN_Pos)) /* Assignment of value for LEN in the GFX2D_LEN register */
...
#define GFX2D_HEAD_HEAD(value)                (GFX2D_HEAD_HEAD_Msk & (_UINT32_(value) << GFX2D_HEAD_HEAD_Pos)) /* Assignment of value for HEAD in the GFX2D_HEAD register */
...
#define GFX2D_TAIL_TAIL(value)                (GFX2D_TAIL_TAIL_Msk & (_UINT32_(value) << GFX2D_TAIL_TAIL_Pos)) /* Assignment of value for TAIL in the GFX2D_TAIL register */
#define GFX2D_TAIL_Msk                        _UINT32_(0x000003FF)                                 /* (GFX2D_TAIL) Register Mask  */


/* GFX2D register offsets definitions */
...
/* GFX2D_CHID register API structure */
typedef struct
{
...
/* GFX2D_SUB0 register API structure */
typedef struct
{
