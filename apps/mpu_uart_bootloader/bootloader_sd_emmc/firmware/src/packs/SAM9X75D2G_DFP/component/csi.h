...
#define CSI_CSI2_RESETN_CSI2_RESETN(value)    (CSI_CSI2_RESETN_CSI2_RESETN_Msk & (_UINT32_(value) << CSI_CSI2_RESETN_CSI2_RESETN_Pos)) /* Assignment of value for CSI2_RESETN in the CSI_CSI2_RESETN register */
...
#define CSI_INT_ST_MAIN_STATUS_INT_PHY_FATAL(value) (CSI_INT_ST_MAIN_STATUS_INT_PHY_FATAL_Msk & (_UINT32_(value) << CSI_INT_ST_MAIN_STATUS_INT_PHY_FATAL_Pos)) /* Assignment of value for STATUS_INT_PHY_FATAL in the CSI_INT_ST_MAIN register */
...
#define CSI_INT_ST_MAIN_STATUS_INT_PKT_FATAL(value) (CSI_INT_ST_MAIN_STATUS_INT_PKT_FATAL_Msk & (_UINT32_(value) << CSI_INT_ST_MAIN_STATUS_INT_PKT_FATAL_Pos)) /* Assignment of value for STATUS_INT_PKT_FATAL in the CSI_INT_ST_MAIN register */
...
#define CSI_INT_ST_MAIN_STATUS_INT_FRAME_FATAL(value) (CSI_INT_ST_MAIN_STATUS_INT_FRAME_FATAL_Msk & (_UINT32_(value) << CSI_INT_ST_MAIN_STATUS_INT_FRAME_FATAL_Pos)) /* Assignment of value for STATUS_INT_FRAME_FATAL in the CSI_INT_ST_MAIN register */
...
#define CSI_INT_ST_MAIN_STATUS_INT_PKT(value) (CSI_INT_ST_MAIN_STATUS_INT_PKT_Msk & (_UINT32_(value) << CSI_INT_ST_MAIN_STATUS_INT_PKT_Pos)) /* Assignment of value for STATUS_INT_PKT in the CSI_INT_ST_MAIN register */
...
#define CSI_PHY_SHUTDOWNZ_PHY_SHUTDOWNZ(value) (CSI_PHY_SHUTDOWNZ_PHY_SHUTDOWNZ_Msk & (_UINT32_(value) << CSI_PHY_SHUTDOWNZ_PHY_SHUTDOWNZ_Pos)) /* Assignment of value for PHY_SHUTDOWNZ in the CSI_PHY_SHUTDOWNZ register */
...
#define CSI_DPHY_RSTZ_DPHY_RSTZ(value)        (CSI_DPHY_RSTZ_DPHY_RSTZ_Msk & (_UINT32_(value) << CSI_DPHY_RSTZ_DPHY_RSTZ_Pos)) /* Assignment of value for DPHY_RSTZ in the CSI_DPHY_RSTZ register */
...
#define CSI_PHY_RX_PHY_RXULPSESC_0(value)     (CSI_PHY_RX_PHY_RXULPSESC_0_Msk & (_UINT32_(value) << CSI_PHY_RX_PHY_RXULPSESC_0_Pos)) /* Assignment of value for PHY_RXULPSESC_0 in the CSI_PHY_RX register */
...
#define CSI_PHY_RX_PHY_RXULPSESC_1(value)     (CSI_PHY_RX_PHY_RXULPSESC_1_Msk & (_UINT32_(value) << CSI_PHY_RX_PHY_RXULPSESC_1_Pos)) /* Assignment of value for PHY_RXULPSESC_1 in the CSI_PHY_RX register */
...
#define CSI_PHY_RX_PHY_RXULPSESC_2(value)     (CSI_PHY_RX_PHY_RXULPSESC_2_Msk & (_UINT32_(value) << CSI_PHY_RX_PHY_RXULPSESC_2_Pos)) /* Assignment of value for PHY_RXULPSESC_2 in the CSI_PHY_RX register */
...
#define CSI_PHY_RX_PHY_RXULPSESC_3(value)     (CSI_PHY_RX_PHY_RXULPSESC_3_Msk & (_UINT32_(value) << CSI_PHY_RX_PHY_RXULPSESC_3_Pos)) /* Assignment of value for PHY_RXULPSESC_3 in the CSI_PHY_RX register */
...
#define CSI_PHY_STOPSTATE_PHY_STOPSTADATA_2(value) (CSI_PHY_STOPSTATE_PHY_STOPSTADATA_2_Msk & (_UINT32_(value) << CSI_PHY_STOPSTATE_PHY_STOPSTADATA_2_Pos)) /* Assignment of value for PHY_STOPSTADATA_2 in the CSI_PHY_STOPSTATE register */
...
#define CSI_PHY_STOPSTATE_PHY_STOPSTADATA_3(value) (CSI_PHY_STOPSTATE_PHY_STOPSTADATA_3_Msk & (_UINT32_(value) << CSI_PHY_STOPSTATE_PHY_STOPSTADATA_3_Pos)) /* Assignment of value for PHY_STOPSTADATA_3 in the CSI_PHY_STOPSTATE register */
...
#define CSI_PHY_TEST_CTRL0_PHY_TESTCLR(value) (CSI_PHY_TEST_CTRL0_PHY_TESTCLR_Msk & (_UINT32_(value) << CSI_PHY_TEST_CTRL0_PHY_TESTCLR_Pos)) /* Assignment of value for PHY_TESTCLR in the CSI_PHY_TEST_CTRL0 register */
...
#define CSI_PHY_TEST_CTRL0_PHY_TESTCLK(value) (CSI_PHY_TEST_CTRL0_PHY_TESTCLK_Msk & (_UINT32_(value) << CSI_PHY_TEST_CTRL0_PHY_TESTCLK_Pos)) /* Assignment of value for PHY_TESTCLK in the CSI_PHY_TEST_CTRL0 register */
...
#define CSI_PHY_TEST_CTRL1_PHY_TESTDIN(value) (CSI_PHY_TEST_CTRL1_PHY_TESTDIN_Msk & (_UINT32_(value) << CSI_PHY_TEST_CTRL1_PHY_TESTDIN_Pos)) /* Assignment of value for PHY_TESTDIN in the CSI_PHY_TEST_CTRL1 register */
...
#define CSI_PHY_TEST_CTRL1_PHY_TESTDOUT(value) (CSI_PHY_TEST_CTRL1_PHY_TESTDOUT_Msk & (_UINT32_(value) << CSI_PHY_TEST_CTRL1_PHY_TESTDOUT_Pos)) /* Assignment of value for PHY_TESTDOUT in the CSI_PHY_TEST_CTRL1 register */
...
#define CSI_PHY_TEST_CTRL1_PHY_TESTEN(value)  (CSI_PHY_TEST_CTRL1_PHY_TESTEN_Msk & (_UINT32_(value) << CSI_PHY_TEST_CTRL1_PHY_TESTEN_Pos)) /* Assignment of value for PHY_TESTEN in the CSI_PHY_TEST_CTRL1 register */
...
#define CSI_PHY_CAL_RXSKEWCALHS(value)        (CSI_PHY_CAL_RXSKEWCALHS_Msk & (_UINT32_(value) << CSI_PHY_CAL_RXSKEWCALHS_Pos)) /* Assignment of value for RXSKEWCALHS in the CSI_PHY_CAL register */
...
#define CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_0(value) (CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_0_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_0_Pos)) /* Assignment of value for PHY_ERRSOTSYNCHS_0 in the CSI_INT_ST_PHY_FATAL register */
...
#define CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_1(value) (CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_1_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_1_Pos)) /* Assignment of value for PHY_ERRSOTSYNCHS_1 in the CSI_INT_ST_PHY_FATAL register */
...
#define CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_2(value) (CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_2_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_2_Pos)) /* Assignment of value for PHY_ERRSOTSYNCHS_2 in the CSI_INT_ST_PHY_FATAL register */
...
#define CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_3(value) (CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_3_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS_3_Pos)) /* Assignment of value for PHY_ERRSOTSYNCHS_3 in the CSI_INT_ST_PHY_FATAL register */
...
#define CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_0(value) (CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_0_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_0_Pos)) /* Assignment of value for MASK_ERRSOTSYNCHS_0 in the CSI_INT_MSK_PHY_FATAL register */
...
#define CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_1(value) (CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_1_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_1_Pos)) /* Assignment of value for MASK_ERRSOTSYNCHS_1 in the CSI_INT_MSK_PHY_FATAL register */
...
#define CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_2(value) (CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_2_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_2_Pos)) /* Assignment of value for MASK_ERRSOTSYNCHS_2 in the CSI_INT_MSK_PHY_FATAL register */
...
#define CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_3(value) (CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_3_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS_3_Pos)) /* Assignment of value for MASK_ERRSOTSYNCHS_3 in the CSI_INT_MSK_PHY_FATAL register */
...
#define CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_0(value) (CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_0_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_0_Pos)) /* Assignment of value for FORCE_ERRSOTSYNCHS_0 in the CSI_INT_FORCE_PHY_FATAL register */
...
#define CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_1(value) (CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_1_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_1_Pos)) /* Assignment of value for FORCE_ERRSOTSYNCHS_1 in the CSI_INT_FORCE_PHY_FATAL register */
...
#define CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_2(value) (CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_2_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_2_Pos)) /* Assignment of value for FORCE_ERRSOTSYNCHS_2 in the CSI_INT_FORCE_PHY_FATAL register */
...
#define CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_3(value) (CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_3_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS_3_Pos)) /* Assignment of value for FORCE_ERRSOTSYNCHS_3 in the CSI_INT_FORCE_PHY_FATAL register */
...
#define CSI_INT_ST_PKT_FATAL_VC0_ERR_CRC(value) (CSI_INT_ST_PKT_FATAL_VC0_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_FATAL_VC0_ERR_CRC_Pos)) /* Assignment of value for VC0_ERR_CRC in the CSI_INT_ST_PKT_FATAL register */
...
#define CSI_INT_ST_PKT_FATAL_VC1_ERR_CRC(value) (CSI_INT_ST_PKT_FATAL_VC1_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_FATAL_VC1_ERR_CRC_Pos)) /* Assignment of value for VC1_ERR_CRC in the CSI_INT_ST_PKT_FATAL register */
...
#define CSI_INT_ST_PKT_FATAL_VC2_ERR_CRC(value) (CSI_INT_ST_PKT_FATAL_VC2_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_FATAL_VC2_ERR_CRC_Pos)) /* Assignment of value for VC2_ERR_CRC in the CSI_INT_ST_PKT_FATAL register */
...
#define CSI_INT_ST_PKT_FATAL_VC3_ERR_CRC(value) (CSI_INT_ST_PKT_FATAL_VC3_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_FATAL_VC3_ERR_CRC_Pos)) /* Assignment of value for VC3_ERR_CRC in the CSI_INT_ST_PKT_FATAL register */
...
#define CSI_INT_ST_PKT_FATAL_ERR_ECC_DOUBLE(value) (CSI_INT_ST_PKT_FATAL_ERR_ECC_DOUBLE_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_FATAL_ERR_ECC_DOUBLE_Pos)) /* Assignment of value for ERR_ECC_DOUBLE in the CSI_INT_ST_PKT_FATAL register */
...
#define CSI_INT_MSK_PKT_FATAL_MASK_VC0_ERR_CRC(value) (CSI_INT_MSK_PKT_FATAL_MASK_VC0_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_FATAL_MASK_VC0_ERR_CRC_Pos)) /* Assignment of value for MASK_VC0_ERR_CRC in the CSI_INT_MSK_PKT_FATAL register */
...
#define CSI_INT_MSK_PKT_FATAL_MASK_VC1_ERR_CRC(value) (CSI_INT_MSK_PKT_FATAL_MASK_VC1_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_FATAL_MASK_VC1_ERR_CRC_Pos)) /* Assignment of value for MASK_VC1_ERR_CRC in the CSI_INT_MSK_PKT_FATAL register */
...
#define CSI_INT_MSK_PKT_FATAL_MASK_VC2_ERR_CRC(value) (CSI_INT_MSK_PKT_FATAL_MASK_VC2_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_FATAL_MASK_VC2_ERR_CRC_Pos)) /* Assignment of value for MASK_VC2_ERR_CRC in the CSI_INT_MSK_PKT_FATAL register */
...
#define CSI_INT_MSK_PKT_FATAL_MASK_VC3_ERR_CRC(value) (CSI_INT_MSK_PKT_FATAL_MASK_VC3_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_FATAL_MASK_VC3_ERR_CRC_Pos)) /* Assignment of value for MASK_VC3_ERR_CRC in the CSI_INT_MSK_PKT_FATAL register */
...
#define CSI_INT_MSK_PKT_FATAL_MASK_ERR_ECC_DOUBLE(value) (CSI_INT_MSK_PKT_FATAL_MASK_ERR_ECC_DOUBLE_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_FATAL_MASK_ERR_ECC_DOUBLE_Pos)) /* Assignment of value for MASK_ERR_ECC_DOUBLE in the CSI_INT_MSK_PKT_FATAL register */
...
#define CSI_INT_FORCE_PKT_FATAL_FORCE_VC0_ERR_CRC(value) (CSI_INT_FORCE_PKT_FATAL_FORCE_VC0_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FATAL_FORCE_VC0_ERR_CRC_Pos)) /* Assignment of value for FORCE_VC0_ERR_CRC in the CSI_INT_FORCE_PKT_FATAL register */
...
#define CSI_INT_FORCE_PKT_FATAL_FORCE_VC1_ERR_CRC(value) (CSI_INT_FORCE_PKT_FATAL_FORCE_VC1_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FATAL_FORCE_VC1_ERR_CRC_Pos)) /* Assignment of value for FORCE_VC1_ERR_CRC in the CSI_INT_FORCE_PKT_FATAL register */
...
#define CSI_INT_FORCE_PKT_FATAL_FORCE_VC2_ERR_CRC(value) (CSI_INT_FORCE_PKT_FATAL_FORCE_VC2_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FATAL_FORCE_VC2_ERR_CRC_Pos)) /* Assignment of value for FORCE_VC2_ERR_CRC in the CSI_INT_FORCE_PKT_FATAL register */
...
#define CSI_INT_FORCE_PKT_FATAL_FORCE_VC3_ERR_CRC(value) (CSI_INT_FORCE_PKT_FATAL_FORCE_VC3_ERR_CRC_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FATAL_FORCE_VC3_ERR_CRC_Pos)) /* Assignment of value for FORCE_VC3_ERR_CRC in the CSI_INT_FORCE_PKT_FATAL register */
...
#define CSI_INT_FORCE_PKT_FATAL_FORCE_ERR_ECC_DOUBLE(value) (CSI_INT_FORCE_PKT_FATAL_FORCE_ERR_ECC_DOUBLE_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FATAL_FORCE_ERR_ECC_DOUBLE_Pos)) /* Assignment of value for FORCE_ERR_ECC_DOUBLE in the CSI_INT_FORCE_PKT_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC0(value) (CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC0_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC0_Pos)) /* Assignment of value for ERR_F_BNDRY_MATCH_VC0 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC1(value) (CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC1_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC1_Pos)) /* Assignment of value for ERR_F_BNDRY_MATCH_VC1 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC2(value) (CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC2_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC2_Pos)) /* Assignment of value for ERR_F_BNDRY_MATCH_VC2 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC3(value) (CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC3_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_F_BNDRY_MATCH_VC3_Pos)) /* Assignment of value for ERR_F_BNDRY_MATCH_VC3 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC0(value) (CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC0_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC0_Pos)) /* Assignment of value for ERR_F_SEQ_VC0 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC1(value) (CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC1_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC1_Pos)) /* Assignment of value for ERR_F_SEQ_VC1 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC2(value) (CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC2_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC2_Pos)) /* Assignment of value for ERR_F_SEQ_VC2 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC3(value) (CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC3_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_F_SEQ_VC3_Pos)) /* Assignment of value for ERR_F_SEQ_VC3 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC0(value) (CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC0_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC0_Pos)) /* Assignment of value for ERR_FRAME_DATA_VC0 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC1(value) (CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC1_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC1_Pos)) /* Assignment of value for ERR_FRAME_DATA_VC1 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC2(value) (CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC2_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC2_Pos)) /* Assignment of value for ERR_FRAME_DATA_VC2 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC3(value) (CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC3_Msk & (_UINT32_(value) << CSI_INT_ST_FRAME_FATAL_ERR_FRAME_DATA_VC3_Pos)) /* Assignment of value for ERR_FRAME_DATA_VC3 in the CSI_INT_ST_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC0(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC0_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC0_Pos)) /* Assignment of value for MASK_ERR_F_BNDRY_MATCH_VC0 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC1(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC1_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC1_Pos)) /* Assignment of value for MASK_ERR_F_BNDRY_MATCH_VC1 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC2(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC2_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC2_Pos)) /* Assignment of value for MASK_ERR_F_BNDRY_MATCH_VC2 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC3(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC3_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_BNDRY_MATCH_VC3_Pos)) /* Assignment of value for MASK_ERR_F_BNDRY_MATCH_VC3 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC0(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC0_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC0_Pos)) /* Assignment of value for MASK_ERR_F_SEQ_VC0 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC1(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC1_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC1_Pos)) /* Assignment of value for MASK_ERR_F_SEQ_VC1 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC2(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC2_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC2_Pos)) /* Assignment of value for MASK_ERR_F_SEQ_VC2 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC3(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC3_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_F_SEQ_VC3_Pos)) /* Assignment of value for MASK_ERR_F_SEQ_VC3 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC0(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC0_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC0_Pos)) /* Assignment of value for MASK_ERR_FRAME_DATA_VC0 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC1(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC1_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC1_Pos)) /* Assignment of value for MASK_ERR_FRAME_DATA_VC1 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC2(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC2_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC2_Pos)) /* Assignment of value for MASK_ERR_FRAME_DATA_VC2 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC3(value) (CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC3_Msk & (_UINT32_(value) << CSI_INT_MSK_FRAME_FATAL_MASK_ERR_FRAME_DATA_VC3_Pos)) /* Assignment of value for MASK_ERR_FRAME_DATA_VC3 in the CSI_INT_MSK_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC0(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC0_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC0_Pos)) /* Assignment of value for FORCE_ERR_F_BNDRY_MATCH_VC0 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC1(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC1_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC1_Pos)) /* Assignment of value for FORCE_ERR_F_BNDRY_MATCH_VC1 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC2(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC2_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC2_Pos)) /* Assignment of value for FORCE_ERR_F_BNDRY_MATCH_VC2 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC3(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC3_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_BNDRY_MATCH_VC3_Pos)) /* Assignment of value for FORCE_ERR_F_BNDRY_MATCH_VC3 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC0(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC0_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC0_Pos)) /* Assignment of value for FORCE_ERR_F_SEQ_VC0 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC1(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC1_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC1_Pos)) /* Assignment of value for FORCE_ERR_F_SEQ_VC1 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC2(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC2_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC2_Pos)) /* Assignment of value for FORCE_ERR_F_SEQ_VC2 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC3(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC3_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_F_SEQ_VC3_Pos)) /* Assignment of value for FORCE_ERR_F_SEQ_VC3 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC0(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC0_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC0_Pos)) /* Assignment of value for FORCE_ERR_FRAME_DATA_VC0 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC1(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC1_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC1_Pos)) /* Assignment of value for FORCE_ERR_FRAME_DATA_VC1 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC2(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC2_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC2_Pos)) /* Assignment of value for FORCE_ERR_FRAME_DATA_VC2 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC3(value) (CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC3_Msk & (_UINT32_(value) << CSI_INT_FORCE_FRAME_FATAL_FORCE_ERR_FRAME_DATA_VC3_Pos)) /* Assignment of value for FORCE_ERR_FRAME_DATA_VC3 in the CSI_INT_FORCE_FRAME_FATAL register */
...
#define CSI_INT_ST_PHY_PHY_ERRSOTHS_0(value)  (CSI_INT_ST_PHY_PHY_ERRSOTHS_0_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_PHY_ERRSOTHS_0_Pos)) /* Assignment of value for PHY_ERRSOTHS_0 in the CSI_INT_ST_PHY register */
...
#define CSI_INT_ST_PHY_PHY_ERRSOTHS_1(value)  (CSI_INT_ST_PHY_PHY_ERRSOTHS_1_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_PHY_ERRSOTHS_1_Pos)) /* Assignment of value for PHY_ERRSOTHS_1 in the CSI_INT_ST_PHY register */
...
#define CSI_INT_ST_PHY_PHY_ERRSOTHS_2(value)  (CSI_INT_ST_PHY_PHY_ERRSOTHS_2_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_PHY_ERRSOTHS_2_Pos)) /* Assignment of value for PHY_ERRSOTHS_2 in the CSI_INT_ST_PHY register */
...
#define CSI_INT_ST_PHY_PHY_ERRSOTHS_3(value)  (CSI_INT_ST_PHY_PHY_ERRSOTHS_3_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_PHY_ERRSOTHS_3_Pos)) /* Assignment of value for PHY_ERRSOTHS_3 in the CSI_INT_ST_PHY register */
...
#define CSI_INT_ST_PHY_PHY_ERRESC_0(value)    (CSI_INT_ST_PHY_PHY_ERRESC_0_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_PHY_ERRESC_0_Pos)) /* Assignment of value for PHY_ERRESC_0 in the CSI_INT_ST_PHY register */
...
#define CSI_INT_ST_PHY_PHY_ERRESC_1(value)    (CSI_INT_ST_PHY_PHY_ERRESC_1_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_PHY_ERRESC_1_Pos)) /* Assignment of value for PHY_ERRESC_1 in the CSI_INT_ST_PHY register */
...
#define CSI_INT_ST_PHY_PHY_ERRESC_2(value)    (CSI_INT_ST_PHY_PHY_ERRESC_2_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_PHY_ERRESC_2_Pos)) /* Assignment of value for PHY_ERRESC_2 in the CSI_INT_ST_PHY register */
...
#define CSI_INT_ST_PHY_PHY_ERRESC_3(value)    (CSI_INT_ST_PHY_PHY_ERRESC_3_Msk & (_UINT32_(value) << CSI_INT_ST_PHY_PHY_ERRESC_3_Pos)) /* Assignment of value for PHY_ERRESC_3 in the CSI_INT_ST_PHY register */
...
#define CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_0(value) (CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_0_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_0_Pos)) /* Assignment of value for MASK_PHY_ERRSOTHS_0 in the CSI_INT_MSK_PHY register */
...
#define CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_1(value) (CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_1_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_1_Pos)) /* Assignment of value for MASK_PHY_ERRSOTHS_1 in the CSI_INT_MSK_PHY register */
...
#define CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_2(value) (CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_2_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_2_Pos)) /* Assignment of value for MASK_PHY_ERRSOTHS_2 in the CSI_INT_MSK_PHY register */
...
#define CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_3(value) (CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_3_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_MASK_PHY_ERRSOTHS_3_Pos)) /* Assignment of value for MASK_PHY_ERRSOTHS_3 in the CSI_INT_MSK_PHY register */
...
#define CSI_INT_MSK_PHY_MASK_PHY_ERRESC_0(value) (CSI_INT_MSK_PHY_MASK_PHY_ERRESC_0_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_MASK_PHY_ERRESC_0_Pos)) /* Assignment of value for MASK_PHY_ERRESC_0 in the CSI_INT_MSK_PHY register */
...
#define CSI_INT_MSK_PHY_MASK_PHY_ERRESC_1(value) (CSI_INT_MSK_PHY_MASK_PHY_ERRESC_1_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_MASK_PHY_ERRESC_1_Pos)) /* Assignment of value for MASK_PHY_ERRESC_1 in the CSI_INT_MSK_PHY register */
...
#define CSI_INT_MSK_PHY_MASK_PHY_ERRESC_2(value) (CSI_INT_MSK_PHY_MASK_PHY_ERRESC_2_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_MASK_PHY_ERRESC_2_Pos)) /* Assignment of value for MASK_PHY_ERRESC_2 in the CSI_INT_MSK_PHY register */
...
#define CSI_INT_MSK_PHY_MASK_PHY_ERRESC_3(value) (CSI_INT_MSK_PHY_MASK_PHY_ERRESC_3_Msk & (_UINT32_(value) << CSI_INT_MSK_PHY_MASK_PHY_ERRESC_3_Pos)) /* Assignment of value for MASK_PHY_ERRESC_3 in the CSI_INT_MSK_PHY register */
...
#define CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_0(value) (CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_0_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_0_Pos)) /* Assignment of value for FORCE_PHY_ERRSOTHS_0 in the CSI_INT_FORCE_PHY register */
...
#define CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_1(value) (CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_1_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_1_Pos)) /* Assignment of value for FORCE_PHY_ERRSOTHS_1 in the CSI_INT_FORCE_PHY register */
...
#define CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_2(value) (CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_2_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_2_Pos)) /* Assignment of value for FORCE_PHY_ERRSOTHS_2 in the CSI_INT_FORCE_PHY register */
...
#define CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_3(value) (CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_3_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FORCE_PHY_ERRSOTHS_3_Pos)) /* Assignment of value for FORCE_PHY_ERRSOTHS_3 in the CSI_INT_FORCE_PHY register */
...
#define CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_0(value) (CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_0_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_0_Pos)) /* Assignment of value for FORCE_PHY_ERRESC_0 in the CSI_INT_FORCE_PHY register */
...
#define CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_1(value) (CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_1_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_1_Pos)) /* Assignment of value for FORCE_PHY_ERRESC_1 in the CSI_INT_FORCE_PHY register */
...
#define CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_2(value) (CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_2_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_2_Pos)) /* Assignment of value for FORCE_PHY_ERRESC_2 in the CSI_INT_FORCE_PHY register */
...
#define CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_3(value) (CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_3_Msk & (_UINT32_(value) << CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC_3_Pos)) /* Assignment of value for FORCE_PHY_ERRESC_3 in the CSI_INT_FORCE_PHY register */
...
#define CSI_INT_ST_PKT_ERR_ID_VC0(value)      (CSI_INT_ST_PKT_ERR_ID_VC0_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_ERR_ID_VC0_Pos)) /* Assignment of value for ERR_ID_VC0 in the CSI_INT_ST_PKT register */
...
#define CSI_INT_ST_PKT_ERR_ID_VC1(value)      (CSI_INT_ST_PKT_ERR_ID_VC1_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_ERR_ID_VC1_Pos)) /* Assignment of value for ERR_ID_VC1 in the CSI_INT_ST_PKT register */
...
#define CSI_INT_ST_PKT_ERR_ID_VC2(value)      (CSI_INT_ST_PKT_ERR_ID_VC2_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_ERR_ID_VC2_Pos)) /* Assignment of value for ERR_ID_VC2 in the CSI_INT_ST_PKT register */
...
#define CSI_INT_ST_PKT_ERR_ID_VC3(value)      (CSI_INT_ST_PKT_ERR_ID_VC3_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_ERR_ID_VC3_Pos)) /* Assignment of value for ERR_ID_VC3 in the CSI_INT_ST_PKT register */
...
#define CSI_INT_ST_PKT_VC0_ERR_ECC_CORRECTED(value) (CSI_INT_ST_PKT_VC0_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_VC0_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for VC0_ERR_ECC_CORRECTED in the CSI_INT_ST_PKT register */
...
#define CSI_INT_ST_PKT_VC1_ERR_ECC_CORRECTED(value) (CSI_INT_ST_PKT_VC1_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_VC1_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for VC1_ERR_ECC_CORRECTED in the CSI_INT_ST_PKT register */
...
#define CSI_INT_ST_PKT_VC2_ERR_ECC_CORRECTED(value) (CSI_INT_ST_PKT_VC2_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_VC2_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for VC2_ERR_ECC_CORRECTED in the CSI_INT_ST_PKT register */
...
#define CSI_INT_ST_PKT_VC3_ERR_ECC_CORRECTED(value) (CSI_INT_ST_PKT_VC3_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_ST_PKT_VC3_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for VC3_ERR_ECC_CORRECTED in the CSI_INT_ST_PKT register */
...
#define CSI_INT_MSK_PKT_MASK_ERR_ID_VC0(value) (CSI_INT_MSK_PKT_MASK_ERR_ID_VC0_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_MASK_ERR_ID_VC0_Pos)) /* Assignment of value for MASK_ERR_ID_VC0 in the CSI_INT_MSK_PKT register */
...
#define CSI_INT_MSK_PKT_MASK_ERR_ID_VC1(value) (CSI_INT_MSK_PKT_MASK_ERR_ID_VC1_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_MASK_ERR_ID_VC1_Pos)) /* Assignment of value for MASK_ERR_ID_VC1 in the CSI_INT_MSK_PKT register */
...
#define CSI_INT_MSK_PKT_MASK_ERR_ID_VC2(value) (CSI_INT_MSK_PKT_MASK_ERR_ID_VC2_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_MASK_ERR_ID_VC2_Pos)) /* Assignment of value for MASK_ERR_ID_VC2 in the CSI_INT_MSK_PKT register */
...
#define CSI_INT_MSK_PKT_MASK_ERR_ID_VC3(value) (CSI_INT_MSK_PKT_MASK_ERR_ID_VC3_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_MASK_ERR_ID_VC3_Pos)) /* Assignment of value for MASK_ERR_ID_VC3 in the CSI_INT_MSK_PKT register */
...
#define CSI_INT_MSK_PKT_MASK_VC0_ERR_ECC_CORRECTED(value) (CSI_INT_MSK_PKT_MASK_VC0_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_MASK_VC0_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for MASK_VC0_ERR_ECC_CORRECTED in the CSI_INT_MSK_PKT register */
...
#define CSI_INT_MSK_PKT_MASK_VC1_ERR_ECC_CORRECTED(value) (CSI_INT_MSK_PKT_MASK_VC1_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_MASK_VC1_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for MASK_VC1_ERR_ECC_CORRECTED in the CSI_INT_MSK_PKT register */
...
#define CSI_INT_MSK_PKT_MASK_VC2_ERR_ECC_CORRECTED(value) (CSI_INT_MSK_PKT_MASK_VC2_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_MASK_VC2_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for MASK_VC2_ERR_ECC_CORRECTED in the CSI_INT_MSK_PKT register */
...
#define CSI_INT_MSK_PKT_MASK_VC3_ERR_ECC_CORRECTED(value) (CSI_INT_MSK_PKT_MASK_VC3_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_MSK_PKT_MASK_VC3_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for MASK_VC3_ERR_ECC_CORRECTED in the CSI_INT_MSK_PKT register */
...
#define CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC0(value) (CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC0_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC0_Pos)) /* Assignment of value for FORCE_ERR_ID_VC0 in the CSI_INT_FORCE_PKT register */
...
#define CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC1(value) (CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC1_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC1_Pos)) /* Assignment of value for FORCE_ERR_ID_VC1 in the CSI_INT_FORCE_PKT register */
...
#define CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC2(value) (CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC2_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC2_Pos)) /* Assignment of value for FORCE_ERR_ID_VC2 in the CSI_INT_FORCE_PKT register */
...
#define CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC3(value) (CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC3_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FORCE_ERR_ID_VC3_Pos)) /* Assignment of value for FORCE_ERR_ID_VC3 in the CSI_INT_FORCE_PKT register */
...
#define CSI_INT_FORCE_PKT_FORCE_VC0_ERR_ECC_CORRECTED(value) (CSI_INT_FORCE_PKT_FORCE_VC0_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FORCE_VC0_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for FORCE_VC0_ERR_ECC_CORRECTED in the CSI_INT_FORCE_PKT register */
...
#define CSI_INT_FORCE_PKT_FORCE_VC1_ERR_ECC_CORRECTED(value) (CSI_INT_FORCE_PKT_FORCE_VC1_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FORCE_VC1_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for FORCE_VC1_ERR_ECC_CORRECTED in the CSI_INT_FORCE_PKT register */
...
#define CSI_INT_FORCE_PKT_FORCE_VC2_ERR_ECC_CORRECTED(value) (CSI_INT_FORCE_PKT_FORCE_VC2_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FORCE_VC2_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for FORCE_VC2_ERR_ECC_CORRECTED in the CSI_INT_FORCE_PKT register */
...
#define CSI_INT_FORCE_PKT_FORCE_VC3_ERR_ECC_CORRECTED(value) (CSI_INT_FORCE_PKT_FORCE_VC3_ERR_ECC_CORRECTED_Msk & (_UINT32_(value) << CSI_INT_FORCE_PKT_FORCE_VC3_ERR_ECC_CORRECTED_Pos)) /* Assignment of value for FORCE_VC3_ERR_ECC_CORRECTED in the CSI_INT_FORCE_PKT register */
...
#define CSI_SCRAMBLING_SCRAMBLE_ENABLE(value) (CSI_SCRAMBLING_SCRAMBLE_ENABLE_Msk & (_UINT32_(value) << CSI_SCRAMBLING_SCRAMBLE_ENABLE_Pos)) /* Assignment of value for SCRAMBLE_ENABLE in the CSI_SCRAMBLING register */
...
#define CSI_SCRAMBLING_SEED0_SCRAMBLE_SEED_LANE0(value) (CSI_SCRAMBLING_SEED0_SCRAMBLE_SEED_LANE0_Msk & (_UINT32_(value) << CSI_SCRAMBLING_SEED0_SCRAMBLE_SEED_LANE0_Pos)) /* Assignment of value for SCRAMBLE_SEED_LANE0 in the CSI_SCRAMBLING_SEED0 register */
...
#define CSI_SCRAMBLING_SEED1_SCRAMBLE_SEED_LANE1(value) (CSI_SCRAMBLING_SEED1_SCRAMBLE_SEED_LANE1_Msk & (_UINT32_(value) << CSI_SCRAMBLING_SEED1_SCRAMBLE_SEED_LANE1_Pos)) /* Assignment of value for SCRAMBLE_SEED_LANE1 in the CSI_SCRAMBLING_SEED1 register */
...
#define CSI_SCRAMBLING_SEED2_SCRAMBLE_SEED_LANE2(value) (CSI_SCRAMBLING_SEED2_SCRAMBLE_SEED_LANE2_Msk & (_UINT32_(value) << CSI_SCRAMBLING_SEED2_SCRAMBLE_SEED_LANE2_Pos)) /* Assignment of value for SCRAMBLE_SEED_LANE2 in the CSI_SCRAMBLING_SEED2 register */
...
#define CSI_SCRAMBLING_SEED3_SCRAMBLE_SEED_LANE3(value) (CSI_SCRAMBLING_SEED3_SCRAMBLE_SEED_LANE3_Msk & (_UINT32_(value) << CSI_SCRAMBLING_SEED3_SCRAMBLE_SEED_LANE3_Pos)) /* Assignment of value for SCRAMBLE_SEED_LANE3 in the CSI_SCRAMBLING_SEED3 register */
#define CSI_SCRAMBLING_SEED3_Msk              _UINT32_(0x0000FFFF)                                 /* (CSI_SCRAMBLING_SEED3) Register Mask  */


/* CSI register offsets definitions */
