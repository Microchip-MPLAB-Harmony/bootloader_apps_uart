...
#define WDT_CR_LOCKMR(value)                  (WDT_CR_LOCKMR_Msk & (_UINT32_(value) << WDT_CR_LOCKMR_Pos)) /* Assignment of value for LOCKMR in the WDT_CR register */
...
#define WDT_MR_PERIODRST(value)               (WDT_MR_PERIODRST_Msk & (_UINT32_(value) << WDT_MR_PERIODRST_Pos)) /* Assignment of value for PERIODRST in the WDT_MR register */
...
#define WDT_MR_RPTHRST(value)                 (WDT_MR_RPTHRST_Msk & (_UINT32_(value) << WDT_MR_RPTHRST_Pos)) /* Assignment of value for RPTHRST in the WDT_MR register */
...
#define WDT_VR_COUNTER(value)                 (WDT_VR_COUNTER_Msk & (_UINT32_(value) << WDT_VR_COUNTER_Pos)) /* Assignment of value for COUNTER in the WDT_VR register */
...
#define WDT_WLR_PERIOD(value)                 (WDT_WLR_PERIOD_Msk & (_UINT32_(value) << WDT_WLR_PERIOD_Pos)) /* Assignment of value for PERIOD in the WDT_WLR register */
...
#define WDT_WLR_RPTH(value)                   (WDT_WLR_RPTH_Msk & (_UINT32_(value) << WDT_WLR_RPTH_Pos)) /* Assignment of value for RPTH in the WDT_WLR register */
...
#define WDT_ILR_LVLTH(value)                  (WDT_ILR_LVLTH_Msk & (_UINT32_(value) << WDT_ILR_LVLTH_Pos)) /* Assignment of value for LVLTH in the WDT_ILR register */
...
#define WDT_IER_PERINT(value)                 (WDT_IER_PERINT_Msk & (_UINT32_(value) << WDT_IER_PERINT_Pos)) /* Assignment of value for PERINT in the WDT_IER register */
...
#define WDT_IER_RPTHINT(value)                (WDT_IER_RPTHINT_Msk & (_UINT32_(value) << WDT_IER_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the WDT_IER register */
...
#define WDT_IER_LVLINT(value)                 (WDT_IER_LVLINT_Msk & (_UINT32_(value) << WDT_IER_LVLINT_Pos)) /* Assignment of value for LVLINT in the WDT_IER register */
...
#define WDT_IDR_PERINT(value)                 (WDT_IDR_PERINT_Msk & (_UINT32_(value) << WDT_IDR_PERINT_Pos)) /* Assignment of value for PERINT in the WDT_IDR register */
...
#define WDT_IDR_RPTHINT(value)                (WDT_IDR_RPTHINT_Msk & (_UINT32_(value) << WDT_IDR_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the WDT_IDR register */
...
#define WDT_IDR_LVLINT(value)                 (WDT_IDR_LVLINT_Msk & (_UINT32_(value) << WDT_IDR_LVLINT_Pos)) /* Assignment of value for LVLINT in the WDT_IDR register */
...
#define WDT_ISR_PERINT(value)                 (WDT_ISR_PERINT_Msk & (_UINT32_(value) << WDT_ISR_PERINT_Pos)) /* Assignment of value for PERINT in the WDT_ISR register */
...
#define WDT_ISR_RPTHINT(value)                (WDT_ISR_RPTHINT_Msk & (_UINT32_(value) << WDT_ISR_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the WDT_ISR register */
...
#define WDT_ISR_LVLINT(value)                 (WDT_ISR_LVLINT_Msk & (_UINT32_(value) << WDT_ISR_LVLINT_Pos)) /* Assignment of value for LVLINT in the WDT_ISR register */
...
#define WDT_IMR_PERINT(value)                 (WDT_IMR_PERINT_Msk & (_UINT32_(value) << WDT_IMR_PERINT_Pos)) /* Assignment of value for PERINT in the WDT_IMR register */
...
#define WDT_IMR_RPTHINT(value)                (WDT_IMR_RPTHINT_Msk & (_UINT32_(value) << WDT_IMR_RPTHINT_Pos)) /* Assignment of value for RPTHINT in the WDT_IMR register */
...
#define WDT_IMR_LVLINT(value)                 (WDT_IMR_LVLINT_Msk & (_UINT32_(value) << WDT_IMR_LVLINT_Pos)) /* Assignment of value for LVLINT in the WDT_IMR register */
