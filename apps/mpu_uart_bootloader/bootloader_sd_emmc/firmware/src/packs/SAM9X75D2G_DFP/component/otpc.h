...
#define OTPC_CR_REPAIR(value)                 (OTPC_CR_REPAIR_Msk & (_UINT32_(value) << OTPC_CR_REPAIR_Pos)) /* Assignment of value for REPAIR in the OTPC_CR register */
...
#define OTPC_SR_MNT(value)                    (OTPC_SR_MNT_Msk & (_UINT32_(value) << OTPC_SR_MNT_Pos)) /* Assignment of value for MNT in the OTPC_SR register */
...
#define OTPC_LRMR_FREQ(value)                 (OTPC_LRMR_FREQ_Msk & (_UINT32_(value) << OTPC_LRMR_FREQ_Pos)) /* Assignment of value for FREQ in the OTPC_LRMR register */
...
#define OTPC_LRMR_EN(value)                   (OTPC_LRMR_EN_Msk & (_UINT32_(value) << OTPC_LRMR_EN_Pos)) /* Assignment of value for EN in the OTPC_LRMR register */
...
#define OTPC_LRMR_KEY(value)                  (OTPC_LRMR_KEY_Msk & (_UINT32_(value) << OTPC_LRMR_KEY_Pos)) /* Assignment of value for KEY in the OTPC_LRMR register */
