...
#ifndef _SAMA7G5_TZAESB_COMPONENT_H_
#define _SAMA7G5_TZAESB_COMPONENT_H_
...
#define TZAESB_CR_START(value)                (TZAESB_CR_START_Msk & (_UINT32_(value) << TZAESB_CR_START_Pos)) /* Assignment of value for START in the TZAESB_CR register */
...
#define TZAESB_CR_SWRST(value)                (TZAESB_CR_SWRST_Msk & (_UINT32_(value) << TZAESB_CR_SWRST_Pos)) /* Assignment of value for SWRST in the TZAESB_CR register */
...
#define TZAESB_CR_UNLOCK(value)               (TZAESB_CR_UNLOCK_Msk & (_UINT32_(value) << TZAESB_CR_UNLOCK_Pos)) /* Assignment of value for UNLOCK in the TZAESB_CR register */
...
#define TZAESB_MR_PROCDLY(value)              (TZAESB_MR_PROCDLY_Msk & (_UINT32_(value) << TZAESB_MR_PROCDLY_Pos)) /* Assignment of value for PROCDLY in the TZAESB_MR register */
...
#define TZAESB_MR_OPMOD(value)                (TZAESB_MR_OPMOD_Msk & (_UINT32_(value) << TZAESB_MR_OPMOD_Pos)) /* Assignment of value for OPMOD in the TZAESB_MR register */
...
#define TZAESB_MR_CKEY(value)                 (TZAESB_MR_CKEY_Msk & (_UINT32_(value) << TZAESB_MR_CKEY_Pos)) /* Assignment of value for CKEY in the TZAESB_MR register */
...
#define TZAESB_MR_TAMPCLR(value)              (TZAESB_MR_TAMPCLR_Msk & (_UINT32_(value) << TZAESB_MR_TAMPCLR_Pos)) /* Assignment of value for TAMPCLR in the TZAESB_MR register */
...
#define TZAESB_IER_URAD(value)                (TZAESB_IER_URAD_Msk & (_UINT32_(value) << TZAESB_IER_URAD_Pos)) /* Assignment of value for URAD in the TZAESB_IER register */
...
#define TZAESB_IER_SECE(value)                (TZAESB_IER_SECE_Msk & (_UINT32_(value) << TZAESB_IER_SECE_Pos)) /* Assignment of value for SECE in the TZAESB_IER register */
...
#define TZAESB_IDR_URAD(value)                (TZAESB_IDR_URAD_Msk & (_UINT32_(value) << TZAESB_IDR_URAD_Pos)) /* Assignment of value for URAD in the TZAESB_IDR register */
...
#define TZAESB_IDR_SECE(value)                (TZAESB_IDR_SECE_Msk & (_UINT32_(value) << TZAESB_IDR_SECE_Pos)) /* Assignment of value for SECE in the TZAESB_IDR register */
...
#define TZAESB_IMR_URAD(value)                (TZAESB_IMR_URAD_Msk & (_UINT32_(value) << TZAESB_IMR_URAD_Pos)) /* Assignment of value for URAD in the TZAESB_IMR register */
...
#define TZAESB_IMR_SECE(value)                (TZAESB_IMR_SECE_Msk & (_UINT32_(value) << TZAESB_IMR_SECE_Pos)) /* Assignment of value for SECE in the TZAESB_IMR register */
...
#define TZAESB_ISR_URAD(value)                (TZAESB_ISR_URAD_Msk & (_UINT32_(value) << TZAESB_ISR_URAD_Pos)) /* Assignment of value for URAD in the TZAESB_ISR register */
...
#define TZAESB_ISR_URAT(value)                (TZAESB_ISR_URAT_Msk & (_UINT32_(value) << TZAESB_ISR_URAT_Pos)) /* Assignment of value for URAT in the TZAESB_ISR register */
...
#define TZAESB_ISR_SECE(value)                (TZAESB_ISR_SECE_Msk & (_UINT32_(value) << TZAESB_ISR_SECE_Pos)) /* Assignment of value for SECE in the TZAESB_ISR register */
...
#define TZAESB_KEYWR_KEYW(value)              (TZAESB_KEYWR_KEYW_Msk & (_UINT32_(value) << TZAESB_KEYWR_KEYW_Pos)) /* Assignment of value for KEYW in the TZAESB_KEYWR register */
...
#define TZAESB_IVR_IV(value)                  (TZAESB_IVR_IV_Msk & (_UINT32_(value) << TZAESB_IVR_IV_Pos)) /* Assignment of value for IV in the TZAESB_IVR register */
...
#define TZAESB_EMR_PKWO(value)                (TZAESB_EMR_PKWO_Msk & (_UINT32_(value) << TZAESB_EMR_PKWO_Pos)) /* Assignment of value for PKWO in the TZAESB_EMR register */
...
#define TZAESB_EMR_PKRS(value)                (TZAESB_EMR_PKRS_Msk & (_UINT32_(value) << TZAESB_EMR_PKRS_Pos)) /* Assignment of value for PKRS in the TZAESB_EMR register */
...
#define TZAESB_WPMR_WPEN(value)               (TZAESB_WPMR_WPEN_Msk & (_UINT32_(value) << TZAESB_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the TZAESB_WPMR register */
...
#define TZAESB_WPMR_WPITEN(value)             (TZAESB_WPMR_WPITEN_Msk & (_UINT32_(value) << TZAESB_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the TZAESB_WPMR register */
...
#define TZAESB_WPMR_WPCREN(value)             (TZAESB_WPMR_WPCREN_Msk & (_UINT32_(value) << TZAESB_WPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the TZAESB_WPMR register */
...
#define TZAESB_WPMR_FIRSTE(value)             (TZAESB_WPMR_FIRSTE_Msk & (_UINT32_(value) << TZAESB_WPMR_FIRSTE_Pos)) /* Assignment of value for FIRSTE in the TZAESB_WPMR register */
...
#define TZAESB_WPMR_ACTION(value)             (TZAESB_WPMR_ACTION_Msk & (_UINT32_(value) << TZAESB_WPMR_ACTION_Pos)) /* Assignment of value for ACTION in the TZAESB_WPMR register */
...
#define TZAESB_WPMR_WPKEY(value)              (TZAESB_WPMR_WPKEY_Msk & (_UINT32_(value) << TZAESB_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the TZAESB_WPMR register */
...
#define TZAESB_WPSR_WPVS(value)               (TZAESB_WPSR_WPVS_Msk & (_UINT32_(value) << TZAESB_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the TZAESB_WPSR register */
...
#define TZAESB_WPSR_CGD(value)                (TZAESB_WPSR_CGD_Msk & (_UINT32_(value) << TZAESB_WPSR_CGD_Pos)) /* Assignment of value for CGD in the TZAESB_WPSR register */
...
#define TZAESB_WPSR_SEQE(value)               (TZAESB_WPSR_SEQE_Msk & (_UINT32_(value) << TZAESB_WPSR_SEQE_Pos)) /* Assignment of value for SEQE in the TZAESB_WPSR register */
...
#define TZAESB_WPSR_SWE(value)                (TZAESB_WPSR_SWE_Msk & (_UINT32_(value) << TZAESB_WPSR_SWE_Pos)) /* Assignment of value for SWE in the TZAESB_WPSR register */
...
#define TZAESB_WPSR_PKRPVS(value)             (TZAESB_WPSR_PKRPVS_Msk & (_UINT32_(value) << TZAESB_WPSR_PKRPVS_Pos)) /* Assignment of value for PKRPVS in the TZAESB_WPSR register */
...
#define TZAESB_WPSR_WPVSRC(value)             (TZAESB_WPSR_WPVSRC_Msk & (_UINT32_(value) << TZAESB_WPSR_WPVSRC_Pos)) /* Assignment of value for WPVSRC in the TZAESB_WPSR register */
...
#define TZAESB_WPSR_SWETYP(value)             (TZAESB_WPSR_SWETYP_Msk & (_UINT32_(value) << TZAESB_WPSR_SWETYP_Pos)) /* Assignment of value for SWETYP in the TZAESB_WPSR register */
...
#define TZAESB_WPSR_ECLASS(value)             (TZAESB_WPSR_ECLASS_Msk & (_UINT32_(value) << TZAESB_WPSR_ECLASS_Pos)) /* Assignment of value for ECLASS in the TZAESB_WPSR register */
...
/* TZAESB register offsets definitions */
...
#endif /* _SAMA7G5_TZAESB_COMPONENT_H_ */
