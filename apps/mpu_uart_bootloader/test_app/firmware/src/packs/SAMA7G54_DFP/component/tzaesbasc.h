...
#ifndef _SAMA7G5_TZAESBASC_COMPONENT_H_
#define _SAMA7G5_TZAESBASC_COMPONENT_H_
...
#define TZAESBASC_RBAR_BASE(value)            (TZAESBASC_RBAR_BASE_Msk & (_UINT32_(value) << TZAESBASC_RBAR_BASE_Pos)) /* Assignment of value for BASE in the TZAESBASC_RBAR register */
...
#define TZAESBASC_RTAR_TOP(value)             (TZAESBASC_RTAR_TOP_Msk & (_UINT32_(value) << TZAESBASC_RTAR_TOP_Pos)) /* Assignment of value for TOP in the TZAESBASC_RTAR register */
...
#define TZAESBASC_RSECR_SEC0(value)           (TZAESBASC_RSECR_SEC0_Msk & (_UINT32_(value) << TZAESBASC_RSECR_SEC0_Pos)) /* Assignment of value for SEC0 in the TZAESBASC_RSECR register */
...
#define TZAESBASC_RSECR_SEC1(value)           (TZAESBASC_RSECR_SEC1_Msk & (_UINT32_(value) << TZAESBASC_RSECR_SEC1_Pos)) /* Assignment of value for SEC1 in the TZAESBASC_RSECR register */
...
#define TZAESBASC_RSECR_SEC2(value)           (TZAESBASC_RSECR_SEC2_Msk & (_UINT32_(value) << TZAESBASC_RSECR_SEC2_Pos)) /* Assignment of value for SEC2 in the TZAESBASC_RSECR register */
...
#define TZAESBASC_RSECR_SEC3(value)           (TZAESBASC_RSECR_SEC3_Msk & (_UINT32_(value) << TZAESBASC_RSECR_SEC3_Pos)) /* Assignment of value for SEC3 in the TZAESBASC_RSECR register */
...
#define TZAESBASC_RSECR_SEC4(value)           (TZAESBASC_RSECR_SEC4_Msk & (_UINT32_(value) << TZAESBASC_RSECR_SEC4_Pos)) /* Assignment of value for SEC4 in the TZAESBASC_RSECR register */
...
#define TZAESBASC_RSECR_SEC5(value)           (TZAESBASC_RSECR_SEC5_Msk & (_UINT32_(value) << TZAESBASC_RSECR_SEC5_Pos)) /* Assignment of value for SEC5 in the TZAESBASC_RSECR register */
...
#define TZAESBASC_RSECR_SEC6(value)           (TZAESBASC_RSECR_SEC6_Msk & (_UINT32_(value) << TZAESBASC_RSECR_SEC6_Pos)) /* Assignment of value for SEC6 in the TZAESBASC_RSECR register */
...
#define TZAESBASC_RSECR_SEC7(value)           (TZAESBASC_RSECR_SEC7_Msk & (_UINT32_(value) << TZAESBASC_RSECR_SEC7_Pos)) /* Assignment of value for SEC7 in the TZAESBASC_RSECR register */
...
#define TZAESBASC_RER_EN0(value)              (TZAESBASC_RER_EN0_Msk & (_UINT32_(value) << TZAESBASC_RER_EN0_Pos)) /* Assignment of value for EN0 in the TZAESBASC_RER register */
...
#define TZAESBASC_RER_EN1(value)              (TZAESBASC_RER_EN1_Msk & (_UINT32_(value) << TZAESBASC_RER_EN1_Pos)) /* Assignment of value for EN1 in the TZAESBASC_RER register */
...
#define TZAESBASC_RER_EN2(value)              (TZAESBASC_RER_EN2_Msk & (_UINT32_(value) << TZAESBASC_RER_EN2_Pos)) /* Assignment of value for EN2 in the TZAESBASC_RER register */
...
#define TZAESBASC_RER_EN3(value)              (TZAESBASC_RER_EN3_Msk & (_UINT32_(value) << TZAESBASC_RER_EN3_Pos)) /* Assignment of value for EN3 in the TZAESBASC_RER register */
...
#define TZAESBASC_RER_EN4(value)              (TZAESBASC_RER_EN4_Msk & (_UINT32_(value) << TZAESBASC_RER_EN4_Pos)) /* Assignment of value for EN4 in the TZAESBASC_RER register */
...
#define TZAESBASC_RER_EN5(value)              (TZAESBASC_RER_EN5_Msk & (_UINT32_(value) << TZAESBASC_RER_EN5_Pos)) /* Assignment of value for EN5 in the TZAESBASC_RER register */
...
#define TZAESBASC_RER_EN6(value)              (TZAESBASC_RER_EN6_Msk & (_UINT32_(value) << TZAESBASC_RER_EN6_Pos)) /* Assignment of value for EN6 in the TZAESBASC_RER register */
...
#define TZAESBASC_RER_EN7(value)              (TZAESBASC_RER_EN7_Msk & (_UINT32_(value) << TZAESBASC_RER_EN7_Pos)) /* Assignment of value for EN7 in the TZAESBASC_RER register */
...
#define TZAESBASC_RDR_DIS0(value)             (TZAESBASC_RDR_DIS0_Msk & (_UINT32_(value) << TZAESBASC_RDR_DIS0_Pos)) /* Assignment of value for DIS0 in the TZAESBASC_RDR register */
...
#define TZAESBASC_RDR_DIS1(value)             (TZAESBASC_RDR_DIS1_Msk & (_UINT32_(value) << TZAESBASC_RDR_DIS1_Pos)) /* Assignment of value for DIS1 in the TZAESBASC_RDR register */
...
#define TZAESBASC_RDR_DIS2(value)             (TZAESBASC_RDR_DIS2_Msk & (_UINT32_(value) << TZAESBASC_RDR_DIS2_Pos)) /* Assignment of value for DIS2 in the TZAESBASC_RDR register */
...
#define TZAESBASC_RDR_DIS3(value)             (TZAESBASC_RDR_DIS3_Msk & (_UINT32_(value) << TZAESBASC_RDR_DIS3_Pos)) /* Assignment of value for DIS3 in the TZAESBASC_RDR register */
...
#define TZAESBASC_RDR_DIS4(value)             (TZAESBASC_RDR_DIS4_Msk & (_UINT32_(value) << TZAESBASC_RDR_DIS4_Pos)) /* Assignment of value for DIS4 in the TZAESBASC_RDR register */
...
#define TZAESBASC_RDR_DIS5(value)             (TZAESBASC_RDR_DIS5_Msk & (_UINT32_(value) << TZAESBASC_RDR_DIS5_Pos)) /* Assignment of value for DIS5 in the TZAESBASC_RDR register */
...
#define TZAESBASC_RDR_DIS6(value)             (TZAESBASC_RDR_DIS6_Msk & (_UINT32_(value) << TZAESBASC_RDR_DIS6_Pos)) /* Assignment of value for DIS6 in the TZAESBASC_RDR register */
...
#define TZAESBASC_RDR_DIS7(value)             (TZAESBASC_RDR_DIS7_Msk & (_UINT32_(value) << TZAESBASC_RDR_DIS7_Pos)) /* Assignment of value for DIS7 in the TZAESBASC_RDR register */
...
#define TZAESBASC_RSR_ES0(value)              (TZAESBASC_RSR_ES0_Msk & (_UINT32_(value) << TZAESBASC_RSR_ES0_Pos)) /* Assignment of value for ES0 in the TZAESBASC_RSR register */
...
#define TZAESBASC_RSR_ES1(value)              (TZAESBASC_RSR_ES1_Msk & (_UINT32_(value) << TZAESBASC_RSR_ES1_Pos)) /* Assignment of value for ES1 in the TZAESBASC_RSR register */
...
#define TZAESBASC_RSR_ES2(value)              (TZAESBASC_RSR_ES2_Msk & (_UINT32_(value) << TZAESBASC_RSR_ES2_Pos)) /* Assignment of value for ES2 in the TZAESBASC_RSR register */
...
#define TZAESBASC_RSR_ES3(value)              (TZAESBASC_RSR_ES3_Msk & (_UINT32_(value) << TZAESBASC_RSR_ES3_Pos)) /* Assignment of value for ES3 in the TZAESBASC_RSR register */
...
#define TZAESBASC_RSR_ES4(value)              (TZAESBASC_RSR_ES4_Msk & (_UINT32_(value) << TZAESBASC_RSR_ES4_Pos)) /* Assignment of value for ES4 in the TZAESBASC_RSR register */
...
#define TZAESBASC_RSR_ES5(value)              (TZAESBASC_RSR_ES5_Msk & (_UINT32_(value) << TZAESBASC_RSR_ES5_Pos)) /* Assignment of value for ES5 in the TZAESBASC_RSR register */
...
#define TZAESBASC_RSR_ES6(value)              (TZAESBASC_RSR_ES6_Msk & (_UINT32_(value) << TZAESBASC_RSR_ES6_Pos)) /* Assignment of value for ES6 in the TZAESBASC_RSR register */
...
#define TZAESBASC_RSR_ES7(value)              (TZAESBASC_RSR_ES7_Msk & (_UINT32_(value) << TZAESBASC_RSR_ES7_Pos)) /* Assignment of value for ES7 in the TZAESBASC_RSR register */
...
#define TZAESBASC_RESR_AER0(value)            (TZAESBASC_RESR_AER0_Msk & (_UINT32_(value) << TZAESBASC_RESR_AER0_Pos)) /* Assignment of value for AER0 in the TZAESBASC_RESR register */
...
#define TZAESBASC_RESR_AER1(value)            (TZAESBASC_RESR_AER1_Msk & (_UINT32_(value) << TZAESBASC_RESR_AER1_Pos)) /* Assignment of value for AER1 in the TZAESBASC_RESR register */
...
#define TZAESBASC_RESR_AER2(value)            (TZAESBASC_RESR_AER2_Msk & (_UINT32_(value) << TZAESBASC_RESR_AER2_Pos)) /* Assignment of value for AER2 in the TZAESBASC_RESR register */
...
#define TZAESBASC_RESR_AER3(value)            (TZAESBASC_RESR_AER3_Msk & (_UINT32_(value) << TZAESBASC_RESR_AER3_Pos)) /* Assignment of value for AER3 in the TZAESBASC_RESR register */
...
#define TZAESBASC_RESR_AER4(value)            (TZAESBASC_RESR_AER4_Msk & (_UINT32_(value) << TZAESBASC_RESR_AER4_Pos)) /* Assignment of value for AER4 in the TZAESBASC_RESR register */
...
#define TZAESBASC_RESR_AER5(value)            (TZAESBASC_RESR_AER5_Msk & (_UINT32_(value) << TZAESBASC_RESR_AER5_Pos)) /* Assignment of value for AER5 in the TZAESBASC_RESR register */
...
#define TZAESBASC_RESR_AER6(value)            (TZAESBASC_RESR_AER6_Msk & (_UINT32_(value) << TZAESBASC_RESR_AER6_Pos)) /* Assignment of value for AER6 in the TZAESBASC_RESR register */
...
#define TZAESBASC_RESR_AER7(value)            (TZAESBASC_RESR_AER7_Msk & (_UINT32_(value) << TZAESBASC_RESR_AER7_Pos)) /* Assignment of value for AER7 in the TZAESBASC_RESR register */
...
#define TZAESBASC_RSSR_SYNC(value)            (TZAESBASC_RSSR_SYNC_Msk & (_UINT32_(value) << TZAESBASC_RSSR_SYNC_Pos)) /* Assignment of value for SYNC in the TZAESBASC_RSSR register */
...
#define TZAESBASC_WPMR_WPEN(value)            (TZAESBASC_WPMR_WPEN_Msk & (_UINT32_(value) << TZAESBASC_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the TZAESBASC_WPMR register */
...
#define TZAESBASC_WPMR_WPKEY(value)           (TZAESBASC_WPMR_WPKEY_Msk & (_UINT32_(value) << TZAESBASC_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the TZAESBASC_WPMR register */
...
#define TZAESBASC_WPSR_WPVS(value)            (TZAESBASC_WPSR_WPVS_Msk & (_UINT32_(value) << TZAESBASC_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the TZAESBASC_WPSR register */
...
#define TZAESBASC_WPSR_WPSRC(value)           (TZAESBASC_WPSR_WPSRC_Msk & (_UINT32_(value) << TZAESBASC_WPSR_WPSRC_Pos)) /* Assignment of value for WPSRC in the TZAESBASC_WPSR register */
#define TZAESBASC_WPSR_Msk                    _UINT32_(0x00FFFF01)                                 /* (TZAESBASC_WPSR) Register Mask  */


/* TZAESBASC register offsets definitions */
...
/* TZAESBASC_RID register API structure */
typedef struct
{
...
/* TZAESBASC register API structure */
typedef struct
...
#endif /* _SAMA7G5_TZAESBASC_COMPONENT_H_ */
