...
#define RSTC_GRSTR_USB_RST1(value)            (RSTC_GRSTR_USB_RST1_Msk & (_UINT32_(value) << RSTC_GRSTR_USB_RST1_Pos)) /* Assignment of value for USB_RST1 in the RSTC_GRSTR register */
...
#define RSTC_GRSTR_USB_RST2(value)            (RSTC_GRSTR_USB_RST2_Msk & (_UINT32_(value) << RSTC_GRSTR_USB_RST2_Pos)) /* Assignment of value for USB_RST2 in the RSTC_GRSTR register */
...
#define RSTC_GRSTR_USB_RST3(value)            (RSTC_GRSTR_USB_RST3_Msk & (_UINT32_(value) << RSTC_GRSTR_USB_RST3_Pos)) /* Assignment of value for USB_RST3 in the RSTC_GRSTR register */
...
#endif /* _SAMA7G5_RSTC_COMPONENT_H_ */
