...
#ifndef _SAMA7G5_SECUMOD_COMPONENT_H_
#define _SAMA7G5_SECUMOD_COMPONENT_H_
...
#define SECUMOD_JTAGCR_RESETVALUE             _UINT32_(0x00)                                       /*  (SECUMOD_JTAGCR) JTAG Protection Control Register  Reset Value */
...
#define SECUMOD_JTAGCR_FNTRST(value)          (SECUMOD_JTAGCR_FNTRST_Msk & (_UINT32_(value) << SECUMOD_JTAGCR_FNTRST_Pos)) /* Assignment of value for FNTRST in the SECUMOD_JTAGCR register */
#define   SECUMOD_JTAGCR_FNTRST_0_Val         _UINT32_(0x0)                                        /* (SECUMOD_JTAGCR) The ARM processor TAP controller access and Boundary JTAG are not blocked by the SECUMOD.  */
#define   SECUMOD_JTAGCR_FNTRST_1_Val         _UINT32_(0x1)                                        /* (SECUMOD_JTAGCR) NDBGRESET of the ARM processor TAP controller and Boundary JTAG reset are held low, preventing the processor from switching to debug state and Boundary JTAG to work.  */
#define SECUMOD_JTAGCR_FNTRST_0               (SECUMOD_JTAGCR_FNTRST_0_Val << SECUMOD_JTAGCR_FNTRST_Pos) /* (SECUMOD_JTAGCR) The ARM processor TAP controller access and Boundary JTAG are not blocked by the SECUMOD. Position */
#define SECUMOD_JTAGCR_FNTRST_1               (SECUMOD_JTAGCR_FNTRST_1_Val << SECUMOD_JTAGCR_FNTRST_Pos) /* (SECUMOD_JTAGCR) NDBGRESET of the ARM processor TAP controller and Boundary JTAG reset are held low, preventing the processor from switching to debug state and Boundary JTAG to work. Position */
...
#define   SECUMOD_GPSBR_TSRANGE_0_Val         _UINT32_(0x0)                                        /* (SECUMOD_GPSBR) Sets temperature sensor high threshold to 105 Celsius degree.  */
#define   SECUMOD_GPSBR_TSRANGE_1_Val         _UINT32_(0x1)                                        /* (SECUMOD_GPSBR) Sets temperature sensor high threshold to 120 Celsius degree.  */
#define SECUMOD_GPSBR_TSRANGE_0               (SECUMOD_GPSBR_TSRANGE_0_Val << SECUMOD_GPSBR_TSRANGE_Pos) /* (SECUMOD_GPSBR) Sets temperature sensor high threshold to 105 Celsius degree. Position */
#define SECUMOD_GPSBR_TSRANGE_1               (SECUMOD_GPSBR_TSRANGE_1_Val << SECUMOD_GPSBR_TSRANGE_Pos) /* (SECUMOD_GPSBR) Sets temperature sensor high threshold to 120 Celsius degree. Position */
...
#endif /* _SAMA7G5_SECUMOD_COMPONENT_H_ */
