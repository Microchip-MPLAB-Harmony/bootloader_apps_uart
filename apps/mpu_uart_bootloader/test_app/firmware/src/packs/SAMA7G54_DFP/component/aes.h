...
#ifndef _SAMA7G5_AES_COMPONENT_H_
#define _SAMA7G5_AES_COMPONENT_H_
...
#define AES_CR_START(value)                   (AES_CR_START_Msk & (_UINT32_(value) << AES_CR_START_Pos)) /* Assignment of value for START in the AES_CR register */
...
#define AES_CR_SWRST(value)                   (AES_CR_SWRST_Msk & (_UINT32_(value) << AES_CR_SWRST_Pos)) /* Assignment of value for SWRST in the AES_CR register */
...
#define AES_CR_UNLOCK(value)                  (AES_CR_UNLOCK_Msk & (_UINT32_(value) << AES_CR_UNLOCK_Pos)) /* Assignment of value for UNLOCK in the AES_CR register */
...
#define AES_MR_CIPHER(value)                  (AES_MR_CIPHER_Msk & (_UINT32_(value) << AES_MR_CIPHER_Pos)) /* Assignment of value for CIPHER in the AES_MR register */
...
#define AES_MR_GTAGEN(value)                  (AES_MR_GTAGEN_Msk & (_UINT32_(value) << AES_MR_GTAGEN_Pos)) /* Assignment of value for GTAGEN in the AES_MR register */
...
#define AES_MR_DUALBUFF(value)                (AES_MR_DUALBUFF_Msk & (_UINT32_(value) << AES_MR_DUALBUFF_Pos)) /* Assignment of value for DUALBUFF in the AES_MR register */
...
#define AES_MR_PROCDLY(value)                 (AES_MR_PROCDLY_Msk & (_UINT32_(value) << AES_MR_PROCDLY_Pos)) /* Assignment of value for PROCDLY in the AES_MR register */
...
#define AES_MR_SMOD(value)                    (AES_MR_SMOD_Msk & (_UINT32_(value) << AES_MR_SMOD_Pos)) /* Assignment of value for SMOD in the AES_MR register */
...
#define AES_MR_KEYSIZE(value)                 (AES_MR_KEYSIZE_Msk & (_UINT32_(value) << AES_MR_KEYSIZE_Pos)) /* Assignment of value for KEYSIZE in the AES_MR register */
...
#define AES_MR_OPMOD(value)                   (AES_MR_OPMOD_Msk & (_UINT32_(value) << AES_MR_OPMOD_Pos)) /* Assignment of value for OPMOD in the AES_MR register */
...
#define AES_MR_LOD(value)                     (AES_MR_LOD_Msk & (_UINT32_(value) << AES_MR_LOD_Pos)) /* Assignment of value for LOD in the AES_MR register */
...
#define AES_MR_CFBS(value)                    (AES_MR_CFBS_Msk & (_UINT32_(value) << AES_MR_CFBS_Pos)) /* Assignment of value for CFBS in the AES_MR register */
...
#define AES_MR_CKEY(value)                    (AES_MR_CKEY_Msk & (_UINT32_(value) << AES_MR_CKEY_Pos)) /* Assignment of value for CKEY in the AES_MR register */
...
#define AES_MR_TAMPCLR(value)                 (AES_MR_TAMPCLR_Msk & (_UINT32_(value) << AES_MR_TAMPCLR_Pos)) /* Assignment of value for TAMPCLR in the AES_MR register */
...
#define AES_IER_DATRDY(value)                 (AES_IER_DATRDY_Msk & (_UINT32_(value) << AES_IER_DATRDY_Pos)) /* Assignment of value for DATRDY in the AES_IER register */
...
#define AES_IER_URAD(value)                   (AES_IER_URAD_Msk & (_UINT32_(value) << AES_IER_URAD_Pos)) /* Assignment of value for URAD in the AES_IER register */
...
#define AES_IER_TAGRDY(value)                 (AES_IER_TAGRDY_Msk & (_UINT32_(value) << AES_IER_TAGRDY_Pos)) /* Assignment of value for TAGRDY in the AES_IER register */
...
#define AES_IER_EOPAD(value)                  (AES_IER_EOPAD_Msk & (_UINT32_(value) << AES_IER_EOPAD_Pos)) /* Assignment of value for EOPAD in the AES_IER register */
...
#define AES_IER_PLENERR(value)                (AES_IER_PLENERR_Msk & (_UINT32_(value) << AES_IER_PLENERR_Pos)) /* Assignment of value for PLENERR in the AES_IER register */
...
#define AES_IER_SECE(value)                   (AES_IER_SECE_Msk & (_UINT32_(value) << AES_IER_SECE_Pos)) /* Assignment of value for SECE in the AES_IER register */
...
#define AES_IDR_DATRDY(value)                 (AES_IDR_DATRDY_Msk & (_UINT32_(value) << AES_IDR_DATRDY_Pos)) /* Assignment of value for DATRDY in the AES_IDR register */
...
#define AES_IDR_URAD(value)                   (AES_IDR_URAD_Msk & (_UINT32_(value) << AES_IDR_URAD_Pos)) /* Assignment of value for URAD in the AES_IDR register */
...
#define AES_IDR_TAGRDY(value)                 (AES_IDR_TAGRDY_Msk & (_UINT32_(value) << AES_IDR_TAGRDY_Pos)) /* Assignment of value for TAGRDY in the AES_IDR register */
...
#define AES_IDR_EOPAD(value)                  (AES_IDR_EOPAD_Msk & (_UINT32_(value) << AES_IDR_EOPAD_Pos)) /* Assignment of value for EOPAD in the AES_IDR register */
...
#define AES_IDR_PLENERR(value)                (AES_IDR_PLENERR_Msk & (_UINT32_(value) << AES_IDR_PLENERR_Pos)) /* Assignment of value for PLENERR in the AES_IDR register */
...
#define AES_IDR_SECE(value)                   (AES_IDR_SECE_Msk & (_UINT32_(value) << AES_IDR_SECE_Pos)) /* Assignment of value for SECE in the AES_IDR register */
...
#define AES_IMR_DATRDY(value)                 (AES_IMR_DATRDY_Msk & (_UINT32_(value) << AES_IMR_DATRDY_Pos)) /* Assignment of value for DATRDY in the AES_IMR register */
...
#define AES_IMR_URAD(value)                   (AES_IMR_URAD_Msk & (_UINT32_(value) << AES_IMR_URAD_Pos)) /* Assignment of value for URAD in the AES_IMR register */
...
#define AES_IMR_TAGRDY(value)                 (AES_IMR_TAGRDY_Msk & (_UINT32_(value) << AES_IMR_TAGRDY_Pos)) /* Assignment of value for TAGRDY in the AES_IMR register */
...
#define AES_IMR_EOPAD(value)                  (AES_IMR_EOPAD_Msk & (_UINT32_(value) << AES_IMR_EOPAD_Pos)) /* Assignment of value for EOPAD in the AES_IMR register */
...
#define AES_IMR_PLENERR(value)                (AES_IMR_PLENERR_Msk & (_UINT32_(value) << AES_IMR_PLENERR_Pos)) /* Assignment of value for PLENERR in the AES_IMR register */
...
#define AES_IMR_SECE(value)                   (AES_IMR_SECE_Msk & (_UINT32_(value) << AES_IMR_SECE_Pos)) /* Assignment of value for SECE in the AES_IMR register */
...
#define AES_ISR_DATRDY(value)                 (AES_ISR_DATRDY_Msk & (_UINT32_(value) << AES_ISR_DATRDY_Pos)) /* Assignment of value for DATRDY in the AES_ISR register */
...
#define AES_ISR_URAD(value)                   (AES_ISR_URAD_Msk & (_UINT32_(value) << AES_ISR_URAD_Pos)) /* Assignment of value for URAD in the AES_ISR register */
...
#define AES_ISR_URAT(value)                   (AES_ISR_URAT_Msk & (_UINT32_(value) << AES_ISR_URAT_Pos)) /* Assignment of value for URAT in the AES_ISR register */
...
#define AES_ISR_TAGRDY(value)                 (AES_ISR_TAGRDY_Msk & (_UINT32_(value) << AES_ISR_TAGRDY_Pos)) /* Assignment of value for TAGRDY in the AES_ISR register */
...
#define AES_ISR_EOPAD(value)                  (AES_ISR_EOPAD_Msk & (_UINT32_(value) << AES_ISR_EOPAD_Pos)) /* Assignment of value for EOPAD in the AES_ISR register */
...
#define AES_ISR_PLENERR(value)                (AES_ISR_PLENERR_Msk & (_UINT32_(value) << AES_ISR_PLENERR_Pos)) /* Assignment of value for PLENERR in the AES_ISR register */
...
#define AES_ISR_SECE(value)                   (AES_ISR_SECE_Msk & (_UINT32_(value) << AES_ISR_SECE_Pos)) /* Assignment of value for SECE in the AES_ISR register */
...
#define AES_KEYWR_KEYW(value)                 (AES_KEYWR_KEYW_Msk & (_UINT32_(value) << AES_KEYWR_KEYW_Pos)) /* Assignment of value for KEYW in the AES_KEYWR register */
...
#define AES_IDATAR_IDATA(value)               (AES_IDATAR_IDATA_Msk & (_UINT32_(value) << AES_IDATAR_IDATA_Pos)) /* Assignment of value for IDATA in the AES_IDATAR register */
...
#define AES_ODATAR_ODATA(value)               (AES_ODATAR_ODATA_Msk & (_UINT32_(value) << AES_ODATAR_ODATA_Pos)) /* Assignment of value for ODATA in the AES_ODATAR register */
...
#define AES_IVR_IV(value)                     (AES_IVR_IV_Msk & (_UINT32_(value) << AES_IVR_IV_Pos)) /* Assignment of value for IV in the AES_IVR register */
...
#define AES_AADLENR_AADLEN(value)             (AES_AADLENR_AADLEN_Msk & (_UINT32_(value) << AES_AADLENR_AADLEN_Pos)) /* Assignment of value for AADLEN in the AES_AADLENR register */
...
#define AES_CLENR_CLEN(value)                 (AES_CLENR_CLEN_Msk & (_UINT32_(value) << AES_CLENR_CLEN_Pos)) /* Assignment of value for CLEN in the AES_CLENR register */
...
#define AES_GHASHR_GHASH(value)               (AES_GHASHR_GHASH_Msk & (_UINT32_(value) << AES_GHASHR_GHASH_Pos)) /* Assignment of value for GHASH in the AES_GHASHR register */
...
#define AES_TAGR_TAG(value)                   (AES_TAGR_TAG_Msk & (_UINT32_(value) << AES_TAGR_TAG_Pos)) /* Assignment of value for TAG in the AES_TAGR register */
...
#define AES_CTRR_CTR(value)                   (AES_CTRR_CTR_Msk & (_UINT32_(value) << AES_CTRR_CTR_Pos)) /* Assignment of value for CTR in the AES_CTRR register */
...
#define AES_GCMHR_H(value)                    (AES_GCMHR_H_Msk & (_UINT32_(value) << AES_GCMHR_H_Pos)) /* Assignment of value for H in the AES_GCMHR register */
...
#define AES_EMR_APEN(value)                   (AES_EMR_APEN_Msk & (_UINT32_(value) << AES_EMR_APEN_Pos)) /* Assignment of value for APEN in the AES_EMR register */
...
#define AES_EMR_APM(value)                    (AES_EMR_APM_Msk & (_UINT32_(value) << AES_EMR_APM_Pos)) /* Assignment of value for APM in the AES_EMR register */
...
#define AES_EMR_PLIPEN(value)                 (AES_EMR_PLIPEN_Msk & (_UINT32_(value) << AES_EMR_PLIPEN_Pos)) /* Assignment of value for PLIPEN in the AES_EMR register */
...
#define AES_EMR_PLIPD(value)                  (AES_EMR_PLIPD_Msk & (_UINT32_(value) << AES_EMR_PLIPD_Pos)) /* Assignment of value for PLIPD in the AES_EMR register */
...
#define AES_EMR_PKWL(value)                   (AES_EMR_PKWL_Msk & (_UINT32_(value) << AES_EMR_PKWL_Pos)) /* Assignment of value for PKWL in the AES_EMR register */
...
#define AES_EMR_PKRS(value)                   (AES_EMR_PKRS_Msk & (_UINT32_(value) << AES_EMR_PKRS_Pos)) /* Assignment of value for PKRS in the AES_EMR register */
...
#define AES_EMR_PADLEN(value)                 (AES_EMR_PADLEN_Msk & (_UINT32_(value) << AES_EMR_PADLEN_Pos)) /* Assignment of value for PADLEN in the AES_EMR register */
...
#define AES_EMR_NHEAD(value)                  (AES_EMR_NHEAD_Msk & (_UINT32_(value) << AES_EMR_NHEAD_Pos)) /* Assignment of value for NHEAD in the AES_EMR register */
...
#define AES_EMR_BPE(value)                    (AES_EMR_BPE_Msk & (_UINT32_(value) << AES_EMR_BPE_Pos)) /* Assignment of value for BPE in the AES_EMR register */
...
#define AES_EMR_Msk                           _UINT32_(0x80FFFFF3)                                 /* (AES_EMR) Register Mask  */
...
#define AES_BCNT_BCNT(value)                  (AES_BCNT_BCNT_Msk & (_UINT32_(value) << AES_BCNT_BCNT_Pos)) /* Assignment of value for BCNT in the AES_BCNT register */
...
#define AES_TWR_TWEAK(value)                  (AES_TWR_TWEAK_Msk & (_UINT32_(value) << AES_TWR_TWEAK_Pos)) /* Assignment of value for TWEAK in the AES_TWR register */
...
#define AES_ALPHAR_ALPHA(value)               (AES_ALPHAR_ALPHA_Msk & (_UINT32_(value) << AES_ALPHAR_ALPHA_Pos)) /* Assignment of value for ALPHA in the AES_ALPHAR register */
...
#define AES_WPMR_WPEN(value)                  (AES_WPMR_WPEN_Msk & (_UINT32_(value) << AES_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the AES_WPMR register */
...
#define AES_WPMR_WPITEN(value)                (AES_WPMR_WPITEN_Msk & (_UINT32_(value) << AES_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the AES_WPMR register */
...
#define AES_WPMR_WPCREN(value)                (AES_WPMR_WPCREN_Msk & (_UINT32_(value) << AES_WPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the AES_WPMR register */
...
#define AES_WPMR_FIRSTE(value)                (AES_WPMR_FIRSTE_Msk & (_UINT32_(value) << AES_WPMR_FIRSTE_Pos)) /* Assignment of value for FIRSTE in the AES_WPMR register */
...
#define AES_WPMR_ACTION(value)                (AES_WPMR_ACTION_Msk & (_UINT32_(value) << AES_WPMR_ACTION_Pos)) /* Assignment of value for ACTION in the AES_WPMR register */
...
#define AES_WPMR_WPKEY(value)                 (AES_WPMR_WPKEY_Msk & (_UINT32_(value) << AES_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the AES_WPMR register */
...
#define AES_WPSR_WPVS(value)                  (AES_WPSR_WPVS_Msk & (_UINT32_(value) << AES_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the AES_WPSR register */
...
#define AES_WPSR_CGD(value)                   (AES_WPSR_CGD_Msk & (_UINT32_(value) << AES_WPSR_CGD_Pos)) /* Assignment of value for CGD in the AES_WPSR register */
...
#define AES_WPSR_SEQE(value)                  (AES_WPSR_SEQE_Msk & (_UINT32_(value) << AES_WPSR_SEQE_Pos)) /* Assignment of value for SEQE in the AES_WPSR register */
...
#define AES_WPSR_SWE(value)                   (AES_WPSR_SWE_Msk & (_UINT32_(value) << AES_WPSR_SWE_Pos)) /* Assignment of value for SWE in the AES_WPSR register */
...
#define AES_WPSR_PKRPVS(value)                (AES_WPSR_PKRPVS_Msk & (_UINT32_(value) << AES_WPSR_PKRPVS_Pos)) /* Assignment of value for PKRPVS in the AES_WPSR register */
...
#define AES_WPSR_WPVSRC(value)                (AES_WPSR_WPVSRC_Msk & (_UINT32_(value) << AES_WPSR_WPVSRC_Pos)) /* Assignment of value for WPVSRC in the AES_WPSR register */
...
#define AES_WPSR_SWETYP(value)                (AES_WPSR_SWETYP_Msk & (_UINT32_(value) << AES_WPSR_SWETYP_Pos)) /* Assignment of value for SWETYP in the AES_WPSR register */
...
#define AES_WPSR_ECLASS(value)                (AES_WPSR_ECLASS_Msk & (_UINT32_(value) << AES_WPSR_ECLASS_Pos)) /* Assignment of value for ECLASS in the AES_WPSR register */
...
/* AES register offsets definitions */
...
#endif /* _SAMA7G5_AES_COMPONENT_H_ */
