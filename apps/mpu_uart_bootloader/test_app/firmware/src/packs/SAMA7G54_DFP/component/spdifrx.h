...
#ifndef _SAMA7G5_SPDIFRX_COMPONENT_H_
#define _SAMA7G5_SPDIFRX_COMPONENT_H_
...
#define SPDIFRX_CHxSR_CHSTATUS(value)         (SPDIFRX_CHxSR_CHSTATUS_Msk & (_UINT32_(value) << SPDIFRX_CHxSR_CHSTATUS_Pos)) /* Assignment of value for CHSTATUS in the SPDIFRX_CHxSR register */
...
#define SPDIFRX_CHxUD_CHUSERDATA(value)       (SPDIFRX_CHxUD_CHUSERDATA_Msk & (_UINT32_(value) << SPDIFRX_CHxUD_CHUSERDATA_Pos)) /* Assignment of value for CHUSERDATA in the SPDIFRX_CHxUD register */
...
#define SPDIFRX_CR_SWRST(value)               (SPDIFRX_CR_SWRST_Msk & (_UINT32_(value) << SPDIFRX_CR_SWRST_Pos)) /* Assignment of value for SWRST in the SPDIFRX_CR register */
...
#define SPDIFRX_MR_RXEN(value)                (SPDIFRX_MR_RXEN_Msk & (_UINT32_(value) << SPDIFRX_MR_RXEN_Pos)) /* Assignment of value for RXEN in the SPDIFRX_MR register */
...
#define SPDIFRX_MR_VBMODE(value)              (SPDIFRX_MR_VBMODE_Msk & (_UINT32_(value) << SPDIFRX_MR_VBMODE_Pos)) /* Assignment of value for VBMODE in the SPDIFRX_MR register */
...
#define SPDIFRX_MR_ENDIAN(value)              (SPDIFRX_MR_ENDIAN_Msk & (_UINT32_(value) << SPDIFRX_MR_ENDIAN_Pos)) /* Assignment of value for ENDIAN in the SPDIFRX_MR register */
...
#define SPDIFRX_MR_PBMODE(value)              (SPDIFRX_MR_PBMODE_Msk & (_UINT32_(value) << SPDIFRX_MR_PBMODE_Pos)) /* Assignment of value for PBMODE in the SPDIFRX_MR register */
...
#define SPDIFRX_MR_DATAWIDTH(value)           (SPDIFRX_MR_DATAWIDTH_Msk & (_UINT32_(value) << SPDIFRX_MR_DATAWIDTH_Pos)) /* Assignment of value for DATAWIDTH in the SPDIFRX_MR register */
...
#define SPDIFRX_MR_PACK(value)                (SPDIFRX_MR_PACK_Msk & (_UINT32_(value) << SPDIFRX_MR_PACK_Pos)) /* Assignment of value for PACK in the SPDIFRX_MR register */
...
#define SPDIFRX_MR_SBMODE(value)              (SPDIFRX_MR_SBMODE_Msk & (_UINT32_(value) << SPDIFRX_MR_SBMODE_Pos)) /* Assignment of value for SBMODE in the SPDIFRX_MR register */
...
#define SPDIFRX_MR_AUTORST(value)             (SPDIFRX_MR_AUTORST_Msk & (_UINT32_(value) << SPDIFRX_MR_AUTORST_Pos)) /* Assignment of value for AUTORST in the SPDIFRX_MR register */
...
#define SPDIFRX_IER_RXRDY(value)              (SPDIFRX_IER_RXRDY_Msk & (_UINT32_(value) << SPDIFRX_IER_RXRDY_Pos)) /* Assignment of value for RXRDY in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_LOCKED(value)             (SPDIFRX_IER_LOCKED_Msk & (_UINT32_(value) << SPDIFRX_IER_LOCKED_Pos)) /* Assignment of value for LOCKED in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_LOSS(value)               (SPDIFRX_IER_LOSS_Msk & (_UINT32_(value) << SPDIFRX_IER_LOSS_Pos)) /* Assignment of value for LOSS in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_BLOCKEND(value)           (SPDIFRX_IER_BLOCKEND_Msk & (_UINT32_(value) << SPDIFRX_IER_BLOCKEND_Pos)) /* Assignment of value for BLOCKEND in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_SFE(value)                (SPDIFRX_IER_SFE_Msk & (_UINT32_(value) << SPDIFRX_IER_SFE_Pos)) /* Assignment of value for SFE in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_PAR_ERR(value)            (SPDIFRX_IER_PAR_ERR_Msk & (_UINT32_(value) << SPDIFRX_IER_PAR_ERR_Pos)) /* Assignment of value for PAR_ERR in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_OVERRUN(value)            (SPDIFRX_IER_OVERRUN_Msk & (_UINT32_(value) << SPDIFRX_IER_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_RXFULL(value)             (SPDIFRX_IER_RXFULL_Msk & (_UINT32_(value) << SPDIFRX_IER_RXFULL_Pos)) /* Assignment of value for RXFULL in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_C1SC(value)               (SPDIFRX_IER_C1SC_Msk & (_UINT32_(value) << SPDIFRX_IER_C1SC_Pos)) /* Assignment of value for C1SC in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_C2SC(value)               (SPDIFRX_IER_C2SC_Msk & (_UINT32_(value) << SPDIFRX_IER_C2SC_Pos)) /* Assignment of value for C2SC in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_SECE(value)               (SPDIFRX_IER_SECE_Msk & (_UINT32_(value) << SPDIFRX_IER_SECE_Pos)) /* Assignment of value for SECE in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_BLOCKST(value)            (SPDIFRX_IER_BLOCKST_Msk & (_UINT32_(value) << SPDIFRX_IER_BLOCKST_Pos)) /* Assignment of value for BLOCKST in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_NRZ_ERR(value)            (SPDIFRX_IER_NRZ_ERR_Msk & (_UINT32_(value) << SPDIFRX_IER_NRZ_ERR_Pos)) /* Assignment of value for NRZ_ERR in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_PRE_ERR(value)            (SPDIFRX_IER_PRE_ERR_Msk & (_UINT32_(value) << SPDIFRX_IER_PRE_ERR_Pos)) /* Assignment of value for PRE_ERR in the SPDIFRX_IER register */
...
#define SPDIFRX_IER_CP_ERR(value)             (SPDIFRX_IER_CP_ERR_Msk & (_UINT32_(value) << SPDIFRX_IER_CP_ERR_Pos)) /* Assignment of value for CP_ERR in the SPDIFRX_IER register */
...
#define SPDIFRX_IDR_RXRDY(value)              (SPDIFRX_IDR_RXRDY_Msk & (_UINT32_(value) << SPDIFRX_IDR_RXRDY_Pos)) /* Assignment of value for RXRDY in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_LOCKED(value)             (SPDIFRX_IDR_LOCKED_Msk & (_UINT32_(value) << SPDIFRX_IDR_LOCKED_Pos)) /* Assignment of value for LOCKED in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_LOSS(value)               (SPDIFRX_IDR_LOSS_Msk & (_UINT32_(value) << SPDIFRX_IDR_LOSS_Pos)) /* Assignment of value for LOSS in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_BLOCKEND(value)           (SPDIFRX_IDR_BLOCKEND_Msk & (_UINT32_(value) << SPDIFRX_IDR_BLOCKEND_Pos)) /* Assignment of value for BLOCKEND in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_SFE(value)                (SPDIFRX_IDR_SFE_Msk & (_UINT32_(value) << SPDIFRX_IDR_SFE_Pos)) /* Assignment of value for SFE in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_PAR_ERR(value)            (SPDIFRX_IDR_PAR_ERR_Msk & (_UINT32_(value) << SPDIFRX_IDR_PAR_ERR_Pos)) /* Assignment of value for PAR_ERR in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_OVERRUN(value)            (SPDIFRX_IDR_OVERRUN_Msk & (_UINT32_(value) << SPDIFRX_IDR_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_RXFULL(value)             (SPDIFRX_IDR_RXFULL_Msk & (_UINT32_(value) << SPDIFRX_IDR_RXFULL_Pos)) /* Assignment of value for RXFULL in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_C1SC(value)               (SPDIFRX_IDR_C1SC_Msk & (_UINT32_(value) << SPDIFRX_IDR_C1SC_Pos)) /* Assignment of value for C1SC in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_C2SC(value)               (SPDIFRX_IDR_C2SC_Msk & (_UINT32_(value) << SPDIFRX_IDR_C2SC_Pos)) /* Assignment of value for C2SC in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_SECE(value)               (SPDIFRX_IDR_SECE_Msk & (_UINT32_(value) << SPDIFRX_IDR_SECE_Pos)) /* Assignment of value for SECE in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_BLOCKST(value)            (SPDIFRX_IDR_BLOCKST_Msk & (_UINT32_(value) << SPDIFRX_IDR_BLOCKST_Pos)) /* Assignment of value for BLOCKST in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_NRZ_ERR(value)            (SPDIFRX_IDR_NRZ_ERR_Msk & (_UINT32_(value) << SPDIFRX_IDR_NRZ_ERR_Pos)) /* Assignment of value for NRZ_ERR in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_PRE_ERR(value)            (SPDIFRX_IDR_PRE_ERR_Msk & (_UINT32_(value) << SPDIFRX_IDR_PRE_ERR_Pos)) /* Assignment of value for PRE_ERR in the SPDIFRX_IDR register */
...
#define SPDIFRX_IDR_CP_ERR(value)             (SPDIFRX_IDR_CP_ERR_Msk & (_UINT32_(value) << SPDIFRX_IDR_CP_ERR_Pos)) /* Assignment of value for CP_ERR in the SPDIFRX_IDR register */
...
#define SPDIFRX_IMR_RXRDY(value)              (SPDIFRX_IMR_RXRDY_Msk & (_UINT32_(value) << SPDIFRX_IMR_RXRDY_Pos)) /* Assignment of value for RXRDY in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_LOCKED(value)             (SPDIFRX_IMR_LOCKED_Msk & (_UINT32_(value) << SPDIFRX_IMR_LOCKED_Pos)) /* Assignment of value for LOCKED in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_LOSS(value)               (SPDIFRX_IMR_LOSS_Msk & (_UINT32_(value) << SPDIFRX_IMR_LOSS_Pos)) /* Assignment of value for LOSS in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_BLOCKEND(value)           (SPDIFRX_IMR_BLOCKEND_Msk & (_UINT32_(value) << SPDIFRX_IMR_BLOCKEND_Pos)) /* Assignment of value for BLOCKEND in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_SFE(value)                (SPDIFRX_IMR_SFE_Msk & (_UINT32_(value) << SPDIFRX_IMR_SFE_Pos)) /* Assignment of value for SFE in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_PAR_ERR(value)            (SPDIFRX_IMR_PAR_ERR_Msk & (_UINT32_(value) << SPDIFRX_IMR_PAR_ERR_Pos)) /* Assignment of value for PAR_ERR in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_OVERRUN(value)            (SPDIFRX_IMR_OVERRUN_Msk & (_UINT32_(value) << SPDIFRX_IMR_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_RXFULL(value)             (SPDIFRX_IMR_RXFULL_Msk & (_UINT32_(value) << SPDIFRX_IMR_RXFULL_Pos)) /* Assignment of value for RXFULL in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_C1SC(value)               (SPDIFRX_IMR_C1SC_Msk & (_UINT32_(value) << SPDIFRX_IMR_C1SC_Pos)) /* Assignment of value for C1SC in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_C2SC(value)               (SPDIFRX_IMR_C2SC_Msk & (_UINT32_(value) << SPDIFRX_IMR_C2SC_Pos)) /* Assignment of value for C2SC in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_SECE(value)               (SPDIFRX_IMR_SECE_Msk & (_UINT32_(value) << SPDIFRX_IMR_SECE_Pos)) /* Assignment of value for SECE in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_BLOCKST(value)            (SPDIFRX_IMR_BLOCKST_Msk & (_UINT32_(value) << SPDIFRX_IMR_BLOCKST_Pos)) /* Assignment of value for BLOCKST in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_NRZ_ERR(value)            (SPDIFRX_IMR_NRZ_ERR_Msk & (_UINT32_(value) << SPDIFRX_IMR_NRZ_ERR_Pos)) /* Assignment of value for NRZ_ERR in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_PRE_ERR(value)            (SPDIFRX_IMR_PRE_ERR_Msk & (_UINT32_(value) << SPDIFRX_IMR_PRE_ERR_Pos)) /* Assignment of value for PRE_ERR in the SPDIFRX_IMR register */
...
#define SPDIFRX_IMR_CP_ERR(value)             (SPDIFRX_IMR_CP_ERR_Msk & (_UINT32_(value) << SPDIFRX_IMR_CP_ERR_Pos)) /* Assignment of value for CP_ERR in the SPDIFRX_IMR register */
...
#define SPDIFRX_ISR_RXRDY(value)              (SPDIFRX_ISR_RXRDY_Msk & (_UINT32_(value) << SPDIFRX_ISR_RXRDY_Pos)) /* Assignment of value for RXRDY in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_LOCKED(value)             (SPDIFRX_ISR_LOCKED_Msk & (_UINT32_(value) << SPDIFRX_ISR_LOCKED_Pos)) /* Assignment of value for LOCKED in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_LOSS(value)               (SPDIFRX_ISR_LOSS_Msk & (_UINT32_(value) << SPDIFRX_ISR_LOSS_Pos)) /* Assignment of value for LOSS in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_BLOCKEND(value)           (SPDIFRX_ISR_BLOCKEND_Msk & (_UINT32_(value) << SPDIFRX_ISR_BLOCKEND_Pos)) /* Assignment of value for BLOCKEND in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_SFE(value)                (SPDIFRX_ISR_SFE_Msk & (_UINT32_(value) << SPDIFRX_ISR_SFE_Pos)) /* Assignment of value for SFE in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_PAR_ERR(value)            (SPDIFRX_ISR_PAR_ERR_Msk & (_UINT32_(value) << SPDIFRX_ISR_PAR_ERR_Pos)) /* Assignment of value for PAR_ERR in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_OVERRUN(value)            (SPDIFRX_ISR_OVERRUN_Msk & (_UINT32_(value) << SPDIFRX_ISR_OVERRUN_Pos)) /* Assignment of value for OVERRUN in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_RXFULL(value)             (SPDIFRX_ISR_RXFULL_Msk & (_UINT32_(value) << SPDIFRX_ISR_RXFULL_Pos)) /* Assignment of value for RXFULL in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_C1SC(value)               (SPDIFRX_ISR_C1SC_Msk & (_UINT32_(value) << SPDIFRX_ISR_C1SC_Pos)) /* Assignment of value for C1SC in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_C2SC(value)               (SPDIFRX_ISR_C2SC_Msk & (_UINT32_(value) << SPDIFRX_ISR_C2SC_Pos)) /* Assignment of value for C2SC in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_SECE(value)               (SPDIFRX_ISR_SECE_Msk & (_UINT32_(value) << SPDIFRX_ISR_SECE_Pos)) /* Assignment of value for SECE in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_BLOCKST(value)            (SPDIFRX_ISR_BLOCKST_Msk & (_UINT32_(value) << SPDIFRX_ISR_BLOCKST_Pos)) /* Assignment of value for BLOCKST in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_NRZ_ERR(value)            (SPDIFRX_ISR_NRZ_ERR_Msk & (_UINT32_(value) << SPDIFRX_ISR_NRZ_ERR_Pos)) /* Assignment of value for NRZ_ERR in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_PRE_ERR(value)            (SPDIFRX_ISR_PRE_ERR_Msk & (_UINT32_(value) << SPDIFRX_ISR_PRE_ERR_Pos)) /* Assignment of value for PRE_ERR in the SPDIFRX_ISR register */
...
#define SPDIFRX_ISR_CP_ERR(value)             (SPDIFRX_ISR_CP_ERR_Msk & (_UINT32_(value) << SPDIFRX_ISR_CP_ERR_Pos)) /* Assignment of value for CP_ERR in the SPDIFRX_ISR register */
...
#define SPDIFRX_RSR_ULOCK(value)              (SPDIFRX_RSR_ULOCK_Msk & (_UINT32_(value) << SPDIFRX_RSR_ULOCK_Pos)) /* Assignment of value for ULOCK in the SPDIFRX_RSR register */
...
#define SPDIFRX_RSR_BADF(value)               (SPDIFRX_RSR_BADF_Msk & (_UINT32_(value) << SPDIFRX_RSR_BADF_Pos)) /* Assignment of value for BADF in the SPDIFRX_RSR register */
...
#define SPDIFRX_RSR_LOWF(value)               (SPDIFRX_RSR_LOWF_Msk & (_UINT32_(value) << SPDIFRX_RSR_LOWF_Pos)) /* Assignment of value for LOWF in the SPDIFRX_RSR register */
...
#define SPDIFRX_RSR_NOSIGNAL(value)           (SPDIFRX_RSR_NOSIGNAL_Msk & (_UINT32_(value) << SPDIFRX_RSR_NOSIGNAL_Pos)) /* Assignment of value for NOSIGNAL in the SPDIFRX_RSR register */
...
#define SPDIFRX_RSR_IFS(value)                (SPDIFRX_RSR_IFS_Msk & (_UINT32_(value) << SPDIFRX_RSR_IFS_Pos)) /* Assignment of value for IFS in the SPDIFRX_RSR register */
...
#define SPDIFRX_RHR_DATA(value)               (SPDIFRX_RHR_DATA_Msk & (_UINT32_(value) << SPDIFRX_RHR_DATA_Pos)) /* Assignment of value for DATA in the SPDIFRX_RHR register */
...
#define SPDIFRX_WPMR_WPEN(value)              (SPDIFRX_WPMR_WPEN_Msk & (_UINT32_(value) << SPDIFRX_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the SPDIFRX_WPMR register */
...
#define SPDIFRX_WPMR_WPITEN(value)            (SPDIFRX_WPMR_WPITEN_Msk & (_UINT32_(value) << SPDIFRX_WPMR_WPITEN_Pos)) /* Assignment of value for WPITEN in the SPDIFRX_WPMR register */
...
#define SPDIFRX_WPMR_WPCREN(value)            (SPDIFRX_WPMR_WPCREN_Msk & (_UINT32_(value) << SPDIFRX_WPMR_WPCREN_Pos)) /* Assignment of value for WPCREN in the SPDIFRX_WPMR register */
...
#define SPDIFRX_WPMR_FIRSTE(value)            (SPDIFRX_WPMR_FIRSTE_Msk & (_UINT32_(value) << SPDIFRX_WPMR_FIRSTE_Pos)) /* Assignment of value for FIRSTE in the SPDIFRX_WPMR register */
...
#define SPDIFRX_WPMR_WPKEY(value)             (SPDIFRX_WPMR_WPKEY_Msk & (_UINT32_(value) << SPDIFRX_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the SPDIFRX_WPMR register */
...
#define SPDIFRX_WPSR_WPVS(value)              (SPDIFRX_WPSR_WPVS_Msk & (_UINT32_(value) << SPDIFRX_WPSR_WPVS_Pos)) /* Assignment of value for WPVS in the SPDIFRX_WPSR register */
...
#define SPDIFRX_WPSR_SEQE(value)              (SPDIFRX_WPSR_SEQE_Msk & (_UINT32_(value) << SPDIFRX_WPSR_SEQE_Pos)) /* Assignment of value for SEQE in the SPDIFRX_WPSR register */
...
#define SPDIFRX_WPSR_SWE(value)               (SPDIFRX_WPSR_SWE_Msk & (_UINT32_(value) << SPDIFRX_WPSR_SWE_Pos)) /* Assignment of value for SWE in the SPDIFRX_WPSR register */
...
#define SPDIFRX_WPSR_WPSRC(value)             (SPDIFRX_WPSR_WPSRC_Msk & (_UINT32_(value) << SPDIFRX_WPSR_WPSRC_Pos)) /* Assignment of value for WPSRC in the SPDIFRX_WPSR register */
...
#define SPDIFRX_WPSR_SWETYP(value)            (SPDIFRX_WPSR_SWETYP_Msk & (_UINT32_(value) << SPDIFRX_WPSR_SWETYP_Pos)) /* Assignment of value for SWETYP in the SPDIFRX_WPSR register */
...
/* SPDIFRX register offsets definitions */
...
/* SPDIFRX_CH register API structure */
typedef struct
{
...
/* SPDIFRX register API structure */
typedef struct
...
#endif /* _SAMA7G5_SPDIFRX_COMPONENT_H_ */
