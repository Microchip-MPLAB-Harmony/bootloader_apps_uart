...
#ifndef _SAMA7G5_ACC_COMPONENT_H_
#define _SAMA7G5_ACC_COMPONENT_H_
...
#define ACC_ACR_MSEL(value)                   (ACC_ACR_MSEL_Msk & (_UINT32_(value) << ACC_ACR_MSEL_Pos)) /* Assignment of value for MSEL in the ACC_ACR register */
...
#endif /* _SAMA7G5_ACC_COMPONENT_H_ */
