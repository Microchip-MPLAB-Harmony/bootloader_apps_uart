...
#define CSI_INT_ST_PHY_FATAL_PHY_ERRSOTSYNCHS__Pos _UINT32_(0)                                          /* (CSI_INT_ST_PHY_FATAL Position) Data Lane x Start Of Transmission Error Status (cleared on read) */
...
#define CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS__Pos _UINT32_(0)                                          /* (CSI_INT_MSK_PHY_FATAL Position) Data Lane x Start Of Transmission Error Interrupt Mask */
#define CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS__Msk (_UINT32_(0x3) << CSI_INT_MSK_PHY_FATAL_MASK_ERRSOTSYNCHS__Pos) /* (CSI_INT_MSK_PHY_FATAL Mask) MASK_ERRSOTSYNCHS_ */
...
#define CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS__Pos _UINT32_(0)                                          /* (CSI_INT_FORCE_PHY_FATAL Position) Force Start Of Transmission Interrupt Error on Data Lane x */
#define CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS__Msk (_UINT32_(0x3) << CSI_INT_FORCE_PHY_FATAL_FORCE_ERRSOTSYNCHS__Pos) /* (CSI_INT_FORCE_PHY_FATAL Mask) FORCE_ERRSOTSYNCHS_ */
...
#define CSI_INT_ST_PHY_PHY_ERRESC__Pos        _UINT32_(16)                                         /* (CSI_INT_ST_PHY Position) Start of Transmission Error on Data Lane x (synchronization can still be achieved) (cleared on read) */
...
#define CSI_INT_MSK_PHY_MASK_PHY_ERRESC__Pos  _UINT32_(16)                                         /* (CSI_INT_MSK_PHY Position) Start of Transmission Error on Data Lane x (synchronization can still be achieved) Interrupt Mask */
...
#define CSI_INT_FORCE_PHY_FORCE_PHY_ERRESC__Pos _UINT32_(16)                                         /* (CSI_INT_FORCE_PHY Position) Force Start of Transmission Error on Data Lane x (synchronization can still be achieved) Interrupt */
...
#endif /* _SAMA7G5_CSI_COMPONENT_H_ */
