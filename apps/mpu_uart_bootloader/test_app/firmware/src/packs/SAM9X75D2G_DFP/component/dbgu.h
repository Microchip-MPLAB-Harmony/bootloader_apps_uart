...
#define DBGU_CR_RSTRX(value)                  (DBGU_CR_RSTRX_Msk & (_UINT32_(value) << DBGU_CR_RSTRX_Pos)) /* Assignment of value for RSTRX in the DBGU_CR register */
...
#define DBGU_CR_RSTTX(value)                  (DBGU_CR_RSTTX_Msk & (_UINT32_(value) << DBGU_CR_RSTTX_Pos)) /* Assignment of value for RSTTX in the DBGU_CR register */
...
#define DBGU_CR_RXEN(value)                   (DBGU_CR_RXEN_Msk & (_UINT32_(value) << DBGU_CR_RXEN_Pos)) /* Assignment of value for RXEN in the DBGU_CR register */
...
#define DBGU_CR_RXDIS(value)                  (DBGU_CR_RXDIS_Msk & (_UINT32_(value) << DBGU_CR_RXDIS_Pos)) /* Assignment of value for RXDIS in the DBGU_CR register */
...
#define DBGU_CR_TXEN(value)                   (DBGU_CR_TXEN_Msk & (_UINT32_(value) << DBGU_CR_TXEN_Pos)) /* Assignment of value for TXEN in the DBGU_CR register */
...
#define DBGU_CR_TXDIS(value)                  (DBGU_CR_TXDIS_Msk & (_UINT32_(value) << DBGU_CR_TXDIS_Pos)) /* Assignment of value for TXDIS in the DBGU_CR register */
...
#define DBGU_CR_RSTSTA(value)                 (DBGU_CR_RSTSTA_Msk & (_UINT32_(value) << DBGU_CR_RSTSTA_Pos)) /* Assignment of value for RSTSTA in the DBGU_CR register */
...
#define DBGU_CR_RETTO(value)                  (DBGU_CR_RETTO_Msk & (_UINT32_(value) << DBGU_CR_RETTO_Pos)) /* Assignment of value for RETTO in the DBGU_CR register */
...
#define DBGU_CR_STTTO(value)                  (DBGU_CR_STTTO_Msk & (_UINT32_(value) << DBGU_CR_STTTO_Pos)) /* Assignment of value for STTTO in the DBGU_CR register */
...
#define DBGU_MR_FILTER(value)                 (DBGU_MR_FILTER_Msk & (_UINT32_(value) << DBGU_MR_FILTER_Pos)) /* Assignment of value for FILTER in the DBGU_MR register */
...
#define DBGU_MR_PAR(value)                    (DBGU_MR_PAR_Msk & (_UINT32_(value) << DBGU_MR_PAR_Pos)) /* Assignment of value for PAR in the DBGU_MR register */
...
#define DBGU_MR_BRSRCCK(value)                (DBGU_MR_BRSRCCK_Msk & (_UINT32_(value) << DBGU_MR_BRSRCCK_Pos)) /* Assignment of value for BRSRCCK in the DBGU_MR register */
...
#define DBGU_MR_CHMODE(value)                 (DBGU_MR_CHMODE_Msk & (_UINT32_(value) << DBGU_MR_CHMODE_Pos)) /* Assignment of value for CHMODE in the DBGU_MR register */
...
#define DBGU_IER_RXRDY(value)                 (DBGU_IER_RXRDY_Msk & (_UINT32_(value) << DBGU_IER_RXRDY_Pos)) /* Assignment of value for RXRDY in the DBGU_IER register */
...
#define DBGU_IER_TXRDY(value)                 (DBGU_IER_TXRDY_Msk & (_UINT32_(value) << DBGU_IER_TXRDY_Pos)) /* Assignment of value for TXRDY in the DBGU_IER register */
...
#define DBGU_IER_OVRE(value)                  (DBGU_IER_OVRE_Msk & (_UINT32_(value) << DBGU_IER_OVRE_Pos)) /* Assignment of value for OVRE in the DBGU_IER register */
...
#define DBGU_IER_FRAME(value)                 (DBGU_IER_FRAME_Msk & (_UINT32_(value) << DBGU_IER_FRAME_Pos)) /* Assignment of value for FRAME in the DBGU_IER register */
...
#define DBGU_IER_PARE(value)                  (DBGU_IER_PARE_Msk & (_UINT32_(value) << DBGU_IER_PARE_Pos)) /* Assignment of value for PARE in the DBGU_IER register */
...
#define DBGU_IER_TIMEOUT(value)               (DBGU_IER_TIMEOUT_Msk & (_UINT32_(value) << DBGU_IER_TIMEOUT_Pos)) /* Assignment of value for TIMEOUT in the DBGU_IER register */
...
#define DBGU_IER_TXEMPTY(value)               (DBGU_IER_TXEMPTY_Msk & (_UINT32_(value) << DBGU_IER_TXEMPTY_Pos)) /* Assignment of value for TXEMPTY in the DBGU_IER register */
...
#define DBGU_IER_COMMTX(value)                (DBGU_IER_COMMTX_Msk & (_UINT32_(value) << DBGU_IER_COMMTX_Pos)) /* Assignment of value for COMMTX in the DBGU_IER register */
...
#define DBGU_IER_COMMRX(value)                (DBGU_IER_COMMRX_Msk & (_UINT32_(value) << DBGU_IER_COMMRX_Pos)) /* Assignment of value for COMMRX in the DBGU_IER register */
...
#define DBGU_IDR_RXRDY(value)                 (DBGU_IDR_RXRDY_Msk & (_UINT32_(value) << DBGU_IDR_RXRDY_Pos)) /* Assignment of value for RXRDY in the DBGU_IDR register */
...
#define DBGU_IDR_TXRDY(value)                 (DBGU_IDR_TXRDY_Msk & (_UINT32_(value) << DBGU_IDR_TXRDY_Pos)) /* Assignment of value for TXRDY in the DBGU_IDR register */
...
#define DBGU_IDR_OVRE(value)                  (DBGU_IDR_OVRE_Msk & (_UINT32_(value) << DBGU_IDR_OVRE_Pos)) /* Assignment of value for OVRE in the DBGU_IDR register */
...
#define DBGU_IDR_FRAME(value)                 (DBGU_IDR_FRAME_Msk & (_UINT32_(value) << DBGU_IDR_FRAME_Pos)) /* Assignment of value for FRAME in the DBGU_IDR register */
...
#define DBGU_IDR_PARE(value)                  (DBGU_IDR_PARE_Msk & (_UINT32_(value) << DBGU_IDR_PARE_Pos)) /* Assignment of value for PARE in the DBGU_IDR register */
...
#define DBGU_IDR_TIMEOUT(value)               (DBGU_IDR_TIMEOUT_Msk & (_UINT32_(value) << DBGU_IDR_TIMEOUT_Pos)) /* Assignment of value for TIMEOUT in the DBGU_IDR register */
...
#define DBGU_IDR_TXEMPTY(value)               (DBGU_IDR_TXEMPTY_Msk & (_UINT32_(value) << DBGU_IDR_TXEMPTY_Pos)) /* Assignment of value for TXEMPTY in the DBGU_IDR register */
...
#define DBGU_IDR_COMMTX(value)                (DBGU_IDR_COMMTX_Msk & (_UINT32_(value) << DBGU_IDR_COMMTX_Pos)) /* Assignment of value for COMMTX in the DBGU_IDR register */
...
#define DBGU_IDR_COMMRX(value)                (DBGU_IDR_COMMRX_Msk & (_UINT32_(value) << DBGU_IDR_COMMRX_Pos)) /* Assignment of value for COMMRX in the DBGU_IDR register */
...
#define DBGU_IMR_RXRDY(value)                 (DBGU_IMR_RXRDY_Msk & (_UINT32_(value) << DBGU_IMR_RXRDY_Pos)) /* Assignment of value for RXRDY in the DBGU_IMR register */
...
#define DBGU_IMR_TXRDY(value)                 (DBGU_IMR_TXRDY_Msk & (_UINT32_(value) << DBGU_IMR_TXRDY_Pos)) /* Assignment of value for TXRDY in the DBGU_IMR register */
...
#define DBGU_IMR_OVRE(value)                  (DBGU_IMR_OVRE_Msk & (_UINT32_(value) << DBGU_IMR_OVRE_Pos)) /* Assignment of value for OVRE in the DBGU_IMR register */
...
#define DBGU_IMR_FRAME(value)                 (DBGU_IMR_FRAME_Msk & (_UINT32_(value) << DBGU_IMR_FRAME_Pos)) /* Assignment of value for FRAME in the DBGU_IMR register */
...
#define DBGU_IMR_PARE(value)                  (DBGU_IMR_PARE_Msk & (_UINT32_(value) << DBGU_IMR_PARE_Pos)) /* Assignment of value for PARE in the DBGU_IMR register */
...
#define DBGU_IMR_TIMEOUT(value)               (DBGU_IMR_TIMEOUT_Msk & (_UINT32_(value) << DBGU_IMR_TIMEOUT_Pos)) /* Assignment of value for TIMEOUT in the DBGU_IMR register */
...
#define DBGU_IMR_TXEMPTY(value)               (DBGU_IMR_TXEMPTY_Msk & (_UINT32_(value) << DBGU_IMR_TXEMPTY_Pos)) /* Assignment of value for TXEMPTY in the DBGU_IMR register */
...
#define DBGU_IMR_COMMTX(value)                (DBGU_IMR_COMMTX_Msk & (_UINT32_(value) << DBGU_IMR_COMMTX_Pos)) /* Assignment of value for COMMTX in the DBGU_IMR register */
...
#define DBGU_IMR_COMMRX(value)                (DBGU_IMR_COMMRX_Msk & (_UINT32_(value) << DBGU_IMR_COMMRX_Pos)) /* Assignment of value for COMMRX in the DBGU_IMR register */
...
#define DBGU_SR_RXRDY(value)                  (DBGU_SR_RXRDY_Msk & (_UINT32_(value) << DBGU_SR_RXRDY_Pos)) /* Assignment of value for RXRDY in the DBGU_SR register */
...
#define DBGU_SR_TXRDY(value)                  (DBGU_SR_TXRDY_Msk & (_UINT32_(value) << DBGU_SR_TXRDY_Pos)) /* Assignment of value for TXRDY in the DBGU_SR register */
...
#define DBGU_SR_OVRE(value)                   (DBGU_SR_OVRE_Msk & (_UINT32_(value) << DBGU_SR_OVRE_Pos)) /* Assignment of value for OVRE in the DBGU_SR register */
...
#define DBGU_SR_FRAME(value)                  (DBGU_SR_FRAME_Msk & (_UINT32_(value) << DBGU_SR_FRAME_Pos)) /* Assignment of value for FRAME in the DBGU_SR register */
...
#define DBGU_SR_PARE(value)                   (DBGU_SR_PARE_Msk & (_UINT32_(value) << DBGU_SR_PARE_Pos)) /* Assignment of value for PARE in the DBGU_SR register */
...
#define DBGU_SR_TIMEOUT(value)                (DBGU_SR_TIMEOUT_Msk & (_UINT32_(value) << DBGU_SR_TIMEOUT_Pos)) /* Assignment of value for TIMEOUT in the DBGU_SR register */
...
#define DBGU_SR_TXEMPTY(value)                (DBGU_SR_TXEMPTY_Msk & (_UINT32_(value) << DBGU_SR_TXEMPTY_Pos)) /* Assignment of value for TXEMPTY in the DBGU_SR register */
...
#define DBGU_SR_COMMTX(value)                 (DBGU_SR_COMMTX_Msk & (_UINT32_(value) << DBGU_SR_COMMTX_Pos)) /* Assignment of value for COMMTX in the DBGU_SR register */
...
#define DBGU_SR_COMMRX(value)                 (DBGU_SR_COMMRX_Msk & (_UINT32_(value) << DBGU_SR_COMMRX_Pos)) /* Assignment of value for COMMRX in the DBGU_SR register */
...
#define DBGU_RHR_RXCHR(value)                 (DBGU_RHR_RXCHR_Msk & (_UINT32_(value) << DBGU_RHR_RXCHR_Pos)) /* Assignment of value for RXCHR in the DBGU_RHR register */
...
#define DBGU_THR_TXCHR(value)                 (DBGU_THR_TXCHR_Msk & (_UINT32_(value) << DBGU_THR_TXCHR_Pos)) /* Assignment of value for TXCHR in the DBGU_THR register */
...
#define DBGU_BRGR_CD(value)                   (DBGU_BRGR_CD_Msk & (_UINT32_(value) << DBGU_BRGR_CD_Pos)) /* Assignment of value for CD in the DBGU_BRGR register */
...
#define DBGU_RTOR_TO(value)                   (DBGU_RTOR_TO_Msk & (_UINT32_(value) << DBGU_RTOR_TO_Pos)) /* Assignment of value for TO in the DBGU_RTOR register */
...
#define DBGU_CIDR_CHID(value)                 (DBGU_CIDR_CHID_Msk & (_UINT32_(value) << DBGU_CIDR_CHID_Pos)) /* Assignment of value for CHID in the DBGU_CIDR register */
...
#define DBGU_CIDR_EXT(value)                  (DBGU_CIDR_EXT_Msk & (_UINT32_(value) << DBGU_CIDR_EXT_Pos)) /* Assignment of value for EXT in the DBGU_CIDR register */
...
#define DBGU_EXID_EXID(value)                 (DBGU_EXID_EXID_Msk & (_UINT32_(value) << DBGU_EXID_EXID_Pos)) /* Assignment of value for EXID in the DBGU_EXID register */
...
#define DBGU_FNR_FNTRST(value)                (DBGU_FNR_FNTRST_Msk & (_UINT32_(value) << DBGU_FNR_FNTRST_Pos)) /* Assignment of value for FNTRST in the DBGU_FNR register */
...
#define DBGU_WPMR_WPEN(value)                 (DBGU_WPMR_WPEN_Msk & (_UINT32_(value) << DBGU_WPMR_WPEN_Pos)) /* Assignment of value for WPEN in the DBGU_WPMR register */
...
#define DBGU_WPMR_WPKEY(value)                (DBGU_WPMR_WPKEY_Msk & (_UINT32_(value) << DBGU_WPMR_WPKEY_Pos)) /* Assignment of value for WPKEY in the DBGU_WPMR register */
...
/* DBGU register offsets definitions */
