...
#define DSI_PWR_UP_SHUTDOWNZ(value)           (DSI_PWR_UP_SHUTDOWNZ_Msk & (_UINT32_(value) << DSI_PWR_UP_SHUTDOWNZ_Pos)) /* Assignment of value for SHUTDOWNZ in the DSI_PWR_UP register */
...
#define DSI_CLKMGR_CFG_TX_ESC_CLK_DIVISION(value) (DSI_CLKMGR_CFG_TX_ESC_CLK_DIVISION_Msk & (_UINT32_(value) << DSI_CLKMGR_CFG_TX_ESC_CLK_DIVISION_Pos)) /* Assignment of value for TX_ESC_CLK_DIVISION in the DSI_CLKMGR_CFG register */
...
#define DSI_CLKMGR_CFG_TO_CLK_DIVISION(value) (DSI_CLKMGR_CFG_TO_CLK_DIVISION_Msk & (_UINT32_(value) << DSI_CLKMGR_CFG_TO_CLK_DIVISION_Pos)) /* Assignment of value for TO_CLK_DIVISION in the DSI_CLKMGR_CFG register */
...
#define DSI_DPI_VCID_DPI_VCID(value)          (DSI_DPI_VCID_DPI_VCID_Msk & (_UINT32_(value) << DSI_DPI_VCID_DPI_VCID_Pos)) /* Assignment of value for DPI_VCID in the DSI_DPI_VCID register */
...
#define DSI_DPI_COLOR_CODING_DPI_COLOR_CODING(value) (DSI_DPI_COLOR_CODING_DPI_COLOR_CODING_Msk & (_UINT32_(value) << DSI_DPI_COLOR_CODING_DPI_COLOR_CODING_Pos)) /* Assignment of value for DPI_COLOR_CODING in the DSI_DPI_COLOR_CODING register */
...
#define DSI_DPI_CFG_POL_DATAEN_ACTIVE_LOW(value) (DSI_DPI_CFG_POL_DATAEN_ACTIVE_LOW_Msk & (_UINT32_(value) << DSI_DPI_CFG_POL_DATAEN_ACTIVE_LOW_Pos)) /* Assignment of value for DATAEN_ACTIVE_LOW in the DSI_DPI_CFG_POL register */
...
#define DSI_DPI_CFG_POL_VSYNC_ACTIVE_LOW(value) (DSI_DPI_CFG_POL_VSYNC_ACTIVE_LOW_Msk & (_UINT32_(value) << DSI_DPI_CFG_POL_VSYNC_ACTIVE_LOW_Pos)) /* Assignment of value for VSYNC_ACTIVE_LOW in the DSI_DPI_CFG_POL register */
...
#define DSI_DPI_CFG_POL_HSYNC_ACTIVE_LOW(value) (DSI_DPI_CFG_POL_HSYNC_ACTIVE_LOW_Msk & (_UINT32_(value) << DSI_DPI_CFG_POL_HSYNC_ACTIVE_LOW_Pos)) /* Assignment of value for HSYNC_ACTIVE_LOW in the DSI_DPI_CFG_POL register */
...
#define DSI_DPI_CFG_POL_SHUTD_ACTIVE_LOW(value) (DSI_DPI_CFG_POL_SHUTD_ACTIVE_LOW_Msk & (_UINT32_(value) << DSI_DPI_CFG_POL_SHUTD_ACTIVE_LOW_Pos)) /* Assignment of value for SHUTD_ACTIVE_LOW in the DSI_DPI_CFG_POL register */
...
#define DSI_DPI_CFG_POL_COLORM_ACTIVE_LOW(value) (DSI_DPI_CFG_POL_COLORM_ACTIVE_LOW_Msk & (_UINT32_(value) << DSI_DPI_CFG_POL_COLORM_ACTIVE_LOW_Pos)) /* Assignment of value for COLORM_ACTIVE_LOW in the DSI_DPI_CFG_POL register */
...
#define DSI_DPI_LP_CMD_TIM_INVACT_LPCMD_TIME(value) (DSI_DPI_LP_CMD_TIM_INVACT_LPCMD_TIME_Msk & (_UINT32_(value) << DSI_DPI_LP_CMD_TIM_INVACT_LPCMD_TIME_Pos)) /* Assignment of value for INVACT_LPCMD_TIME in the DSI_DPI_LP_CMD_TIM register */
...
#define DSI_DPI_LP_CMD_TIM_OUTVACT_LPCMD_TIME(value) (DSI_DPI_LP_CMD_TIM_OUTVACT_LPCMD_TIME_Msk & (_UINT32_(value) << DSI_DPI_LP_CMD_TIM_OUTVACT_LPCMD_TIME_Pos)) /* Assignment of value for OUTVACT_LPCMD_TIME in the DSI_DPI_LP_CMD_TIM register */
...
#define DSI_PCKHDL_CFG_EOTP_TX_EN(value)      (DSI_PCKHDL_CFG_EOTP_TX_EN_Msk & (_UINT32_(value) << DSI_PCKHDL_CFG_EOTP_TX_EN_Pos)) /* Assignment of value for EOTP_TX_EN in the DSI_PCKHDL_CFG register */
...
#define DSI_PCKHDL_CFG_EOTP_RX_EN(value)      (DSI_PCKHDL_CFG_EOTP_RX_EN_Msk & (_UINT32_(value) << DSI_PCKHDL_CFG_EOTP_RX_EN_Pos)) /* Assignment of value for EOTP_RX_EN in the DSI_PCKHDL_CFG register */
...
#define DSI_PCKHDL_CFG_BTA_EN(value)          (DSI_PCKHDL_CFG_BTA_EN_Msk & (_UINT32_(value) << DSI_PCKHDL_CFG_BTA_EN_Pos)) /* Assignment of value for BTA_EN in the DSI_PCKHDL_CFG register */
...
#define DSI_PCKHDL_CFG_ECC_RX_EN(value)       (DSI_PCKHDL_CFG_ECC_RX_EN_Msk & (_UINT32_(value) << DSI_PCKHDL_CFG_ECC_RX_EN_Pos)) /* Assignment of value for ECC_RX_EN in the DSI_PCKHDL_CFG register */
...
#define DSI_PCKHDL_CFG_CRC_RX_EN(value)       (DSI_PCKHDL_CFG_CRC_RX_EN_Msk & (_UINT32_(value) << DSI_PCKHDL_CFG_CRC_RX_EN_Pos)) /* Assignment of value for CRC_RX_EN in the DSI_PCKHDL_CFG register */
...
#define DSI_PCKHDL_CFG_EOTP_TX_LP_EN(value)   (DSI_PCKHDL_CFG_EOTP_TX_LP_EN_Msk & (_UINT32_(value) << DSI_PCKHDL_CFG_EOTP_TX_LP_EN_Pos)) /* Assignment of value for EOTP_TX_LP_EN in the DSI_PCKHDL_CFG register */
...
#define DSI_GEN_VCID_GEN_VCID_RX(value)       (DSI_GEN_VCID_GEN_VCID_RX_Msk & (_UINT32_(value) << DSI_GEN_VCID_GEN_VCID_RX_Pos)) /* Assignment of value for GEN_VCID_RX in the DSI_GEN_VCID register */
...
#define DSI_GEN_VCID_GEN_VCID_TEAR_AUTO(value) (DSI_GEN_VCID_GEN_VCID_TEAR_AUTO_Msk & (_UINT32_(value) << DSI_GEN_VCID_GEN_VCID_TEAR_AUTO_Pos)) /* Assignment of value for GEN_VCID_TEAR_AUTO in the DSI_GEN_VCID register */
...
#define DSI_GEN_VCID_GEN_VCID_TX_AUTO(value)  (DSI_GEN_VCID_GEN_VCID_TX_AUTO_Msk & (_UINT32_(value) << DSI_GEN_VCID_GEN_VCID_TX_AUTO_Pos)) /* Assignment of value for GEN_VCID_TX_AUTO in the DSI_GEN_VCID register */
...
#define DSI_MODE_CFG_CMD_VIDEO_MODE(value)    (DSI_MODE_CFG_CMD_VIDEO_MODE_Msk & (_UINT32_(value) << DSI_MODE_CFG_CMD_VIDEO_MODE_Pos)) /* Assignment of value for CMD_VIDEO_MODE in the DSI_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_VID_MODE_TYPE(value) (DSI_VID_MODE_CFG_VID_MODE_TYPE_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_VID_MODE_TYPE_Pos)) /* Assignment of value for VID_MODE_TYPE in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_LP_VSA_EN(value)     (DSI_VID_MODE_CFG_LP_VSA_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_LP_VSA_EN_Pos)) /* Assignment of value for LP_VSA_EN in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_LP_VBP_EN(value)     (DSI_VID_MODE_CFG_LP_VBP_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_LP_VBP_EN_Pos)) /* Assignment of value for LP_VBP_EN in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_LP_VFP_EN(value)     (DSI_VID_MODE_CFG_LP_VFP_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_LP_VFP_EN_Pos)) /* Assignment of value for LP_VFP_EN in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_LP_VACT_EN(value)    (DSI_VID_MODE_CFG_LP_VACT_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_LP_VACT_EN_Pos)) /* Assignment of value for LP_VACT_EN in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_LP_HBP_EN(value)     (DSI_VID_MODE_CFG_LP_HBP_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_LP_HBP_EN_Pos)) /* Assignment of value for LP_HBP_EN in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_LP_HFP_EN(value)     (DSI_VID_MODE_CFG_LP_HFP_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_LP_HFP_EN_Pos)) /* Assignment of value for LP_HFP_EN in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_FRAME_BTA_ACK_EN(value) (DSI_VID_MODE_CFG_FRAME_BTA_ACK_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_FRAME_BTA_ACK_EN_Pos)) /* Assignment of value for FRAME_BTA_ACK_EN in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_LP_CMD_EN(value)     (DSI_VID_MODE_CFG_LP_CMD_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_LP_CMD_EN_Pos)) /* Assignment of value for LP_CMD_EN in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_VPG_EN(value)        (DSI_VID_MODE_CFG_VPG_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_VPG_EN_Pos)) /* Assignment of value for VPG_EN in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_VPG_MODE(value)      (DSI_VID_MODE_CFG_VPG_MODE_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_VPG_MODE_Pos)) /* Assignment of value for VPG_MODE in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_MODE_CFG_VPG_ORIENTATION(value) (DSI_VID_MODE_CFG_VPG_ORIENTATION_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_VPG_ORIENTATION_Pos)) /* Assignment of value for VPG_ORIENTATION in the DSI_VID_MODE_CFG register */
...
#define DSI_VID_PKT_SIZE_VID_PKT_SIZE(value)  (DSI_VID_PKT_SIZE_VID_PKT_SIZE_Msk & (_UINT32_(value) << DSI_VID_PKT_SIZE_VID_PKT_SIZE_Pos)) /* Assignment of value for VID_PKT_SIZE in the DSI_VID_PKT_SIZE register */
...
#define DSI_VID_NUM_CHUNKS_VID_NUM_CHUNKS(value) (DSI_VID_NUM_CHUNKS_VID_NUM_CHUNKS_Msk & (_UINT32_(value) << DSI_VID_NUM_CHUNKS_VID_NUM_CHUNKS_Pos)) /* Assignment of value for VID_NUM_CHUNKS in the DSI_VID_NUM_CHUNKS register */
...
#define DSI_VID_NULL_SIZE_VID_NULL_SIZE(value) (DSI_VID_NULL_SIZE_VID_NULL_SIZE_Msk & (_UINT32_(value) << DSI_VID_NULL_SIZE_VID_NULL_SIZE_Pos)) /* Assignment of value for VID_NULL_SIZE in the DSI_VID_NULL_SIZE register */
...
#define DSI_VID_HSA_TIME_VID_HSA_TIME(value)  (DSI_VID_HSA_TIME_VID_HSA_TIME_Msk & (_UINT32_(value) << DSI_VID_HSA_TIME_VID_HSA_TIME_Pos)) /* Assignment of value for VID_HSA_TIME in the DSI_VID_HSA_TIME register */
...
#define DSI_VID_HBP_TIME_VID_HBP_TIME(value)  (DSI_VID_HBP_TIME_VID_HBP_TIME_Msk & (_UINT32_(value) << DSI_VID_HBP_TIME_VID_HBP_TIME_Pos)) /* Assignment of value for VID_HBP_TIME in the DSI_VID_HBP_TIME register */
...
#define DSI_VID_HLINE_TIME_VID_HLINE_TIME(value) (DSI_VID_HLINE_TIME_VID_HLINE_TIME_Msk & (_UINT32_(value) << DSI_VID_HLINE_TIME_VID_HLINE_TIME_Pos)) /* Assignment of value for VID_HLINE_TIME in the DSI_VID_HLINE_TIME register */
...
#define DSI_VID_VSA_LINES_VSA_LINES(value)    (DSI_VID_VSA_LINES_VSA_LINES_Msk & (_UINT32_(value) << DSI_VID_VSA_LINES_VSA_LINES_Pos)) /* Assignment of value for VSA_LINES in the DSI_VID_VSA_LINES register */
...
#define DSI_VID_VBP_LINES_VBP_LINES(value)    (DSI_VID_VBP_LINES_VBP_LINES_Msk & (_UINT32_(value) << DSI_VID_VBP_LINES_VBP_LINES_Pos)) /* Assignment of value for VBP_LINES in the DSI_VID_VBP_LINES register */
...
#define DSI_VID_VFP_LINES_VFP_LINES(value)    (DSI_VID_VFP_LINES_VFP_LINES_Msk & (_UINT32_(value) << DSI_VID_VFP_LINES_VFP_LINES_Pos)) /* Assignment of value for VFP_LINES in the DSI_VID_VFP_LINES register */
...
#define DSI_VID_VACTIVE_LINES_V_ACTIVE_LINES(value) (DSI_VID_VACTIVE_LINES_V_ACTIVE_LINES_Msk & (_UINT32_(value) << DSI_VID_VACTIVE_LINES_V_ACTIVE_LINES_Pos)) /* Assignment of value for V_ACTIVE_LINES in the DSI_VID_VACTIVE_LINES register */
...
#define DSI_CMD_MODE_CFG_TEAR_FX_EN(value)    (DSI_CMD_MODE_CFG_TEAR_FX_EN_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_TEAR_FX_EN_Pos)) /* Assignment of value for TEAR_FX_EN in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_ACK_RQST_EN(value)   (DSI_CMD_MODE_CFG_ACK_RQST_EN_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_ACK_RQST_EN_Pos)) /* Assignment of value for ACK_RQST_EN in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_GEN_SW_0P_TX(value)  (DSI_CMD_MODE_CFG_GEN_SW_0P_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_GEN_SW_0P_TX_Pos)) /* Assignment of value for GEN_SW_0P_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_GEN_SW_1P_TX(value)  (DSI_CMD_MODE_CFG_GEN_SW_1P_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_GEN_SW_1P_TX_Pos)) /* Assignment of value for GEN_SW_1P_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_GEN_SW_2P_TX(value)  (DSI_CMD_MODE_CFG_GEN_SW_2P_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_GEN_SW_2P_TX_Pos)) /* Assignment of value for GEN_SW_2P_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_GEN_SR_0P_TX(value)  (DSI_CMD_MODE_CFG_GEN_SR_0P_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_GEN_SR_0P_TX_Pos)) /* Assignment of value for GEN_SR_0P_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_GEN_SR_1P_TX(value)  (DSI_CMD_MODE_CFG_GEN_SR_1P_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_GEN_SR_1P_TX_Pos)) /* Assignment of value for GEN_SR_1P_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_GEN_SR_2P_TX(value)  (DSI_CMD_MODE_CFG_GEN_SR_2P_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_GEN_SR_2P_TX_Pos)) /* Assignment of value for GEN_SR_2P_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_GEN_LW_TX(value)     (DSI_CMD_MODE_CFG_GEN_LW_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_GEN_LW_TX_Pos)) /* Assignment of value for GEN_LW_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_DCS_SW_0P_TX(value)  (DSI_CMD_MODE_CFG_DCS_SW_0P_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_DCS_SW_0P_TX_Pos)) /* Assignment of value for DCS_SW_0P_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_DCS_SW_1P_TX(value)  (DSI_CMD_MODE_CFG_DCS_SW_1P_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_DCS_SW_1P_TX_Pos)) /* Assignment of value for DCS_SW_1P_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_DCS_SR_0P_TX(value)  (DSI_CMD_MODE_CFG_DCS_SR_0P_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_DCS_SR_0P_TX_Pos)) /* Assignment of value for DCS_SR_0P_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_DCS_LW_TX(value)     (DSI_CMD_MODE_CFG_DCS_LW_TX_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_DCS_LW_TX_Pos)) /* Assignment of value for DCS_LW_TX in the DSI_CMD_MODE_CFG register */
...
#define DSI_CMD_MODE_CFG_MAX_RD_PKT_SIZE(value) (DSI_CMD_MODE_CFG_MAX_RD_PKT_SIZE_Msk & (_UINT32_(value) << DSI_CMD_MODE_CFG_MAX_RD_PKT_SIZE_Pos)) /* Assignment of value for MAX_RD_PKT_SIZE in the DSI_CMD_MODE_CFG register */
...
#define DSI_GEN_HDR_GEN_DT(value)             (DSI_GEN_HDR_GEN_DT_Msk & (_UINT32_(value) << DSI_GEN_HDR_GEN_DT_Pos)) /* Assignment of value for GEN_DT in the DSI_GEN_HDR register */
...
#define DSI_GEN_HDR_GEN_VC(value)             (DSI_GEN_HDR_GEN_VC_Msk & (_UINT32_(value) << DSI_GEN_HDR_GEN_VC_Pos)) /* Assignment of value for GEN_VC in the DSI_GEN_HDR register */
...
#define DSI_GEN_HDR_GEN_WC_LSBYTE(value)      (DSI_GEN_HDR_GEN_WC_LSBYTE_Msk & (_UINT32_(value) << DSI_GEN_HDR_GEN_WC_LSBYTE_Pos)) /* Assignment of value for GEN_WC_LSBYTE in the DSI_GEN_HDR register */
...
#define DSI_GEN_HDR_GEN_WC_MSBYTE(value)      (DSI_GEN_HDR_GEN_WC_MSBYTE_Msk & (_UINT32_(value) << DSI_GEN_HDR_GEN_WC_MSBYTE_Pos)) /* Assignment of value for GEN_WC_MSBYTE in the DSI_GEN_HDR register */
...
#define DSI_GEN_PLD_DATA_GEN_PLD_B1(value)    (DSI_GEN_PLD_DATA_GEN_PLD_B1_Msk & (_UINT32_(value) << DSI_GEN_PLD_DATA_GEN_PLD_B1_Pos)) /* Assignment of value for GEN_PLD_B1 in the DSI_GEN_PLD_DATA register */
...
#define DSI_GEN_PLD_DATA_GEN_PLD_B2(value)    (DSI_GEN_PLD_DATA_GEN_PLD_B2_Msk & (_UINT32_(value) << DSI_GEN_PLD_DATA_GEN_PLD_B2_Pos)) /* Assignment of value for GEN_PLD_B2 in the DSI_GEN_PLD_DATA register */
...
#define DSI_GEN_PLD_DATA_GEN_PLD_B3(value)    (DSI_GEN_PLD_DATA_GEN_PLD_B3_Msk & (_UINT32_(value) << DSI_GEN_PLD_DATA_GEN_PLD_B3_Pos)) /* Assignment of value for GEN_PLD_B3 in the DSI_GEN_PLD_DATA register */
...
#define DSI_GEN_PLD_DATA_GEN_PLD_B4(value)    (DSI_GEN_PLD_DATA_GEN_PLD_B4_Msk & (_UINT32_(value) << DSI_GEN_PLD_DATA_GEN_PLD_B4_Pos)) /* Assignment of value for GEN_PLD_B4 in the DSI_GEN_PLD_DATA register */
...
#define DSI_CMD_PKT_STATUS_GEN_CMD_EMPTY(value) (DSI_CMD_PKT_STATUS_GEN_CMD_EMPTY_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_CMD_EMPTY_Pos)) /* Assignment of value for GEN_CMD_EMPTY in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_CMD_FULL(value) (DSI_CMD_PKT_STATUS_GEN_CMD_FULL_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_CMD_FULL_Pos)) /* Assignment of value for GEN_CMD_FULL in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_PLD_W_EMPTY(value) (DSI_CMD_PKT_STATUS_GEN_PLD_W_EMPTY_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_PLD_W_EMPTY_Pos)) /* Assignment of value for GEN_PLD_W_EMPTY in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_PLD_W_FULL(value) (DSI_CMD_PKT_STATUS_GEN_PLD_W_FULL_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_PLD_W_FULL_Pos)) /* Assignment of value for GEN_PLD_W_FULL in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_PLD_R_EMPTY(value) (DSI_CMD_PKT_STATUS_GEN_PLD_R_EMPTY_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_PLD_R_EMPTY_Pos)) /* Assignment of value for GEN_PLD_R_EMPTY in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_PLD_R_FULL(value) (DSI_CMD_PKT_STATUS_GEN_PLD_R_FULL_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_PLD_R_FULL_Pos)) /* Assignment of value for GEN_PLD_R_FULL in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_RD_CMD_BUSY(value) (DSI_CMD_PKT_STATUS_GEN_RD_CMD_BUSY_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_RD_CMD_BUSY_Pos)) /* Assignment of value for GEN_RD_CMD_BUSY in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_BUFF_CMD_EMPTY(value) (DSI_CMD_PKT_STATUS_GEN_BUFF_CMD_EMPTY_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_BUFF_CMD_EMPTY_Pos)) /* Assignment of value for GEN_BUFF_CMD_EMPTY in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_BUFF_CMD_FULL(value) (DSI_CMD_PKT_STATUS_GEN_BUFF_CMD_FULL_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_BUFF_CMD_FULL_Pos)) /* Assignment of value for GEN_BUFF_CMD_FULL in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_BUFF_PLD_EMPTY(value) (DSI_CMD_PKT_STATUS_GEN_BUFF_PLD_EMPTY_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_BUFF_PLD_EMPTY_Pos)) /* Assignment of value for GEN_BUFF_PLD_EMPTY in the DSI_CMD_PKT_STATUS register */
...
#define DSI_CMD_PKT_STATUS_GEN_BUFF_PLD_FULL(value) (DSI_CMD_PKT_STATUS_GEN_BUFF_PLD_FULL_Msk & (_UINT32_(value) << DSI_CMD_PKT_STATUS_GEN_BUFF_PLD_FULL_Pos)) /* Assignment of value for GEN_BUFF_PLD_FULL in the DSI_CMD_PKT_STATUS register */
...
#define DSI_TO_CNT_CFG_LPRX_TO_CNT(value)     (DSI_TO_CNT_CFG_LPRX_TO_CNT_Msk & (_UINT32_(value) << DSI_TO_CNT_CFG_LPRX_TO_CNT_Pos)) /* Assignment of value for LPRX_TO_CNT in the DSI_TO_CNT_CFG register */
...
#define DSI_TO_CNT_CFG_HSTX_TO_CNT(value)     (DSI_TO_CNT_CFG_HSTX_TO_CNT_Msk & (_UINT32_(value) << DSI_TO_CNT_CFG_HSTX_TO_CNT_Pos)) /* Assignment of value for HSTX_TO_CNT in the DSI_TO_CNT_CFG register */
...
#define DSI_HS_RD_TO_CNT_HS_RD_TO_CNT(value)  (DSI_HS_RD_TO_CNT_HS_RD_TO_CNT_Msk & (_UINT32_(value) << DSI_HS_RD_TO_CNT_HS_RD_TO_CNT_Pos)) /* Assignment of value for HS_RD_TO_CNT in the DSI_HS_RD_TO_CNT register */
...
#define DSI_LP_RD_TO_CNT_LP_RD_TO_CNT(value)  (DSI_LP_RD_TO_CNT_LP_RD_TO_CNT_Msk & (_UINT32_(value) << DSI_LP_RD_TO_CNT_LP_RD_TO_CNT_Pos)) /* Assignment of value for LP_RD_TO_CNT in the DSI_LP_RD_TO_CNT register */
...
#define DSI_HS_WR_TO_CNT_HS_WR_TO_CNT(value)  (DSI_HS_WR_TO_CNT_HS_WR_TO_CNT_Msk & (_UINT32_(value) << DSI_HS_WR_TO_CNT_HS_WR_TO_CNT_Pos)) /* Assignment of value for HS_WR_TO_CNT in the DSI_HS_WR_TO_CNT register */
...
#define DSI_LP_WR_TO_CNT_LP_WR_TO_CNT(value)  (DSI_LP_WR_TO_CNT_LP_WR_TO_CNT_Msk & (_UINT32_(value) << DSI_LP_WR_TO_CNT_LP_WR_TO_CNT_Pos)) /* Assignment of value for LP_WR_TO_CNT in the DSI_LP_WR_TO_CNT register */
...
#define DSI_BTA_TO_CNT_BTA_TO_CNT(value)      (DSI_BTA_TO_CNT_BTA_TO_CNT_Msk & (_UINT32_(value) << DSI_BTA_TO_CNT_BTA_TO_CNT_Pos)) /* Assignment of value for BTA_TO_CNT in the DSI_BTA_TO_CNT register */
...
#define DSI_SDF_3D_MODE_3D(value)             (DSI_SDF_3D_MODE_3D_Msk & (_UINT32_(value) << DSI_SDF_3D_MODE_3D_Pos)) /* Assignment of value for MODE_3D in the DSI_SDF_3D register */
...
#define DSI_SDF_3D_SECOND_VSYNC(value)        (DSI_SDF_3D_SECOND_VSYNC_Msk & (_UINT32_(value) << DSI_SDF_3D_SECOND_VSYNC_Pos)) /* Assignment of value for SECOND_VSYNC in the DSI_SDF_3D register */
...
#define DSI_SDF_3D_RIGHT_FIRST(value)         (DSI_SDF_3D_RIGHT_FIRST_Msk & (_UINT32_(value) << DSI_SDF_3D_RIGHT_FIRST_Pos)) /* Assignment of value for RIGHT_FIRST in the DSI_SDF_3D register */
...
#define DSI_SDF_3D_SEND_3D_CFG(value)         (DSI_SDF_3D_SEND_3D_CFG_Msk & (_UINT32_(value) << DSI_SDF_3D_SEND_3D_CFG_Pos)) /* Assignment of value for SEND_3D_CFG in the DSI_SDF_3D register */
...
#define DSI_LPCLK_CTRL_PHY_TXREQUESTCLKHS(value) (DSI_LPCLK_CTRL_PHY_TXREQUESTCLKHS_Msk & (_UINT32_(value) << DSI_LPCLK_CTRL_PHY_TXREQUESTCLKHS_Pos)) /* Assignment of value for PHY_TXREQUESTCLKHS in the DSI_LPCLK_CTRL register */
...
#define DSI_LPCLK_CTRL_AUTO_CLKLANE_CTRL(value) (DSI_LPCLK_CTRL_AUTO_CLKLANE_CTRL_Msk & (_UINT32_(value) << DSI_LPCLK_CTRL_AUTO_CLKLANE_CTRL_Pos)) /* Assignment of value for AUTO_CLKLANE_CTRL in the DSI_LPCLK_CTRL register */
...
#define DSI_DPHY_TMR_LPCLK_CFG_PHY_CLKLP2HS_TIME(value) (DSI_DPHY_TMR_LPCLK_CFG_PHY_CLKLP2HS_TIME_Msk & (_UINT32_(value) << DSI_DPHY_TMR_LPCLK_CFG_PHY_CLKLP2HS_TIME_Pos)) /* Assignment of value for PHY_CLKLP2HS_TIME in the DSI_DPHY_TMR_LPCLK_CFG register */
...
#define DSI_DPHY_TMR_LPCLK_CFG_PHY_CLKHS2LP_TIME(value) (DSI_DPHY_TMR_LPCLK_CFG_PHY_CLKHS2LP_TIME_Msk & (_UINT32_(value) << DSI_DPHY_TMR_LPCLK_CFG_PHY_CLKHS2LP_TIME_Pos)) /* Assignment of value for PHY_CLKHS2LP_TIME in the DSI_DPHY_TMR_LPCLK_CFG register */
...
#define DSI_DPHY_TMR_CFG_PHY_LP2HS_TIME(value) (DSI_DPHY_TMR_CFG_PHY_LP2HS_TIME_Msk & (_UINT32_(value) << DSI_DPHY_TMR_CFG_PHY_LP2HS_TIME_Pos)) /* Assignment of value for PHY_LP2HS_TIME in the DSI_DPHY_TMR_CFG register */
...
#define DSI_DPHY_TMR_CFG_PHY_HS2LP_TIME(value) (DSI_DPHY_TMR_CFG_PHY_HS2LP_TIME_Msk & (_UINT32_(value) << DSI_DPHY_TMR_CFG_PHY_HS2LP_TIME_Pos)) /* Assignment of value for PHY_HS2LP_TIME in the DSI_DPHY_TMR_CFG register */
...
#define DSI_DPHY_RSTZ_DPHY_SHUTDOWNZ(value)   (DSI_DPHY_RSTZ_DPHY_SHUTDOWNZ_Msk & (_UINT32_(value) << DSI_DPHY_RSTZ_DPHY_SHUTDOWNZ_Pos)) /* Assignment of value for DPHY_SHUTDOWNZ in the DSI_DPHY_RSTZ register */
...
#define DSI_DPHY_RSTZ_DPHY_RSTZ(value)        (DSI_DPHY_RSTZ_DPHY_RSTZ_Msk & (_UINT32_(value) << DSI_DPHY_RSTZ_DPHY_RSTZ_Pos)) /* Assignment of value for DPHY_RSTZ in the DSI_DPHY_RSTZ register */
...
#define DSI_DPHY_RSTZ_DPHY_ENABLECLK(value)   (DSI_DPHY_RSTZ_DPHY_ENABLECLK_Msk & (_UINT32_(value) << DSI_DPHY_RSTZ_DPHY_ENABLECLK_Pos)) /* Assignment of value for DPHY_ENABLECLK in the DSI_DPHY_RSTZ register */
...
#define DSI_DPHY_RSTZ_DPHY_FORCEPLL(value)    (DSI_DPHY_RSTZ_DPHY_FORCEPLL_Msk & (_UINT32_(value) << DSI_DPHY_RSTZ_DPHY_FORCEPLL_Pos)) /* Assignment of value for DPHY_FORCEPLL in the DSI_DPHY_RSTZ register */
...
#define DSI_DPHY_IF_CFG_N_LANES(value)        (DSI_DPHY_IF_CFG_N_LANES_Msk & (_UINT32_(value) << DSI_DPHY_IF_CFG_N_LANES_Pos)) /* Assignment of value for N_LANES in the DSI_DPHY_IF_CFG register */
...
#define DSI_DPHY_IF_CFG_PHY_STOP_WAIT_TIME(value) (DSI_DPHY_IF_CFG_PHY_STOP_WAIT_TIME_Msk & (_UINT32_(value) << DSI_DPHY_IF_CFG_PHY_STOP_WAIT_TIME_Pos)) /* Assignment of value for PHY_STOP_WAIT_TIME in the DSI_DPHY_IF_CFG register */
...
#define DSI_DPHY_ULPS_CTRL_PHY_TXREQULPSCLK(value) (DSI_DPHY_ULPS_CTRL_PHY_TXREQULPSCLK_Msk & (_UINT32_(value) << DSI_DPHY_ULPS_CTRL_PHY_TXREQULPSCLK_Pos)) /* Assignment of value for PHY_TXREQULPSCLK in the DSI_DPHY_ULPS_CTRL register */
...
#define DSI_DPHY_ULPS_CTRL_PHY_TXEXITULPSCLK(value) (DSI_DPHY_ULPS_CTRL_PHY_TXEXITULPSCLK_Msk & (_UINT32_(value) << DSI_DPHY_ULPS_CTRL_PHY_TXEXITULPSCLK_Pos)) /* Assignment of value for PHY_TXEXITULPSCLK in the DSI_DPHY_ULPS_CTRL register */
...
#define DSI_DPHY_ULPS_CTRL_PHY_TXREQULPSLAN(value) (DSI_DPHY_ULPS_CTRL_PHY_TXREQULPSLAN_Msk & (_UINT32_(value) << DSI_DPHY_ULPS_CTRL_PHY_TXREQULPSLAN_Pos)) /* Assignment of value for PHY_TXREQULPSLAN in the DSI_DPHY_ULPS_CTRL register */
...
#define DSI_DPHY_ULPS_CTRL_PHY_TXEXITULPSLAN(value) (DSI_DPHY_ULPS_CTRL_PHY_TXEXITULPSLAN_Msk & (_UINT32_(value) << DSI_DPHY_ULPS_CTRL_PHY_TXEXITULPSLAN_Pos)) /* Assignment of value for PHY_TXEXITULPSLAN in the DSI_DPHY_ULPS_CTRL register */
...
#define DSI_DPHY_TX_TRIGGERS_PHY_TX_TRIGGERS(value) (DSI_DPHY_TX_TRIGGERS_PHY_TX_TRIGGERS_Msk & (_UINT32_(value) << DSI_DPHY_TX_TRIGGERS_PHY_TX_TRIGGERS_Pos)) /* Assignment of value for PHY_TX_TRIGGERS in the DSI_DPHY_TX_TRIGGERS register */
...
#define DSI_DPHY_STATUS_PHY_LOCK(value)       (DSI_DPHY_STATUS_PHY_LOCK_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_LOCK_Pos)) /* Assignment of value for PHY_LOCK in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_DIRECTION(value)  (DSI_DPHY_STATUS_PHY_DIRECTION_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_DIRECTION_Pos)) /* Assignment of value for PHY_DIRECTION in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_STOPSTATECLKLANE(value) (DSI_DPHY_STATUS_PHY_STOPSTATECLKLANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_STOPSTATECLKLANE_Pos)) /* Assignment of value for PHY_STOPSTATECLKLANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_ULPSACTIVENOTCLK(value) (DSI_DPHY_STATUS_PHY_ULPSACTIVENOTCLK_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_ULPSACTIVENOTCLK_Pos)) /* Assignment of value for PHY_ULPSACTIVENOTCLK in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_STOPSTATE0LANE(value) (DSI_DPHY_STATUS_PHY_STOPSTATE0LANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_STOPSTATE0LANE_Pos)) /* Assignment of value for PHY_STOPSTATE0LANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_ULPSACTIVENOT0LANE(value) (DSI_DPHY_STATUS_PHY_ULPSACTIVENOT0LANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_ULPSACTIVENOT0LANE_Pos)) /* Assignment of value for PHY_ULPSACTIVENOT0LANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_RXULPSESC0LANE(value) (DSI_DPHY_STATUS_PHY_RXULPSESC0LANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_RXULPSESC0LANE_Pos)) /* Assignment of value for PHY_RXULPSESC0LANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_STOPSTATE1LANE(value) (DSI_DPHY_STATUS_PHY_STOPSTATE1LANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_STOPSTATE1LANE_Pos)) /* Assignment of value for PHY_STOPSTATE1LANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_ULPSACTIVENOT1LANE(value) (DSI_DPHY_STATUS_PHY_ULPSACTIVENOT1LANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_ULPSACTIVENOT1LANE_Pos)) /* Assignment of value for PHY_ULPSACTIVENOT1LANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_STOPSTATE2LANE(value) (DSI_DPHY_STATUS_PHY_STOPSTATE2LANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_STOPSTATE2LANE_Pos)) /* Assignment of value for PHY_STOPSTATE2LANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_ULPSACTIVENOT2LANE(value) (DSI_DPHY_STATUS_PHY_ULPSACTIVENOT2LANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_ULPSACTIVENOT2LANE_Pos)) /* Assignment of value for PHY_ULPSACTIVENOT2LANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_STOPSTATE3LANE(value) (DSI_DPHY_STATUS_PHY_STOPSTATE3LANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_STOPSTATE3LANE_Pos)) /* Assignment of value for PHY_STOPSTATE3LANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_STATUS_PHY_ULPSACTIVENOT3LANE(value) (DSI_DPHY_STATUS_PHY_ULPSACTIVENOT3LANE_Msk & (_UINT32_(value) << DSI_DPHY_STATUS_PHY_ULPSACTIVENOT3LANE_Pos)) /* Assignment of value for PHY_ULPSACTIVENOT3LANE in the DSI_DPHY_STATUS register */
...
#define DSI_DPHY_TST_CTRL0_PHY_TESTCLR(value) (DSI_DPHY_TST_CTRL0_PHY_TESTCLR_Msk & (_UINT32_(value) << DSI_DPHY_TST_CTRL0_PHY_TESTCLR_Pos)) /* Assignment of value for PHY_TESTCLR in the DSI_DPHY_TST_CTRL0 register */
...
#define DSI_DPHY_TST_CTRL0_PHY_TESTCLK(value) (DSI_DPHY_TST_CTRL0_PHY_TESTCLK_Msk & (_UINT32_(value) << DSI_DPHY_TST_CTRL0_PHY_TESTCLK_Pos)) /* Assignment of value for PHY_TESTCLK in the DSI_DPHY_TST_CTRL0 register */
...
#define DSI_DPHY_TST_CTRL1_PHY_TESTDIN(value) (DSI_DPHY_TST_CTRL1_PHY_TESTDIN_Msk & (_UINT32_(value) << DSI_DPHY_TST_CTRL1_PHY_TESTDIN_Pos)) /* Assignment of value for PHY_TESTDIN in the DSI_DPHY_TST_CTRL1 register */
...
#define DSI_DPHY_TST_CTRL1_PHY_TESTDOUT(value) (DSI_DPHY_TST_CTRL1_PHY_TESTDOUT_Msk & (_UINT32_(value) << DSI_DPHY_TST_CTRL1_PHY_TESTDOUT_Pos)) /* Assignment of value for PHY_TESTDOUT in the DSI_DPHY_TST_CTRL1 register */
...
#define DSI_DPHY_TST_CTRL1_PHY_TESTEN(value)  (DSI_DPHY_TST_CTRL1_PHY_TESTEN_Msk & (_UINT32_(value) << DSI_DPHY_TST_CTRL1_PHY_TESTEN_Pos)) /* Assignment of value for PHY_TESTEN in the DSI_DPHY_TST_CTRL1 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_0(value)     (DSI_INT_ST0_ACK_WITH_ERR_0_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_0_Pos)) /* Assignment of value for ACK_WITH_ERR_0 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_1(value)     (DSI_INT_ST0_ACK_WITH_ERR_1_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_1_Pos)) /* Assignment of value for ACK_WITH_ERR_1 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_2(value)     (DSI_INT_ST0_ACK_WITH_ERR_2_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_2_Pos)) /* Assignment of value for ACK_WITH_ERR_2 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_3(value)     (DSI_INT_ST0_ACK_WITH_ERR_3_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_3_Pos)) /* Assignment of value for ACK_WITH_ERR_3 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_4(value)     (DSI_INT_ST0_ACK_WITH_ERR_4_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_4_Pos)) /* Assignment of value for ACK_WITH_ERR_4 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_5(value)     (DSI_INT_ST0_ACK_WITH_ERR_5_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_5_Pos)) /* Assignment of value for ACK_WITH_ERR_5 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_6(value)     (DSI_INT_ST0_ACK_WITH_ERR_6_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_6_Pos)) /* Assignment of value for ACK_WITH_ERR_6 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_7(value)     (DSI_INT_ST0_ACK_WITH_ERR_7_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_7_Pos)) /* Assignment of value for ACK_WITH_ERR_7 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_8(value)     (DSI_INT_ST0_ACK_WITH_ERR_8_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_8_Pos)) /* Assignment of value for ACK_WITH_ERR_8 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_9(value)     (DSI_INT_ST0_ACK_WITH_ERR_9_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_9_Pos)) /* Assignment of value for ACK_WITH_ERR_9 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_10(value)    (DSI_INT_ST0_ACK_WITH_ERR_10_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_10_Pos)) /* Assignment of value for ACK_WITH_ERR_10 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_11(value)    (DSI_INT_ST0_ACK_WITH_ERR_11_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_11_Pos)) /* Assignment of value for ACK_WITH_ERR_11 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_12(value)    (DSI_INT_ST0_ACK_WITH_ERR_12_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_12_Pos)) /* Assignment of value for ACK_WITH_ERR_12 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_13(value)    (DSI_INT_ST0_ACK_WITH_ERR_13_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_13_Pos)) /* Assignment of value for ACK_WITH_ERR_13 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_14(value)    (DSI_INT_ST0_ACK_WITH_ERR_14_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_14_Pos)) /* Assignment of value for ACK_WITH_ERR_14 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_ACK_WITH_ERR_15(value)    (DSI_INT_ST0_ACK_WITH_ERR_15_Msk & (_UINT32_(value) << DSI_INT_ST0_ACK_WITH_ERR_15_Pos)) /* Assignment of value for ACK_WITH_ERR_15 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_DPHY_ERRORS_0(value)      (DSI_INT_ST0_DPHY_ERRORS_0_Msk & (_UINT32_(value) << DSI_INT_ST0_DPHY_ERRORS_0_Pos)) /* Assignment of value for DPHY_ERRORS_0 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_DPHY_ERRORS_1(value)      (DSI_INT_ST0_DPHY_ERRORS_1_Msk & (_UINT32_(value) << DSI_INT_ST0_DPHY_ERRORS_1_Pos)) /* Assignment of value for DPHY_ERRORS_1 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_DPHY_ERRORS_2(value)      (DSI_INT_ST0_DPHY_ERRORS_2_Msk & (_UINT32_(value) << DSI_INT_ST0_DPHY_ERRORS_2_Pos)) /* Assignment of value for DPHY_ERRORS_2 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_DPHY_ERRORS_3(value)      (DSI_INT_ST0_DPHY_ERRORS_3_Msk & (_UINT32_(value) << DSI_INT_ST0_DPHY_ERRORS_3_Pos)) /* Assignment of value for DPHY_ERRORS_3 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST0_DPHY_ERRORS_4(value)      (DSI_INT_ST0_DPHY_ERRORS_4_Msk & (_UINT32_(value) << DSI_INT_ST0_DPHY_ERRORS_4_Pos)) /* Assignment of value for DPHY_ERRORS_4 in the DSI_INT_ST0 register */
...
#define DSI_INT_ST1_TO_HS_TX(value)           (DSI_INT_ST1_TO_HS_TX_Msk & (_UINT32_(value) << DSI_INT_ST1_TO_HS_TX_Pos)) /* Assignment of value for TO_HS_TX in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_TO_LP_RX(value)           (DSI_INT_ST1_TO_LP_RX_Msk & (_UINT32_(value) << DSI_INT_ST1_TO_LP_RX_Pos)) /* Assignment of value for TO_LP_RX in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_ECC_SINGLE_ERR(value)     (DSI_INT_ST1_ECC_SINGLE_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_ECC_SINGLE_ERR_Pos)) /* Assignment of value for ECC_SINGLE_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_ECC_MULTI_ERR(value)      (DSI_INT_ST1_ECC_MULTI_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_ECC_MULTI_ERR_Pos)) /* Assignment of value for ECC_MULTI_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_CRC_ERR(value)            (DSI_INT_ST1_CRC_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_CRC_ERR_Pos)) /* Assignment of value for CRC_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_PKT_SIZE_ERR(value)       (DSI_INT_ST1_PKT_SIZE_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_PKT_SIZE_ERR_Pos)) /* Assignment of value for PKT_SIZE_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_EOTP_ERR(value)           (DSI_INT_ST1_EOTP_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_EOTP_ERR_Pos)) /* Assignment of value for EOTP_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_DPI_PLD_WR_ERR(value)     (DSI_INT_ST1_DPI_PLD_WR_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_DPI_PLD_WR_ERR_Pos)) /* Assignment of value for DPI_PLD_WR_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_GEN_CMD_WR_ERR(value)     (DSI_INT_ST1_GEN_CMD_WR_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_GEN_CMD_WR_ERR_Pos)) /* Assignment of value for GEN_CMD_WR_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_GEN_PLD_WR_ERR(value)     (DSI_INT_ST1_GEN_PLD_WR_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_GEN_PLD_WR_ERR_Pos)) /* Assignment of value for GEN_PLD_WR_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_GEN_PLD_SEND_ERR(value)   (DSI_INT_ST1_GEN_PLD_SEND_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_GEN_PLD_SEND_ERR_Pos)) /* Assignment of value for GEN_PLD_SEND_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_GEN_PLD_RD_ERR(value)     (DSI_INT_ST1_GEN_PLD_RD_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_GEN_PLD_RD_ERR_Pos)) /* Assignment of value for GEN_PLD_RD_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_GEN_PLD_RECEV_ERR(value)  (DSI_INT_ST1_GEN_PLD_RECEV_ERR_Msk & (_UINT32_(value) << DSI_INT_ST1_GEN_PLD_RECEV_ERR_Pos)) /* Assignment of value for GEN_PLD_RECEV_ERR in the DSI_INT_ST1 register */
...
#define DSI_INT_ST1_DPI_BUFF_PLD_UNDER(value) (DSI_INT_ST1_DPI_BUFF_PLD_UNDER_Msk & (_UINT32_(value) << DSI_INT_ST1_DPI_BUFF_PLD_UNDER_Pos)) /* Assignment of value for DPI_BUFF_PLD_UNDER in the DSI_INT_ST1 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_0(value)    (DSI_INT_MSK0_ACK_WITH_ERR_0_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_0_Pos)) /* Assignment of value for ACK_WITH_ERR_0 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_1(value)    (DSI_INT_MSK0_ACK_WITH_ERR_1_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_1_Pos)) /* Assignment of value for ACK_WITH_ERR_1 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_2(value)    (DSI_INT_MSK0_ACK_WITH_ERR_2_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_2_Pos)) /* Assignment of value for ACK_WITH_ERR_2 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_3(value)    (DSI_INT_MSK0_ACK_WITH_ERR_3_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_3_Pos)) /* Assignment of value for ACK_WITH_ERR_3 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_4(value)    (DSI_INT_MSK0_ACK_WITH_ERR_4_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_4_Pos)) /* Assignment of value for ACK_WITH_ERR_4 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_5(value)    (DSI_INT_MSK0_ACK_WITH_ERR_5_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_5_Pos)) /* Assignment of value for ACK_WITH_ERR_5 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_6(value)    (DSI_INT_MSK0_ACK_WITH_ERR_6_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_6_Pos)) /* Assignment of value for ACK_WITH_ERR_6 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_7(value)    (DSI_INT_MSK0_ACK_WITH_ERR_7_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_7_Pos)) /* Assignment of value for ACK_WITH_ERR_7 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_8(value)    (DSI_INT_MSK0_ACK_WITH_ERR_8_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_8_Pos)) /* Assignment of value for ACK_WITH_ERR_8 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_9(value)    (DSI_INT_MSK0_ACK_WITH_ERR_9_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_9_Pos)) /* Assignment of value for ACK_WITH_ERR_9 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_10(value)   (DSI_INT_MSK0_ACK_WITH_ERR_10_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_10_Pos)) /* Assignment of value for ACK_WITH_ERR_10 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_11(value)   (DSI_INT_MSK0_ACK_WITH_ERR_11_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_11_Pos)) /* Assignment of value for ACK_WITH_ERR_11 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_12(value)   (DSI_INT_MSK0_ACK_WITH_ERR_12_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_12_Pos)) /* Assignment of value for ACK_WITH_ERR_12 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_13(value)   (DSI_INT_MSK0_ACK_WITH_ERR_13_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_13_Pos)) /* Assignment of value for ACK_WITH_ERR_13 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_14(value)   (DSI_INT_MSK0_ACK_WITH_ERR_14_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_14_Pos)) /* Assignment of value for ACK_WITH_ERR_14 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_ACK_WITH_ERR_15(value)   (DSI_INT_MSK0_ACK_WITH_ERR_15_Msk & (_UINT32_(value) << DSI_INT_MSK0_ACK_WITH_ERR_15_Pos)) /* Assignment of value for ACK_WITH_ERR_15 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_DPHY_ERRORS_0(value)     (DSI_INT_MSK0_DPHY_ERRORS_0_Msk & (_UINT32_(value) << DSI_INT_MSK0_DPHY_ERRORS_0_Pos)) /* Assignment of value for DPHY_ERRORS_0 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_DPHY_ERRORS_1(value)     (DSI_INT_MSK0_DPHY_ERRORS_1_Msk & (_UINT32_(value) << DSI_INT_MSK0_DPHY_ERRORS_1_Pos)) /* Assignment of value for DPHY_ERRORS_1 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_DPHY_ERRORS_2(value)     (DSI_INT_MSK0_DPHY_ERRORS_2_Msk & (_UINT32_(value) << DSI_INT_MSK0_DPHY_ERRORS_2_Pos)) /* Assignment of value for DPHY_ERRORS_2 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_DPHY_ERRORS_3(value)     (DSI_INT_MSK0_DPHY_ERRORS_3_Msk & (_UINT32_(value) << DSI_INT_MSK0_DPHY_ERRORS_3_Pos)) /* Assignment of value for DPHY_ERRORS_3 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK0_DPHY_ERRORS_4(value)     (DSI_INT_MSK0_DPHY_ERRORS_4_Msk & (_UINT32_(value) << DSI_INT_MSK0_DPHY_ERRORS_4_Pos)) /* Assignment of value for DPHY_ERRORS_4 in the DSI_INT_MSK0 register */
...
#define DSI_INT_MSK1_TO_HS_TX(value)          (DSI_INT_MSK1_TO_HS_TX_Msk & (_UINT32_(value) << DSI_INT_MSK1_TO_HS_TX_Pos)) /* Assignment of value for TO_HS_TX in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_TO_LP_RX(value)          (DSI_INT_MSK1_TO_LP_RX_Msk & (_UINT32_(value) << DSI_INT_MSK1_TO_LP_RX_Pos)) /* Assignment of value for TO_LP_RX in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_ECC_SINGLE_ERR(value)    (DSI_INT_MSK1_ECC_SINGLE_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_ECC_SINGLE_ERR_Pos)) /* Assignment of value for ECC_SINGLE_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_ECC_MULTI_ERR(value)     (DSI_INT_MSK1_ECC_MULTI_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_ECC_MULTI_ERR_Pos)) /* Assignment of value for ECC_MULTI_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_CRC_ERR(value)           (DSI_INT_MSK1_CRC_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_CRC_ERR_Pos)) /* Assignment of value for CRC_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_PKT_SIZE_ERR(value)      (DSI_INT_MSK1_PKT_SIZE_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_PKT_SIZE_ERR_Pos)) /* Assignment of value for PKT_SIZE_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_EOTP_ERR(value)          (DSI_INT_MSK1_EOTP_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_EOTP_ERR_Pos)) /* Assignment of value for EOTP_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_DPI_PLD_WR_ERR(value)    (DSI_INT_MSK1_DPI_PLD_WR_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_DPI_PLD_WR_ERR_Pos)) /* Assignment of value for DPI_PLD_WR_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_GEN_CMD_WR_ERR(value)    (DSI_INT_MSK1_GEN_CMD_WR_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_GEN_CMD_WR_ERR_Pos)) /* Assignment of value for GEN_CMD_WR_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_GEN_PLD_WR_ERR(value)    (DSI_INT_MSK1_GEN_PLD_WR_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_GEN_PLD_WR_ERR_Pos)) /* Assignment of value for GEN_PLD_WR_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_GEN_PLD_SEND_ERR(value)  (DSI_INT_MSK1_GEN_PLD_SEND_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_GEN_PLD_SEND_ERR_Pos)) /* Assignment of value for GEN_PLD_SEND_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_GEN_PLD_RD_ERR(value)    (DSI_INT_MSK1_GEN_PLD_RD_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_GEN_PLD_RD_ERR_Pos)) /* Assignment of value for GEN_PLD_RD_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_GEN_PLD_RECEV_ERR(value) (DSI_INT_MSK1_GEN_PLD_RECEV_ERR_Msk & (_UINT32_(value) << DSI_INT_MSK1_GEN_PLD_RECEV_ERR_Pos)) /* Assignment of value for GEN_PLD_RECEV_ERR in the DSI_INT_MSK1 register */
...
#define DSI_INT_MSK1_DPI_BUFF_PLD_UNDER(value) (DSI_INT_MSK1_DPI_BUFF_PLD_UNDER_Msk & (_UINT32_(value) << DSI_INT_MSK1_DPI_BUFF_PLD_UNDER_Pos)) /* Assignment of value for DPI_BUFF_PLD_UNDER in the DSI_INT_MSK1 register */
...
#define DSI_DPHY_CAL_TXSKEWCALHS(value)       (DSI_DPHY_CAL_TXSKEWCALHS_Msk & (_UINT32_(value) << DSI_DPHY_CAL_TXSKEWCALHS_Pos)) /* Assignment of value for TXSKEWCALHS in the DSI_DPHY_CAL register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_0(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_0_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_0_Pos)) /* Assignment of value for ACK_WITH_ERR_0 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_1(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_1_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_1_Pos)) /* Assignment of value for ACK_WITH_ERR_1 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_2(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_2_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_2_Pos)) /* Assignment of value for ACK_WITH_ERR_2 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_3(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_3_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_3_Pos)) /* Assignment of value for ACK_WITH_ERR_3 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_4(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_4_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_4_Pos)) /* Assignment of value for ACK_WITH_ERR_4 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_5(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_5_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_5_Pos)) /* Assignment of value for ACK_WITH_ERR_5 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_6(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_6_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_6_Pos)) /* Assignment of value for ACK_WITH_ERR_6 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_7(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_7_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_7_Pos)) /* Assignment of value for ACK_WITH_ERR_7 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_8(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_8_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_8_Pos)) /* Assignment of value for ACK_WITH_ERR_8 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_9(value)  (DSI_INT_FORCE0_ACK_WITH_ERR_9_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_9_Pos)) /* Assignment of value for ACK_WITH_ERR_9 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_10(value) (DSI_INT_FORCE0_ACK_WITH_ERR_10_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_10_Pos)) /* Assignment of value for ACK_WITH_ERR_10 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_11(value) (DSI_INT_FORCE0_ACK_WITH_ERR_11_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_11_Pos)) /* Assignment of value for ACK_WITH_ERR_11 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_12(value) (DSI_INT_FORCE0_ACK_WITH_ERR_12_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_12_Pos)) /* Assignment of value for ACK_WITH_ERR_12 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_13(value) (DSI_INT_FORCE0_ACK_WITH_ERR_13_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_13_Pos)) /* Assignment of value for ACK_WITH_ERR_13 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_14(value) (DSI_INT_FORCE0_ACK_WITH_ERR_14_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_14_Pos)) /* Assignment of value for ACK_WITH_ERR_14 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_ACK_WITH_ERR_15(value) (DSI_INT_FORCE0_ACK_WITH_ERR_15_Msk & (_UINT32_(value) << DSI_INT_FORCE0_ACK_WITH_ERR_15_Pos)) /* Assignment of value for ACK_WITH_ERR_15 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_DPHY_ERRORS_0(value)   (DSI_INT_FORCE0_DPHY_ERRORS_0_Msk & (_UINT32_(value) << DSI_INT_FORCE0_DPHY_ERRORS_0_Pos)) /* Assignment of value for DPHY_ERRORS_0 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_DPHY_ERRORS_1(value)   (DSI_INT_FORCE0_DPHY_ERRORS_1_Msk & (_UINT32_(value) << DSI_INT_FORCE0_DPHY_ERRORS_1_Pos)) /* Assignment of value for DPHY_ERRORS_1 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_DPHY_ERRORS_2(value)   (DSI_INT_FORCE0_DPHY_ERRORS_2_Msk & (_UINT32_(value) << DSI_INT_FORCE0_DPHY_ERRORS_2_Pos)) /* Assignment of value for DPHY_ERRORS_2 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_DPHY_ERRORS_3(value)   (DSI_INT_FORCE0_DPHY_ERRORS_3_Msk & (_UINT32_(value) << DSI_INT_FORCE0_DPHY_ERRORS_3_Pos)) /* Assignment of value for DPHY_ERRORS_3 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE0_DPHY_ERRORS_4(value)   (DSI_INT_FORCE0_DPHY_ERRORS_4_Msk & (_UINT32_(value) << DSI_INT_FORCE0_DPHY_ERRORS_4_Pos)) /* Assignment of value for DPHY_ERRORS_4 in the DSI_INT_FORCE0 register */
...
#define DSI_INT_FORCE1_TO_HS_TX(value)        (DSI_INT_FORCE1_TO_HS_TX_Msk & (_UINT32_(value) << DSI_INT_FORCE1_TO_HS_TX_Pos)) /* Assignment of value for TO_HS_TX in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_TO_LP_RX(value)        (DSI_INT_FORCE1_TO_LP_RX_Msk & (_UINT32_(value) << DSI_INT_FORCE1_TO_LP_RX_Pos)) /* Assignment of value for TO_LP_RX in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_ECC_SINGLE_ERR(value)  (DSI_INT_FORCE1_ECC_SINGLE_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_ECC_SINGLE_ERR_Pos)) /* Assignment of value for ECC_SINGLE_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_ECC_MULTI_ERR(value)   (DSI_INT_FORCE1_ECC_MULTI_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_ECC_MULTI_ERR_Pos)) /* Assignment of value for ECC_MULTI_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_CRC_ERR(value)         (DSI_INT_FORCE1_CRC_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_CRC_ERR_Pos)) /* Assignment of value for CRC_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_PKT_SIZE_ERR(value)    (DSI_INT_FORCE1_PKT_SIZE_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_PKT_SIZE_ERR_Pos)) /* Assignment of value for PKT_SIZE_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_EOTP_ERR(value)        (DSI_INT_FORCE1_EOTP_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_EOTP_ERR_Pos)) /* Assignment of value for EOTP_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_DPI_PLD_WR_ERR(value)  (DSI_INT_FORCE1_DPI_PLD_WR_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_DPI_PLD_WR_ERR_Pos)) /* Assignment of value for DPI_PLD_WR_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_GEN_CMD_WR_ERR(value)  (DSI_INT_FORCE1_GEN_CMD_WR_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_GEN_CMD_WR_ERR_Pos)) /* Assignment of value for GEN_CMD_WR_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_GEN_PLD_WR_ERR(value)  (DSI_INT_FORCE1_GEN_PLD_WR_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_GEN_PLD_WR_ERR_Pos)) /* Assignment of value for GEN_PLD_WR_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_GEN_PLD_SEND_ERR(value) (DSI_INT_FORCE1_GEN_PLD_SEND_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_GEN_PLD_SEND_ERR_Pos)) /* Assignment of value for GEN_PLD_SEND_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_GEN_PLD_RD_ERR(value)  (DSI_INT_FORCE1_GEN_PLD_RD_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_GEN_PLD_RD_ERR_Pos)) /* Assignment of value for GEN_PLD_RD_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_GEN_PLD_RECEV_ERR(value) (DSI_INT_FORCE1_GEN_PLD_RECEV_ERR_Msk & (_UINT32_(value) << DSI_INT_FORCE1_GEN_PLD_RECEV_ERR_Pos)) /* Assignment of value for GEN_PLD_RECEV_ERR in the DSI_INT_FORCE1 register */
...
#define DSI_INT_FORCE1_DPI_BUFF_PLD_UNDER(value) (DSI_INT_FORCE1_DPI_BUFF_PLD_UNDER_Msk & (_UINT32_(value) << DSI_INT_FORCE1_DPI_BUFF_PLD_UNDER_Pos)) /* Assignment of value for DPI_BUFF_PLD_UNDER in the DSI_INT_FORCE1 register */
...
#define DSI_DPHY_TMR_RD_CFG_MAX_RD_TIME(value) (DSI_DPHY_TMR_RD_CFG_MAX_RD_TIME_Msk & (_UINT32_(value) << DSI_DPHY_TMR_RD_CFG_MAX_RD_TIME_Pos)) /* Assignment of value for MAX_RD_TIME in the DSI_DPHY_TMR_RD_CFG register */
...
#define DSI_VID_SHADOW_CTRL_VID_SHADOW_EN(value) (DSI_VID_SHADOW_CTRL_VID_SHADOW_EN_Msk & (_UINT32_(value) << DSI_VID_SHADOW_CTRL_VID_SHADOW_EN_Pos)) /* Assignment of value for VID_SHADOW_EN in the DSI_VID_SHADOW_CTRL register */
...
#define DSI_VID_SHADOW_CTRL_VID_SHADOW_REQ(value) (DSI_VID_SHADOW_CTRL_VID_SHADOW_REQ_Msk & (_UINT32_(value) << DSI_VID_SHADOW_CTRL_VID_SHADOW_REQ_Pos)) /* Assignment of value for VID_SHADOW_REQ in the DSI_VID_SHADOW_CTRL register */
...
#define DSI_DPI_VCID_ACT_DPI_VCID(value)      (DSI_DPI_VCID_ACT_DPI_VCID_Msk & (_UINT32_(value) << DSI_DPI_VCID_ACT_DPI_VCID_Pos)) /* Assignment of value for DPI_VCID in the DSI_DPI_VCID_ACT register */
...
#define DSI_DPI_COLOR_CODING_ACT_DPI_COLOR_CODING(value) (DSI_DPI_COLOR_CODING_ACT_DPI_COLOR_CODING_Msk & (_UINT32_(value) << DSI_DPI_COLOR_CODING_ACT_DPI_COLOR_CODING_Pos)) /* Assignment of value for DPI_COLOR_CODING in the DSI_DPI_COLOR_CODING_ACT register */
...
#define DSI_DPI_COLOR_CODING_ACT_LOOSELY18_EN(value) (DSI_DPI_COLOR_CODING_ACT_LOOSELY18_EN_Msk & (_UINT32_(value) << DSI_DPI_COLOR_CODING_ACT_LOOSELY18_EN_Pos)) /* Assignment of value for LOOSELY18_EN in the DSI_DPI_COLOR_CODING_ACT register */
...
#define DSI_DPI_LP_CMD_TIM_ACT_INVACT_LPCMD_TIME(value) (DSI_DPI_LP_CMD_TIM_ACT_INVACT_LPCMD_TIME_Msk & (_UINT32_(value) << DSI_DPI_LP_CMD_TIM_ACT_INVACT_LPCMD_TIME_Pos)) /* Assignment of value for INVACT_LPCMD_TIME in the DSI_DPI_LP_CMD_TIM_ACT register */
...
#define DSI_DPI_LP_CMD_TIM_ACT_OUTVACT_LPCMD_TIME(value) (DSI_DPI_LP_CMD_TIM_ACT_OUTVACT_LPCMD_TIME_Msk & (_UINT32_(value) << DSI_DPI_LP_CMD_TIM_ACT_OUTVACT_LPCMD_TIME_Pos)) /* Assignment of value for OUTVACT_LPCMD_TIME in the DSI_DPI_LP_CMD_TIM_ACT register */
...
#define DSI_VID_MODE_CFG_ACT_VID_MODE_TYPE(value) (DSI_VID_MODE_CFG_ACT_VID_MODE_TYPE_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_ACT_VID_MODE_TYPE_Pos)) /* Assignment of value for VID_MODE_TYPE in the DSI_VID_MODE_CFG_ACT register */
...
#define DSI_VID_MODE_CFG_ACT_LP_VSA_EN(value) (DSI_VID_MODE_CFG_ACT_LP_VSA_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_ACT_LP_VSA_EN_Pos)) /* Assignment of value for LP_VSA_EN in the DSI_VID_MODE_CFG_ACT register */
...
#define DSI_VID_MODE_CFG_ACT_LP_VBP_EN(value) (DSI_VID_MODE_CFG_ACT_LP_VBP_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_ACT_LP_VBP_EN_Pos)) /* Assignment of value for LP_VBP_EN in the DSI_VID_MODE_CFG_ACT register */
...
#define DSI_VID_MODE_CFG_ACT_LP_VFP_EN(value) (DSI_VID_MODE_CFG_ACT_LP_VFP_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_ACT_LP_VFP_EN_Pos)) /* Assignment of value for LP_VFP_EN in the DSI_VID_MODE_CFG_ACT register */
...
#define DSI_VID_MODE_CFG_ACT_LP_VACT_EN(value) (DSI_VID_MODE_CFG_ACT_LP_VACT_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_ACT_LP_VACT_EN_Pos)) /* Assignment of value for LP_VACT_EN in the DSI_VID_MODE_CFG_ACT register */
...
#define DSI_VID_MODE_CFG_ACT_LP_HBP_EN(value) (DSI_VID_MODE_CFG_ACT_LP_HBP_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_ACT_LP_HBP_EN_Pos)) /* Assignment of value for LP_HBP_EN in the DSI_VID_MODE_CFG_ACT register */
...
#define DSI_VID_MODE_CFG_ACT_LP_HFP_EN(value) (DSI_VID_MODE_CFG_ACT_LP_HFP_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_ACT_LP_HFP_EN_Pos)) /* Assignment of value for LP_HFP_EN in the DSI_VID_MODE_CFG_ACT register */
...
#define DSI_VID_MODE_CFG_ACT_FRAME_BTA_ACK_EN(value) (DSI_VID_MODE_CFG_ACT_FRAME_BTA_ACK_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_ACT_FRAME_BTA_ACK_EN_Pos)) /* Assignment of value for FRAME_BTA_ACK_EN in the DSI_VID_MODE_CFG_ACT register */
...
#define DSI_VID_MODE_CFG_ACT_LP_CMD_EN(value) (DSI_VID_MODE_CFG_ACT_LP_CMD_EN_Msk & (_UINT32_(value) << DSI_VID_MODE_CFG_ACT_LP_CMD_EN_Pos)) /* Assignment of value for LP_CMD_EN in the DSI_VID_MODE_CFG_ACT register */
...
#define DSI_VID_PKT_SIZE_ACT_VID_PKT_SIZE(value) (DSI_VID_PKT_SIZE_ACT_VID_PKT_SIZE_Msk & (_UINT32_(value) << DSI_VID_PKT_SIZE_ACT_VID_PKT_SIZE_Pos)) /* Assignment of value for VID_PKT_SIZE in the DSI_VID_PKT_SIZE_ACT register */
...
#define DSI_VID_NUM_CHUNKS_ACT_VID_NUM_CHUNKS(value) (DSI_VID_NUM_CHUNKS_ACT_VID_NUM_CHUNKS_Msk & (_UINT32_(value) << DSI_VID_NUM_CHUNKS_ACT_VID_NUM_CHUNKS_Pos)) /* Assignment of value for VID_NUM_CHUNKS in the DSI_VID_NUM_CHUNKS_ACT register */
...
#define DSI_VID_NULL_SIZE_ACT_VID_NULL_SIZE(value) (DSI_VID_NULL_SIZE_ACT_VID_NULL_SIZE_Msk & (_UINT32_(value) << DSI_VID_NULL_SIZE_ACT_VID_NULL_SIZE_Pos)) /* Assignment of value for VID_NULL_SIZE in the DSI_VID_NULL_SIZE_ACT register */
...
#define DSI_VID_HSA_TIME_ACT_VID_HSA_TIME(value) (DSI_VID_HSA_TIME_ACT_VID_HSA_TIME_Msk & (_UINT32_(value) << DSI_VID_HSA_TIME_ACT_VID_HSA_TIME_Pos)) /* Assignment of value for VID_HSA_TIME in the DSI_VID_HSA_TIME_ACT register */
...
#define DSI_VID_HBP_TIME_ACT_VID_HBP_TIME(value) (DSI_VID_HBP_TIME_ACT_VID_HBP_TIME_Msk & (_UINT32_(value) << DSI_VID_HBP_TIME_ACT_VID_HBP_TIME_Pos)) /* Assignment of value for VID_HBP_TIME in the DSI_VID_HBP_TIME_ACT register */
...
#define DSI_VID_HLINE_TIME_ACT_VID_HLINE_TIME(value) (DSI_VID_HLINE_TIME_ACT_VID_HLINE_TIME_Msk & (_UINT32_(value) << DSI_VID_HLINE_TIME_ACT_VID_HLINE_TIME_Pos)) /* Assignment of value for VID_HLINE_TIME in the DSI_VID_HLINE_TIME_ACT register */
...
#define DSI_VID_VSA_LINES_ACT_VSA_LINES(value) (DSI_VID_VSA_LINES_ACT_VSA_LINES_Msk & (_UINT32_(value) << DSI_VID_VSA_LINES_ACT_VSA_LINES_Pos)) /* Assignment of value for VSA_LINES in the DSI_VID_VSA_LINES_ACT register */
...
#define DSI_VID_VBP_LINES_ACT_VBP_LINES(value) (DSI_VID_VBP_LINES_ACT_VBP_LINES_Msk & (_UINT32_(value) << DSI_VID_VBP_LINES_ACT_VBP_LINES_Pos)) /* Assignment of value for VBP_LINES in the DSI_VID_VBP_LINES_ACT register */
...
#define DSI_VID_VFP_LINES_ACT_VFP_LINES(value) (DSI_VID_VFP_LINES_ACT_VFP_LINES_Msk & (_UINT32_(value) << DSI_VID_VFP_LINES_ACT_VFP_LINES_Pos)) /* Assignment of value for VFP_LINES in the DSI_VID_VFP_LINES_ACT register */
...
#define DSI_VID_VACTIVE_LINES_ACT_V_ACTIVE_LINES(value) (DSI_VID_VACTIVE_LINES_ACT_V_ACTIVE_LINES_Msk & (_UINT32_(value) << DSI_VID_VACTIVE_LINES_ACT_V_ACTIVE_LINES_Pos)) /* Assignment of value for V_ACTIVE_LINES in the DSI_VID_VACTIVE_LINES_ACT register */
...
#define DSI_VID_PKT_STATUS_DPI_CMD_W_EMPTY(value) (DSI_VID_PKT_STATUS_DPI_CMD_W_EMPTY_Msk & (_UINT32_(value) << DSI_VID_PKT_STATUS_DPI_CMD_W_EMPTY_Pos)) /* Assignment of value for DPI_CMD_W_EMPTY in the DSI_VID_PKT_STATUS register */
...
#define DSI_VID_PKT_STATUS_DPI_CMD_W_FULL(value) (DSI_VID_PKT_STATUS_DPI_CMD_W_FULL_Msk & (_UINT32_(value) << DSI_VID_PKT_STATUS_DPI_CMD_W_FULL_Pos)) /* Assignment of value for DPI_CMD_W_FULL in the DSI_VID_PKT_STATUS register */
...
#define DSI_VID_PKT_STATUS_DPI_PLD_W_EMPTY(value) (DSI_VID_PKT_STATUS_DPI_PLD_W_EMPTY_Msk & (_UINT32_(value) << DSI_VID_PKT_STATUS_DPI_PLD_W_EMPTY_Pos)) /* Assignment of value for DPI_PLD_W_EMPTY in the DSI_VID_PKT_STATUS register */
...
#define DSI_VID_PKT_STATUS_DPI_PLD_W_FULL(value) (DSI_VID_PKT_STATUS_DPI_PLD_W_FULL_Msk & (_UINT32_(value) << DSI_VID_PKT_STATUS_DPI_PLD_W_FULL_Pos)) /* Assignment of value for DPI_PLD_W_FULL in the DSI_VID_PKT_STATUS register */
...
#define DSI_VID_PKT_STATUS_DPI_BUFF_PLD_EMPTY(value) (DSI_VID_PKT_STATUS_DPI_BUFF_PLD_EMPTY_Msk & (_UINT32_(value) << DSI_VID_PKT_STATUS_DPI_BUFF_PLD_EMPTY_Pos)) /* Assignment of value for DPI_BUFF_PLD_EMPTY in the DSI_VID_PKT_STATUS register */
...
#define DSI_VID_PKT_STATUS_DPI_BUFF_PLD_FULL(value) (DSI_VID_PKT_STATUS_DPI_BUFF_PLD_FULL_Msk & (_UINT32_(value) << DSI_VID_PKT_STATUS_DPI_BUFF_PLD_FULL_Pos)) /* Assignment of value for DPI_BUFF_PLD_FULL in the DSI_VID_PKT_STATUS register */
...
#define DSI_SDF_3D_ACT_MODE_3D(value)         (DSI_SDF_3D_ACT_MODE_3D_Msk & (_UINT32_(value) << DSI_SDF_3D_ACT_MODE_3D_Pos)) /* Assignment of value for MODE_3D in the DSI_SDF_3D_ACT register */
...
#define DSI_SDF_3D_ACT_SECOND_VSYNC(value)    (DSI_SDF_3D_ACT_SECOND_VSYNC_Msk & (_UINT32_(value) << DSI_SDF_3D_ACT_SECOND_VSYNC_Pos)) /* Assignment of value for SECOND_VSYNC in the DSI_SDF_3D_ACT register */
...
#define DSI_SDF_3D_ACT_RIGHT_FIRST(value)     (DSI_SDF_3D_ACT_RIGHT_FIRST_Msk & (_UINT32_(value) << DSI_SDF_3D_ACT_RIGHT_FIRST_Pos)) /* Assignment of value for RIGHT_FIRST in the DSI_SDF_3D_ACT register */
...
#define DSI_SDF_3D_ACT_SEND_3D_CFG(value)     (DSI_SDF_3D_ACT_SEND_3D_CFG_Msk & (_UINT32_(value) << DSI_SDF_3D_ACT_SEND_3D_CFG_Pos)) /* Assignment of value for SEND_3D_CFG in the DSI_SDF_3D_ACT register */
#define DSI_SDF_3D_ACT_Msk                    _UINT32_(0x0001003F)                                 /* (DSI_SDF_3D_ACT) Register Mask  */


/* DSI register offsets definitions */
