...
#define PMECC_ECC_ECC(value)                  (PMECC_ECC_ECC_Msk & (_UINT32_(value) << PMECC_ECC_ECC_Pos)) /* Assignment of value for ECC in the PMECC_ECC register */
...
#define PMECC_REM_REM2NP1(value)              (PMECC_REM_REM2NP1_Msk & (_UINT32_(value) << PMECC_REM_REM2NP1_Pos)) /* Assignment of value for REM2NP1 in the PMECC_REM register */
...
#define PMECC_REM_REM2NP3(value)              (PMECC_REM_REM2NP3_Msk & (_UINT32_(value) << PMECC_REM_REM2NP3_Pos)) /* Assignment of value for REM2NP3 in the PMECC_REM register */
...
#define PMECC_CFG_BCH_ERR(value)              (PMECC_CFG_BCH_ERR_Msk & (_UINT32_(value) << PMECC_CFG_BCH_ERR_Pos)) /* Assignment of value for BCH_ERR in the PMECC_CFG register */
...
#define PMECC_CFG_SECTORSZ(value)             (PMECC_CFG_SECTORSZ_Msk & (_UINT32_(value) << PMECC_CFG_SECTORSZ_Pos)) /* Assignment of value for SECTORSZ in the PMECC_CFG register */
...
#define PMECC_CFG_PAGESIZE(value)             (PMECC_CFG_PAGESIZE_Msk & (_UINT32_(value) << PMECC_CFG_PAGESIZE_Pos)) /* Assignment of value for PAGESIZE in the PMECC_CFG register */
...
#define PMECC_CFG_SPAREEN(value)              (PMECC_CFG_SPAREEN_Msk & (_UINT32_(value) << PMECC_CFG_SPAREEN_Pos)) /* Assignment of value for SPAREEN in the PMECC_CFG register */
...
#define PMECC_CFG_AUTO(value)                 (PMECC_CFG_AUTO_Msk & (_UINT32_(value) << PMECC_CFG_AUTO_Pos)) /* Assignment of value for AUTO in the PMECC_CFG register */
...
#define PMECC_SAREA_SPARESIZE(value)          (PMECC_SAREA_SPARESIZE_Msk & (_UINT32_(value) << PMECC_SAREA_SPARESIZE_Pos)) /* Assignment of value for SPARESIZE in the PMECC_SAREA register */
...
#define PMECC_SADDR_STARTADDR(value)          (PMECC_SADDR_STARTADDR_Msk & (_UINT32_(value) << PMECC_SADDR_STARTADDR_Pos)) /* Assignment of value for STARTADDR in the PMECC_SADDR register */
...
#define PMECC_EADDR_ENDADDR(value)            (PMECC_EADDR_ENDADDR_Msk & (_UINT32_(value) << PMECC_EADDR_ENDADDR_Pos)) /* Assignment of value for ENDADDR in the PMECC_EADDR register */
...
#define PMECC_CLK_CLKCTRL(value)              (PMECC_CLK_CLKCTRL_Msk & (_UINT32_(value) << PMECC_CLK_CLKCTRL_Pos)) /* Assignment of value for CLKCTRL in the PMECC_CLK register */
...
#define PMECC_CTRL_RST(value)                 (PMECC_CTRL_RST_Msk & (_UINT32_(value) << PMECC_CTRL_RST_Pos)) /* Assignment of value for RST in the PMECC_CTRL register */
...
#define PMECC_CTRL_DATA(value)                (PMECC_CTRL_DATA_Msk & (_UINT32_(value) << PMECC_CTRL_DATA_Pos)) /* Assignment of value for DATA in the PMECC_CTRL register */
...
#define PMECC_CTRL_USER(value)                (PMECC_CTRL_USER_Msk & (_UINT32_(value) << PMECC_CTRL_USER_Pos)) /* Assignment of value for USER in the PMECC_CTRL register */
...
#define PMECC_CTRL_ENABLE(value)              (PMECC_CTRL_ENABLE_Msk & (_UINT32_(value) << PMECC_CTRL_ENABLE_Pos)) /* Assignment of value for ENABLE in the PMECC_CTRL register */
...
#define PMECC_CTRL_DISABLE(value)             (PMECC_CTRL_DISABLE_Msk & (_UINT32_(value) << PMECC_CTRL_DISABLE_Pos)) /* Assignment of value for DISABLE in the PMECC_CTRL register */
...
#define PMECC_SR_BUSY(value)                  (PMECC_SR_BUSY_Msk & (_UINT32_(value) << PMECC_SR_BUSY_Pos)) /* Assignment of value for BUSY in the PMECC_SR register */
...
#define PMECC_SR_ENABLE(value)                (PMECC_SR_ENABLE_Msk & (_UINT32_(value) << PMECC_SR_ENABLE_Pos)) /* Assignment of value for ENABLE in the PMECC_SR register */
...
#define PMECC_IER_ERRIE(value)                (PMECC_IER_ERRIE_Msk & (_UINT32_(value) << PMECC_IER_ERRIE_Pos)) /* Assignment of value for ERRIE in the PMECC_IER register */
...
#define PMECC_IDR_ERRID(value)                (PMECC_IDR_ERRID_Msk & (_UINT32_(value) << PMECC_IDR_ERRID_Pos)) /* Assignment of value for ERRID in the PMECC_IDR register */
...
#define PMECC_IMR_ERRIM(value)                (PMECC_IMR_ERRIM_Msk & (_UINT32_(value) << PMECC_IMR_ERRIM_Pos)) /* Assignment of value for ERRIM in the PMECC_IMR register */
...
#define PMECC_ISR_ERRIS(value)                (PMECC_ISR_ERRIS_Msk & (_UINT32_(value) << PMECC_ISR_ERRIS_Pos)) /* Assignment of value for ERRIS in the PMECC_ISR register */
#define PMECC_ISR_Msk                         _UINT32_(0x000000FF)                                 /* (PMECC_ISR) Register Mask  */


/* PMECC register offsets definitions */
...
/* PMECC_ECC register API structure */
typedef struct
{
...
/* PMECC_REM register API structure */
typedef struct
{
