...
#ifndef _SAM9X6_GFX2D_COMPONENT_H_
#define _SAM9X6_GFX2D_COMPONENT_H_
...
#define GFX2D_GC_CGDISCORE_Pos                _UINT32_(0)                                          /* (GFX2D_GC) Clock Gating Disable Core Position */
#define GFX2D_GC_CGDISCORE_Msk                (_UINT32_(0x1) << GFX2D_GC_CGDISCORE_Pos)            /* (GFX2D_GC) Clock Gating Disable Core Mask */
#define GFX2D_GC_CGDISCORE(value)             (GFX2D_GC_CGDISCORE_Msk & (_UINT32_(value) << GFX2D_GC_CGDISCORE_Pos)) /* Assigment of value for CGDISCORE in the GFX2D_GC register */
#define GFX2D_GC_CGDISAXI_Pos                 _UINT32_(1)                                          /* (GFX2D_GC) Clock Gating Disable AXI Position */
#define GFX2D_GC_CGDISAXI_Msk                 (_UINT32_(0x1) << GFX2D_GC_CGDISAXI_Pos)             /* (GFX2D_GC) Clock Gating Disable AXI Mask */
#define GFX2D_GC_CGDISAXI(value)              (GFX2D_GC_CGDISAXI_Msk & (_UINT32_(value) << GFX2D_GC_CGDISAXI_Pos)) /* Assigment of value for CGDISAXI in the GFX2D_GC register */
#define GFX2D_GC_CGDISFIFO_Pos                _UINT32_(2)                                          /* (GFX2D_GC) Clock Gating Disable FIFO Position */
#define GFX2D_GC_CGDISFIFO_Msk                (_UINT32_(0x1) << GFX2D_GC_CGDISFIFO_Pos)            /* (GFX2D_GC) Clock Gating Disable FIFO Mask */
#define GFX2D_GC_CGDISFIFO(value)             (GFX2D_GC_CGDISFIFO_Msk & (_UINT32_(value) << GFX2D_GC_CGDISFIFO_Pos)) /* Assigment of value for CGDISFIFO in the GFX2D_GC register */
...
#define GFX2D_GC_Msk                          _UINT32_(0x000FFF57)                                 /* (GFX2D_GC) Register Mask  */
...
#define GFX2D_PC_REG_OFST              _UINT32_(0x00)      /* (GFX2D_PC) Performance Configuration 0 Register Offset */
#define GFX2D_MC_REG_OFST              _UINT32_(0x04)      /* (GFX2D_MC) Metrics Counter 0 Register Offset */
...
#endif /* _SAM9X6_GFX2D_COMPONENT_H_ */
