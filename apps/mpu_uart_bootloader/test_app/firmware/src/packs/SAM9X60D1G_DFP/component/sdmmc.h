...
#ifndef _SAM9X6_SDMMC_COMPONENT_H_
#define _SAM9X6_SDMMC_COMPONENT_H_
...
#define SDMMC_HC1R_SD_SDIO_Msk                _UINT8_(0x1F)                                         /* (SDMMC_HC1R_SD_SDIO) Register Mask  */
...
#define SDMMC_HC2R_SD_SDIO_Msk                _UINT16_(0xC000)                                      /* (SDMMC_HC2R_SD_SDIO) Register Mask  */
...
#define SDMMC_HC2R_E_MMC_Msk                  _UINT16_(0x8000)                                      /* (SDMMC_HC2R_E_MMC) Register Mask  */
...
#define SDMMC_ACR_HNBRDIS_Pos                 _UINT32_(4)                                          /* (SDMMC_ACR) HNBREQ Disable Position */
#define SDMMC_ACR_HNBRDIS_Msk                 (_UINT32_(0x1) << SDMMC_ACR_HNBRDIS_Pos)             /* (SDMMC_ACR) HNBREQ Disable Mask */
#define SDMMC_ACR_HNBRDIS(value)              (SDMMC_ACR_HNBRDIS_Msk & (_UINT32_(value) << SDMMC_ACR_HNBRDIS_Pos)) /* Assigment of value for HNBRDIS in the SDMMC_ACR register */
#define SDMMC_ACR_B1KBDIS_Pos                 _UINT32_(5)                                          /* (SDMMC_ACR) 1kB Boundary Disable Position */
#define SDMMC_ACR_B1KBDIS_Msk                 (_UINT32_(0x1) << SDMMC_ACR_B1KBDIS_Pos)             /* (SDMMC_ACR) 1kB Boundary Disable Mask */
#define SDMMC_ACR_B1KBDIS(value)              (SDMMC_ACR_B1KBDIS_Msk & (_UINT32_(value) << SDMMC_ACR_B1KBDIS_Pos)) /* Assigment of value for B1KBDIS in the SDMMC_ACR register */
#define SDMMC_ACR_Msk                         _UINT32_(0x00000033)                                 /* (SDMMC_ACR) Register Mask  */
...
#define SDMMC_TUNSR_DLLPS_Pos                 _UINT32_(0)                                          /* (SDMMC_TUNSR) Tuning DLL Phase Status Position */
#define SDMMC_TUNSR_DLLPS_Msk                 (_UINT32_(0xF) << SDMMC_TUNSR_DLLPS_Pos)             /* (SDMMC_TUNSR) Tuning DLL Phase Status Mask */
#define SDMMC_TUNSR_DLLPS(value)              (SDMMC_TUNSR_DLLPS_Msk & (_UINT32_(value) << SDMMC_TUNSR_DLLPS_Pos)) /* Assigment of value for DLLPS in the SDMMC_TUNSR register */
#define SDMMC_TUNSR_SMPLES_Pos                _UINT32_(8)                                          /* (SDMMC_TUNSR) Tuning Sampling SDCLK Edge Status Position */
#define SDMMC_TUNSR_SMPLES_Msk                (_UINT32_(0x1) << SDMMC_TUNSR_SMPLES_Pos)            /* (SDMMC_TUNSR) Tuning Sampling SDCLK Edge Status Mask */
#define SDMMC_TUNSR_SMPLES(value)             (SDMMC_TUNSR_SMPLES_Msk & (_UINT32_(value) << SDMMC_TUNSR_SMPLES_Pos)) /* Assigment of value for SMPLES in the SDMMC_TUNSR register */
#define SDMMC_TUNSR_Msk                       _UINT32_(0x0000010F)                                 /* (SDMMC_TUNSR) Register Mask  */
...
#define SDMMC_TUNSR_REG_OFST           _UINT32_(0x224)     /* (SDMMC_TUNSR) Tuning Status Register Offset */
...
#endif /* _SAM9X6_SDMMC_COMPONENT_H_ */
