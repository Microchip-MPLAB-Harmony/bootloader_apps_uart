...
#ifndef _SAM9X6_MPDDRC_COMPONENT_H_
#define _SAM9X6_MPDDRC_COMPONENT_H_
...
#define   MPDDRC_MR_MODE_DEEP_MD_Val          _UINT32_(0x6)                                        /* (MPDDRC_MR) Deep Power mode: Access to Deep Powerdown mode  */
...
#define   MPDDRC_CR_NC_DDR9_MDDR8_COL_BITS_Val _UINT32_(0x0)                                        /* (MPDDRC_CR) 9 bits to define the column number, up to 512 columns, for DDR2-SDRAM 8 bits to define the column number, up to 256 columns, for LPDDR1-SDRAM  */
#define   MPDDRC_CR_NC_DDR10_MDDR9_COL_BITS_Val _UINT32_(0x1)                                        /* (MPDDRC_CR) 10 bits to define the column number, up to 1024 columns, for DDR2-SDRAM 9 bits to define the column number, up to 512 columns, for LPDDR1-SDRAM  */
#define   MPDDRC_CR_NC_DDR11_MDDR10_COL_BITS_Val _UINT32_(0x2)                                        /* (MPDDRC_CR) 11 bits to define the column number, up to 2048 columns, for DDR2-SDRAM 10 bits to define the column number, up to 1024 columns, for LPDDR1-SDRAM  */
#define   MPDDRC_CR_NC_DDR12_MDDR11_COL_BITS_Val _UINT32_(0x3)                                        /* (MPDDRC_CR) 12 bits to define the column number, up to 4096 columns, for DDR2-SDRAM 11 bits to define the column number, up to 2048 columns, for LPDDR1-SDRAM  */
...
#define   MPDDRC_CR_DIC_DS_DDR2_NORMALSTRENGTH_Val _UINT32_(0x0)                                        /* (MPDDRC_CR) Normal drive strength (DDR2)  */
#define   MPDDRC_CR_DIC_DS_DDR2_WEAKSTRENGTH_Val _UINT32_(0x1)                                        /* (MPDDRC_CR) Weak drive strength (DDR2)  */
...
#define   MPDDRC_CR_NB_8_BANKS_Val            _UINT32_(0x1)                                        /* (MPDDRC_CR) 8 banks. Only possible when using DDR2-SDRAM devices.  */
...
#define MPDDRC_CR_Msk                         _UINT32_(0x00F973FF)                                 /* (MPDDRC_CR) Register Mask  */
...
#define   MPDDRC_LPR_APDE_DDR2_FAST_EXIT_Val  _UINT32_(0x0)                                        /* (MPDDRC_LPR) Fast Exit from Power Down. DDR2-SDRAM devices only.  */
#define   MPDDRC_LPR_APDE_DDR2_SLOW_EXIT_Val  _UINT32_(0x1)                                        /* (MPDDRC_LPR) Slow Exit from Power Down. DDR2-SDRAM devices only.  */
...
#define MPDDRC_LPR_Msk                        _UINT32_(0x03317777)                                 /* (MPDDRC_LPR) Register Mask  */
...
#define MPDDRC_IO_CALIBR_CK_F_RANGE_Msk       (_UINT32_(0x7) << MPDDRC_IO_CALIBR_CK_F_RANGE_Pos)   /* (MPDDRC_IO_CALIBR) DDRCK Maximum Clock Frequency Range Indicator Mask */
...
#define MPDDRC_IO_CALIBR_Msk                  _UINT32_(0x00FF7F07)                                 /* (MPDDRC_IO_CALIBR) Register Mask  */
...
#define MPDDRC_CONF_ARBITER_Msk               _UINT32_(0x0F0F0F0B)                                 /* (MPDDRC_CONF_ARBITER) Register Mask  */

#define MPDDRC_CONF_ARBITER_RQ_WD_P_Pos       _UINT32_(8)                                          /* (MPDDRC_CONF_ARBITER Position) Request or Word from Port X */
#define MPDDRC_CONF_ARBITER_RQ_WD_P_Msk       (_UINT32_(0xF) << MPDDRC_CONF_ARBITER_RQ_WD_P_Pos)   /* (MPDDRC_CONF_ARBITER Mask) RQ_WD_P */
...
#define MPDDRC_CONF_ARBITER_MA_PR_P_Msk       (_UINT32_(0xF) << MPDDRC_CONF_ARBITER_MA_PR_P_Pos)   /* (MPDDRC_CONF_ARBITER Mask) MA_PR_P */
...
#define MPDDRC_CONF_ARBITER_BDW_BURST_P_Msk   (_UINT32_(0xF) << MPDDRC_CONF_ARBITER_BDW_BURST_P_Pos) /* (MPDDRC_CONF_ARBITER Mask) BDW_BURST_P */
...
#define MPDDRC_TIMEOUT_TIMEOUT_P0_Pos         _UINT32_(0)                                          /* (MPDDRC_TIMEOUT) Timeout for Ports 0, 1, 2, 3 Position */
#define MPDDRC_TIMEOUT_TIMEOUT_P0_Msk         (_UINT32_(0xF) << MPDDRC_TIMEOUT_TIMEOUT_P0_Pos)     /* (MPDDRC_TIMEOUT) Timeout for Ports 0, 1, 2, 3 Mask */
...
#define MPDDRC_TIMEOUT_TIMEOUT_P1_Pos         _UINT32_(4)                                          /* (MPDDRC_TIMEOUT) Timeout for Ports 0, 1, 2, 3 Position */
#define MPDDRC_TIMEOUT_TIMEOUT_P1_Msk         (_UINT32_(0xF) << MPDDRC_TIMEOUT_TIMEOUT_P1_Pos)     /* (MPDDRC_TIMEOUT) Timeout for Ports 0, 1, 2, 3 Mask */
...
#define MPDDRC_TIMEOUT_TIMEOUT_P2_Pos         _UINT32_(8)                                          /* (MPDDRC_TIMEOUT) Timeout for Ports 0, 1, 2, 3 Position */
#define MPDDRC_TIMEOUT_TIMEOUT_P2_Msk         (_UINT32_(0xF) << MPDDRC_TIMEOUT_TIMEOUT_P2_Pos)     /* (MPDDRC_TIMEOUT) Timeout for Ports 0, 1, 2, 3 Mask */
...
#define MPDDRC_TIMEOUT_TIMEOUT_P3_Pos         _UINT32_(12)                                         /* (MPDDRC_TIMEOUT) Timeout for Ports 0, 1, 2, 3 Position */
#define MPDDRC_TIMEOUT_TIMEOUT_P3_Msk         (_UINT32_(0xF) << MPDDRC_TIMEOUT_TIMEOUT_P3_Pos)     /* (MPDDRC_TIMEOUT) Timeout for Ports 0, 1, 2, 3 Mask */
...
#define MPDDRC_TIMEOUT_Msk                    _UINT32_(0x0000FFFF)                                 /* (MPDDRC_TIMEOUT) Register Mask  */
...
#define   MPDDRC_RD_DATA_PATH_SHIFT_SAMPLING_SHIFT_THREE_CYCLES_Val _UINT32_(0x3)                                        /* (MPDDRC_RD_DATA_PATH) Not applicable for DDR2 and LPDDR1 devices.  */
...
#define MPDDRC_MADDR0_ADDR_LOW_PORT0_Pos      _UINT32_(0)                                          /* (MPDDRC_MADDR0) Address Low on Port 0 Position */
#define MPDDRC_MADDR0_ADDR_LOW_PORT0_Msk      (_UINT32_(0xFFFF) << MPDDRC_MADDR0_ADDR_LOW_PORT0_Pos) /* (MPDDRC_MADDR0) Address Low on Port 0 Mask */
...
#define MPDDRC_MADDR0_ADDR_HIGH_PORT0_Pos     _UINT32_(16)                                         /* (MPDDRC_MADDR0) Address High on Port 0 Position */
#define MPDDRC_MADDR0_ADDR_HIGH_PORT0_Msk     (_UINT32_(0xFFFF) << MPDDRC_MADDR0_ADDR_HIGH_PORT0_Pos) /* (MPDDRC_MADDR0) Address High on Port 0 Mask */
...
#define MPDDRC_MADDR1_ADDR_LOW_PORT1_Pos      _UINT32_(0)                                          /* (MPDDRC_MADDR1) Address Low on Port 1 Position */
#define MPDDRC_MADDR1_ADDR_LOW_PORT1_Msk      (_UINT32_(0xFFFF) << MPDDRC_MADDR1_ADDR_LOW_PORT1_Pos) /* (MPDDRC_MADDR1) Address Low on Port 1 Mask */
...
#define MPDDRC_MADDR1_ADDR_HIGH_PORT1_Pos     _UINT32_(16)                                         /* (MPDDRC_MADDR1) Address High on Port 1 Position */
#define MPDDRC_MADDR1_ADDR_HIGH_PORT1_Msk     (_UINT32_(0xFFFF) << MPDDRC_MADDR1_ADDR_HIGH_PORT1_Pos) /* (MPDDRC_MADDR1) Address High on Port 1 Mask */
...
#define MPDDRC_MADDR2_ADDR_LOW_PORT2_Pos      _UINT32_(0)                                          /* (MPDDRC_MADDR2) Address Low on Port 2 Position */
#define MPDDRC_MADDR2_ADDR_LOW_PORT2_Msk      (_UINT32_(0xFFFF) << MPDDRC_MADDR2_ADDR_LOW_PORT2_Pos) /* (MPDDRC_MADDR2) Address Low on Port 2 Mask */
...
#define MPDDRC_MADDR2_ADDR_HIGH_PORT2_Pos     _UINT32_(16)                                         /* (MPDDRC_MADDR2) Address High on Port 2 Position */
#define MPDDRC_MADDR2_ADDR_HIGH_PORT2_Msk     (_UINT32_(0xFFFF) << MPDDRC_MADDR2_ADDR_HIGH_PORT2_Pos) /* (MPDDRC_MADDR2) Address High on Port 2 Mask */
...
#define MPDDRC_MADDR3_ADDR_LOW_PORT3_Pos      _UINT32_(0)                                          /* (MPDDRC_MADDR3) Address Low on Port 3 Position */
#define MPDDRC_MADDR3_ADDR_LOW_PORT3_Msk      (_UINT32_(0xFFFF) << MPDDRC_MADDR3_ADDR_LOW_PORT3_Pos) /* (MPDDRC_MADDR3) Address Low on Port 3 Mask */
...
#define MPDDRC_MADDR3_ADDR_HIGH_PORT3_Pos     _UINT32_(16)                                         /* (MPDDRC_MADDR3) Address High on Port 3 Position */
#define MPDDRC_MADDR3_ADDR_HIGH_PORT3_Msk     (_UINT32_(0xFFFF) << MPDDRC_MADDR3_ADDR_HIGH_PORT3_Pos) /* (MPDDRC_MADDR3) Address High on Port 3 Mask */
...
/* MAX_WAIT mode */
#define MPDDRC_MINFO0_MAX_WAIT_MAX_PORT0_WAITING_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO0) Address High on Port 0 Position */
#define MPDDRC_MINFO0_MAX_WAIT_MAX_PORT0_WAITING_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO0_MAX_WAIT_MAX_PORT0_WAITING_Pos) /* (MPDDRC_MINFO0) Address High on Port 0 Mask */
...
#define MPDDRC_MINFO0_MAX_WAIT_BURST_Pos      _UINT32_(16)                                         /* (MPDDRC_MINFO0) Type of Burst on Port 0 Position */
#define MPDDRC_MINFO0_MAX_WAIT_BURST_Msk      (_UINT32_(0x7) << MPDDRC_MINFO0_MAX_WAIT_BURST_Pos)  /* (MPDDRC_MINFO0) Type of Burst on Port 0 Mask */
...
#define MPDDRC_MINFO0_MAX_WAIT_SIZE_Pos       _UINT32_(20)                                         /* (MPDDRC_MINFO0) Transfer Size on Port 0 Position */
#define MPDDRC_MINFO0_MAX_WAIT_SIZE_Msk       (_UINT32_(0x7) << MPDDRC_MINFO0_MAX_WAIT_SIZE_Pos)   /* (MPDDRC_MINFO0) Transfer Size on Port 0 Mask */
...
#define MPDDRC_MINFO0_MAX_WAIT_READ_WRITE_Pos _UINT32_(24)                                         /* (MPDDRC_MINFO0) Read or Write Access on Port 0 Position */
#define MPDDRC_MINFO0_MAX_WAIT_READ_WRITE_Msk (_UINT32_(0x1) << MPDDRC_MINFO0_MAX_WAIT_READ_WRITE_Pos) /* (MPDDRC_MINFO0) Read or Write Access on Port 0 Mask */
...
#define MPDDRC_MINFO0_MAX_WAIT_LQOS_Pos       _UINT32_(25)                                         /* (MPDDRC_MINFO0) Value of Quality Of Service on Port 0 Position */
#define MPDDRC_MINFO0_MAX_WAIT_LQOS_Msk       (_UINT32_(0x3) << MPDDRC_MINFO0_MAX_WAIT_LQOS_Pos)   /* (MPDDRC_MINFO0) Value of Quality Of Service on Port 0 Mask */
...
/* NB_TRANSFERS mode */
#define MPDDRC_MINFO0_NB_TRANSFERS_P0_NB_TRANSFERS_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO0) Number of Transfers on Port 0 Position */
#define MPDDRC_MINFO0_NB_TRANSFERS_P0_NB_TRANSFERS_Msk (_UINT32_(0xFFFFFFFF) << MPDDRC_MINFO0_NB_TRANSFERS_P0_NB_TRANSFERS_Pos) /* (MPDDRC_MINFO0) Number of Transfers on Port 0 Mask */
...
/* TOTAL_LATENCY mode */
#define MPDDRC_MINFO0_TOTAL_LATENCY_P0_TOTAL_LATENCY_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO0) Total Latency on Port 0 Position */
#define MPDDRC_MINFO0_TOTAL_LATENCY_P0_TOTAL_LATENCY_Msk (_UINT32_(0xFFFFFFFF) << MPDDRC_MINFO0_TOTAL_LATENCY_P0_TOTAL_LATENCY_Pos) /* (MPDDRC_MINFO0) Total Latency on Port 0 Mask */
...
#define MPDDRC_MINFO0_TOTAL_LATENCY_QOS01_P0_TOTAL_LATENCY_QOS0_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO0) Total Latency on Port 0 when value of qos is 0 Position */
#define MPDDRC_MINFO0_TOTAL_LATENCY_QOS01_P0_TOTAL_LATENCY_QOS0_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO0_TOTAL_LATENCY_QOS01_P0_TOTAL_LATENCY_QOS0_Pos) /* (MPDDRC_MINFO0) Total Latency on Port 0 when value of qos is 0 Mask */
...
#define MPDDRC_MINFO0_TOTAL_LATENCY_QOS01_P0_TOTAL_LATENCY_QOS1_Pos _UINT32_(16)                                         /* (MPDDRC_MINFO0) Total Latency on Port 1 when value of qos is 1 Position */
#define MPDDRC_MINFO0_TOTAL_LATENCY_QOS01_P0_TOTAL_LATENCY_QOS1_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO0_TOTAL_LATENCY_QOS01_P0_TOTAL_LATENCY_QOS1_Pos) /* (MPDDRC_MINFO0) Total Latency on Port 1 when value of qos is 1 Mask */
...
#define MPDDRC_MINFO0_TOTAL_LATENCY_QOS23_P0_TOTAL_LATENCY_QOS2_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO0) Total Latency on Port 2 when value of qos is 2 Position */
#define MPDDRC_MINFO0_TOTAL_LATENCY_QOS23_P0_TOTAL_LATENCY_QOS2_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO0_TOTAL_LATENCY_QOS23_P0_TOTAL_LATENCY_QOS2_Pos) /* (MPDDRC_MINFO0) Total Latency on Port 2 when value of qos is 2 Mask */
...
#define MPDDRC_MINFO0_TOTAL_LATENCY_QOS23_P0_TOTAL_LATENCY_QOS3_Pos _UINT32_(16)                                         /* (MPDDRC_MINFO0) Total Latency on Port 3 when value of qos is 3 Position */
#define MPDDRC_MINFO0_TOTAL_LATENCY_QOS23_P0_TOTAL_LATENCY_QOS3_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO0_TOTAL_LATENCY_QOS23_P0_TOTAL_LATENCY_QOS3_Pos) /* (MPDDRC_MINFO0) Total Latency on Port 3 when value of qos is 3 Mask */
...
/* MAX_WAIT mode */
#define MPDDRC_MINFO1_MAX_WAIT_MAX_PORT1_WAITING_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO1) Address High on Port 1 Position */
#define MPDDRC_MINFO1_MAX_WAIT_MAX_PORT1_WAITING_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO1_MAX_WAIT_MAX_PORT1_WAITING_Pos) /* (MPDDRC_MINFO1) Address High on Port 1 Mask */
...
#define MPDDRC_MINFO1_MAX_WAIT_BURST_Pos      _UINT32_(16)                                         /* (MPDDRC_MINFO1) Type of Burst on Port 1 Position */
#define MPDDRC_MINFO1_MAX_WAIT_BURST_Msk      (_UINT32_(0x7) << MPDDRC_MINFO1_MAX_WAIT_BURST_Pos)  /* (MPDDRC_MINFO1) Type of Burst on Port 1 Mask */
...
#define MPDDRC_MINFO1_MAX_WAIT_SIZE_Pos       _UINT32_(20)                                         /* (MPDDRC_MINFO1) Transfer Size on Port 1 Position */
#define MPDDRC_MINFO1_MAX_WAIT_SIZE_Msk       (_UINT32_(0x7) << MPDDRC_MINFO1_MAX_WAIT_SIZE_Pos)   /* (MPDDRC_MINFO1) Transfer Size on Port 1 Mask */
...
#define MPDDRC_MINFO1_MAX_WAIT_READ_WRITE_Pos _UINT32_(24)                                         /* (MPDDRC_MINFO1) Read or Write Access on Port 1 Position */
#define MPDDRC_MINFO1_MAX_WAIT_READ_WRITE_Msk (_UINT32_(0x1) << MPDDRC_MINFO1_MAX_WAIT_READ_WRITE_Pos) /* (MPDDRC_MINFO1) Read or Write Access on Port 1 Mask */
...
#define MPDDRC_MINFO1_MAX_WAIT_LQOS_Pos       _UINT32_(25)                                         /* (MPDDRC_MINFO1) Value of Quality Of Service on Port 1 Position */
#define MPDDRC_MINFO1_MAX_WAIT_LQOS_Msk       (_UINT32_(0x3) << MPDDRC_MINFO1_MAX_WAIT_LQOS_Pos)   /* (MPDDRC_MINFO1) Value of Quality Of Service on Port 1 Mask */
...
/* NB_TRANSFERS mode */
#define MPDDRC_MINFO1_NB_TRANSFERS_P1_NB_TRANSFERS_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO1) Number of Transfers on Port 1 Position */
#define MPDDRC_MINFO1_NB_TRANSFERS_P1_NB_TRANSFERS_Msk (_UINT32_(0xFFFFFFFF) << MPDDRC_MINFO1_NB_TRANSFERS_P1_NB_TRANSFERS_Pos) /* (MPDDRC_MINFO1) Number of Transfers on Port 1 Mask */
...
/* TOTAL_LATENCY mode */
#define MPDDRC_MINFO1_TOTAL_LATENCY_P1_TOTAL_LATENCY_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO1) Total Latency on Port 1 Position */
#define MPDDRC_MINFO1_TOTAL_LATENCY_P1_TOTAL_LATENCY_Msk (_UINT32_(0xFFFFFFFF) << MPDDRC_MINFO1_TOTAL_LATENCY_P1_TOTAL_LATENCY_Pos) /* (MPDDRC_MINFO1) Total Latency on Port 1 Mask */
...
/* TOTAL_LATENCY_QOS01 mode */
#define MPDDRC_MINFO1_TOTAL_LATENCY_QOS01_P1_TOTAL_LATENCY_QOS0_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO1) Total Latency on Port 0 when value of qos is 0 Position */
#define MPDDRC_MINFO1_TOTAL_LATENCY_QOS01_P1_TOTAL_LATENCY_QOS0_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO1_TOTAL_LATENCY_QOS01_P1_TOTAL_LATENCY_QOS0_Pos) /* (MPDDRC_MINFO1) Total Latency on Port 0 when value of qos is 0 Mask */
...
#define MPDDRC_MINFO1_TOTAL_LATENCY_QOS01_P1_TOTAL_LATENCY_QOS1_Pos _UINT32_(16)                                         /* (MPDDRC_MINFO1) Total Latency on Port 1 when value of qos is 1 Position */
#define MPDDRC_MINFO1_TOTAL_LATENCY_QOS01_P1_TOTAL_LATENCY_QOS1_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO1_TOTAL_LATENCY_QOS01_P1_TOTAL_LATENCY_QOS1_Pos) /* (MPDDRC_MINFO1) Total Latency on Port 1 when value of qos is 1 Mask */
...
/* TOTAL_LATENCY_QOS23 mode */
#define MPDDRC_MINFO1_TOTAL_LATENCY_QOS23_P1_TOTAL_LATENCY_QOS2_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO1) Total Latency on Port 2 when value of qos is 2 Position */
#define MPDDRC_MINFO1_TOTAL_LATENCY_QOS23_P1_TOTAL_LATENCY_QOS2_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO1_TOTAL_LATENCY_QOS23_P1_TOTAL_LATENCY_QOS2_Pos) /* (MPDDRC_MINFO1) Total Latency on Port 2 when value of qos is 2 Mask */
...
#define MPDDRC_MINFO1_TOTAL_LATENCY_QOS23_P1_TOTAL_LATENCY_QOS3_Pos _UINT32_(16)                                         /* (MPDDRC_MINFO1) Total Latency on Port 3 when value of qos is 3 Position */
#define MPDDRC_MINFO1_TOTAL_LATENCY_QOS23_P1_TOTAL_LATENCY_QOS3_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO1_TOTAL_LATENCY_QOS23_P1_TOTAL_LATENCY_QOS3_Pos) /* (MPDDRC_MINFO1) Total Latency on Port 3 when value of qos is 3 Mask */
...
/* MAX_WAIT mode */
#define MPDDRC_MINFO2_MAX_WAIT_MAX_PORT2_WAITING_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO2) Address High on Port 2 Position */
#define MPDDRC_MINFO2_MAX_WAIT_MAX_PORT2_WAITING_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO2_MAX_WAIT_MAX_PORT2_WAITING_Pos) /* (MPDDRC_MINFO2) Address High on Port 2 Mask */
...
#define MPDDRC_MINFO2_MAX_WAIT_BURST_Pos      _UINT32_(16)                                         /* (MPDDRC_MINFO2) Type of Burst on Port 2 Position */
#define MPDDRC_MINFO2_MAX_WAIT_BURST_Msk      (_UINT32_(0x7) << MPDDRC_MINFO2_MAX_WAIT_BURST_Pos)  /* (MPDDRC_MINFO2) Type of Burst on Port 2 Mask */
...
#define MPDDRC_MINFO2_MAX_WAIT_SIZE_Pos       _UINT32_(20)                                         /* (MPDDRC_MINFO2) Transfer Size on Port 2 Position */
#define MPDDRC_MINFO2_MAX_WAIT_SIZE_Msk       (_UINT32_(0x7) << MPDDRC_MINFO2_MAX_WAIT_SIZE_Pos)   /* (MPDDRC_MINFO2) Transfer Size on Port 2 Mask */
...
#define MPDDRC_MINFO2_MAX_WAIT_READ_WRITE_Pos _UINT32_(24)                                         /* (MPDDRC_MINFO2) Read or Write Access on Port 2 Position */
#define MPDDRC_MINFO2_MAX_WAIT_READ_WRITE_Msk (_UINT32_(0x1) << MPDDRC_MINFO2_MAX_WAIT_READ_WRITE_Pos) /* (MPDDRC_MINFO2) Read or Write Access on Port 2 Mask */
...
#define MPDDRC_MINFO2_MAX_WAIT_LQOS_Pos       _UINT32_(25)                                         /* (MPDDRC_MINFO2) Value of Quality Of Service on Port 2 Position */
#define MPDDRC_MINFO2_MAX_WAIT_LQOS_Msk       (_UINT32_(0x3) << MPDDRC_MINFO2_MAX_WAIT_LQOS_Pos)   /* (MPDDRC_MINFO2) Value of Quality Of Service on Port 2 Mask */
...
/* NB_TRANSFERS mode */
#define MPDDRC_MINFO2_NB_TRANSFERS_P2_NB_TRANSFERS_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO2) Number of Transfers on Port 2 Position */
#define MPDDRC_MINFO2_NB_TRANSFERS_P2_NB_TRANSFERS_Msk (_UINT32_(0xFFFFFFFF) << MPDDRC_MINFO2_NB_TRANSFERS_P2_NB_TRANSFERS_Pos) /* (MPDDRC_MINFO2) Number of Transfers on Port 2 Mask */
...
/* TOTAL_LATENCY mode */
#define MPDDRC_MINFO2_TOTAL_LATENCY_P2_TOTAL_LATENCY_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO2) Total Latency on Port 2 Position */
#define MPDDRC_MINFO2_TOTAL_LATENCY_P2_TOTAL_LATENCY_Msk (_UINT32_(0xFFFFFFFF) << MPDDRC_MINFO2_TOTAL_LATENCY_P2_TOTAL_LATENCY_Pos) /* (MPDDRC_MINFO2) Total Latency on Port 2 Mask */
...
/* TOTAL_LATENCY_QOS01 mode */
#define MPDDRC_MINFO2_TOTAL_LATENCY_QOS01_P2_TOTAL_LATENCY_QOS0_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO2) Total Latency on Port 0 when value of qos is 0 Position */
#define MPDDRC_MINFO2_TOTAL_LATENCY_QOS01_P2_TOTAL_LATENCY_QOS0_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO2_TOTAL_LATENCY_QOS01_P2_TOTAL_LATENCY_QOS0_Pos) /* (MPDDRC_MINFO2) Total Latency on Port 0 when value of qos is 0 Mask */
...
#define MPDDRC_MINFO2_TOTAL_LATENCY_QOS01_P2_TOTAL_LATENCY_QOS1_Pos _UINT32_(16)                                         /* (MPDDRC_MINFO2) Total Latency on Port 1 when value of qos is 1 Position */
#define MPDDRC_MINFO2_TOTAL_LATENCY_QOS01_P2_TOTAL_LATENCY_QOS1_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO2_TOTAL_LATENCY_QOS01_P2_TOTAL_LATENCY_QOS1_Pos) /* (MPDDRC_MINFO2) Total Latency on Port 1 when value of qos is 1 Mask */
...
/* TOTAL_LATENCY_QOS23 mode */
#define MPDDRC_MINFO2_TOTAL_LATENCY_QOS23_P2_TOTAL_LATENCY_QOS2_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO2) Total Latency on Port 2 when value of qos is 2 Position */
#define MPDDRC_MINFO2_TOTAL_LATENCY_QOS23_P2_TOTAL_LATENCY_QOS2_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO2_TOTAL_LATENCY_QOS23_P2_TOTAL_LATENCY_QOS2_Pos) /* (MPDDRC_MINFO2) Total Latency on Port 2 when value of qos is 2 Mask */
...
#define MPDDRC_MINFO2_TOTAL_LATENCY_QOS23_P2_TOTAL_LATENCY_QOS3_Pos _UINT32_(16)                                         /* (MPDDRC_MINFO2) Total Latency on Port 3 when value of qos is 3 Position */
#define MPDDRC_MINFO2_TOTAL_LATENCY_QOS23_P2_TOTAL_LATENCY_QOS3_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO2_TOTAL_LATENCY_QOS23_P2_TOTAL_LATENCY_QOS3_Pos) /* (MPDDRC_MINFO2) Total Latency on Port 3 when value of qos is 3 Mask */
...
/* MAX_WAIT mode */
#define MPDDRC_MINFO3_MAX_WAIT_MAX_PORT3_WAITING_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO3) Address High on Port 3 Position */
#define MPDDRC_MINFO3_MAX_WAIT_MAX_PORT3_WAITING_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO3_MAX_WAIT_MAX_PORT3_WAITING_Pos) /* (MPDDRC_MINFO3) Address High on Port 3 Mask */
...
#define MPDDRC_MINFO3_MAX_WAIT_BURST_Pos      _UINT32_(16)                                         /* (MPDDRC_MINFO3) Type of Burst on Port 3 Position */
#define MPDDRC_MINFO3_MAX_WAIT_BURST_Msk      (_UINT32_(0x7) << MPDDRC_MINFO3_MAX_WAIT_BURST_Pos)  /* (MPDDRC_MINFO3) Type of Burst on Port 3 Mask */
...
#define MPDDRC_MINFO3_MAX_WAIT_SIZE_Pos       _UINT32_(20)                                         /* (MPDDRC_MINFO3) Transfer Size on Port 3 Position */
#define MPDDRC_MINFO3_MAX_WAIT_SIZE_Msk       (_UINT32_(0x7) << MPDDRC_MINFO3_MAX_WAIT_SIZE_Pos)   /* (MPDDRC_MINFO3) Transfer Size on Port 3 Mask */
...
#define MPDDRC_MINFO3_MAX_WAIT_READ_WRITE_Pos _UINT32_(24)                                         /* (MPDDRC_MINFO3) Read or Write Access on Port 3 Position */
#define MPDDRC_MINFO3_MAX_WAIT_READ_WRITE_Msk (_UINT32_(0x1) << MPDDRC_MINFO3_MAX_WAIT_READ_WRITE_Pos) /* (MPDDRC_MINFO3) Read or Write Access on Port 3 Mask */
...
#define MPDDRC_MINFO3_MAX_WAIT_LQOS_Pos       _UINT32_(25)                                         /* (MPDDRC_MINFO3) Value of Quality Of Service on Port 3 Position */
#define MPDDRC_MINFO3_MAX_WAIT_LQOS_Msk       (_UINT32_(0x3) << MPDDRC_MINFO3_MAX_WAIT_LQOS_Pos)   /* (MPDDRC_MINFO3) Value of Quality Of Service on Port 3 Mask */
...
/* NB_TRANSFERS mode */
#define MPDDRC_MINFO3_NB_TRANSFERS_P3_NB_TRANSFERS_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO3) Number of Transfers on Port 3 Position */
#define MPDDRC_MINFO3_NB_TRANSFERS_P3_NB_TRANSFERS_Msk (_UINT32_(0xFFFFFFFF) << MPDDRC_MINFO3_NB_TRANSFERS_P3_NB_TRANSFERS_Pos) /* (MPDDRC_MINFO3) Number of Transfers on Port 3 Mask */
...
/* TOTAL_LATENCY mode */
#define MPDDRC_MINFO3_TOTAL_LATENCY_P3_TOTAL_LATENCY_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO3) Total Latency on Port 3 Position */
#define MPDDRC_MINFO3_TOTAL_LATENCY_P3_TOTAL_LATENCY_Msk (_UINT32_(0xFFFFFFFF) << MPDDRC_MINFO3_TOTAL_LATENCY_P3_TOTAL_LATENCY_Pos) /* (MPDDRC_MINFO3) Total Latency on Port 3 Mask */
...
/* TOTAL_LATENCY_QOS01 mode */
#define MPDDRC_MINFO3_TOTAL_LATENCY_QOS01_P3_TOTAL_LATENCY_QOS0_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO3) Total Latency on Port 0 when value of qos is 0 Position */
#define MPDDRC_MINFO3_TOTAL_LATENCY_QOS01_P3_TOTAL_LATENCY_QOS0_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO3_TOTAL_LATENCY_QOS01_P3_TOTAL_LATENCY_QOS0_Pos) /* (MPDDRC_MINFO3) Total Latency on Port 0 when value of qos is 0 Mask */
...
#define MPDDRC_MINFO3_TOTAL_LATENCY_QOS01_P3_TOTAL_LATENCY_QOS1_Pos _UINT32_(16)                                         /* (MPDDRC_MINFO3) Total Latency on Port 1 when value of qos is 1 Position */
#define MPDDRC_MINFO3_TOTAL_LATENCY_QOS01_P3_TOTAL_LATENCY_QOS1_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO3_TOTAL_LATENCY_QOS01_P3_TOTAL_LATENCY_QOS1_Pos) /* (MPDDRC_MINFO3) Total Latency on Port 1 when value of qos is 1 Mask */
...
/* TOTAL_LATENCY_QOS23 mode */
#define MPDDRC_MINFO3_TOTAL_LATENCY_QOS23_P3_TOTAL_LATENCY_QOS2_Pos _UINT32_(0)                                          /* (MPDDRC_MINFO3) Total Latency on Port 2 when value of qos is 2 Position */
#define MPDDRC_MINFO3_TOTAL_LATENCY_QOS23_P3_TOTAL_LATENCY_QOS2_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO3_TOTAL_LATENCY_QOS23_P3_TOTAL_LATENCY_QOS2_Pos) /* (MPDDRC_MINFO3) Total Latency on Port 2 when value of qos is 2 Mask */
...
#define MPDDRC_MINFO3_TOTAL_LATENCY_QOS23_P3_TOTAL_LATENCY_QOS3_Pos _UINT32_(16)                                         /* (MPDDRC_MINFO3) Total Latency on Port 3 when value of qos is 3 Position */
#define MPDDRC_MINFO3_TOTAL_LATENCY_QOS23_P3_TOTAL_LATENCY_QOS3_Msk (_UINT32_(0xFFFF) << MPDDRC_MINFO3_TOTAL_LATENCY_QOS23_P3_TOTAL_LATENCY_QOS3_Pos) /* (MPDDRC_MINFO3) Total Latency on Port 3 when value of qos is 3 Mask */
...
#endif /* _SAM9X6_MPDDRC_COMPONENT_H_ */
