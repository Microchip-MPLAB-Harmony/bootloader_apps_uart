...
#ifndef _SAM9X6_MATRIX_COMPONENT_H_
#define _SAM9X6_MATRIX_COMPONENT_H_
...
#define MATRIX_MRCR_RCB_Pos                   _UINT32_(0)                                          /* (MATRIX_MRCR Position) Remap Command Bit for Master x4 */
...
#define MATRIX_MEIER_MERR_Pos                 _UINT32_(0)                                          /* (MATRIX_MEIER Position) Master x4 Access Error */
...
#define MATRIX_MEIDR_MERR_Pos                 _UINT32_(0)                                          /* (MATRIX_MEIDR Position) Master x4 Access Error */
...
#define MATRIX_MEIMR_MERR_Pos                 _UINT32_(0)                                          /* (MATRIX_MEIMR Position) Master x4 Access Error */
...
#define MATRIX_MESR_MERR_Pos                  _UINT32_(0)                                          /* (MATRIX_MESR Position) Master x4 Access Error */
...
#endif /* _SAM9X6_MATRIX_COMPONENT_H_ */
