...
#ifndef _SAM9X6_PMC_COMPONENT_H_
#define _SAM9X6_PMC_COMPONENT_H_
...
#define PMC_PLL_CTRL0_Msk                     _UINT32_(0xB00000FF)                                 /* (PMC_PLL_CTRL0) Register Mask  */
...
#define PMC_PLL_UPDT_ID_Msk                   (_UINT32_(0x1) << PMC_PLL_UPDT_ID_Pos)               /* (PMC_PLL_UPDT) PLL ID Mask */
...
#define PMC_PLL_UPDT_STUPTIM_Pos              _UINT32_(16)                                         /* (PMC_PLL_UPDT) Startup Time Position */
#define PMC_PLL_UPDT_STUPTIM_Msk              (_UINT32_(0xFF) << PMC_PLL_UPDT_STUPTIM_Pos)         /* (PMC_PLL_UPDT) Startup Time Mask */
...
#define PMC_PLL_UPDT_Msk                      _UINT32_(0x00FF0101)                                 /* (PMC_PLL_UPDT) Register Mask  */
...
#define   PMC_CPU_CKR_MDIV_EQ_PCK_Val         _UINT32_(0x0)                                        /* (PMC_CPU_CKR) MCK is FCLK divided by 1. MCK_2X is FCLK divided by 1.  */
#define   PMC_CPU_CKR_MDIV_PCK_DIV2_Val       _UINT32_(0x1)                                        /* (PMC_CPU_CKR) MCK is FCLK divided by 2. MCK_2X is FCLK divided by 1.  */
#define   PMC_CPU_CKR_MDIV_PCK_DIV4_Val       _UINT32_(0x2)                                        /* (PMC_CPU_CKR) MCK is FCLK divided by 4. MCK_2X is FCLK divided by 2.  */
#define   PMC_CPU_CKR_MDIV_PCK_DIV3_Val       _UINT32_(0x3)                                        /* (PMC_CPU_CKR) MCK is FCLK divided by 3. MCK_2X is FCLK divided by 1.5.  */
...
#define PMC_IER_MCKMON_Pos                    _UINT32_(23)                                         /* (PMC_IER) Master Clock Clock Monitor Interrupt Enable Position */
#define PMC_IER_MCKMON_Msk                    (_UINT32_(0x1) << PMC_IER_MCKMON_Pos)                /* (PMC_IER) Master Clock Clock Monitor Interrupt Enable Mask */
...
#define PMC_IDR_MCKMON_Pos                    _UINT32_(23)                                         /* (PMC_IDR) Master Clock Clock Monitor Interrupt Disable Position */
#define PMC_IDR_MCKMON_Msk                    (_UINT32_(0x1) << PMC_IDR_MCKMON_Pos)                /* (PMC_IDR) Master Clock Clock Monitor Interrupt Disable Mask */
...
#define PMC_SR_MCKMON_Pos                     _UINT32_(23)                                         /* (PMC_SR) Master Clock Clock Monitor Error Position */
#define PMC_SR_MCKMON_Msk                     (_UINT32_(0x1) << PMC_SR_MCKMON_Pos)                 /* (PMC_SR) Master Clock Clock Monitor Error Mask */
...
#define PMC_IMR_MCKMON_Pos                    _UINT32_(23)                                         /* (PMC_IMR) Master Clock Monitor Error Interrupt Mask Position */
#define PMC_IMR_MCKMON_Msk                    (_UINT32_(0x1) << PMC_IMR_MCKMON_Pos)                /* (PMC_IMR) Master Clock Monitor Error Interrupt Mask Mask */
...
#define PMC_CSR0_Msk                          _UINT32_(0x7FDFFFFC)                                 /* (PMC_CSR0) Register Mask  */

#define PMC_CSR0_PID_Pos                      _UINT32_(2)                                          /* (PMC_CSR0 Position) Peripheral Clock 3x Status */
#define PMC_CSR0_PID_Msk                      (_UINT32_(0xFFFFFFF) << PMC_CSR0_PID_Pos)            /* (PMC_CSR0 Mask) PID */
...
#define PMC_CSR1_Msk                          _UINT32_(0x00003FFF)                                 /* (PMC_CSR1) Register Mask  */

#define PMC_CSR1_PID_Pos                      _UINT32_(0)                                          /* (PMC_CSR1 Position) Peripheral Clock 45 Status */
...
#define PMC_GCSR0_Msk                         _UINT32_(0x060BFFE0)                                 /* (PMC_GCSR0) Register Mask  */

#define PMC_GCSR0_GPID_Pos                    _UINT32_(5)                                          /* (PMC_GCSR0 Position) Generic Clock 26 Status */
#define PMC_GCSR0_GPID_Msk                    (_UINT32_(0xFFFF) << PMC_GCSR0_GPID_Pos)             /* (PMC_GCSR0 Mask) GPID */
...
#define PMC_GCSR1_Msk                         _UINT32_(0x0000A427)                                 /* (PMC_GCSR1) Register Mask  */

#define PMC_GCSR1_GPID_Pos                    _UINT32_(0)                                          /* (PMC_GCSR1 Position) Generic Clock 47 Status */
#define PMC_GCSR1_GPID_Msk                    (_UINT32_(0x7F) << PMC_GCSR1_GPID_Pos)               /* (PMC_GCSR1 Mask) GPID */
...
#define PMC_PLL_IER_Msk                       _UINT32_(0x00030003)                                 /* (PMC_PLL_IER) Register Mask  */
...
#define PMC_PLL_IDR_Msk                       _UINT32_(0x00030003)                                 /* (PMC_PLL_IDR) Register Mask  */
...
#define PMC_PLL_IMR_Msk                       _UINT32_(0x00030003)                                 /* (PMC_PLL_IMR) Register Mask  */
...
#define PMC_PLL_ISR0_Msk                      _UINT32_(0x00030003)                                 /* (PMC_PLL_ISR0) Register Mask  */


/* -------- PMC_PLL_ISR1 : (PMC Offset: 0xF0) ( R/ 32) PLL Interrupt Status Register 1 -------- */
#define PMC_PLL_ISR1_UDRA_Pos                 _UINT32_(0)                                          /* (PMC_PLL_ISR1) PLLA Underflow Position */
#define PMC_PLL_ISR1_UDRA_Msk                 (_UINT32_(0x1) << PMC_PLL_ISR1_UDRA_Pos)             /* (PMC_PLL_ISR1) PLLA Underflow Mask */
#define PMC_PLL_ISR1_UDRA(value)              (PMC_PLL_ISR1_UDRA_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDRA_Pos)) /* Assigment of value for UDRA in the PMC_PLL_ISR1 register */
#define PMC_PLL_ISR1_UDRU_Pos                 _UINT32_(1)                                          /* (PMC_PLL_ISR1) UPLL Underflow Position */
#define PMC_PLL_ISR1_UDRU_Msk                 (_UINT32_(0x1) << PMC_PLL_ISR1_UDRU_Pos)             /* (PMC_PLL_ISR1) UPLL Underflow Mask */
#define PMC_PLL_ISR1_UDRU(value)              (PMC_PLL_ISR1_UDRU_Msk & (_UINT32_(value) << PMC_PLL_ISR1_UDRU_Pos)) /* Assigment of value for UDRU in the PMC_PLL_ISR1 register */
#define PMC_PLL_ISR1_OVRA_Pos                 _UINT32_(16)                                         /* (PMC_PLL_ISR1) PLLA Overflow Position */
#define PMC_PLL_ISR1_OVRA_Msk                 (_UINT32_(0x1) << PMC_PLL_ISR1_OVRA_Pos)             /* (PMC_PLL_ISR1) PLLA Overflow Mask */
#define PMC_PLL_ISR1_OVRA(value)              (PMC_PLL_ISR1_OVRA_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVRA_Pos)) /* Assigment of value for OVRA in the PMC_PLL_ISR1 register */
#define PMC_PLL_ISR1_OVRU_Pos                 _UINT32_(17)                                         /* (PMC_PLL_ISR1) UPLL Overflow Position */
#define PMC_PLL_ISR1_OVRU_Msk                 (_UINT32_(0x1) << PMC_PLL_ISR1_OVRU_Pos)             /* (PMC_PLL_ISR1) UPLL Overflow Mask */
#define PMC_PLL_ISR1_OVRU(value)              (PMC_PLL_ISR1_OVRU_Msk & (_UINT32_(value) << PMC_PLL_ISR1_OVRU_Pos)) /* Assigment of value for OVRU in the PMC_PLL_ISR1 register */
#define PMC_PLL_ISR1_Msk                      _UINT32_(0x00030003)                                 /* (PMC_PLL_ISR1) Register Mask  */
...
#define PMC_OCR_REG_OFST               _UINT32_(0x8C)      /* (PMC_OCR) Oscillator Calibration Register Offset */
...
#endif /* _SAM9X6_PMC_COMPONENT_H_ */
