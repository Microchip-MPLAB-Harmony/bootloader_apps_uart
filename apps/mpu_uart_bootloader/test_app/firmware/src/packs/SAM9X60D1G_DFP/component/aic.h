...
#ifndef _SAM9X6_AIC_COMPONENT_H_
#define _SAM9X6_AIC_COMPONENT_H_
...
#define   AIC_SMR_PRIOR_MINIMUM_Val           _UINT32_(0x0)                                        /* (AIC_SMR) Minimum priority  */
#define   AIC_SMR_PRIOR_VERY_LOW_Val          _UINT32_(0x1)                                        /* (AIC_SMR) Very low priority  */
#define   AIC_SMR_PRIOR_LOW_Val               _UINT32_(0x2)                                        /* (AIC_SMR) Low priority  */
#define   AIC_SMR_PRIOR_MEDIUM_LOW_Val        _UINT32_(0x3)                                        /* (AIC_SMR) Medium priority  */
#define   AIC_SMR_PRIOR_MEDIUM_HIGH_Val       _UINT32_(0x4)                                        /* (AIC_SMR) Medium-high priority  */
#define   AIC_SMR_PRIOR_HIGH_Val              _UINT32_(0x5)                                        /* (AIC_SMR) High priority  */
#define   AIC_SMR_PRIOR_VERY_HIGH_Val         _UINT32_(0x6)                                        /* (AIC_SMR) Very high priority  */
#define   AIC_SMR_PRIOR_MAXIMUM_Val           _UINT32_(0x7)                                        /* (AIC_SMR) Maximum priority  */
...
#endif /* _SAM9X6_AIC_COMPONENT_H_ */
