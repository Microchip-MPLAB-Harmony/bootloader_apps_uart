...
#ifndef _SAM9X6_ISI_COMPONENT_H_
#define _SAM9X6_ISI_COMPONENT_H_
...
#define ISI_CFG1_Msk                          _UINT32_(0xFFFF7FDC)                                 /* (ISI_CFG1) Register Mask  */
...
#define   ISI_CFG2_RGB_CFG_DEFAULT_Val        _UINT32_(0x0)                                        /* (ISI_CFG2) Byte 0 R/G(MSB) Byte 1 G(LSB)/B Byte 2 R/G(MSB) Byte 3 G(LSB)/B  */
#define   ISI_CFG2_RGB_CFG_MODE1_Val          _UINT32_(0x1)                                        /* (ISI_CFG2) Byte 0 B/G(MSB) Byte 1 G(LSB)/R Byte 2 B/G(MSB) Byte 3 G(LSB)/R  */
#define   ISI_CFG2_RGB_CFG_MODE2_Val          _UINT32_(0x2)                                        /* (ISI_CFG2) Byte 0 G(LSB)/R Byte 1 B/G(MSB) Byte 2 G(LSB)/R Byte 3 B/G(MSB)  */
#define   ISI_CFG2_RGB_CFG_MODE3_Val          _UINT32_(0x3)                                        /* (ISI_CFG2) Byte 0 G(LSB)/B Byte 1 R/G(MSB) Byte 2 G(LSB)/B Byte 3 R/G(MSB)  */
...
#endif /* _SAM9X6_ISI_COMPONENT_H_ */
