...
#ifndef _SAM9X6_LCDC_COMPONENT_H_
#define _SAM9X6_LCDC_COMPONENT_H_
...
#define LCDC_LCDCFG0_Msk                      _UINT32_(0x00FF0F09)                                 /* (LCDC_LCDCFG0) Register Mask  */
...
#define LCDC_LCDCFG5_Msk                      _UINT32_(0x00FF33DF)                                 /* (LCDC_LCDCFG5) Register Mask  */
...
#define LCDC_LCDIER_Msk                       _UINT32_(0x00000F1F)                                 /* (LCDC_LCDIER) Register Mask  */
...
#define LCDC_LCDIDR_Msk                       _UINT32_(0x00000F1F)                                 /* (LCDC_LCDIDR) Register Mask  */
...
#define LCDC_LCDIMR_Msk                       _UINT32_(0x00000F1F)                                 /* (LCDC_LCDIMR) Register Mask  */
...
#define LCDC_LCDISR_Msk                       _UINT32_(0x00000F1F)                                 /* (LCDC_LCDISR) Register Mask  */
...
#define LCDC_ATTR_Msk                         _UINT32_(0x00000F0F)                                 /* (LCDC_ATTR) Register Mask  */
...
#define LCDC_QOSCFG_QOSLOCK_Pos               _UINT32_(0)                                          /* (LCDC_QOSCFG) Quality Of Service Lock Position */
#define LCDC_QOSCFG_QOSLOCK_Msk               (_UINT32_(0x1) << LCDC_QOSCFG_QOSLOCK_Pos)           /* (LCDC_QOSCFG) Quality Of Service Lock Mask */
#define LCDC_QOSCFG_QOSLOCK(value)            (LCDC_QOSCFG_QOSLOCK_Msk & (_UINT32_(value) << LCDC_QOSCFG_QOSLOCK_Pos)) /* Assigment of value for QOSLOCK in the LCDC_QOSCFG register */
#define LCDC_QOSCFG_QOS1CFG_Pos               _UINT32_(4)                                          /* (LCDC_QOSCFG) Quality Of Service for 0 to 1 Transition Position */
#define LCDC_QOSCFG_QOS1CFG_Msk               (_UINT32_(0x3) << LCDC_QOSCFG_QOS1CFG_Pos)           /* (LCDC_QOSCFG) Quality Of Service for 0 to 1 Transition Mask */
#define LCDC_QOSCFG_QOS1CFG(value)            (LCDC_QOSCFG_QOS1CFG_Msk & (_UINT32_(value) << LCDC_QOSCFG_QOS1CFG_Pos)) /* Assigment of value for QOS1CFG in the LCDC_QOSCFG register */
#define LCDC_QOSCFG_QOS2CFG_Pos               _UINT32_(8)                                          /* (LCDC_QOSCFG) Quality Of Service for 1 to 2 Transition Position */
#define LCDC_QOSCFG_QOS2CFG_Msk               (_UINT32_(0x3) << LCDC_QOSCFG_QOS2CFG_Pos)           /* (LCDC_QOSCFG) Quality Of Service for 1 to 2 Transition Mask */
#define LCDC_QOSCFG_QOS2CFG(value)            (LCDC_QOSCFG_QOS2CFG_Msk & (_UINT32_(value) << LCDC_QOSCFG_QOS2CFG_Pos)) /* Assigment of value for QOS2CFG in the LCDC_QOSCFG register */
#define LCDC_QOSCFG_QOS3CFG_Pos               _UINT32_(12)                                         /* (LCDC_QOSCFG) Quality Of Service for 2 to 3 Transition Position */
#define LCDC_QOSCFG_QOS3CFG_Msk               (_UINT32_(0x3) << LCDC_QOSCFG_QOS3CFG_Pos)           /* (LCDC_QOSCFG) Quality Of Service for 2 to 3 Transition Mask */
#define LCDC_QOSCFG_QOS3CFG(value)            (LCDC_QOSCFG_QOS3CFG_Msk & (_UINT32_(value) << LCDC_QOSCFG_QOS3CFG_Pos)) /* Assigment of value for QOS3CFG in the LCDC_QOSCFG register */
#define LCDC_QOSCFG_Msk                       _UINT32_(0x00003331)                                 /* (LCDC_QOSCFG) Register Mask  */


/* -------- LCDC_QOS1M : (LCDC Offset: 0x44) ( R/ 32) LCD Controller QoS 1 Metrics Register -------- */
#define LCDC_QOS1M_MET1_Pos                   _UINT32_(0)                                          /* (LCDC_QOS1M) Metrics QoS 1 Position */
#define LCDC_QOS1M_MET1_Msk                   (_UINT32_(0xFFFFF) << LCDC_QOS1M_MET1_Pos)           /* (LCDC_QOS1M) Metrics QoS 1 Mask */
#define LCDC_QOS1M_MET1(value)                (LCDC_QOS1M_MET1_Msk & (_UINT32_(value) << LCDC_QOS1M_MET1_Pos)) /* Assigment of value for MET1 in the LCDC_QOS1M register */
#define LCDC_QOS1M_Msk                        _UINT32_(0x000FFFFF)                                 /* (LCDC_QOS1M) Register Mask  */


/* -------- LCDC_QOS2M : (LCDC Offset: 0x48) ( R/ 32) LCD Controller QoS 2 Metrics Register -------- */
#define LCDC_QOS2M_MET2_Pos                   _UINT32_(0)                                          /* (LCDC_QOS2M) Metrics QoS 2 Position */
#define LCDC_QOS2M_MET2_Msk                   (_UINT32_(0xFFFFF) << LCDC_QOS2M_MET2_Pos)           /* (LCDC_QOS2M) Metrics QoS 2 Mask */
#define LCDC_QOS2M_MET2(value)                (LCDC_QOS2M_MET2_Msk & (_UINT32_(value) << LCDC_QOS2M_MET2_Pos)) /* Assigment of value for MET2 in the LCDC_QOS2M register */
#define LCDC_QOS2M_Msk                        _UINT32_(0x000FFFFF)                                 /* (LCDC_QOS2M) Register Mask  */


/* -------- LCDC_QOS3M : (LCDC Offset: 0x4C) ( R/ 32) LCD Controller QoS 3 Metrics Register -------- */
#define LCDC_QOS3M_MET3_Pos                   _UINT32_(0)                                          /* (LCDC_QOS3M) Metrics QoS 3 Position */
#define LCDC_QOS3M_MET3_Msk                   (_UINT32_(0xFFFFF) << LCDC_QOS3M_MET3_Pos)           /* (LCDC_QOS3M) Metrics QoS 3 Mask */
#define LCDC_QOS3M_MET3(value)                (LCDC_QOS3M_MET3_Msk & (_UINT32_(value) << LCDC_QOS3M_MET3_Pos)) /* Assigment of value for MET3 in the LCDC_QOS3M register */
#define LCDC_QOS3M_Msk                        _UINT32_(0x000FFFFF)                                 /* (LCDC_QOS3M) Register Mask  */


/* -------- LCDC_QOSMIN : (LCDC Offset: 0x50) ( R/ 32) LCD Controller QoS Min FIFO Level Register -------- */
#define LCDC_QOSMIN_LEVEL_Pos                 _UINT32_(0)                                          /* (LCDC_QOSMIN) Minimum FIFO Level Position */
#define LCDC_QOSMIN_LEVEL_Msk                 (_UINT32_(0x1FF) << LCDC_QOSMIN_LEVEL_Pos)           /* (LCDC_QOSMIN) Minimum FIFO Level Mask */
#define LCDC_QOSMIN_LEVEL(value)              (LCDC_QOSMIN_LEVEL_Msk & (_UINT32_(value) << LCDC_QOSMIN_LEVEL_Pos)) /* Assigment of value for LEVEL in the LCDC_QOSMIN register */
#define LCDC_QOSMIN_Msk                       _UINT32_(0x000001FF)                                 /* (LCDC_QOSMIN) Register Mask  */
...
#define LCDC_BASECFG0_BLEN_Msk                (_UINT32_(0x3) << LCDC_BASECFG0_BLEN_Pos)            /* (LCDC_BASECFG0) System Bus Burst Length Mask */
...
#define   LCDC_BASECFG0_BLEN_AHB_SINGLE_Val   _UINT32_(0x0)                                        /* (LCDC_BASECFG0) System bus access is started as soon as there is enough space in the FIFO to store one data. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_BASECFG0_BLEN_AHB_INCR4_Val    _UINT32_(0x1)                                        /* (LCDC_BASECFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 4 data. A system bus INCR4 Burst is used. SINGLE, INCR and INCR4 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_BASECFG0_BLEN_AHB_INCR8_Val    _UINT32_(0x2)                                        /* (LCDC_BASECFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 8 data. A system bus INCR8 Burst is used. SINGLE, INCR, INCR4 and INCR8 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_BASECFG0_BLEN_AHB_INCR16_Val   _UINT32_(0x3)                                        /* (LCDC_BASECFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 16 data. A system bus INCR16 Burst is used. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
...
#define LCDC_BASECFG0_Msk                     _UINT32_(0x00000130)                                 /* (LCDC_BASECFG0) Register Mask  */
...
#define LCDC_OVR1CFG0_BLEN_Msk                (_UINT32_(0x3) << LCDC_OVR1CFG0_BLEN_Pos)            /* (LCDC_OVR1CFG0) System Bus Burst Length Mask */
...
#define   LCDC_OVR1CFG0_BLEN_AHB_BLEN_SINGLE_Val _UINT32_(0x0)                                        /* (LCDC_OVR1CFG0) System bus access is started as soon as there is enough space in the FIFO to store one data. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_OVR1CFG0_BLEN_AHB_BLEN_INCR4_Val _UINT32_(0x1)                                        /* (LCDC_OVR1CFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 4 data. A system bus INCR4 Burst is used. SINGLE, INCR and INCR4 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_OVR1CFG0_BLEN_AHB_BLEN_INCR8_Val _UINT32_(0x2)                                        /* (LCDC_OVR1CFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 8 data. A system bus INCR8 Burst is used. SINGLE, INCR, INCR4 and INCR8 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_OVR1CFG0_BLEN_AHB_BLEN_INCR16_Val _UINT32_(0x3)                                        /* (LCDC_OVR1CFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 16 data. A system bus INCR16 Burst is used. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
...
#define LCDC_OVR1CFG0_Msk                     _UINT32_(0x00003130)                                 /* (LCDC_OVR1CFG0) Register Mask  */
...
#define LCDC_OVR2CFG0_BLEN_Msk                (_UINT32_(0x3) << LCDC_OVR2CFG0_BLEN_Pos)            /* (LCDC_OVR2CFG0) System Bus Burst Length Mask */
...
#define   LCDC_OVR2CFG0_BLEN_AHB_SINGLE_Val   _UINT32_(0x0)                                        /* (LCDC_OVR2CFG0) System bus access is started as soon as there is enough space in the FIFO to store one data. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_OVR2CFG0_BLEN_AHB_INCR4_Val    _UINT32_(0x1)                                        /* (LCDC_OVR2CFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 4 data. A system bus INCR4 Burst is used. SINGLE, INCR and INCR4 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_OVR2CFG0_BLEN_AHB_INCR8_Val    _UINT32_(0x2)                                        /* (LCDC_OVR2CFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 8 data. A system bus INCR8 Burst is used. SINGLE, INCR, INCR4 and INCR8 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_OVR2CFG0_BLEN_AHB_INCR16_Val   _UINT32_(0x3)                                        /* (LCDC_OVR2CFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 16 data. A system bus INCR16 Burst is used. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
...
#define LCDC_HEOCFG0_BLEN_Msk                 (_UINT32_(0x3) << LCDC_HEOCFG0_BLEN_Pos)             /* (LCDC_HEOCFG0) System Bus Burst Length Mask */
...
#define   LCDC_HEOCFG0_BLEN_AHB_BLEN_SINGLE_Val _UINT32_(0x0)                                        /* (LCDC_HEOCFG0) System bus access is started as soon as there is enough space in the FIFO to store one data. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_HEOCFG0_BLEN_AHB_BLEN_INCR4_Val _UINT32_(0x1)                                        /* (LCDC_HEOCFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 4 data. A system bus INCR4 Burst is used. SINGLE, INCR and INCR4 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_HEOCFG0_BLEN_AHB_BLEN_INCR8_Val _UINT32_(0x2)                                        /* (LCDC_HEOCFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 8 data. A system bus INCR8 Burst is used. SINGLE, INCR, INCR4 and INCR8 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_HEOCFG0_BLEN_AHB_BLEN_INCR16_Val _UINT32_(0x3)                                        /* (LCDC_HEOCFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 16 data. A system bus INCR16 Burst is used. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
...
#define LCDC_HEOCFG0_BLENUV_Pos               _UINT32_(6)                                          /* (LCDC_HEOCFG0) System Bus Burst Length for U-V Channel Position */
#define LCDC_HEOCFG0_BLENUV_Msk               (_UINT32_(0x3) << LCDC_HEOCFG0_BLENUV_Pos)           /* (LCDC_HEOCFG0) System Bus Burst Length for U-V Channel Mask */
...
#define   LCDC_HEOCFG0_BLENUV_AHB_SINGLE_Val  _UINT32_(0x0)                                        /* (LCDC_HEOCFG0) System bus access is started as soon as there is enough space in the FIFO to store one data. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_HEOCFG0_BLENUV_AHB_INCR4_Val   _UINT32_(0x1)                                        /* (LCDC_HEOCFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 4 data. A system bus INCR4 Burst is used. SINGLE, INCR and INCR4 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_HEOCFG0_BLENUV_AHB_INCR8_Val   _UINT32_(0x2)                                        /* (LCDC_HEOCFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 8 data. A system bus INCR8 Burst is used. SINGLE, INCR, INCR4 and INCR8 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
#define   LCDC_HEOCFG0_BLENUV_AHB_INCR16_Val  _UINT32_(0x3)                                        /* (LCDC_HEOCFG0) System bus access is started as soon as there is enough space in the FIFO to store a total amount of 16 data. A system bus INCR16 Burst is used. SINGLE, INCR, INCR4, INCR8 and INCR16 bursts are used. INCR is used for a burst of 2 and 3 beats.  */
...
#define LCDC_HEOCFG0_Msk                      _UINT32_(0x000031F0)                                 /* (LCDC_HEOCFG0) Register Mask  */
...
#define LCDC_LCDCFG7_REG_OFST          _UINT32_(0x1C)      /* (LCDC_LCDCFG7) LCD Controller Configuration Register 7 Offset */
...
#define LCDC_QOSCFG_REG_OFST           _UINT32_(0x40)      /* (LCDC_QOSCFG) LCD Controller QoS Configuration Register Offset */
#define LCDC_QOS1M_REG_OFST            _UINT32_(0x44)      /* (LCDC_QOS1M) LCD Controller QoS 1 Metrics Register Offset */
#define LCDC_QOS2M_REG_OFST            _UINT32_(0x48)      /* (LCDC_QOS2M) LCD Controller QoS 2 Metrics Register Offset */
#define LCDC_QOS3M_REG_OFST            _UINT32_(0x4C)      /* (LCDC_QOS3M) LCD Controller QoS 3 Metrics Register Offset */
#define LCDC_QOSMIN_REG_OFST           _UINT32_(0x50)      /* (LCDC_QOSMIN) LCD Controller QoS Min FIFO Level Register Offset */
#define LCDC_BASECHER_REG_OFST         _UINT32_(0x60)      /* (LCDC_BASECHER) Base Layer Channel Enable Register Offset */
#define LCDC_BASECHDR_REG_OFST         _UINT32_(0x64)      /* (LCDC_BASECHDR) Base Layer Channel Disable Register Offset */
#define LCDC_BASECHSR_REG_OFST         _UINT32_(0x68)      /* (LCDC_BASECHSR) Base Layer Channel Status Register Offset */
#define LCDC_BASEIER_REG_OFST          _UINT32_(0x6C)      /* (LCDC_BASEIER) Base Layer Interrupt Enable Register Offset */
#define LCDC_BASEIDR_REG_OFST          _UINT32_(0x70)      /* (LCDC_BASEIDR) Base Layer Interrupt Disabled Register Offset */
#define LCDC_BASEIMR_REG_OFST          _UINT32_(0x74)      /* (LCDC_BASEIMR) Base Layer Interrupt Mask Register Offset */
#define LCDC_BASEISR_REG_OFST          _UINT32_(0x78)      /* (LCDC_BASEISR) Base Layer Interrupt Status Register Offset */
#define LCDC_BASEHEAD_REG_OFST         _UINT32_(0x7C)      /* (LCDC_BASEHEAD) Base DMA Head Register Offset */
#define LCDC_BASEADDR_REG_OFST         _UINT32_(0x80)      /* (LCDC_BASEADDR) Base DMA Address Register Offset */
#define LCDC_BASECTRL_REG_OFST         _UINT32_(0x84)      /* (LCDC_BASECTRL) Base DMA Control Register Offset */
#define LCDC_BASENEXT_REG_OFST         _UINT32_(0x88)      /* (LCDC_BASENEXT) Base DMA Next Register Offset */
#define LCDC_BASECFG0_REG_OFST         _UINT32_(0x8C)      /* (LCDC_BASECFG0) Base Layer Configuration Register 0 Offset */
#define LCDC_BASECFG1_REG_OFST         _UINT32_(0x90)      /* (LCDC_BASECFG1) Base Layer Configuration Register 1 Offset */
#define LCDC_BASECFG2_REG_OFST         _UINT32_(0x94)      /* (LCDC_BASECFG2) Base Layer Configuration Register 2 Offset */
#define LCDC_BASECFG3_REG_OFST         _UINT32_(0x98)      /* (LCDC_BASECFG3) Base Layer Configuration Register 3 Offset */
#define LCDC_BASECFG4_REG_OFST         _UINT32_(0x9C)      /* (LCDC_BASECFG4) Base Layer Configuration Register 4 Offset */
#define LCDC_BASECFG5_REG_OFST         _UINT32_(0xA0)      /* (LCDC_BASECFG5) Base Layer Configuration Register 5 Offset */
#define LCDC_BASECFG6_REG_OFST         _UINT32_(0xA4)      /* (LCDC_BASECFG6) Base Layer Configuration Register 6 Offset */
#define LCDC_OVR1CHER_REG_OFST         _UINT32_(0x160)     /* (LCDC_OVR1CHER) Overlay 1 Channel Enable Register Offset */
#define LCDC_OVR1CHDR_REG_OFST         _UINT32_(0x164)     /* (LCDC_OVR1CHDR) Overlay 1 Channel Disable Register Offset */
#define LCDC_OVR1CHSR_REG_OFST         _UINT32_(0x168)     /* (LCDC_OVR1CHSR) Overlay 1 Channel Status Register Offset */
#define LCDC_OVR1IER_REG_OFST          _UINT32_(0x16C)     /* (LCDC_OVR1IER) Overlay 1 Interrupt Enable Register Offset */
#define LCDC_OVR1IDR_REG_OFST          _UINT32_(0x170)     /* (LCDC_OVR1IDR) Overlay 1 Interrupt Disable Register Offset */
#define LCDC_OVR1IMR_REG_OFST          _UINT32_(0x174)     /* (LCDC_OVR1IMR) Overlay 1 Interrupt Mask Register Offset */
#define LCDC_OVR1ISR_REG_OFST          _UINT32_(0x178)     /* (LCDC_OVR1ISR) Overlay 1 Interrupt Status Register Offset */
#define LCDC_OVR1HEAD_REG_OFST         _UINT32_(0x17C)     /* (LCDC_OVR1HEAD) Overlay 1 DMA Head Register Offset */
#define LCDC_OVR1ADDR_REG_OFST         _UINT32_(0x180)     /* (LCDC_OVR1ADDR) Overlay 1 DMA Address Register Offset */
#define LCDC_OVR1CTRL_REG_OFST         _UINT32_(0x184)     /* (LCDC_OVR1CTRL) Overlay 1 DMA Control Register Offset */
#define LCDC_OVR1NEXT_REG_OFST         _UINT32_(0x188)     /* (LCDC_OVR1NEXT) Overlay 1 DMA Next Register Offset */
#define LCDC_OVR1CFG0_REG_OFST         _UINT32_(0x18C)     /* (LCDC_OVR1CFG0) Overlay 1 Configuration Register 0 Offset */
#define LCDC_OVR1CFG1_REG_OFST         _UINT32_(0x190)     /* (LCDC_OVR1CFG1) Overlay 1 Configuration Register 1 Offset */
#define LCDC_OVR1CFG2_REG_OFST         _UINT32_(0x194)     /* (LCDC_OVR1CFG2) Overlay 1 Configuration Register 2 Offset */
#define LCDC_OVR1CFG3_REG_OFST         _UINT32_(0x198)     /* (LCDC_OVR1CFG3) Overlay 1 Configuration Register 3 Offset */
#define LCDC_OVR1CFG4_REG_OFST         _UINT32_(0x19C)     /* (LCDC_OVR1CFG4) Overlay 1 Configuration Register 4 Offset */
#define LCDC_OVR1CFG5_REG_OFST         _UINT32_(0x1A0)     /* (LCDC_OVR1CFG5) Overlay 1 Configuration Register 5 Offset */
#define LCDC_OVR1CFG6_REG_OFST         _UINT32_(0x1A4)     /* (LCDC_OVR1CFG6) Overlay 1 Configuration Register 6 Offset */
#define LCDC_OVR1CFG7_REG_OFST         _UINT32_(0x1A8)     /* (LCDC_OVR1CFG7) Overlay 1 Configuration Register 7 Offset */
#define LCDC_OVR1CFG8_REG_OFST         _UINT32_(0x1AC)     /* (LCDC_OVR1CFG8) Overlay 1 Configuration Register 8 Offset */
#define LCDC_OVR1CFG9_REG_OFST         _UINT32_(0x1B0)     /* (LCDC_OVR1CFG9) Overlay 1 Configuration Register 9 Offset */
#define LCDC_OVR2CHER_REG_OFST         _UINT32_(0x260)     /* (LCDC_OVR2CHER) Overlay 2 Channel Enable Register Offset */
#define LCDC_OVR2CHDR_REG_OFST         _UINT32_(0x264)     /* (LCDC_OVR2CHDR) Overlay 2 Channel Disable Register Offset */
#define LCDC_OVR2CHSR_REG_OFST         _UINT32_(0x268)     /* (LCDC_OVR2CHSR) Overlay 2 Channel Status Register Offset */
#define LCDC_OVR2IER_REG_OFST          _UINT32_(0x26C)     /* (LCDC_OVR2IER) Overlay 2 Interrupt Enable Register Offset */
#define LCDC_OVR2IDR_REG_OFST          _UINT32_(0x270)     /* (LCDC_OVR2IDR) Overlay 2 Interrupt Disable Register Offset */
#define LCDC_OVR2IMR_REG_OFST          _UINT32_(0x274)     /* (LCDC_OVR2IMR) Overlay 2 Interrupt Mask Register Offset */
#define LCDC_OVR2ISR_REG_OFST          _UINT32_(0x278)     /* (LCDC_OVR2ISR) Overlay 2 Interrupt Status Register Offset */
#define LCDC_OVR2HEAD_REG_OFST         _UINT32_(0x27C)     /* (LCDC_OVR2HEAD) Overlay 2 DMA Head Register Offset */
#define LCDC_OVR2ADDR_REG_OFST         _UINT32_(0x280)     /* (LCDC_OVR2ADDR) Overlay 2 DMA Address Register Offset */
#define LCDC_OVR2CTRL_REG_OFST         _UINT32_(0x284)     /* (LCDC_OVR2CTRL) Overlay 2 DMA Control Register Offset */
#define LCDC_OVR2NEXT_REG_OFST         _UINT32_(0x288)     /* (LCDC_OVR2NEXT) Overlay 2 DMA Next Register Offset */
#define LCDC_OVR2CFG0_REG_OFST         _UINT32_(0x28C)     /* (LCDC_OVR2CFG0) Overlay 2 Configuration Register 0 Offset */
#define LCDC_OVR2CFG1_REG_OFST         _UINT32_(0x290)     /* (LCDC_OVR2CFG1) Overlay 2 Configuration Register 1 Offset */
#define LCDC_OVR2CFG2_REG_OFST         _UINT32_(0x294)     /* (LCDC_OVR2CFG2) Overlay 2 Configuration Register 2 Offset */
#define LCDC_OVR2CFG3_REG_OFST         _UINT32_(0x298)     /* (LCDC_OVR2CFG3) Overlay 2 Configuration Register 3 Offset */
#define LCDC_OVR2CFG4_REG_OFST         _UINT32_(0x29C)     /* (LCDC_OVR2CFG4) Overlay 2 Configuration Register 4 Offset */
#define LCDC_OVR2CFG5_REG_OFST         _UINT32_(0x2A0)     /* (LCDC_OVR2CFG5) Overlay 2 Configuration Register 5 Offset */
#define LCDC_OVR2CFG6_REG_OFST         _UINT32_(0x2A4)     /* (LCDC_OVR2CFG6) Overlay 2 Configuration Register 6 Offset */
#define LCDC_OVR2CFG7_REG_OFST         _UINT32_(0x2A8)     /* (LCDC_OVR2CFG7) Overlay 2 Configuration Register 7 Offset */
#define LCDC_OVR2CFG8_REG_OFST         _UINT32_(0x2AC)     /* (LCDC_OVR2CFG8) Overlay 2 Configuration Register 8 Offset */
#define LCDC_OVR2CFG9_REG_OFST         _UINT32_(0x2B0)     /* (LCDC_OVR2CFG9) Overlay 2 Configuration Register 9 Offset */
#define LCDC_HEOCHER_REG_OFST          _UINT32_(0x360)     /* (LCDC_HEOCHER) High-End Overlay Channel Enable Register Offset */
#define LCDC_HEOCHDR_REG_OFST          _UINT32_(0x364)     /* (LCDC_HEOCHDR) High-End Overlay Channel Disable Register Offset */
#define LCDC_HEOCHSR_REG_OFST          _UINT32_(0x368)     /* (LCDC_HEOCHSR) High-End Overlay Channel Status Register Offset */
#define LCDC_HEOIER_REG_OFST           _UINT32_(0x36C)     /* (LCDC_HEOIER) High-End Overlay Interrupt Enable Register Offset */
#define LCDC_HEOIDR_REG_OFST           _UINT32_(0x370)     /* (LCDC_HEOIDR) High-End Overlay Interrupt Disable Register Offset */
#define LCDC_HEOIMR_REG_OFST           _UINT32_(0x374)     /* (LCDC_HEOIMR) High-End Overlay Interrupt Mask Register Offset */
#define LCDC_HEOISR_REG_OFST           _UINT32_(0x378)     /* (LCDC_HEOISR) High-End Overlay Interrupt Status Register Offset */
#define LCDC_HEOHEAD_REG_OFST          _UINT32_(0x37C)     /* (LCDC_HEOHEAD) High-End Overlay DMA Head Register Offset */
#define LCDC_HEOADDR_REG_OFST          _UINT32_(0x380)     /* (LCDC_HEOADDR) High-End Overlay DMA Address Register Offset */
#define LCDC_HEOCTRL_REG_OFST          _UINT32_(0x384)     /* (LCDC_HEOCTRL) High-End Overlay DMA Control Register Offset */
#define LCDC_HEONEXT_REG_OFST          _UINT32_(0x388)     /* (LCDC_HEONEXT) High-End Overlay DMA Next Register Offset */
#define LCDC_HEOUHEAD_REG_OFST         _UINT32_(0x38C)     /* (LCDC_HEOUHEAD) High-End Overlay U-UV DMA Head Register Offset */
#define LCDC_HEOUADDR_REG_OFST         _UINT32_(0x390)     /* (LCDC_HEOUADDR) High-End Overlay U-UV DMA Address Register Offset */
#define LCDC_HEOUCTRL_REG_OFST         _UINT32_(0x394)     /* (LCDC_HEOUCTRL) High-End Overlay U-UV DMA Control Register Offset */
#define LCDC_HEOUNEXT_REG_OFST         _UINT32_(0x398)     /* (LCDC_HEOUNEXT) High-End Overlay U-UV DMA Next Register Offset */
#define LCDC_HEOVHEAD_REG_OFST         _UINT32_(0x39C)     /* (LCDC_HEOVHEAD) High-End Overlay V DMA Head Register Offset */
#define LCDC_HEOVADDR_REG_OFST         _UINT32_(0x3A0)     /* (LCDC_HEOVADDR) High-End Overlay V DMA Address Register Offset */
#define LCDC_HEOVCTRL_REG_OFST         _UINT32_(0x3A4)     /* (LCDC_HEOVCTRL) High-End Overlay V DMA Control Register Offset */
#define LCDC_HEOVNEXT_REG_OFST         _UINT32_(0x3A8)     /* (LCDC_HEOVNEXT) High-End Overlay V DMA Next Register Offset */
#define LCDC_HEOCFG0_REG_OFST          _UINT32_(0x3AC)     /* (LCDC_HEOCFG0) High-End Overlay Configuration Register 0 Offset */
#define LCDC_HEOCFG1_REG_OFST          _UINT32_(0x3B0)     /* (LCDC_HEOCFG1) High-End Overlay Configuration Register 1 Offset */
#define LCDC_HEOCFG2_REG_OFST          _UINT32_(0x3B4)     /* (LCDC_HEOCFG2) High-End Overlay Configuration Register 2 Offset */
#define LCDC_HEOCFG3_REG_OFST          _UINT32_(0x3B8)     /* (LCDC_HEOCFG3) High-End Overlay Configuration Register 3 Offset */
#define LCDC_HEOCFG4_REG_OFST          _UINT32_(0x3BC)     /* (LCDC_HEOCFG4) High-End Overlay Configuration Register 4 Offset */
#define LCDC_HEOCFG5_REG_OFST          _UINT32_(0x3C0)     /* (LCDC_HEOCFG5) High-End Overlay Configuration Register 5 Offset */
#define LCDC_HEOCFG6_REG_OFST          _UINT32_(0x3C4)     /* (LCDC_HEOCFG6) High-End Overlay Configuration Register 6 Offset */
#define LCDC_HEOCFG7_REG_OFST          _UINT32_(0x3C8)     /* (LCDC_HEOCFG7) High-End Overlay Configuration Register 7 Offset */
#define LCDC_HEOCFG8_REG_OFST          _UINT32_(0x3CC)     /* (LCDC_HEOCFG8) High-End Overlay Configuration Register 8 Offset */
#define LCDC_HEOCFG9_REG_OFST          _UINT32_(0x3D0)     /* (LCDC_HEOCFG9) High-End Overlay Configuration Register 9 Offset */
#define LCDC_HEOCFG10_REG_OFST         _UINT32_(0x3D4)     /* (LCDC_HEOCFG10) High-End Overlay Configuration Register 10 Offset */
#define LCDC_HEOCFG11_REG_OFST         _UINT32_(0x3D8)     /* (LCDC_HEOCFG11) High-End Overlay Configuration Register 11 Offset */
#define LCDC_HEOCFG12_REG_OFST         _UINT32_(0x3DC)     /* (LCDC_HEOCFG12) High-End Overlay Configuration Register 12 Offset */
#define LCDC_HEOCFG13_REG_OFST         _UINT32_(0x3E0)     /* (LCDC_HEOCFG13) High-End Overlay Configuration Register 13 Offset */
#define LCDC_HEOCFG14_REG_OFST         _UINT32_(0x3E4)     /* (LCDC_HEOCFG14) High-End Overlay Configuration Register 14 Offset */
#define LCDC_HEOCFG15_REG_OFST         _UINT32_(0x3E8)     /* (LCDC_HEOCFG15) High-End Overlay Configuration Register 15 Offset */
#define LCDC_HEOCFG16_REG_OFST         _UINT32_(0x3EC)     /* (LCDC_HEOCFG16) High-End Overlay Configuration Register 16 Offset */
#define LCDC_HEOCFG17_REG_OFST         _UINT32_(0x3F0)     /* (LCDC_HEOCFG17) High-End Overlay Configuration Register 17 Offset */
#define LCDC_HEOCFG18_REG_OFST         _UINT32_(0x3F4)     /* (LCDC_HEOCFG18) High-End Overlay Configuration Register 18 Offset */
#define LCDC_HEOCFG19_REG_OFST         _UINT32_(0x3F8)     /* (LCDC_HEOCFG19) High-End Overlay Configuration Register 19 Offset */
#define LCDC_HEOCFG20_REG_OFST         _UINT32_(0x3FC)     /* (LCDC_HEOCFG20) High-End Overlay Configuration Register 20 Offset */
#define LCDC_HEOCFG21_REG_OFST         _UINT32_(0x400)     /* (LCDC_HEOCFG21) High-End Overlay Configuration Register 21 Offset */
#define LCDC_HEOCFG22_REG_OFST         _UINT32_(0x404)     /* (LCDC_HEOCFG22) High-End Overlay Configuration Register 22 Offset */
#define LCDC_HEOCFG23_REG_OFST         _UINT32_(0x408)     /* (LCDC_HEOCFG23) High-End Overlay Configuration Register 23 Offset */
#define LCDC_HEOCFG24_REG_OFST         _UINT32_(0x40C)     /* (LCDC_HEOCFG24) High-End Overlay Configuration Register 24 Offset */
#define LCDC_HEOCFG25_REG_OFST         _UINT32_(0x410)     /* (LCDC_HEOCFG25) High-End Overlay Configuration Register 25 Offset */
#define LCDC_HEOCFG26_REG_OFST         _UINT32_(0x414)     /* (LCDC_HEOCFG26) High-End Overlay Configuration Register 26 Offset */
#define LCDC_HEOCFG27_REG_OFST         _UINT32_(0x418)     /* (LCDC_HEOCFG27) High-End Overlay Configuration Register 27 Offset */
#define LCDC_HEOCFG28_REG_OFST         _UINT32_(0x41C)     /* (LCDC_HEOCFG28) High-End Overlay Configuration Register 28 Offset */
#define LCDC_HEOCFG29_REG_OFST         _UINT32_(0x420)     /* (LCDC_HEOCFG29) High-End Overlay Configuration Register 29 Offset */
#define LCDC_HEOCFG30_REG_OFST         _UINT32_(0x424)     /* (LCDC_HEOCFG30) High-End Overlay Configuration Register 30 Offset */
#define LCDC_HEOCFG31_REG_OFST         _UINT32_(0x428)     /* (LCDC_HEOCFG31) High-End Overlay Configuration Register 31 Offset */
#define LCDC_HEOCFG32_REG_OFST         _UINT32_(0x42C)     /* (LCDC_HEOCFG32) High-End Overlay Configuration Register 32 Offset */
#define LCDC_HEOCFG33_REG_OFST         _UINT32_(0x430)     /* (LCDC_HEOCFG33) High-End Overlay Configuration Register 33 Offset */
#define LCDC_HEOCFG34_REG_OFST         _UINT32_(0x434)     /* (LCDC_HEOCFG34) High-End Overlay Configuration Register 34 Offset */
#define LCDC_HEOCFG35_REG_OFST         _UINT32_(0x438)     /* (LCDC_HEOCFG35) High-End Overlay Configuration Register 35 Offset */
#define LCDC_HEOCFG36_REG_OFST         _UINT32_(0x43C)     /* (LCDC_HEOCFG36) High-End Overlay Configuration Register 36 Offset */
#define LCDC_HEOCFG37_REG_OFST         _UINT32_(0x440)     /* (LCDC_HEOCFG37) High-End Overlay Configuration Register 37 Offset */
#define LCDC_HEOCFG38_REG_OFST         _UINT32_(0x444)     /* (LCDC_HEOCFG38) High-End Overlay Configuration Register 38 Offset */
#define LCDC_HEOCFG39_REG_OFST         _UINT32_(0x448)     /* (LCDC_HEOCFG39) High-End Overlay Configuration Register 39 Offset */
#define LCDC_HEOCFG40_REG_OFST         _UINT32_(0x44C)     /* (LCDC_HEOCFG40) High-End Overlay Configuration Register 40 Offset */
#define LCDC_HEOCFG41_REG_OFST         _UINT32_(0x450)     /* (LCDC_HEOCFG41) High-End Overlay Configuration Register 41 Offset */
...
#endif /* _SAM9X6_LCDC_COMPONENT_H_ */
