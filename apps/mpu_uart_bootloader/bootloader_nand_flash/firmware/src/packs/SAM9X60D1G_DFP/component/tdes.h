...
#ifndef _SAM9X6_TDES_COMPONENT_H_
#define _SAM9X6_TDES_COMPONENT_H_
...
#define TDES_CR_LOADSEED_Pos                  _UINT32_(16)                                         /* (TDES_CR) Loadseed Position */
#define TDES_CR_LOADSEED_Msk                  (_UINT32_(0x1) << TDES_CR_LOADSEED_Pos)              /* (TDES_CR) Loadseed Mask */
#define TDES_CR_LOADSEED(value)               (TDES_CR_LOADSEED_Msk & (_UINT32_(value) << TDES_CR_LOADSEED_Pos)) /* Assigment of value for LOADSEED in the TDES_CR register */
...
#define TDES_CR_Msk                           _UINT32_(0x01010101)                                 /* (TDES_CR) Register Mask  */
...
#define TDES_MR_CKEY_Pos                      _UINT32_(20)                                         /* (TDES_MR) Countermeasure Key Position */
#define TDES_MR_CKEY_Msk                      (_UINT32_(0xF) << TDES_MR_CKEY_Pos)                  /* (TDES_MR) Countermeasure Key Mask */
#define TDES_MR_CKEY(value)                   (TDES_MR_CKEY_Msk & (_UINT32_(value) << TDES_MR_CKEY_Pos)) /* Assigment of value for CKEY in the TDES_MR register */
#define TDES_MR_CMTYP1_Pos                    _UINT32_(24)                                         /* (TDES_MR) Countermeasure Type 1 Position */
#define TDES_MR_CMTYP1_Msk                    (_UINT32_(0x1) << TDES_MR_CMTYP1_Pos)                /* (TDES_MR) Countermeasure Type 1 Mask */
#define TDES_MR_CMTYP1(value)                 (TDES_MR_CMTYP1_Msk & (_UINT32_(value) << TDES_MR_CMTYP1_Pos)) /* Assigment of value for CMTYP1 in the TDES_MR register */
#define   TDES_MR_CMTYP1_NO_PAUSE_Val         _UINT32_(0x0)                                        /* (TDES_MR) Countermeasure type 1 is disabled.  */
#define   TDES_MR_CMTYP1_PAUSE_Val            _UINT32_(0x1)                                        /* (TDES_MR) Countermeasure type 1 is enabled.  */
...
#define TDES_MR_CMTYP2_Pos                    _UINT32_(25)                                         /* (TDES_MR) Countermeasure Type 2 Position */
#define TDES_MR_CMTYP2_Msk                    (_UINT32_(0x1) << TDES_MR_CMTYP2_Pos)                /* (TDES_MR) Countermeasure Type 2 Mask */
#define TDES_MR_CMTYP2(value)                 (TDES_MR_CMTYP2_Msk & (_UINT32_(value) << TDES_MR_CMTYP2_Pos)) /* Assigment of value for CMTYP2 in the TDES_MR register */
#define   TDES_MR_CMTYP2_NO_DUMMY_Val         _UINT32_(0x0)                                        /* (TDES_MR) Countermeasure type 2 is disabled.  */
#define   TDES_MR_CMTYP2_DUMMY_Val            _UINT32_(0x1)                                        /* (TDES_MR) Countermeasure type 2 is enabled.  */
...
#define TDES_MR_CMTYP3_Pos                    _UINT32_(26)                                         /* (TDES_MR) Countermeasure Type 3 Position */
#define TDES_MR_CMTYP3_Msk                    (_UINT32_(0x1) << TDES_MR_CMTYP3_Pos)                /* (TDES_MR) Countermeasure Type 3 Mask */
#define TDES_MR_CMTYP3(value)                 (TDES_MR_CMTYP3_Msk & (_UINT32_(value) << TDES_MR_CMTYP3_Pos)) /* Assigment of value for CMTYP3 in the TDES_MR register */
#define   TDES_MR_CMTYP3_NO_RESTART_Val       _UINT32_(0x0)                                        /* (TDES_MR) Countermeasure type 3 is disabled.  */
#define   TDES_MR_CMTYP3_RESTART_Val          _UINT32_(0x1)                                        /* (TDES_MR) Countermeasure type 3 is enabled.  */
...
#define TDES_MR_CMTYP4_Pos                    _UINT32_(27)                                         /* (TDES_MR) Countermeasure Type 4 Position */
#define TDES_MR_CMTYP4_Msk                    (_UINT32_(0x1) << TDES_MR_CMTYP4_Pos)                /* (TDES_MR) Countermeasure Type 4 Mask */
#define TDES_MR_CMTYP4(value)                 (TDES_MR_CMTYP4_Msk & (_UINT32_(value) << TDES_MR_CMTYP4_Pos)) /* Assigment of value for CMTYP4 in the TDES_MR register */
#define   TDES_MR_CMTYP4_NO_IDLECURRENT_Val   _UINT32_(0x0)                                        /* (TDES_MR) Countermeasure type 4 is disabled.  */
#define   TDES_MR_CMTYP4_IDLECURRENT_Val      _UINT32_(0x1)                                        /* (TDES_MR) Countermeasure type 4 is enabled.  */
...
#define TDES_MR_CMTYP5_Pos                    _UINT32_(28)                                         /* (TDES_MR) Countermeasure Type 5 Position */
#define TDES_MR_CMTYP5_Msk                    (_UINT32_(0x1) << TDES_MR_CMTYP5_Pos)                /* (TDES_MR) Countermeasure Type 5 Mask */
#define TDES_MR_CMTYP5(value)                 (TDES_MR_CMTYP5_Msk & (_UINT32_(value) << TDES_MR_CMTYP5_Pos)) /* Assigment of value for CMTYP5 in the TDES_MR register */
#define   TDES_MR_CMTYP5_NO_ADDACCESS_Val     _UINT32_(0x0)                                        /* (TDES_MR) Countermeasure type 5 is disabled.  */
#define   TDES_MR_CMTYP5_ADDACCESS_Val        _UINT32_(0x1)                                        /* (TDES_MR) Countermeasure type 5 is enabled.  */
...
#define TDES_MR_CMTYP6_Pos                    _UINT32_(29)                                         /* (TDES_MR) Countermeasure Type 6 Position */
#define TDES_MR_CMTYP6_Msk                    (_UINT32_(0x1) << TDES_MR_CMTYP6_Pos)                /* (TDES_MR) Countermeasure Type 6 Mask */
#define TDES_MR_CMTYP6(value)                 (TDES_MR_CMTYP6_Msk & (_UINT32_(value) << TDES_MR_CMTYP6_Pos)) /* Assigment of value for CMTYP6 in the TDES_MR register */
#define   TDES_MR_CMTYP6_NO_UNIFORM_Val       _UINT32_(0x0)                                        /* (TDES_MR) Countermeasure type 6 is disabled.  */
#define   TDES_MR_CMTYP6_UNIFORM_Val          _UINT32_(0x1)                                        /* (TDES_MR) Countermeasure type 6 is enabled.  */
...
#define TDES_MR_CMTYP7_Pos                    _UINT32_(30)                                         /* (TDES_MR) Countermeasure Type 7 Position */
#define TDES_MR_CMTYP7_Msk                    (_UINT32_(0x1) << TDES_MR_CMTYP7_Pos)                /* (TDES_MR) Countermeasure Type 7 Mask */
#define TDES_MR_CMTYP7(value)                 (TDES_MR_CMTYP7_Msk & (_UINT32_(value) << TDES_MR_CMTYP7_Pos)) /* Assigment of value for CMTYP7 in the TDES_MR register */
#define   TDES_MR_CMTYP7_NO_STARTDELAY_Val    _UINT32_(0x0)                                        /* (TDES_MR) Countermeasure type 7 is disabled.  */
#define   TDES_MR_CMTYP7_STARTDELAY_Val       _UINT32_(0x1)                                        /* (TDES_MR) Countermeasure type 7 is enabled.  */
...
#define TDES_MR_Msk                           _UINT32_(0xFFF3B3D7)                                 /* (TDES_MR) Register Mask  */

#define TDES_MR_CMTYP_Pos                     _UINT32_(24)                                         /* (TDES_MR Position) Countermeasure Type x */
#define TDES_MR_CMTYP_Msk                     (_UINT32_(0x7F) << TDES_MR_CMTYP_Pos)                /* (TDES_MR Mask) CMTYP */
#define TDES_MR_CMTYP(value)                  (TDES_MR_CMTYP_Msk & (_UINT32_(value) << TDES_MR_CMTYP_Pos)) 
...
#endif /* _SAM9X6_TDES_COMPONENT_H_ */
