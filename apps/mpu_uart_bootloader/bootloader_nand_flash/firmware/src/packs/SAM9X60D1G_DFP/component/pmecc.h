...
#ifndef _SAM9X6_PMECC_COMPONENT_H_
#define _SAM9X6_PMECC_COMPONENT_H_
...
#define   PMECC_CFG_PAGESIZE_PAGESIZE_8SEC_Val _UINT32_(0x3)                                        /* (PMECC_CFG) 8 sectors for main area (4096 or 8192 bytes)  */
...
#define PMECC_ECC_REG_OFST             _UINT32_(0x00)      /* (PMECC_ECC) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC0_REG_OFST            _UINT32_(0x00)      /* (PMECC_ECC0) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC1_REG_OFST            _UINT32_(0x04)      /* (PMECC_ECC1) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC2_REG_OFST            _UINT32_(0x08)      /* (PMECC_ECC2) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC3_REG_OFST            _UINT32_(0x0C)      /* (PMECC_ECC3) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC4_REG_OFST            _UINT32_(0x10)      /* (PMECC_ECC4) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC5_REG_OFST            _UINT32_(0x14)      /* (PMECC_ECC5) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC6_REG_OFST            _UINT32_(0x18)      /* (PMECC_ECC6) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC7_REG_OFST            _UINT32_(0x1C)      /* (PMECC_ECC7) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC8_REG_OFST            _UINT32_(0x20)      /* (PMECC_ECC8) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC9_REG_OFST            _UINT32_(0x24)      /* (PMECC_ECC9) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_ECC10_REG_OFST           _UINT32_(0x28)      /* (PMECC_ECC10) PMECC ECC 0 Register (sec_num = 0) Offset */
#define PMECC_REM_REG_OFST             _UINT32_(0x00)      /* (PMECC_REM) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM0_REG_OFST            _UINT32_(0x00)      /* (PMECC_REM0) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM1_REG_OFST            _UINT32_(0x04)      /* (PMECC_REM1) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM2_REG_OFST            _UINT32_(0x08)      /* (PMECC_REM2) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM3_REG_OFST            _UINT32_(0x0C)      /* (PMECC_REM3) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM4_REG_OFST            _UINT32_(0x10)      /* (PMECC_REM4) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM5_REG_OFST            _UINT32_(0x14)      /* (PMECC_REM5) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM6_REG_OFST            _UINT32_(0x18)      /* (PMECC_REM6) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM7_REG_OFST            _UINT32_(0x1C)      /* (PMECC_REM7) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM8_REG_OFST            _UINT32_(0x20)      /* (PMECC_REM8) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM9_REG_OFST            _UINT32_(0x24)      /* (PMECC_REM9) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM10_REG_OFST           _UINT32_(0x28)      /* (PMECC_REM10) PMECC REM 0 Register (sec_num = 0) Offset */
#define PMECC_REM11_REG_OFST           _UINT32_(0x2C)      /* (PMECC_REM11) PMECC REM 0 Register (sec_num = 0) Offset */
...
#endif /* _SAM9X6_PMECC_COMPONENT_H_ */
