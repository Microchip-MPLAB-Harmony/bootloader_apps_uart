...
#define CAN_MRCFG_OFFSET(value)               (CAN_MRCFG_OFFSET_Msk & (_UINT32_(value) << CAN_MRCFG_OFFSET_Pos)) /* Assignment of value for OFFSET in the CAN_MRCFG register */
...
#define CAN_ERROR_BERR(value)                 (CAN_ERROR_BERR_Msk & (_UINT32_(value) << CAN_ERROR_BERR_Pos)) /* Assignment of value for BERR in the CAN_ERROR register */
...
#endif /* _PIC32WM_BZ6_CAN_COMPONENT_H_ */
