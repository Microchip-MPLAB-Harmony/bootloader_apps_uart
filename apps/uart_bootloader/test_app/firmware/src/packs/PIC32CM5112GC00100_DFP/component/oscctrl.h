...
#ifndef _PIC32CMGC00_OSCCTRL_COMPONENT_H_
#define _PIC32CMGC00_OSCCTRL_COMPONENT_H_
...
#define   OSCCTRL_XOSCCTRLA_CFDPRESC_DIV128_Val _UINT32_(0x7)                                        /* (OSCCTRL_XOSCCTRLA) 0.375 MHz  */
#define   OSCCTRL_XOSCCTRLA_CFDPRESC_DIV256_Val _UINT32_(0x8)                                        /* (OSCCTRL_XOSCCTRLA) 187.5 KHz  */
#define   OSCCTRL_XOSCCTRLA_CFDPRESC_DIV512_Val _UINT32_(0x9)                                        /* (OSCCTRL_XOSCCTRLA) 93.75 KHz  */
#define   OSCCTRL_XOSCCTRLA_CFDPRESC_DIV1024_Val _UINT32_(0xA)                                        /* (OSCCTRL_XOSCCTRLA) 46.875 KHz  */
#define   OSCCTRL_XOSCCTRLA_CFDPRESC_DIV2048_Val _UINT32_(0xB)                                        /* (OSCCTRL_XOSCCTRLA) 23.437 KHz  */
#define   OSCCTRL_XOSCCTRLA_CFDPRESC_DIV4096_Val _UINT32_(0xC)                                        /* (OSCCTRL_XOSCCTRLA) 11.718 KHz  */
#define   OSCCTRL_XOSCCTRLA_CFDPRESC_DIV8192_Val _UINT32_(0xD)                                        /* (OSCCTRL_XOSCCTRLA) 5.85 KHz  */
#define   OSCCTRL_XOSCCTRLA_CFDPRESC_DIV16384_Val _UINT32_(0xE)                                        /* (OSCCTRL_XOSCCTRLA) 2.92 KHz  */
#define   OSCCTRL_XOSCCTRLA_CFDPRESC_DIV32768_Val _UINT32_(0xF)                                        /* (OSCCTRL_XOSCCTRLA) 1.46 KHz  */
...
#define OSCCTRL_XOSCCTRLA_CFDPRESC_DIV128     (OSCCTRL_XOSCCTRLA_CFDPRESC_DIV128_Val << OSCCTRL_XOSCCTRLA_CFDPRESC_Pos) /* (OSCCTRL_XOSCCTRLA) 0.375 MHz Position */
#define OSCCTRL_XOSCCTRLA_CFDPRESC_DIV256     (OSCCTRL_XOSCCTRLA_CFDPRESC_DIV256_Val << OSCCTRL_XOSCCTRLA_CFDPRESC_Pos) /* (OSCCTRL_XOSCCTRLA) 187.5 KHz Position */
#define OSCCTRL_XOSCCTRLA_CFDPRESC_DIV512     (OSCCTRL_XOSCCTRLA_CFDPRESC_DIV512_Val << OSCCTRL_XOSCCTRLA_CFDPRESC_Pos) /* (OSCCTRL_XOSCCTRLA) 93.75 KHz Position */
#define OSCCTRL_XOSCCTRLA_CFDPRESC_DIV1024    (OSCCTRL_XOSCCTRLA_CFDPRESC_DIV1024_Val << OSCCTRL_XOSCCTRLA_CFDPRESC_Pos) /* (OSCCTRL_XOSCCTRLA) 46.875 KHz Position */
#define OSCCTRL_XOSCCTRLA_CFDPRESC_DIV2048    (OSCCTRL_XOSCCTRLA_CFDPRESC_DIV2048_Val << OSCCTRL_XOSCCTRLA_CFDPRESC_Pos) /* (OSCCTRL_XOSCCTRLA) 23.437 KHz Position */
#define OSCCTRL_XOSCCTRLA_CFDPRESC_DIV4096    (OSCCTRL_XOSCCTRLA_CFDPRESC_DIV4096_Val << OSCCTRL_XOSCCTRLA_CFDPRESC_Pos) /* (OSCCTRL_XOSCCTRLA) 11.718 KHz Position */
#define OSCCTRL_XOSCCTRLA_CFDPRESC_DIV8192    (OSCCTRL_XOSCCTRLA_CFDPRESC_DIV8192_Val << OSCCTRL_XOSCCTRLA_CFDPRESC_Pos) /* (OSCCTRL_XOSCCTRLA) 5.85 KHz Position */
#define OSCCTRL_XOSCCTRLA_CFDPRESC_DIV16384   (OSCCTRL_XOSCCTRLA_CFDPRESC_DIV16384_Val << OSCCTRL_XOSCCTRLA_CFDPRESC_Pos) /* (OSCCTRL_XOSCCTRLA) 2.92 KHz Position */
#define OSCCTRL_XOSCCTRLA_CFDPRESC_DIV32768   (OSCCTRL_XOSCCTRLA_CFDPRESC_DIV32768_Val << OSCCTRL_XOSCCTRLA_CFDPRESC_Pos) /* (OSCCTRL_XOSCCTRLA) 1.46 KHz Position */
...
#define   OSCCTRL_XOSCCTRLA_USBHSDIV_DIV4_Val _UINT32_(0x3)                                        /* (OSCCTRL_XOSCCTRLA) USBHS PLL reference XOSC clock is divided by 4  */
...
#define OSCCTRL_XOSCCTRLA_USBHSDIV_DIV4       (OSCCTRL_XOSCCTRLA_USBHSDIV_DIV4_Val << OSCCTRL_XOSCCTRLA_USBHSDIV_Pos) /* (OSCCTRL_XOSCCTRLA) USBHS PLL reference XOSC clock is divided by 4 Position */
...
/* -------- OSCCTRL_PLL0POSTDIVB : (OSCCTRL Offset: 0x50) (R/W 32) PLL output clock divider B -------- */
#define OSCCTRL_PLL0POSTDIVB_RESETVALUE       _UINT32_(0x20)                                       /*  (OSCCTRL_PLL0POSTDIVB) PLL output clock divider B  Reset Value */
...
#define OSCCTRL_PLL0POSTDIVB_Msk              _UINT32_(0x000000BF)                                 /* (OSCCTRL_PLL0POSTDIVB) Register Mask  */

#define OSCCTRL_PLL0POSTDIVB_OUTEN_Pos        _UINT32_(7)                                          /* (OSCCTRL_PLL0POSTDIVB Position) PLL output 4 enable */
#define OSCCTRL_PLL0POSTDIVB_OUTEN_Msk        (_UINT32_(0x1) << OSCCTRL_PLL0POSTDIVB_OUTEN_Pos)    /* (OSCCTRL_PLL0POSTDIVB Mask) OUTEN */
#define OSCCTRL_PLL0POSTDIVB_OUTEN(value)     (OSCCTRL_PLL0POSTDIVB_OUTEN_Msk & (_UINT32_(value) << OSCCTRL_PLL0POSTDIVB_OUTEN_Pos)) 
...
{  /* Oscillators Control */
  ...
  __IO  uint32_t                       OSCCTRL_PLL0POSTDIVB; /* Offset: 0x50 (R/W  32) PLL output clock divider B */
...
#endif /* _PIC32CMGC00_OSCCTRL_COMPONENT_H_ */
