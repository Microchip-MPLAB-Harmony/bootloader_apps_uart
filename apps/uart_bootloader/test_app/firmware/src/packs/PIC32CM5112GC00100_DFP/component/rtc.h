...
#ifndef _PIC32CMGC00_RTC_COMPONENT_H_
#define _PIC32CMGC00_RTC_COMPONENT_H_
...
#define RTC_MODE0_CTRLB_SEPTO(value)          (RTC_MODE0_CTRLB_SEPTO_Msk & (_UINT16_(value) << RTC_MODE0_CTRLB_SEPTO_Pos)) /* Assignment of value for SEPTO in the RTC_MODE0_CTRLB register */
...
#define RTC_MODE1_CTRLB_SEPTO(value)          (RTC_MODE1_CTRLB_SEPTO_Msk & (_UINT16_(value) << RTC_MODE1_CTRLB_SEPTO_Pos)) /* Assignment of value for SEPTO in the RTC_MODE1_CTRLB register */
...
#define RTC_MODE2_CTRLB_SEPTO(value)          (RTC_MODE2_CTRLB_SEPTO_Msk & (_UINT16_(value) << RTC_MODE2_CTRLB_SEPTO_Pos)) /* Assignment of value for SEPTO in the RTC_MODE2_CTRLB register */
...
#define RTC_TAMPCTRL_IN4ACT(value)            (RTC_TAMPCTRL_IN4ACT_Msk & (_UINT32_(value) << RTC_TAMPCTRL_IN4ACT_Pos)) /* Assignment of value for IN4ACT in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_IN5ACT(value)            (RTC_TAMPCTRL_IN5ACT_Msk & (_UINT32_(value) << RTC_TAMPCTRL_IN5ACT_Pos)) /* Assignment of value for IN5ACT in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_IN6ACT(value)            (RTC_TAMPCTRL_IN6ACT_Msk & (_UINT32_(value) << RTC_TAMPCTRL_IN6ACT_Pos)) /* Assignment of value for IN6ACT in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_IN7ACT(value)            (RTC_TAMPCTRL_IN7ACT_Msk & (_UINT32_(value) << RTC_TAMPCTRL_IN7ACT_Pos)) /* Assignment of value for IN7ACT in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_TAMLVL4(value)           (RTC_TAMPCTRL_TAMLVL4_Msk & (_UINT32_(value) << RTC_TAMPCTRL_TAMLVL4_Pos)) /* Assignment of value for TAMLVL4 in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_TAMLVL5(value)           (RTC_TAMPCTRL_TAMLVL5_Msk & (_UINT32_(value) << RTC_TAMPCTRL_TAMLVL5_Pos)) /* Assignment of value for TAMLVL5 in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_TAMLVL6(value)           (RTC_TAMPCTRL_TAMLVL6_Msk & (_UINT32_(value) << RTC_TAMPCTRL_TAMLVL6_Pos)) /* Assignment of value for TAMLVL6 in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_TAMLVL7(value)           (RTC_TAMPCTRL_TAMLVL7_Msk & (_UINT32_(value) << RTC_TAMPCTRL_TAMLVL7_Pos)) /* Assignment of value for TAMLVL7 in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_DEBNC4(value)            (RTC_TAMPCTRL_DEBNC4_Msk & (_UINT32_(value) << RTC_TAMPCTRL_DEBNC4_Pos)) /* Assignment of value for DEBNC4 in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_DEBNC5(value)            (RTC_TAMPCTRL_DEBNC5_Msk & (_UINT32_(value) << RTC_TAMPCTRL_DEBNC5_Pos)) /* Assignment of value for DEBNC5 in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_DEBNC6(value)            (RTC_TAMPCTRL_DEBNC6_Msk & (_UINT32_(value) << RTC_TAMPCTRL_DEBNC6_Pos)) /* Assignment of value for DEBNC6 in the RTC_TAMPCTRL register */
...
#define RTC_TAMPCTRL_DEBNC7(value)            (RTC_TAMPCTRL_DEBNC7_Msk & (_UINT32_(value) << RTC_TAMPCTRL_DEBNC7_Pos)) /* Assignment of value for DEBNC7 in the RTC_TAMPCTRL register */
...
#define RTC_TAMPID_TAMPID4(value)             (RTC_TAMPID_TAMPID4_Msk & (_UINT32_(value) << RTC_TAMPID_TAMPID4_Pos)) /* Assignment of value for TAMPID4 in the RTC_TAMPID register */
...
#define RTC_TAMPID_TAMPID5(value)             (RTC_TAMPID_TAMPID5_Msk & (_UINT32_(value) << RTC_TAMPID_TAMPID5_Pos)) /* Assignment of value for TAMPID5 in the RTC_TAMPID register */
...
#define RTC_TAMPID_TAMPID6(value)             (RTC_TAMPID_TAMPID6_Msk & (_UINT32_(value) << RTC_TAMPID_TAMPID6_Pos)) /* Assignment of value for TAMPID6 in the RTC_TAMPID register */
...
#define RTC_TAMPID_TAMPID7(value)             (RTC_TAMPID_TAMPID7_Msk & (_UINT32_(value) << RTC_TAMPID_TAMPID7_Pos)) /* Assignment of value for TAMPID7 in the RTC_TAMPID register */
...
#define RTC_TAMPCTRLB_ALSI0(value)            (RTC_TAMPCTRLB_ALSI0_Msk & (_UINT32_(value) << RTC_TAMPCTRLB_ALSI0_Pos)) /* Assignment of value for ALSI0 in the RTC_TAMPCTRLB register */
...
#define RTC_TAMPCTRLB_ALSI1(value)            (RTC_TAMPCTRLB_ALSI1_Msk & (_UINT32_(value) << RTC_TAMPCTRLB_ALSI1_Pos)) /* Assignment of value for ALSI1 in the RTC_TAMPCTRLB register */
...
#define RTC_TAMPCTRLB_ALSI2(value)            (RTC_TAMPCTRLB_ALSI2_Msk & (_UINT32_(value) << RTC_TAMPCTRLB_ALSI2_Pos)) /* Assignment of value for ALSI2 in the RTC_TAMPCTRLB register */
...
#define RTC_TAMPCTRLB_ALSI3(value)            (RTC_TAMPCTRLB_ALSI3_Msk & (_UINT32_(value) << RTC_TAMPCTRLB_ALSI3_Pos)) /* Assignment of value for ALSI3 in the RTC_TAMPCTRLB register */
...
#define RTC_TAMPCTRLB_ALSI4(value)            (RTC_TAMPCTRLB_ALSI4_Msk & (_UINT32_(value) << RTC_TAMPCTRLB_ALSI4_Pos)) /* Assignment of value for ALSI4 in the RTC_TAMPCTRLB register */
...
#define RTC_TAMPCTRLB_ALSI5(value)            (RTC_TAMPCTRLB_ALSI5_Msk & (_UINT32_(value) << RTC_TAMPCTRLB_ALSI5_Pos)) /* Assignment of value for ALSI5 in the RTC_TAMPCTRLB register */
...
#define RTC_TAMPCTRLB_ALSI6(value)            (RTC_TAMPCTRLB_ALSI6_Msk & (_UINT32_(value) << RTC_TAMPCTRLB_ALSI6_Pos)) /* Assignment of value for ALSI6 in the RTC_TAMPCTRLB register */
...
#define RTC_TAMPCTRLB_ALSI7(value)            (RTC_TAMPCTRLB_ALSI7_Msk & (_UINT32_(value) << RTC_TAMPCTRLB_ALSI7_Pos)) /* Assignment of value for ALSI7 in the RTC_TAMPCTRLB register */
...
/* MODE2_ALARM register API structure */
typedef struct
{
...
#endif /* _PIC32CMGC00_RTC_COMPONENT_H_ */
