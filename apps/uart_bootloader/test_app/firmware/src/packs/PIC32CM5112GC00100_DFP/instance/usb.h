...
#ifndef _PIC32CMGC00_USB_INSTANCE_
#define _PIC32CMGC00_USB_INSTANCE_
...
#define USB_BRIDGE_ID                            (1)        /* H2PB Bridge ID */
...
#define USB_GCLK_ID                              (38)       
#define USB_INITIAL_CONTROL_QOS                  (3)        /* CONTROL QOS RESET value */
#define USB_INITIAL_DATA_QOS                     (3)        /* DATA QOS RESET value */
#define USB_INSTANCE_ID                          (44)       /* Instance index for USB */
#define USB_MCLK_ID_AHB                          (54)       /* Index for USB AHB clock */
#define USB_MCLK_ID_APB                          (55)       /* Index for USB APB clock */
#define USB_MISSING_SOF_DET_IMPLEMENTED          (1)        /* 48 mHz xPLL feature implemented */
#define USB_PAC_ID                               (44)       /* Index for USB registers write protection */
#define USB_PERIPH_ID                            (25)       /* H2PB Peripheral ID */
...
#endif /* _PIC32CMGC00_USB_INSTANCE_ */
