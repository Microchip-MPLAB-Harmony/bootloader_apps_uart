...
#define EEFC_FMR_FAM_Pos                      _UINT32_(24)                                         /* (EEFC_FMR) Flash Access Mode Position */
#define EEFC_FMR_FAM_Msk                      (_UINT32_(0x1) << EEFC_FMR_FAM_Pos)                  /* (EEFC_FMR) Flash Access Mode Mask */
#define EEFC_FMR_FAM(value)                   (EEFC_FMR_FAM_Msk & (_UINT32_(value) << EEFC_FMR_FAM_Pos)) /* Assigment of value for FAM in the EEFC_FMR register */
...
#define EEFC_FMR_Msk                          _UINT32_(0x05010F01)                                 /* (EEFC_FMR) Register Mask  */
...
#define EEFC_FSR_Msk                          _UINT32_(0x0000000F)                                 /* (EEFC_FSR) Register Mask  */
