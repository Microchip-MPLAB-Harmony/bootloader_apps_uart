...
#define   MATRIX_MCFG_ULBT_UNLIMITED_Val      _UINT32_(0x0)                                        /* (MATRIX_MCFG) No predicted end of burst is generated and therefore INCR bursts coming from this master cannot be broken.  */
#define   MATRIX_MCFG_ULBT_SINGLE_Val         _UINT32_(0x1)                                        /* (MATRIX_MCFG) The undefined length burst is treated as a succession of single access allowing rearbitration at each beat of the INCR burst.  */
#define   MATRIX_MCFG_ULBT_4_BEAT_Val         _UINT32_(0x2)                                        /* (MATRIX_MCFG) The undefined length burst is split into a 4-beat bursts allowing rearbitration at each 4-beat burst end.  */
#define   MATRIX_MCFG_ULBT_8_BEAT_Val         _UINT32_(0x3)                                        /* (MATRIX_MCFG) The undefined length burst is split into 8-beat bursts allowing rearbitration at each 8-beat burst end.  */
#define   MATRIX_MCFG_ULBT_16_BEAT_Val        _UINT32_(0x4)                                        /* (MATRIX_MCFG) The undefined length burst is split into 16-beat bursts allowing rearbitration at each 16-beat burst end.  */
...
#define MATRIX_SCFG_SLOT_CYCLE_Pos            _UINT32_(0)                                          /* (MATRIX_SCFG) Maximum Number of Allowed Cycles for a Burst Position */
#define MATRIX_SCFG_SLOT_CYCLE_Msk            (_UINT32_(0xFF) << MATRIX_SCFG_SLOT_CYCLE_Pos)       /* (MATRIX_SCFG) Maximum Number of Allowed Cycles for a Burst Mask */
...
#define   MATRIX_SCFG_DEFMSTR_TYPE_NO_DEFAULT_Val _UINT32_(0x0)                                        /* (MATRIX_SCFG) At the end of current slave access, if no other master request is pending, the slave is disconnected from all masters.This results in having a one cycle latency for the first access of a burst transfer or for a single access.  */
#define   MATRIX_SCFG_DEFMSTR_TYPE_LAST_Val   _UINT32_(0x1)                                        /* (MATRIX_SCFG) At the end of current slave access, if no other master request is pending, the slave stays connected to the last master having accessed it.This results in not having the one cycle latency when the last master tries to access the slave again.  */
#define   MATRIX_SCFG_DEFMSTR_TYPE_FIXED_Val  _UINT32_(0x2)                                        /* (MATRIX_SCFG) At the end of the current slave access, if no other master request is pending, the slave connects to the fixed master the number that has been written in the FIXED_DEFMSTR field.This results in not having the one cycle latency when the fixed master tries to access the slave again.  */
...
#define MATRIX_SCFG_FIXED_DEFMSTR_Msk         (_UINT32_(0x7) << MATRIX_SCFG_FIXED_DEFMSTR_Pos)     /* (MATRIX_SCFG) Fixed Default Master Mask */
...
#define MATRIX_SCFG_Msk                       _UINT32_(0x001F00FF)                                 /* (MATRIX_SCFG) Register Mask  */


/* -------- MATRIX_PRAS0 : (MATRIX Offset: 0x80) (R/W 32) Priority Register A for Slave 0 -------- */
#define MATRIX_PRAS0_M0PR_Pos                 _UINT32_(0)                                          /* (MATRIX_PRAS0) Master 0 Priority Position */
#define MATRIX_PRAS0_M0PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS0_M0PR_Pos)             /* (MATRIX_PRAS0) Master 0 Priority Mask */
#define MATRIX_PRAS0_M0PR(value)              (MATRIX_PRAS0_M0PR_Msk & (_UINT32_(value) << MATRIX_PRAS0_M0PR_Pos)) /* Assigment of value for M0PR in the MATRIX_PRAS0 register */
#define MATRIX_PRAS0_M1PR_Pos                 _UINT32_(4)                                          /* (MATRIX_PRAS0) Master 1 Priority Position */
#define MATRIX_PRAS0_M1PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS0_M1PR_Pos)             /* (MATRIX_PRAS0) Master 1 Priority Mask */
#define MATRIX_PRAS0_M1PR(value)              (MATRIX_PRAS0_M1PR_Msk & (_UINT32_(value) << MATRIX_PRAS0_M1PR_Pos)) /* Assigment of value for M1PR in the MATRIX_PRAS0 register */
#define MATRIX_PRAS0_M2PR_Pos                 _UINT32_(8)                                          /* (MATRIX_PRAS0) Master 2 Priority Position */
#define MATRIX_PRAS0_M2PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS0_M2PR_Pos)             /* (MATRIX_PRAS0) Master 2 Priority Mask */
#define MATRIX_PRAS0_M2PR(value)              (MATRIX_PRAS0_M2PR_Msk & (_UINT32_(value) << MATRIX_PRAS0_M2PR_Pos)) /* Assigment of value for M2PR in the MATRIX_PRAS0 register */
#define MATRIX_PRAS0_M3PR_Pos                 _UINT32_(12)                                         /* (MATRIX_PRAS0) Master 3 Priority Position */
#define MATRIX_PRAS0_M3PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS0_M3PR_Pos)             /* (MATRIX_PRAS0) Master 3 Priority Mask */
#define MATRIX_PRAS0_M3PR(value)              (MATRIX_PRAS0_M3PR_Msk & (_UINT32_(value) << MATRIX_PRAS0_M3PR_Pos)) /* Assigment of value for M3PR in the MATRIX_PRAS0 register */
#define MATRIX_PRAS0_Msk                      _UINT32_(0x00003333)                                 /* (MATRIX_PRAS0) Register Mask  */


/* -------- MATRIX_PRAS1 : (MATRIX Offset: 0x88) (R/W 32) Priority Register A for Slave 1 -------- */
#define MATRIX_PRAS1_M0PR_Pos                 _UINT32_(0)                                          /* (MATRIX_PRAS1) Master 0 Priority Position */
#define MATRIX_PRAS1_M0PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS1_M0PR_Pos)             /* (MATRIX_PRAS1) Master 0 Priority Mask */
#define MATRIX_PRAS1_M0PR(value)              (MATRIX_PRAS1_M0PR_Msk & (_UINT32_(value) << MATRIX_PRAS1_M0PR_Pos)) /* Assigment of value for M0PR in the MATRIX_PRAS1 register */
#define MATRIX_PRAS1_M1PR_Pos                 _UINT32_(4)                                          /* (MATRIX_PRAS1) Master 1 Priority Position */
#define MATRIX_PRAS1_M1PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS1_M1PR_Pos)             /* (MATRIX_PRAS1) Master 1 Priority Mask */
#define MATRIX_PRAS1_M1PR(value)              (MATRIX_PRAS1_M1PR_Msk & (_UINT32_(value) << MATRIX_PRAS1_M1PR_Pos)) /* Assigment of value for M1PR in the MATRIX_PRAS1 register */
#define MATRIX_PRAS1_M2PR_Pos                 _UINT32_(8)                                          /* (MATRIX_PRAS1) Master 2 Priority Position */
#define MATRIX_PRAS1_M2PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS1_M2PR_Pos)             /* (MATRIX_PRAS1) Master 2 Priority Mask */
#define MATRIX_PRAS1_M2PR(value)              (MATRIX_PRAS1_M2PR_Msk & (_UINT32_(value) << MATRIX_PRAS1_M2PR_Pos)) /* Assigment of value for M2PR in the MATRIX_PRAS1 register */
#define MATRIX_PRAS1_M3PR_Pos                 _UINT32_(12)                                         /* (MATRIX_PRAS1) Master 3 Priority Position */
#define MATRIX_PRAS1_M3PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS1_M3PR_Pos)             /* (MATRIX_PRAS1) Master 3 Priority Mask */
#define MATRIX_PRAS1_M3PR(value)              (MATRIX_PRAS1_M3PR_Msk & (_UINT32_(value) << MATRIX_PRAS1_M3PR_Pos)) /* Assigment of value for M3PR in the MATRIX_PRAS1 register */
#define MATRIX_PRAS1_Msk                      _UINT32_(0x00003333)                                 /* (MATRIX_PRAS1) Register Mask  */


/* -------- MATRIX_PRAS2 : (MATRIX Offset: 0x90) (R/W 32) Priority Register A for Slave 2 -------- */
#define MATRIX_PRAS2_M0PR_Pos                 _UINT32_(0)                                          /* (MATRIX_PRAS2) Master 0 Priority Position */
#define MATRIX_PRAS2_M0PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS2_M0PR_Pos)             /* (MATRIX_PRAS2) Master 0 Priority Mask */
#define MATRIX_PRAS2_M0PR(value)              (MATRIX_PRAS2_M0PR_Msk & (_UINT32_(value) << MATRIX_PRAS2_M0PR_Pos)) /* Assigment of value for M0PR in the MATRIX_PRAS2 register */
#define MATRIX_PRAS2_M1PR_Pos                 _UINT32_(4)                                          /* (MATRIX_PRAS2) Master 1 Priority Position */
#define MATRIX_PRAS2_M1PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS2_M1PR_Pos)             /* (MATRIX_PRAS2) Master 1 Priority Mask */
#define MATRIX_PRAS2_M1PR(value)              (MATRIX_PRAS2_M1PR_Msk & (_UINT32_(value) << MATRIX_PRAS2_M1PR_Pos)) /* Assigment of value for M1PR in the MATRIX_PRAS2 register */
#define MATRIX_PRAS2_M2PR_Pos                 _UINT32_(8)                                          /* (MATRIX_PRAS2) Master 2 Priority Position */
#define MATRIX_PRAS2_M2PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS2_M2PR_Pos)             /* (MATRIX_PRAS2) Master 2 Priority Mask */
#define MATRIX_PRAS2_M2PR(value)              (MATRIX_PRAS2_M2PR_Msk & (_UINT32_(value) << MATRIX_PRAS2_M2PR_Pos)) /* Assigment of value for M2PR in the MATRIX_PRAS2 register */
#define MATRIX_PRAS2_M3PR_Pos                 _UINT32_(12)                                         /* (MATRIX_PRAS2) Master 3 Priority Position */
#define MATRIX_PRAS2_M3PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS2_M3PR_Pos)             /* (MATRIX_PRAS2) Master 3 Priority Mask */
#define MATRIX_PRAS2_M3PR(value)              (MATRIX_PRAS2_M3PR_Msk & (_UINT32_(value) << MATRIX_PRAS2_M3PR_Pos)) /* Assigment of value for M3PR in the MATRIX_PRAS2 register */
#define MATRIX_PRAS2_Msk                      _UINT32_(0x00003333)                                 /* (MATRIX_PRAS2) Register Mask  */


/* -------- MATRIX_PRAS3 : (MATRIX Offset: 0x98) (R/W 32) Priority Register A for Slave 3 -------- */
#define MATRIX_PRAS3_M0PR_Pos                 _UINT32_(0)                                          /* (MATRIX_PRAS3) Master 0 Priority Position */
#define MATRIX_PRAS3_M0PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS3_M0PR_Pos)             /* (MATRIX_PRAS3) Master 0 Priority Mask */
#define MATRIX_PRAS3_M0PR(value)              (MATRIX_PRAS3_M0PR_Msk & (_UINT32_(value) << MATRIX_PRAS3_M0PR_Pos)) /* Assigment of value for M0PR in the MATRIX_PRAS3 register */
#define MATRIX_PRAS3_M1PR_Pos                 _UINT32_(4)                                          /* (MATRIX_PRAS3) Master 1 Priority Position */
#define MATRIX_PRAS3_M1PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS3_M1PR_Pos)             /* (MATRIX_PRAS3) Master 1 Priority Mask */
#define MATRIX_PRAS3_M1PR(value)              (MATRIX_PRAS3_M1PR_Msk & (_UINT32_(value) << MATRIX_PRAS3_M1PR_Pos)) /* Assigment of value for M1PR in the MATRIX_PRAS3 register */
#define MATRIX_PRAS3_M2PR_Pos                 _UINT32_(8)                                          /* (MATRIX_PRAS3) Master 2 Priority Position */
#define MATRIX_PRAS3_M2PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS3_M2PR_Pos)             /* (MATRIX_PRAS3) Master 2 Priority Mask */
#define MATRIX_PRAS3_M2PR(value)              (MATRIX_PRAS3_M2PR_Msk & (_UINT32_(value) << MATRIX_PRAS3_M2PR_Pos)) /* Assigment of value for M2PR in the MATRIX_PRAS3 register */
#define MATRIX_PRAS3_M3PR_Pos                 _UINT32_(12)                                         /* (MATRIX_PRAS3) Master 3 Priority Position */
#define MATRIX_PRAS3_M3PR_Msk                 (_UINT32_(0x3) << MATRIX_PRAS3_M3PR_Pos)             /* (MATRIX_PRAS3) Master 3 Priority Mask */
#define MATRIX_PRAS3_M3PR(value)              (MATRIX_PRAS3_M3PR_Msk & (_UINT32_(value) << MATRIX_PRAS3_M3PR_Pos)) /* Assigment of value for M3PR in the MATRIX_PRAS3 register */
#define MATRIX_PRAS3_Msk                      _UINT32_(0x00003333)                                 /* (MATRIX_PRAS3) Register Mask  */
...
#define CCFG_SYSIO_SYSIO10_Pos                _UINT32_(10)                                         /* (CCFG_SYSIO) PA21 or DM Assignment Position */
#define CCFG_SYSIO_SYSIO10_Msk                (_UINT32_(0x1) << CCFG_SYSIO_SYSIO10_Pos)            /* (CCFG_SYSIO) PA21 or DM Assignment Mask */
#define CCFG_SYSIO_SYSIO10(value)             (CCFG_SYSIO_SYSIO10_Msk & (_UINT32_(value) << CCFG_SYSIO_SYSIO10_Pos)) /* Assigment of value for SYSIO10 in the CCFG_SYSIO register */
#define CCFG_SYSIO_SYSIO11_Pos                _UINT32_(11)                                         /* (CCFG_SYSIO) PA22 or DP Assignment Position */
#define CCFG_SYSIO_SYSIO11_Msk                (_UINT32_(0x1) << CCFG_SYSIO_SYSIO11_Pos)            /* (CCFG_SYSIO) PA22 or DP Assignment Mask */
#define CCFG_SYSIO_SYSIO11(value)             (CCFG_SYSIO_SYSIO11_Msk & (_UINT32_(value) << CCFG_SYSIO_SYSIO11_Pos)) /* Assigment of value for SYSIO11 in the CCFG_SYSIO register */
...
#define CCFG_SYSIO_Msk                        _UINT32_(0x00001CF0)                                 /* (CCFG_SYSIO) Register Mask  */

#define CCFG_SYSIO_SYSIO_Pos                  _UINT32_(4)                                          /* (CCFG_SYSIO Position) PBx2 or ERASE Assignment */
#define CCFG_SYSIO_SYSIO_Msk                  (_UINT32_(0x7F) << CCFG_SYSIO_SYSIO_Pos)             /* (CCFG_SYSIO Mask) SYSIO */
...
#define CCFG_I2SCLKSEL_CLKSEL0_Pos            _UINT32_(0)                                          /* (CCFG_I2SCLKSEL) I2S0 Clock Source Position */
#define CCFG_I2SCLKSEL_CLKSEL0_Msk            (_UINT32_(0x1) << CCFG_I2SCLKSEL_CLKSEL0_Pos)        /* (CCFG_I2SCLKSEL) I2S0 Clock Source Mask */
#define CCFG_I2SCLKSEL_CLKSEL0(value)         (CCFG_I2SCLKSEL_CLKSEL0_Msk & (_UINT32_(value) << CCFG_I2SCLKSEL_CLKSEL0_Pos)) /* Assigment of value for CLKSEL0 in the CCFG_I2SCLKSEL register */
#define CCFG_I2SCLKSEL_CLKSEL1_Pos            _UINT32_(1)                                          /* (CCFG_I2SCLKSEL) I2S1 Clock Source Position */
#define CCFG_I2SCLKSEL_CLKSEL1_Msk            (_UINT32_(0x1) << CCFG_I2SCLKSEL_CLKSEL1_Pos)        /* (CCFG_I2SCLKSEL) I2S1 Clock Source Mask */
#define CCFG_I2SCLKSEL_CLKSEL1(value)         (CCFG_I2SCLKSEL_CLKSEL1_Msk & (_UINT32_(value) << CCFG_I2SCLKSEL_CLKSEL1_Pos)) /* Assigment of value for CLKSEL1 in the CCFG_I2SCLKSEL register */
#define CCFG_I2SCLKSEL_Msk                    _UINT32_(0x00000003)                                 /* (CCFG_I2SCLKSEL) Register Mask  */

#define CCFG_I2SCLKSEL_CLKSEL_Pos             _UINT32_(0)                                          /* (CCFG_I2SCLKSEL Position) I2Sx Clock Source */
#define CCFG_I2SCLKSEL_CLKSEL_Msk             (_UINT32_(0x3) << CCFG_I2SCLKSEL_CLKSEL_Pos)         /* (CCFG_I2SCLKSEL Mask) CLKSEL */
#define CCFG_I2SCLKSEL_CLKSEL(value)          (CCFG_I2SCLKSEL_CLKSEL_Msk & (_UINT32_(value) << CCFG_I2SCLKSEL_CLKSEL_Pos)) 

/* -------- CCFG_USBMR : (MATRIX Offset: 0x120) (R/W 32) USB Management Register -------- */
#define CCFG_USBMR_USBMODE_Pos                _UINT32_(0)                                          /* (CCFG_USBMR) USB Mode Selection Position */
#define CCFG_USBMR_USBMODE_Msk                (_UINT32_(0x1) << CCFG_USBMR_USBMODE_Pos)            /* (CCFG_USBMR) USB Mode Selection Mask */
#define CCFG_USBMR_USBMODE(value)             (CCFG_USBMR_USBMODE_Msk & (_UINT32_(value) << CCFG_USBMR_USBMODE_Pos)) /* Assigment of value for USBMODE in the CCFG_USBMR register */
#define CCFG_USBMR_USBHTSSC_Pos               _UINT32_(1)                                          /* (CCFG_USBMR) USB Transceiver Suspend Software Control Position */
#define CCFG_USBMR_USBHTSSC_Msk               (_UINT32_(0x1) << CCFG_USBMR_USBHTSSC_Pos)           /* (CCFG_USBMR) USB Transceiver Suspend Software Control Mask */
#define CCFG_USBMR_USBHTSSC(value)            (CCFG_USBMR_USBHTSSC_Msk & (_UINT32_(value) << CCFG_USBMR_USBHTSSC_Pos)) /* Assigment of value for USBHTSSC in the CCFG_USBMR register */
#define CCFG_USBMR_USBHTSC_Pos                _UINT32_(2)                                          /* (CCFG_USBMR) USB Host Transceiver Suspend Control Position */
#define CCFG_USBMR_USBHTSC_Msk                (_UINT32_(0x1) << CCFG_USBMR_USBHTSC_Pos)            /* (CCFG_USBMR) USB Host Transceiver Suspend Control Mask */
#define CCFG_USBMR_USBHTSC(value)             (CCFG_USBMR_USBHTSC_Msk & (_UINT32_(value) << CCFG_USBMR_USBHTSC_Pos)) /* Assigment of value for USBHTSC in the CCFG_USBMR register */
#define CCFG_USBMR_Msk                        _UINT32_(0x00000007)                                 /* (CCFG_USBMR) Register Mask  */
...
#define MATRIX_PRAS0_REG_OFST          _UINT32_(0x80)      /* (MATRIX_PRAS0) Priority Register A for Slave 0 Offset */
#define MATRIX_PRAS1_REG_OFST          _UINT32_(0x88)      /* (MATRIX_PRAS1) Priority Register A for Slave 1 Offset */
#define MATRIX_PRAS2_REG_OFST          _UINT32_(0x90)      /* (MATRIX_PRAS2) Priority Register A for Slave 2 Offset */
#define MATRIX_PRAS3_REG_OFST          _UINT32_(0x98)      /* (MATRIX_PRAS3) Priority Register A for Slave 3 Offset */
#define CCFG_SYSIO_REG_OFST            _UINT32_(0x114)     /* (CCFG_SYSIO) System I/O Configuration Register Offset */
#define CCFG_DYNCKG_REG_OFST           _UINT32_(0x118)     /* (CCFG_DYNCKG) Dynamic Clock Gating Register Offset */
#define CCFG_I2SCLKSEL_REG_OFST        _UINT32_(0x11C)     /* (CCFG_I2SCLKSEL) I2S Clock Source Selection Register Offset */
#define CCFG_USBMR_REG_OFST            _UINT32_(0x120)     /* (CCFG_USBMR) USB Management Register Offset */
