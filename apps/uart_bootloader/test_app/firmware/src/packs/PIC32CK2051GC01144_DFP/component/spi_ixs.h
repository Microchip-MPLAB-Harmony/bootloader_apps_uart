...
#define SPI_IXS_STATUS_RESETVALUE             _UINT32_(0x90002000)                                 /*  (SPI_IXS_STATUS) SPI Status Register  Reset Value */
...
/* SPI_IXS register offsets definitions */
...
/* SPI_IXS register API structure */
typedef struct
...
#endif /* _PIC32CKGC01_SPI_IXS_COMPONENT_H_ */
