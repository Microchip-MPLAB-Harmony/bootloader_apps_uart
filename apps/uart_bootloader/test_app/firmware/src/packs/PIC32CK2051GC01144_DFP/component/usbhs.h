...
#ifndef _PIC32CKGC01_USBHS_COMPONENT_H_
#define _PIC32CKGC01_USBHS_COMPONENT_H_
...
#define USBHS_DMACNTL_DMAEN(value)            (USBHS_DMACNTL_DMAEN_Msk & (_UINT32_(value) << USBHS_DMACNTL_DMAEN_Pos)) /* Assignment of value for DMAEN in the USBHS_DMACNTL register */
...
#define USBHS_DMACNTL_DMADIR(value)           (USBHS_DMACNTL_DMADIR_Msk & (_UINT32_(value) << USBHS_DMACNTL_DMADIR_Pos)) /* Assignment of value for DMADIR in the USBHS_DMACNTL register */
...
#define USBHS_DMACNTL_DMAMODE(value)          (USBHS_DMACNTL_DMAMODE_Msk & (_UINT32_(value) << USBHS_DMACNTL_DMAMODE_Pos)) /* Assignment of value for DMAMODE in the USBHS_DMACNTL register */
...
#define USBHS_DMACNTL_DMAIE(value)            (USBHS_DMACNTL_DMAIE_Msk & (_UINT32_(value) << USBHS_DMACNTL_DMAIE_Pos)) /* Assignment of value for DMAIE in the USBHS_DMACNTL register */
...
#define USBHS_DMACNTL_DMAEP(value)            (USBHS_DMACNTL_DMAEP_Msk & (_UINT32_(value) << USBHS_DMACNTL_DMAEP_Pos)) /* Assignment of value for DMAEP in the USBHS_DMACNTL register */
...
#define USBHS_DMACNTL_DMAERR(value)           (USBHS_DMACNTL_DMAERR_Msk & (_UINT32_(value) << USBHS_DMACNTL_DMAERR_Pos)) /* Assignment of value for DMAERR in the USBHS_DMACNTL register */
...
#define USBHS_DMACNTL_DMABRSTM(value)         (USBHS_DMACNTL_DMABRSTM_Msk & (_UINT32_(value) << USBHS_DMACNTL_DMABRSTM_Pos)) /* Assignment of value for DMABRSTM in the USBHS_DMACNTL register */
...
#define USBHS_DMAADDR_ADDR10(value)           (USBHS_DMAADDR_ADDR10_Msk & (_UINT32_(value) << USBHS_DMAADDR_ADDR10_Pos)) /* Assignment of value for ADDR10 in the USBHS_DMAADDR register */
...
#define USBHS_DMAADDR_ADDR312(value)          (USBHS_DMAADDR_ADDR312_Msk & (_UINT32_(value) << USBHS_DMAADDR_ADDR312_Pos)) /* Assignment of value for ADDR312 in the USBHS_DMAADDR register */
...
#define USBHS_DMACOUNT_DMACOUNT(value)        (USBHS_DMACOUNT_DMACOUNT_Msk & (_UINT32_(value) << USBHS_DMACOUNT_DMACOUNT_Pos)) /* Assignment of value for DMACOUNT in the USBHS_DMACOUNT register */
...
#define USBHS_TXFUNCADDREP_TXFUNCADDR(value)  (USBHS_TXFUNCADDREP_TXFUNCADDR_Msk & (_UINT8_(value) << USBHS_TXFUNCADDREP_TXFUNCADDR_Pos)) /* Assignment of value for TXFUNCADDR in the USBHS_TXFUNCADDREP register */
...
#define USBHS_TXHUBADDREP_TXHUBADDR(value)    (USBHS_TXHUBADDREP_TXHUBADDR_Msk & (_UINT8_(value) << USBHS_TXHUBADDREP_TXHUBADDR_Pos)) /* Assignment of value for TXHUBADDR in the USBHS_TXHUBADDREP register */
...
#define USBHS_TXHUBADDREP_MULTRANS(value)     (USBHS_TXHUBADDREP_MULTRANS_Msk & (_UINT8_(value) << USBHS_TXHUBADDREP_MULTRANS_Pos)) /* Assignment of value for MULTRANS in the USBHS_TXHUBADDREP register */
...
#define USBHS_TXHUBPORT_HUBPORT(value)        (USBHS_TXHUBPORT_HUBPORT_Msk & (_UINT8_(value) << USBHS_TXHUBPORT_HUBPORT_Pos)) /* Assignment of value for HUBPORT in the USBHS_TXHUBPORT register */
...
#define USBHS_RXFUNCADDREP_RXFUNCADDR(value)  (USBHS_RXFUNCADDREP_RXFUNCADDR_Msk & (_UINT8_(value) << USBHS_RXFUNCADDREP_RXFUNCADDR_Pos)) /* Assignment of value for RXFUNCADDR in the USBHS_RXFUNCADDREP register */
...
#define USBHS_RXHUBADDREP_RXHUBADDR(value)    (USBHS_RXHUBADDREP_RXHUBADDR_Msk & (_UINT8_(value) << USBHS_RXHUBADDREP_RXHUBADDR_Pos)) /* Assignment of value for RXHUBADDR in the USBHS_RXHUBADDREP register */
...
#define USBHS_RXHUBADDREP_MULTRANS(value)     (USBHS_RXHUBADDREP_MULTRANS_Msk & (_UINT8_(value) << USBHS_RXHUBADDREP_MULTRANS_Pos)) /* Assignment of value for MULTRANS in the USBHS_RXHUBADDREP register */
...
#define USBHS_RXHUBPORT_HUBPORT(value)        (USBHS_RXHUBPORT_HUBPORT_Msk & (_UINT8_(value) << USBHS_RXHUBPORT_HUBPORT_Pos)) /* Assignment of value for HUBPORT in the USBHS_RXHUBPORT register */
...
#define USBHS_CTRLA_SWRST(value)              (USBHS_CTRLA_SWRST_Msk & (_UINT32_(value) << USBHS_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the USBHS_CTRLA register */
...
#define USBHS_CTRLA_ENABLE(value)             (USBHS_CTRLA_ENABLE_Msk & (_UINT32_(value) << USBHS_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the USBHS_CTRLA register */
...
#define USBHS_CTRLA_IDVAL(value)              (USBHS_CTRLA_IDVAL_Msk & (_UINT32_(value) << USBHS_CTRLA_IDVAL_Pos)) /* Assignment of value for IDVAL in the USBHS_CTRLA register */
...
#define USBHS_CTRLA_IDOVEN(value)             (USBHS_CTRLA_IDOVEN_Msk & (_UINT32_(value) << USBHS_CTRLA_IDOVEN_Pos)) /* Assignment of value for IDOVEN in the USBHS_CTRLA register */
...
#define USBHS_CTRLA_REFCLKSEL(value)          (USBHS_CTRLA_REFCLKSEL_Msk & (_UINT32_(value) << USBHS_CTRLA_REFCLKSEL_Pos)) /* Assignment of value for REFCLKSEL in the USBHS_CTRLA register */
...
#define USBHS_CTRLB_BLANK(value)              (USBHS_CTRLB_BLANK_Msk & (_UINT32_(value) << USBHS_CTRLB_BLANK_Pos)) /* Assignment of value for BLANK in the USBHS_CTRLB register */
...
#define USBHS_CTRLC_T1MSEN(value)             (USBHS_CTRLC_T1MSEN_Msk & (_UINT32_(value) << USBHS_CTRLC_T1MSEN_Pos)) /* Assignment of value for T1MSEN in the USBHS_CTRLC register */
...
#define USBHS_INTENCLR_WAKEUP(value)          (USBHS_INTENCLR_WAKEUP_Msk & (_UINT32_(value) << USBHS_INTENCLR_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the USBHS_INTENCLR register */
...
#define USBHS_INTENCLR_RESUME(value)          (USBHS_INTENCLR_RESUME_Msk & (_UINT32_(value) << USBHS_INTENCLR_RESUME_Pos)) /* Assignment of value for RESUME in the USBHS_INTENCLR register */
...
#define USBHS_INTENCLR_USB(value)             (USBHS_INTENCLR_USB_Msk & (_UINT32_(value) << USBHS_INTENCLR_USB_Pos)) /* Assignment of value for USB in the USBHS_INTENCLR register */
...
#define USBHS_INTENCLR_DMA(value)             (USBHS_INTENCLR_DMA_Msk & (_UINT32_(value) << USBHS_INTENCLR_DMA_Pos)) /* Assignment of value for DMA in the USBHS_INTENCLR register */
...
#define USBHS_INTENCLR_T1MS(value)            (USBHS_INTENCLR_T1MS_Msk & (_UINT32_(value) << USBHS_INTENCLR_T1MS_Pos)) /* Assignment of value for T1MS in the USBHS_INTENCLR register */
...
#define USBHS_INTENCLR_PHYRDY(value)          (USBHS_INTENCLR_PHYRDY_Msk & (_UINT32_(value) << USBHS_INTENCLR_PHYRDY_Pos)) /* Assignment of value for PHYRDY in the USBHS_INTENCLR register */
...
#define USBHS_INTENSET_WAKEUP(value)          (USBHS_INTENSET_WAKEUP_Msk & (_UINT32_(value) << USBHS_INTENSET_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the USBHS_INTENSET register */
...
#define USBHS_INTENSET_RESUME(value)          (USBHS_INTENSET_RESUME_Msk & (_UINT32_(value) << USBHS_INTENSET_RESUME_Pos)) /* Assignment of value for RESUME in the USBHS_INTENSET register */
...
#define USBHS_INTENSET_USB(value)             (USBHS_INTENSET_USB_Msk & (_UINT32_(value) << USBHS_INTENSET_USB_Pos)) /* Assignment of value for USB in the USBHS_INTENSET register */
...
#define USBHS_INTENSET_DMA(value)             (USBHS_INTENSET_DMA_Msk & (_UINT32_(value) << USBHS_INTENSET_DMA_Pos)) /* Assignment of value for DMA in the USBHS_INTENSET register */
...
#define USBHS_INTENSET_T1MS(value)            (USBHS_INTENSET_T1MS_Msk & (_UINT32_(value) << USBHS_INTENSET_T1MS_Pos)) /* Assignment of value for T1MS in the USBHS_INTENSET register */
...
#define USBHS_INTENSET_PHYRDY(value)          (USBHS_INTENSET_PHYRDY_Msk & (_UINT32_(value) << USBHS_INTENSET_PHYRDY_Pos)) /* Assignment of value for PHYRDY in the USBHS_INTENSET register */
...
#define USBHS_INTFLAG_WAKEUP(value)           (USBHS_INTFLAG_WAKEUP_Msk & (_UINT32_(value) << USBHS_INTFLAG_WAKEUP_Pos)) /* Assignment of value for WAKEUP in the USBHS_INTFLAG register */
...
#define USBHS_INTFLAG_RESUME(value)           (USBHS_INTFLAG_RESUME_Msk & (_UINT32_(value) << USBHS_INTFLAG_RESUME_Pos)) /* Assignment of value for RESUME in the USBHS_INTFLAG register */
...
#define USBHS_INTFLAG_USB(value)              (USBHS_INTFLAG_USB_Msk & (_UINT32_(value) << USBHS_INTFLAG_USB_Pos)) /* Assignment of value for USB in the USBHS_INTFLAG register */
...
#define USBHS_INTFLAG_DMA(value)              (USBHS_INTFLAG_DMA_Msk & (_UINT32_(value) << USBHS_INTFLAG_DMA_Pos)) /* Assignment of value for DMA in the USBHS_INTFLAG register */
...
#define USBHS_INTFLAG_T1MS(value)             (USBHS_INTFLAG_T1MS_Msk & (_UINT32_(value) << USBHS_INTFLAG_T1MS_Pos)) /* Assignment of value for T1MS in the USBHS_INTFLAG register */
...
#define USBHS_INTFLAG_PHYRDY(value)           (USBHS_INTFLAG_PHYRDY_Msk & (_UINT32_(value) << USBHS_INTFLAG_PHYRDY_Pos)) /* Assignment of value for PHYRDY in the USBHS_INTFLAG register */
...
#define USBHS_STATUS_PHYRDY(value)            (USBHS_STATUS_PHYRDY_Msk & (_UINT32_(value) << USBHS_STATUS_PHYRDY_Pos)) /* Assignment of value for PHYRDY in the USBHS_STATUS register */
...
#define USBHS_STATUS_PHYON(value)             (USBHS_STATUS_PHYON_Msk & (_UINT32_(value) << USBHS_STATUS_PHYON_Pos)) /* Assignment of value for PHYON in the USBHS_STATUS register */
...
#define USBHS_STATUS_VREGRDY(value)           (USBHS_STATUS_VREGRDY_Msk & (_UINT32_(value) << USBHS_STATUS_VREGRDY_Pos)) /* Assignment of value for VREGRDY in the USBHS_STATUS register */
...
#define USBHS_SYNCBUSY_SWRST(value)           (USBHS_SYNCBUSY_SWRST_Msk & (_UINT32_(value) << USBHS_SYNCBUSY_SWRST_Pos)) /* Assignment of value for SWRST in the USBHS_SYNCBUSY register */
...
#define USBHS_SYNCBUSY_ENABLE(value)          (USBHS_SYNCBUSY_ENABLE_Msk & (_UINT32_(value) << USBHS_SYNCBUSY_ENABLE_Pos)) /* Assignment of value for ENABLE in the USBHS_SYNCBUSY register */
...
#define USBHS_SYNCBUSY_T1MSEN(value)          (USBHS_SYNCBUSY_T1MSEN_Msk & (_UINT32_(value) << USBHS_SYNCBUSY_T1MSEN_Pos)) /* Assignment of value for T1MSEN in the USBHS_SYNCBUSY register */
...
#define USBHS_FADDR_FUNCADDR(value)           (USBHS_FADDR_FUNCADDR_Msk & (_UINT8_(value) << USBHS_FADDR_FUNCADDR_Pos)) /* Assignment of value for FUNCADDR in the USBHS_FADDR register */
...
#define USBHS_POWER_ENABLESUSPENDM(value)     (USBHS_POWER_ENABLESUSPENDM_Msk & (_UINT8_(value) << USBHS_POWER_ENABLESUSPENDM_Pos)) /* Assignment of value for ENABLESUSPENDM in the USBHS_POWER register */
...
#define USBHS_POWER_SUSPENDMODE(value)        (USBHS_POWER_SUSPENDMODE_Msk & (_UINT8_(value) << USBHS_POWER_SUSPENDMODE_Pos)) /* Assignment of value for SUSPENDMODE in the USBHS_POWER register */
...
#define USBHS_POWER_RESUME(value)             (USBHS_POWER_RESUME_Msk & (_UINT8_(value) << USBHS_POWER_RESUME_Pos)) /* Assignment of value for RESUME in the USBHS_POWER register */
...
#define USBHS_POWER_RESET(value)              (USBHS_POWER_RESET_Msk & (_UINT8_(value) << USBHS_POWER_RESET_Pos)) /* Assignment of value for RESET in the USBHS_POWER register */
...
#define USBHS_POWER_HSMODE(value)             (USBHS_POWER_HSMODE_Msk & (_UINT8_(value) << USBHS_POWER_HSMODE_Pos)) /* Assignment of value for HSMODE in the USBHS_POWER register */
...
#define USBHS_POWER_HSENABLE(value)           (USBHS_POWER_HSENABLE_Msk & (_UINT8_(value) << USBHS_POWER_HSENABLE_Pos)) /* Assignment of value for HSENABLE in the USBHS_POWER register */
...
#define USBHS_POWER_SOFTCONN(value)           (USBHS_POWER_SOFTCONN_Msk & (_UINT8_(value) << USBHS_POWER_SOFTCONN_Pos)) /* Assignment of value for SOFTCONN in the USBHS_POWER register */
...
#define USBHS_POWER_ISOUPDATE(value)          (USBHS_POWER_ISOUPDATE_Msk & (_UINT8_(value) << USBHS_POWER_ISOUPDATE_Pos)) /* Assignment of value for ISOUPDATE in the USBHS_POWER register */
...
#define USBHS_INTRTX_EP0TX(value)             (USBHS_INTRTX_EP0TX_Msk & (_UINT16_(value) << USBHS_INTRTX_EP0TX_Pos)) /* Assignment of value for EP0TX in the USBHS_INTRTX register */
...
#define USBHS_INTRTX_EP1TX(value)             (USBHS_INTRTX_EP1TX_Msk & (_UINT16_(value) << USBHS_INTRTX_EP1TX_Pos)) /* Assignment of value for EP1TX in the USBHS_INTRTX register */
...
#define USBHS_INTRTX_EP2TX(value)             (USBHS_INTRTX_EP2TX_Msk & (_UINT16_(value) << USBHS_INTRTX_EP2TX_Pos)) /* Assignment of value for EP2TX in the USBHS_INTRTX register */
...
#define USBHS_INTRTX_EP3TX(value)             (USBHS_INTRTX_EP3TX_Msk & (_UINT16_(value) << USBHS_INTRTX_EP3TX_Pos)) /* Assignment of value for EP3TX in the USBHS_INTRTX register */
...
#define USBHS_INTRTX_EP4TX(value)             (USBHS_INTRTX_EP4TX_Msk & (_UINT16_(value) << USBHS_INTRTX_EP4TX_Pos)) /* Assignment of value for EP4TX in the USBHS_INTRTX register */
...
#define USBHS_INTRTX_EP5TX(value)             (USBHS_INTRTX_EP5TX_Msk & (_UINT16_(value) << USBHS_INTRTX_EP5TX_Pos)) /* Assignment of value for EP5TX in the USBHS_INTRTX register */
...
#define USBHS_INTRTX_EP6TX(value)             (USBHS_INTRTX_EP6TX_Msk & (_UINT16_(value) << USBHS_INTRTX_EP6TX_Pos)) /* Assignment of value for EP6TX in the USBHS_INTRTX register */
...
#define USBHS_INTRTX_EP7TX(value)             (USBHS_INTRTX_EP7TX_Msk & (_UINT16_(value) << USBHS_INTRTX_EP7TX_Pos)) /* Assignment of value for EP7TX in the USBHS_INTRTX register */
...
#define USBHS_INTRRX_EP1RX(value)             (USBHS_INTRRX_EP1RX_Msk & (_UINT16_(value) << USBHS_INTRRX_EP1RX_Pos)) /* Assignment of value for EP1RX in the USBHS_INTRRX register */
...
#define USBHS_INTRRX_EP2RX(value)             (USBHS_INTRRX_EP2RX_Msk & (_UINT16_(value) << USBHS_INTRRX_EP2RX_Pos)) /* Assignment of value for EP2RX in the USBHS_INTRRX register */
...
#define USBHS_INTRRX_EP3RX(value)             (USBHS_INTRRX_EP3RX_Msk & (_UINT16_(value) << USBHS_INTRRX_EP3RX_Pos)) /* Assignment of value for EP3RX in the USBHS_INTRRX register */
...
#define USBHS_INTRRX_EP4RX(value)             (USBHS_INTRRX_EP4RX_Msk & (_UINT16_(value) << USBHS_INTRRX_EP4RX_Pos)) /* Assignment of value for EP4RX in the USBHS_INTRRX register */
...
#define USBHS_INTRRX_EP5RX(value)             (USBHS_INTRRX_EP5RX_Msk & (_UINT16_(value) << USBHS_INTRRX_EP5RX_Pos)) /* Assignment of value for EP5RX in the USBHS_INTRRX register */
...
#define USBHS_INTRRX_EP6RX(value)             (USBHS_INTRRX_EP6RX_Msk & (_UINT16_(value) << USBHS_INTRRX_EP6RX_Pos)) /* Assignment of value for EP6RX in the USBHS_INTRRX register */
...
#define USBHS_INTRRX_EP7RX(value)             (USBHS_INTRRX_EP7RX_Msk & (_UINT16_(value) << USBHS_INTRRX_EP7RX_Pos)) /* Assignment of value for EP7RX in the USBHS_INTRRX register */
...
#define USBHS_INTRTXE_EP0TXEN(value)          (USBHS_INTRTXE_EP0TXEN_Msk & (_UINT16_(value) << USBHS_INTRTXE_EP0TXEN_Pos)) /* Assignment of value for EP0TXEN in the USBHS_INTRTXE register */
...
#define USBHS_INTRTXE_EP1TXEN(value)          (USBHS_INTRTXE_EP1TXEN_Msk & (_UINT16_(value) << USBHS_INTRTXE_EP1TXEN_Pos)) /* Assignment of value for EP1TXEN in the USBHS_INTRTXE register */
...
#define USBHS_INTRTXE_EP2TXEN(value)          (USBHS_INTRTXE_EP2TXEN_Msk & (_UINT16_(value) << USBHS_INTRTXE_EP2TXEN_Pos)) /* Assignment of value for EP2TXEN in the USBHS_INTRTXE register */
...
#define USBHS_INTRTXE_EP3TXEN(value)          (USBHS_INTRTXE_EP3TXEN_Msk & (_UINT16_(value) << USBHS_INTRTXE_EP3TXEN_Pos)) /* Assignment of value for EP3TXEN in the USBHS_INTRTXE register */
...
#define USBHS_INTRTXE_EP4TXEN(value)          (USBHS_INTRTXE_EP4TXEN_Msk & (_UINT16_(value) << USBHS_INTRTXE_EP4TXEN_Pos)) /* Assignment of value for EP4TXEN in the USBHS_INTRTXE register */
...
#define USBHS_INTRTXE_EP5TXEN(value)          (USBHS_INTRTXE_EP5TXEN_Msk & (_UINT16_(value) << USBHS_INTRTXE_EP5TXEN_Pos)) /* Assignment of value for EP5TXEN in the USBHS_INTRTXE register */
...
#define USBHS_INTRTXE_EP6TXEN(value)          (USBHS_INTRTXE_EP6TXEN_Msk & (_UINT16_(value) << USBHS_INTRTXE_EP6TXEN_Pos)) /* Assignment of value for EP6TXEN in the USBHS_INTRTXE register */
...
#define USBHS_INTRTXE_EP7TXEN(value)          (USBHS_INTRTXE_EP7TXEN_Msk & (_UINT16_(value) << USBHS_INTRTXE_EP7TXEN_Pos)) /* Assignment of value for EP7TXEN in the USBHS_INTRTXE register */
...
#define USBHS_INTRRXE_EP1RXE(value)           (USBHS_INTRRXE_EP1RXE_Msk & (_UINT16_(value) << USBHS_INTRRXE_EP1RXE_Pos)) /* Assignment of value for EP1RXE in the USBHS_INTRRXE register */
...
#define USBHS_INTRRXE_EP2RXE(value)           (USBHS_INTRRXE_EP2RXE_Msk & (_UINT16_(value) << USBHS_INTRRXE_EP2RXE_Pos)) /* Assignment of value for EP2RXE in the USBHS_INTRRXE register */
...
#define USBHS_INTRRXE_EP3RXE(value)           (USBHS_INTRRXE_EP3RXE_Msk & (_UINT16_(value) << USBHS_INTRRXE_EP3RXE_Pos)) /* Assignment of value for EP3RXE in the USBHS_INTRRXE register */
...
#define USBHS_INTRRXE_EP4RXE(value)           (USBHS_INTRRXE_EP4RXE_Msk & (_UINT16_(value) << USBHS_INTRRXE_EP4RXE_Pos)) /* Assignment of value for EP4RXE in the USBHS_INTRRXE register */
...
#define USBHS_INTRRXE_EP5RXE(value)           (USBHS_INTRRXE_EP5RXE_Msk & (_UINT16_(value) << USBHS_INTRRXE_EP5RXE_Pos)) /* Assignment of value for EP5RXE in the USBHS_INTRRXE register */
...
#define USBHS_INTRRXE_EP6RXE(value)           (USBHS_INTRRXE_EP6RXE_Msk & (_UINT16_(value) << USBHS_INTRRXE_EP6RXE_Pos)) /* Assignment of value for EP6RXE in the USBHS_INTRRXE register */
...
#define USBHS_INTRRXE_EP7RXE(value)           (USBHS_INTRRXE_EP7RXE_Msk & (_UINT16_(value) << USBHS_INTRRXE_EP7RXE_Pos)) /* Assignment of value for EP7RXE in the USBHS_INTRRXE register */
...
#define USBHS_INTRUSB_SUSPEND(value)          (USBHS_INTRUSB_SUSPEND_Msk & (_UINT8_(value) << USBHS_INTRUSB_SUSPEND_Pos)) /* Assignment of value for SUSPEND in the USBHS_INTRUSB register */
...
#define USBHS_INTRUSB_RESUME(value)           (USBHS_INTRUSB_RESUME_Msk & (_UINT8_(value) << USBHS_INTRUSB_RESUME_Pos)) /* Assignment of value for RESUME in the USBHS_INTRUSB register */
...
#define USBHS_INTRUSB_RESET(value)            (USBHS_INTRUSB_RESET_Msk & (_UINT8_(value) << USBHS_INTRUSB_RESET_Pos)) /* Assignment of value for RESET in the USBHS_INTRUSB register */
...
#define USBHS_INTRUSB_SOF(value)              (USBHS_INTRUSB_SOF_Msk & (_UINT8_(value) << USBHS_INTRUSB_SOF_Pos)) /* Assignment of value for SOF in the USBHS_INTRUSB register */
...
#define USBHS_INTRUSB_CONN(value)             (USBHS_INTRUSB_CONN_Msk & (_UINT8_(value) << USBHS_INTRUSB_CONN_Pos)) /* Assignment of value for CONN in the USBHS_INTRUSB register */
...
#define USBHS_INTRUSB_DISCON(value)           (USBHS_INTRUSB_DISCON_Msk & (_UINT8_(value) << USBHS_INTRUSB_DISCON_Pos)) /* Assignment of value for DISCON in the USBHS_INTRUSB register */
...
#define USBHS_INTRUSB_SESSREQ(value)          (USBHS_INTRUSB_SESSREQ_Msk & (_UINT8_(value) << USBHS_INTRUSB_SESSREQ_Pos)) /* Assignment of value for SESSREQ in the USBHS_INTRUSB register */
...
#define USBHS_INTRUSB_VBUSERR(value)          (USBHS_INTRUSB_VBUSERR_Msk & (_UINT8_(value) << USBHS_INTRUSB_VBUSERR_Pos)) /* Assignment of value for VBUSERR in the USBHS_INTRUSB register */
...
#define USBHS_INTRUSBE_SUSPENDEN(value)       (USBHS_INTRUSBE_SUSPENDEN_Msk & (_UINT8_(value) << USBHS_INTRUSBE_SUSPENDEN_Pos)) /* Assignment of value for SUSPENDEN in the USBHS_INTRUSBE register */
...
#define USBHS_INTRUSBE_RESUMEEN(value)        (USBHS_INTRUSBE_RESUMEEN_Msk & (_UINT8_(value) << USBHS_INTRUSBE_RESUMEEN_Pos)) /* Assignment of value for RESUMEEN in the USBHS_INTRUSBE register */
...
#define USBHS_INTRUSBE_RESETEN(value)         (USBHS_INTRUSBE_RESETEN_Msk & (_UINT8_(value) << USBHS_INTRUSBE_RESETEN_Pos)) /* Assignment of value for RESETEN in the USBHS_INTRUSBE register */
...
#define USBHS_INTRUSBE_SOFEN(value)           (USBHS_INTRUSBE_SOFEN_Msk & (_UINT8_(value) << USBHS_INTRUSBE_SOFEN_Pos)) /* Assignment of value for SOFEN in the USBHS_INTRUSBE register */
...
#define USBHS_INTRUSBE_CONNEN(value)          (USBHS_INTRUSBE_CONNEN_Msk & (_UINT8_(value) << USBHS_INTRUSBE_CONNEN_Pos)) /* Assignment of value for CONNEN in the USBHS_INTRUSBE register */
...
#define USBHS_INTRUSBE_DISCONEN(value)        (USBHS_INTRUSBE_DISCONEN_Msk & (_UINT8_(value) << USBHS_INTRUSBE_DISCONEN_Pos)) /* Assignment of value for DISCONEN in the USBHS_INTRUSBE register */
...
#define USBHS_INTRUSBE_SESSREQEN(value)       (USBHS_INTRUSBE_SESSREQEN_Msk & (_UINT8_(value) << USBHS_INTRUSBE_SESSREQEN_Pos)) /* Assignment of value for SESSREQEN in the USBHS_INTRUSBE register */
...
#define USBHS_INTRUSBE_VBUSERREN(value)       (USBHS_INTRUSBE_VBUSERREN_Msk & (_UINT8_(value) << USBHS_INTRUSBE_VBUSERREN_Pos)) /* Assignment of value for VBUSERREN in the USBHS_INTRUSBE register */
...
#define USBHS_FRAME_FRMNUM(value)             (USBHS_FRAME_FRMNUM_Msk & (_UINT16_(value) << USBHS_FRAME_FRMNUM_Pos)) /* Assignment of value for FRMNUM in the USBHS_FRAME register */
...
#define USBHS_INDEX_SELEP(value)              (USBHS_INDEX_SELEP_Msk & (_UINT8_(value) << USBHS_INDEX_SELEP_Pos)) /* Assignment of value for SELEP in the USBHS_INDEX register */
...
#define USBHS_TESTMODE_TESTSE0NAK(value)      (USBHS_TESTMODE_TESTSE0NAK_Msk & (_UINT8_(value) << USBHS_TESTMODE_TESTSE0NAK_Pos)) /* Assignment of value for TESTSE0NAK in the USBHS_TESTMODE register */
...
#define USBHS_TESTMODE_TESTJ(value)           (USBHS_TESTMODE_TESTJ_Msk & (_UINT8_(value) << USBHS_TESTMODE_TESTJ_Pos)) /* Assignment of value for TESTJ in the USBHS_TESTMODE register */
...
#define USBHS_TESTMODE_TESTK(value)           (USBHS_TESTMODE_TESTK_Msk & (_UINT8_(value) << USBHS_TESTMODE_TESTK_Pos)) /* Assignment of value for TESTK in the USBHS_TESTMODE register */
...
#define USBHS_TESTMODE_TESTPACKET(value)      (USBHS_TESTMODE_TESTPACKET_Msk & (_UINT8_(value) << USBHS_TESTMODE_TESTPACKET_Pos)) /* Assignment of value for TESTPACKET in the USBHS_TESTMODE register */
...
#define USBHS_TESTMODE_FORCEHS(value)         (USBHS_TESTMODE_FORCEHS_Msk & (_UINT8_(value) << USBHS_TESTMODE_FORCEHS_Pos)) /* Assignment of value for FORCEHS in the USBHS_TESTMODE register */
...
#define USBHS_TESTMODE_FORCEFS(value)         (USBHS_TESTMODE_FORCEFS_Msk & (_UINT8_(value) << USBHS_TESTMODE_FORCEFS_Pos)) /* Assignment of value for FORCEFS in the USBHS_TESTMODE register */
...
#define USBHS_TESTMODE_FIFOACCESS(value)      (USBHS_TESTMODE_FIFOACCESS_Msk & (_UINT8_(value) << USBHS_TESTMODE_FIFOACCESS_Pos)) /* Assignment of value for FIFOACCESS in the USBHS_TESTMODE register */
...
#define USBHS_TESTMODE_FORCEHOST(value)       (USBHS_TESTMODE_FORCEHOST_Msk & (_UINT8_(value) << USBHS_TESTMODE_FORCEHOST_Pos)) /* Assignment of value for FORCEHOST in the USBHS_TESTMODE register */
...
#define USBHS_ENDPOINTX_TXMAXP_MAXPAYLOAD(value) (USBHS_ENDPOINTX_TXMAXP_MAXPAYLOAD_Msk & (_UINT16_(value) << USBHS_ENDPOINTX_TXMAXP_MAXPAYLOAD_Pos)) /* Assignment of value for MAXPAYLOAD in the USBHS_ENDPOINTX_TXMAXP register */
...
#define USBHS_ENDPOINTX_TXMAXP_MULTIPLIER(value) (USBHS_ENDPOINTX_TXMAXP_MULTIPLIER_Msk & (_UINT16_(value) << USBHS_ENDPOINTX_TXMAXP_MULTIPLIER_Pos)) /* Assignment of value for MULTIPLIER in the USBHS_ENDPOINTX_TXMAXP register */
...
#define USBHS_ENDPOINTX_TXCSRL_TXPKTRDY(value) (USBHS_ENDPOINTX_TXCSRL_TXPKTRDY_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_TXCSRL_TXPKTRDY_Pos)) /* Assignment of value for TXPKTRDY in the USBHS_ENDPOINTX_TXCSRL register */
...
#define USBHS_ENDPOINTX_TXCSRL_FIFONOTEMPTY(value) (USBHS_ENDPOINTX_TXCSRL_FIFONOTEMPTY_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_TXCSRL_FIFONOTEMPTY_Pos)) /* Assignment of value for FIFONOTEMPTY in the USBHS_ENDPOINTX_TXCSRL register */
...
#define USBHS_ENDPOINTX_TXCSRL_FLUSHFIFO(value) (USBHS_ENDPOINTX_TXCSRL_FLUSHFIFO_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_TXCSRL_FLUSHFIFO_Pos)) /* Assignment of value for FLUSHFIFO in the USBHS_ENDPOINTX_TXCSRL register */
...
#define USBHS_ENDPOINTX_TXCSRL_CLRDATATOG(value) (USBHS_ENDPOINTX_TXCSRL_CLRDATATOG_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_TXCSRL_CLRDATATOG_Pos)) /* Assignment of value for CLRDATATOG in the USBHS_ENDPOINTX_TXCSRL register */
...
#define USBHS_ENDPOINT0_CSR0L_RXPKTRDY(value) (USBHS_ENDPOINT0_CSR0L_RXPKTRDY_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CSR0L_RXPKTRDY_Pos)) /* Assignment of value for RXPKTRDY in the USBHS_ENDPOINT0_CSR0L register */
...
#define USBHS_ENDPOINT0_CSR0L_TXPKTRDY(value) (USBHS_ENDPOINT0_CSR0L_TXPKTRDY_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CSR0L_TXPKTRDY_Pos)) /* Assignment of value for TXPKTRDY in the USBHS_ENDPOINT0_CSR0L register */
...
#define USBHS_ENDPOINTX_TXCSRH_MODE(value)    (USBHS_ENDPOINTX_TXCSRH_MODE_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_TXCSRH_MODE_Pos)) /* Assignment of value for MODE in the USBHS_ENDPOINTX_TXCSRH register */
...
#define USBHS_ENDPOINT0_CSR0H_FLUSHFIFO(value) (USBHS_ENDPOINT0_CSR0H_FLUSHFIFO_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CSR0H_FLUSHFIFO_Pos)) /* Assignment of value for FLUSHFIFO in the USBHS_ENDPOINT0_CSR0H register */
...
#define USBHS_ENDPOINTX_RXMAXP_MAXPAYLOAD(value) (USBHS_ENDPOINTX_RXMAXP_MAXPAYLOAD_Msk & (_UINT16_(value) << USBHS_ENDPOINTX_RXMAXP_MAXPAYLOAD_Pos)) /* Assignment of value for MAXPAYLOAD in the USBHS_ENDPOINTX_RXMAXP register */
...
#define USBHS_ENDPOINTX_RXMAXP_MULTIPLIER(value) (USBHS_ENDPOINTX_RXMAXP_MULTIPLIER_Msk & (_UINT16_(value) << USBHS_ENDPOINTX_RXMAXP_MULTIPLIER_Pos)) /* Assignment of value for MULTIPLIER in the USBHS_ENDPOINTX_RXMAXP register */
...
#define USBHS_ENDPOINTX_RXCSRL_RXPKTRDY(value) (USBHS_ENDPOINTX_RXCSRL_RXPKTRDY_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_RXCSRL_RXPKTRDY_Pos)) /* Assignment of value for RXPKTRDY in the USBHS_ENDPOINTX_RXCSRL register */
...
#define USBHS_ENDPOINTX_RXCSRL_FLUSHFIFO(value) (USBHS_ENDPOINTX_RXCSRL_FLUSHFIFO_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_RXCSRL_FLUSHFIFO_Pos)) /* Assignment of value for FLUSHFIFO in the USBHS_ENDPOINTX_RXCSRL register */
...
#define USBHS_ENDPOINTX_RXCSRL_CLRDATATOG(value) (USBHS_ENDPOINTX_RXCSRL_CLRDATATOG_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_RXCSRL_CLRDATATOG_Pos)) /* Assignment of value for CLRDATATOG in the USBHS_ENDPOINTX_RXCSRL register */
...
#define USBHS_ENDPOINTX_RXCSRH_DMAREQMODE(value) (USBHS_ENDPOINTX_RXCSRH_DMAREQMODE_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_RXCSRH_DMAREQMODE_Pos)) /* Assignment of value for DMAREQMODE in the USBHS_ENDPOINTX_RXCSRH register */
...
#define USBHS_ENDPOINTX_RXCSRH_DMAREQENAB(value) (USBHS_ENDPOINTX_RXCSRH_DMAREQENAB_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_RXCSRH_DMAREQENAB_Pos)) /* Assignment of value for DMAREQENAB in the USBHS_ENDPOINTX_RXCSRH register */
...
#define USBHS_ENDPOINTX_RXCOUNT_ENDPOINTRXCOUNT(value) (USBHS_ENDPOINTX_RXCOUNT_ENDPOINTRXCOUNT_Msk & (_UINT16_(value) << USBHS_ENDPOINTX_RXCOUNT_ENDPOINTRXCOUNT_Pos)) /* Assignment of value for ENDPOINTRXCOUNT in the USBHS_ENDPOINTX_RXCOUNT register */
...
#define USBHS_ENDPOINT0_COUNT0_EP0RXCOUNT(value) (USBHS_ENDPOINT0_COUNT0_EP0RXCOUNT_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_COUNT0_EP0RXCOUNT_Pos)) /* Assignment of value for EP0RXCOUNT in the USBHS_ENDPOINT0_COUNT0 register */
...
#define USBHS_ENDPOINTX_TXTYPE_ENDPOINTNUMBER(value) (USBHS_ENDPOINTX_TXTYPE_ENDPOINTNUMBER_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_TXTYPE_ENDPOINTNUMBER_Pos)) /* Assignment of value for ENDPOINTNUMBER in the USBHS_ENDPOINTX_TXTYPE register */
...
#define USBHS_ENDPOINTX_TXTYPE_PROTOCOL(value) (USBHS_ENDPOINTX_TXTYPE_PROTOCOL_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_TXTYPE_PROTOCOL_Pos)) /* Assignment of value for PROTOCOL in the USBHS_ENDPOINTX_TXTYPE register */
...
#define USBHS_ENDPOINTX_TXTYPE_SPEED(value)   (USBHS_ENDPOINTX_TXTYPE_SPEED_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_TXTYPE_SPEED_Pos)) /* Assignment of value for SPEED in the USBHS_ENDPOINTX_TXTYPE register */
...
#define USBHS_ENDPOINT0_TYPE0_SPEED(value)    (USBHS_ENDPOINT0_TYPE0_SPEED_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_TYPE0_SPEED_Pos)) /* Assignment of value for SPEED in the USBHS_ENDPOINT0_TYPE0 register */
...
#define USBHS_ENDPOINTX_TXINTERVAL_TXPOLLINGINTERVAL(value) (USBHS_ENDPOINTX_TXINTERVAL_TXPOLLINGINTERVAL_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_TXINTERVAL_TXPOLLINGINTERVAL_Pos)) /* Assignment of value for TXPOLLINGINTERVAL in the USBHS_ENDPOINTX_TXINTERVAL register */
...
#define USBHS_ENDPOINT0_NAKLIMIT0_EP0NAKLIMIT(value) (USBHS_ENDPOINT0_NAKLIMIT0_EP0NAKLIMIT_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_NAKLIMIT0_EP0NAKLIMIT_Pos)) /* Assignment of value for EP0NAKLIMIT in the USBHS_ENDPOINT0_NAKLIMIT0 register */
...
#define USBHS_ENDPOINTX_RXTYPE_ENDPOINTNUMBER(value) (USBHS_ENDPOINTX_RXTYPE_ENDPOINTNUMBER_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_RXTYPE_ENDPOINTNUMBER_Pos)) /* Assignment of value for ENDPOINTNUMBER in the USBHS_ENDPOINTX_RXTYPE register */
...
#define USBHS_ENDPOINTX_RXTYPE_PROTOCOL(value) (USBHS_ENDPOINTX_RXTYPE_PROTOCOL_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_RXTYPE_PROTOCOL_Pos)) /* Assignment of value for PROTOCOL in the USBHS_ENDPOINTX_RXTYPE register */
...
#define USBHS_ENDPOINTX_RXTYPE_SPEED(value)   (USBHS_ENDPOINTX_RXTYPE_SPEED_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_RXTYPE_SPEED_Pos)) /* Assignment of value for SPEED in the USBHS_ENDPOINTX_RXTYPE register */
...
#define USBHS_ENDPOINTX_RXINTERVAL_RXPOLLINGINTERVAL(value) (USBHS_ENDPOINTX_RXINTERVAL_RXPOLLINGINTERVAL_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_RXINTERVAL_RXPOLLINGINTERVAL_Pos)) /* Assignment of value for RXPOLLINGINTERVAL in the USBHS_ENDPOINTX_RXINTERVAL register */
...
#define USBHS_ENDPOINTX_FIFOSIZE_TXFIFOSIZE(value) (USBHS_ENDPOINTX_FIFOSIZE_TXFIFOSIZE_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_FIFOSIZE_TXFIFOSIZE_Pos)) /* Assignment of value for TXFIFOSIZE in the USBHS_ENDPOINTX_FIFOSIZE register */
...
#define USBHS_ENDPOINTX_FIFOSIZE_RXFIFOSIZE(value) (USBHS_ENDPOINTX_FIFOSIZE_RXFIFOSIZE_Msk & (_UINT8_(value) << USBHS_ENDPOINTX_FIFOSIZE_RXFIFOSIZE_Pos)) /* Assignment of value for RXFIFOSIZE in the USBHS_ENDPOINTX_FIFOSIZE register */
...
#define USBHS_ENDPOINT0_CONFIGDATA_UTMIDATAWIDTH(value) (USBHS_ENDPOINT0_CONFIGDATA_UTMIDATAWIDTH_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CONFIGDATA_UTMIDATAWIDTH_Pos)) /* Assignment of value for UTMIDATAWIDTH in the USBHS_ENDPOINT0_CONFIGDATA register */
...
#define USBHS_ENDPOINT0_CONFIGDATA_SOFTCONE(value) (USBHS_ENDPOINT0_CONFIGDATA_SOFTCONE_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CONFIGDATA_SOFTCONE_Pos)) /* Assignment of value for SOFTCONE in the USBHS_ENDPOINT0_CONFIGDATA register */
...
#define USBHS_ENDPOINT0_CONFIGDATA_DYNFIFOSIZING(value) (USBHS_ENDPOINT0_CONFIGDATA_DYNFIFOSIZING_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CONFIGDATA_DYNFIFOSIZING_Pos)) /* Assignment of value for DYNFIFOSIZING in the USBHS_ENDPOINT0_CONFIGDATA register */
...
#define USBHS_ENDPOINT0_CONFIGDATA_HBTXE(value) (USBHS_ENDPOINT0_CONFIGDATA_HBTXE_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CONFIGDATA_HBTXE_Pos)) /* Assignment of value for HBTXE in the USBHS_ENDPOINT0_CONFIGDATA register */
...
#define USBHS_ENDPOINT0_CONFIGDATA_HBRXE(value) (USBHS_ENDPOINT0_CONFIGDATA_HBRXE_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CONFIGDATA_HBRXE_Pos)) /* Assignment of value for HBRXE in the USBHS_ENDPOINT0_CONFIGDATA register */
...
#define USBHS_ENDPOINT0_CONFIGDATA_BIGENDIAN(value) (USBHS_ENDPOINT0_CONFIGDATA_BIGENDIAN_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CONFIGDATA_BIGENDIAN_Pos)) /* Assignment of value for BIGENDIAN in the USBHS_ENDPOINT0_CONFIGDATA register */
...
#define USBHS_ENDPOINT0_CONFIGDATA_MPTXE(value) (USBHS_ENDPOINT0_CONFIGDATA_MPTXE_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CONFIGDATA_MPTXE_Pos)) /* Assignment of value for MPTXE in the USBHS_ENDPOINT0_CONFIGDATA register */
...
#define USBHS_ENDPOINT0_CONFIGDATA_MPRXE(value) (USBHS_ENDPOINT0_CONFIGDATA_MPRXE_Msk & (_UINT8_(value) << USBHS_ENDPOINT0_CONFIGDATA_MPRXE_Pos)) /* Assignment of value for MPRXE in the USBHS_ENDPOINT0_CONFIGDATA register */
...
#define USBHS_FIFOX_FIFOADDR(value)           (USBHS_FIFOX_FIFOADDR_Msk & (_UINT32_(value) << USBHS_FIFOX_FIFOADDR_Pos)) /* Assignment of value for FIFOADDR in the USBHS_FIFOX register */
...
#define USBHS_DEVCTL_SESSION(value)           (USBHS_DEVCTL_SESSION_Msk & (_UINT8_(value) << USBHS_DEVCTL_SESSION_Pos)) /* Assignment of value for SESSION in the USBHS_DEVCTL register */
...
#define USBHS_DEVCTL_HOSTREQ(value)           (USBHS_DEVCTL_HOSTREQ_Msk & (_UINT8_(value) << USBHS_DEVCTL_HOSTREQ_Pos)) /* Assignment of value for HOSTREQ in the USBHS_DEVCTL register */
...
#define USBHS_DEVCTL_HOSTMODE(value)          (USBHS_DEVCTL_HOSTMODE_Msk & (_UINT8_(value) << USBHS_DEVCTL_HOSTMODE_Pos)) /* Assignment of value for HOSTMODE in the USBHS_DEVCTL register */
...
#define USBHS_DEVCTL_VBUS(value)              (USBHS_DEVCTL_VBUS_Msk & (_UINT8_(value) << USBHS_DEVCTL_VBUS_Pos)) /* Assignment of value for VBUS in the USBHS_DEVCTL register */
...
#define USBHS_DEVCTL_LSDEV(value)             (USBHS_DEVCTL_LSDEV_Msk & (_UINT8_(value) << USBHS_DEVCTL_LSDEV_Pos)) /* Assignment of value for LSDEV in the USBHS_DEVCTL register */
...
#define USBHS_DEVCTL_FSDEV(value)             (USBHS_DEVCTL_FSDEV_Msk & (_UINT8_(value) << USBHS_DEVCTL_FSDEV_Pos)) /* Assignment of value for FSDEV in the USBHS_DEVCTL register */
...
#define USBHS_DEVCTL_BDEVICE(value)           (USBHS_DEVCTL_BDEVICE_Msk & (_UINT8_(value) << USBHS_DEVCTL_BDEVICE_Pos)) /* Assignment of value for BDEVICE in the USBHS_DEVCTL register */
...
#define USBHS_MISC_RXEDMA(value)              (USBHS_MISC_RXEDMA_Msk & (_UINT8_(value) << USBHS_MISC_RXEDMA_Pos)) /* Assignment of value for RXEDMA in the USBHS_MISC register */
...
#define USBHS_MISC_TXEDMA(value)              (USBHS_MISC_TXEDMA_Msk & (_UINT8_(value) << USBHS_MISC_TXEDMA_Pos)) /* Assignment of value for TXEDMA in the USBHS_MISC register */
...
#define USBHS_TXFIFOSZ_SZ(value)              (USBHS_TXFIFOSZ_SZ_Msk & (_UINT8_(value) << USBHS_TXFIFOSZ_SZ_Pos)) /* Assignment of value for SZ in the USBHS_TXFIFOSZ register */
...
#define USBHS_TXFIFOSZ_DPB(value)             (USBHS_TXFIFOSZ_DPB_Msk & (_UINT8_(value) << USBHS_TXFIFOSZ_DPB_Pos)) /* Assignment of value for DPB in the USBHS_TXFIFOSZ register */
...
#define USBHS_RXFIFOSZ_SZ(value)              (USBHS_RXFIFOSZ_SZ_Msk & (_UINT8_(value) << USBHS_RXFIFOSZ_SZ_Pos)) /* Assignment of value for SZ in the USBHS_RXFIFOSZ register */
...
#define USBHS_RXFIFOSZ_DPB(value)             (USBHS_RXFIFOSZ_DPB_Msk & (_UINT8_(value) << USBHS_RXFIFOSZ_DPB_Pos)) /* Assignment of value for DPB in the USBHS_RXFIFOSZ register */
...
#define USBHS_TXFIFOADD_ADDR(value)           (USBHS_TXFIFOADD_ADDR_Msk & (_UINT16_(value) << USBHS_TXFIFOADD_ADDR_Pos)) /* Assignment of value for ADDR in the USBHS_TXFIFOADD register */
...
#define USBHS_RXFIFOADD_ADDR(value)           (USBHS_RXFIFOADD_ADDR_Msk & (_UINT16_(value) << USBHS_RXFIFOADD_ADDR_Pos)) /* Assignment of value for ADDR in the USBHS_RXFIFOADD register */
...
#define USBHS_EPINFO_TXENDPOINTS(value)       (USBHS_EPINFO_TXENDPOINTS_Msk & (_UINT8_(value) << USBHS_EPINFO_TXENDPOINTS_Pos)) /* Assignment of value for TXENDPOINTS in the USBHS_EPINFO register */
...
#define USBHS_EPINFO_RXENDPOINTS(value)       (USBHS_EPINFO_RXENDPOINTS_Msk & (_UINT8_(value) << USBHS_EPINFO_RXENDPOINTS_Pos)) /* Assignment of value for RXENDPOINTS in the USBHS_EPINFO register */
...
#define USBHS_RAMINFO_RAMBITS(value)          (USBHS_RAMINFO_RAMBITS_Msk & (_UINT8_(value) << USBHS_RAMINFO_RAMBITS_Pos)) /* Assignment of value for RAMBITS in the USBHS_RAMINFO register */
...
#define USBHS_RAMINFO_DMACHANS(value)         (USBHS_RAMINFO_DMACHANS_Msk & (_UINT8_(value) << USBHS_RAMINFO_DMACHANS_Pos)) /* Assignment of value for DMACHANS in the USBHS_RAMINFO register */
...
#define USBHS_LINKINFO_WTID(value)            (USBHS_LINKINFO_WTID_Msk & (_UINT8_(value) << USBHS_LINKINFO_WTID_Pos)) /* Assignment of value for WTID in the USBHS_LINKINFO register */
...
#define USBHS_LINKINFO_WTCON(value)           (USBHS_LINKINFO_WTCON_Msk & (_UINT8_(value) << USBHS_LINKINFO_WTCON_Pos)) /* Assignment of value for WTCON in the USBHS_LINKINFO register */
...
#define USBHS_VPLEN_VPLEN(value)              (USBHS_VPLEN_VPLEN_Msk & (_UINT8_(value) << USBHS_VPLEN_VPLEN_Pos)) /* Assignment of value for VPLEN in the USBHS_VPLEN register */
...
#define USBHS_HSEOF1_HSEOF1(value)            (USBHS_HSEOF1_HSEOF1_Msk & (_UINT8_(value) << USBHS_HSEOF1_HSEOF1_Pos)) /* Assignment of value for HSEOF1 in the USBHS_HSEOF1 register */
...
#define USBHS_FSEOF1_FSEOF1(value)            (USBHS_FSEOF1_FSEOF1_Msk & (_UINT8_(value) << USBHS_FSEOF1_FSEOF1_Pos)) /* Assignment of value for FSEOF1 in the USBHS_FSEOF1 register */
...
#define USBHS_LSEOF1_LSEOF1(value)            (USBHS_LSEOF1_LSEOF1_Msk & (_UINT8_(value) << USBHS_LSEOF1_LSEOF1_Pos)) /* Assignment of value for LSEOF1 in the USBHS_LSEOF1 register */
...
#define USBHS_SOFTRST_NRST(value)             (USBHS_SOFTRST_NRST_Msk & (_UINT8_(value) << USBHS_SOFTRST_NRST_Pos)) /* Assignment of value for NRST in the USBHS_SOFTRST register */
...
#define USBHS_SOFTRST_NRSTX(value)            (USBHS_SOFTRST_NRSTX_Msk & (_UINT8_(value) << USBHS_SOFTRST_NRSTX_Pos)) /* Assignment of value for NRSTX in the USBHS_SOFTRST register */
...
#define USBHS_DMAINTR_DMAINTR(value)          (USBHS_DMAINTR_DMAINTR_Msk & (_UINT32_(value) << USBHS_DMAINTR_DMAINTR_Pos)) /* Assignment of value for DMAINTR in the USBHS_DMAINTR register */
...
#define USBHS_RQPKTCOUNT_RQPKTCOUNT(value)    (USBHS_RQPKTCOUNT_RQPKTCOUNT_Msk & (_UINT32_(value) << USBHS_RQPKTCOUNT_RQPKTCOUNT_Pos)) /* Assignment of value for RQPKTCOUNT in the USBHS_RQPKTCOUNT register */
...
#define USBHS_RXDPKTBUFDIS_EPxRXDIS(value)    (USBHS_RXDPKTBUFDIS_EPxRXDIS_Msk & (_UINT16_(value) << USBHS_RXDPKTBUFDIS_EPxRXDIS_Pos)) /* Assignment of value for EPxRXDIS in the USBHS_RXDPKTBUFDIS register */
...
#define USBHS_TXDPKTBUFDIS_EPxTXDIS(value)    (USBHS_TXDPKTBUFDIS_EPxTXDIS_Msk & (_UINT16_(value) << USBHS_TXDPKTBUFDIS_EPxTXDIS_Pos)) /* Assignment of value for EPxTXDIS in the USBHS_TXDPKTBUFDIS register */
...
#define USBHS_CTUCH_CTUCH(value)              (USBHS_CTUCH_CTUCH_Msk & (_UINT16_(value) << USBHS_CTUCH_CTUCH_Pos)) /* Assignment of value for CTUCH in the USBHS_CTUCH register */
...
#define USBHS_CTHHSRTN_CTHHSRTN(value)        (USBHS_CTHHSRTN_CTHHSRTN_Msk & (_UINT16_(value) << USBHS_CTHHSRTN_CTHHSRTN_Pos)) /* Assignment of value for CTHHSRTN in the USBHS_CTHHSRTN register */
...
#define USBHS_CTHSBT_HSTMEOUTADD(value)       (USBHS_CTHSBT_HSTMEOUTADD_Msk & (_UINT16_(value) << USBHS_CTHSBT_HSTMEOUTADD_Pos)) /* Assignment of value for HSTMEOUTADD in the USBHS_CTHSBT register */
...
#define USBHS_LPMATTR_LINKSTATE(value)        (USBHS_LPMATTR_LINKSTATE_Msk & (_UINT16_(value) << USBHS_LPMATTR_LINKSTATE_Pos)) /* Assignment of value for LINKSTATE in the USBHS_LPMATTR register */
...
#define USBHS_LPMATTR_HIRD(value)             (USBHS_LPMATTR_HIRD_Msk & (_UINT16_(value) << USBHS_LPMATTR_HIRD_Pos)) /* Assignment of value for HIRD in the USBHS_LPMATTR register */
...
#define USBHS_LPMATTR_RMTWAK(value)           (USBHS_LPMATTR_RMTWAK_Msk & (_UINT16_(value) << USBHS_LPMATTR_RMTWAK_Pos)) /* Assignment of value for RMTWAK in the USBHS_LPMATTR register */
...
#define USBHS_LPMATTR_ENDPOINT(value)         (USBHS_LPMATTR_ENDPOINT_Msk & (_UINT16_(value) << USBHS_LPMATTR_ENDPOINT_Pos)) /* Assignment of value for ENDPOINT in the USBHS_LPMATTR register */
...
#define USBHS_LPMINTREN_LPMSTEN(value)        (USBHS_LPMINTREN_LPMSTEN_Msk & (_UINT8_(value) << USBHS_LPMINTREN_LPMSTEN_Pos)) /* Assignment of value for LPMSTEN in the USBHS_LPMINTREN register */
...
#define USBHS_LPMINTREN_LPMNYEN(value)        (USBHS_LPMINTREN_LPMNYEN_Msk & (_UINT8_(value) << USBHS_LPMINTREN_LPMNYEN_Pos)) /* Assignment of value for LPMNYEN in the USBHS_LPMINTREN register */
...
#define USBHS_LPMINTREN_LPMACKEN(value)       (USBHS_LPMINTREN_LPMACKEN_Msk & (_UINT8_(value) << USBHS_LPMINTREN_LPMACKEN_Pos)) /* Assignment of value for LPMACKEN in the USBHS_LPMINTREN register */
...
#define USBHS_LPMINTREN_LPMNCEN(value)        (USBHS_LPMINTREN_LPMNCEN_Msk & (_UINT8_(value) << USBHS_LPMINTREN_LPMNCEN_Pos)) /* Assignment of value for LPMNCEN in the USBHS_LPMINTREN register */
...
#define USBHS_LPMINTREN_LPMRESEN(value)       (USBHS_LPMINTREN_LPMRESEN_Msk & (_UINT8_(value) << USBHS_LPMINTREN_LPMRESEN_Pos)) /* Assignment of value for LPMRESEN in the USBHS_LPMINTREN register */
...
#define USBHS_LPMINTREN_LPMERREN(value)       (USBHS_LPMINTREN_LPMERREN_Msk & (_UINT8_(value) << USBHS_LPMINTREN_LPMERREN_Pos)) /* Assignment of value for LPMERREN in the USBHS_LPMINTREN register */
...
#define USBHS_LPMFADDR_FUNCADDR(value)        (USBHS_LPMFADDR_FUNCADDR_Msk & (_UINT8_(value) << USBHS_LPMFADDR_FUNCADDR_Pos)) /* Assignment of value for FUNCADDR in the USBHS_LPMFADDR register */
...
#define USBHS_PHY00_PREEMP(value)             (USBHS_PHY00_PREEMP_Msk & (_UINT32_(value) << USBHS_PHY00_PREEMP_Pos)) /* Assignment of value for PREEMP in the USBHS_PHY00 register */
...
#define USBHS_PHY00_SLEWRATE(value)           (USBHS_PHY00_SLEWRATE_Msk & (_UINT32_(value) << USBHS_PHY00_SLEWRATE_Pos)) /* Assignment of value for SLEWRATE in the USBHS_PHY00 register */
...
#define USBHS_PHY00_RXPHSSEL(value)           (USBHS_PHY00_RXPHSSEL_Msk & (_UINT32_(value) << USBHS_PHY00_RXPHSSEL_Pos)) /* Assignment of value for RXPHSSEL in the USBHS_PHY00 register */
...
#define USBHS_PHY04_TXPHSSEL(value)           (USBHS_PHY04_TXPHSSEL_Msk & (_UINT32_(value) << USBHS_PHY04_TXPHSSEL_Pos)) /* Assignment of value for TXPHSSEL in the USBHS_PHY04 register */
...
#define USBHS_PHY04_RSVD(value)               (USBHS_PHY04_RSVD_Msk & (_UINT32_(value) << USBHS_PHY04_RSVD_Pos)) /* Assignment of value for RSVD in the USBHS_PHY04 register */
...
#define USBHS_PHY04_HIZ(value)                (USBHS_PHY04_HIZ_Msk & (_UINT32_(value) << USBHS_PHY04_HIZ_Pos)) /* Assignment of value for HIZ in the USBHS_PHY04 register */
...
#define USBHS_PHY04_SQUELCH210(value)         (USBHS_PHY04_SQUELCH210_Msk & (_UINT32_(value) << USBHS_PHY04_SQUELCH210_Pos)) /* Assignment of value for SQUELCH210 in the USBHS_PHY04 register */
...
#define USBHS_PHY08_SQUELCH3(value)           (USBHS_PHY08_SQUELCH3_Msk & (_UINT32_(value) << USBHS_PHY08_SQUELCH3_Pos)) /* Assignment of value for SQUELCH3 in the USBHS_PHY08 register */
...
#define USBHS_PHY08_RSVD(value)               (USBHS_PHY08_RSVD_Msk & (_UINT32_(value) << USBHS_PHY08_RSVD_Pos)) /* Assignment of value for RSVD in the USBHS_PHY08 register */
...
#define USBHS_PHY0C_TUNE210(value)            (USBHS_PHY0C_TUNE210_Msk & (_UINT32_(value) << USBHS_PHY0C_TUNE210_Pos)) /* Assignment of value for TUNE210 in the USBHS_PHY0C register */
...
#define USBHS_PHY10_TUNE76543(value)          (USBHS_PHY10_TUNE76543_Msk & (_UINT32_(value) << USBHS_PHY10_TUNE76543_Pos)) /* Assignment of value for TUNE76543 in the USBHS_PHY10 register */
...
#define USBHS_PHY10_DRVTUNE210(value)         (USBHS_PHY10_DRVTUNE210_Msk & (_UINT32_(value) << USBHS_PHY10_DRVTUNE210_Pos)) /* Assignment of value for DRVTUNE210 in the USBHS_PHY10 register */
...
#define USBHS_PHY14_DRVTUNE43(value)          (USBHS_PHY14_DRVTUNE43_Msk & (_UINT32_(value) << USBHS_PHY14_DRVTUNE43_Pos)) /* Assignment of value for DRVTUNE43 in the USBHS_PHY14 register */
...
#define USBHS_PHY14_COMPBYPSS(value)          (USBHS_PHY14_COMPBYPSS_Msk & (_UINT32_(value) << USBHS_PHY14_COMPBYPSS_Pos)) /* Assignment of value for COMPBYPSS in the USBHS_PHY14 register */
...
#define USBHS_PHY14_BYPSSSQUELCH(value)       (USBHS_PHY14_BYPSSSQUELCH_Msk & (_UINT32_(value) << USBHS_PHY14_BYPSSSQUELCH_Pos)) /* Assignment of value for BYPSSSQUELCH in the USBHS_PHY14 register */
...
#define USBHS_PHY14_ODT0(value)               (USBHS_PHY14_ODT0_Msk & (_UINT32_(value) << USBHS_PHY14_ODT0_Pos)) /* Assignment of value for ODT0 in the USBHS_PHY14 register */
...
#define USBHS_PHY18_ODT21(value)              (USBHS_PHY18_ODT21_Msk & (_UINT32_(value) << USBHS_PHY18_ODT21_Pos)) /* Assignment of value for ODT21 in the USBHS_PHY18 register */
...
#define USBHS_PHY18_RSVD(value)               (USBHS_PHY18_RSVD_Msk & (_UINT32_(value) << USBHS_PHY18_RSVD_Pos)) /* Assignment of value for RSVD in the USBHS_PHY18 register */
...
#define USBHS_PHY1C_ODTBYPASS(value)          (USBHS_PHY1C_ODTBYPASS_Msk & (_UINT32_(value) << USBHS_PHY1C_ODTBYPASS_Pos)) /* Assignment of value for ODTBYPASS in the USBHS_PHY1C register */
...
#define USBHS_PHY1C_FSLSDIFF(value)           (USBHS_PHY1C_FSLSDIFF_Msk & (_UINT32_(value) << USBHS_PHY1C_FSLSDIFF_Pos)) /* Assignment of value for FSLSDIFF in the USBHS_PHY1C register */
...
#define USBHS_PHY20_RSVD(value)               (USBHS_PHY20_RSVD_Msk & (_UINT32_(value) << USBHS_PHY20_RSVD_Pos)) /* Assignment of value for RSVD in the USBHS_PHY20 register */
...
#define USBHS_PHY20_HSSLEW10(value)           (USBHS_PHY20_HSSLEW10_Msk & (_UINT32_(value) << USBHS_PHY20_HSSLEW10_Pos)) /* Assignment of value for HSSLEW10 in the USBHS_PHY20 register */
...
#define USBHS_PHY24_VBUSDETEN_Pos             _UINT32_(1)                                          /* (USBHS_PHY24) VBUS Detection Switch 0 - Closed, 1 - Open Position */
#define USBHS_PHY24_VBUSDETEN_Msk             (_UINT32_(0x1) << USBHS_PHY24_VBUSDETEN_Pos)         /* (USBHS_PHY24) VBUS Detection Switch 0 - Closed, 1 - Open Mask */
#define USBHS_PHY24_VBUSDETEN(value)          (USBHS_PHY24_VBUSDETEN_Msk & (_UINT32_(value) << USBHS_PHY24_VBUSDETEN_Pos)) /* Assignment of value for VBUSDETEN in the USBHS_PHY24 register */
#define USBHS_PHY24_ENHLFBITPRE_Pos           _UINT32_(2)                                          /* (USBHS_PHY24) Enable half-bit pre-emphasis for HS transmit Position */
#define USBHS_PHY24_ENHLFBITPRE_Msk           (_UINT32_(0x1) << USBHS_PHY24_ENHLFBITPRE_Pos)       /* (USBHS_PHY24) Enable half-bit pre-emphasis for HS transmit Mask */
#define USBHS_PHY24_ENHLFBITPRE(value)        (USBHS_PHY24_ENHLFBITPRE_Msk & (_UINT32_(value) << USBHS_PHY24_ENHLFBITPRE_Pos)) /* Assignment of value for ENHLFBITPRE in the USBHS_PHY24 register */
...
#define USBHS_PHY24_HSPREEMPST(value)         (USBHS_PHY24_HSPREEMPST_Msk & (_UINT32_(value) << USBHS_PHY24_HSPREEMPST_Pos)) /* Assignment of value for HSPREEMPST in the USBHS_PHY24 register */
...
#define USBHS_PHY28_HSDRIVST2(value)          (USBHS_PHY28_HSDRIVST2_Msk & (_UINT32_(value) << USBHS_PHY28_HSDRIVST2_Pos)) /* Assignment of value for HSDRIVST2 in the USBHS_PHY28 register */
...
#define USBHS_PHY28_DISCONDET(value)          (USBHS_PHY28_DISCONDET_Msk & (_UINT32_(value) << USBHS_PHY28_DISCONDET_Pos)) /* Assignment of value for DISCONDET in the USBHS_PHY28 register */
...
#define USBHS_PHY28_HSDRVCOMP(value)          (USBHS_PHY28_HSDRVCOMP_Msk & (_UINT32_(value) << USBHS_PHY28_HSDRVCOMP_Pos)) /* Assignment of value for HSDRVCOMP in the USBHS_PHY28 register */
...
#define USBHS_PHY44_PLLDAMP(value)            (USBHS_PHY44_PLLDAMP_Msk & (_UINT32_(value) << USBHS_PHY44_PLLDAMP_Pos)) /* Assignment of value for PLLDAMP in the USBHS_PHY44 register */
...
#define USBHS_PHY44_DIGDBG(value)             (USBHS_PHY44_DIGDBG_Msk & (_UINT32_(value) << USBHS_PHY44_DIGDBG_Pos)) /* Assignment of value for DIGDBG in the USBHS_PHY44 register */
...
#define USBHS_PHY44_FRCVBUSVAL(value)         (USBHS_PHY44_FRCVBUSVAL_Msk & (_UINT32_(value) << USBHS_PHY44_FRCVBUSVAL_Pos)) /* Assignment of value for FRCVBUSVAL in the USBHS_PHY44 register */
...
#define USBHS_PHY44_RSVD(value)               (USBHS_PHY44_RSVD_Msk & (_UINT32_(value) << USBHS_PHY44_RSVD_Pos)) /* Assignment of value for RSVD in the USBHS_PHY44 register */
...
#define USBHS_PHY44_FRCSESSEND(value)         (USBHS_PHY44_FRCSESSEND_Msk & (_UINT32_(value) << USBHS_PHY44_FRCSESSEND_Pos)) /* Assignment of value for FRCSESSEND in the USBHS_PHY44 register */
...
#define USBHS_PHY48_FRCASESSVAL(value)        (USBHS_PHY48_FRCASESSVAL_Msk & (_UINT32_(value) << USBHS_PHY48_FRCASESSVAL_Pos)) /* Assignment of value for FRCASESSVAL in the USBHS_PHY48 register */
...
#define USBHS_PHY48_FRCBSESSVAL(value)        (USBHS_PHY48_FRCBSESSVAL_Msk & (_UINT32_(value) << USBHS_PHY48_FRCBSESSVAL_Pos)) /* Assignment of value for FRCBSESSVAL in the USBHS_PHY48 register */
...
#define USBHS_PHY48_VBUSCHRGE(value)          (USBHS_PHY48_VBUSCHRGE_Msk & (_UINT32_(value) << USBHS_PHY48_VBUSCHRGE_Pos)) /* Assignment of value for VBUSCHRGE in the USBHS_PHY48 register */
...
#define USBHS_PHY48_SESSENDTUNE(value)        (USBHS_PHY48_SESSENDTUNE_Msk & (_UINT32_(value) << USBHS_PHY48_SESSENDTUNE_Pos)) /* Assignment of value for SESSENDTUNE in the USBHS_PHY48 register */
...
#define USBHS_PHY4C_VBUSVALTUNE(value)        (USBHS_PHY4C_VBUSVALTUNE_Msk & (_UINT32_(value) << USBHS_PHY4C_VBUSVALTUNE_Pos)) /* Assignment of value for VBUSVALTUNE in the USBHS_PHY4C register */
...
#define USBHS_PHY4C_BSESSVALIDTUNE10(value)   (USBHS_PHY4C_BSESSVALIDTUNE10_Msk & (_UINT32_(value) << USBHS_PHY4C_BSESSVALIDTUNE10_Pos)) /* Assignment of value for BSESSVALIDTUNE10 in the USBHS_PHY4C register */
...
#define USBHS_PHY50_BSESSVALIDTUNE2(value)    (USBHS_PHY50_BSESSVALIDTUNE2_Msk & (_UINT32_(value) << USBHS_PHY50_BSESSVALIDTUNE2_Pos)) /* Assignment of value for BSESSVALIDTUNE2 in the USBHS_PHY50 register */
...
#define USBHS_PHY50_ASESSVALIDTUNE(value)     (USBHS_PHY50_ASESSVALIDTUNE_Msk & (_UINT32_(value) << USBHS_PHY50_ASESSVALIDTUNE_Pos)) /* Assignment of value for ASESSVALIDTUNE in the USBHS_PHY50 register */
...
#define USBHS_PHY50_COMPCURREF(value)         (USBHS_PHY50_COMPCURREF_Msk & (_UINT32_(value) << USBHS_PHY50_COMPCURREF_Pos)) /* Assignment of value for COMPCURREF in the USBHS_PHY50 register */
...
/* TXFUNADDR register API structure */
typedef struct
{
...
#endif /* _PIC32CKGC01_USBHS_COMPONENT_H_ */
