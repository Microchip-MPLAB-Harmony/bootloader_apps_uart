...
#ifndef _PIC32CKGC01_SQI_COMPONENT_H_
#define _PIC32CKGC01_SQI_COMPONENT_H_
...
#define SQI_BDCTRL_BD_BUFLEN(value)           (SQI_BDCTRL_BD_BUFLEN_Msk & (_UINT32_(value) << SQI_BDCTRL_BD_BUFLEN_Pos)) /* Assignment of value for BD_BUFLEN in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_CBD_INT_EN(value)          (SQI_BDCTRL_CBD_INT_EN_Msk & (_UINT32_(value) << SQI_BDCTRL_CBD_INT_EN_Pos)) /* Assignment of value for CBD_INT_EN in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_PKT_INT_EN(value)          (SQI_BDCTRL_PKT_INT_EN_Msk & (_UINT32_(value) << SQI_BDCTRL_PKT_INT_EN_Pos)) /* Assignment of value for PKT_INT_EN in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_LIFM(value)                (SQI_BDCTRL_LIFM_Msk & (_UINT32_(value) << SQI_BDCTRL_LIFM_Pos)) /* Assignment of value for LIFM in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_LAST_BD(value)             (SQI_BDCTRL_LAST_BD_Msk & (_UINT32_(value) << SQI_BDCTRL_LAST_BD_Pos)) /* Assignment of value for LAST_BD in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_DIR(value)                 (SQI_BDCTRL_DIR_Msk & (_UINT32_(value) << SQI_BDCTRL_DIR_Pos)) /* Assignment of value for DIR in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_SDR_DDR(value)             (SQI_BDCTRL_SDR_DDR_Msk & (_UINT32_(value) << SQI_BDCTRL_SDR_DDR_Pos)) /* Assignment of value for SDR_DDR in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_MODE(value)                (SQI_BDCTRL_MODE_Msk & (_UINT32_(value) << SQI_BDCTRL_MODE_Pos)) /* Assignment of value for MODE in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_SPI_DEV_SEL2(value)        (SQI_BDCTRL_SPI_DEV_SEL2_Msk & (_UINT32_(value) << SQI_BDCTRL_SPI_DEV_SEL2_Pos)) /* Assignment of value for SPI_DEV_SEL2 in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_LSBF(value)                (SQI_BDCTRL_LSBF_Msk & (_UINT32_(value) << SQI_BDCTRL_LSBF_Pos)) /* Assignment of value for LSBF in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_STAT_CHECK(value)          (SQI_BDCTRL_STAT_CHECK_Msk & (_UINT32_(value) << SQI_BDCTRL_STAT_CHECK_Pos)) /* Assignment of value for STAT_CHECK in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_SPI_DEV_SEL10(value)       (SQI_BDCTRL_SPI_DEV_SEL10_Msk & (_UINT32_(value) << SQI_BDCTRL_SPI_DEV_SEL10_Pos)) /* Assignment of value for SPI_DEV_SEL10 in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_CS_ASSERT(value)           (SQI_BDCTRL_CS_ASSERT_Msk & (_UINT32_(value) << SQI_BDCTRL_CS_ASSERT_Pos)) /* Assignment of value for CS_ASSERT in the SQI_BDCTRL register */
...
#define SQI_BDCTRL_DESC_EN(value)             (SQI_BDCTRL_DESC_EN_Msk & (_UINT32_(value) << SQI_BDCTRL_DESC_EN_Pos)) /* Assignment of value for DESC_EN in the SQI_BDCTRL register */
...
#define SQI_CTRLA_SWRST(value)                (SQI_CTRLA_SWRST_Msk & (_UINT32_(value) << SQI_CTRLA_SWRST_Pos)) /* Assignment of value for SWRST in the SQI_CTRLA register */
...
#define SQI_CTRLA_RUNSTDBY(value)             (SQI_CTRLA_RUNSTDBY_Msk & (_UINT32_(value) << SQI_CTRLA_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the SQI_CTRLA register */
...
#define SQI_INTENCLR_SQI(value)               (SQI_INTENCLR_SQI_Msk & (_UINT32_(value) << SQI_INTENCLR_SQI_Pos)) /* Assignment of value for SQI in the SQI_INTENCLR register */
...
#define SQI_INTENSET_SQI(value)               (SQI_INTENSET_SQI_Msk & (_UINT32_(value) << SQI_INTENSET_SQI_Pos)) /* Assignment of value for SQI in the SQI_INTENSET register */
...
#define SQI_INTFLAG_SQI(value)                (SQI_INTFLAG_SQI_Msk & (_UINT32_(value) << SQI_INTFLAG_SQI_Pos)) /* Assignment of value for SQI in the SQI_INTFLAG register */
...
#define SQI_SYNCBUSY_SWRST(value)             (SQI_SYNCBUSY_SWRST_Msk & (_UINT32_(value) << SQI_SYNCBUSY_SWRST_Pos)) /* Assignment of value for SWRST in the SQI_SYNCBUSY register */
...
#define SQI_XCON1_TYPECMD(value)              (SQI_XCON1_TYPECMD_Msk & (_UINT32_(value) << SQI_XCON1_TYPECMD_Pos)) /* Assignment of value for TYPECMD in the SQI_XCON1 register */
...
#define SQI_XCON1_TYPEADDR(value)             (SQI_XCON1_TYPEADDR_Msk & (_UINT32_(value) << SQI_XCON1_TYPEADDR_Pos)) /* Assignment of value for TYPEADDR in the SQI_XCON1 register */
...
#define SQI_XCON1_TYPEMODE(value)             (SQI_XCON1_TYPEMODE_Msk & (_UINT32_(value) << SQI_XCON1_TYPEMODE_Pos)) /* Assignment of value for TYPEMODE in the SQI_XCON1 register */
...
#define SQI_XCON1_TYPEDUMMY(value)            (SQI_XCON1_TYPEDUMMY_Msk & (_UINT32_(value) << SQI_XCON1_TYPEDUMMY_Pos)) /* Assignment of value for TYPEDUMMY in the SQI_XCON1 register */
...
#define SQI_XCON1_TYPEDATA(value)             (SQI_XCON1_TYPEDATA_Msk & (_UINT32_(value) << SQI_XCON1_TYPEDATA_Pos)) /* Assignment of value for TYPEDATA in the SQI_XCON1 register */
...
#define SQI_XCON1_READOPCODE(value)           (SQI_XCON1_READOPCODE_Msk & (_UINT32_(value) << SQI_XCON1_READOPCODE_Pos)) /* Assignment of value for READOPCODE in the SQI_XCON1 register */
...
#define SQI_XCON1_ADDRBYTES(value)            (SQI_XCON1_ADDRBYTES_Msk & (_UINT32_(value) << SQI_XCON1_ADDRBYTES_Pos)) /* Assignment of value for ADDRBYTES in the SQI_XCON1 register */
...
#define SQI_XCON1_DUMMYBYTES(value)           (SQI_XCON1_DUMMYBYTES_Msk & (_UINT32_(value) << SQI_XCON1_DUMMYBYTES_Pos)) /* Assignment of value for DUMMYBYTES in the SQI_XCON1 register */
...
#define SQI_XCON1_DDRCMD(value)               (SQI_XCON1_DDRCMD_Msk & (_UINT32_(value) << SQI_XCON1_DDRCMD_Pos)) /* Assignment of value for DDRCMD in the SQI_XCON1 register */
...
#define SQI_XCON1_DDRADDR(value)              (SQI_XCON1_DDRADDR_Msk & (_UINT32_(value) << SQI_XCON1_DDRADDR_Pos)) /* Assignment of value for DDRADDR in the SQI_XCON1 register */
...
#define SQI_XCON1_DDRMODE(value)              (SQI_XCON1_DDRMODE_Msk & (_UINT32_(value) << SQI_XCON1_DDRMODE_Pos)) /* Assignment of value for DDRMODE in the SQI_XCON1 register */
...
#define SQI_XCON1_DDRDUMMY(value)             (SQI_XCON1_DDRDUMMY_Msk & (_UINT32_(value) << SQI_XCON1_DDRDUMMY_Pos)) /* Assignment of value for DDRDUMMY in the SQI_XCON1 register */
...
#define SQI_XCON1_DDRDATA(value)              (SQI_XCON1_DDRDATA_Msk & (_UINT32_(value) << SQI_XCON1_DDRDATA_Pos)) /* Assignment of value for DDRDATA in the SQI_XCON1 register */
...
#define SQI_XCON1_SDRCMD(value)               (SQI_XCON1_SDRCMD_Msk & (_UINT32_(value) << SQI_XCON1_SDRCMD_Pos)) /* Assignment of value for SDRCMD in the SQI_XCON1 register */
...
#define SQI_XCON2_MODECODE(value)             (SQI_XCON2_MODECODE_Msk & (_UINT32_(value) << SQI_XCON2_MODECODE_Pos)) /* Assignment of value for MODECODE in the SQI_XCON2 register */
...
#define SQI_XCON2_MODEBYTES(value)            (SQI_XCON2_MODEBYTES_Msk & (_UINT32_(value) << SQI_XCON2_MODEBYTES_Pos)) /* Assignment of value for MODEBYTES in the SQI_XCON2 register */
...
#define SQI_XCON2_DEVSEL(value)               (SQI_XCON2_DEVSEL_Msk & (_UINT32_(value) << SQI_XCON2_DEVSEL_Pos)) /* Assignment of value for DEVSEL in the SQI_XCON2 register */
...
#define SQI_CFG_MODE(value)                   (SQI_CFG_MODE_Msk & (_UINT32_(value) << SQI_CFG_MODE_Pos)) /* Assignment of value for MODE in the SQI_CFG register */
...
#define SQI_CFG_CPHA(value)                   (SQI_CFG_CPHA_Msk & (_UINT32_(value) << SQI_CFG_CPHA_Pos)) /* Assignment of value for CPHA in the SQI_CFG register */
...
#define SQI_CFG_CPOL(value)                   (SQI_CFG_CPOL_Msk & (_UINT32_(value) << SQI_CFG_CPOL_Pos)) /* Assignment of value for CPOL in the SQI_CFG register */
...
#define SQI_CFG_LSBF(value)                   (SQI_CFG_LSBF_Msk & (_UINT32_(value) << SQI_CFG_LSBF_Pos)) /* Assignment of value for LSBF in the SQI_CFG register */
...
#define SQI_CFG_WP(value)                     (SQI_CFG_WP_Msk & (_UINT32_(value) << SQI_CFG_WP_Pos)) /* Assignment of value for WP in the SQI_CFG register */
...
#define SQI_CFG_HOLD(value)                   (SQI_CFG_HOLD_Msk & (_UINT32_(value) << SQI_CFG_HOLD_Pos)) /* Assignment of value for HOLD in the SQI_CFG register */
...
#define SQI_CFG_BURSTEN(value)                (SQI_CFG_BURSTEN_Msk & (_UINT32_(value) << SQI_CFG_BURSTEN_Pos)) /* Assignment of value for BURSTEN in the SQI_CFG register */
...
#define SQI_CFG_AHB_BURST_INCR4_EN(value)     (SQI_CFG_AHB_BURST_INCR4_EN_Msk & (_UINT32_(value) << SQI_CFG_AHB_BURST_INCR4_EN_Pos)) /* Assignment of value for AHB_BURST_INCR4_EN in the SQI_CFG register */
...
#define SQI_CFG_AHB_BURST_INCR8_EN(value)     (SQI_CFG_AHB_BURST_INCR8_EN_Msk & (_UINT32_(value) << SQI_CFG_AHB_BURST_INCR8_EN_Pos)) /* Assignment of value for AHB_BURST_INCR8_EN in the SQI_CFG register */
...
#define SQI_CFG_AHB_BURST_INCR16_EN(value)    (SQI_CFG_AHB_BURST_INCR16_EN_Msk & (_UINT32_(value) << SQI_CFG_AHB_BURST_INCR16_EN_Pos)) /* Assignment of value for AHB_BURST_INCR16_EN in the SQI_CFG register */
...
#define SQI_CFG_TXBUFRST(value)               (SQI_CFG_TXBUFRST_Msk & (_UINT32_(value) << SQI_CFG_TXBUFRST_Pos)) /* Assignment of value for TXBUFRST in the SQI_CFG register */
...
#define SQI_CFG_RXBUFRST(value)               (SQI_CFG_RXBUFRST_Msk & (_UINT32_(value) << SQI_CFG_RXBUFRST_Pos)) /* Assignment of value for RXBUFRST in the SQI_CFG register */
...
#define SQI_CFG_CONBUFRST(value)              (SQI_CFG_CONBUFRST_Msk & (_UINT32_(value) << SQI_CFG_CONBUFRST_Pos)) /* Assignment of value for CONBUFRST in the SQI_CFG register */
...
#define SQI_CFG_DATAEN(value)                 (SQI_CFG_DATAEN_Msk & (_UINT32_(value) << SQI_CFG_DATAEN_Pos)) /* Assignment of value for DATAEN in the SQI_CFG register */
...
#define SQI_CFG_SQIEN(value)                  (SQI_CFG_SQIEN_Msk & (_UINT32_(value) << SQI_CFG_SQIEN_Pos)) /* Assignment of value for SQIEN in the SQI_CFG register */
...
#define SQI_CFG_CSEN(value)                   (SQI_CFG_CSEN_Msk & (_UINT32_(value) << SQI_CFG_CSEN_Pos)) /* Assignment of value for CSEN in the SQI_CFG register */
...
#define SQI_CON_TXRXCOUNT(value)              (SQI_CON_TXRXCOUNT_Msk & (_UINT32_(value) << SQI_CON_TXRXCOUNT_Pos)) /* Assignment of value for TXRXCOUNT in the SQI_CON register */
...
#define SQI_CON_CMDINIT(value)                (SQI_CON_CMDINIT_Msk & (_UINT32_(value) << SQI_CON_CMDINIT_Pos)) /* Assignment of value for CMDINIT in the SQI_CON register */
...
#define SQI_CON_LANEMODE(value)               (SQI_CON_LANEMODE_Msk & (_UINT32_(value) << SQI_CON_LANEMODE_Pos)) /* Assignment of value for LANEMODE in the SQI_CON register */
...
#define SQI_CON_DEVSEL(value)                 (SQI_CON_DEVSEL_Msk & (_UINT32_(value) << SQI_CON_DEVSEL_Pos)) /* Assignment of value for DEVSEL in the SQI_CON register */
...
#define SQI_CON_DASSERT(value)                (SQI_CON_DASSERT_Msk & (_UINT32_(value) << SQI_CON_DASSERT_Pos)) /* Assignment of value for DASSERT in the SQI_CON register */
...
#define SQI_CON_DDRMODE(value)                (SQI_CON_DDRMODE_Msk & (_UINT32_(value) << SQI_CON_DDRMODE_Pos)) /* Assignment of value for DDRMODE in the SQI_CON register */
...
#define SQI_CON_SCHECK(value)                 (SQI_CON_SCHECK_Msk & (_UINT32_(value) << SQI_CON_SCHECK_Pos)) /* Assignment of value for SCHECK in the SQI_CON register */
...
#define SQI_CON_DEV_SEL_2(value)              (SQI_CON_DEV_SEL_2_Msk & (_UINT32_(value) << SQI_CON_DEV_SEL_2_Pos)) /* Assignment of value for DEV_SEL_2 in the SQI_CON register */
...
#define SQI_CLKCON_EN(value)                  (SQI_CLKCON_EN_Msk & (_UINT32_(value) << SQI_CLKCON_EN_Pos)) /* Assignment of value for EN in the SQI_CLKCON register */
...
#define SQI_CLKCON_STABLE(value)              (SQI_CLKCON_STABLE_Msk & (_UINT32_(value) << SQI_CLKCON_STABLE_Pos)) /* Assignment of value for STABLE in the SQI_CLKCON register */
...
#define SQI_CLKCON_CLKDIV(value)              (SQI_CLKCON_CLKDIV_Msk & (_UINT32_(value) << SQI_CLKCON_CLKDIV_Pos)) /* Assignment of value for CLKDIV in the SQI_CLKCON register */
...
#define SQI_CMDTHR_RXCMDTHR(value)            (SQI_CMDTHR_RXCMDTHR_Msk & (_UINT32_(value) << SQI_CMDTHR_RXCMDTHR_Pos)) /* Assignment of value for RXCMDTHR in the SQI_CMDTHR register */
...
#define SQI_CMDTHR_TXCMDTHR(value)            (SQI_CMDTHR_TXCMDTHR_Msk & (_UINT32_(value) << SQI_CMDTHR_TXCMDTHR_Pos)) /* Assignment of value for TXCMDTHR in the SQI_CMDTHR register */
...
#define SQI_INTTHR_RXINTTHR(value)            (SQI_INTTHR_RXINTTHR_Msk & (_UINT32_(value) << SQI_INTTHR_RXINTTHR_Pos)) /* Assignment of value for RXINTTHR in the SQI_INTTHR register */
...
#define SQI_INTTHR_TXINTTHR(value)            (SQI_INTTHR_TXINTTHR_Msk & (_UINT32_(value) << SQI_INTTHR_TXINTTHR_Pos)) /* Assignment of value for TXINTTHR in the SQI_INTTHR register */
...
#define SQI_INTEN_TXEMPTYIE(value)            (SQI_INTEN_TXEMPTYIE_Msk & (_UINT32_(value) << SQI_INTEN_TXEMPTYIE_Pos)) /* Assignment of value for TXEMPTYIE in the SQI_INTEN register */
...
#define SQI_INTEN_TXFULLIE(value)             (SQI_INTEN_TXFULLIE_Msk & (_UINT32_(value) << SQI_INTEN_TXFULLIE_Pos)) /* Assignment of value for TXFULLIE in the SQI_INTEN register */
...
#define SQI_INTEN_TXTHRIE(value)              (SQI_INTEN_TXTHRIE_Msk & (_UINT32_(value) << SQI_INTEN_TXTHRIE_Pos)) /* Assignment of value for TXTHRIE in the SQI_INTEN register */
...
#define SQI_INTEN_RXEMPTYIE(value)            (SQI_INTEN_RXEMPTYIE_Msk & (_UINT32_(value) << SQI_INTEN_RXEMPTYIE_Pos)) /* Assignment of value for RXEMPTYIE in the SQI_INTEN register */
...
#define SQI_INTEN_RXFULLIE(value)             (SQI_INTEN_RXFULLIE_Msk & (_UINT32_(value) << SQI_INTEN_RXFULLIE_Pos)) /* Assignment of value for RXFULLIE in the SQI_INTEN register */
...
#define SQI_INTEN_RXTHRIE(value)              (SQI_INTEN_RXTHRIE_Msk & (_UINT32_(value) << SQI_INTEN_RXTHRIE_Pos)) /* Assignment of value for RXTHRIE in the SQI_INTEN register */
...
#define SQI_INTEN_CONFULLIE(value)            (SQI_INTEN_CONFULLIE_Msk & (_UINT32_(value) << SQI_INTEN_CONFULLIE_Pos)) /* Assignment of value for CONFULLIE in the SQI_INTEN register */
...
#define SQI_INTEN_CONEMPTYIE(value)           (SQI_INTEN_CONEMPTYIE_Msk & (_UINT32_(value) << SQI_INTEN_CONEMPTYIE_Pos)) /* Assignment of value for CONEMPTYIE in the SQI_INTEN register */
...
#define SQI_INTEN_CONTHRIE(value)             (SQI_INTEN_CONTHRIE_Msk & (_UINT32_(value) << SQI_INTEN_CONTHRIE_Pos)) /* Assignment of value for CONTHRIE in the SQI_INTEN register */
...
#define SQI_INTEN_BDDONEIE(value)             (SQI_INTEN_BDDONEIE_Msk & (_UINT32_(value) << SQI_INTEN_BDDONEIE_Pos)) /* Assignment of value for BDDONEIE in the SQI_INTEN register */
...
#define SQI_INTEN_PKTCOMPIE(value)            (SQI_INTEN_PKTCOMPIE_Msk & (_UINT32_(value) << SQI_INTEN_PKTCOMPIE_Pos)) /* Assignment of value for PKTCOMPIE in the SQI_INTEN register */
...
#define SQI_INTEN_DMAEIE(value)               (SQI_INTEN_DMAEIE_Msk & (_UINT32_(value) << SQI_INTEN_DMAEIE_Pos)) /* Assignment of value for DMAEIE in the SQI_INTEN register */
...
#define SQI_INTSTAT_TXEMPTYIF(value)          (SQI_INTSTAT_TXEMPTYIF_Msk & (_UINT32_(value) << SQI_INTSTAT_TXEMPTYIF_Pos)) /* Assignment of value for TXEMPTYIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_TXFULLIF(value)           (SQI_INTSTAT_TXFULLIF_Msk & (_UINT32_(value) << SQI_INTSTAT_TXFULLIF_Pos)) /* Assignment of value for TXFULLIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_TXTHRIF(value)            (SQI_INTSTAT_TXTHRIF_Msk & (_UINT32_(value) << SQI_INTSTAT_TXTHRIF_Pos)) /* Assignment of value for TXTHRIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_RXEMPTYIF(value)          (SQI_INTSTAT_RXEMPTYIF_Msk & (_UINT32_(value) << SQI_INTSTAT_RXEMPTYIF_Pos)) /* Assignment of value for RXEMPTYIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_RXFULLIF(value)           (SQI_INTSTAT_RXFULLIF_Msk & (_UINT32_(value) << SQI_INTSTAT_RXFULLIF_Pos)) /* Assignment of value for RXFULLIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_RXTHRIF(value)            (SQI_INTSTAT_RXTHRIF_Msk & (_UINT32_(value) << SQI_INTSTAT_RXTHRIF_Pos)) /* Assignment of value for RXTHRIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_CONFULLIF(value)          (SQI_INTSTAT_CONFULLIF_Msk & (_UINT32_(value) << SQI_INTSTAT_CONFULLIF_Pos)) /* Assignment of value for CONFULLIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_CONEMPTYIF(value)         (SQI_INTSTAT_CONEMPTYIF_Msk & (_UINT32_(value) << SQI_INTSTAT_CONEMPTYIF_Pos)) /* Assignment of value for CONEMPTYIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_CONTHRIF(value)           (SQI_INTSTAT_CONTHRIF_Msk & (_UINT32_(value) << SQI_INTSTAT_CONTHRIF_Pos)) /* Assignment of value for CONTHRIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_BDDONEIF(value)           (SQI_INTSTAT_BDDONEIF_Msk & (_UINT32_(value) << SQI_INTSTAT_BDDONEIF_Pos)) /* Assignment of value for BDDONEIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_PKTCOMPIF(value)          (SQI_INTSTAT_PKTCOMPIF_Msk & (_UINT32_(value) << SQI_INTSTAT_PKTCOMPIF_Pos)) /* Assignment of value for PKTCOMPIF in the SQI_INTSTAT register */
...
#define SQI_INTSTAT_DMAEIF(value)             (SQI_INTSTAT_DMAEIF_Msk & (_UINT32_(value) << SQI_INTSTAT_DMAEIF_Pos)) /* Assignment of value for DMAEIF in the SQI_INTSTAT register */
...
#define SQI_TXDATA_TXDATA(value)              (SQI_TXDATA_TXDATA_Msk & (_UINT32_(value) << SQI_TXDATA_TXDATA_Pos)) /* Assignment of value for TXDATA in the SQI_TXDATA register */
...
#define SQI_RXDATA_RXDATA(value)              (SQI_RXDATA_RXDATA_Msk & (_UINT32_(value) << SQI_RXDATA_RXDATA_Pos)) /* Assignment of value for RXDATA in the SQI_RXDATA register */
...
#define SQI_STAT1_RXBUFCNT(value)             (SQI_STAT1_RXBUFCNT_Msk & (_UINT32_(value) << SQI_STAT1_RXBUFCNT_Pos)) /* Assignment of value for RXBUFCNT in the SQI_STAT1 register */
...
#define SQI_STAT1_TXBUFFREE(value)            (SQI_STAT1_TXBUFFREE_Msk & (_UINT32_(value) << SQI_STAT1_TXBUFFREE_Pos)) /* Assignment of value for TXBUFFREE in the SQI_STAT1 register */
...
#define SQI_STAT2_TXOV(value)                 (SQI_STAT2_TXOV_Msk & (_UINT32_(value) << SQI_STAT2_TXOV_Pos)) /* Assignment of value for TXOV in the SQI_STAT2 register */
...
#define SQI_STAT2_RXUN(value)                 (SQI_STAT2_RXUN_Msk & (_UINT32_(value) << SQI_STAT2_RXUN_Pos)) /* Assignment of value for RXUN in the SQI_STAT2 register */
...
#define SQI_STAT2_SQID0(value)                (SQI_STAT2_SQID0_Msk & (_UINT32_(value) << SQI_STAT2_SQID0_Pos)) /* Assignment of value for SQID0 in the SQI_STAT2 register */
...
#define SQI_STAT2_SQID1(value)                (SQI_STAT2_SQID1_Msk & (_UINT32_(value) << SQI_STAT2_SQID1_Pos)) /* Assignment of value for SQID1 in the SQI_STAT2 register */
...
#define SQI_STAT2_SQID2(value)                (SQI_STAT2_SQID2_Msk & (_UINT32_(value) << SQI_STAT2_SQID2_Pos)) /* Assignment of value for SQID2 in the SQI_STAT2 register */
...
#define SQI_STAT2_SQID3(value)                (SQI_STAT2_SQID3_Msk & (_UINT32_(value) << SQI_STAT2_SQID3_Pos)) /* Assignment of value for SQID3 in the SQI_STAT2 register */
...
#define SQI_STAT2_CONAVAIL(value)             (SQI_STAT2_CONAVAIL_Msk & (_UINT32_(value) << SQI_STAT2_CONAVAIL_Pos)) /* Assignment of value for CONAVAIL in the SQI_STAT2 register */
...
#define SQI_STAT2_CMDSTAT(value)              (SQI_STAT2_CMDSTAT_Msk & (_UINT32_(value) << SQI_STAT2_CMDSTAT_Pos)) /* Assignment of value for CMDSTAT in the SQI_STAT2 register */
...
#define SQI_BDCON_DMAEN(value)                (SQI_BDCON_DMAEN_Msk & (_UINT32_(value) << SQI_BDCON_DMAEN_Pos)) /* Assignment of value for DMAEN in the SQI_BDCON register */
...
#define SQI_BDCON_POLLEN(value)               (SQI_BDCON_POLLEN_Msk & (_UINT32_(value) << SQI_BDCON_POLLEN_Pos)) /* Assignment of value for POLLEN in the SQI_BDCON register */
...
#define SQI_BDCON_START(value)                (SQI_BDCON_START_Msk & (_UINT32_(value) << SQI_BDCON_START_Pos)) /* Assignment of value for START in the SQI_BDCON register */
...
#define SQI_BDCURADD_BDCURRADDR(value)        (SQI_BDCURADD_BDCURRADDR_Msk & (_UINT32_(value) << SQI_BDCURADD_BDCURRADDR_Pos)) /* Assignment of value for BDCURRADDR in the SQI_BDCURADD register */
...
#define SQI_BDBASEADD_BDADDR(value)           (SQI_BDBASEADD_BDADDR_Msk & (_UINT32_(value) << SQI_BDBASEADD_BDADDR_Pos)) /* Assignment of value for BDADDR in the SQI_BDBASEADD register */
...
#define SQI_BDSTAT_BDCON(value)               (SQI_BDSTAT_BDCON_Msk & (_UINT32_(value) << SQI_BDSTAT_BDCON_Pos)) /* Assignment of value for BDCON in the SQI_BDSTAT register */
...
#define SQI_BDSTAT_DMAACTV(value)             (SQI_BDSTAT_DMAACTV_Msk & (_UINT32_(value) << SQI_BDSTAT_DMAACTV_Pos)) /* Assignment of value for DMAACTV in the SQI_BDSTAT register */
...
#define SQI_BDSTAT_DMASTART(value)            (SQI_BDSTAT_DMASTART_Msk & (_UINT32_(value) << SQI_BDSTAT_DMASTART_Pos)) /* Assignment of value for DMASTART in the SQI_BDSTAT register */
...
#define SQI_BDSTAT_BDSTATE(value)             (SQI_BDSTAT_BDSTATE_Msk & (_UINT32_(value) << SQI_BDSTAT_BDSTATE_Pos)) /* Assignment of value for BDSTATE in the SQI_BDSTAT register */
...
#define SQI_BDPOLLCON_POLLCON(value)          (SQI_BDPOLLCON_POLLCON_Msk & (_UINT32_(value) << SQI_BDPOLLCON_POLLCON_Pos)) /* Assignment of value for POLLCON in the SQI_BDPOLLCON register */
...
#define SQI_BDTXDSTAT_TXCURBUFLEN(value)      (SQI_BDTXDSTAT_TXCURBUFLEN_Msk & (_UINT32_(value) << SQI_BDTXDSTAT_TXCURBUFLEN_Pos)) /* Assignment of value for TXCURBUFLEN in the SQI_BDTXDSTAT register */
...
#define SQI_BDTXDSTAT_TXBUFCNT(value)         (SQI_BDTXDSTAT_TXBUFCNT_Msk & (_UINT32_(value) << SQI_BDTXDSTAT_TXBUFCNT_Pos)) /* Assignment of value for TXBUFCNT in the SQI_BDTXDSTAT register */
...
#define SQI_BDRXDSTAT_RXCURBUFLEN(value)      (SQI_BDRXDSTAT_RXCURBUFLEN_Msk & (_UINT32_(value) << SQI_BDRXDSTAT_RXCURBUFLEN_Pos)) /* Assignment of value for RXCURBUFLEN in the SQI_BDRXDSTAT register */
...
#define SQI_BDRXDSTAT_RXBUFCNT(value)         (SQI_BDRXDSTAT_RXBUFCNT_Msk & (_UINT32_(value) << SQI_BDRXDSTAT_RXBUFCNT_Pos)) /* Assignment of value for RXBUFCNT in the SQI_BDRXDSTAT register */
...
#define SQI_THR_THRES(value)                  (SQI_THR_THRES_Msk & (_UINT32_(value) << SQI_THR_THRES_Pos)) /* Assignment of value for THRES in the SQI_THR register */
...
#define SQI_INTSIGEN_TXEMPTYISE(value)        (SQI_INTSIGEN_TXEMPTYISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_TXEMPTYISE_Pos)) /* Assignment of value for TXEMPTYISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_TXFULLISE(value)         (SQI_INTSIGEN_TXFULLISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_TXFULLISE_Pos)) /* Assignment of value for TXFULLISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_TXTHRISE(value)          (SQI_INTSIGEN_TXTHRISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_TXTHRISE_Pos)) /* Assignment of value for TXTHRISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_RXEMPTYISE(value)        (SQI_INTSIGEN_RXEMPTYISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_RXEMPTYISE_Pos)) /* Assignment of value for RXEMPTYISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_RXFULLISE(value)         (SQI_INTSIGEN_RXFULLISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_RXFULLISE_Pos)) /* Assignment of value for RXFULLISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_RXTHRISE(value)          (SQI_INTSIGEN_RXTHRISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_RXTHRISE_Pos)) /* Assignment of value for RXTHRISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_CONFULLISE(value)        (SQI_INTSIGEN_CONFULLISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_CONFULLISE_Pos)) /* Assignment of value for CONFULLISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_CONEMPTYISE(value)       (SQI_INTSIGEN_CONEMPTYISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_CONEMPTYISE_Pos)) /* Assignment of value for CONEMPTYISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_CONTHRISE(value)         (SQI_INTSIGEN_CONTHRISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_CONTHRISE_Pos)) /* Assignment of value for CONTHRISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_BDDONEISE(value)         (SQI_INTSIGEN_BDDONEISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_BDDONEISE_Pos)) /* Assignment of value for BDDONEISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_PKTCOMPISE(value)        (SQI_INTSIGEN_PKTCOMPISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_PKTCOMPISE_Pos)) /* Assignment of value for PKTCOMPISE in the SQI_INTSIGEN register */
...
#define SQI_INTSIGEN_DMAEISE(value)           (SQI_INTSIGEN_DMAEISE_Msk & (_UINT32_(value) << SQI_INTSIGEN_DMAEISE_Pos)) /* Assignment of value for DMAEISE in the SQI_INTSIGEN register */
...
#define SQI_TAPCON_CLKOUTDLY(value)           (SQI_TAPCON_CLKOUTDLY_Msk & (_UINT32_(value) << SQI_TAPCON_CLKOUTDLY_Pos)) /* Assignment of value for CLKOUTDLY in the SQI_TAPCON register */
...
#define SQI_TAPCON_DATAOUTDLY(value)          (SQI_TAPCON_DATAOUTDLY_Msk & (_UINT32_(value) << SQI_TAPCON_DATAOUTDLY_Pos)) /* Assignment of value for DATAOUTDLY in the SQI_TAPCON register */
...
#define SQI_TAPCON_SDRCLKINDLY(value)         (SQI_TAPCON_SDRCLKINDLY_Msk & (_UINT32_(value) << SQI_TAPCON_SDRCLKINDLY_Pos)) /* Assignment of value for SDRCLKINDLY in the SQI_TAPCON register */
...
#define SQI_TAPCON_DDRDATINDLY(value)         (SQI_TAPCON_DDRDATINDLY_Msk & (_UINT32_(value) << SQI_TAPCON_DDRDATINDLY_Pos)) /* Assignment of value for DDRDATINDLY in the SQI_TAPCON register */
...
#define SQI_TAPCON_SDRDATINDLY(value)         (SQI_TAPCON_SDRDATINDLY_Msk & (_UINT32_(value) << SQI_TAPCON_SDRDATINDLY_Pos)) /* Assignment of value for SDRDATINDLY in the SQI_TAPCON register */
...
#define SQI_TAPCON_DDRCLKINDLY(value)         (SQI_TAPCON_DDRCLKINDLY_Msk & (_UINT32_(value) << SQI_TAPCON_DDRCLKINDLY_Pos)) /* Assignment of value for DDRCLKINDLY in the SQI_TAPCON register */
...
#define SQI_MEMSTAT_STATCMD(value)            (SQI_MEMSTAT_STATCMD_Msk & (_UINT32_(value) << SQI_MEMSTAT_STATCMD_Pos)) /* Assignment of value for STATCMD in the SQI_MEMSTAT register */
...
#define SQI_MEMSTAT_STATBYTES(value)          (SQI_MEMSTAT_STATBYTES_Msk & (_UINT32_(value) << SQI_MEMSTAT_STATBYTES_Pos)) /* Assignment of value for STATBYTES in the SQI_MEMSTAT register */
...
#define SQI_MEMSTAT_TYPESTAT(value)           (SQI_MEMSTAT_TYPESTAT_Msk & (_UINT32_(value) << SQI_MEMSTAT_TYPESTAT_Pos)) /* Assignment of value for TYPESTAT in the SQI_MEMSTAT register */
...
#define SQI_MEMSTAT_STATPOS(value)            (SQI_MEMSTAT_STATPOS_Msk & (_UINT32_(value) << SQI_MEMSTAT_STATPOS_Pos)) /* Assignment of value for STATPOS in the SQI_MEMSTAT register */
...
#define SQI_XCON3_INIT1CMD1(value)            (SQI_XCON3_INIT1CMD1_Msk & (_UINT32_(value) << SQI_XCON3_INIT1CMD1_Pos)) /* Assignment of value for INIT1CMD1 in the SQI_XCON3 register */
...
#define SQI_XCON3_INIT1CMD2(value)            (SQI_XCON3_INIT1CMD2_Msk & (_UINT32_(value) << SQI_XCON3_INIT1CMD2_Pos)) /* Assignment of value for INIT1CMD2 in the SQI_XCON3 register */
...
#define SQI_XCON3_INIT1CMD3(value)            (SQI_XCON3_INIT1CMD3_Msk & (_UINT32_(value) << SQI_XCON3_INIT1CMD3_Pos)) /* Assignment of value for INIT1CMD3 in the SQI_XCON3 register */
...
#define SQI_XCON3_INIT1TYPE(value)            (SQI_XCON3_INIT1TYPE_Msk & (_UINT32_(value) << SQI_XCON3_INIT1TYPE_Pos)) /* Assignment of value for INIT1TYPE in the SQI_XCON3 register */
...
#define SQI_XCON3_INIT1COUNT(value)           (SQI_XCON3_INIT1COUNT_Msk & (_UINT32_(value) << SQI_XCON3_INIT1COUNT_Pos)) /* Assignment of value for INIT1COUNT in the SQI_XCON3 register */
...
#define SQI_XCON3_INIT1SCHECK(value)          (SQI_XCON3_INIT1SCHECK_Msk & (_UINT32_(value) << SQI_XCON3_INIT1SCHECK_Pos)) /* Assignment of value for INIT1SCHECK in the SQI_XCON3 register */
...
#define SQI_XCON4_INIT2CMD1(value)            (SQI_XCON4_INIT2CMD1_Msk & (_UINT32_(value) << SQI_XCON4_INIT2CMD1_Pos)) /* Assignment of value for INIT2CMD1 in the SQI_XCON4 register */
...
#define SQI_XCON4_INIT2CMD2(value)            (SQI_XCON4_INIT2CMD2_Msk & (_UINT32_(value) << SQI_XCON4_INIT2CMD2_Pos)) /* Assignment of value for INIT2CMD2 in the SQI_XCON4 register */
...
#define SQI_XCON4_INIT2CMD3(value)            (SQI_XCON4_INIT2CMD3_Msk & (_UINT32_(value) << SQI_XCON4_INIT2CMD3_Pos)) /* Assignment of value for INIT2CMD3 in the SQI_XCON4 register */
...
#define SQI_XCON4_INIT2TYPE(value)            (SQI_XCON4_INIT2TYPE_Msk & (_UINT32_(value) << SQI_XCON4_INIT2TYPE_Pos)) /* Assignment of value for INIT2TYPE in the SQI_XCON4 register */
...
#define SQI_XCON4_INIT2COUNT(value)           (SQI_XCON4_INIT2COUNT_Msk & (_UINT32_(value) << SQI_XCON4_INIT2COUNT_Pos)) /* Assignment of value for INIT2COUNT in the SQI_XCON4 register */
...
#define SQI_XCON4_INIT2SCHECK(value)          (SQI_XCON4_INIT2SCHECK_Msk & (_UINT32_(value) << SQI_XCON4_INIT2SCHECK_Pos)) /* Assignment of value for INIT2SCHECK in the SQI_XCON4 register */
#define SQI_XCON4_Msk                         _UINT32_(0x1FFFFFFF)                                 /* (SQI_XCON4) Register Mask  */


/* SQI register offsets definitions */
...
/* SQI_DESCRIPTOR register API structure */
typedef struct
...
/* SQI_DESCRIPTOR memory section attribute */
#if defined (__GNUC__) || defined (__CC_ARM)
 #define SECTION_SQI_DESCRIPTOR       __attribute__ ((section(".hsram")))
#elif defined (__ICCARM__)
 #define SECTION_SQI_DESCRIPTOR       @".hsram"
#else
 #ifndef SECTION_SQI_DESCRIPTOR
  #error SECTION_SQI_DESCRIPTOR must be defined for compiler to use memory section .hsram
 #endif
#endif

#endif /* _PIC32CKGC01_SQI_COMPONENT_H_ */
