...
#define RSTC_BKUPEXIT_VBAT0_Pos               _UINT8_(0)                                           /* (RSTC_BKUPEXIT) VBAT failure in backup mode Position */
#define RSTC_BKUPEXIT_VBAT0_Msk               (_UINT8_(0x1) << RSTC_BKUPEXIT_VBAT0_Pos)            /* (RSTC_BKUPEXIT) VBAT failure in backup mode Mask */
#define RSTC_BKUPEXIT_VBAT0(value)            (RSTC_BKUPEXIT_VBAT0_Msk & (_UINT8_(value) << RSTC_BKUPEXIT_VBAT0_Pos)) /* Assignment of value for VBAT0 in the RSTC_BKUPEXIT register */
...
#define RSTC_BKUPEXIT_BBPS0_Pos               _UINT8_(2)                                           /* (RSTC_BKUPEXIT) Battery Backup Power Switch Position */
#define RSTC_BKUPEXIT_BBPS0_Msk               (_UINT8_(0x1) << RSTC_BKUPEXIT_BBPS0_Pos)            /* (RSTC_BKUPEXIT) Battery Backup Power Switch Mask */
#define RSTC_BKUPEXIT_BBPS0(value)            (RSTC_BKUPEXIT_BBPS0_Msk & (_UINT8_(value) << RSTC_BKUPEXIT_BBPS0_Pos)) /* Assignment of value for BBPS0 in the RSTC_BKUPEXIT register */
...
#define RSTC_BKUPEXIT_Msk                     _UINT8_(0x87)                                        /* (RSTC_BKUPEXIT) Register Mask  */

#define RSTC_BKUPEXIT_VBAT_Pos                _UINT8_(0)                                           /* (RSTC_BKUPEXIT Position) VBAT failure in backup mode */
#define RSTC_BKUPEXIT_VBAT_Msk                (_UINT8_(0x1) << RSTC_BKUPEXIT_VBAT_Pos)             /* (RSTC_BKUPEXIT Mask) VBAT */
#define RSTC_BKUPEXIT_VBAT(value)             (RSTC_BKUPEXIT_VBAT_Msk & (_UINT8_(value) << RSTC_BKUPEXIT_VBAT_Pos)) 
#define RSTC_BKUPEXIT_BBPS_Pos                _UINT8_(2)                                           /* (RSTC_BKUPEXIT Position) Battery Backup Power Switch */
#define RSTC_BKUPEXIT_BBPS_Msk                (_UINT8_(0x1) << RSTC_BKUPEXIT_BBPS_Pos)             /* (RSTC_BKUPEXIT Mask) BBPS */
#define RSTC_BKUPEXIT_BBPS(value)             (RSTC_BKUPEXIT_BBPS_Msk & (_UINT8_(value) << RSTC_BKUPEXIT_BBPS_Pos)) 
...
#endif /* _PIC32CKGC01_RSTC_COMPONENT_H_ */
