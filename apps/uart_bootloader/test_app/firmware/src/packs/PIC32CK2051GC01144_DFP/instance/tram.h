...
#ifndef _PIC32CKGC01_TRAM_INSTANCE_
#define _PIC32CKGC01_TRAM_INSTANCE_


/* ========== Instance Parameter definitions for TRAM peripheral ========== */
#define TRAM_ADDR_MSB                            (7)        /* Value of the MSB bit of physical RAM address */
#define TRAM_INSTANCE_ID                         (15)       /* Instance index for TRAM */
#define TRAM_MCLK_ID_APB                         (47)       /* Index for TRAM APB clock */
#define TRAM_PAC_ID                              (15)       /* Index for TRAM registers write protection */

#endif /* _PIC32CKGC01_TRAM_INSTANCE_ */
