...
#ifndef _PIC32CXMTSH_GPBR_COMPONENT_H_
#define _PIC32CXMTSH_GPBR_COMPONENT_H_
...
#define SYS_GPBR8_REG_OFST             _UINT32_(0x28)      /* (SYS_GPBR8) General Purpose Backup Register Offset */
#define SYS_GPBR9_REG_OFST             _UINT32_(0x2C)      /* (SYS_GPBR9) General Purpose Backup Register Offset */
#define SYS_GPBR10_REG_OFST            _UINT32_(0x30)      /* (SYS_GPBR10) General Purpose Backup Register Offset */
#define SYS_GPBR11_REG_OFST            _UINT32_(0x34)      /* (SYS_GPBR11) General Purpose Backup Register Offset */
#define SYS_GPBR12_REG_OFST            _UINT32_(0x38)      /* (SYS_GPBR12) General Purpose Backup Register Offset */
#define SYS_GPBR13_REG_OFST            _UINT32_(0x3C)      /* (SYS_GPBR13) General Purpose Backup Register Offset */
#define SYS_GPBR14_REG_OFST            _UINT32_(0x40)      /* (SYS_GPBR14) General Purpose Backup Register Offset */
#define SYS_GPBR15_REG_OFST            _UINT32_(0x44)      /* (SYS_GPBR15) General Purpose Backup Register Offset */
#define SYS_GPBR16_REG_OFST            _UINT32_(0x48)      /* (SYS_GPBR16) General Purpose Backup Register Offset */
#define SYS_GPBR17_REG_OFST            _UINT32_(0x4C)      /* (SYS_GPBR17) General Purpose Backup Register Offset */
#define SYS_GPBR18_REG_OFST            _UINT32_(0x50)      /* (SYS_GPBR18) General Purpose Backup Register Offset */
#define SYS_GPBR19_REG_OFST            _UINT32_(0x54)      /* (SYS_GPBR19) General Purpose Backup Register Offset */
#define SYS_GPBR20_REG_OFST            _UINT32_(0x58)      /* (SYS_GPBR20) General Purpose Backup Register Offset */
#define SYS_GPBR21_REG_OFST            _UINT32_(0x5C)      /* (SYS_GPBR21) General Purpose Backup Register Offset */
#define SYS_GPBR22_REG_OFST            _UINT32_(0x60)      /* (SYS_GPBR22) General Purpose Backup Register Offset */
#define SYS_GPBR23_REG_OFST            _UINT32_(0x64)      /* (SYS_GPBR23) General Purpose Backup Register Offset */
...
typedef struct
{
  ...
  __IO  uint32_t                       SYS_GPBR[24];       /**< Offset: 0x08 (R/W  32) General Purpose Backup Register */
} gpbr_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CXMTSH_GPBR_COMPONENT_H_ */
