...
#ifndef _PIC32CKSG01_PDEC_COMPONENT_H_
#define _PIC32CKSG01_PDEC_COMPONENT_H_
...
/* -------- PDEC_CCBUF : (PDEC Offset: 0x30) (R/W 32) Channel n Compare Buffer Value -------- */
#define PDEC_CCBUF_RESETVALUE                 _UINT32_(0x00)                                       /*  (PDEC_CCBUF) Channel n Compare Buffer Value  Reset Value */
...
#define PDEC_CCBUF_REG_OFST            _UINT32_(0x30)      /* (PDEC_CCBUF) Channel n Compare Buffer Value Offset */
#define PDEC_CCBUF0_REG_OFST           _UINT32_(0x30)      /* (PDEC_CCBUF0) Channel n Compare Buffer Value Offset */
#define PDEC_CCBUF1_REG_OFST           _UINT32_(0x34)      /* (PDEC_CCBUF1) Channel n Compare Buffer Value Offset */
...
{  /* Position Decoder */
  ...
  __IO  uint32_t                       PDEC_CCBUF[2];      /**< Offset: 0x30 (R/W  32) Channel n Compare Buffer Value */
} pdec_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CKSG01_PDEC_COMPONENT_H_ */
