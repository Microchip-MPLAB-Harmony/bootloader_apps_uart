...
#ifndef _PIC32CMSG00_SUPC_COMPONENT_H_
#define _PIC32CMSG00_SUPC_COMPONENT_H_
...
#define SUPC_INTENCLR_Msk                     _UINT32_(0x0000012F)                                 /* (SUPC_INTENCLR) Register Mask  */
...
#define SUPC_INTENSET_Msk                     _UINT32_(0x0000012F)                                 /* (SUPC_INTENSET) Register Mask  */
...
#define SUPC_INTFLAG_Msk                      _UINT32_(0x0000012F)                                 /* (SUPC_INTFLAG) Register Mask  */
...
#define SUPC_STATUS_Msk                       _UINT32_(0x0000012F)                                 /* (SUPC_STATUS) Register Mask  */
...
#define SUPC_VREGCTRL_RESETVALUE              _UINT32_(0x04)                                       /*  (SUPC_VREGCTRL) VREG Control  Reset Value */
...
#define SUPC_VREGCTRL_SRAM_VLD_Pos            _UINT32_(30)                                         /* (SUPC_VREGCTRL) SRAM VALID Status Bit Position */
#define SUPC_VREGCTRL_SRAM_VLD_Msk            (_UINT32_(0x1) << SUPC_VREGCTRL_SRAM_VLD_Pos)        /* (SUPC_VREGCTRL) SRAM VALID Status Bit Mask */
#define SUPC_VREGCTRL_SRAM_VLD(value)         (SUPC_VREGCTRL_SRAM_VLD_Msk & (_UINT32_(value) << SUPC_VREGCTRL_SRAM_VLD_Pos)) /* Assignment of value for SRAM_VLD in the SUPC_VREGCTRL register */
#define SUPC_VREGCTRL_BKUP_VLD_Pos            _UINT32_(31)                                         /* (SUPC_VREGCTRL) Backup Domain Valid Status Bit Position */
#define SUPC_VREGCTRL_BKUP_VLD_Msk            (_UINT32_(0x1) << SUPC_VREGCTRL_BKUP_VLD_Pos)        /* (SUPC_VREGCTRL) Backup Domain Valid Status Bit Mask */
#define SUPC_VREGCTRL_BKUP_VLD(value)         (SUPC_VREGCTRL_BKUP_VLD_Msk & (_UINT32_(value) << SUPC_VREGCTRL_BKUP_VLD_Pos)) /* Assignment of value for BKUP_VLD in the SUPC_VREGCTRL register */
#define SUPC_VREGCTRL_Msk                     _UINT32_(0xC101F337)                                 /* (SUPC_VREGCTRL) Register Mask  */


/* -------- SUPC_VREFCTRL : (SUPC Offset: 0x20) (R/W 32) VREF Control -------- */
#define SUPC_VREFCTRL_RESETVALUE              _UINT32_(0x02)                                       /*  (SUPC_VREFCTRL) VREF Control  Reset Value */
...
#endif /* _PIC32CMSG00_SUPC_COMPONENT_H_ */
