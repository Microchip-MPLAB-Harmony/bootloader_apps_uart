...
/* PIC32CM5112SG00100 definitions
  This file defines all structures and symbols for PIC32CM5112SG00100:
...
/* ************************************************************************** */
/*                  CMSIS DEFINITIONS FOR PIC32CM5112SG00100                  */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
/* ************* PIC32CM5112SG00100 specific Interrupt Numbers ************** */
...
typedef struct _DeviceVectors
{
  ...
  void* pfnTRAM_Handler;                         /*  33 TrustRAM (TRAM) */
...
#include "system_pic32cmsg00.h"
#endif /* USE_CMSIS_INIT */

/* ************************************************************************** */
/*         SOFTWARE PERIPHERAL API DEFINITIONS FOR PIC32CM5112SG00100         */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                INSTANCE DEFINITIONS FOR PIC32CM5112SG00100                 */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*              PERIPHERAL ID DEFINITIONS FOR PIC32CM5112SG00100              */
/* ************************************************************************** */
...
#define ID_IDAU          ( 24) /* Instance index for IDAU (IDAU) */
...
/* ************************************************************************** */
/*       REGISTER STRUCTURE ADDRESS DEFINITIONS FOR PIC32CM5112SG00100        */
/* ************************************************************************** */
#if !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__))
...
#define PUF_REGS                         ((puf_registers_t*)0x44834000)                /* PUF Registers Address        */
...
#define TRAM_REGS                        ((tram_registers_t*)0x4500a000)               /* TRAM Registers Address       */
...
/* ************************************************************************** */
/*              BASE ADDRESS DEFINITIONS FOR PIC32CM5112SG00100               */
/* ************************************************************************** */
...
#define PUF_BASE_ADDRESS                 _UINT32_(0x44834000)                          /* PUF Base Address */
...
#define TRAM_BASE_ADDRESS                _UINT32_(0x4500a000)                          /* TRAM Base Address */
#define USB_BASE_ADDRESS                 _UINT32_(0x44832000)                          /* USB Base Address */
#define WDT_BASE_ADDRESS                 _UINT32_(0x4400e000)                          /* WDT Base Address */

/* ************************************************************************** */
/*                   PIO DEFINITIONS FOR PIC32CM5112SG00100                   */
/* ************************************************************************** */
#include "pio/pic32cm5112sg00100.h"

/* ************************************************************************** */
/*             MEMORY MAPPING DEFINITIONS FOR PIC32CM5112SG00100              */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                  DEVICE SIGNATURES FOR PIC32CM5112SG00100                  */
/* ************************************************************************** */
#define CHIP_DSU_DID                   _UINT32_(0X0AC08053)

/* ************************************************************************** */
/*               ELECTRICAL DEFINITIONS FOR PIC32CM5112SG00100                */
/* ************************************************************************** */

/* ************************************************************************** */
/*                  Event Generator IDs for C32CM5112SG00100                  */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*                    Event User IDs for C32CM5112SG00100                     */
/* ************************************************************************** */
...
/* ************************************************************************** */
/*          IDAU TrustZone REGION DEFINITIONS FOR PIC32CM5112SG00100          */
/* ************************************************************************** */
#define IDAU_REGION_BROMC_ROM_SEC                _UINT32_(1) /* IDAU region number for BROMC_ROM_SEC */
#define IDAU_REGION_FCR_BFM_SEC                  _UINT32_(2) /* IDAU region number for FCR_BFM_SEC */
#define IDAU_REGION_FCR_BFM_NSC                  _UINT32_(3) /* IDAU region number for FCR_BFM_NSC */
#define IDAU_REGION_FCR_CFM_SEC                  _UINT32_(4) /* IDAU region number for FCR_CFM_SEC */
#define IDAU_REGION_FCR_PFM_SEC                  _UINT32_(5) /* IDAU region number for FCR_PFM_SEC */
#define IDAU_REGION_FCR_PFM_NSC                  _UINT32_(6) /* IDAU region number for FCR_PFM_NSC */
#define IDAU_REGION_FCR_PFM_NS                   _UINT32_(7) /* IDAU region number for FCR_PFM_NS */
#define IDAU_REGION_MCRAMC_RET_SEC               _UINT32_(8) /* IDAU region number for MCRAMC_RET_SEC */
#define IDAU_REGION_MCRAMC_RET_NS                _UINT32_(9) /* IDAU region number for MCRAMC_RET_NS */
