...
#ifndef _PIC32CMSG00_CCL_COMPONENT_H_
#define _PIC32CMSG00_CCL_COMPONENT_H_
...
#define   CCL_LUTCTRL_INSEL0_PERSEL0_Val      _UINT32_(0x5)                                        /* (CCL_LUTCTRL) Peripheral 0 input source  */
#define   CCL_LUTCTRL_INSEL0_PERSEL1_Val      _UINT32_(0x6)                                        /* (CCL_LUTCTRL) Peripheral 1 input source  */
#define   CCL_LUTCTRL_INSEL0_PERSEL2_Val      _UINT32_(0x7)                                        /* (CCL_LUTCTRL) Peripheral 2 input source  */
#define   CCL_LUTCTRL_INSEL0_PERSEL3_Val      _UINT32_(0x8)                                        /* (CCL_LUTCTRL) Peripheral 3 input source  */
#define   CCL_LUTCTRL_INSEL0_PERSEL4_Val      _UINT32_(0x9)                                        /* (CCL_LUTCTRL) Peripheral 4 input source  */
#define   CCL_LUTCTRL_INSEL0_PERSEL5_Val      _UINT32_(0xA)                                        /* (CCL_LUTCTRL) Peripheral 5 input source  */
#define   CCL_LUTCTRL_INSEL0_ASYNCEVENT_Val   _UINT32_(0xB)                                        /* (CCL_LUTCTRL) Asynchronous event input source. The EVENT input will bypass edge detection logic.  */
...
#define CCL_LUTCTRL_INSEL0_PERSEL0            (CCL_LUTCTRL_INSEL0_PERSEL0_Val << CCL_LUTCTRL_INSEL0_Pos) /* (CCL_LUTCTRL) Peripheral 0 input source Position */
#define CCL_LUTCTRL_INSEL0_PERSEL1            (CCL_LUTCTRL_INSEL0_PERSEL1_Val << CCL_LUTCTRL_INSEL0_Pos) /* (CCL_LUTCTRL) Peripheral 1 input source Position */
#define CCL_LUTCTRL_INSEL0_PERSEL2            (CCL_LUTCTRL_INSEL0_PERSEL2_Val << CCL_LUTCTRL_INSEL0_Pos) /* (CCL_LUTCTRL) Peripheral 2 input source Position */
#define CCL_LUTCTRL_INSEL0_PERSEL3            (CCL_LUTCTRL_INSEL0_PERSEL3_Val << CCL_LUTCTRL_INSEL0_Pos) /* (CCL_LUTCTRL) Peripheral 3 input source Position */
#define CCL_LUTCTRL_INSEL0_PERSEL4            (CCL_LUTCTRL_INSEL0_PERSEL4_Val << CCL_LUTCTRL_INSEL0_Pos) /* (CCL_LUTCTRL) Peripheral 4 input source Position */
#define CCL_LUTCTRL_INSEL0_PERSEL5            (CCL_LUTCTRL_INSEL0_PERSEL5_Val << CCL_LUTCTRL_INSEL0_Pos) /* (CCL_LUTCTRL) Peripheral 5 input source Position */
...
#define   CCL_LUTCTRL_INSEL1_PERSEL0_Val      _UINT32_(0x5)                                        /* (CCL_LUTCTRL) Peripheral 0 input source  */
#define   CCL_LUTCTRL_INSEL1_PERSEL1_Val      _UINT32_(0x6)                                        /* (CCL_LUTCTRL) Peripheral 1 input source  */
#define   CCL_LUTCTRL_INSEL1_PERSEL2_Val      _UINT32_(0x7)                                        /* (CCL_LUTCTRL) Peripheral 2 input source  */
#define   CCL_LUTCTRL_INSEL1_PERSEL3_Val      _UINT32_(0x8)                                        /* (CCL_LUTCTRL) Peripheral 3 input source  */
#define   CCL_LUTCTRL_INSEL1_PERSEL4_Val      _UINT32_(0x9)                                        /* (CCL_LUTCTRL) Peripheral 4 input source  */
#define   CCL_LUTCTRL_INSEL1_PERSEL5_Val      _UINT32_(0xA)                                        /* (CCL_LUTCTRL) Peripheral 5 input source  */
#define   CCL_LUTCTRL_INSEL1_ASYNCEVENT_Val   _UINT32_(0xB)                                        /* (CCL_LUTCTRL) Asynchronous event input source. The EVENT input will bypass edge detection logic.  */
...
#define CCL_LUTCTRL_INSEL1_PERSEL0            (CCL_LUTCTRL_INSEL1_PERSEL0_Val << CCL_LUTCTRL_INSEL1_Pos) /* (CCL_LUTCTRL) Peripheral 0 input source Position */
#define CCL_LUTCTRL_INSEL1_PERSEL1            (CCL_LUTCTRL_INSEL1_PERSEL1_Val << CCL_LUTCTRL_INSEL1_Pos) /* (CCL_LUTCTRL) Peripheral 1 input source Position */
#define CCL_LUTCTRL_INSEL1_PERSEL2            (CCL_LUTCTRL_INSEL1_PERSEL2_Val << CCL_LUTCTRL_INSEL1_Pos) /* (CCL_LUTCTRL) Peripheral 2 input source Position */
#define CCL_LUTCTRL_INSEL1_PERSEL3            (CCL_LUTCTRL_INSEL1_PERSEL3_Val << CCL_LUTCTRL_INSEL1_Pos) /* (CCL_LUTCTRL) Peripheral 3 input source Position */
#define CCL_LUTCTRL_INSEL1_PERSEL4            (CCL_LUTCTRL_INSEL1_PERSEL4_Val << CCL_LUTCTRL_INSEL1_Pos) /* (CCL_LUTCTRL) Peripheral 4 input source Position */
#define CCL_LUTCTRL_INSEL1_PERSEL5            (CCL_LUTCTRL_INSEL1_PERSEL5_Val << CCL_LUTCTRL_INSEL1_Pos) /* (CCL_LUTCTRL) Peripheral 5 input source Position */
...
#define   CCL_LUTCTRL_INSEL2_PERSEL0_Val      _UINT32_(0x5)                                        /* (CCL_LUTCTRL) Peripheral 0 input source  */
#define   CCL_LUTCTRL_INSEL2_PERSEL1_Val      _UINT32_(0x6)                                        /* (CCL_LUTCTRL) Peripheral 1 input source  */
#define   CCL_LUTCTRL_INSEL2_PERSEL2_Val      _UINT32_(0x7)                                        /* (CCL_LUTCTRL) Peripheral 2 input source  */
#define   CCL_LUTCTRL_INSEL2_PERSEL3_Val      _UINT32_(0x8)                                        /* (CCL_LUTCTRL) Peripheral 3 input source  */
#define   CCL_LUTCTRL_INSEL2_PERSEL4_Val      _UINT32_(0x9)                                        /* (CCL_LUTCTRL) Peripheral 4 input source  */
#define   CCL_LUTCTRL_INSEL2_PERSEL5_Val      _UINT32_(0xA)                                        /* (CCL_LUTCTRL) Peripheral 5 input source  */
#define   CCL_LUTCTRL_INSEL2_ASYNCEVENT_Val   _UINT32_(0xB)                                        /* (CCL_LUTCTRL) Asynchronous event input source. The EVENT input will bypass edge detection logic.  */
...
#define CCL_LUTCTRL_INSEL2_PERSEL0            (CCL_LUTCTRL_INSEL2_PERSEL0_Val << CCL_LUTCTRL_INSEL2_Pos) /* (CCL_LUTCTRL) Peripheral 0 input source Position */
#define CCL_LUTCTRL_INSEL2_PERSEL1            (CCL_LUTCTRL_INSEL2_PERSEL1_Val << CCL_LUTCTRL_INSEL2_Pos) /* (CCL_LUTCTRL) Peripheral 1 input source Position */
#define CCL_LUTCTRL_INSEL2_PERSEL2            (CCL_LUTCTRL_INSEL2_PERSEL2_Val << CCL_LUTCTRL_INSEL2_Pos) /* (CCL_LUTCTRL) Peripheral 2 input source Position */
#define CCL_LUTCTRL_INSEL2_PERSEL3            (CCL_LUTCTRL_INSEL2_PERSEL3_Val << CCL_LUTCTRL_INSEL2_Pos) /* (CCL_LUTCTRL) Peripheral 3 input source Position */
#define CCL_LUTCTRL_INSEL2_PERSEL4            (CCL_LUTCTRL_INSEL2_PERSEL4_Val << CCL_LUTCTRL_INSEL2_Pos) /* (CCL_LUTCTRL) Peripheral 4 input source Position */
#define CCL_LUTCTRL_INSEL2_PERSEL5            (CCL_LUTCTRL_INSEL2_PERSEL5_Val << CCL_LUTCTRL_INSEL2_Pos) /* (CCL_LUTCTRL) Peripheral 5 input source Position */
...
#endif /* _PIC32CMSG00_CCL_COMPONENT_H_ */
