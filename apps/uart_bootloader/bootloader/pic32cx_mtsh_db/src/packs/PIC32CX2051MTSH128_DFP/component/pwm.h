...
#define PWM_DIS_Msk                           _UINT32_(0x00000007)                                 /* (PWM_DIS) Register Mask  */
...
#define PWM_IDR1_Msk                          _UINT32_(0x00070007)                                 /* (PWM_IDR1) Register Mask  */

#define PWM_IDR1_CHID_Pos                     _UINT32_(0)                                          /* (PWM_IDR1 Position) Counter Event on Channel x Interrupt Disable */
#define PWM_IDR1_CHID_Msk                     (_UINT32_(0x7) << PWM_IDR1_CHID_Pos)                 /* (PWM_IDR1 Mask) CHID */
#define PWM_IDR1_CHID(value)                  (PWM_IDR1_CHID_Msk & (_UINT32_(value) << PWM_IDR1_CHID_Pos)) 
#define PWM_IDR1_FCHID_Pos                    _UINT32_(16)                                         /* (PWM_IDR1 Position) Fault Protection Trigger on Channel 2 Interrupt Disable */
...
#define PWM_IER2_ENDTX_Pos                    _UINT32_(1)                                          /* (PWM_IER2) PDC End of TX Buffer Interrupt Enable Position */
#define PWM_IER2_ENDTX_Msk                    (_UINT32_(0x1) << PWM_IER2_ENDTX_Pos)                /* (PWM_IER2) PDC End of TX Buffer Interrupt Enable Mask */
#define PWM_IER2_ENDTX(value)                 (PWM_IER2_ENDTX_Msk & (_UINT32_(value) << PWM_IER2_ENDTX_Pos)) /* Assigment of value for ENDTX in the PWM_IER2 register */
#define PWM_IER2_TXBUFE_Pos                   _UINT32_(2)                                          /* (PWM_IER2) PDC TX Buffer Empty Interrupt Enable Position */
#define PWM_IER2_TXBUFE_Msk                   (_UINT32_(0x1) << PWM_IER2_TXBUFE_Pos)               /* (PWM_IER2) PDC TX Buffer Empty Interrupt Enable Mask */
#define PWM_IER2_TXBUFE(value)                (PWM_IER2_TXBUFE_Msk & (_UINT32_(value) << PWM_IER2_TXBUFE_Pos)) /* Assigment of value for TXBUFE in the PWM_IER2 register */
...
#define PWM_IER2_Msk                          _UINT32_(0x00FFFF0F)                                 /* (PWM_IER2) Register Mask  */
...
#define PWM_IMR2_ENDTX_Pos                    _UINT32_(1)                                          /* (PWM_IMR2) PDC End of TX Buffer Interrupt Mask Position */
#define PWM_IMR2_ENDTX_Msk                    (_UINT32_(0x1) << PWM_IMR2_ENDTX_Pos)                /* (PWM_IMR2) PDC End of TX Buffer Interrupt Mask Mask */
#define PWM_IMR2_ENDTX(value)                 (PWM_IMR2_ENDTX_Msk & (_UINT32_(value) << PWM_IMR2_ENDTX_Pos)) /* Assigment of value for ENDTX in the PWM_IMR2 register */
#define PWM_IMR2_TXBUFE_Pos                   _UINT32_(2)                                          /* (PWM_IMR2) PDC TX Buffer Empty Interrupt Mask Position */
#define PWM_IMR2_TXBUFE_Msk                   (_UINT32_(0x1) << PWM_IMR2_TXBUFE_Pos)               /* (PWM_IMR2) PDC TX Buffer Empty Interrupt Mask Mask */
#define PWM_IMR2_TXBUFE(value)                (PWM_IMR2_TXBUFE_Msk & (_UINT32_(value) << PWM_IMR2_TXBUFE_Pos)) /* Assigment of value for TXBUFE in the PWM_IMR2 register */
...
#define PWM_IMR2_Msk                          _UINT32_(0x00FFFF0F)                                 /* (PWM_IMR2) Register Mask  */
...
#define PWM_ISR2_ENDTX_Pos                    _UINT32_(1)                                          /* (PWM_ISR2) PDC End of TX Buffer Position */
#define PWM_ISR2_ENDTX_Msk                    (_UINT32_(0x1) << PWM_ISR2_ENDTX_Pos)                /* (PWM_ISR2) PDC End of TX Buffer Mask */
#define PWM_ISR2_ENDTX(value)                 (PWM_ISR2_ENDTX_Msk & (_UINT32_(value) << PWM_ISR2_ENDTX_Pos)) /* Assigment of value for ENDTX in the PWM_ISR2 register */
#define PWM_ISR2_TXBUFE_Pos                   _UINT32_(2)                                          /* (PWM_ISR2) PDC TX Buffer Empty Position */
#define PWM_ISR2_TXBUFE_Msk                   (_UINT32_(0x1) << PWM_ISR2_TXBUFE_Pos)               /* (PWM_ISR2) PDC TX Buffer Empty Mask */
#define PWM_ISR2_TXBUFE(value)                (PWM_ISR2_TXBUFE_Msk & (_UINT32_(value) << PWM_ISR2_TXBUFE_Pos)) /* Assigment of value for TXBUFE in the PWM_ISR2 register */
...
#define PWM_ISR2_Msk                          _UINT32_(0x00FFFF0F)                                 /* (PWM_ISR2) Register Mask  */
...
#define PWM_OOV_Msk                           _UINT32_(0x00070007)                                 /* (PWM_OOV) Register Mask  */

#define PWM_OOV_OOVH_Pos                      _UINT32_(0)                                          /* (PWM_OOV Position) Output Override Value for PWMH output of the channel x */
#define PWM_OOV_OOVH_Msk                      (_UINT32_(0x7) << PWM_OOV_OOVH_Pos)                  /* (PWM_OOV Mask) OOVH */
#define PWM_OOV_OOVH(value)                   (PWM_OOV_OOVH_Msk & (_UINT32_(value) << PWM_OOV_OOVH_Pos)) 
#define PWM_OOV_OOVL_Pos                      _UINT32_(16)                                         /* (PWM_OOV Position) Output Override Value for PWML output of the channel 2 */
#define PWM_OOV_OOVL_Msk                      (_UINT32_(0x7) << PWM_OOV_OOVL_Pos)                  /* (PWM_OOV Mask) OOVL */
...
#define PWM_OS_Msk                            _UINT32_(0x00070007)                                 /* (PWM_OS) Register Mask  */

#define PWM_OS_OSH_Pos                        _UINT32_(0)                                          /* (PWM_OS Position) Output Selection for PWMH output of the channel x */
#define PWM_OS_OSH_Msk                        (_UINT32_(0x7) << PWM_OS_OSH_Pos)                    /* (PWM_OS Mask) OSH */
#define PWM_OS_OSH(value)                     (PWM_OS_OSH_Msk & (_UINT32_(value) << PWM_OS_OSH_Pos)) 
#define PWM_OS_OSL_Pos                        _UINT32_(16)                                         /* (PWM_OS Position) Output Selection for PWML output of the channel 2 */
...
#define PWM_OSS_Msk                           _UINT32_(0x00070007)                                 /* (PWM_OSS) Register Mask  */

#define PWM_OSS_OSSH_Pos                      _UINT32_(0)                                          /* (PWM_OSS Position) Output Selection Set for PWMH output of the channel x */
#define PWM_OSS_OSSH_Msk                      (_UINT32_(0x7) << PWM_OSS_OSSH_Pos)                  /* (PWM_OSS Mask) OSSH */
...
#define PWM_OSSUPD_Msk                        _UINT32_(0x00070007)                                 /* (PWM_OSSUPD) Register Mask  */

#define PWM_OSSUPD_OSSUPH_Pos                 _UINT32_(0)                                          /* (PWM_OSSUPD Position) Output Selection Set for PWMH output of the channel x */
#define PWM_OSSUPD_OSSUPH_Msk                 (_UINT32_(0x7) << PWM_OSSUPD_OSSUPH_Pos)             /* (PWM_OSSUPD Mask) OSSUPH */
#define PWM_OSSUPD_OSSUPH(value)              (PWM_OSSUPD_OSSUPH_Msk & (_UINT32_(value) << PWM_OSSUPD_OSSUPH_Pos)) 
#define PWM_OSSUPD_OSSUPL_Pos                 _UINT32_(16)                                         /* (PWM_OSSUPD Position) Output Selection Set for PWML output of the channel 2 */
...
typedef struct
{
  ...
  __IO  uint32_t                       PWM_ELMR[1];        /**< Offset: 0x7C (R/W  32) PWM Event Line 0 Mode Register */
  ...
  __IO  uint32_t                       PWM_TPR;            /**< Offset: 0x108 (R/W  32) Transmit Pointer Register */
  __IO  uint32_t                       PWM_TCR;            /**< Offset: 0x10C (R/W  32) Transmit Counter Register */
  __I   uint8_t                        Reserved8[0x08];
  __IO  uint32_t                       PWM_TNPR;           /**< Offset: 0x118 (R/W  32) Transmit Next Pointer Register */
  __IO  uint32_t                       PWM_TNCR;           /**< Offset: 0x11C (R/W  32) Transmit Next Counter Register */
  __O   uint32_t                       PWM_PTCR;           /**< Offset: 0x120 ( /W  32) Transfer Control Register */
  __I   uint32_t                       PWM_PTSR;           /**< Offset: 0x124 (R/   32) Transfer Status Register */
  __IO  uint32_t                       PWM_PWPMR;          /**< Offset: 0x128 (R/W  32) Write Protection Mode Register */
  __I   uint8_t                        Reserved9[0x04];
        pwm_cmp_registers_t            PWM_CMP[PWM_CMP_NUMBER]; /**< Offset: 0x130  */
  __I   uint8_t                        Reserved10[0x50];
        pwm_ch_num_registers_t         PWM_CH_NUM[PWM_CH_NUM_NUMBER]; /**< Offset: 0x200  */
  __I   uint8_t                        Reserved11[0x1A0];
...
#endif /* _PIC32CXMTSH_PWM_COMPONENT_H_ */
