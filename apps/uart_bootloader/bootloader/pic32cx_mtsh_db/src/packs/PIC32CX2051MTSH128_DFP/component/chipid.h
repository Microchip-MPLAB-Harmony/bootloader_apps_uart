...
#ifndef _PIC32CXMTSH_CHIPID_COMPONENT_H_
#define _PIC32CXMTSH_CHIPID_COMPONENT_H_
...
#define   CHIPID_CIDR_ARCH_PIC32CXMTSH128_Val _UINT32_(0xC3)                                       /* (CHIPID_CIDR) Dual Core, Single Phase, High Accuracy (128-lead version)  */
#define   CHIPID_CIDR_ARCH_PIC32CXMTC128_Val  _UINT32_(0xC5)                                       /* (CHIPID_CIDR) Dual Core (128-lead version)  */
#define   CHIPID_CIDR_ARCH_PIC32CXMTG64_Val   _UINT32_(0xC6)                                       /* (CHIPID_CIDR) Single Core (64-lead version)  */
#define   CHIPID_CIDR_ARCH_PIC32CXMTG128_Val  _UINT32_(0xC8)                                       /* (CHIPID_CIDR) Single Core (128-lead version)  */
#define CHIPID_CIDR_ARCH_PIC32CXMTSH128       (CHIPID_CIDR_ARCH_PIC32CXMTSH128_Val << CHIPID_CIDR_ARCH_Pos) /* (CHIPID_CIDR) Dual Core, Single Phase, High Accuracy (128-lead version) Position  */
#define CHIPID_CIDR_ARCH_PIC32CXMTC128        (CHIPID_CIDR_ARCH_PIC32CXMTC128_Val << CHIPID_CIDR_ARCH_Pos) /* (CHIPID_CIDR) Dual Core (128-lead version) Position  */
#define CHIPID_CIDR_ARCH_PIC32CXMTG64         (CHIPID_CIDR_ARCH_PIC32CXMTG64_Val << CHIPID_CIDR_ARCH_Pos) /* (CHIPID_CIDR) Single Core (64-lead version) Position  */
#define CHIPID_CIDR_ARCH_PIC32CXMTG128        (CHIPID_CIDR_ARCH_PIC32CXMTG128_Val << CHIPID_CIDR_ARCH_Pos) /* (CHIPID_CIDR) Single Core (128-lead version) Position  */
...
#endif /* _PIC32CXMTSH_CHIPID_COMPONENT_H_ */
