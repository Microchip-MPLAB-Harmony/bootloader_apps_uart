...
#ifndef _PIC32WM_BZ6_GPIO_COMPONENT_H_
#define _PIC32WM_BZ6_GPIO_COMPONENT_H_
...
#define GPIO_ANSEL_ANS15(value)               (GPIO_ANSEL_ANS15_Msk & (_UINT32_(value) << GPIO_ANSEL_ANS15_Pos)) /* Assignment of value for ANS15 in the GPIO_ANSEL register */
...
#define GPIO_TRIS_TRIS15(value)               (GPIO_TRIS_TRIS15_Msk & (_UINT32_(value) << GPIO_TRIS_TRIS15_Pos)) /* Assignment of value for TRIS15 in the GPIO_TRIS register */
...
#define GPIO_PORT_R15(value)                  (GPIO_PORT_R15_Msk & (_UINT32_(value) << GPIO_PORT_R15_Pos)) /* Assignment of value for R15 in the GPIO_PORT register */
...
#define GPIO_LAT_LAT15(value)                 (GPIO_LAT_LAT15_Msk & (_UINT32_(value) << GPIO_LAT_LAT15_Pos)) /* Assignment of value for LAT15 in the GPIO_LAT register */
...
#define GPIO_ODC_ODC15(value)                 (GPIO_ODC_ODC15_Msk & (_UINT32_(value) << GPIO_ODC_ODC15_Pos)) /* Assignment of value for ODC15 in the GPIO_ODC register */
...
#define GPIO_CNPU_CNPU15(value)               (GPIO_CNPU_CNPU15_Msk & (_UINT32_(value) << GPIO_CNPU_CNPU15_Pos)) /* Assignment of value for CNPU15 in the GPIO_CNPU register */
...
#define GPIO_CNPD_CNPD15(value)               (GPIO_CNPD_CNPD15_Msk & (_UINT32_(value) << GPIO_CNPD_CNPD15_Pos)) /* Assignment of value for CNPD15 in the GPIO_CNPD register */
...
#define GPIO_CNEN_CNIE15(value)               (GPIO_CNEN_CNIE15_Msk & (_UINT32_(value) << GPIO_CNEN_CNIE15_Pos)) /* Assignment of value for CNIE15 in the GPIO_CNEN register */
...
#define GPIO_CNSTAT_CNSTAT9(value)            (GPIO_CNSTAT_CNSTAT9_Msk & (_UINT32_(value) << GPIO_CNSTAT_CNSTAT9_Pos)) /* Assignment of value for CNSTAT9 in the GPIO_CNSTAT register */
...
#define GPIO_CNSTAT_CNSTAT15(value)           (GPIO_CNSTAT_CNSTAT15_Msk & (_UINT32_(value) << GPIO_CNSTAT_CNSTAT15_Pos)) /* Assignment of value for CNSTAT15 in the GPIO_CNSTAT register */
...
#define GPIO_CNNE_CNNE15(value)               (GPIO_CNNE_CNNE15_Msk & (_UINT32_(value) << GPIO_CNNE_CNNE15_Pos)) /* Assignment of value for CNNE15 in the GPIO_CNNE register */
...
#define GPIO_CNF_CNF15(value)                 (GPIO_CNF_CNF15_Msk & (_UINT32_(value) << GPIO_CNF_CNF15_Pos)) /* Assignment of value for CNF15 in the GPIO_CNF register */
...
#define GPIO_SRCON0_SR015(value)              (GPIO_SRCON0_SR015_Msk & (_UINT32_(value) << GPIO_SRCON0_SR015_Pos)) /* Assignment of value for SR015 in the GPIO_SRCON0 register */
...
#define GPIO_SRCON1_SR115(value)              (GPIO_SRCON1_SR115_Msk & (_UINT32_(value) << GPIO_SRCON1_SR115_Pos)) /* Assignment of value for SR115 in the GPIO_SRCON1 register */
...
#endif /* _PIC32WM_BZ6_GPIO_COMPONENT_H_ */
