...
#ifndef _PIC32CMGC00_AC_COMPONENT_H_
#define _PIC32CMGC00_AC_COMPONENT_H_

/* ************************************************************************** */
/*                       SOFTWARE API DEFINITION FOR AC                       */
/* ************************************************************************** */

/* -------- AC_COMPCTRL : (AC Offset: 0x00) (R/W 32) Pair n Comparator Control 0 -------- */
...
#define AC_COMPCTRL_SUT(value)                (AC_COMPCTRL_SUT_Msk & (_UINT32_(value) << AC_COMPCTRL_SUT_Pos)) /* Assignment of value for SUT in the AC_COMPCTRL register */
#define AC_COMPCTRL_Msk                       _UINT32_(0xFFFB777A)                                 /* (AC_COMPCTRL) Register Mask  */


/* -------- AC_DACCTRL : (AC Offset: 0x08) (R/W 32) Dac n Control -------- */
#define AC_DACCTRL_RESETVALUE                 _UINT32_(0x00)                                       /*  (AC_DACCTRL) Dac n Control  Reset Value */
...
#define AC_DACCTRL_VALUE0(value)              (AC_DACCTRL_VALUE0_Msk & (_UINT32_(value) << AC_DACCTRL_VALUE0_Pos)) /* Assignment of value for VALUE0 in the AC_DACCTRL register */
...
#define AC_DACCTRL_SHEN0(value)               (AC_DACCTRL_SHEN0_Msk & (_UINT32_(value) << AC_DACCTRL_SHEN0_Pos)) /* Assignment of value for SHEN0 in the AC_DACCTRL register */
...
#define AC_DACCTRL_VALUE1(value)              (AC_DACCTRL_VALUE1_Msk & (_UINT32_(value) << AC_DACCTRL_VALUE1_Pos)) /* Assignment of value for VALUE1 in the AC_DACCTRL register */
...
#define AC_DACCTRL_SHEN1(value)               (AC_DACCTRL_SHEN1_Msk & (_UINT32_(value) << AC_DACCTRL_SHEN1_Pos)) /* Assignment of value for SHEN1 in the AC_DACCTRL register */
#define AC_DACCTRL_Msk                        _UINT32_(0x807F807F)                                 /* (AC_DACCTRL) Register Mask  */


/* -------- AC_WINCTRL : (AC Offset: 0x0C) (R/W 32) Window Monitor  n Control -------- */
#define AC_WINCTRL_RESETVALUE                 _UINT32_(0x00)                                       /*  (AC_WINCTRL) Window Monitor  n Control  Reset Value */

#define AC_WINCTRL_WEN_Pos                    _UINT32_(0)                                          /* (AC_WINCTRL) Window n Mode Enable Position */
#define AC_WINCTRL_WEN_Msk                    (_UINT32_(0x1) << AC_WINCTRL_WEN_Pos)                /* (AC_WINCTRL) Window n Mode Enable Mask */
#define AC_WINCTRL_WEN(value)                 (AC_WINCTRL_WEN_Msk & (_UINT32_(value) << AC_WINCTRL_WEN_Pos)) /* Assignment of value for WEN in the AC_WINCTRL register */
#define AC_WINCTRL_WINTSEL_Pos                _UINT32_(1)                                          /* (AC_WINCTRL) Window n Interrupt Selection Position */
#define AC_WINCTRL_WINTSEL_Msk                (_UINT32_(0x3) << AC_WINCTRL_WINTSEL_Pos)            /* (AC_WINCTRL) Window n Interrupt Selection Mask */
#define AC_WINCTRL_WINTSEL(value)             (AC_WINCTRL_WINTSEL_Msk & (_UINT32_(value) << AC_WINCTRL_WINTSEL_Pos)) /* Assignment of value for WINTSEL in the AC_WINCTRL register */
#define   AC_WINCTRL_WINTSEL_ABOVE_Val        _UINT32_(0x0)                                        /* (AC_WINCTRL) Interrupt on signal above window  */
#define   AC_WINCTRL_WINTSEL_INSIDE_Val       _UINT32_(0x1)                                        /* (AC_WINCTRL) Interrupt on signal inside window  */
#define   AC_WINCTRL_WINTSEL_BELOW_Val        _UINT32_(0x2)                                        /* (AC_WINCTRL) Interrupt on signal below window  */
#define   AC_WINCTRL_WINTSEL_OUTSIDE_Val      _UINT32_(0x3)                                        /* (AC_WINCTRL) Interrupt on signal outside window  */
#define AC_WINCTRL_WINTSEL_ABOVE              (AC_WINCTRL_WINTSEL_ABOVE_Val << AC_WINCTRL_WINTSEL_Pos) /* (AC_WINCTRL) Interrupt on signal above window Position */
#define AC_WINCTRL_WINTSEL_INSIDE             (AC_WINCTRL_WINTSEL_INSIDE_Val << AC_WINCTRL_WINTSEL_Pos) /* (AC_WINCTRL) Interrupt on signal inside window Position */
#define AC_WINCTRL_WINTSEL_BELOW              (AC_WINCTRL_WINTSEL_BELOW_Val << AC_WINCTRL_WINTSEL_Pos) /* (AC_WINCTRL) Interrupt on signal below window Position */
#define AC_WINCTRL_WINTSEL_OUTSIDE            (AC_WINCTRL_WINTSEL_OUTSIDE_Val << AC_WINCTRL_WINTSEL_Pos) /* (AC_WINCTRL) Interrupt on signal outside window Position */
...
#define AC_CTRLB_START0(value)                (AC_CTRLB_START0_Msk & (_UINT32_(value) << AC_CTRLB_START0_Pos)) /* Assignment of value for START0 in the AC_CTRLB register */
...
#define AC_CTRLB_START1(value)                (AC_CTRLB_START1_Msk & (_UINT32_(value) << AC_CTRLB_START1_Pos)) /* Assignment of value for START1 in the AC_CTRLB register */
...
#define AC_CTRLC_WIDTH(value)                 (AC_CTRLC_WIDTH_Msk & (_UINT32_(value) << AC_CTRLC_WIDTH_Pos)) /* Assignment of value for WIDTH in the AC_CTRLC register */
...
#define AC_CTRLC_PER(value)                   (AC_CTRLC_PER_Msk & (_UINT32_(value) << AC_CTRLC_PER_Pos)) /* Assignment of value for PER in the AC_CTRLC register */
...
#define AC_CTRLC_PRESCALER(value)             (AC_CTRLC_PRESCALER_Msk & (_UINT32_(value) << AC_CTRLC_PRESCALER_Pos)) /* Assignment of value for PRESCALER in the AC_CTRLC register */
...
#define AC_CTRLC_AIPMPEN(value)               (AC_CTRLC_AIPMPEN_Msk & (_UINT32_(value) << AC_CTRLC_AIPMPEN_Pos)) /* Assignment of value for AIPMPEN in the AC_CTRLC register */
...
#define AC_CTRLC_CONFIG(value)                (AC_CTRLC_CONFIG_Msk & (_UINT32_(value) << AC_CTRLC_CONFIG_Pos)) /* Assignment of value for CONFIG in the AC_CTRLC register */
...
#define AC_EVCTRL_COMPEI0(value)              (AC_EVCTRL_COMPEI0_Msk & (_UINT32_(value) << AC_EVCTRL_COMPEI0_Pos)) /* Assignment of value for COMPEI0 in the AC_EVCTRL register */
...
#define AC_EVCTRL_COMPEI1(value)              (AC_EVCTRL_COMPEI1_Msk & (_UINT32_(value) << AC_EVCTRL_COMPEI1_Pos)) /* Assignment of value for COMPEI1 in the AC_EVCTRL register */
...
#define AC_EVCTRL_INVEI0(value)               (AC_EVCTRL_INVEI0_Msk & (_UINT32_(value) << AC_EVCTRL_INVEI0_Pos)) /* Assignment of value for INVEI0 in the AC_EVCTRL register */
...
#define AC_EVCTRL_INVEI1(value)               (AC_EVCTRL_INVEI1_Msk & (_UINT32_(value) << AC_EVCTRL_INVEI1_Pos)) /* Assignment of value for INVEI1 in the AC_EVCTRL register */
...
#define AC_STATUSA_STATE0(value)              (AC_STATUSA_STATE0_Msk & (_UINT32_(value) << AC_STATUSA_STATE0_Pos)) /* Assignment of value for STATE0 in the AC_STATUSA register */
...
#define AC_STATUSA_STATE1(value)              (AC_STATUSA_STATE1_Msk & (_UINT32_(value) << AC_STATUSA_STATE1_Pos)) /* Assignment of value for STATE1 in the AC_STATUSA register */
...
#define AC_STATUSA_WSTATE0(value)             (AC_STATUSA_WSTATE0_Msk & (_UINT32_(value) << AC_STATUSA_WSTATE0_Pos)) /* Assignment of value for WSTATE0 in the AC_STATUSA register */
...
#define AC_STATUSB_READY0(value)              (AC_STATUSB_READY0_Msk & (_UINT32_(value) << AC_STATUSB_READY0_Pos)) /* Assignment of value for READY0 in the AC_STATUSB register */
...
#define AC_STATUSB_READY1(value)              (AC_STATUSB_READY1_Msk & (_UINT32_(value) << AC_STATUSB_READY1_Pos)) /* Assignment of value for READY1 in the AC_STATUSB register */
...
#define AC_DBGCTRL_DBGRUN(value)              (AC_DBGCTRL_DBGRUN_Msk & (_UINT32_(value) << AC_DBGCTRL_DBGRUN_Pos)) /* Assignment of value for DBGRUN in the AC_DBGCTRL register */
...
#define AC_SYNCBUSY_WINCTRL0(value)           (AC_SYNCBUSY_WINCTRL0_Msk & (_UINT32_(value) << AC_SYNCBUSY_WINCTRL0_Pos)) /* Assignment of value for WINCTRL0 in the AC_SYNCBUSY register */
...
#define AC_COMPCTRL_REG_OFST           _UINT32_(0x00)      /* (AC_COMPCTRL) Pair n Comparator Control 0 Offset */
#define AC_COMPCTRL0_REG_OFST          _UINT32_(0x00)      /* (AC_COMPCTRL0) Pair n Comparator Control 0 Offset */
#define AC_COMPCTRL1_REG_OFST          _UINT32_(0x04)      /* (AC_COMPCTRL1) Pair n Comparator Control 0 Offset */
#define AC_DACCTRL_REG_OFST            _UINT32_(0x08)      /* (AC_DACCTRL) Dac n Control Offset */
#define AC_WINCTRL_REG_OFST            _UINT32_(0x0C)      /* (AC_WINCTRL) Window Monitor  n Control Offset */
...
typedef struct
{
  __IO  uint32_t                       AC_COMPCTRL[2];     /* Offset: 0x00 (R/W  32) Pair n Comparator Control 0 */
  __IO  uint32_t                       AC_DACCTRL;         /* Offset: 0x08 (R/W  32) Dac n Control */
  __IO  uint32_t                       AC_WINCTRL;         /* Offset: 0x0C (R/W  32) Window Monitor  n Control */
} ac_channel_registers_t;

#define AC_CHANNEL_NUMBER 1
...
{  /* Analog Comparator Controller */
  ...
  __I   uint8_t                        Reserved1[0x04];
        ac_channel_registers_t         CHANNEL[AC_CHANNEL_NUMBER]; /* Offset: 0x30  */
} ac_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CMGC00_AC_COMPONENT_H_ */
