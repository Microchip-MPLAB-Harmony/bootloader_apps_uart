...
#ifndef _PIC32CMGC00_TCC_COMPONENT_H_
#define _PIC32CMGC00_TCC_COMPONENT_H_
...
#define TCC_CTRLA_Msk                         _UINT32_(0x0381FF63)                                 /* (TCC_CTRLA) Register Mask  */

#define TCC_CTRLA_CPTEN_Pos                   _UINT32_(24)                                         /* (TCC_CTRLA Position) Capture Channel x Enable */
#define TCC_CTRLA_CPTEN_Msk                   (_UINT32_(0x3) << TCC_CTRLA_CPTEN_Pos)               /* (TCC_CTRLA Mask) CPTEN */
...
#define TCC_SYNCBUSY_Msk                      _UINT32_(0x000003FF)                                 /* (TCC_SYNCBUSY) Register Mask  */

#define TCC_SYNCBUSY_CC_Pos                   _UINT32_(8)                                          /* (TCC_SYNCBUSY Position) Compare Channel x Busy */
#define TCC_SYNCBUSY_CC_Msk                   (_UINT32_(0x3) << TCC_SYNCBUSY_CC_Pos)               /* (TCC_SYNCBUSY Mask) CC */
...
#define TCC_DRVCTRL_Msk                       _UINT32_(0xFF030303)                                 /* (TCC_DRVCTRL) Register Mask  */

#define TCC_DRVCTRL_NRE_Pos                   _UINT32_(0)                                          /* (TCC_DRVCTRL Position) Non-Recoverable State x Output Enable */
#define TCC_DRVCTRL_NRE_Msk                   (_UINT32_(0x3) << TCC_DRVCTRL_NRE_Pos)               /* (TCC_DRVCTRL Mask) NRE */
...
#define TCC_DRVCTRL_NRV_Msk                   (_UINT32_(0x3) << TCC_DRVCTRL_NRV_Pos)               /* (TCC_DRVCTRL Mask) NRV */
...
#define TCC_DRVCTRL_INVEN_Msk                 (_UINT32_(0x3) << TCC_DRVCTRL_INVEN_Pos)             /* (TCC_DRVCTRL Mask) INVEN */
...
#define TCC_EVCTRL_Msk                        _UINT32_(0x0303F7FF)                                 /* (TCC_EVCTRL) Register Mask  */
...
#define TCC_EVCTRL_MCEI_Msk                   (_UINT32_(0x3) << TCC_EVCTRL_MCEI_Pos)               /* (TCC_EVCTRL Mask) MCEI */
#define TCC_EVCTRL_MCEI(value)                (TCC_EVCTRL_MCEI_Msk & (_UINT32_(value) << TCC_EVCTRL_MCEI_Pos)) 
#define TCC_EVCTRL_MCEO_Pos                   _UINT32_(24)                                         /* (TCC_EVCTRL Position) Match or Capture Channel x Event Output Enable */
#define TCC_EVCTRL_MCEO_Msk                   (_UINT32_(0x3) << TCC_EVCTRL_MCEO_Pos)               /* (TCC_EVCTRL Mask) MCEO */
...
#define TCC_INTENCLR_Msk                      _UINT32_(0x0003FC0F)                                 /* (TCC_INTENCLR) Register Mask  */
...
#define TCC_INTENCLR_MC_Pos                   _UINT32_(16)                                         /* (TCC_INTENCLR Position) Match or Capture Channel x Interrupt Enable */
#define TCC_INTENCLR_MC_Msk                   (_UINT32_(0x3) << TCC_INTENCLR_MC_Pos)               /* (TCC_INTENCLR Mask) MC */
...
#define TCC_INTENSET_Msk                      _UINT32_(0x0003FC0F)                                 /* (TCC_INTENSET) Register Mask  */
...
#define TCC_INTENSET_MC_Pos                   _UINT32_(16)                                         /* (TCC_INTENSET Position) Match or Capture Channel x Interrupt Enable */
#define TCC_INTENSET_MC_Msk                   (_UINT32_(0x3) << TCC_INTENSET_MC_Pos)               /* (TCC_INTENSET Mask) MC */
...
#define TCC_INTFLAG_Msk                       _UINT32_(0x0003FC0F)                                 /* (TCC_INTFLAG) Register Mask  */
...
#define TCC_INTFLAG_MC_Pos                    _UINT32_(16)                                         /* (TCC_INTFLAG Position) Match or Capture x */
#define TCC_INTFLAG_MC_Msk                    (_UINT32_(0x3) << TCC_INTFLAG_MC_Pos)                /* (TCC_INTFLAG Mask) MC */
...
#define TCC_STATUS_Msk                        _UINT32_(0x0303FFBF)                                 /* (TCC_STATUS) Register Mask  */
...
#define TCC_STATUS_CCBUFV_Msk                 (_UINT32_(0x3) << TCC_STATUS_CCBUFV_Pos)             /* (TCC_STATUS Mask) CCBUFV */
#define TCC_STATUS_CCBUFV(value)              (TCC_STATUS_CCBUFV_Msk & (_UINT32_(value) << TCC_STATUS_CCBUFV_Pos)) 
#define TCC_STATUS_CMP_Pos                    _UINT32_(24)                                         /* (TCC_STATUS Position) Compare Channel x Value */
#define TCC_STATUS_CMP_Msk                    (_UINT32_(0x3) << TCC_STATUS_CMP_Pos)                /* (TCC_STATUS Mask) CMP */
...
#define TCC_COUNT_DITH4_COUNT_Msk             (_UINT32_(0xFFF) << TCC_COUNT_DITH4_COUNT_Pos)       /* (TCC_COUNT) Counter Value Mask */
#define TCC_COUNT_DITH4_COUNT(value)          (TCC_COUNT_DITH4_COUNT_Msk & (_UINT32_(value) << TCC_COUNT_DITH4_COUNT_Pos))
#define TCC_COUNT_DITH4_Msk                   _UINT32_(0x0000FFF0)                                 /* (TCC_COUNT_DITH4) Register Mask  */

/* DITH5 mode */
#define TCC_COUNT_DITH5_COUNT_Pos             _UINT32_(5)                                          /* (TCC_COUNT) Counter Value Position */
#define TCC_COUNT_DITH5_COUNT_Msk             (_UINT32_(0x7FF) << TCC_COUNT_DITH5_COUNT_Pos)       /* (TCC_COUNT) Counter Value Mask */
#define TCC_COUNT_DITH5_COUNT(value)          (TCC_COUNT_DITH5_COUNT_Msk & (_UINT32_(value) << TCC_COUNT_DITH5_COUNT_Pos))
#define TCC_COUNT_DITH5_Msk                   _UINT32_(0x0000FFE0)                                 /* (TCC_COUNT_DITH5) Register Mask  */

/* DITH6 mode */
#define TCC_COUNT_DITH6_COUNT_Pos             _UINT32_(6)                                          /* (TCC_COUNT) Counter Value Position */
#define TCC_COUNT_DITH6_COUNT_Msk             (_UINT32_(0x3FF) << TCC_COUNT_DITH6_COUNT_Pos)       /* (TCC_COUNT) Counter Value Mask */
#define TCC_COUNT_DITH6_COUNT(value)          (TCC_COUNT_DITH6_COUNT_Msk & (_UINT32_(value) << TCC_COUNT_DITH6_COUNT_Pos))
#define TCC_COUNT_DITH6_Msk                   _UINT32_(0x0000FFC0)                                 /* (TCC_COUNT_DITH6) Register Mask  */
...
#define TCC_WAVE_Msk                          _UINT32_(0x000303F7)                                 /* (TCC_WAVE) Register Mask  */

#define TCC_WAVE_CICCEN_Pos                   _UINT32_(8)                                          /* (TCC_WAVE Position) Circular Channel x Enable */
#define TCC_WAVE_CICCEN_Msk                   (_UINT32_(0x3) << TCC_WAVE_CICCEN_Pos)               /* (TCC_WAVE Mask) CICCEN */
...
#define TCC_WAVE_POL_Msk                      (_UINT32_(0x3) << TCC_WAVE_POL_Pos)                  /* (TCC_WAVE Mask) POL */
#define TCC_WAVE_POL(value)                   (TCC_WAVE_POL_Msk & (_UINT32_(value) << TCC_WAVE_POL_Pos)) 

/* -------- TCC_PER : (TCC Offset: 0x40) (R/W 32) Period -------- */
#define TCC_PER_RESETVALUE                    _UINT32_(0xFFFF)                                     /*  (TCC_PER) Period  Reset Value */
...
#define TCC_PER_DITH4_PER_Msk                 (_UINT32_(0xFFF) << TCC_PER_DITH4_PER_Pos)           /* (TCC_PER) Period Value Mask */
#define TCC_PER_DITH4_PER(value)              (TCC_PER_DITH4_PER_Msk & (_UINT32_(value) << TCC_PER_DITH4_PER_Pos))
#define TCC_PER_DITH4_Msk                     _UINT32_(0x0000FFFF)                                 /* (TCC_PER_DITH4) Register Mask  */
...
#define TCC_PER_DITH5_PER_Msk                 (_UINT32_(0x7FF) << TCC_PER_DITH5_PER_Pos)           /* (TCC_PER) Period Value Mask */
#define TCC_PER_DITH5_PER(value)              (TCC_PER_DITH5_PER_Msk & (_UINT32_(value) << TCC_PER_DITH5_PER_Pos))
#define TCC_PER_DITH5_Msk                     _UINT32_(0x0000FFFF)                                 /* (TCC_PER_DITH5) Register Mask  */
...
#define TCC_PER_DITH6_PER_Msk                 (_UINT32_(0x3FF) << TCC_PER_DITH6_PER_Pos)           /* (TCC_PER) Period Value Mask */
#define TCC_PER_DITH6_PER(value)              (TCC_PER_DITH6_PER_Msk & (_UINT32_(value) << TCC_PER_DITH6_PER_Pos))
#define TCC_PER_DITH6_Msk                     _UINT32_(0x0000FFFF)                                 /* (TCC_PER_DITH6) Register Mask  */
...
#define TCC_CC_CC_Msk                         (_UINT32_(0xFFFF) << TCC_CC_CC_Pos)                  /* (TCC_CC) Channel Compare/Capture Value Mask */
...
#define TCC_CC_DITH4_CC_Msk                   (_UINT32_(0xFFF) << TCC_CC_DITH4_CC_Pos)             /* (TCC_CC) Channel Compare/Capture Value Mask */
#define TCC_CC_DITH4_CC(value)                (TCC_CC_DITH4_CC_Msk & (_UINT32_(value) << TCC_CC_DITH4_CC_Pos))
#define TCC_CC_DITH4_Msk                      _UINT32_(0x0000FFFF)                                 /* (TCC_CC_DITH4) Register Mask  */
...
#define TCC_CC_DITH5_CC_Msk                   (_UINT32_(0x7FF) << TCC_CC_DITH5_CC_Pos)             /* (TCC_CC) Channel Compare/Capture Value Mask */
#define TCC_CC_DITH5_CC(value)                (TCC_CC_DITH5_CC_Msk & (_UINT32_(value) << TCC_CC_DITH5_CC_Pos))
#define TCC_CC_DITH5_Msk                      _UINT32_(0x0000FFFF)                                 /* (TCC_CC_DITH5) Register Mask  */
...
#define TCC_CC_DITH6_CC_Msk                   (_UINT32_(0x3FF) << TCC_CC_DITH6_CC_Pos)             /* (TCC_CC) Channel Compare/Capture Value Mask */
#define TCC_CC_DITH6_CC(value)                (TCC_CC_DITH6_CC_Msk & (_UINT32_(value) << TCC_CC_DITH6_CC_Pos))
#define TCC_CC_DITH6_Msk                      _UINT32_(0x0000FFFF)                                 /* (TCC_CC_DITH6) Register Mask  */


/* -------- TCC_PERBUF : (TCC Offset: 0x6C) (R/W 32) Period Buffer -------- */
#define TCC_PERBUF_RESETVALUE                 _UINT32_(0xFFFF)                                     /*  (TCC_PERBUF) Period Buffer  Reset Value */
...
#define TCC_PERBUF_DITH4_PERBUF_Msk           (_UINT32_(0xFFF) << TCC_PERBUF_DITH4_PERBUF_Pos)     /* (TCC_PERBUF) Period Buffer Value Mask */
#define TCC_PERBUF_DITH4_PERBUF(value)        (TCC_PERBUF_DITH4_PERBUF_Msk & (_UINT32_(value) << TCC_PERBUF_DITH4_PERBUF_Pos))
#define TCC_PERBUF_DITH4_Msk                  _UINT32_(0x0000FFFF)                                 /* (TCC_PERBUF_DITH4) Register Mask  */
...
#define TCC_PERBUF_DITH5_PERBUF_Msk           (_UINT32_(0x7FF) << TCC_PERBUF_DITH5_PERBUF_Pos)     /* (TCC_PERBUF) Period Buffer Value Mask */
#define TCC_PERBUF_DITH5_PERBUF(value)        (TCC_PERBUF_DITH5_PERBUF_Msk & (_UINT32_(value) << TCC_PERBUF_DITH5_PERBUF_Pos))
#define TCC_PERBUF_DITH5_Msk                  _UINT32_(0x0000FFFF)                                 /* (TCC_PERBUF_DITH5) Register Mask  */
...
#define TCC_PERBUF_DITH6_PERBUF_Msk           (_UINT32_(0x3FF) << TCC_PERBUF_DITH6_PERBUF_Pos)     /* (TCC_PERBUF) Period Buffer Value Mask */
#define TCC_PERBUF_DITH6_PERBUF(value)        (TCC_PERBUF_DITH6_PERBUF_Msk & (_UINT32_(value) << TCC_PERBUF_DITH6_PERBUF_Pos))
#define TCC_PERBUF_DITH6_Msk                  _UINT32_(0x0000FFFF)                                 /* (TCC_PERBUF_DITH6) Register Mask  */
...
#define TCC_CCBUF_CCBUF_Msk                   (_UINT32_(0xFFFF) << TCC_CCBUF_CCBUF_Pos)            /* (TCC_CCBUF) Channel Compare/Capture Buffer Value Mask */
...
#define TCC_CCBUF_DITH4_CCBUF_Msk             (_UINT32_(0xFFF) << TCC_CCBUF_DITH4_CCBUF_Pos)       /* (TCC_CCBUF) Dithering Buffer Cycle Number Mask */
#define TCC_CCBUF_DITH4_CCBUF(value)          (TCC_CCBUF_DITH4_CCBUF_Msk & (_UINT32_(value) << TCC_CCBUF_DITH4_CCBUF_Pos))
#define TCC_CCBUF_DITH4_Msk                   _UINT32_(0x0000FFFF)                                 /* (TCC_CCBUF_DITH4) Register Mask  */
...
#define TCC_CCBUF_DITH5_CCBUF_Msk             (_UINT32_(0x7FF) << TCC_CCBUF_DITH5_CCBUF_Pos)       /* (TCC_CCBUF) Channel Compare/Capture Buffer Value Mask */
#define TCC_CCBUF_DITH5_CCBUF(value)          (TCC_CCBUF_DITH5_CCBUF_Msk & (_UINT32_(value) << TCC_CCBUF_DITH5_CCBUF_Pos))
#define TCC_CCBUF_DITH5_Msk                   _UINT32_(0x0000FFFF)                                 /* (TCC_CCBUF_DITH5) Register Mask  */
...
#define TCC_CCBUF_DITH6_CCBUF_Msk             (_UINT32_(0x3FF) << TCC_CCBUF_DITH6_CCBUF_Pos)       /* (TCC_CCBUF) Channel Compare/Capture Buffer Value Mask */
#define TCC_CCBUF_DITH6_CCBUF(value)          (TCC_CCBUF_DITH6_CCBUF_Msk & (_UINT32_(value) << TCC_CCBUF_DITH6_CCBUF_Pos))
#define TCC_CCBUF_DITH6_Msk                   _UINT32_(0x0000FFFF)                                 /* (TCC_CCBUF_DITH6) Register Mask  */
...
{  /* Timer Counter for Control Applications */
  ...
  __IO  uint32_t                       TCC_CC[2];          /* Offset: 0x44 (R/W  32) Compare and Capture */
  __I   uint8_t                        Reserved6[0x20];
  __IO  uint32_t                       TCC_PERBUF;         /* Offset: 0x6C (R/W  32) Period Buffer */
  __IO  uint32_t                       TCC_CCBUF[2];       /* Offset: 0x70 (R/W  32) Compare and Capture Buffer */
} tcc_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CMGC00_TCC_COMPONENT_H_ */
