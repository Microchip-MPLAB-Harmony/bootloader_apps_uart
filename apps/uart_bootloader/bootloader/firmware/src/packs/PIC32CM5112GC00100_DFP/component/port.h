...
#ifndef _PIC32CMGC00_PORT_COMPONENT_H_
#define _PIC32CMGC00_PORT_COMPONENT_H_
...
#define PORT_INTENCLR_NSCHK(value)            (PORT_INTENCLR_NSCHK_Msk & (_UINT32_(value) << PORT_INTENCLR_NSCHK_Pos)) /* Assignment of value for NSCHK in the PORT_INTENCLR register */
...
#define PORT_INTENSET_NSCHK(value)            (PORT_INTENSET_NSCHK_Msk & (_UINT32_(value) << PORT_INTENSET_NSCHK_Pos)) /* Assignment of value for NSCHK in the PORT_INTENSET register */
...
#define PORT_INTFLAG_NSCHK(value)             (PORT_INTFLAG_NSCHK_Msk & (_UINT32_(value) << PORT_INTFLAG_NSCHK_Pos)) /* Assignment of value for NSCHK in the PORT_INTFLAG register */
...
#define PORT_NONSEC_NONSEC(value)             (PORT_NONSEC_NONSEC_Msk & (_UINT32_(value) << PORT_NONSEC_NONSEC_Pos)) /* Assignment of value for NONSEC in the PORT_NONSEC register */
...
#define PORT_NSCHK_NSCHK(value)               (PORT_NSCHK_NSCHK_Msk & (_UINT32_(value) << PORT_NSCHK_NSCHK_Pos)) /* Assignment of value for NSCHK in the PORT_NSCHK register */
...
#endif /* _PIC32CMGC00_PORT_COMPONENT_H_ */
