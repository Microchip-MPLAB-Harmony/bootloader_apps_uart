...
#ifndef _PIC32CMGC00_EVSYS_COMPONENT_H_
#define _PIC32CMGC00_EVSYS_COMPONENT_H_
...
#define EVSYS_READYUSR_RESETVALUE             _UINT32_(0xFFF)                                      /*  (EVSYS_READYUSR) Ready Users  Reset Value */
...
#define EVSYS_USER_CHANNEL(value)             (EVSYS_USER_CHANNEL_Msk & (_UINT8_(value) << EVSYS_USER_CHANNEL_Pos)) /* Assignment of value for CHANNEL in the EVSYS_USER register */
...
{  /* Event System Interface */
  ...
  __IO  uint8_t                        EVSYS_USER[62];     /* Offset: 0x120 (R/W  8) User Multiplexer n */
} evsys_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CMGC00_EVSYS_COMPONENT_H_ */
