...
#ifndef _PIC32CMGC00_ADC_COMPONENT_H_
#define _PIC32CMGC00_ADC_COMPONENT_H_
...
#define ADC_CORCTRL_SAMC(value)               (ADC_CORCTRL_SAMC_Msk & (_UINT32_(value) << ADC_CORCTRL_SAMC_Pos)) /* Assignment of value for SAMC in the ADC_CORCTRL register */
...
#define ADC_CORCTRL_SELRES(value)             (ADC_CORCTRL_SELRES_Msk & (_UINT32_(value) << ADC_CORCTRL_SELRES_Pos)) /* Assignment of value for SELRES in the ADC_CORCTRL register */
...
#define   ADC_CORCTRL_SELRES_12_BITS_Val      _UINT32_(0x3)                                        /* (ADC_CORCTRL) 12 bits (power-on default)  */
...
#define ADC_CORCTRL_SELRES_12_BITS            (ADC_CORCTRL_SELRES_12_BITS_Val << ADC_CORCTRL_SELRES_Pos) /* (ADC_CORCTRL) 12 bits (power-on default) Position */
...
#define ADC_CORCTRL_EIS(value)                (ADC_CORCTRL_EIS_Msk & (_UINT32_(value) << ADC_CORCTRL_EIS_Pos)) /* Assignment of value for EIS in the ADC_CORCTRL register */
...
#define ADC_CORCTRL_EIRQOVR(value)            (ADC_CORCTRL_EIRQOVR_Msk & (_UINT32_(value) << ADC_CORCTRL_EIRQOVR_Pos)) /* Assignment of value for EIRQOVR in the ADC_CORCTRL register */
...
#define ADC_CORCTRL_STRGSRC(value)            (ADC_CORCTRL_STRGSRC_Msk & (_UINT32_(value) << ADC_CORCTRL_STRGSRC_Pos)) /* Assignment of value for STRGSRC in the ADC_CORCTRL register */
...
#define   ADC_CORCTRL_STRGSRC_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CORCTRL) Synchronous Trigger (STRIG)  */
...
#define ADC_CORCTRL_STRGSRC_SYNC_TRIGGER      (ADC_CORCTRL_STRGSRC_SYNC_TRIGGER_Val << ADC_CORCTRL_STRGSRC_Pos) /* (ADC_CORCTRL) Synchronous Trigger (STRIG) Position */
...
#define ADC_CORCTRL_STRGLVL(value)            (ADC_CORCTRL_STRGLVL_Msk & (_UINT32_(value) << ADC_CORCTRL_STRGLVL_Pos)) /* Assignment of value for STRGLVL in the ADC_CORCTRL register */
...
#define ADC_CORCTRL_SCNRTDS(value)            (ADC_CORCTRL_SCNRTDS_Msk & (_UINT32_(value) << ADC_CORCTRL_SCNRTDS_Pos)) /* Assignment of value for SCNRTDS in the ADC_CORCTRL register */
...
#define ADC_CORCTRL_ADCDIV(value)             (ADC_CORCTRL_ADCDIV_Msk & (_UINT32_(value) << ADC_CORCTRL_ADCDIV_Pos)) /* Assignment of value for ADCDIV in the ADC_CORCTRL register */
...
#define ADC_CHNCFG1_CHNCMPEN(value)           (ADC_CHNCFG1_CHNCMPEN_Msk & (_UINT32_(value) << ADC_CHNCFG1_CHNCMPEN_Pos)) /* Assignment of value for CHNCMPEN in the ADC_CHNCFG1 register */
...
#define ADC_CHNCFG1_LVL(value)                (ADC_CHNCFG1_LVL_Msk & (_UINT32_(value) << ADC_CHNCFG1_LVL_Pos)) /* Assignment of value for LVL in the ADC_CHNCFG1 register */
...
#define ADC_CHNCFG2_CSS(value)                (ADC_CHNCFG2_CSS_Msk & (_UINT32_(value) << ADC_CHNCFG2_CSS_Pos)) /* Assignment of value for CSS in the ADC_CHNCFG2 register */
...
#define ADC_CHNCFG2_FRACT(value)              (ADC_CHNCFG2_FRACT_Msk & (_UINT32_(value) << ADC_CHNCFG2_FRACT_Pos)) /* Assignment of value for FRACT in the ADC_CHNCFG2 register */
...
#define ADC_CHNCFG3_DIFF(value)               (ADC_CHNCFG3_DIFF_Msk & (_UINT32_(value) << ADC_CHNCFG3_DIFF_Pos)) /* Assignment of value for DIFF in the ADC_CHNCFG3 register */
...
#define ADC_CHNCFG3_SIGN(value)               (ADC_CHNCFG3_SIGN_Msk & (_UINT32_(value) << ADC_CHNCFG3_SIGN_Pos)) /* Assignment of value for SIGN in the ADC_CHNCFG3 register */
...
#define ADC_CHNCFG4_TRGSRC0(value)            (ADC_CHNCFG4_TRGSRC0_Msk & (_UINT32_(value) << ADC_CHNCFG4_TRGSRC0_Pos)) /* Assignment of value for TRGSRC0 in the ADC_CHNCFG4 register */
...
#define   ADC_CHNCFG4_TRGSRC0_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG4) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG4_TRGSRC0_SYNC_TRIGGER      (ADC_CHNCFG4_TRGSRC0_SYNC_TRIGGER_Val << ADC_CHNCFG4_TRGSRC0_Pos) /* (ADC_CHNCFG4) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG4_TRGSRC1(value)            (ADC_CHNCFG4_TRGSRC1_Msk & (_UINT32_(value) << ADC_CHNCFG4_TRGSRC1_Pos)) /* Assignment of value for TRGSRC1 in the ADC_CHNCFG4 register */
...
#define   ADC_CHNCFG4_TRGSRC1_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG4) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG4_TRGSRC1_SYNC_TRIGGER      (ADC_CHNCFG4_TRGSRC1_SYNC_TRIGGER_Val << ADC_CHNCFG4_TRGSRC1_Pos) /* (ADC_CHNCFG4) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG4_TRGSRC2(value)            (ADC_CHNCFG4_TRGSRC2_Msk & (_UINT32_(value) << ADC_CHNCFG4_TRGSRC2_Pos)) /* Assignment of value for TRGSRC2 in the ADC_CHNCFG4 register */
...
#define   ADC_CHNCFG4_TRGSRC2_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG4) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG4_TRGSRC2_SYNC_TRIGGER      (ADC_CHNCFG4_TRGSRC2_SYNC_TRIGGER_Val << ADC_CHNCFG4_TRGSRC2_Pos) /* (ADC_CHNCFG4) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG4_TRGSRC3(value)            (ADC_CHNCFG4_TRGSRC3_Msk & (_UINT32_(value) << ADC_CHNCFG4_TRGSRC3_Pos)) /* Assignment of value for TRGSRC3 in the ADC_CHNCFG4 register */
...
#define   ADC_CHNCFG4_TRGSRC3_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG4) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG4_TRGSRC3_SYNC_TRIGGER      (ADC_CHNCFG4_TRGSRC3_SYNC_TRIGGER_Val << ADC_CHNCFG4_TRGSRC3_Pos) /* (ADC_CHNCFG4) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG4_TRGSRC4(value)            (ADC_CHNCFG4_TRGSRC4_Msk & (_UINT32_(value) << ADC_CHNCFG4_TRGSRC4_Pos)) /* Assignment of value for TRGSRC4 in the ADC_CHNCFG4 register */
...
#define   ADC_CHNCFG4_TRGSRC4_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG4) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG4_TRGSRC4_SYNC_TRIGGER      (ADC_CHNCFG4_TRGSRC4_SYNC_TRIGGER_Val << ADC_CHNCFG4_TRGSRC4_Pos) /* (ADC_CHNCFG4) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG4_TRGSRC5(value)            (ADC_CHNCFG4_TRGSRC5_Msk & (_UINT32_(value) << ADC_CHNCFG4_TRGSRC5_Pos)) /* Assignment of value for TRGSRC5 in the ADC_CHNCFG4 register */
...
#define   ADC_CHNCFG4_TRGSRC5_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG4) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG4_TRGSRC5_SYNC_TRIGGER      (ADC_CHNCFG4_TRGSRC5_SYNC_TRIGGER_Val << ADC_CHNCFG4_TRGSRC5_Pos) /* (ADC_CHNCFG4) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG4_TRGSRC6(value)            (ADC_CHNCFG4_TRGSRC6_Msk & (_UINT32_(value) << ADC_CHNCFG4_TRGSRC6_Pos)) /* Assignment of value for TRGSRC6 in the ADC_CHNCFG4 register */
...
#define   ADC_CHNCFG4_TRGSRC6_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG4) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG4_TRGSRC6_SYNC_TRIGGER      (ADC_CHNCFG4_TRGSRC6_SYNC_TRIGGER_Val << ADC_CHNCFG4_TRGSRC6_Pos) /* (ADC_CHNCFG4) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG4_TRGSRC7(value)            (ADC_CHNCFG4_TRGSRC7_Msk & (_UINT32_(value) << ADC_CHNCFG4_TRGSRC7_Pos)) /* Assignment of value for TRGSRC7 in the ADC_CHNCFG4 register */
...
#define   ADC_CHNCFG4_TRGSRC7_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG4) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG4_TRGSRC7_SYNC_TRIGGER      (ADC_CHNCFG4_TRGSRC7_SYNC_TRIGGER_Val << ADC_CHNCFG4_TRGSRC7_Pos) /* (ADC_CHNCFG4) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG5_TRGSRC8(value)            (ADC_CHNCFG5_TRGSRC8_Msk & (_UINT32_(value) << ADC_CHNCFG5_TRGSRC8_Pos)) /* Assignment of value for TRGSRC8 in the ADC_CHNCFG5 register */
...
#define   ADC_CHNCFG5_TRGSRC8_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG5) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG5_TRGSRC8_SYNC_TRIGGER      (ADC_CHNCFG5_TRGSRC8_SYNC_TRIGGER_Val << ADC_CHNCFG5_TRGSRC8_Pos) /* (ADC_CHNCFG5) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG5_TRGSRC9(value)            (ADC_CHNCFG5_TRGSRC9_Msk & (_UINT32_(value) << ADC_CHNCFG5_TRGSRC9_Pos)) /* Assignment of value for TRGSRC9 in the ADC_CHNCFG5 register */
...
#define   ADC_CHNCFG5_TRGSRC9_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG5) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG5_TRGSRC9_SYNC_TRIGGER      (ADC_CHNCFG5_TRGSRC9_SYNC_TRIGGER_Val << ADC_CHNCFG5_TRGSRC9_Pos) /* (ADC_CHNCFG5) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG5_TRGSRC10(value)           (ADC_CHNCFG5_TRGSRC10_Msk & (_UINT32_(value) << ADC_CHNCFG5_TRGSRC10_Pos)) /* Assignment of value for TRGSRC10 in the ADC_CHNCFG5 register */
...
#define   ADC_CHNCFG5_TRGSRC10_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG5) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG5_TRGSRC10_SYNC_TRIGGER     (ADC_CHNCFG5_TRGSRC10_SYNC_TRIGGER_Val << ADC_CHNCFG5_TRGSRC10_Pos) /* (ADC_CHNCFG5) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG5_TRGSRC11(value)           (ADC_CHNCFG5_TRGSRC11_Msk & (_UINT32_(value) << ADC_CHNCFG5_TRGSRC11_Pos)) /* Assignment of value for TRGSRC11 in the ADC_CHNCFG5 register */
...
#define   ADC_CHNCFG5_TRGSRC11_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG5) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG5_TRGSRC11_SYNC_TRIGGER     (ADC_CHNCFG5_TRGSRC11_SYNC_TRIGGER_Val << ADC_CHNCFG5_TRGSRC11_Pos) /* (ADC_CHNCFG5) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG5_TRGSRC12(value)           (ADC_CHNCFG5_TRGSRC12_Msk & (_UINT32_(value) << ADC_CHNCFG5_TRGSRC12_Pos)) /* Assignment of value for TRGSRC12 in the ADC_CHNCFG5 register */
...
#define   ADC_CHNCFG5_TRGSRC12_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG5) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG5_TRGSRC12_SYNC_TRIGGER     (ADC_CHNCFG5_TRGSRC12_SYNC_TRIGGER_Val << ADC_CHNCFG5_TRGSRC12_Pos) /* (ADC_CHNCFG5) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG5_TRGSRC13(value)           (ADC_CHNCFG5_TRGSRC13_Msk & (_UINT32_(value) << ADC_CHNCFG5_TRGSRC13_Pos)) /* Assignment of value for TRGSRC13 in the ADC_CHNCFG5 register */
...
#define   ADC_CHNCFG5_TRGSRC13_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG5) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG5_TRGSRC13_SYNC_TRIGGER     (ADC_CHNCFG5_TRGSRC13_SYNC_TRIGGER_Val << ADC_CHNCFG5_TRGSRC13_Pos) /* (ADC_CHNCFG5) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG5_TRGSRC14(value)           (ADC_CHNCFG5_TRGSRC14_Msk & (_UINT32_(value) << ADC_CHNCFG5_TRGSRC14_Pos)) /* Assignment of value for TRGSRC14 in the ADC_CHNCFG5 register */
...
#define   ADC_CHNCFG5_TRGSRC14_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG5) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG5_TRGSRC14_SYNC_TRIGGER     (ADC_CHNCFG5_TRGSRC14_SYNC_TRIGGER_Val << ADC_CHNCFG5_TRGSRC14_Pos) /* (ADC_CHNCFG5) Synchronous Trigger (STRIG) Position */
...
#define ADC_CHNCFG5_TRGSRC15(value)           (ADC_CHNCFG5_TRGSRC15_Msk & (_UINT32_(value) << ADC_CHNCFG5_TRGSRC15_Pos)) /* Assignment of value for TRGSRC15 in the ADC_CHNCFG5 register */
...
#define   ADC_CHNCFG5_TRGSRC15_SYNC_TRIGGER_Val _UINT32_(0x4)                                        /* (ADC_CHNCFG5) Synchronous Trigger (STRIG)  */
...
#define ADC_CHNCFG5_TRGSRC15_SYNC_TRIGGER     (ADC_CHNCFG5_TRGSRC15_SYNC_TRIGGER_Val << ADC_CHNCFG5_TRGSRC15_Pos) /* (ADC_CHNCFG5) Synchronous Trigger (STRIG) Position */
...
#define ADC_CALCTRL_CALBITS(value)            (ADC_CALCTRL_CALBITS_Msk & (_UINT32_(value) << ADC_CALCTRL_CALBITS_Pos)) /* Assignment of value for CALBITS in the ADC_CALCTRL register */
...
#define ADC_EVCTRL_CMPEO_Pos                  _UINT32_(5)                                          /* (ADC_EVCTRL) Comparator Window Event Out Position */
#define ADC_EVCTRL_CMPEO_Msk                  (_UINT32_(0x1) << ADC_EVCTRL_CMPEO_Pos)              /* (ADC_EVCTRL) Comparator Window Event Out Mask */
#define ADC_EVCTRL_CMPEO(value)               (ADC_EVCTRL_CMPEO_Msk & (_UINT32_(value) << ADC_EVCTRL_CMPEO_Pos)) /* Assignment of value for CMPEO in the ADC_EVCTRL register */
#define ADC_EVCTRL_Msk                        _UINT32_(0x00000039)                                 /* (ADC_EVCTRL) Register Mask  */
...
#define ADC_INTENCLR_CMPHIT(value)            (ADC_INTENCLR_CMPHIT_Msk & (_UINT32_(value) << ADC_INTENCLR_CMPHIT_Pos)) /* Assignment of value for CMPHIT in the ADC_INTENCLR register */
...
#define ADC_INTENCLR_SOVFL(value)             (ADC_INTENCLR_SOVFL_Msk & (_UINT32_(value) << ADC_INTENCLR_SOVFL_Pos)) /* Assignment of value for SOVFL in the ADC_INTENCLR register */
...
#define ADC_INTENCLR_CHRDYC(value)            (ADC_INTENCLR_CHRDYC_Msk & (_UINT32_(value) << ADC_INTENCLR_CHRDYC_Pos)) /* Assignment of value for CHRDYC in the ADC_INTENCLR register */
...
#define ADC_INTENCLR_FLTRDY(value)            (ADC_INTENCLR_FLTRDY_Msk & (_UINT32_(value) << ADC_INTENCLR_FLTRDY_Pos)) /* Assignment of value for FLTRDY in the ADC_INTENCLR register */
...
#define ADC_INTENCLR_CHNERRC(value)           (ADC_INTENCLR_CHNERRC_Msk & (_UINT32_(value) << ADC_INTENCLR_CHNERRC_Pos)) /* Assignment of value for CHNERRC in the ADC_INTENCLR register */
...
#define ADC_INTENCLR_EOSRDY(value)            (ADC_INTENCLR_EOSRDY_Msk & (_UINT32_(value) << ADC_INTENCLR_EOSRDY_Pos)) /* Assignment of value for EOSRDY in the ADC_INTENCLR register */
#define ADC_INTENCLR_CHRDY_Pos                _UINT32_(16)                                         /* (ADC_INTENCLR) Channel Ready Disable Position */
#define ADC_INTENCLR_CHRDY_Msk                (_UINT32_(0xFFFF) << ADC_INTENCLR_CHRDY_Pos)         /* (ADC_INTENCLR) Channel Ready Disable Mask */
#define ADC_INTENCLR_CHRDY(value)             (ADC_INTENCLR_CHRDY_Msk & (_UINT32_(value) << ADC_INTENCLR_CHRDY_Pos)) /* Assignment of value for CHRDY in the ADC_INTENCLR register */
#define ADC_INTENCLR_Msk                      _UINT32_(0xFFFF0F90)                                 /* (ADC_INTENCLR) Register Mask  */
...
#define ADC_INTENSET_CMPHIT(value)            (ADC_INTENSET_CMPHIT_Msk & (_UINT32_(value) << ADC_INTENSET_CMPHIT_Pos)) /* Assignment of value for CMPHIT in the ADC_INTENSET register */
...
#define ADC_INTENSET_SOVFL(value)             (ADC_INTENSET_SOVFL_Msk & (_UINT32_(value) << ADC_INTENSET_SOVFL_Pos)) /* Assignment of value for SOVFL in the ADC_INTENSET register */
...
#define ADC_INTENSET_CHRDYC(value)            (ADC_INTENSET_CHRDYC_Msk & (_UINT32_(value) << ADC_INTENSET_CHRDYC_Pos)) /* Assignment of value for CHRDYC in the ADC_INTENSET register */
...
#define ADC_INTENSET_FLTRDY(value)            (ADC_INTENSET_FLTRDY_Msk & (_UINT32_(value) << ADC_INTENSET_FLTRDY_Pos)) /* Assignment of value for FLTRDY in the ADC_INTENSET register */
...
#define ADC_INTENSET_CHNERRC(value)           (ADC_INTENSET_CHNERRC_Msk & (_UINT32_(value) << ADC_INTENSET_CHNERRC_Pos)) /* Assignment of value for CHNERRC in the ADC_INTENSET register */
...
#define ADC_INTENSET_EOSRDY(value)            (ADC_INTENSET_EOSRDY_Msk & (_UINT32_(value) << ADC_INTENSET_EOSRDY_Pos)) /* Assignment of value for EOSRDY in the ADC_INTENSET register */
...
#define ADC_INTENSET_CHRDY(value)             (ADC_INTENSET_CHRDY_Msk & (_UINT32_(value) << ADC_INTENSET_CHRDY_Pos)) /* Assignment of value for CHRDY in the ADC_INTENSET register */
...
#define ADC_INTFLAG_CMPINTID(value)           (ADC_INTFLAG_CMPINTID_Msk & (_UINT32_(value) << ADC_INTFLAG_CMPINTID_Pos)) /* Assignment of value for CMPINTID in the ADC_INTFLAG register */
...
#define ADC_INTFLAG_CMPHIT(value)             (ADC_INTFLAG_CMPHIT_Msk & (_UINT32_(value) << ADC_INTFLAG_CMPHIT_Pos)) /* Assignment of value for CMPHIT in the ADC_INTFLAG register */
...
#define ADC_INTFLAG_SOVFL(value)              (ADC_INTFLAG_SOVFL_Msk & (_UINT32_(value) << ADC_INTFLAG_SOVFL_Pos)) /* Assignment of value for SOVFL in the ADC_INTFLAG register */
...
#define ADC_INTFLAG_CHRDYC(value)             (ADC_INTFLAG_CHRDYC_Msk & (_UINT32_(value) << ADC_INTFLAG_CHRDYC_Pos)) /* Assignment of value for CHRDYC in the ADC_INTFLAG register */
...
#define ADC_INTFLAG_FLTRDY(value)             (ADC_INTFLAG_FLTRDY_Msk & (_UINT32_(value) << ADC_INTFLAG_FLTRDY_Pos)) /* Assignment of value for FLTRDY in the ADC_INTFLAG register */
...
#define ADC_INTFLAG_CHNERRC(value)            (ADC_INTFLAG_CHNERRC_Msk & (_UINT32_(value) << ADC_INTFLAG_CHNERRC_Pos)) /* Assignment of value for CHNERRC in the ADC_INTFLAG register */
...
#define ADC_INTFLAG_EOSRDY(value)             (ADC_INTFLAG_EOSRDY_Msk & (_UINT32_(value) << ADC_INTFLAG_EOSRDY_Pos)) /* Assignment of value for EOSRDY in the ADC_INTFLAG register */
...
#define ADC_INTFLAG_CRDYID(value)             (ADC_INTFLAG_CRDYID_Msk & (_UINT32_(value) << ADC_INTFLAG_CRDYID_Pos)) /* Assignment of value for CRDYID in the ADC_INTFLAG register */
...
#define ADC_INTFLAG_CHRDY(value)              (ADC_INTFLAG_CHRDY_Msk & (_UINT32_(value) << ADC_INTFLAG_CHRDY_Pos)) /* Assignment of value for CHRDY in the ADC_INTFLAG register */
...
#define ADC_CTRLA_ANAEN(value)                (ADC_CTRLA_ANAEN_Msk & (_UINT32_(value) << ADC_CTRLA_ANAEN_Pos)) /* Assignment of value for ANAEN in the ADC_CTRLA register */
...
#define ADC_CTRLA_AIPMPEN(value)              (ADC_CTRLA_AIPMPEN_Msk & (_UINT32_(value) << ADC_CTRLA_AIPMPEN_Pos)) /* Assignment of value for AIPMPEN in the ADC_CTRLA register */
...
#define ADC_CTRLB_ADCHSEL(value)              (ADC_CTRLB_ADCHSEL_Msk & (_UINT32_(value) << ADC_CTRLB_ADCHSEL_Pos)) /* Assignment of value for ADCHSEL in the ADC_CTRLB register */
...
#define ADC_CTRLB_ADCORSEL(value)             (ADC_CTRLB_ADCORSEL_Msk & (_UINT32_(value) << ADC_CTRLB_ADCORSEL_Pos)) /* Assignment of value for ADCORSEL in the ADC_CTRLB register */
...
#define ADC_CTRLB_RQCNVRT(value)              (ADC_CTRLB_RQCNVRT_Msk & (_UINT32_(value) << ADC_CTRLB_RQCNVRT_Pos)) /* Assignment of value for RQCNVRT in the ADC_CTRLB register */
...
#define ADC_CTRLB_SAMP(value)                 (ADC_CTRLB_SAMP_Msk & (_UINT32_(value) << ADC_CTRLB_SAMP_Pos)) /* Assignment of value for SAMP in the ADC_CTRLB register */
...
#define ADC_CTRLB_GSWTRG(value)               (ADC_CTRLB_GSWTRG_Msk & (_UINT32_(value) << ADC_CTRLB_GSWTRG_Pos)) /* Assignment of value for GSWTRG in the ADC_CTRLB register */
...
#define ADC_CTRLB_LSWTRG(value)               (ADC_CTRLB_LSWTRG_Msk & (_UINT32_(value) << ADC_CTRLB_LSWTRG_Pos)) /* Assignment of value for LSWTRG in the ADC_CTRLB register */
...
#define ADC_CTRLB_TRGSUSP(value)              (ADC_CTRLB_TRGSUSP_Msk & (_UINT32_(value) << ADC_CTRLB_TRGSUSP_Pos)) /* Assignment of value for TRGSUSP in the ADC_CTRLB register */
#define ADC_CTRLB_STRGEN_Pos                  _UINT32_(11)                                         /* (ADC_CTRLB) Synchronous Trigger Enable Position */
#define ADC_CTRLB_STRGEN_Msk                  (_UINT32_(0x1) << ADC_CTRLB_STRGEN_Pos)              /* (ADC_CTRLB) Synchronous Trigger Enable Mask */
#define ADC_CTRLB_STRGEN(value)               (ADC_CTRLB_STRGEN_Msk & (_UINT32_(value) << ADC_CTRLB_STRGEN_Pos)) /* Assignment of value for STRGEN in the ADC_CTRLB register */
...
#define ADC_CTRLB_SWCNVEN(value)              (ADC_CTRLB_SWCNVEN_Msk & (_UINT32_(value) << ADC_CTRLB_SWCNVEN_Pos)) /* Assignment of value for SWCNVEN in the ADC_CTRLB register */
#define ADC_CTRLB_Msk                         _UINT32_(0x00008FFF)                                 /* (ADC_CTRLB) Register Mask  */
...
#define ADC_CTRLC_CNT(value)                  (ADC_CTRLC_CNT_Msk & (_UINT32_(value) << ADC_CTRLC_CNT_Pos)) /* Assignment of value for CNT in the ADC_CTRLC register */
...
#define ADC_CTRLC_COREINTERLEAVED(value)      (ADC_CTRLC_COREINTERLEAVED_Msk & (_UINT32_(value) << ADC_CTRLC_COREINTERLEAVED_Pos)) /* Assignment of value for COREINTERLEAVED in the ADC_CTRLC register */
...
#define ADC_CTRLD_CTLCKDIV(value)             (ADC_CTRLD_CTLCKDIV_Msk & (_UINT32_(value) << ADC_CTRLD_CTLCKDIV_Pos)) /* Assignment of value for CTLCKDIV in the ADC_CTRLD register */
#define ADC_CTRLD_CHNEN0_Pos                  _UINT32_(16)                                         /* (ADC_CTRLD) Core 0 Digital Channel Enable Position */
#define ADC_CTRLD_CHNEN0_Msk                  (_UINT32_(0x1) << ADC_CTRLD_CHNEN0_Pos)              /* (ADC_CTRLD) Core 0 Digital Channel Enable Mask */
#define ADC_CTRLD_CHNEN0(value)               (ADC_CTRLD_CHNEN0_Msk & (_UINT32_(value) << ADC_CTRLD_CHNEN0_Pos)) /* Assignment of value for CHNEN0 in the ADC_CTRLD register */
#define ADC_CTRLD_ANLEN0_Pos                  _UINT32_(20)                                         /* (ADC_CTRLD) Analog and Bias circuitry Enable for core 0 Position */
#define ADC_CTRLD_ANLEN0_Msk                  (_UINT32_(0x1) << ADC_CTRLD_ANLEN0_Pos)              /* (ADC_CTRLD) Analog and Bias circuitry Enable for core 0 Mask */
#define ADC_CTRLD_ANLEN0(value)               (ADC_CTRLD_ANLEN0_Msk & (_UINT32_(value) << ADC_CTRLD_ANLEN0_Pos)) /* Assignment of value for ANLEN0 in the ADC_CTRLD register */
...
#define ADC_CTRLD_WKUPEXP(value)              (ADC_CTRLD_WKUPEXP_Msk & (_UINT32_(value) << ADC_CTRLD_WKUPEXP_Pos)) /* Assignment of value for WKUPEXP in the ADC_CTRLD register */
...
#define ADC_CTRLD_VREFSEL(value)              (ADC_CTRLD_VREFSEL_Msk & (_UINT32_(value) << ADC_CTRLD_VREFSEL_Pos)) /* Assignment of value for VREFSEL in the ADC_CTRLD register */
...
#define ADC_CTRLD_Msk                         _UINT32_(0x7F113F00)                                 /* (ADC_CTRLD) Register Mask  */

#define ADC_CTRLD_CHNEN_Pos                   _UINT32_(16)                                         /* (ADC_CTRLD Position) Core x Digital Channel Enable */
#define ADC_CTRLD_CHNEN_Msk                   (_UINT32_(0x1) << ADC_CTRLD_CHNEN_Pos)               /* (ADC_CTRLD Mask) CHNEN */
#define ADC_CTRLD_CHNEN(value)                (ADC_CTRLD_CHNEN_Msk & (_UINT32_(value) << ADC_CTRLD_CHNEN_Pos)) 
#define ADC_CTRLD_ANLEN_Pos                   _UINT32_(20)                                         /* (ADC_CTRLD Position) Analog and Bias circuitry Enable for core x */
#define ADC_CTRLD_ANLEN_Msk                   (_UINT32_(0x1) << ADC_CTRLD_ANLEN_Pos)               /* (ADC_CTRLD Mask) ANLEN */
#define ADC_CTRLD_ANLEN(value)                (ADC_CTRLD_ANLEN_Msk & (_UINT32_(value) << ADC_CTRLD_ANLEN_Pos)) 
...
#define ADC_CMPCTRL_ADCMPLO(value)            (ADC_CMPCTRL_ADCMPLO_Msk & (_UINT32_(value) << ADC_CMPCTRL_ADCMPLO_Pos)) /* Assignment of value for ADCMPLO in the ADC_CMPCTRL register */
...
#define ADC_CMPCTRL_CMPEN(value)              (ADC_CMPCTRL_CMPEN_Msk & (_UINT32_(value) << ADC_CMPCTRL_CMPEN_Pos)) /* Assignment of value for CMPEN in the ADC_CMPCTRL register */
...
#define ADC_CMPCTRL_IELOLO(value)             (ADC_CMPCTRL_IELOLO_Msk & (_UINT32_(value) << ADC_CMPCTRL_IELOLO_Pos)) /* Assignment of value for IELOLO in the ADC_CMPCTRL register */
...
#define ADC_CMPCTRL_IELOHI(value)             (ADC_CMPCTRL_IELOHI_Msk & (_UINT32_(value) << ADC_CMPCTRL_IELOHI_Pos)) /* Assignment of value for IELOHI in the ADC_CMPCTRL register */
...
#define ADC_CMPCTRL_IEBTWN(value)             (ADC_CMPCTRL_IEBTWN_Msk & (_UINT32_(value) << ADC_CMPCTRL_IEBTWN_Pos)) /* Assignment of value for IEBTWN in the ADC_CMPCTRL register */
...
#define ADC_CMPCTRL_ADCMPHI(value)            (ADC_CMPCTRL_ADCMPHI_Msk & (_UINT32_(value) << ADC_CMPCTRL_ADCMPHI_Pos)) /* Assignment of value for ADCMPHI in the ADC_CMPCTRL register */
...
#define ADC_CMPCTRL_IEHILO(value)             (ADC_CMPCTRL_IEHILO_Msk & (_UINT32_(value) << ADC_CMPCTRL_IEHILO_Pos)) /* Assignment of value for IEHILO in the ADC_CMPCTRL register */
...
#define ADC_CMPCTRL_IEHIHI(value)             (ADC_CMPCTRL_IEHIHI_Msk & (_UINT32_(value) << ADC_CMPCTRL_IEHIHI_Pos)) /* Assignment of value for IEHIHI in the ADC_CMPCTRL register */
...
#define ADC_FLTCTRL_OVRSAM(value)             (ADC_FLTCTRL_OVRSAM_Msk & (_UINT32_(value) << ADC_FLTCTRL_OVRSAM_Pos)) /* Assignment of value for OVRSAM in the ADC_FLTCTRL register */
...
#define ADC_FLTCTRL_FMODE(value)              (ADC_FLTCTRL_FMODE_Msk & (_UINT32_(value) << ADC_FLTCTRL_FMODE_Pos)) /* Assignment of value for FMODE in the ADC_FLTCTRL register */
...
#define ADC_FLTCTRL_DATA16EN(value)           (ADC_FLTCTRL_DATA16EN_Msk & (_UINT32_(value) << ADC_FLTCTRL_DATA16EN_Pos)) /* Assignment of value for DATA16EN in the ADC_FLTCTRL register */
...
#define ADC_FLTCTRL_FLTEN(value)              (ADC_FLTCTRL_FLTEN_Msk & (_UINT32_(value) << ADC_FLTCTRL_FLTEN_Pos)) /* Assignment of value for FLTEN in the ADC_FLTCTRL register */
...
#define ADC_FLTCTRL_FLTCHNID(value)           (ADC_FLTCTRL_FLTCHNID_Msk & (_UINT32_(value) << ADC_FLTCTRL_FLTCHNID_Pos)) /* Assignment of value for FLTCHNID in the ADC_FLTCTRL register */
...
#define ADC_CORCHDATAID_CHRDYID(value)        (ADC_CORCHDATAID_CHRDYID_Msk & (_UINT32_(value) << ADC_CORCHDATAID_CHRDYID_Pos)) /* Assignment of value for CHRDYID in the ADC_CORCHDATAID register */
...
#define ADC_CORCHDATAID_CORDYID(value)        (ADC_CORCHDATAID_CORDYID_Msk & (_UINT32_(value) << ADC_CORCHDATAID_CORDYID_Pos)) /* Assignment of value for CORDYID in the ADC_CORCHDATAID register */
...
#define ADC_CHRDYDAT_CHRDYDAT(value)          (ADC_CHRDYDAT_CHRDYDAT_Msk & (_UINT32_(value) << ADC_CHRDYDAT_CHRDYDAT_Pos)) /* Assignment of value for CHRDYDAT in the ADC_CHRDYDAT register */
...
#define ADC_CHRDYDAT_LVL(value)               (ADC_CHRDYDAT_LVL_Msk & (_UINT32_(value) << ADC_CHRDYDAT_LVL_Pos)) /* Assignment of value for LVL in the ADC_CHRDYDAT register */
...
#define ADC_CHRDYDAT_DIFF(value)              (ADC_CHRDYDAT_DIFF_Msk & (_UINT32_(value) << ADC_CHRDYDAT_DIFF_Pos)) /* Assignment of value for DIFF in the ADC_CHRDYDAT register */
...
#define ADC_CHRDYDAT_SIGN(value)              (ADC_CHRDYDAT_SIGN_Msk & (_UINT32_(value) << ADC_CHRDYDAT_SIGN_Pos)) /* Assignment of value for SIGN in the ADC_CHRDYDAT register */
...
#define ADC_CHRDYDAT_FRACT(value)             (ADC_CHRDYDAT_FRACT_Msk & (_UINT32_(value) << ADC_CHRDYDAT_FRACT_Pos)) /* Assignment of value for FRACT in the ADC_CHRDYDAT register */
...
#define ADC_PFFDATA_PFFDATA(value)            (ADC_PFFDATA_PFFDATA_Msk & (_UINT32_(value) << ADC_PFFDATA_PFFDATA_Pos)) /* Assignment of value for PFFDATA in the ADC_PFFDATA register */
...
#define ADC_PFFDATA_PFFCHNID(value)           (ADC_PFFDATA_PFFCHNID_Msk & (_UINT32_(value) << ADC_PFFDATA_PFFCHNID_Pos)) /* Assignment of value for PFFCHNID in the ADC_PFFDATA register */
...
#define ADC_PFFDATA_PFFCORID(value)           (ADC_PFFDATA_PFFCORID_Msk & (_UINT32_(value) << ADC_PFFDATA_PFFCORID_Pos)) /* Assignment of value for PFFCORID in the ADC_PFFDATA register */
...
#define ADC_PFFDATA_PFFSIGN(value)            (ADC_PFFDATA_PFFSIGN_Msk & (_UINT32_(value) << ADC_PFFDATA_PFFSIGN_Pos)) /* Assignment of value for PFFSIGN in the ADC_PFFDATA register */
...
#define ADC_PFFDATA_PFFFRACT(value)           (ADC_PFFDATA_PFFFRACT_Msk & (_UINT32_(value) << ADC_PFFDATA_PFFFRACT_Pos)) /* Assignment of value for PFFFRACT in the ADC_PFFDATA register */
...
#define ADC_PFFDATA_PFFCNT(value)             (ADC_PFFDATA_PFFCNT_Msk & (_UINT32_(value) << ADC_PFFDATA_PFFCNT_Pos)) /* Assignment of value for PFFCNT in the ADC_PFFDATA register */
...
#define ADC_DMABASE_DMABASE(value)            (ADC_DMABASE_DMABASE_Msk & (_UINT32_(value) << ADC_DMABASE_DMABASE_Pos)) /* Assignment of value for DMABASE in the ADC_DMABASE register */
...
#define ADC_DMACTRL_DMAEN(value)              (ADC_DMACTRL_DMAEN_Msk & (_UINT32_(value) << ADC_DMACTRL_DMAEN_Pos)) /* Assignment of value for DMAEN in the ADC_DMACTRL register */
#define ADC_DMACTRL_DMACR0_Pos                _UINT32_(4)                                          /* (ADC_DMACTRL) DMA CORE0 Enable Position */
#define ADC_DMACTRL_DMACR0_Msk                (_UINT32_(0x1) << ADC_DMACTRL_DMACR0_Pos)            /* (ADC_DMACTRL) DMA CORE0 Enable Mask */
#define ADC_DMACTRL_DMACR0(value)             (ADC_DMACTRL_DMACR0_Msk & (_UINT32_(value) << ADC_DMACTRL_DMACR0_Pos)) /* Assignment of value for DMACR0 in the ADC_DMACTRL register */
...
#define ADC_DMACTRL_DMABL(value)              (ADC_DMACTRL_DMABL_Msk & (_UINT32_(value) << ADC_DMACTRL_DMABL_Pos)) /* Assignment of value for DMABL in the ADC_DMACTRL register */
#define ADC_DMACTRL_Msk                       _UINT32_(0x00000712)                                 /* (ADC_DMACTRL) Register Mask  */

#define ADC_DMACTRL_DMACR_Pos                 _UINT32_(4)                                          /* (ADC_DMACTRL Position) DMA COREx Enable */
#define ADC_DMACTRL_DMACR_Msk                 (_UINT32_(0x1) << ADC_DMACTRL_DMACR_Pos)             /* (ADC_DMACTRL Mask) DMACR */
#define ADC_DMACTRL_DMACR(value)              (ADC_DMACTRL_DMACR_Msk & (_UINT32_(value) << ADC_DMACTRL_DMACR_Pos)) 
...
#define ADC_PFFCTRL_PFFEN(value)              (ADC_PFFCTRL_PFFEN_Msk & (_UINT32_(value) << ADC_PFFCTRL_PFFEN_Pos)) /* Assignment of value for PFFEN in the ADC_PFFCTRL register */
#define ADC_PFFCTRL_PFFCR0_Pos                _UINT32_(4)                                          /* (ADC_PFFCTRL) APB CORE 0 FIFO Enable Position */
#define ADC_PFFCTRL_PFFCR0_Msk                (_UINT32_(0x1) << ADC_PFFCTRL_PFFCR0_Pos)            /* (ADC_PFFCTRL) APB CORE 0 FIFO Enable Mask */
#define ADC_PFFCTRL_PFFCR0(value)             (ADC_PFFCTRL_PFFCR0_Msk & (_UINT32_(value) << ADC_PFFCTRL_PFFCR0_Pos)) /* Assignment of value for PFFCR0 in the ADC_PFFCTRL register */
...
#define ADC_PFFCTRL_PFFRDYDM(value)           (ADC_PFFCTRL_PFFRDYDM_Msk & (_UINT32_(value) << ADC_PFFCTRL_PFFRDYDM_Pos)) /* Assignment of value for PFFRDYDM in the ADC_PFFCTRL register */
...
#define ADC_PFFCTRL_Msk                       _UINT32_(0x00010012)                                 /* (ADC_PFFCTRL) Register Mask  */

#define ADC_PFFCTRL_PFFCR_Pos                 _UINT32_(4)                                          /* (ADC_PFFCTRL Position) APB CORE x FIFO Enable */
#define ADC_PFFCTRL_PFFCR_Msk                 (_UINT32_(0x1) << ADC_PFFCTRL_PFFCR_Pos)             /* (ADC_PFFCTRL Mask) PFFCR */
#define ADC_PFFCTRL_PFFCR(value)              (ADC_PFFCTRL_PFFCR_Msk & (_UINT32_(value) << ADC_PFFCTRL_PFFCR_Pos)) 
...
#define ADC_SYNCBUSY_SWRST_Pos                _UINT32_(0)                                          /* (ADC_SYNCBUSY) Software Reset Sync Busy Position */
#define ADC_SYNCBUSY_SWRST_Msk                (_UINT32_(0x1) << ADC_SYNCBUSY_SWRST_Pos)            /* (ADC_SYNCBUSY) Software Reset Sync Busy Mask */
#define ADC_SYNCBUSY_SWRST(value)             (ADC_SYNCBUSY_SWRST_Msk & (_UINT32_(value) << ADC_SYNCBUSY_SWRST_Pos)) /* Assignment of value for SWRST in the ADC_SYNCBUSY register */
#define ADC_SYNCBUSY_ENABLE_Pos               _UINT32_(1)                                          /* (ADC_SYNCBUSY) Enable bit Sync Busy Position */
#define ADC_SYNCBUSY_ENABLE_Msk               (_UINT32_(0x1) << ADC_SYNCBUSY_ENABLE_Pos)           /* (ADC_SYNCBUSY) Enable bit Sync Busy Mask */
#define ADC_SYNCBUSY_ENABLE(value)            (ADC_SYNCBUSY_ENABLE_Msk & (_UINT32_(value) << ADC_SYNCBUSY_ENABLE_Pos)) /* Assignment of value for ENABLE in the ADC_SYNCBUSY register */
...
#define ADC_SYNCBUSY_CTRLB(value)             (ADC_SYNCBUSY_CTRLB_Msk & (_UINT32_(value) << ADC_SYNCBUSY_CTRLB_Pos)) /* Assignment of value for CTRLB in the ADC_SYNCBUSY register */
...
#define ADC_DMAINTENCLR_RAF(value)            (ADC_DMAINTENCLR_RAF_Msk & (_UINT32_(value) << ADC_DMAINTENCLR_RAF_Pos)) /* Assignment of value for RAF in the ADC_DMAINTENCLR register */
...
#define ADC_DMAINTENCLR_RBF(value)            (ADC_DMAINTENCLR_RBF_Msk & (_UINT32_(value) << ADC_DMAINTENCLR_RBF_Pos)) /* Assignment of value for RBF in the ADC_DMAINTENCLR register */
...
#define ADC_DMAINTENCLR_SOVFL(value)          (ADC_DMAINTENCLR_SOVFL_Msk & (_UINT32_(value) << ADC_DMAINTENCLR_SOVFL_Pos)) /* Assignment of value for SOVFL in the ADC_DMAINTENCLR register */
...
#define ADC_DMAINTSET_RAF(value)              (ADC_DMAINTSET_RAF_Msk & (_UINT32_(value) << ADC_DMAINTSET_RAF_Pos)) /* Assignment of value for RAF in the ADC_DMAINTSET register */
...
#define ADC_DMAINTSET_RBF(value)              (ADC_DMAINTSET_RBF_Msk & (_UINT32_(value) << ADC_DMAINTSET_RBF_Pos)) /* Assignment of value for RBF in the ADC_DMAINTSET register */
...
#define ADC_DMAINTSET_SOVFL(value)            (ADC_DMAINTSET_SOVFL_Msk & (_UINT32_(value) << ADC_DMAINTSET_SOVFL_Pos)) /* Assignment of value for SOVFL in the ADC_DMAINTSET register */
...
#define ADC_DMAINTFLAG_RAF(value)             (ADC_DMAINTFLAG_RAF_Msk & (_UINT32_(value) << ADC_DMAINTFLAG_RAF_Pos)) /* Assignment of value for RAF in the ADC_DMAINTFLAG register */
...
#define ADC_DMAINTFLAG_RBF(value)             (ADC_DMAINTFLAG_RBF_Msk & (_UINT32_(value) << ADC_DMAINTFLAG_RBF_Pos)) /* Assignment of value for RBF in the ADC_DMAINTFLAG register */
...
#define ADC_DMAINTFLAG_EAF(value)             (ADC_DMAINTFLAG_EAF_Msk & (_UINT32_(value) << ADC_DMAINTFLAG_EAF_Pos)) /* Assignment of value for EAF in the ADC_DMAINTFLAG register */
...
#define ADC_DMAINTFLAG_EBF(value)             (ADC_DMAINTFLAG_EBF_Msk & (_UINT32_(value) << ADC_DMAINTFLAG_EBF_Pos)) /* Assignment of value for EBF in the ADC_DMAINTFLAG register */
...
#define ADC_DMAINTFLAG_SOVFL(value)           (ADC_DMAINTFLAG_SOVFL_Msk & (_UINT32_(value) << ADC_DMAINTFLAG_SOVFL_Pos)) /* Assignment of value for SOVFL in the ADC_DMAINTFLAG register */
...
#define ADC_DMAINTFLAG_DMAERR(value)          (ADC_DMAINTFLAG_DMAERR_Msk & (_UINT32_(value) << ADC_DMAINTFLAG_DMAERR_Pos)) /* Assignment of value for DMAERR in the ADC_DMAINTFLAG register */
...
#define ADC_CTLINTENSET_CRRDY0_Pos            _UINT32_(0)                                          /* (ADC_CTLINTENSET) Core 0 Ready Position */
#define ADC_CTLINTENSET_CRRDY0_Msk            (_UINT32_(0x1) << ADC_CTLINTENSET_CRRDY0_Pos)        /* (ADC_CTLINTENSET) Core 0 Ready Mask */
#define ADC_CTLINTENSET_CRRDY0(value)         (ADC_CTLINTENSET_CRRDY0_Msk & (_UINT32_(value) << ADC_CTLINTENSET_CRRDY0_Pos)) /* Assignment of value for CRRDY0 in the ADC_CTLINTENSET register */
...
#define ADC_CTLINTENSET_VREFUPD(value)        (ADC_CTLINTENSET_VREFUPD_Msk & (_UINT32_(value) << ADC_CTLINTENSET_VREFUPD_Pos)) /* Assignment of value for VREFUPD in the ADC_CTLINTENSET register */
...
#define ADC_CTLINTENSET_VREFRDY(value)        (ADC_CTLINTENSET_VREFRDY_Msk & (_UINT32_(value) << ADC_CTLINTENSET_VREFRDY_Pos)) /* Assignment of value for VREFRDY in the ADC_CTLINTENSET register */
...
#define ADC_CTLINTENSET_PFFUNF(value)         (ADC_CTLINTENSET_PFFUNF_Msk & (_UINT32_(value) << ADC_CTLINTENSET_PFFUNF_Pos)) /* Assignment of value for PFFUNF in the ADC_CTLINTENSET register */
...
#define ADC_CTLINTENSET_PFFOVF(value)         (ADC_CTLINTENSET_PFFOVF_Msk & (_UINT32_(value) << ADC_CTLINTENSET_PFFOVF_Pos)) /* Assignment of value for PFFOVF in the ADC_CTLINTENSET register */
...
#define ADC_CTLINTENSET_PFFRDY(value)         (ADC_CTLINTENSET_PFFRDY_Msk & (_UINT32_(value) << ADC_CTLINTENSET_PFFRDY_Pos)) /* Assignment of value for PFFRDY in the ADC_CTLINTENSET register */
...
#define ADC_CTLINTENSET_PFFHFUL(value)        (ADC_CTLINTENSET_PFFHFUL_Msk & (_UINT32_(value) << ADC_CTLINTENSET_PFFHFUL_Pos)) /* Assignment of value for PFFHFUL in the ADC_CTLINTENSET register */
#define ADC_CTLINTENSET_Msk                   _UINT32_(0x00000FC1)                                 /* (ADC_CTLINTENSET) Register Mask  */

#define ADC_CTLINTENSET_CRRDY_Pos             _UINT32_(0)                                          /* (ADC_CTLINTENSET Position) Core x Ready */
#define ADC_CTLINTENSET_CRRDY_Msk             (_UINT32_(0x1) << ADC_CTLINTENSET_CRRDY_Pos)         /* (ADC_CTLINTENSET Mask) CRRDY */
#define ADC_CTLINTENSET_CRRDY(value)          (ADC_CTLINTENSET_CRRDY_Msk & (_UINT32_(value) << ADC_CTLINTENSET_CRRDY_Pos)) 
...
#define ADC_CTLINTENCLR_CRRDY0_Pos            _UINT32_(0)                                          /* (ADC_CTLINTENCLR) Core Ready 0 Disable Position */
#define ADC_CTLINTENCLR_CRRDY0_Msk            (_UINT32_(0x1) << ADC_CTLINTENCLR_CRRDY0_Pos)        /* (ADC_CTLINTENCLR) Core Ready 0 Disable Mask */
#define ADC_CTLINTENCLR_CRRDY0(value)         (ADC_CTLINTENCLR_CRRDY0_Msk & (_UINT32_(value) << ADC_CTLINTENCLR_CRRDY0_Pos)) /* Assignment of value for CRRDY0 in the ADC_CTLINTENCLR register */
...
#define ADC_CTLINTENCLR_VREFUPD(value)        (ADC_CTLINTENCLR_VREFUPD_Msk & (_UINT32_(value) << ADC_CTLINTENCLR_VREFUPD_Pos)) /* Assignment of value for VREFUPD in the ADC_CTLINTENCLR register */
...
#define ADC_CTLINTENCLR_VREFRDY(value)        (ADC_CTLINTENCLR_VREFRDY_Msk & (_UINT32_(value) << ADC_CTLINTENCLR_VREFRDY_Pos)) /* Assignment of value for VREFRDY in the ADC_CTLINTENCLR register */
...
#define ADC_CTLINTENCLR_PFFUNF(value)         (ADC_CTLINTENCLR_PFFUNF_Msk & (_UINT32_(value) << ADC_CTLINTENCLR_PFFUNF_Pos)) /* Assignment of value for PFFUNF in the ADC_CTLINTENCLR register */
...
#define ADC_CTLINTENCLR_PFFOVF(value)         (ADC_CTLINTENCLR_PFFOVF_Msk & (_UINT32_(value) << ADC_CTLINTENCLR_PFFOVF_Pos)) /* Assignment of value for PFFOVF in the ADC_CTLINTENCLR register */
...
#define ADC_CTLINTENCLR_PFFRDY(value)         (ADC_CTLINTENCLR_PFFRDY_Msk & (_UINT32_(value) << ADC_CTLINTENCLR_PFFRDY_Pos)) /* Assignment of value for PFFRDY in the ADC_CTLINTENCLR register */
...
#define ADC_CTLINTENCLR_PFFHFUL(value)        (ADC_CTLINTENCLR_PFFHFUL_Msk & (_UINT32_(value) << ADC_CTLINTENCLR_PFFHFUL_Pos)) /* Assignment of value for PFFHFUL in the ADC_CTLINTENCLR register */
#define ADC_CTLINTENCLR_Msk                   _UINT32_(0x00000FC1)                                 /* (ADC_CTLINTENCLR) Register Mask  */

#define ADC_CTLINTENCLR_CRRDY_Pos             _UINT32_(0)                                          /* (ADC_CTLINTENCLR Position) Core Ready x Disable */
#define ADC_CTLINTENCLR_CRRDY_Msk             (_UINT32_(0x1) << ADC_CTLINTENCLR_CRRDY_Pos)         /* (ADC_CTLINTENCLR Mask) CRRDY */
#define ADC_CTLINTENCLR_CRRDY(value)          (ADC_CTLINTENCLR_CRRDY_Msk & (_UINT32_(value) << ADC_CTLINTENCLR_CRRDY_Pos)) 
...
#define ADC_CTLINTFLAG_CRRDY(value)           (ADC_CTLINTFLAG_CRRDY_Msk & (_UINT32_(value) << ADC_CTLINTFLAG_CRRDY_Pos)) /* Assignment of value for CRRDY in the ADC_CTLINTFLAG register */
...
#define ADC_CTLINTFLAG_VREFUPD(value)         (ADC_CTLINTFLAG_VREFUPD_Msk & (_UINT32_(value) << ADC_CTLINTFLAG_VREFUPD_Pos)) /* Assignment of value for VREFUPD in the ADC_CTLINTFLAG register */
...
#define ADC_CTLINTFLAG_VREFRDY(value)         (ADC_CTLINTFLAG_VREFRDY_Msk & (_UINT32_(value) << ADC_CTLINTFLAG_VREFRDY_Pos)) /* Assignment of value for VREFRDY in the ADC_CTLINTFLAG register */
...
#define ADC_CTLINTFLAG_PFFUNF(value)          (ADC_CTLINTFLAG_PFFUNF_Msk & (_UINT32_(value) << ADC_CTLINTFLAG_PFFUNF_Pos)) /* Assignment of value for PFFUNF in the ADC_CTLINTFLAG register */
...
#define ADC_CTLINTFLAG_PFFOVF(value)          (ADC_CTLINTFLAG_PFFOVF_Msk & (_UINT32_(value) << ADC_CTLINTFLAG_PFFOVF_Pos)) /* Assignment of value for PFFOVF in the ADC_CTLINTFLAG register */
...
#define ADC_CTLINTFLAG_PFFRDY(value)          (ADC_CTLINTFLAG_PFFRDY_Msk & (_UINT32_(value) << ADC_CTLINTFLAG_PFFRDY_Pos)) /* Assignment of value for PFFRDY in the ADC_CTLINTFLAG register */
...
#define ADC_CTLINTFLAG_PFFHFUL(value)         (ADC_CTLINTFLAG_PFFHFUL_Msk & (_UINT32_(value) << ADC_CTLINTFLAG_PFFHFUL_Pos)) /* Assignment of value for PFFHFUL in the ADC_CTLINTFLAG register */
...
#define ADC_CONFIG_NUMBER 1

#define ADC_INT_NUMBER 1
...
{  /* ADC Controller */
  ...
  __I   uint8_t                        Reserved3[0x70];
  __IO  uint32_t                       ADC_CMPCTRL;        /* Offset: 0xB0 (R/W  32) Comparator Control */
  __I   uint8_t                        Reserved4[0x0C];
  __IO  uint32_t                       ADC_FLTCTRL;        /* Offset: 0xC0 (R/W  32) Filter Control */
...
#endif /* _PIC32CMGC00_ADC_COMPONENT_H_ */
