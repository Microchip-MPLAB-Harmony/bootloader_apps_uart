...
#ifndef _PIC32CMGC00_AC_INSTANCE_
#define _PIC32CMGC00_AC_INSTANCE_
...
#define AC_BRIDGE_ID                             (1)        /* H2PB Bridge ID */
#define AC_DACVALUE_BIT                          (7)        /* Defines the number of bits in DACCTRLn.VALUE */
#define AC_GCLK_ID                               (34)       
#define AC_INSTANCE_ID                           (40)       /* Instance index for AC */
...
#define AC_MCLK_ID_APB                           (50)       /* Index for AC APB clock */
#define AC_NUM_CMP                               (2)        /* Number of comparators */
#define AC_PAC_ID                                (40)       /* Index for AC registers write protection */
#define AC_PAIRS                                 (1)        /* Defines the number of AC pairs */
#define AC_PERIPH_ID                             (21)       /* H2PB Peripheral ID */

#endif /* _PIC32CMGC00_AC_INSTANCE_ */
