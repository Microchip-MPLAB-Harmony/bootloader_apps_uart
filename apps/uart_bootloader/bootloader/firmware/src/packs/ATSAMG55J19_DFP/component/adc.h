...
#define   ADC_MR_TRGEN_EN_Val                 _UINT32_(0x1)                                        /* (ADC_MR) Hardware trigger selected by TRGSEL field is enabled.  */
...
#define   ADC_MR_TRGSEL_ADC_TRIG0_Val         _UINT32_(0x0)                                        /* (ADC_MR) ADTRG External trigger  */
#define   ADC_MR_TRGSEL_ADC_TRIG1_Val         _UINT32_(0x1)                                        /* (ADC_MR) TIOA0 Output of the Timer Counter Channel 0  */
#define   ADC_MR_TRGSEL_ADC_TRIG2_Val         _UINT32_(0x2)                                        /* (ADC_MR) TIOA1 Output of the Timer Counter Channel 1  */
#define   ADC_MR_TRGSEL_ADC_TRIG3_Val         _UINT32_(0x3)                                        /* (ADC_MR) TIOA2 Output of the Timer Counter Channel 2  */
#define   ADC_MR_TRGSEL_ADC_TRIG4_Val         _UINT32_(0x4)                                        /* (ADC_MR) RTCOUT0  */
#define   ADC_MR_TRGSEL_ADC_TRIG5_Val         _UINT32_(0x5)                                        /* (ADC_MR) RTT 16-Bit prescaler output  */
#define   ADC_MR_TRGSEL_ADC_TRIG6_Val         _UINT32_(0x6)                                        /* (ADC_MR) RTTEVENT  */
#define   ADC_MR_TRGSEL_ADC_TRIG7_Val         _UINT32_(0x7)                                        /* (ADC_MR) -  */
...
#define   ADC_MR_SLEEP_SLEEP_Val              _UINT32_(0x1)                                        /* (ADC_MR) Sleep Mode: The wake-up time can be modified by programming FWUP bit.  */
...
#define ADC_MR_FREERUN_Pos                    _UINT32_(7)                                          /* (ADC_MR) Free Run Mode Position */
#define ADC_MR_FREERUN_Msk                    (_UINT32_(0x1) << ADC_MR_FREERUN_Pos)                /* (ADC_MR) Free Run Mode Mask */
...
#define ADC_MR_SETTLING_Pos                   _UINT32_(20)                                         /* (ADC_MR) Analog Settling Time Position */
#define ADC_MR_SETTLING_Msk                   (_UINT32_(0x3) << ADC_MR_SETTLING_Pos)               /* (ADC_MR) Analog Settling Time Mask */
...
#define   ADC_MR_ANACH_NONE_Val               _UINT32_(0x0)                                        /* (ADC_MR) No analog change on channel switching: DIFF0, and OFF0 are used for all channels.  */
#define   ADC_MR_ANACH_ALLOWED_Val            _UINT32_(0x1)                                        /* (ADC_MR) Allows different analog settings for each channel. See ADC_COR registers.  */
...
#define ADC_MR_TRANSFER_Pos                   _UINT32_(28)                                         /* (ADC_MR) Transfer Period Position */
#define ADC_MR_TRANSFER_Msk                   (_UINT32_(0x3) << ADC_MR_TRANSFER_Pos)               /* (ADC_MR) Transfer Period Mask */
...
#define   ADC_MR_USEQ_REG_ORDER_Val           _UINT32_(0x1)                                        /* (ADC_MR) User Sequence Mode: The sequence respects what is defined in ADC_SEQR1 register and can be used to convert the same channel several times.  */
...
#define ADC_MR_Msk                            _UINT32_(0xBFBFFFEF)                                 /* (ADC_MR) Register Mask  */
...
#define ADC_SEQR1_Msk                         _UINT32_(0x0FFFFFFF)                                 /* (ADC_SEQR1) Register Mask  */
...
#define ADC_IER_ENDRX_Pos                     _UINT32_(27)                                         /* (ADC_IER) End of Receive Buffer Interrupt Enable Position */
#define ADC_IER_ENDRX_Msk                     (_UINT32_(0x1) << ADC_IER_ENDRX_Pos)                 /* (ADC_IER) End of Receive Buffer Interrupt Enable Mask */
...
#define ADC_IER_Msk                           _UINT32_(0x1F0800FF)                                 /* (ADC_IER) Register Mask  */
...
#define ADC_IDR_ENDRX_Pos                     _UINT32_(27)                                         /* (ADC_IDR) End of Receive Buffer Interrupt Disable Position */
#define ADC_IDR_ENDRX_Msk                     (_UINT32_(0x1) << ADC_IDR_ENDRX_Pos)                 /* (ADC_IDR) End of Receive Buffer Interrupt Disable Mask */
...
#define ADC_IDR_Msk                           _UINT32_(0x1F0800FF)                                 /* (ADC_IDR) Register Mask  */
...
#define ADC_IMR_LCCHG_Pos                     _UINT32_(19)                                         /* (ADC_IMR) Last Channel Change Interrupt Mask Position */
#define ADC_IMR_LCCHG_Msk                     (_UINT32_(0x1) << ADC_IMR_LCCHG_Pos)                 /* (ADC_IMR) Last Channel Change Interrupt Mask Mask */
...
#define ADC_IMR_ENDRX_Pos                     _UINT32_(27)                                         /* (ADC_IMR) End of Receive Buffer Interrupt Mask Position */
#define ADC_IMR_ENDRX_Msk                     (_UINT32_(0x1) << ADC_IMR_ENDRX_Pos)                 /* (ADC_IMR) End of Receive Buffer Interrupt Mask Mask */
...
#define ADC_IMR_Msk                           _UINT32_(0x1F0800FF)                                 /* (ADC_IMR) Register Mask  */
...
#define ADC_ISR_Msk                           _UINT32_(0x1F0800FF)                                 /* (ADC_ISR) Register Mask  */
...
#define   ADC_LCTMR_CMPMOD_LOW_Val            _UINT32_(0x0)                                        /* (ADC_LCTMR) Generates an event when the converted data is lower than the low threshold of the window.  */
#define   ADC_LCTMR_CMPMOD_HIGH_Val           _UINT32_(0x1)                                        /* (ADC_LCTMR) Generates an event when the converted data is higher than the high threshold of the window.  */
#define   ADC_LCTMR_CMPMOD_IN_Val             _UINT32_(0x2)                                        /* (ADC_LCTMR) Generates an event when the converted data is in the comparison window.  */
#define   ADC_LCTMR_CMPMOD_OUT_Val            _UINT32_(0x3)                                        /* (ADC_LCTMR) Generates an event when the converted data is out of the comparison window.  */
...
#define   ADC_EMR_CMPMODE_LOW_Val             _UINT32_(0x0)                                        /* (ADC_EMR) Generates an event when the converted data is lower than the low threshold of the window.  */
#define   ADC_EMR_CMPMODE_HIGH_Val            _UINT32_(0x1)                                        /* (ADC_EMR) Generates an event when the converted data is higher than the high threshold of the window.  */
#define   ADC_EMR_CMPMODE_IN_Val              _UINT32_(0x2)                                        /* (ADC_EMR) Generates an event when the converted data is in the comparison window.  */
#define   ADC_EMR_CMPMODE_OUT_Val             _UINT32_(0x3)                                        /* (ADC_EMR) Generates an event when the converted data is out of the comparison window.  */
...
#define   ADC_EMR_SRCCLK_PMC_PCK_Val          _UINT32_(0x1)                                        /* (ADC_EMR) PMC PCKx is the source clock for the ADC prescaler, thus the ADC clock can be independent of the core/peripheral clock.  */
...
#define ADC_EMR_TAG_Pos                       _UINT32_(24)                                         /* (ADC_EMR) Tag of the ADC_LCDR Position */
#define ADC_EMR_TAG_Msk                       (_UINT32_(0x1) << ADC_EMR_TAG_Pos)                   /* (ADC_EMR) Tag of the ADC_LCDR Mask */
...
#define ADC_EMR_Msk                           _UINT32_(0x013732F7)                                 /* (ADC_EMR) Register Mask  */
...
#define ADC_COR_OFF0_Pos                      _UINT32_(0)                                          /* (ADC_COR) Offset for Channel 0 Position */
#define ADC_COR_OFF0_Msk                      (_UINT32_(0x1) << ADC_COR_OFF0_Pos)                  /* (ADC_COR) Offset for Channel 0 Mask */
#define ADC_COR_OFF0(value)                   (ADC_COR_OFF0_Msk & (_UINT32_(value) << ADC_COR_OFF0_Pos)) /* Assigment of value for OFF0 in the ADC_COR register */
#define ADC_COR_OFF1_Pos                      _UINT32_(1)                                          /* (ADC_COR) Offset for Channel 1 Position */
#define ADC_COR_OFF1_Msk                      (_UINT32_(0x1) << ADC_COR_OFF1_Pos)                  /* (ADC_COR) Offset for Channel 1 Mask */
#define ADC_COR_OFF1(value)                   (ADC_COR_OFF1_Msk & (_UINT32_(value) << ADC_COR_OFF1_Pos)) /* Assigment of value for OFF1 in the ADC_COR register */
#define ADC_COR_OFF2_Pos                      _UINT32_(2)                                          /* (ADC_COR) Offset for Channel 2 Position */
#define ADC_COR_OFF2_Msk                      (_UINT32_(0x1) << ADC_COR_OFF2_Pos)                  /* (ADC_COR) Offset for Channel 2 Mask */
#define ADC_COR_OFF2(value)                   (ADC_COR_OFF2_Msk & (_UINT32_(value) << ADC_COR_OFF2_Pos)) /* Assigment of value for OFF2 in the ADC_COR register */
#define ADC_COR_OFF3_Pos                      _UINT32_(3)                                          /* (ADC_COR) Offset for Channel 3 Position */
#define ADC_COR_OFF3_Msk                      (_UINT32_(0x1) << ADC_COR_OFF3_Pos)                  /* (ADC_COR) Offset for Channel 3 Mask */
#define ADC_COR_OFF3(value)                   (ADC_COR_OFF3_Msk & (_UINT32_(value) << ADC_COR_OFF3_Pos)) /* Assigment of value for OFF3 in the ADC_COR register */
#define ADC_COR_OFF4_Pos                      _UINT32_(4)                                          /* (ADC_COR) Offset for Channel 4 Position */
#define ADC_COR_OFF4_Msk                      (_UINT32_(0x1) << ADC_COR_OFF4_Pos)                  /* (ADC_COR) Offset for Channel 4 Mask */
#define ADC_COR_OFF4(value)                   (ADC_COR_OFF4_Msk & (_UINT32_(value) << ADC_COR_OFF4_Pos)) /* Assigment of value for OFF4 in the ADC_COR register */
#define ADC_COR_OFF5_Pos                      _UINT32_(5)                                          /* (ADC_COR) Offset for Channel 5 Position */
#define ADC_COR_OFF5_Msk                      (_UINT32_(0x1) << ADC_COR_OFF5_Pos)                  /* (ADC_COR) Offset for Channel 5 Mask */
#define ADC_COR_OFF5(value)                   (ADC_COR_OFF5_Msk & (_UINT32_(value) << ADC_COR_OFF5_Pos)) /* Assigment of value for OFF5 in the ADC_COR register */
#define ADC_COR_OFF6_Pos                      _UINT32_(6)                                          /* (ADC_COR) Offset for Channel 6 Position */
#define ADC_COR_OFF6_Msk                      (_UINT32_(0x1) << ADC_COR_OFF6_Pos)                  /* (ADC_COR) Offset for Channel 6 Mask */
#define ADC_COR_OFF6(value)                   (ADC_COR_OFF6_Msk & (_UINT32_(value) << ADC_COR_OFF6_Pos)) /* Assigment of value for OFF6 in the ADC_COR register */
#define ADC_COR_OFF7_Pos                      _UINT32_(7)                                          /* (ADC_COR) Offset for Channel 7 Position */
#define ADC_COR_OFF7_Msk                      (_UINT32_(0x1) << ADC_COR_OFF7_Pos)                  /* (ADC_COR) Offset for Channel 7 Mask */
#define ADC_COR_OFF7(value)                   (ADC_COR_OFF7_Msk & (_UINT32_(value) << ADC_COR_OFF7_Pos)) /* Assigment of value for OFF7 in the ADC_COR register */
...
#define ADC_COR_Msk                           _UINT32_(0x00FF00FF)                                 /* (ADC_COR) Register Mask  */

#define ADC_COR_OFF_Pos                       _UINT32_(0)                                          /* (ADC_COR Position) Offset for Channel x */
#define ADC_COR_OFF_Msk                       (_UINT32_(0xFF) << ADC_COR_OFF_Pos)                  /* (ADC_COR Mask) OFF */
#define ADC_COR_OFF(value)                    (ADC_COR_OFF_Msk & (_UINT32_(value) << ADC_COR_OFF_Pos)) 
#define ADC_COR_DIFF_Pos                      _UINT32_(16)                                         /* (ADC_COR Position) Differential Inputs for Channel 7 */
#define ADC_COR_DIFF_Msk                      (_UINT32_(0xFF) << ADC_COR_DIFF_Pos)                 /* (ADC_COR Mask) DIFF */
...
#define ADC_ACR_AUTOTEST_Pos                  _UINT32_(30)                                         /* (ADC_ACR) ADC Auto-test modes Position */
#define ADC_ACR_AUTOTEST_Msk                  (_UINT32_(0x3) << ADC_ACR_AUTOTEST_Pos)              /* (ADC_ACR) ADC Auto-test modes Mask */
#define ADC_ACR_AUTOTEST(value)               (ADC_ACR_AUTOTEST_Msk & (_UINT32_(value) << ADC_ACR_AUTOTEST_Pos)) /* Assigment of value for AUTOTEST in the ADC_ACR register */
#define   ADC_ACR_AUTOTEST_NO_AUTOTEST_Val    _UINT32_(0x0)                                        /* (ADC_ACR) No auto test, normal mode of operation  */
#define   ADC_ACR_AUTOTEST_OFFSET_ERROR_Val   _UINT32_(0x1)                                        /* (ADC_ACR) Offset Error test (refer to ADC cell datasheet)  */
#define   ADC_ACR_AUTOTEST_GAIN_ERROR_HIGH_Val _UINT32_(0x2)                                        /* (ADC_ACR) Gain Error (high code) test (refer to ADC cell datasheet)  */
#define   ADC_ACR_AUTOTEST_GAIN_ERROR_LOW_Val _UINT32_(0x3)                                        /* (ADC_ACR) Gain Error (low code) test (refer to ADC cell datasheet)  */
...
#define ADC_ACR_Msk                           _UINT32_(0xC0000000)                                 /* (ADC_ACR) Register Mask  */
...
#define ADC_CDR_REG_OFST               _UINT32_(0x50)      /* (ADC_CDR) Channel Data Register 0 Offset */
#define ADC_CDR0_REG_OFST              _UINT32_(0x50)      /* (ADC_CDR0) Channel Data Register 0 Offset */
#define ADC_CDR1_REG_OFST              _UINT32_(0x54)      /* (ADC_CDR1) Channel Data Register 0 Offset */
#define ADC_CDR2_REG_OFST              _UINT32_(0x58)      /* (ADC_CDR2) Channel Data Register 0 Offset */
#define ADC_CDR3_REG_OFST              _UINT32_(0x5C)      /* (ADC_CDR3) Channel Data Register 0 Offset */
#define ADC_CDR4_REG_OFST              _UINT32_(0x60)      /* (ADC_CDR4) Channel Data Register 0 Offset */
#define ADC_CDR5_REG_OFST              _UINT32_(0x64)      /* (ADC_CDR5) Channel Data Register 0 Offset */
#define ADC_CDR6_REG_OFST              _UINT32_(0x68)      /* (ADC_CDR6) Channel Data Register 0 Offset */
#define ADC_CDR7_REG_OFST              _UINT32_(0x6C)      /* (ADC_CDR7) Channel Data Register 0 Offset */
