...
#define   MEM2MEM_MR_TSIZE_T_8BIT_Val         _UINT32_(0x0)                                        /* (MEM2MEM_MR) The buffer size is defined in byte.  */
#define   MEM2MEM_MR_TSIZE_T_16BIT_Val        _UINT32_(0x1)                                        /* (MEM2MEM_MR) The buffer size is defined in half-word (16-bit).  */
#define   MEM2MEM_MR_TSIZE_T_32BIT_Val        _UINT32_(0x2)                                        /* (MEM2MEM_MR) The buffer size is defined in word (32-bit). Default value.  */
...
#define MEM2MEM_THR_REG_OFST           _UINT32_(0x00)      /* (MEM2MEM_THR) Memory to Memory Transfer Holding Register Offset */
#define MEM2MEM_MR_REG_OFST            _UINT32_(0x04)      /* (MEM2MEM_MR) Memory to Memory Mode Register Offset */
#define MEM2MEM_IER_REG_OFST           _UINT32_(0x08)      /* (MEM2MEM_IER) Memory to Memory Interrupt Enable Register Offset */
#define MEM2MEM_IDR_REG_OFST           _UINT32_(0x0C)      /* (MEM2MEM_IDR) Memory to Memory Interrupt Disable Register Offset */
#define MEM2MEM_IMR_REG_OFST           _UINT32_(0x10)      /* (MEM2MEM_IMR) Memory to Memory Interrupt Mask Register Offset */
#define MEM2MEM_ISR_REG_OFST           _UINT32_(0x14)      /* (MEM2MEM_ISR) Memory to Memory Interrupt Status Register Offset */
