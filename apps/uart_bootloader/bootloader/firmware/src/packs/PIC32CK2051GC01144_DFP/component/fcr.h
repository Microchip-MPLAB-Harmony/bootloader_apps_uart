...
#ifndef _PIC32CKGC01_FCR_COMPONENT_H_
#define _PIC32CKGC01_FCR_COMPONENT_H_
...
#define FCR_CTRLA_RESETVALUE                  _UINT32_(0x8000)                                     /*  (FCR_CTRLA) Control A Register  Reset Value */
...
#define FCR_CTRLA_ARB(value)                  (FCR_CTRLA_ARB_Msk & (_UINT32_(value) << FCR_CTRLA_ARB_Pos)) /* Assignment of value for ARB in the FCR_CTRLA register */
...
#define FCR_CTRLB_TEMP(value)                 (FCR_CTRLB_TEMP_Msk & (_UINT32_(value) << FCR_CTRLB_TEMP_Pos)) /* Assignment of value for TEMP in the FCR_CTRLB register */
...
#define FCR_INTENCLR_DERR(value)              (FCR_INTENCLR_DERR_Msk & (_UINT32_(value) << FCR_INTENCLR_DERR_Pos)) /* Assignment of value for DERR in the FCR_INTENCLR register */
...
#define FCR_INTENSET_DERR(value)              (FCR_INTENSET_DERR_Msk & (_UINT32_(value) << FCR_INTENSET_DERR_Pos)) /* Assignment of value for DERR in the FCR_INTENSET register */
...
#define FCR_INTFLAG_DERR(value)               (FCR_INTFLAG_DERR_Msk & (_UINT32_(value) << FCR_INTFLAG_DERR_Pos)) /* Assignment of value for DERR in the FCR_INTFLAG register */
...
#define FCR_STATUS_RESETVALUE                 _UINT32_(0x00)                                       /*  (FCR_STATUS) NVM Status Register  Reset Value */
...
#define FCR_STATUS_TEMP(value)                (FCR_STATUS_TEMP_Msk & (_UINT32_(value) << FCR_STATUS_TEMP_Pos)) /* Assignment of value for TEMP in the FCR_STATUS register */
...
#define FCR_CRCCTRL_PLEN32(value)             (FCR_CRCCTRL_PLEN32_Msk & (_UINT32_(value) << FCR_CRCCTRL_PLEN32_Pos)) /* Assignment of value for PLEN32 in the FCR_CRCCTRL register */
...
#define FCR_CRCCTRL_AUTOR(value)              (FCR_CRCCTRL_AUTOR_Msk & (_UINT32_(value) << FCR_CRCCTRL_AUTOR_Pos)) /* Assignment of value for AUTOR in the FCR_CRCCTRL register */
...
#define FCR_CRCCTRL_ROUT(value)               (FCR_CRCCTRL_ROUT_Msk & (_UINT32_(value) << FCR_CRCCTRL_ROUT_Pos)) /* Assignment of value for ROUT in the FCR_CRCCTRL register */
...
#define FCR_CRCCTRL_RIN(value)                (FCR_CRCCTRL_RIN_Msk & (_UINT32_(value) << FCR_CRCCTRL_RIN_Pos)) /* Assignment of value for RIN in the FCR_CRCCTRL register */
...
#define FCR_CRCCTRL_PERIOD(value)             (FCR_CRCCTRL_PERIOD_Msk & (_UINT32_(value) << FCR_CRCCTRL_PERIOD_Pos)) /* Assignment of value for PERIOD in the FCR_CRCCTRL register */
...
#define FCR_FFLTCTRL_CTLFLT(value)            (FCR_FFLTCTRL_CTLFLT_Msk & (_UINT32_(value) << FCR_FFLTCTRL_CTLFLT_Pos)) /* Assignment of value for CTLFLT in the FCR_FFLTCTRL register */
...
#define FCR_FFLTCTRL_FLTMD(value)             (FCR_FFLTCTRL_FLTMD_Msk & (_UINT32_(value) << FCR_FFLTCTRL_FLTMD_Pos)) /* Assignment of value for FLTMD in the FCR_FFLTCTRL register */
...
#define FCR_FFLTPTR_FLT1PTR(value)            (FCR_FFLTPTR_FLT1PTR_Msk & (_UINT32_(value) << FCR_FFLTPTR_FLT1PTR_Pos)) /* Assignment of value for FLT1PTR in the FCR_FFLTPTR register */
...
#define FCR_FFLTPTR_FLT2PTR(value)            (FCR_FFLTPTR_FLT2PTR_Msk & (_UINT32_(value) << FCR_FFLTPTR_FLT2PTR_Pos)) /* Assignment of value for FLT2PTR in the FCR_FFLTPTR register */
...
#define FCR_FFLTSYN_DERR(value)               (FCR_FFLTSYN_DERR_Msk & (_UINT32_(value) << FCR_FFLTSYN_DERR_Pos)) /* Assignment of value for DERR in the FCR_FFLTSYN register */
...
#define FCR_CRP_BC2RP(value)                  (FCR_CRP_BC2RP_Msk & (_UINT32_(value) << FCR_CRP_BC2RP_Pos)) /* Assignment of value for BC2RP in the FCR_CRP register */
...
#define FCR_CRP_BC2RPLOCK(value)              (FCR_CRP_BC2RPLOCK_Msk & (_UINT32_(value) << FCR_CRP_BC2RPLOCK_Pos)) /* Assignment of value for BC2RPLOCK in the FCR_CRP register */
...
#define FCR_HSMCTRL_ECCDIS(value)             (FCR_HSMCTRL_ECCDIS_Msk & (_UINT32_(value) << FCR_HSMCTRL_ECCDIS_Pos)) /* Assignment of value for ECCDIS in the FCR_HSMCTRL register */
...
#define FCR_HSMCTRL_KEYZ(value)               (FCR_HSMCTRL_KEYZ_Msk & (_UINT32_(value) << FCR_HSMCTRL_KEYZ_Pos)) /* Assignment of value for KEYZ in the FCR_HSMCTRL register */
...
#endif /* _PIC32CKGC01_FCR_COMPONENT_H_ */
