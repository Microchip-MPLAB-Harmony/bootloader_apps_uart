...
#ifndef _PIC32CKGC01_ETH_COMPONENT_H_
#define _PIC32CKGC01_ETH_COMPONENT_H_
...
#define ETH_UR_UO_Pos                         _UINT32_(0)                                          /* (ETH_UR) User Programmable Outputs Position */
#define ETH_UR_UO_Msk                         (_UINT32_(0xFFFF) << ETH_UR_UO_Pos)                  /* (ETH_UR) User Programmable Outputs Mask */
#define ETH_UR_UO(value)                      (ETH_UR_UO_Msk & (_UINT32_(value) << ETH_UR_UO_Pos)) /* Assignment of value for UO in the ETH_UR register */
#define ETH_UR_UI_Pos                         _UINT32_(16)                                         /* (ETH_UR) User Programmable Inputs Position */
#define ETH_UR_UI_Msk                         (_UINT32_(0xFFFF) << ETH_UR_UI_Pos)                  /* (ETH_UR) User Programmable Inputs Mask */
#define ETH_UR_UI(value)                      (ETH_UR_UI_Msk & (_UINT32_(value) << ETH_UR_UI_Pos)) /* Assignment of value for UI in the ETH_UR register */
#define ETH_UR_Msk                            _UINT32_(0xFFFFFFFF)                                 /* (ETH_UR) Register Mask  */
...
#define ETH_TIDM_TID(value)                   (ETH_TIDM_TID_Msk & (_UINT32_(value) << ETH_TIDM_TID_Pos)) /* Assignment of value for TID in the ETH_TIDM register */
...
#define ETH_TSH_TCS(value)                    (ETH_TSH_TCS_Msk & (_UINT32_(value) << ETH_TSH_TCS_Pos)) /* Assignment of value for TCS in the ETH_TSH register */
...
#endif /* _PIC32CKGC01_ETH_COMPONENT_H_ */
