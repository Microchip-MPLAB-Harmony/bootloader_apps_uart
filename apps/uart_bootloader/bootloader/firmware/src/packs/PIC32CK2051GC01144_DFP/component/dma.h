...
#ifndef _PIC32CKGC01_DMA_COMPONENT_H_
#define _PIC32CKGC01_DMA_COMPONENT_H_
...
#define DMA_BDNXT_NXT(value)                  (DMA_BDNXT_NXT_Msk & (_UINT32_(value) << DMA_BDNXT_NXT_Pos)) /* Assignment of value for NXT in the DMA_BDNXT register */
...
#define DMA_BDCFG_CTRLB(value)                (DMA_BDCFG_CTRLB_Msk & (_UINT32_(value) << DMA_BDCFG_CTRLB_Pos)) /* Assignment of value for CTRLB in the DMA_BDCFG register */
...
#define DMA_BDCFG_EVCTRL(value)               (DMA_BDCFG_EVCTRL_Msk & (_UINT32_(value) << DMA_BDCFG_EVCTRL_Pos)) /* Assignment of value for EVCTRL in the DMA_BDCFG register */
...
#define DMA_BDCFG_SSA(value)                  (DMA_BDCFG_SSA_Msk & (_UINT32_(value) << DMA_BDCFG_SSA_Pos)) /* Assignment of value for SSA in the DMA_BDCFG register */
...
#define DMA_BDCFG_DSA(value)                  (DMA_BDCFG_DSA_Msk & (_UINT32_(value) << DMA_BDCFG_DSA_Pos)) /* Assignment of value for DSA in the DMA_BDCFG register */
...
#define DMA_BDCFG_SSTRD(value)                (DMA_BDCFG_SSTRD_Msk & (_UINT32_(value) << DMA_BDCFG_SSTRD_Pos)) /* Assignment of value for SSTRD in the DMA_BDCFG register */
...
#define DMA_BDCFG_DSTRD(value)                (DMA_BDCFG_DSTRD_Msk & (_UINT32_(value) << DMA_BDCFG_DSTRD_Pos)) /* Assignment of value for DSTRD in the DMA_BDCFG register */
...
#define DMA_BDCFG_XSIZ(value)                 (DMA_BDCFG_XSIZ_Msk & (_UINT32_(value) << DMA_BDCFG_XSIZ_Pos)) /* Assignment of value for XSIZ in the DMA_BDCFG register */
...
#define DMA_BDCFG_PDAT(value)                 (DMA_BDCFG_PDAT_Msk & (_UINT32_(value) << DMA_BDCFG_PDAT_Pos)) /* Assignment of value for PDAT in the DMA_BDCFG register */
...
#define DMA_BDCFG_CTRLCRC(value)              (DMA_BDCFG_CTRLCRC_Msk & (_UINT32_(value) << DMA_BDCFG_CTRLCRC_Pos)) /* Assignment of value for CTRLCRC in the DMA_BDCFG register */
...
#define DMA_BDCFG_CRCDAT(value)               (DMA_BDCFG_CRCDAT_Msk & (_UINT32_(value) << DMA_BDCFG_CRCDAT_Pos)) /* Assignment of value for CRCDAT in the DMA_BDCFG register */
...
#define DMA_BDCFG_ENABLE(value)               (DMA_BDCFG_ENABLE_Msk & (_UINT32_(value) << DMA_BDCFG_ENABLE_Pos)) /* Assignment of value for ENABLE in the DMA_BDCFG register */
...
#define DMA_BDCFG_LLEN(value)                 (DMA_BDCFG_LLEN_Msk & (_UINT32_(value) << DMA_BDCFG_LLEN_Pos)) /* Assignment of value for LLEN in the DMA_BDCFG register */
...
#define DMA_BDCFG_SWFRC(value)                (DMA_BDCFG_SWFRC_Msk & (_UINT32_(value) << DMA_BDCFG_SWFRC_Pos)) /* Assignment of value for SWFRC in the DMA_BDCFG register */
...
#define DMA_BDCFG_RUNSTDBY(value)             (DMA_BDCFG_RUNSTDBY_Msk & (_UINT32_(value) << DMA_BDCFG_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the DMA_BDCFG register */
...
#define DMA_BDCTRLB_WAS(value)                (DMA_BDCTRLB_WAS_Msk & (_UINT32_(value) << DMA_BDCTRLB_WAS_Pos)) /* Assignment of value for WAS in the DMA_BDCTRLB register */
...
#define DMA_BDCTRLB_RAS(value)                (DMA_BDCTRLB_RAS_Msk & (_UINT32_(value) << DMA_BDCTRLB_RAS_Pos)) /* Assignment of value for RAS in the DMA_BDCTRLB register */
...
#define DMA_BDCTRLB_PRI(value)                (DMA_BDCTRLB_PRI_Msk & (_UINT32_(value) << DMA_BDCTRLB_PRI_Pos)) /* Assignment of value for PRI in the DMA_BDCTRLB register */
...
#define   DMA_BDCTRLB_PRI_PRI_3_Val           _UINT32_(0x2)                                        /* (DMA_BDCTRLB) Channel Priority is 3 (HIGHEST)  */
...
#define DMA_BDCTRLB_PRI_PRI_3                 (DMA_BDCTRLB_PRI_PRI_3_Val << DMA_BDCTRLB_PRI_Pos)   /* (DMA_BDCTRLB) Channel Priority is 3 (HIGHEST) Position */
...
#define DMA_BDCTRLB_WBOEN(value)              (DMA_BDCTRLB_WBOEN_Msk & (_UINT32_(value) << DMA_BDCTRLB_WBOEN_Pos)) /* Assignment of value for WBOEN in the DMA_BDCTRLB register */
...
#define DMA_BDCTRLB_BYTORD(value)             (DMA_BDCTRLB_BYTORD_Msk & (_UINT32_(value) << DMA_BDCTRLB_BYTORD_Pos)) /* Assignment of value for BYTORD in the DMA_BDCTRLB register */
...
#define DMA_BDCTRLB_TRIG(value)               (DMA_BDCTRLB_TRIG_Msk & (_UINT32_(value) << DMA_BDCTRLB_TRIG_Pos)) /* Assignment of value for TRIG in the DMA_BDCTRLB register */
...
#define DMA_BDCTRLB_PIGNEN(value)             (DMA_BDCTRLB_PIGNEN_Msk & (_UINT32_(value) << DMA_BDCTRLB_PIGNEN_Pos)) /* Assignment of value for PIGNEN in the DMA_BDCTRLB register */
...
#define DMA_BDCTRLB_PATLEN(value)             (DMA_BDCTRLB_PATLEN_Msk & (_UINT32_(value) << DMA_BDCTRLB_PATLEN_Pos)) /* Assignment of value for PATLEN in the DMA_BDCTRLB register */
...
#define DMA_BDCTRLB_PATEN(value)              (DMA_BDCTRLB_PATEN_Msk & (_UINT32_(value) << DMA_BDCTRLB_PATEN_Pos)) /* Assignment of value for PATEN in the DMA_BDCTRLB register */
...
#define DMA_BDCTRLB_CASTEN(value)             (DMA_BDCTRLB_CASTEN_Msk & (_UINT32_(value) << DMA_BDCTRLB_CASTEN_Pos)) /* Assignment of value for CASTEN in the DMA_BDCTRLB register */
...
#define DMA_BDCTRLB_CRCEN(value)              (DMA_BDCTRLB_CRCEN_Msk & (_UINT32_(value) << DMA_BDCTRLB_CRCEN_Pos)) /* Assignment of value for CRCEN in the DMA_BDCTRLB register */
...
#define DMA_BDEVCTRL_EVAUXACT(value)          (DMA_BDEVCTRL_EVAUXACT_Msk & (_UINT16_(value) << DMA_BDEVCTRL_EVAUXACT_Pos)) /* Assignment of value for EVAUXACT in the DMA_BDEVCTRL register */
...
#define DMA_BDEVCTRL_EVOMODE(value)           (DMA_BDEVCTRL_EVOMODE_Msk & (_UINT16_(value) << DMA_BDEVCTRL_EVOMODE_Pos)) /* Assignment of value for EVOMODE in the DMA_BDEVCTRL register */
...
#define DMA_BDEVCTRL_EVAUXIE(value)           (DMA_BDEVCTRL_EVAUXIE_Msk & (_UINT16_(value) << DMA_BDEVCTRL_EVAUXIE_Pos)) /* Assignment of value for EVAUXIE in the DMA_BDEVCTRL register */
...
#define DMA_BDEVCTRL_EVSTRIE(value)           (DMA_BDEVCTRL_EVSTRIE_Msk & (_UINT16_(value) << DMA_BDEVCTRL_EVSTRIE_Pos)) /* Assignment of value for EVSTRIE in the DMA_BDEVCTRL register */
...
#define DMA_BDEVCTRL_EVOE(value)              (DMA_BDEVCTRL_EVOE_Msk & (_UINT16_(value) << DMA_BDEVCTRL_EVOE_Pos)) /* Assignment of value for EVOE in the DMA_BDEVCTRL register */
...
#define DMA_BDCTRLCRC_CRCMD(value)            (DMA_BDCTRLCRC_CRCMD_Msk & (_UINT16_(value) << DMA_BDCTRLCRC_CRCMD_Pos)) /* Assignment of value for CRCMD in the DMA_BDCTRLCRC register */
...
#define DMA_BDCTRLCRC_CRCAPP(value)           (DMA_BDCTRLCRC_CRCAPP_Msk & (_UINT16_(value) << DMA_BDCTRLCRC_CRCAPP_Pos)) /* Assignment of value for CRCAPP in the DMA_BDCTRLCRC register */
...
#define DMA_BDCTRLCRC_CRCXOR(value)           (DMA_BDCTRLCRC_CRCXOR_Msk & (_UINT16_(value) << DMA_BDCTRLCRC_CRCXOR_Pos)) /* Assignment of value for CRCXOR in the DMA_BDCTRLCRC register */
...
#define DMA_BDCTRLCRC_CRCROUT(value)          (DMA_BDCTRLCRC_CRCROUT_Msk & (_UINT16_(value) << DMA_BDCTRLCRC_CRCROUT_Pos)) /* Assignment of value for CRCROUT in the DMA_BDCTRLCRC register */
...
#define DMA_BDCTRLCRC_CRCRIN(value)           (DMA_BDCTRLCRC_CRCRIN_Msk & (_UINT16_(value) << DMA_BDCTRLCRC_CRCRIN_Pos)) /* Assignment of value for CRCRIN in the DMA_BDCTRLCRC register */
...
#define DMA_BDSSA_SSA(value)                  (DMA_BDSSA_SSA_Msk & (_UINT32_(value) << DMA_BDSSA_SSA_Pos)) /* Assignment of value for SSA in the DMA_BDSSA register */
...
#define DMA_BDDSA_DSA(value)                  (DMA_BDDSA_DSA_Msk & (_UINT32_(value) << DMA_BDDSA_DSA_Pos)) /* Assignment of value for DSA in the DMA_BDDSA register */
...
#define DMA_BDSSTRD_SSTRD(value)              (DMA_BDSSTRD_SSTRD_Msk & (_UINT16_(value) << DMA_BDSSTRD_SSTRD_Pos)) /* Assignment of value for SSTRD in the DMA_BDSSTRD register */
...
#define DMA_BDDSTRD_DSTRD(value)              (DMA_BDDSTRD_DSTRD_Msk & (_UINT16_(value) << DMA_BDDSTRD_DSTRD_Pos)) /* Assignment of value for DSTRD in the DMA_BDDSTRD register */
...
#define DMA_BDXSIZ_CSZ(value)                 (DMA_BDXSIZ_CSZ_Msk & (_UINT32_(value) << DMA_BDXSIZ_CSZ_Pos)) /* Assignment of value for CSZ in the DMA_BDXSIZ register */
...
#define DMA_BDXSIZ_BLKSZ(value)               (DMA_BDXSIZ_BLKSZ_Msk & (_UINT32_(value) << DMA_BDXSIZ_BLKSZ_Pos)) /* Assignment of value for BLKSZ in the DMA_BDXSIZ register */
...
#define DMA_BDPDAT_PDAT(value)                (DMA_BDPDAT_PDAT_Msk & (_UINT32_(value) << DMA_BDPDAT_PDAT_Pos)) /* Assignment of value for PDAT in the DMA_BDPDAT register */
...
#define DMA_BDPDAT_PIGN(value)                (DMA_BDPDAT_PIGN_Msk & (_UINT32_(value) << DMA_BDPDAT_PIGN_Pos)) /* Assignment of value for PIGN in the DMA_BDPDAT register */
...
#define DMA_BDCRCDAT_CRCDAT(value)            (DMA_BDCRCDAT_CRCDAT_Msk & (_UINT32_(value) << DMA_BDCRCDAT_CRCDAT_Pos)) /* Assignment of value for CRCDAT in the DMA_BDCRCDAT register */
...
#define DMA_CHCTRLA_ENABLE(value)             (DMA_CHCTRLA_ENABLE_Msk & (_UINT32_(value) << DMA_CHCTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the DMA_CHCTRLA register */
...
#define DMA_CHCTRLA_LLEN(value)               (DMA_CHCTRLA_LLEN_Msk & (_UINT32_(value) << DMA_CHCTRLA_LLEN_Pos)) /* Assignment of value for LLEN in the DMA_CHCTRLA register */
...
#define DMA_CHCTRLA_SWFRC(value)              (DMA_CHCTRLA_SWFRC_Msk & (_UINT32_(value) << DMA_CHCTRLA_SWFRC_Pos)) /* Assignment of value for SWFRC in the DMA_CHCTRLA register */
...
#define DMA_CHCTRLA_RUNSTDBY(value)           (DMA_CHCTRLA_RUNSTDBY_Msk & (_UINT32_(value) << DMA_CHCTRLA_RUNSTDBY_Pos)) /* Assignment of value for RUNSTDBY in the DMA_CHCTRLA register */
...
#define DMA_CHCTRLB_WAS(value)                (DMA_CHCTRLB_WAS_Msk & (_UINT32_(value) << DMA_CHCTRLB_WAS_Pos)) /* Assignment of value for WAS in the DMA_CHCTRLB register */
...
#define DMA_CHCTRLB_RAS(value)                (DMA_CHCTRLB_RAS_Msk & (_UINT32_(value) << DMA_CHCTRLB_RAS_Pos)) /* Assignment of value for RAS in the DMA_CHCTRLB register */
...
#define DMA_CHCTRLB_PRI(value)                (DMA_CHCTRLB_PRI_Msk & (_UINT32_(value) << DMA_CHCTRLB_PRI_Pos)) /* Assignment of value for PRI in the DMA_CHCTRLB register */
...
#define   DMA_CHCTRLB_PRI_PRI_3_Val           _UINT32_(0x2)                                        /* (DMA_CHCTRLB) Channel Priority is 3 (HIGHEST)  */
...
#define DMA_CHCTRLB_PRI_PRI_3                 (DMA_CHCTRLB_PRI_PRI_3_Val << DMA_CHCTRLB_PRI_Pos)   /* (DMA_CHCTRLB) Channel Priority is 3 (HIGHEST) Position */
...
#define DMA_CHCTRLB_WBOEN(value)              (DMA_CHCTRLB_WBOEN_Msk & (_UINT32_(value) << DMA_CHCTRLB_WBOEN_Pos)) /* Assignment of value for WBOEN in the DMA_CHCTRLB register */
...
#define DMA_CHCTRLB_BYTORD(value)             (DMA_CHCTRLB_BYTORD_Msk & (_UINT32_(value) << DMA_CHCTRLB_BYTORD_Pos)) /* Assignment of value for BYTORD in the DMA_CHCTRLB register */
...
#define DMA_CHCTRLB_TRIG(value)               (DMA_CHCTRLB_TRIG_Msk & (_UINT32_(value) << DMA_CHCTRLB_TRIG_Pos)) /* Assignment of value for TRIG in the DMA_CHCTRLB register */
...
#define DMA_CHCTRLB_PIGNEN(value)             (DMA_CHCTRLB_PIGNEN_Msk & (_UINT32_(value) << DMA_CHCTRLB_PIGNEN_Pos)) /* Assignment of value for PIGNEN in the DMA_CHCTRLB register */
...
#define DMA_CHCTRLB_PATLEN(value)             (DMA_CHCTRLB_PATLEN_Msk & (_UINT32_(value) << DMA_CHCTRLB_PATLEN_Pos)) /* Assignment of value for PATLEN in the DMA_CHCTRLB register */
...
#define DMA_CHCTRLB_PATEN(value)              (DMA_CHCTRLB_PATEN_Msk & (_UINT32_(value) << DMA_CHCTRLB_PATEN_Pos)) /* Assignment of value for PATEN in the DMA_CHCTRLB register */
...
#define DMA_CHCTRLB_CASTEN(value)             (DMA_CHCTRLB_CASTEN_Msk & (_UINT32_(value) << DMA_CHCTRLB_CASTEN_Pos)) /* Assignment of value for CASTEN in the DMA_CHCTRLB register */
...
#define DMA_CHCTRLB_CRCEN(value)              (DMA_CHCTRLB_CRCEN_Msk & (_UINT32_(value) << DMA_CHCTRLB_CRCEN_Pos)) /* Assignment of value for CRCEN in the DMA_CHCTRLB register */
...
#define DMA_CHEVCTRL_EVAUXACT(value)          (DMA_CHEVCTRL_EVAUXACT_Msk & (_UINT32_(value) << DMA_CHEVCTRL_EVAUXACT_Pos)) /* Assignment of value for EVAUXACT in the DMA_CHEVCTRL register */
...
#define DMA_CHEVCTRL_EVOMODE(value)           (DMA_CHEVCTRL_EVOMODE_Msk & (_UINT32_(value) << DMA_CHEVCTRL_EVOMODE_Pos)) /* Assignment of value for EVOMODE in the DMA_CHEVCTRL register */
...
#define DMA_CHEVCTRL_EVAUXIE(value)           (DMA_CHEVCTRL_EVAUXIE_Msk & (_UINT32_(value) << DMA_CHEVCTRL_EVAUXIE_Pos)) /* Assignment of value for EVAUXIE in the DMA_CHEVCTRL register */
...
#define DMA_CHEVCTRL_EVSTRIE(value)           (DMA_CHEVCTRL_EVSTRIE_Msk & (_UINT32_(value) << DMA_CHEVCTRL_EVSTRIE_Pos)) /* Assignment of value for EVSTRIE in the DMA_CHEVCTRL register */
...
#define DMA_CHEVCTRL_EVOE(value)              (DMA_CHEVCTRL_EVOE_Msk & (_UINT32_(value) << DMA_CHEVCTRL_EVOE_Pos)) /* Assignment of value for EVOE in the DMA_CHEVCTRL register */
...
#define DMA_CHINTENCLR_SD(value)              (DMA_CHINTENCLR_SD_Msk & (_UINT32_(value) << DMA_CHINTENCLR_SD_Pos)) /* Assignment of value for SD in the DMA_CHINTENCLR register */
...
#define DMA_CHINTENCLR_TA(value)              (DMA_CHINTENCLR_TA_Msk & (_UINT32_(value) << DMA_CHINTENCLR_TA_Pos)) /* Assignment of value for TA in the DMA_CHINTENCLR register */
...
#define DMA_CHINTENCLR_CC(value)              (DMA_CHINTENCLR_CC_Msk & (_UINT32_(value) << DMA_CHINTENCLR_CC_Pos)) /* Assignment of value for CC in the DMA_CHINTENCLR register */
...
#define DMA_CHINTENCLR_BC(value)              (DMA_CHINTENCLR_BC_Msk & (_UINT32_(value) << DMA_CHINTENCLR_BC_Pos)) /* Assignment of value for BC in the DMA_CHINTENCLR register */
...
#define DMA_CHINTENCLR_BH(value)              (DMA_CHINTENCLR_BH_Msk & (_UINT32_(value) << DMA_CHINTENCLR_BH_Pos)) /* Assignment of value for BH in the DMA_CHINTENCLR register */
...
#define DMA_CHINTENCLR_LL(value)              (DMA_CHINTENCLR_LL_Msk & (_UINT32_(value) << DMA_CHINTENCLR_LL_Pos)) /* Assignment of value for LL in the DMA_CHINTENCLR register */
...
#define DMA_CHINTENSET_SD(value)              (DMA_CHINTENSET_SD_Msk & (_UINT32_(value) << DMA_CHINTENSET_SD_Pos)) /* Assignment of value for SD in the DMA_CHINTENSET register */
...
#define DMA_CHINTENSET_TA(value)              (DMA_CHINTENSET_TA_Msk & (_UINT32_(value) << DMA_CHINTENSET_TA_Pos)) /* Assignment of value for TA in the DMA_CHINTENSET register */
...
#define DMA_CHINTENSET_CC(value)              (DMA_CHINTENSET_CC_Msk & (_UINT32_(value) << DMA_CHINTENSET_CC_Pos)) /* Assignment of value for CC in the DMA_CHINTENSET register */
...
#define DMA_CHINTENSET_BC(value)              (DMA_CHINTENSET_BC_Msk & (_UINT32_(value) << DMA_CHINTENSET_BC_Pos)) /* Assignment of value for BC in the DMA_CHINTENSET register */
...
#define DMA_CHINTENSET_BH(value)              (DMA_CHINTENSET_BH_Msk & (_UINT32_(value) << DMA_CHINTENSET_BH_Pos)) /* Assignment of value for BH in the DMA_CHINTENSET register */
...
#define DMA_CHINTENSET_LL(value)              (DMA_CHINTENSET_LL_Msk & (_UINT32_(value) << DMA_CHINTENSET_LL_Pos)) /* Assignment of value for LL in the DMA_CHINTENSET register */
...
#define DMA_CHINTF_SD(value)                  (DMA_CHINTF_SD_Msk & (_UINT32_(value) << DMA_CHINTF_SD_Pos)) /* Assignment of value for SD in the DMA_CHINTF register */
...
#define DMA_CHINTF_TA(value)                  (DMA_CHINTF_TA_Msk & (_UINT32_(value) << DMA_CHINTF_TA_Pos)) /* Assignment of value for TA in the DMA_CHINTF register */
...
#define DMA_CHINTF_CC(value)                  (DMA_CHINTF_CC_Msk & (_UINT32_(value) << DMA_CHINTF_CC_Pos)) /* Assignment of value for CC in the DMA_CHINTF register */
...
#define DMA_CHINTF_BC(value)                  (DMA_CHINTF_BC_Msk & (_UINT32_(value) << DMA_CHINTF_BC_Pos)) /* Assignment of value for BC in the DMA_CHINTF register */
...
#define DMA_CHINTF_BH(value)                  (DMA_CHINTF_BH_Msk & (_UINT32_(value) << DMA_CHINTF_BH_Pos)) /* Assignment of value for BH in the DMA_CHINTF register */
...
#define DMA_CHINTF_LL(value)                  (DMA_CHINTF_LL_Msk & (_UINT32_(value) << DMA_CHINTF_LL_Pos)) /* Assignment of value for LL in the DMA_CHINTF register */
...
#define DMA_CHINTF_WRE(value)                 (DMA_CHINTF_WRE_Msk & (_UINT32_(value) << DMA_CHINTF_WRE_Pos)) /* Assignment of value for WRE in the DMA_CHINTF register */
...
#define DMA_CHINTF_RDE(value)                 (DMA_CHINTF_RDE_Msk & (_UINT32_(value) << DMA_CHINTF_RDE_Pos)) /* Assignment of value for RDE in the DMA_CHINTF register */
...
#define DMA_CHSSA_SSA(value)                  (DMA_CHSSA_SSA_Msk & (_UINT32_(value) << DMA_CHSSA_SSA_Pos)) /* Assignment of value for SSA in the DMA_CHSSA register */
...
#define DMA_CHDSA_DSA(value)                  (DMA_CHDSA_DSA_Msk & (_UINT32_(value) << DMA_CHDSA_DSA_Pos)) /* Assignment of value for DSA in the DMA_CHDSA register */
...
#define DMA_CHSSTRD_SSTRD(value)              (DMA_CHSSTRD_SSTRD_Msk & (_UINT32_(value) << DMA_CHSSTRD_SSTRD_Pos)) /* Assignment of value for SSTRD in the DMA_CHSSTRD register */
...
#define DMA_CHDSTRD_DSTRD(value)              (DMA_CHDSTRD_DSTRD_Msk & (_UINT32_(value) << DMA_CHDSTRD_DSTRD_Pos)) /* Assignment of value for DSTRD in the DMA_CHDSTRD register */
...
#define DMA_CHXSIZ_CSZ(value)                 (DMA_CHXSIZ_CSZ_Msk & (_UINT32_(value) << DMA_CHXSIZ_CSZ_Pos)) /* Assignment of value for CSZ in the DMA_CHXSIZ register */
...
#define DMA_CHXSIZ_BLKSZ(value)               (DMA_CHXSIZ_BLKSZ_Msk & (_UINT32_(value) << DMA_CHXSIZ_BLKSZ_Pos)) /* Assignment of value for BLKSZ in the DMA_CHXSIZ register */
...
#define DMA_CHPDAT_PDAT(value)                (DMA_CHPDAT_PDAT_Msk & (_UINT32_(value) << DMA_CHPDAT_PDAT_Pos)) /* Assignment of value for PDAT in the DMA_CHPDAT register */
...
#define DMA_CHPDAT_PIGN(value)                (DMA_CHPDAT_PIGN_Msk & (_UINT32_(value) << DMA_CHPDAT_PIGN_Pos)) /* Assignment of value for PIGN in the DMA_CHPDAT register */
...
#define DMA_CHCTRLCRC_CRCMD(value)            (DMA_CHCTRLCRC_CRCMD_Msk & (_UINT32_(value) << DMA_CHCTRLCRC_CRCMD_Pos)) /* Assignment of value for CRCMD in the DMA_CHCTRLCRC register */
...
#define DMA_CHCTRLCRC_CRCAPP(value)           (DMA_CHCTRLCRC_CRCAPP_Msk & (_UINT32_(value) << DMA_CHCTRLCRC_CRCAPP_Pos)) /* Assignment of value for CRCAPP in the DMA_CHCTRLCRC register */
...
#define DMA_CHCTRLCRC_CRCXOR(value)           (DMA_CHCTRLCRC_CRCXOR_Msk & (_UINT32_(value) << DMA_CHCTRLCRC_CRCXOR_Pos)) /* Assignment of value for CRCXOR in the DMA_CHCTRLCRC register */
...
#define DMA_CHCTRLCRC_CRCROUT(value)          (DMA_CHCTRLCRC_CRCROUT_Msk & (_UINT32_(value) << DMA_CHCTRLCRC_CRCROUT_Pos)) /* Assignment of value for CRCROUT in the DMA_CHCTRLCRC register */
...
#define DMA_CHCTRLCRC_CRCRIN(value)           (DMA_CHCTRLCRC_CRCRIN_Msk & (_UINT32_(value) << DMA_CHCTRLCRC_CRCRIN_Pos)) /* Assignment of value for CRCRIN in the DMA_CHCTRLCRC register */
...
#define DMA_CHCRCDAT_CRCDAT(value)            (DMA_CHCRCDAT_CRCDAT_Msk & (_UINT32_(value) << DMA_CHCRCDAT_CRCDAT_Pos)) /* Assignment of value for CRCDAT in the DMA_CHCRCDAT register */
...
#define DMA_CHNXT_NXT(value)                  (DMA_CHNXT_NXT_Msk & (_UINT32_(value) << DMA_CHNXT_NXT_Pos)) /* Assignment of value for NXT in the DMA_CHNXT register */
...
#define DMA_CHLLCFGSTAT_CTRLB(value)          (DMA_CHLLCFGSTAT_CTRLB_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_CTRLB_Pos)) /* Assignment of value for CTRLB in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHLLCFGSTAT_EVCTRL(value)         (DMA_CHLLCFGSTAT_EVCTRL_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_EVCTRL_Pos)) /* Assignment of value for EVCTRL in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHLLCFGSTAT_SSA(value)            (DMA_CHLLCFGSTAT_SSA_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_SSA_Pos)) /* Assignment of value for SSA in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHLLCFGSTAT_DSA(value)            (DMA_CHLLCFGSTAT_DSA_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_DSA_Pos)) /* Assignment of value for DSA in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHLLCFGSTAT_SSTRD(value)          (DMA_CHLLCFGSTAT_SSTRD_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_SSTRD_Pos)) /* Assignment of value for SSTRD in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHLLCFGSTAT_DSTRD(value)          (DMA_CHLLCFGSTAT_DSTRD_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_DSTRD_Pos)) /* Assignment of value for DSTRD in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHLLCFGSTAT_XSIZ(value)           (DMA_CHLLCFGSTAT_XSIZ_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_XSIZ_Pos)) /* Assignment of value for XSIZ in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHLLCFGSTAT_PDAT(value)           (DMA_CHLLCFGSTAT_PDAT_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_PDAT_Pos)) /* Assignment of value for PDAT in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHLLCFGSTAT_CTRLCRC(value)        (DMA_CHLLCFGSTAT_CTRLCRC_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_CTRLCRC_Pos)) /* Assignment of value for CTRLCRC in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHLLCFGSTAT_CRCDAT(value)         (DMA_CHLLCFGSTAT_CRCDAT_Msk & (_UINT32_(value) << DMA_CHLLCFGSTAT_CRCDAT_Pos)) /* Assignment of value for CRCDAT in the DMA_CHLLCFGSTAT register */
...
#define DMA_CHSTATBC_BBTC(value)              (DMA_CHSTATBC_BBTC_Msk & (_UINT32_(value) << DMA_CHSTATBC_BBTC_Pos)) /* Assignment of value for BBTC in the DMA_CHSTATBC register */
...
#define DMA_CHSTATCC_CBTC(value)              (DMA_CHSTATCC_CBTC_Msk & (_UINT32_(value) << DMA_CHSTATCC_CBTC_Pos)) /* Assignment of value for CBTC in the DMA_CHSTATCC register */
...
#define DMA_CHSTAT_BLKBUSY(value)             (DMA_CHSTAT_BLKBUSY_Msk & (_UINT32_(value) << DMA_CHSTAT_BLKBUSY_Pos)) /* Assignment of value for BLKBUSY in the DMA_CHSTAT register */
...
#define DMA_CHSTAT_CELLBUSY(value)            (DMA_CHSTAT_CELLBUSY_Msk & (_UINT32_(value) << DMA_CHSTAT_CELLBUSY_Pos)) /* Assignment of value for CELLBUSY in the DMA_CHSTAT register */
...
#define DMA_CHSTAT_DREAD(value)               (DMA_CHSTAT_DREAD_Msk & (_UINT32_(value) << DMA_CHSTAT_DREAD_Pos)) /* Assignment of value for DREAD in the DMA_CHSTAT register */
...
#define DMA_CTRLA_ENABLE(value)               (DMA_CTRLA_ENABLE_Msk & (_UINT32_(value) << DMA_CTRLA_ENABLE_Pos)) /* Assignment of value for ENABLE in the DMA_CTRLA register */
#define DMA_CTRLA_Msk                         _UINT32_(0x00000002)                                 /* (DMA_CTRLA) Register Mask  */


/* -------- DMA_CTRLB : (DMA Offset: 0x04) (R/W 32) DMA CONTROL B REGISTER -------- */
#define DMA_CTRLB_RESETVALUE                  _UINT32_(0x00)                                       /*  (DMA_CTRLB) DMA CONTROL B REGISTER  Reset Value */

#define DMA_CTRLB_QOS1_Pos                    _UINT32_(0)                                          /* (DMA_CTRLB) Priority Group 1 Quality Of Service Control Position */
#define DMA_CTRLB_QOS1_Msk                    (_UINT32_(0x3) << DMA_CTRLB_QOS1_Pos)                /* (DMA_CTRLB) Priority Group 1 Quality Of Service Control Mask */
#define DMA_CTRLB_QOS1(value)                 (DMA_CTRLB_QOS1_Msk & (_UINT32_(value) << DMA_CTRLB_QOS1_Pos)) /* Assignment of value for QOS1 in the DMA_CTRLB register */
#define   DMA_CTRLB_QOS1_LEVEL_0_Val          _UINT32_(0x0)                                        /* (DMA_CTRLB) QoS level is 0 (lowest)  */
#define   DMA_CTRLB_QOS1_LEVEL_1_Val          _UINT32_(0x1)                                        /* (DMA_CTRLB) QoS level is 1 (lower)  */
#define   DMA_CTRLB_QOS1_LEVEL_2_Val          _UINT32_(0x2)                                        /* (DMA_CTRLB) QoS level is 2 (medium)  */
#define   DMA_CTRLB_QOS1_LEVEL_3_Val          _UINT32_(0x3)                                        /* (DMA_CTRLB) QoS level is 3 (high)  */
#define DMA_CTRLB_QOS1_LEVEL_0                (DMA_CTRLB_QOS1_LEVEL_0_Val << DMA_CTRLB_QOS1_Pos)   /* (DMA_CTRLB) QoS level is 0 (lowest) Position */
#define DMA_CTRLB_QOS1_LEVEL_1                (DMA_CTRLB_QOS1_LEVEL_1_Val << DMA_CTRLB_QOS1_Pos)   /* (DMA_CTRLB) QoS level is 1 (lower) Position */
#define DMA_CTRLB_QOS1_LEVEL_2                (DMA_CTRLB_QOS1_LEVEL_2_Val << DMA_CTRLB_QOS1_Pos)   /* (DMA_CTRLB) QoS level is 2 (medium) Position */
#define DMA_CTRLB_QOS1_LEVEL_3                (DMA_CTRLB_QOS1_LEVEL_3_Val << DMA_CTRLB_QOS1_Pos)   /* (DMA_CTRLB) QoS level is 3 (high) Position */
#define DMA_CTRLB_QOS2_Pos                    _UINT32_(8)                                          /* (DMA_CTRLB) Priority Group 2 Quality Of Service Control Position */
#define DMA_CTRLB_QOS2_Msk                    (_UINT32_(0x3) << DMA_CTRLB_QOS2_Pos)                /* (DMA_CTRLB) Priority Group 2 Quality Of Service Control Mask */
#define DMA_CTRLB_QOS2(value)                 (DMA_CTRLB_QOS2_Msk & (_UINT32_(value) << DMA_CTRLB_QOS2_Pos)) /* Assignment of value for QOS2 in the DMA_CTRLB register */
#define   DMA_CTRLB_QOS2_LEVEL_0_Val          _UINT32_(0x0)                                        /* (DMA_CTRLB) QoS level is 0 (lowest)  */
#define   DMA_CTRLB_QOS2_LEVEL_1_Val          _UINT32_(0x1)                                        /* (DMA_CTRLB) QoS level is 1 (lower)  */
#define   DMA_CTRLB_QOS2_LEVEL_2_Val          _UINT32_(0x2)                                        /* (DMA_CTRLB) QoS level is 2 (medium)  */
#define   DMA_CTRLB_QOS2_LEVEL_3_Val          _UINT32_(0x3)                                        /* (DMA_CTRLB) QoS level is 3 (high)  */
#define DMA_CTRLB_QOS2_LEVEL_0                (DMA_CTRLB_QOS2_LEVEL_0_Val << DMA_CTRLB_QOS2_Pos)   /* (DMA_CTRLB) QoS level is 0 (lowest) Position */
#define DMA_CTRLB_QOS2_LEVEL_1                (DMA_CTRLB_QOS2_LEVEL_1_Val << DMA_CTRLB_QOS2_Pos)   /* (DMA_CTRLB) QoS level is 1 (lower) Position */
#define DMA_CTRLB_QOS2_LEVEL_2                (DMA_CTRLB_QOS2_LEVEL_2_Val << DMA_CTRLB_QOS2_Pos)   /* (DMA_CTRLB) QoS level is 2 (medium) Position */
#define DMA_CTRLB_QOS2_LEVEL_3                (DMA_CTRLB_QOS2_LEVEL_3_Val << DMA_CTRLB_QOS2_Pos)   /* (DMA_CTRLB) QoS level is 3 (high) Position */
#define DMA_CTRLB_QOS3_Pos                    _UINT32_(16)                                         /* (DMA_CTRLB) Priority Group 3 Quality Of Service Control Position */
#define DMA_CTRLB_QOS3_Msk                    (_UINT32_(0x3) << DMA_CTRLB_QOS3_Pos)                /* (DMA_CTRLB) Priority Group 3 Quality Of Service Control Mask */
#define DMA_CTRLB_QOS3(value)                 (DMA_CTRLB_QOS3_Msk & (_UINT32_(value) << DMA_CTRLB_QOS3_Pos)) /* Assignment of value for QOS3 in the DMA_CTRLB register */
#define   DMA_CTRLB_QOS3_LEVEL_0_Val          _UINT32_(0x0)                                        /* (DMA_CTRLB) QoS level is 0 (lowest)  */
#define   DMA_CTRLB_QOS3_LEVEL_1_Val          _UINT32_(0x1)                                        /* (DMA_CTRLB) QoS level is 1 (lower)  */
#define   DMA_CTRLB_QOS3_LEVEL_2_Val          _UINT32_(0x2)                                        /* (DMA_CTRLB) QoS level is 2 (medium)  */
#define   DMA_CTRLB_QOS3_LEVEL_3_Val          _UINT32_(0x3)                                        /* (DMA_CTRLB) QoS level is 3 (high)  */
#define DMA_CTRLB_QOS3_LEVEL_0                (DMA_CTRLB_QOS3_LEVEL_0_Val << DMA_CTRLB_QOS3_Pos)   /* (DMA_CTRLB) QoS level is 0 (lowest) Position */
#define DMA_CTRLB_QOS3_LEVEL_1                (DMA_CTRLB_QOS3_LEVEL_1_Val << DMA_CTRLB_QOS3_Pos)   /* (DMA_CTRLB) QoS level is 1 (lower) Position */
#define DMA_CTRLB_QOS3_LEVEL_2                (DMA_CTRLB_QOS3_LEVEL_2_Val << DMA_CTRLB_QOS3_Pos)   /* (DMA_CTRLB) QoS level is 2 (medium) Position */
#define DMA_CTRLB_QOS3_LEVEL_3                (DMA_CTRLB_QOS3_LEVEL_3_Val << DMA_CTRLB_QOS3_Pos)   /* (DMA_CTRLB) QoS level is 3 (high) Position */
#define DMA_CTRLB_QOS4_Pos                    _UINT32_(24)                                         /* (DMA_CTRLB) Priority Group 4 Quality Of Service Control Position */
#define DMA_CTRLB_QOS4_Msk                    (_UINT32_(0x3) << DMA_CTRLB_QOS4_Pos)                /* (DMA_CTRLB) Priority Group 4 Quality Of Service Control Mask */
#define DMA_CTRLB_QOS4(value)                 (DMA_CTRLB_QOS4_Msk & (_UINT32_(value) << DMA_CTRLB_QOS4_Pos)) /* Assignment of value for QOS4 in the DMA_CTRLB register */
#define   DMA_CTRLB_QOS4_LEVEL_0_Val          _UINT32_(0x0)                                        /* (DMA_CTRLB) QoS level is 0 (lowest)  */
#define   DMA_CTRLB_QOS4_LEVEL_1_Val          _UINT32_(0x1)                                        /* (DMA_CTRLB) QoS level is 1 (lower)  */
#define   DMA_CTRLB_QOS4_LEVEL_2_Val          _UINT32_(0x2)                                        /* (DMA_CTRLB) QoS level is 2 (medium)  */
#define   DMA_CTRLB_QOS4_LEVEL_3_Val          _UINT32_(0x3)                                        /* (DMA_CTRLB) QoS level is 3 (high)  */
#define DMA_CTRLB_QOS4_LEVEL_0                (DMA_CTRLB_QOS4_LEVEL_0_Val << DMA_CTRLB_QOS4_Pos)   /* (DMA_CTRLB) QoS level is 0 (lowest) Position */
#define DMA_CTRLB_QOS4_LEVEL_1                (DMA_CTRLB_QOS4_LEVEL_1_Val << DMA_CTRLB_QOS4_Pos)   /* (DMA_CTRLB) QoS level is 1 (lower) Position */
#define DMA_CTRLB_QOS4_LEVEL_2                (DMA_CTRLB_QOS4_LEVEL_2_Val << DMA_CTRLB_QOS4_Pos)   /* (DMA_CTRLB) QoS level is 2 (medium) Position */
#define DMA_CTRLB_QOS4_LEVEL_3                (DMA_CTRLB_QOS4_LEVEL_3_Val << DMA_CTRLB_QOS4_Pos)   /* (DMA_CTRLB) QoS level is 3 (high) Position */
#define DMA_CTRLB_Msk                         _UINT32_(0x03030303)                                 /* (DMA_CTRLB) Register Mask  */
...
#define DMA_DBGCTRL_DBGRUN(value)             (DMA_DBGCTRL_DBGRUN_Msk & (_UINT32_(value) << DMA_DBGCTRL_DBGRUN_Pos)) /* Assignment of value for DBGRUN in the DMA_DBGCTRL register */
...
#define DMA_CRCPOLYA_POLYA(value)             (DMA_CRCPOLYA_POLYA_Msk & (_UINT32_(value) << DMA_CRCPOLYA_POLYA_Pos)) /* Assignment of value for POLYA in the DMA_CRCPOLYA register */
...
#define DMA_CRCPOLYB_POLYB(value)             (DMA_CRCPOLYB_POLYB_Msk & (_UINT32_(value) << DMA_CRCPOLYB_POLYB_Pos)) /* Assignment of value for POLYB in the DMA_CRCPOLYB register */
...
#define DMA_INTSTAT3_CH0(value)               (DMA_INTSTAT3_CH0_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH0_Pos)) /* Assignment of value for CH0 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH1(value)               (DMA_INTSTAT3_CH1_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH1_Pos)) /* Assignment of value for CH1 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH2(value)               (DMA_INTSTAT3_CH2_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH2_Pos)) /* Assignment of value for CH2 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH3(value)               (DMA_INTSTAT3_CH3_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH3_Pos)) /* Assignment of value for CH3 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH4(value)               (DMA_INTSTAT3_CH4_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH4_Pos)) /* Assignment of value for CH4 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH5(value)               (DMA_INTSTAT3_CH5_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH5_Pos)) /* Assignment of value for CH5 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH6(value)               (DMA_INTSTAT3_CH6_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH6_Pos)) /* Assignment of value for CH6 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH7(value)               (DMA_INTSTAT3_CH7_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH7_Pos)) /* Assignment of value for CH7 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH8(value)               (DMA_INTSTAT3_CH8_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH8_Pos)) /* Assignment of value for CH8 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH9(value)               (DMA_INTSTAT3_CH9_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH9_Pos)) /* Assignment of value for CH9 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH10(value)              (DMA_INTSTAT3_CH10_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH10_Pos)) /* Assignment of value for CH10 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH11(value)              (DMA_INTSTAT3_CH11_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH11_Pos)) /* Assignment of value for CH11 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH12(value)              (DMA_INTSTAT3_CH12_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH12_Pos)) /* Assignment of value for CH12 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH13(value)              (DMA_INTSTAT3_CH13_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH13_Pos)) /* Assignment of value for CH13 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH14(value)              (DMA_INTSTAT3_CH14_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH14_Pos)) /* Assignment of value for CH14 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH15(value)              (DMA_INTSTAT3_CH15_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH15_Pos)) /* Assignment of value for CH15 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH16(value)              (DMA_INTSTAT3_CH16_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH16_Pos)) /* Assignment of value for CH16 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH17(value)              (DMA_INTSTAT3_CH17_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH17_Pos)) /* Assignment of value for CH17 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH18(value)              (DMA_INTSTAT3_CH18_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH18_Pos)) /* Assignment of value for CH18 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH19(value)              (DMA_INTSTAT3_CH19_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH19_Pos)) /* Assignment of value for CH19 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH20(value)              (DMA_INTSTAT3_CH20_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH20_Pos)) /* Assignment of value for CH20 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH21(value)              (DMA_INTSTAT3_CH21_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH21_Pos)) /* Assignment of value for CH21 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH22(value)              (DMA_INTSTAT3_CH22_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH22_Pos)) /* Assignment of value for CH22 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT3_CH23(value)              (DMA_INTSTAT3_CH23_Msk & (_UINT32_(value) << DMA_INTSTAT3_CH23_Pos)) /* Assignment of value for CH23 in the DMA_INTSTAT3 register */
...
#define DMA_INTSTAT2_CH0(value)               (DMA_INTSTAT2_CH0_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH0_Pos)) /* Assignment of value for CH0 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH1(value)               (DMA_INTSTAT2_CH1_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH1_Pos)) /* Assignment of value for CH1 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH2(value)               (DMA_INTSTAT2_CH2_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH2_Pos)) /* Assignment of value for CH2 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH3(value)               (DMA_INTSTAT2_CH3_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH3_Pos)) /* Assignment of value for CH3 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH4(value)               (DMA_INTSTAT2_CH4_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH4_Pos)) /* Assignment of value for CH4 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH5(value)               (DMA_INTSTAT2_CH5_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH5_Pos)) /* Assignment of value for CH5 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH6(value)               (DMA_INTSTAT2_CH6_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH6_Pos)) /* Assignment of value for CH6 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH7(value)               (DMA_INTSTAT2_CH7_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH7_Pos)) /* Assignment of value for CH7 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH8(value)               (DMA_INTSTAT2_CH8_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH8_Pos)) /* Assignment of value for CH8 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH9(value)               (DMA_INTSTAT2_CH9_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH9_Pos)) /* Assignment of value for CH9 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH10(value)              (DMA_INTSTAT2_CH10_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH10_Pos)) /* Assignment of value for CH10 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH11(value)              (DMA_INTSTAT2_CH11_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH11_Pos)) /* Assignment of value for CH11 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH12(value)              (DMA_INTSTAT2_CH12_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH12_Pos)) /* Assignment of value for CH12 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH13(value)              (DMA_INTSTAT2_CH13_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH13_Pos)) /* Assignment of value for CH13 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH14(value)              (DMA_INTSTAT2_CH14_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH14_Pos)) /* Assignment of value for CH14 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH15(value)              (DMA_INTSTAT2_CH15_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH15_Pos)) /* Assignment of value for CH15 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH16(value)              (DMA_INTSTAT2_CH16_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH16_Pos)) /* Assignment of value for CH16 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH17(value)              (DMA_INTSTAT2_CH17_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH17_Pos)) /* Assignment of value for CH17 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH18(value)              (DMA_INTSTAT2_CH18_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH18_Pos)) /* Assignment of value for CH18 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH19(value)              (DMA_INTSTAT2_CH19_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH19_Pos)) /* Assignment of value for CH19 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH20(value)              (DMA_INTSTAT2_CH20_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH20_Pos)) /* Assignment of value for CH20 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH21(value)              (DMA_INTSTAT2_CH21_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH21_Pos)) /* Assignment of value for CH21 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH22(value)              (DMA_INTSTAT2_CH22_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH22_Pos)) /* Assignment of value for CH22 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT2_CH23(value)              (DMA_INTSTAT2_CH23_Msk & (_UINT32_(value) << DMA_INTSTAT2_CH23_Pos)) /* Assignment of value for CH23 in the DMA_INTSTAT2 register */
...
#define DMA_INTSTAT1_CH0(value)               (DMA_INTSTAT1_CH0_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH0_Pos)) /* Assignment of value for CH0 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH1(value)               (DMA_INTSTAT1_CH1_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH1_Pos)) /* Assignment of value for CH1 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH2(value)               (DMA_INTSTAT1_CH2_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH2_Pos)) /* Assignment of value for CH2 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH3(value)               (DMA_INTSTAT1_CH3_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH3_Pos)) /* Assignment of value for CH3 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH4(value)               (DMA_INTSTAT1_CH4_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH4_Pos)) /* Assignment of value for CH4 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH5(value)               (DMA_INTSTAT1_CH5_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH5_Pos)) /* Assignment of value for CH5 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH6(value)               (DMA_INTSTAT1_CH6_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH6_Pos)) /* Assignment of value for CH6 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH7(value)               (DMA_INTSTAT1_CH7_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH7_Pos)) /* Assignment of value for CH7 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH8(value)               (DMA_INTSTAT1_CH8_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH8_Pos)) /* Assignment of value for CH8 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH9(value)               (DMA_INTSTAT1_CH9_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH9_Pos)) /* Assignment of value for CH9 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH10(value)              (DMA_INTSTAT1_CH10_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH10_Pos)) /* Assignment of value for CH10 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH11(value)              (DMA_INTSTAT1_CH11_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH11_Pos)) /* Assignment of value for CH11 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH12(value)              (DMA_INTSTAT1_CH12_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH12_Pos)) /* Assignment of value for CH12 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH13(value)              (DMA_INTSTAT1_CH13_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH13_Pos)) /* Assignment of value for CH13 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH14(value)              (DMA_INTSTAT1_CH14_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH14_Pos)) /* Assignment of value for CH14 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH15(value)              (DMA_INTSTAT1_CH15_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH15_Pos)) /* Assignment of value for CH15 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH16(value)              (DMA_INTSTAT1_CH16_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH16_Pos)) /* Assignment of value for CH16 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH17(value)              (DMA_INTSTAT1_CH17_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH17_Pos)) /* Assignment of value for CH17 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH18(value)              (DMA_INTSTAT1_CH18_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH18_Pos)) /* Assignment of value for CH18 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH19(value)              (DMA_INTSTAT1_CH19_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH19_Pos)) /* Assignment of value for CH19 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH20(value)              (DMA_INTSTAT1_CH20_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH20_Pos)) /* Assignment of value for CH20 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH21(value)              (DMA_INTSTAT1_CH21_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH21_Pos)) /* Assignment of value for CH21 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH22(value)              (DMA_INTSTAT1_CH22_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH22_Pos)) /* Assignment of value for CH22 in the DMA_INTSTAT1 register */
...
#define DMA_INTSTAT1_CH23(value)              (DMA_INTSTAT1_CH23_Msk & (_UINT32_(value) << DMA_INTSTAT1_CH23_Pos)) /* Assignment of value for CH23 in the DMA_INTSTAT1 register */
...
/* DMA register offsets definitions */
...
#define DMA_CTRLB_REG_OFST             _UINT32_(0x04)      /* (DMA_CTRLB) DMA CONTROL B REGISTER Offset */
...
/* DMA_DESCRIPTOR register API structure */
typedef struct
...
/* DMA register API structure */
typedef struct
{  /* Direct Memory Access Controller */
  __IO  uint32_t                       DMA_CTRLA;          /* Offset: 0x00 (R/W  32) DMA CONTROL A REGISTER */
  __IO  uint32_t                       DMA_CTRLB;          /* Offset: 0x04 (R/W  32) DMA CONTROL B REGISTER */
...
/* DMA_DESCRIPTOR memory section attribute */
#if defined (__GNUC__) || defined (__CC_ARM)
 #define SECTION_DMA_DESCRIPTOR       __attribute__ ((section(".hsram")))
#elif defined (__ICCARM__)
 #define SECTION_DMA_DESCRIPTOR       @".hsram"
#else
 #ifndef SECTION_DMA_DESCRIPTOR
  #error SECTION_DMA_DESCRIPTOR must be defined for compiler to use memory section .hsram
 #endif
#endif

#endif /* _PIC32CKGC01_DMA_COMPONENT_H_ */
