...
#ifndef _PIC32CKGC01_SDMMC_COMPONENT_H_
#define _PIC32CKGC01_SDMMC_COMPONENT_H_
...
#define SDMMC_SSAR_ADDR(value)                (SDMMC_SSAR_ADDR_Msk & (_UINT32_(value) << SDMMC_SSAR_ADDR_Pos)) /* Assignment of value for ADDR in the SDMMC_SSAR register */
...
#define SDMMC_BSR_BLOCKSIZE(value)            (SDMMC_BSR_BLOCKSIZE_Msk & (_UINT16_(value) << SDMMC_BSR_BLOCKSIZE_Pos)) /* Assignment of value for BLOCKSIZE in the SDMMC_BSR register */
...
#define SDMMC_BSR_BOUNDARY(value)             (SDMMC_BSR_BOUNDARY_Msk & (_UINT16_(value) << SDMMC_BSR_BOUNDARY_Pos)) /* Assignment of value for BOUNDARY in the SDMMC_BSR register */
...
#define SDMMC_BCR_BCNT(value)                 (SDMMC_BCR_BCNT_Msk & (_UINT16_(value) << SDMMC_BCR_BCNT_Pos)) /* Assignment of value for BCNT in the SDMMC_BCR register */
...
#define SDMMC_ARG1R_ARG(value)                (SDMMC_ARG1R_ARG_Msk & (_UINT32_(value) << SDMMC_ARG1R_ARG_Pos)) /* Assignment of value for ARG in the SDMMC_ARG1R register */
...
#define SDMMC_TMR_DMAEN(value)                (SDMMC_TMR_DMAEN_Msk & (_UINT16_(value) << SDMMC_TMR_DMAEN_Pos)) /* Assignment of value for DMAEN in the SDMMC_TMR register */
...
#define SDMMC_TMR_BCEN(value)                 (SDMMC_TMR_BCEN_Msk & (_UINT16_(value) << SDMMC_TMR_BCEN_Pos)) /* Assignment of value for BCEN in the SDMMC_TMR register */
...
#define SDMMC_TMR_ACMDEN(value)               (SDMMC_TMR_ACMDEN_Msk & (_UINT16_(value) << SDMMC_TMR_ACMDEN_Pos)) /* Assignment of value for ACMDEN in the SDMMC_TMR register */
...
#define SDMMC_TMR_DTDSEL(value)               (SDMMC_TMR_DTDSEL_Msk & (_UINT16_(value) << SDMMC_TMR_DTDSEL_Pos)) /* Assignment of value for DTDSEL in the SDMMC_TMR register */
...
#define SDMMC_TMR_MSBSEL(value)               (SDMMC_TMR_MSBSEL_Msk & (_UINT16_(value) << SDMMC_TMR_MSBSEL_Pos)) /* Assignment of value for MSBSEL in the SDMMC_TMR register */
...
#define SDMMC_CR_RESPTYP(value)               (SDMMC_CR_RESPTYP_Msk & (_UINT16_(value) << SDMMC_CR_RESPTYP_Pos)) /* Assignment of value for RESPTYP in the SDMMC_CR register */
...
#define SDMMC_CR_CMDCCEN(value)               (SDMMC_CR_CMDCCEN_Msk & (_UINT16_(value) << SDMMC_CR_CMDCCEN_Pos)) /* Assignment of value for CMDCCEN in the SDMMC_CR register */
...
#define SDMMC_CR_CMDICEN(value)               (SDMMC_CR_CMDICEN_Msk & (_UINT16_(value) << SDMMC_CR_CMDICEN_Pos)) /* Assignment of value for CMDICEN in the SDMMC_CR register */
...
#define SDMMC_CR_DPSEL(value)                 (SDMMC_CR_DPSEL_Msk & (_UINT16_(value) << SDMMC_CR_DPSEL_Pos)) /* Assignment of value for DPSEL in the SDMMC_CR register */
...
#define SDMMC_CR_CMDTYP(value)                (SDMMC_CR_CMDTYP_Msk & (_UINT16_(value) << SDMMC_CR_CMDTYP_Pos)) /* Assignment of value for CMDTYP in the SDMMC_CR register */
...
#define SDMMC_CR_CMDIDX(value)                (SDMMC_CR_CMDIDX_Msk & (_UINT16_(value) << SDMMC_CR_CMDIDX_Pos)) /* Assignment of value for CMDIDX in the SDMMC_CR register */
...
#define SDMMC_RR_CMDRESP(value)               (SDMMC_RR_CMDRESP_Msk & (_UINT32_(value) << SDMMC_RR_CMDRESP_Pos)) /* Assignment of value for CMDRESP in the SDMMC_RR register */
...
#define SDMMC_BDPR_BUFDATA(value)             (SDMMC_BDPR_BUFDATA_Msk & (_UINT32_(value) << SDMMC_BDPR_BUFDATA_Pos)) /* Assignment of value for BUFDATA in the SDMMC_BDPR register */
...
#define SDMMC_PSR_CMDINHC(value)              (SDMMC_PSR_CMDINHC_Msk & (_UINT32_(value) << SDMMC_PSR_CMDINHC_Pos)) /* Assignment of value for CMDINHC in the SDMMC_PSR register */
...
#define SDMMC_PSR_CMDINHD(value)              (SDMMC_PSR_CMDINHD_Msk & (_UINT32_(value) << SDMMC_PSR_CMDINHD_Pos)) /* Assignment of value for CMDINHD in the SDMMC_PSR register */
...
#define SDMMC_PSR_DLACT(value)                (SDMMC_PSR_DLACT_Msk & (_UINT32_(value) << SDMMC_PSR_DLACT_Pos)) /* Assignment of value for DLACT in the SDMMC_PSR register */
...
#define SDMMC_PSR_RTREQ(value)                (SDMMC_PSR_RTREQ_Msk & (_UINT32_(value) << SDMMC_PSR_RTREQ_Pos)) /* Assignment of value for RTREQ in the SDMMC_PSR register */
...
#define SDMMC_PSR_WTACT(value)                (SDMMC_PSR_WTACT_Msk & (_UINT32_(value) << SDMMC_PSR_WTACT_Pos)) /* Assignment of value for WTACT in the SDMMC_PSR register */
...
#define SDMMC_PSR_RTACT(value)                (SDMMC_PSR_RTACT_Msk & (_UINT32_(value) << SDMMC_PSR_RTACT_Pos)) /* Assignment of value for RTACT in the SDMMC_PSR register */
...
#define SDMMC_PSR_BUFWREN(value)              (SDMMC_PSR_BUFWREN_Msk & (_UINT32_(value) << SDMMC_PSR_BUFWREN_Pos)) /* Assignment of value for BUFWREN in the SDMMC_PSR register */
...
#define SDMMC_PSR_BUFRDEN(value)              (SDMMC_PSR_BUFRDEN_Msk & (_UINT32_(value) << SDMMC_PSR_BUFRDEN_Pos)) /* Assignment of value for BUFRDEN in the SDMMC_PSR register */
...
#define SDMMC_PSR_CARDINS(value)              (SDMMC_PSR_CARDINS_Msk & (_UINT32_(value) << SDMMC_PSR_CARDINS_Pos)) /* Assignment of value for CARDINS in the SDMMC_PSR register */
...
#define SDMMC_PSR_CARDSS(value)               (SDMMC_PSR_CARDSS_Msk & (_UINT32_(value) << SDMMC_PSR_CARDSS_Pos)) /* Assignment of value for CARDSS in the SDMMC_PSR register */
...
#define SDMMC_PSR_CARDDPL(value)              (SDMMC_PSR_CARDDPL_Msk & (_UINT32_(value) << SDMMC_PSR_CARDDPL_Pos)) /* Assignment of value for CARDDPL in the SDMMC_PSR register */
...
#define SDMMC_PSR_WRPPL(value)                (SDMMC_PSR_WRPPL_Msk & (_UINT32_(value) << SDMMC_PSR_WRPPL_Pos)) /* Assignment of value for WRPPL in the SDMMC_PSR register */
...
#define SDMMC_PSR_DATLL(value)                (SDMMC_PSR_DATLL_Msk & (_UINT32_(value) << SDMMC_PSR_DATLL_Pos)) /* Assignment of value for DATLL in the SDMMC_PSR register */
...
#define SDMMC_PSR_CMDLL(value)                (SDMMC_PSR_CMDLL_Msk & (_UINT32_(value) << SDMMC_PSR_CMDLL_Pos)) /* Assignment of value for CMDLL in the SDMMC_PSR register */
...
#define SDMMC_HC1R_LEDCTRL(value)             (SDMMC_HC1R_LEDCTRL_Msk & (_UINT8_(value) << SDMMC_HC1R_LEDCTRL_Pos)) /* Assignment of value for LEDCTRL in the SDMMC_HC1R register */
...
#define SDMMC_HC1R_DW(value)                  (SDMMC_HC1R_DW_Msk & (_UINT8_(value) << SDMMC_HC1R_DW_Pos)) /* Assignment of value for DW in the SDMMC_HC1R register */
...
#define SDMMC_HC1R_HSEN(value)                (SDMMC_HC1R_HSEN_Msk & (_UINT8_(value) << SDMMC_HC1R_HSEN_Pos)) /* Assignment of value for HSEN in the SDMMC_HC1R register */
...
#define SDMMC_HC1R_DMASEL(value)              (SDMMC_HC1R_DMASEL_Msk & (_UINT8_(value) << SDMMC_HC1R_DMASEL_Pos)) /* Assignment of value for DMASEL in the SDMMC_HC1R register */
...
#define SDMMC_HC1R_CARDDTL(value)             (SDMMC_HC1R_CARDDTL_Msk & (_UINT8_(value) << SDMMC_HC1R_CARDDTL_Pos)) /* Assignment of value for CARDDTL in the SDMMC_HC1R register */
...
#define SDMMC_HC1R_CARDDSEL(value)            (SDMMC_HC1R_CARDDSEL_Msk & (_UINT8_(value) << SDMMC_HC1R_CARDDSEL_Pos)) /* Assignment of value for CARDDSEL in the SDMMC_HC1R register */
...
#define SDMMC_PCR_SDBPWR(value)               (SDMMC_PCR_SDBPWR_Msk & (_UINT8_(value) << SDMMC_PCR_SDBPWR_Pos)) /* Assignment of value for SDBPWR in the SDMMC_PCR register */
...
#define SDMMC_PCR_SDBVSEL(value)              (SDMMC_PCR_SDBVSEL_Msk & (_UINT8_(value) << SDMMC_PCR_SDBVSEL_Pos)) /* Assignment of value for SDBVSEL in the SDMMC_PCR register */
...
#define SDMMC_BGCR_STPBGR(value)              (SDMMC_BGCR_STPBGR_Msk & (_UINT8_(value) << SDMMC_BGCR_STPBGR_Pos)) /* Assignment of value for STPBGR in the SDMMC_BGCR register */
...
#define SDMMC_BGCR_CONTR(value)               (SDMMC_BGCR_CONTR_Msk & (_UINT8_(value) << SDMMC_BGCR_CONTR_Pos)) /* Assignment of value for CONTR in the SDMMC_BGCR register */
...
#define SDMMC_BGCR_RWCTRL(value)              (SDMMC_BGCR_RWCTRL_Msk & (_UINT8_(value) << SDMMC_BGCR_RWCTRL_Pos)) /* Assignment of value for RWCTRL in the SDMMC_BGCR register */
...
#define SDMMC_BGCR_INTBG(value)               (SDMMC_BGCR_INTBG_Msk & (_UINT8_(value) << SDMMC_BGCR_INTBG_Pos)) /* Assignment of value for INTBG in the SDMMC_BGCR register */
...
#define SDMMC_CCR_INTCLKEN(value)             (SDMMC_CCR_INTCLKEN_Msk & (_UINT16_(value) << SDMMC_CCR_INTCLKEN_Pos)) /* Assignment of value for INTCLKEN in the SDMMC_CCR register */
...
#define SDMMC_CCR_INTCLKS(value)              (SDMMC_CCR_INTCLKS_Msk & (_UINT16_(value) << SDMMC_CCR_INTCLKS_Pos)) /* Assignment of value for INTCLKS in the SDMMC_CCR register */
...
#define SDMMC_CCR_SDCLKEN(value)              (SDMMC_CCR_SDCLKEN_Msk & (_UINT16_(value) << SDMMC_CCR_SDCLKEN_Pos)) /* Assignment of value for SDCLKEN in the SDMMC_CCR register */
...
#define SDMMC_CCR_CLKGSEL(value)              (SDMMC_CCR_CLKGSEL_Msk & (_UINT16_(value) << SDMMC_CCR_CLKGSEL_Pos)) /* Assignment of value for CLKGSEL in the SDMMC_CCR register */
...
#define SDMMC_CCR_USDCLKFSEL(value)           (SDMMC_CCR_USDCLKFSEL_Msk & (_UINT16_(value) << SDMMC_CCR_USDCLKFSEL_Pos)) /* Assignment of value for USDCLKFSEL in the SDMMC_CCR register */
...
#define SDMMC_CCR_SDCLKFSEL(value)            (SDMMC_CCR_SDCLKFSEL_Msk & (_UINT16_(value) << SDMMC_CCR_SDCLKFSEL_Pos)) /* Assignment of value for SDCLKFSEL in the SDMMC_CCR register */
...
#define SDMMC_TCR_DTCVAL(value)               (SDMMC_TCR_DTCVAL_Msk & (_UINT8_(value) << SDMMC_TCR_DTCVAL_Pos)) /* Assignment of value for DTCVAL in the SDMMC_TCR register */
...
#define SDMMC_SRR_SWRSTALL(value)             (SDMMC_SRR_SWRSTALL_Msk & (_UINT8_(value) << SDMMC_SRR_SWRSTALL_Pos)) /* Assignment of value for SWRSTALL in the SDMMC_SRR register */
...
#define SDMMC_SRR_SWRSTCMD(value)             (SDMMC_SRR_SWRSTCMD_Msk & (_UINT8_(value) << SDMMC_SRR_SWRSTCMD_Pos)) /* Assignment of value for SWRSTCMD in the SDMMC_SRR register */
...
#define SDMMC_SRR_SWRSTDAT(value)             (SDMMC_SRR_SWRSTDAT_Msk & (_UINT8_(value) << SDMMC_SRR_SWRSTDAT_Pos)) /* Assignment of value for SWRSTDAT in the SDMMC_SRR register */
...
#define SDMMC_NISTR_CMDC(value)               (SDMMC_NISTR_CMDC_Msk & (_UINT16_(value) << SDMMC_NISTR_CMDC_Pos)) /* Assignment of value for CMDC in the SDMMC_NISTR register */
...
#define SDMMC_NISTR_TRFC(value)               (SDMMC_NISTR_TRFC_Msk & (_UINT16_(value) << SDMMC_NISTR_TRFC_Pos)) /* Assignment of value for TRFC in the SDMMC_NISTR register */
...
#define SDMMC_NISTR_BLKGE(value)              (SDMMC_NISTR_BLKGE_Msk & (_UINT16_(value) << SDMMC_NISTR_BLKGE_Pos)) /* Assignment of value for BLKGE in the SDMMC_NISTR register */
...
#define SDMMC_NISTR_DMAINT(value)             (SDMMC_NISTR_DMAINT_Msk & (_UINT16_(value) << SDMMC_NISTR_DMAINT_Pos)) /* Assignment of value for DMAINT in the SDMMC_NISTR register */
...
#define SDMMC_NISTR_BWRRDY(value)             (SDMMC_NISTR_BWRRDY_Msk & (_UINT16_(value) << SDMMC_NISTR_BWRRDY_Pos)) /* Assignment of value for BWRRDY in the SDMMC_NISTR register */
...
#define SDMMC_NISTR_BRDRDY(value)             (SDMMC_NISTR_BRDRDY_Msk & (_UINT16_(value) << SDMMC_NISTR_BRDRDY_Pos)) /* Assignment of value for BRDRDY in the SDMMC_NISTR register */
...
#define SDMMC_NISTR_CINS(value)               (SDMMC_NISTR_CINS_Msk & (_UINT16_(value) << SDMMC_NISTR_CINS_Pos)) /* Assignment of value for CINS in the SDMMC_NISTR register */
...
#define SDMMC_NISTR_CREM(value)               (SDMMC_NISTR_CREM_Msk & (_UINT16_(value) << SDMMC_NISTR_CREM_Pos)) /* Assignment of value for CREM in the SDMMC_NISTR register */
...
#define SDMMC_NISTR_CINT(value)               (SDMMC_NISTR_CINT_Msk & (_UINT16_(value) << SDMMC_NISTR_CINT_Pos)) /* Assignment of value for CINT in the SDMMC_NISTR register */
...
#define SDMMC_NISTR_ERRINT(value)             (SDMMC_NISTR_ERRINT_Msk & (_UINT16_(value) << SDMMC_NISTR_ERRINT_Pos)) /* Assignment of value for ERRINT in the SDMMC_NISTR register */
...
#define SDMMC_EISTR_CMDTEO(value)             (SDMMC_EISTR_CMDTEO_Msk & (_UINT16_(value) << SDMMC_EISTR_CMDTEO_Pos)) /* Assignment of value for CMDTEO in the SDMMC_EISTR register */
...
#define SDMMC_EISTR_CMDCRC(value)             (SDMMC_EISTR_CMDCRC_Msk & (_UINT16_(value) << SDMMC_EISTR_CMDCRC_Pos)) /* Assignment of value for CMDCRC in the SDMMC_EISTR register */
...
#define SDMMC_EISTR_CMDEND(value)             (SDMMC_EISTR_CMDEND_Msk & (_UINT16_(value) << SDMMC_EISTR_CMDEND_Pos)) /* Assignment of value for CMDEND in the SDMMC_EISTR register */
...
#define SDMMC_EISTR_CMDIDX(value)             (SDMMC_EISTR_CMDIDX_Msk & (_UINT16_(value) << SDMMC_EISTR_CMDIDX_Pos)) /* Assignment of value for CMDIDX in the SDMMC_EISTR register */
...
#define SDMMC_EISTR_DATTEO(value)             (SDMMC_EISTR_DATTEO_Msk & (_UINT16_(value) << SDMMC_EISTR_DATTEO_Pos)) /* Assignment of value for DATTEO in the SDMMC_EISTR register */
...
#define SDMMC_EISTR_DATCRC(value)             (SDMMC_EISTR_DATCRC_Msk & (_UINT16_(value) << SDMMC_EISTR_DATCRC_Pos)) /* Assignment of value for DATCRC in the SDMMC_EISTR register */
...
#define SDMMC_EISTR_DATEND(value)             (SDMMC_EISTR_DATEND_Msk & (_UINT16_(value) << SDMMC_EISTR_DATEND_Pos)) /* Assignment of value for DATEND in the SDMMC_EISTR register */
...
#define SDMMC_EISTR_CURLIM(value)             (SDMMC_EISTR_CURLIM_Msk & (_UINT16_(value) << SDMMC_EISTR_CURLIM_Pos)) /* Assignment of value for CURLIM in the SDMMC_EISTR register */
...
#define SDMMC_EISTR_ACMD(value)               (SDMMC_EISTR_ACMD_Msk & (_UINT16_(value) << SDMMC_EISTR_ACMD_Pos)) /* Assignment of value for ACMD in the SDMMC_EISTR register */
...
#define SDMMC_EISTR_ADMA(value)               (SDMMC_EISTR_ADMA_Msk & (_UINT16_(value) << SDMMC_EISTR_ADMA_Pos)) /* Assignment of value for ADMA in the SDMMC_EISTR register */
...
#define SDMMC_NISTER_CMDC(value)              (SDMMC_NISTER_CMDC_Msk & (_UINT16_(value) << SDMMC_NISTER_CMDC_Pos)) /* Assignment of value for CMDC in the SDMMC_NISTER register */
...
#define SDMMC_NISTER_TRFC(value)              (SDMMC_NISTER_TRFC_Msk & (_UINT16_(value) << SDMMC_NISTER_TRFC_Pos)) /* Assignment of value for TRFC in the SDMMC_NISTER register */
...
#define SDMMC_NISTER_BLKGE(value)             (SDMMC_NISTER_BLKGE_Msk & (_UINT16_(value) << SDMMC_NISTER_BLKGE_Pos)) /* Assignment of value for BLKGE in the SDMMC_NISTER register */
...
#define SDMMC_NISTER_DMAINT(value)            (SDMMC_NISTER_DMAINT_Msk & (_UINT16_(value) << SDMMC_NISTER_DMAINT_Pos)) /* Assignment of value for DMAINT in the SDMMC_NISTER register */
...
#define SDMMC_NISTER_BWRRDY(value)            (SDMMC_NISTER_BWRRDY_Msk & (_UINT16_(value) << SDMMC_NISTER_BWRRDY_Pos)) /* Assignment of value for BWRRDY in the SDMMC_NISTER register */
...
#define SDMMC_NISTER_BRDRDY(value)            (SDMMC_NISTER_BRDRDY_Msk & (_UINT16_(value) << SDMMC_NISTER_BRDRDY_Pos)) /* Assignment of value for BRDRDY in the SDMMC_NISTER register */
...
#define SDMMC_NISTER_CINS(value)              (SDMMC_NISTER_CINS_Msk & (_UINT16_(value) << SDMMC_NISTER_CINS_Pos)) /* Assignment of value for CINS in the SDMMC_NISTER register */
...
#define SDMMC_NISTER_CREM(value)              (SDMMC_NISTER_CREM_Msk & (_UINT16_(value) << SDMMC_NISTER_CREM_Pos)) /* Assignment of value for CREM in the SDMMC_NISTER register */
...
#define SDMMC_NISTER_CINT(value)              (SDMMC_NISTER_CINT_Msk & (_UINT16_(value) << SDMMC_NISTER_CINT_Pos)) /* Assignment of value for CINT in the SDMMC_NISTER register */
...
#define SDMMC_EISTER_CMDTEO(value)            (SDMMC_EISTER_CMDTEO_Msk & (_UINT16_(value) << SDMMC_EISTER_CMDTEO_Pos)) /* Assignment of value for CMDTEO in the SDMMC_EISTER register */
...
#define SDMMC_EISTER_CMDCRC(value)            (SDMMC_EISTER_CMDCRC_Msk & (_UINT16_(value) << SDMMC_EISTER_CMDCRC_Pos)) /* Assignment of value for CMDCRC in the SDMMC_EISTER register */
...
#define SDMMC_EISTER_CMDEND(value)            (SDMMC_EISTER_CMDEND_Msk & (_UINT16_(value) << SDMMC_EISTER_CMDEND_Pos)) /* Assignment of value for CMDEND in the SDMMC_EISTER register */
...
#define SDMMC_EISTER_CMDIDX(value)            (SDMMC_EISTER_CMDIDX_Msk & (_UINT16_(value) << SDMMC_EISTER_CMDIDX_Pos)) /* Assignment of value for CMDIDX in the SDMMC_EISTER register */
...
#define SDMMC_EISTER_DATTEO(value)            (SDMMC_EISTER_DATTEO_Msk & (_UINT16_(value) << SDMMC_EISTER_DATTEO_Pos)) /* Assignment of value for DATTEO in the SDMMC_EISTER register */
...
#define SDMMC_EISTER_DATCRC(value)            (SDMMC_EISTER_DATCRC_Msk & (_UINT16_(value) << SDMMC_EISTER_DATCRC_Pos)) /* Assignment of value for DATCRC in the SDMMC_EISTER register */
...
#define SDMMC_EISTER_DATEND(value)            (SDMMC_EISTER_DATEND_Msk & (_UINT16_(value) << SDMMC_EISTER_DATEND_Pos)) /* Assignment of value for DATEND in the SDMMC_EISTER register */
...
#define SDMMC_EISTER_CURLIM(value)            (SDMMC_EISTER_CURLIM_Msk & (_UINT16_(value) << SDMMC_EISTER_CURLIM_Pos)) /* Assignment of value for CURLIM in the SDMMC_EISTER register */
...
#define SDMMC_EISTER_ACMD(value)              (SDMMC_EISTER_ACMD_Msk & (_UINT16_(value) << SDMMC_EISTER_ACMD_Pos)) /* Assignment of value for ACMD in the SDMMC_EISTER register */
...
#define SDMMC_EISTER_ADMA(value)              (SDMMC_EISTER_ADMA_Msk & (_UINT16_(value) << SDMMC_EISTER_ADMA_Pos)) /* Assignment of value for ADMA in the SDMMC_EISTER register */
...
#define SDMMC_NISIER_CMDC(value)              (SDMMC_NISIER_CMDC_Msk & (_UINT16_(value) << SDMMC_NISIER_CMDC_Pos)) /* Assignment of value for CMDC in the SDMMC_NISIER register */
...
#define SDMMC_NISIER_TRFC(value)              (SDMMC_NISIER_TRFC_Msk & (_UINT16_(value) << SDMMC_NISIER_TRFC_Pos)) /* Assignment of value for TRFC in the SDMMC_NISIER register */
...
#define SDMMC_NISIER_BLKGE(value)             (SDMMC_NISIER_BLKGE_Msk & (_UINT16_(value) << SDMMC_NISIER_BLKGE_Pos)) /* Assignment of value for BLKGE in the SDMMC_NISIER register */
...
#define SDMMC_NISIER_DMAINT(value)            (SDMMC_NISIER_DMAINT_Msk & (_UINT16_(value) << SDMMC_NISIER_DMAINT_Pos)) /* Assignment of value for DMAINT in the SDMMC_NISIER register */
...
#define SDMMC_NISIER_BWRRDY(value)            (SDMMC_NISIER_BWRRDY_Msk & (_UINT16_(value) << SDMMC_NISIER_BWRRDY_Pos)) /* Assignment of value for BWRRDY in the SDMMC_NISIER register */
...
#define SDMMC_NISIER_BRDRDY(value)            (SDMMC_NISIER_BRDRDY_Msk & (_UINT16_(value) << SDMMC_NISIER_BRDRDY_Pos)) /* Assignment of value for BRDRDY in the SDMMC_NISIER register */
...
#define SDMMC_NISIER_CINS(value)              (SDMMC_NISIER_CINS_Msk & (_UINT16_(value) << SDMMC_NISIER_CINS_Pos)) /* Assignment of value for CINS in the SDMMC_NISIER register */
...
#define SDMMC_NISIER_CREM(value)              (SDMMC_NISIER_CREM_Msk & (_UINT16_(value) << SDMMC_NISIER_CREM_Pos)) /* Assignment of value for CREM in the SDMMC_NISIER register */
...
#define SDMMC_NISIER_CINT(value)              (SDMMC_NISIER_CINT_Msk & (_UINT16_(value) << SDMMC_NISIER_CINT_Pos)) /* Assignment of value for CINT in the SDMMC_NISIER register */
...
#define SDMMC_EISIER_CMDTEO(value)            (SDMMC_EISIER_CMDTEO_Msk & (_UINT16_(value) << SDMMC_EISIER_CMDTEO_Pos)) /* Assignment of value for CMDTEO in the SDMMC_EISIER register */
...
#define SDMMC_EISIER_CMDCRC(value)            (SDMMC_EISIER_CMDCRC_Msk & (_UINT16_(value) << SDMMC_EISIER_CMDCRC_Pos)) /* Assignment of value for CMDCRC in the SDMMC_EISIER register */
...
#define SDMMC_EISIER_CMDEND(value)            (SDMMC_EISIER_CMDEND_Msk & (_UINT16_(value) << SDMMC_EISIER_CMDEND_Pos)) /* Assignment of value for CMDEND in the SDMMC_EISIER register */
...
#define SDMMC_EISIER_CMDIDX(value)            (SDMMC_EISIER_CMDIDX_Msk & (_UINT16_(value) << SDMMC_EISIER_CMDIDX_Pos)) /* Assignment of value for CMDIDX in the SDMMC_EISIER register */
...
#define SDMMC_EISIER_DATTEO(value)            (SDMMC_EISIER_DATTEO_Msk & (_UINT16_(value) << SDMMC_EISIER_DATTEO_Pos)) /* Assignment of value for DATTEO in the SDMMC_EISIER register */
...
#define SDMMC_EISIER_DATCRC(value)            (SDMMC_EISIER_DATCRC_Msk & (_UINT16_(value) << SDMMC_EISIER_DATCRC_Pos)) /* Assignment of value for DATCRC in the SDMMC_EISIER register */
...
#define SDMMC_EISIER_DATEND(value)            (SDMMC_EISIER_DATEND_Msk & (_UINT16_(value) << SDMMC_EISIER_DATEND_Pos)) /* Assignment of value for DATEND in the SDMMC_EISIER register */
...
#define SDMMC_EISIER_CURLIM(value)            (SDMMC_EISIER_CURLIM_Msk & (_UINT16_(value) << SDMMC_EISIER_CURLIM_Pos)) /* Assignment of value for CURLIM in the SDMMC_EISIER register */
...
#define SDMMC_EISIER_ACMD(value)              (SDMMC_EISIER_ACMD_Msk & (_UINT16_(value) << SDMMC_EISIER_ACMD_Pos)) /* Assignment of value for ACMD in the SDMMC_EISIER register */
...
#define SDMMC_EISIER_ADMA(value)              (SDMMC_EISIER_ADMA_Msk & (_UINT16_(value) << SDMMC_EISIER_ADMA_Pos)) /* Assignment of value for ADMA in the SDMMC_EISIER register */
...
#define SDMMC_ACESR_ACMD12NE(value)           (SDMMC_ACESR_ACMD12NE_Msk & (_UINT16_(value) << SDMMC_ACESR_ACMD12NE_Pos)) /* Assignment of value for ACMD12NE in the SDMMC_ACESR register */
...
#define SDMMC_ACESR_ACMDTEO(value)            (SDMMC_ACESR_ACMDTEO_Msk & (_UINT16_(value) << SDMMC_ACESR_ACMDTEO_Pos)) /* Assignment of value for ACMDTEO in the SDMMC_ACESR register */
...
#define SDMMC_ACESR_ACMDCRC(value)            (SDMMC_ACESR_ACMDCRC_Msk & (_UINT16_(value) << SDMMC_ACESR_ACMDCRC_Pos)) /* Assignment of value for ACMDCRC in the SDMMC_ACESR register */
...
#define SDMMC_ACESR_ACMDEND(value)            (SDMMC_ACESR_ACMDEND_Msk & (_UINT16_(value) << SDMMC_ACESR_ACMDEND_Pos)) /* Assignment of value for ACMDEND in the SDMMC_ACESR register */
...
#define SDMMC_ACESR_ACMDIDX(value)            (SDMMC_ACESR_ACMDIDX_Msk & (_UINT16_(value) << SDMMC_ACESR_ACMDIDX_Pos)) /* Assignment of value for ACMDIDX in the SDMMC_ACESR register */
...
#define SDMMC_ACESR_CMDNI(value)              (SDMMC_ACESR_CMDNI_Msk & (_UINT16_(value) << SDMMC_ACESR_CMDNI_Pos)) /* Assignment of value for CMDNI in the SDMMC_ACESR register */
...
#define SDMMC_HC2R_UHSMS(value)               (SDMMC_HC2R_UHSMS_Msk & (_UINT16_(value) << SDMMC_HC2R_UHSMS_Pos)) /* Assignment of value for UHSMS in the SDMMC_HC2R register */
...
#define SDMMC_HC2R_VS18EN(value)              (SDMMC_HC2R_VS18EN_Msk & (_UINT16_(value) << SDMMC_HC2R_VS18EN_Pos)) /* Assignment of value for VS18EN in the SDMMC_HC2R register */
...
#define SDMMC_HC2R_DRVSEL(value)              (SDMMC_HC2R_DRVSEL_Msk & (_UINT16_(value) << SDMMC_HC2R_DRVSEL_Pos)) /* Assignment of value for DRVSEL in the SDMMC_HC2R register */
...
#define SDMMC_HC2R_EXTUN(value)               (SDMMC_HC2R_EXTUN_Msk & (_UINT16_(value) << SDMMC_HC2R_EXTUN_Pos)) /* Assignment of value for EXTUN in the SDMMC_HC2R register */
...
#define SDMMC_HC2R_SLCKSEL(value)             (SDMMC_HC2R_SLCKSEL_Msk & (_UINT16_(value) << SDMMC_HC2R_SLCKSEL_Pos)) /* Assignment of value for SLCKSEL in the SDMMC_HC2R register */
...
#define SDMMC_HC2R_ASINTEN(value)             (SDMMC_HC2R_ASINTEN_Msk & (_UINT16_(value) << SDMMC_HC2R_ASINTEN_Pos)) /* Assignment of value for ASINTEN in the SDMMC_HC2R register */
...
#define SDMMC_HC2R_PVALEN(value)              (SDMMC_HC2R_PVALEN_Msk & (_UINT16_(value) << SDMMC_HC2R_PVALEN_Pos)) /* Assignment of value for PVALEN in the SDMMC_HC2R register */
...
#define SDMMC_CA0R_TEOCLKF(value)             (SDMMC_CA0R_TEOCLKF_Msk & (_UINT32_(value) << SDMMC_CA0R_TEOCLKF_Pos)) /* Assignment of value for TEOCLKF in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_TEOCLKU(value)             (SDMMC_CA0R_TEOCLKU_Msk & (_UINT32_(value) << SDMMC_CA0R_TEOCLKU_Pos)) /* Assignment of value for TEOCLKU in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_BASECLKF(value)            (SDMMC_CA0R_BASECLKF_Msk & (_UINT32_(value) << SDMMC_CA0R_BASECLKF_Pos)) /* Assignment of value for BASECLKF in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_MAXBLKL(value)             (SDMMC_CA0R_MAXBLKL_Msk & (_UINT32_(value) << SDMMC_CA0R_MAXBLKL_Pos)) /* Assignment of value for MAXBLKL in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_ED8SUP(value)              (SDMMC_CA0R_ED8SUP_Msk & (_UINT32_(value) << SDMMC_CA0R_ED8SUP_Pos)) /* Assignment of value for ED8SUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_ADMA2SUP(value)            (SDMMC_CA0R_ADMA2SUP_Msk & (_UINT32_(value) << SDMMC_CA0R_ADMA2SUP_Pos)) /* Assignment of value for ADMA2SUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_HSSUP(value)               (SDMMC_CA0R_HSSUP_Msk & (_UINT32_(value) << SDMMC_CA0R_HSSUP_Pos)) /* Assignment of value for HSSUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_SDMASUP(value)             (SDMMC_CA0R_SDMASUP_Msk & (_UINT32_(value) << SDMMC_CA0R_SDMASUP_Pos)) /* Assignment of value for SDMASUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_SRSUP(value)               (SDMMC_CA0R_SRSUP_Msk & (_UINT32_(value) << SDMMC_CA0R_SRSUP_Pos)) /* Assignment of value for SRSUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_V33VSUP(value)             (SDMMC_CA0R_V33VSUP_Msk & (_UINT32_(value) << SDMMC_CA0R_V33VSUP_Pos)) /* Assignment of value for V33VSUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_V30VSUP(value)             (SDMMC_CA0R_V30VSUP_Msk & (_UINT32_(value) << SDMMC_CA0R_V30VSUP_Pos)) /* Assignment of value for V30VSUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_V18VSUP(value)             (SDMMC_CA0R_V18VSUP_Msk & (_UINT32_(value) << SDMMC_CA0R_V18VSUP_Pos)) /* Assignment of value for V18VSUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_SB64SUP(value)             (SDMMC_CA0R_SB64SUP_Msk & (_UINT32_(value) << SDMMC_CA0R_SB64SUP_Pos)) /* Assignment of value for SB64SUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_ASINTSUP(value)            (SDMMC_CA0R_ASINTSUP_Msk & (_UINT32_(value) << SDMMC_CA0R_ASINTSUP_Pos)) /* Assignment of value for ASINTSUP in the SDMMC_CA0R register */
...
#define SDMMC_CA0R_SLTYPE(value)              (SDMMC_CA0R_SLTYPE_Msk & (_UINT32_(value) << SDMMC_CA0R_SLTYPE_Pos)) /* Assignment of value for SLTYPE in the SDMMC_CA0R register */
...
#define SDMMC_CA1R_SDR50SUP(value)            (SDMMC_CA1R_SDR50SUP_Msk & (_UINT32_(value) << SDMMC_CA1R_SDR50SUP_Pos)) /* Assignment of value for SDR50SUP in the SDMMC_CA1R register */
...
#define SDMMC_CA1R_SDR104SUP(value)           (SDMMC_CA1R_SDR104SUP_Msk & (_UINT32_(value) << SDMMC_CA1R_SDR104SUP_Pos)) /* Assignment of value for SDR104SUP in the SDMMC_CA1R register */
...
#define SDMMC_CA1R_DDR50SUP(value)            (SDMMC_CA1R_DDR50SUP_Msk & (_UINT32_(value) << SDMMC_CA1R_DDR50SUP_Pos)) /* Assignment of value for DDR50SUP in the SDMMC_CA1R register */
...
#define SDMMC_CA1R_DRVASUP(value)             (SDMMC_CA1R_DRVASUP_Msk & (_UINT32_(value) << SDMMC_CA1R_DRVASUP_Pos)) /* Assignment of value for DRVASUP in the SDMMC_CA1R register */
...
#define SDMMC_CA1R_DRVCSUP(value)             (SDMMC_CA1R_DRVCSUP_Msk & (_UINT32_(value) << SDMMC_CA1R_DRVCSUP_Pos)) /* Assignment of value for DRVCSUP in the SDMMC_CA1R register */
...
#define SDMMC_CA1R_DRVDSUP(value)             (SDMMC_CA1R_DRVDSUP_Msk & (_UINT32_(value) << SDMMC_CA1R_DRVDSUP_Pos)) /* Assignment of value for DRVDSUP in the SDMMC_CA1R register */
...
#define SDMMC_CA1R_TCNTRT(value)              (SDMMC_CA1R_TCNTRT_Msk & (_UINT32_(value) << SDMMC_CA1R_TCNTRT_Pos)) /* Assignment of value for TCNTRT in the SDMMC_CA1R register */
...
#define SDMMC_CA1R_TSDR50(value)              (SDMMC_CA1R_TSDR50_Msk & (_UINT32_(value) << SDMMC_CA1R_TSDR50_Pos)) /* Assignment of value for TSDR50 in the SDMMC_CA1R register */
...
#define SDMMC_CA1R_CLKMULT(value)             (SDMMC_CA1R_CLKMULT_Msk & (_UINT32_(value) << SDMMC_CA1R_CLKMULT_Pos)) /* Assignment of value for CLKMULT in the SDMMC_CA1R register */
...
#define SDMMC_MCCAR_MAXCUR33V(value)          (SDMMC_MCCAR_MAXCUR33V_Msk & (_UINT32_(value) << SDMMC_MCCAR_MAXCUR33V_Pos)) /* Assignment of value for MAXCUR33V in the SDMMC_MCCAR register */
...
#define SDMMC_MCCAR_MAXCUR30V(value)          (SDMMC_MCCAR_MAXCUR30V_Msk & (_UINT32_(value) << SDMMC_MCCAR_MAXCUR30V_Pos)) /* Assignment of value for MAXCUR30V in the SDMMC_MCCAR register */
...
#define SDMMC_MCCAR_MAXCUR18V(value)          (SDMMC_MCCAR_MAXCUR18V_Msk & (_UINT32_(value) << SDMMC_MCCAR_MAXCUR18V_Pos)) /* Assignment of value for MAXCUR18V in the SDMMC_MCCAR register */
...
#define SDMMC_FERACES_ACMD12NE(value)         (SDMMC_FERACES_ACMD12NE_Msk & (_UINT16_(value) << SDMMC_FERACES_ACMD12NE_Pos)) /* Assignment of value for ACMD12NE in the SDMMC_FERACES register */
...
#define SDMMC_FERACES_ACMDTEO(value)          (SDMMC_FERACES_ACMDTEO_Msk & (_UINT16_(value) << SDMMC_FERACES_ACMDTEO_Pos)) /* Assignment of value for ACMDTEO in the SDMMC_FERACES register */
...
#define SDMMC_FERACES_ACMDCRC(value)          (SDMMC_FERACES_ACMDCRC_Msk & (_UINT16_(value) << SDMMC_FERACES_ACMDCRC_Pos)) /* Assignment of value for ACMDCRC in the SDMMC_FERACES register */
...
#define SDMMC_FERACES_ACMDEND(value)          (SDMMC_FERACES_ACMDEND_Msk & (_UINT16_(value) << SDMMC_FERACES_ACMDEND_Pos)) /* Assignment of value for ACMDEND in the SDMMC_FERACES register */
...
#define SDMMC_FERACES_ACMDIDX(value)          (SDMMC_FERACES_ACMDIDX_Msk & (_UINT16_(value) << SDMMC_FERACES_ACMDIDX_Pos)) /* Assignment of value for ACMDIDX in the SDMMC_FERACES register */
...
#define SDMMC_FERACES_CMDNI(value)            (SDMMC_FERACES_CMDNI_Msk & (_UINT16_(value) << SDMMC_FERACES_CMDNI_Pos)) /* Assignment of value for CMDNI in the SDMMC_FERACES register */
...
#define SDMMC_FEREIS_CMDTEO(value)            (SDMMC_FEREIS_CMDTEO_Msk & (_UINT16_(value) << SDMMC_FEREIS_CMDTEO_Pos)) /* Assignment of value for CMDTEO in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_CMDCRC(value)            (SDMMC_FEREIS_CMDCRC_Msk & (_UINT16_(value) << SDMMC_FEREIS_CMDCRC_Pos)) /* Assignment of value for CMDCRC in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_CMDEND(value)            (SDMMC_FEREIS_CMDEND_Msk & (_UINT16_(value) << SDMMC_FEREIS_CMDEND_Pos)) /* Assignment of value for CMDEND in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_CMDIDX(value)            (SDMMC_FEREIS_CMDIDX_Msk & (_UINT16_(value) << SDMMC_FEREIS_CMDIDX_Pos)) /* Assignment of value for CMDIDX in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_DATTEO(value)            (SDMMC_FEREIS_DATTEO_Msk & (_UINT16_(value) << SDMMC_FEREIS_DATTEO_Pos)) /* Assignment of value for DATTEO in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_DATCRC(value)            (SDMMC_FEREIS_DATCRC_Msk & (_UINT16_(value) << SDMMC_FEREIS_DATCRC_Pos)) /* Assignment of value for DATCRC in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_DATEND(value)            (SDMMC_FEREIS_DATEND_Msk & (_UINT16_(value) << SDMMC_FEREIS_DATEND_Pos)) /* Assignment of value for DATEND in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_CURLIM(value)            (SDMMC_FEREIS_CURLIM_Msk & (_UINT16_(value) << SDMMC_FEREIS_CURLIM_Pos)) /* Assignment of value for CURLIM in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_ACMD(value)              (SDMMC_FEREIS_ACMD_Msk & (_UINT16_(value) << SDMMC_FEREIS_ACMD_Pos)) /* Assignment of value for ACMD in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_ADMA(value)              (SDMMC_FEREIS_ADMA_Msk & (_UINT16_(value) << SDMMC_FEREIS_ADMA_Pos)) /* Assignment of value for ADMA in the SDMMC_FEREIS register */
...
#define SDMMC_FEREIS_BOOTAE(value)            (SDMMC_FEREIS_BOOTAE_Msk & (_UINT16_(value) << SDMMC_FEREIS_BOOTAE_Pos)) /* Assignment of value for BOOTAE in the SDMMC_FEREIS register */
...
#define SDMMC_AESR_ERRST(value)               (SDMMC_AESR_ERRST_Msk & (_UINT8_(value) << SDMMC_AESR_ERRST_Pos)) /* Assignment of value for ERRST in the SDMMC_AESR register */
...
#define SDMMC_AESR_LMIS(value)                (SDMMC_AESR_LMIS_Msk & (_UINT8_(value) << SDMMC_AESR_LMIS_Pos)) /* Assignment of value for LMIS in the SDMMC_AESR register */
...
#define SDMMC_ASAR_ADMASA(value)              (SDMMC_ASAR_ADMASA_Msk & (_UINT32_(value) << SDMMC_ASAR_ADMASA_Pos)) /* Assignment of value for ADMASA in the SDMMC_ASAR register */
...
#define SDMMC_PVR_SDCLKFSEL(value)            (SDMMC_PVR_SDCLKFSEL_Msk & (_UINT16_(value) << SDMMC_PVR_SDCLKFSEL_Pos)) /* Assignment of value for SDCLKFSEL in the SDMMC_PVR register */
...
#define SDMMC_PVR_CLKGSEL(value)              (SDMMC_PVR_CLKGSEL_Msk & (_UINT16_(value) << SDMMC_PVR_CLKGSEL_Pos)) /* Assignment of value for CLKGSEL in the SDMMC_PVR register */
...
#define SDMMC_PVR_DRVSEL(value)               (SDMMC_PVR_DRVSEL_Msk & (_UINT16_(value) << SDMMC_PVR_DRVSEL_Pos)) /* Assignment of value for DRVSEL in the SDMMC_PVR register */
...
#define SDMMC_SISR_INTSSL(value)              (SDMMC_SISR_INTSSL_Msk & (_UINT16_(value) << SDMMC_SISR_INTSSL_Pos)) /* Assignment of value for INTSSL in the SDMMC_SISR register */
...
#define SDMMC_HCVR_SVER(value)                (SDMMC_HCVR_SVER_Msk & (_UINT16_(value) << SDMMC_HCVR_SVER_Pos)) /* Assignment of value for SVER in the SDMMC_HCVR register */
...
#define SDMMC_HCVR_VVER(value)                (SDMMC_HCVR_VVER_Msk & (_UINT16_(value) << SDMMC_HCVR_VVER_Pos)) /* Assignment of value for VVER in the SDMMC_HCVR register */
...
#define SDMMC_MC1R_CMDTYP(value)              (SDMMC_MC1R_CMDTYP_Msk & (_UINT8_(value) << SDMMC_MC1R_CMDTYP_Pos)) /* Assignment of value for CMDTYP in the SDMMC_MC1R register */
...
#define SDMMC_MC1R_DDR(value)                 (SDMMC_MC1R_DDR_Msk & (_UINT8_(value) << SDMMC_MC1R_DDR_Pos)) /* Assignment of value for DDR in the SDMMC_MC1R register */
...
#define SDMMC_MC1R_OPD(value)                 (SDMMC_MC1R_OPD_Msk & (_UINT8_(value) << SDMMC_MC1R_OPD_Pos)) /* Assignment of value for OPD in the SDMMC_MC1R register */
...
#define SDMMC_MC1R_BOOTA(value)               (SDMMC_MC1R_BOOTA_Msk & (_UINT8_(value) << SDMMC_MC1R_BOOTA_Pos)) /* Assignment of value for BOOTA in the SDMMC_MC1R register */
...
#define SDMMC_MC1R_RSTN(value)                (SDMMC_MC1R_RSTN_Msk & (_UINT8_(value) << SDMMC_MC1R_RSTN_Pos)) /* Assignment of value for RSTN in the SDMMC_MC1R register */
...
#define SDMMC_MC1R_FCD(value)                 (SDMMC_MC1R_FCD_Msk & (_UINT8_(value) << SDMMC_MC1R_FCD_Pos)) /* Assignment of value for FCD in the SDMMC_MC1R register */
...
#define SDMMC_MC2R_SRESP(value)               (SDMMC_MC2R_SRESP_Msk & (_UINT8_(value) << SDMMC_MC2R_SRESP_Pos)) /* Assignment of value for SRESP in the SDMMC_MC2R register */
...
#define SDMMC_MC2R_ABOOT(value)               (SDMMC_MC2R_ABOOT_Msk & (_UINT8_(value) << SDMMC_MC2R_ABOOT_Pos)) /* Assignment of value for ABOOT in the SDMMC_MC2R register */
...
#define SDMMC_DEBR_CDDVAL(value)              (SDMMC_DEBR_CDDVAL_Msk & (_UINT8_(value) << SDMMC_DEBR_CDDVAL_Pos)) /* Assignment of value for CDDVAL in the SDMMC_DEBR register */
...
#define SDMMC_ACR_BMAX(value)                 (SDMMC_ACR_BMAX_Msk & (_UINT32_(value) << SDMMC_ACR_BMAX_Pos)) /* Assignment of value for BMAX in the SDMMC_ACR register */
...
#define SDMMC_CC2R_FSDCLKD(value)             (SDMMC_CC2R_FSDCLKD_Msk & (_UINT32_(value) << SDMMC_CC2R_FSDCLKD_Pos)) /* Assignment of value for FSDCLKD in the SDMMC_CC2R register */
...
#define SDMMC_CACR_CAPWREN(value)             (SDMMC_CACR_CAPWREN_Msk & (_UINT32_(value) << SDMMC_CACR_CAPWREN_Pos)) /* Assignment of value for CAPWREN in the SDMMC_CACR register */
...
#define SDMMC_CACR_KEY(value)                 (SDMMC_CACR_KEY_Msk & (_UINT32_(value) << SDMMC_CACR_KEY_Pos)) /* Assignment of value for KEY in the SDMMC_CACR register */
...
#define SDMMC_DBGR_NIDBG(value)               (SDMMC_DBGR_NIDBG_Msk & (_UINT32_(value) << SDMMC_DBGR_NIDBG_Pos)) /* Assignment of value for NIDBG in the SDMMC_DBGR register */
...
#endif /* _PIC32CKGC01_SDMMC_COMPONENT_H_ */
