...
#ifndef _PIC32CKGC01_EVSYS_COMPONENT_H_
#define _PIC32CKGC01_EVSYS_COMPONENT_H_
...
{  /* Event System Interface */
  ...
  __IO  uint8_t                        EVSYS_USER[104];    /* Offset: 0x120 (R/W  8) User Multiplexer n */
} evsys_registers_t;


#endif /* !(defined(__ASSEMBLER__) || defined(__IAR_SYSTEMS_ASM__)) */
#endif /* _PIC32CKGC01_EVSYS_COMPONENT_H_ */
