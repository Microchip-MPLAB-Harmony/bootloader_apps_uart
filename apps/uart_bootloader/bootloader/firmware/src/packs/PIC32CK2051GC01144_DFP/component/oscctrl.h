...
#define OSCCTRL_PLL0POSTDIVB_RESETVALUE       _UINT32_(0x2020)                                     /*  (OSCCTRL_PLL0POSTDIVB) PLL output clock divider B  Reset Value */
...
#endif /* _PIC32CKGC01_OSCCTRL_COMPONENT_H_ */
