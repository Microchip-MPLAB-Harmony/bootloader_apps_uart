...
#ifndef _PIC32CKGC01_SERCOM2_INSTANCE_
#define _PIC32CKGC01_SERCOM2_INSTANCE_
...
#define SERCOM2_I2C_0_INT_SRC                    (56)       /* USART/SPI/I2C Error */
#define SERCOM2_I2C_1_INT_SRC                    (59)       /* USART-SPI Receive Complete/ I2C Data Ready */
#define SERCOM2_I2C_2_INT_SRC                    (60)       /* USART Receive Start/ SPI Slave Select Low/ I2C TX FIFO Empty */
#define SERCOM2_I2C_3_INT_SRC                    (61)       /* USART Clear To Send Input Change/ I2C RX FIFO Full */
#define SERCOM2_INSTANCE_ID                      (42)       /* Instance index for SERCOM2 */
#define SERCOM2_MCLK_ID_APB                      (73)       /* Index for SERCOM2 APB clock */
#define SERCOM2_PAC_ID                           (42)       /* Index for SERCOM2 registers write protection */
#define SERCOM2_SPI                              (1)        /* SPI mode implemented? */
#define SERCOM2_SPI_RX_INT_SRC                   (59)       /* USART-SPI Receive Complete/ I2C Data Ready */
#define SERCOM2_SPI_TX_COMPLETE_INT_SRC          (58)       /* USART-SPI Transmit Complete/ I2C Address Match */
#define SERCOM2_SPI_TX_READY_INT_SRC             (57)       /* USART-SPI Data Register Empty/ I2C Stop Received */
...
#define SERCOM2_USART_ERROR_INT_SRC              (56)       /* USART/SPI/I2C Error */
...
#define SERCOM2_USART_RX_INT_SRC                 (59)       /* USART-SPI Receive Complete/ I2C Data Ready */
#define SERCOM2_USART_TX_COMPLETE_INT_SRC        (58)       /* USART-SPI Transmit Complete/ I2C Address Match */
#define SERCOM2_USART_TX_READY_INT_SRC           (57)       /* USART-SPI Data Register Empty/ I2C Stop Received */

#endif /* _PIC32CKGC01_SERCOM2_INSTANCE_ */
