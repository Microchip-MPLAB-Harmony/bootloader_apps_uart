...
1. Open the test application project *test_app/firmware/pic32cm_mc00_curiosity_pro.X* in the IDE
2. Build the project to generate the binary **(Do not program the binary)**
3. Open the bootloader project *bootloader/firmware/pic32cm_mc00_curiosity_pro.X* in the IDE
4. Build and program the application using the IDE

5. Run the **btl_host.py** from command prompt to program the application binary

        python <harmony3_path>/bootloader/tools/btl_host.py -v -i <COM PORT> -d pic32cm -a 0x800 -f <harmony3_path>/bootloader_apps_uart/apps/uart_bootloader/test_app/firmware/pic32cm_mc00_curiosity_pro.X/dist/pic32cm_mc00_curiosity_pro/production/pic32cm_mc00_curiosity_pro.X.production.bin
